; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\scriptregistrar.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@PBD@Z ; ScriptRegistrar::GetScriptFactory
PUBLIC	?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@H@Z ; ScriptRegistrar::GetScriptFactory
PUBLIC	?Count@ScriptRegistrar@@SAHXZ			; ScriptRegistrar::Count
...
EXTRN	?GetNext@ScriptFactory@@IBEPAV1@XZ:PROC		; ScriptFactory::GetNext
EXTRN	?SetNext@ScriptFactory@@IAEXPAV1@@Z:PROC	; ScriptFactory::SetNext
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptregistrar.cpp
;	COMDAT ?Count@ScriptRegistrar@@SAHXZ
_TEXT	SEGMENT
_factory$ = -8						; size = 4
_count$ = -4						; size = 4
?Count@ScriptRegistrar@@SAHXZ PROC			; ScriptRegistrar::Count, COMDAT
...
; 85   : 	ScriptFactory* factory = mScriptFactories;
...
; 89   : 		factory = factory->GetNext();

	mov	ecx, DWORD PTR _factory$[ebp]
	call	?GetNext@ScriptFactory@@IBEPAV1@XZ	; ScriptFactory::GetNext
	mov	DWORD PTR _factory$[ebp], eax
...
; 92   : }
	...
	pop	ebp
	ret	0
?Count@ScriptRegistrar@@SAHXZ ENDP			; ScriptRegistrar::Count
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptregistrar.cpp
;	COMDAT ?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@H@Z
_TEXT	SEGMENT
_factory$ = -8						; size = 4
_count$ = -4						; size = 4
_index$ = 8						; size = 4
?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@H@Z PROC ; ScriptRegistrar::GetScriptFactory, COMDAT
...
; 69   : 	ScriptFactory* factory = mScriptFactories;

	mov	eax, DWORD PTR ?mScriptFactories@ScriptRegistrar@@0PAVScriptFactory@@A ; ScriptRegistrar::mScriptFactories
	mov	DWORD PTR _factory$[ebp], eax
$LN3@GetScriptF:

; 70   : 	while (factory != NULL)

	cmp	DWORD PTR _factory$[ebp], 0
	je	SHORT $LN2@GetScriptF
...
; 72   : 		if (count == index)
	...
	jne	SHORT $LN1@GetScriptF

; 73   : 		{
; 74   : 			return factory;

	mov	eax, DWORD PTR _factory$[ebp]
	jmp	SHORT $LN4@GetScriptF
$LN1@GetScriptF:
...
; 80   : }
	...
	pop	ebp
	ret	0
?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@H@Z ENDP ; ScriptRegistrar::GetScriptFactory
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptregistrar.cpp
;	COMDAT ?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@PBD@Z
_TEXT	SEGMENT
_factory$1 = -4						; size = 4
_name$ = 8						; size = 4
?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@PBD@Z PROC ; ScriptRegistrar::GetScriptFactory, COMDAT
...
; 51   : 	if (name != NULL)
	...
	je	SHORT $LN4@GetScriptF

; 52   : 	{
; 53   : 		ScriptFactory* factory = mScriptFactories;

	mov	eax, DWORD PTR ?mScriptFactories@ScriptRegistrar@@0PAVScriptFactory@@A ; ScriptRegistrar::mScriptFactories
	mov	DWORD PTR _factory$1[ebp], eax
$LN3@GetScriptF:

; 54   : 		while (factory != NULL)

	cmp	DWORD PTR _factory$1[ebp], 0
	je	SHORT $LN4@GetScriptF

; 55   : 		{
; 56   : 			if (_stricmp(factory->GetName(), name) == 0)

	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	mov	ecx, DWORD PTR _factory$1[ebp]
...
; 58   : 				return factory;
	...
	jmp	SHORT $LN5@GetScriptF
$LN1@GetScriptF:

; 59   : 			}
; 60   : 			factory = factory->GetNext();
...
; 64   : }
	...
	pop	ebp
	ret	0
?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@PBD@Z ENDP ; ScriptRegistrar::GetScriptFactory
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptregistrar.cpp
...
; 96   : 	if (scriptName != NULL)
	...
	je	SHORT $LN4@CreateScri

; 97   : 	{
; 98   : 		ScriptFactory* factory = mScriptFactories;

	mov	eax, DWORD PTR ?mScriptFactories@ScriptRegistrar@@0PAVScriptFactory@@A ; ScriptRegistrar::mScriptFactories
	mov	DWORD PTR _factory$1[ebp], eax
$LN3@CreateScri:

; 99   : 		while (factory != NULL)

	cmp	DWORD PTR _factory$1[ebp], 0
	je	SHORT $LN4@CreateScri

; 100  : 		{
; 101  : 			if (_stricmp(factory->GetName(), scriptName) == 0)
	...
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@CreateScri

; 102  : 			{
; 103  : 				return factory->Create();
	...
	call	eax
	jmp	SHORT $LN5@CreateScri
$LN1@CreateScri:

; 104  : 			}
; 105  : 			factory = factory->GetNext();
...
; 19   : 	ScriptFactory* previous = NULL;

	mov	DWORD PTR _previous$[ebp], 0

; 20   : 	ScriptFactory* current = mScriptFactories;
...
; 42   : 	if (factory != NULL)
	...
	cmp	DWORD PTR _factory$[ebp], 0
	je	SHORT $LN2@RegisterSc

; 43   : 	{
; 44   : 		factory->SetNext(mScriptFactories);
