; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\WeaponManager.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@PBD@Z ; WeaponManager::Find_Ammo_Definition
PUBLIC	?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@H@Z ; WeaponManager::Find_Ammo_Definition
PUBLIC	?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@PBD@Z ; WeaponManager::Find_Weapon_Definition
PUBLIC	?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@H@Z ; WeaponManager::Find_Weapon_Definition
...
EXTRN	__imp_?Find_Typed_Definition@DefinitionMgrClass@@SAPAVDefinitionClass@@PBDI_N@Z:PROC
...
; File x:\github\renegade\dragonade_rxd\scripts\weaponmanager.cpp
;	COMDAT ?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@H@Z
_TEXT	SEGMENT
_id$ = 8						; size = 4
?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@H@Z PROC ; WeaponManager::Find_Weapon_Definition, COMDAT
...
; 31   : 	return (const WeaponDefinitionClass *)DefinitionMgrClass::Find_Definition( id, true);
...
; 32   : }
	...
	pop	ebp
	ret	0
?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@H@Z ENDP ; WeaponManager::Find_Weapon_Definition
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\weaponmanager.cpp
;	COMDAT ?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@PBD@Z
_TEXT	SEGMENT
_name$ = 8						; size = 4
?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@PBD@Z PROC ; WeaponManager::Find_Weapon_Definition, COMDAT
...
; 27   : 	return (const WeaponDefinitionClass *)DefinitionMgrClass::Find_Typed_Definition( name, 45057, true);

	push	1
	push	45057					; 0000b001H
	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	call	DWORD PTR __imp_?Find_Typed_Definition@DefinitionMgrClass@@SAPAVDefinitionClass@@PBDI_N@Z
...
; 28   : }
	...
	pop	ebp
	ret	0
?Find_Weapon_Definition@WeaponManager@@SAPBVWeaponDefinitionClass@@PBD@Z ENDP ; WeaponManager::Find_Weapon_Definition
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\weaponmanager.cpp
;	COMDAT ?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@H@Z
_TEXT	SEGMENT
_id$ = 8						; size = 4
?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@H@Z PROC ; WeaponManager::Find_Ammo_Definition, COMDAT
...
; 39   : 	return (const AmmoDefinitionClass *)DefinitionMgrClass::Find_Definition( id, true);
...
; 40   : }
	...
	pop	ebp
	ret	0
?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@H@Z ENDP ; WeaponManager::Find_Ammo_Definition
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\weaponmanager.cpp
;	COMDAT ?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@PBD@Z
_TEXT	SEGMENT
_name$ = 8						; size = 4
?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@PBD@Z PROC ; WeaponManager::Find_Ammo_Definition, COMDAT
...
; 35   : 	return (const AmmoDefinitionClass *)DefinitionMgrClass::Find_Typed_Definition( name, 45058, true);

	push	1
	push	45058					; 0000b002H
	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	call	DWORD PTR __imp_?Find_Typed_Definition@DefinitionMgrClass@@SAPAVDefinitionClass@@PBDI_N@Z
	add	esp, 12					; 0000000cH
...
; 36   : }
	...
	pop	ebp
	ret	0
?Find_Ammo_Definition@WeaponManager@@SAPBVAmmoDefinitionClass@@PBD@Z ENDP ; WeaponManager::Find_Ammo_Definition
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
