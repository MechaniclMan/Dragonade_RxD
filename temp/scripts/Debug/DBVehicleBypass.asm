; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\DBVehicleBypass.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Get_Is_Scripts_Visible@VehicleGameObj@@QAE_NXZ	; VehicleGameObj::Get_Is_Scripts_Visible
PUBLIC	?Bypass_Drop_Off@@YAXVVector3@@MPAVScriptableGameObj@@@Z ; Bypass_Drop_Off
PUBLIC	?ObjectCreateHook@DB_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z ; DB_CinematicVehicleFactoryBypass::ObjectCreateHook
PUBLIC	??0DB_CinematicVehicleFactoryBypass@@QAE@XZ	; DB_CinematicVehicleFactoryBypass::DB_CinematicVehicleFactoryBypass
PUBLIC	??1DB_CinematicVehicleFactoryBypass@@UAE@XZ	; DB_CinematicVehicleFactoryBypass::~DB_CinematicVehicleFactoryBypass
PUBLIC	??_GDB_CinematicVehicleFactoryBypass@@UAEPAXI@Z	; DB_CinematicVehicleFactoryBypass::`scalar deleting destructor'
PUBLIC	?Created@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@@Z ; DB_Check_Airdrop::Created
PUBLIC	?Timer_Expired@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@H@Z ; DB_Check_Airdrop::Timer_Expired
PUBLIC	??0DB_Check_Airdrop@@QAE@XZ			; DB_Check_Airdrop::DB_Check_Airdrop
PUBLIC	??1DB_Check_Airdrop@@UAE@XZ			; DB_Check_Airdrop::~DB_Check_Airdrop
PUBLIC	??_GDB_Check_Airdrop@@UAEPAXI@Z			; DB_Check_Airdrop::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::ScriptRegistrant<DB_CinematicVehicleFactoryBypass>
PUBLIC	?Create@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::Create
PUBLIC	??1?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAE@XZ ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::~ScriptRegistrant<DB_CinematicVehicleFactoryBypass>
PUBLIC	??_G?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VDB_Check_Airdrop@@@@QAE@PBD0@Z ; ScriptRegistrant<DB_Check_Airdrop>::ScriptRegistrant<DB_Check_Airdrop>
PUBLIC	?Create@?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<DB_Check_Airdrop>::Create
PUBLIC	??1?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAE@XZ ; ScriptRegistrant<DB_Check_Airdrop>::~ScriptRegistrant<DB_Check_Airdrop>
PUBLIC	??_G?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAXI@Z ; ScriptRegistrant<DB_Check_Airdrop>::`scalar deleting destructor'
PUBLIC	?Created@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@@Z ; Bypass_Drop_Off_Control::Created
PUBLIC	?Timer_Expired@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@H@Z ; Bypass_Drop_Off_Control::Timer_Expired
PUBLIC	??0Bypass_Drop_Off_Control@@QAE@XZ		; Bypass_Drop_Off_Control::Bypass_Drop_Off_Control
PUBLIC	??1Bypass_Drop_Off_Control@@UAE@XZ		; Bypass_Drop_Off_Control::~Bypass_Drop_Off_Control
PUBLIC	??_GBypass_Drop_Off_Control@@UAEPAXI@Z		; Bypass_Drop_Off_Control::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@QAE@PBD0@Z ; ScriptRegistrant<Bypass_Drop_Off_Control>::ScriptRegistrant<Bypass_Drop_Off_Control>
PUBLIC	?Create@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<Bypass_Drop_Off_Control>::Create
PUBLIC	??1?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAE@XZ ; ScriptRegistrant<Bypass_Drop_Off_Control>::~ScriptRegistrant<Bypass_Drop_Off_Control>
PUBLIC	??_G?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAXI@Z ; ScriptRegistrant<Bypass_Drop_Off_Control>::`scalar deleting destructor'
...
PUBLIC	??_C@_0BB@DGIDEDNE@invisible_object?$AA@	; `string'
PUBLIC	??_C@_02IKAHHCAI@?$CFi?$AA@			; `string'
PUBLIC	??_C@_0BI@HAKDAMCO@Bypass_Drop_Off_Control?$AA@	; `string'
PUBLIC	??_7DB_CinematicVehicleFactoryBypass@@6B@	; DB_CinematicVehicleFactoryBypass::`vftable'
PUBLIC	??_C@_0L@FPLAAJEA@PresetName?$AA@		; `string'
PUBLIC	??_C@_0BB@IDFBNCKJ@DB_Check_Airdrop?$AA@	; `string'
PUBLIC	??_7DB_Check_Airdrop@@6B@			; DB_Check_Airdrop::`vftable'
PUBLIC	??_C@_0CB@DDNLOMJF@DAAirDroppedVehicleObserverClass@ ; `string'
PUBLIC	??_C@_07EECDMLNK@ArrowID?$AA@			; `string'
PUBLIC	??_C@_0CI@BJNFBMCE@Your?5Vehicle?5will?5be?5Airdropped?5@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@ ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`vftable'
PUBLIC	?DB_CinematicVehicleFactoryBypass_Registrant@@3V?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@A ; DB_CinematicVehicleFactoryBypass_Registrant
PUBLIC	??_C@_0BC@BEFKOJOJ@PresetName?3string?$AA@	; `string'
PUBLIC	??_C@_0CB@EFFGNNNN@DB_CinematicVehicleFactoryBypass@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@	; ScriptRegistrant<DB_Check_Airdrop>::`vftable'
PUBLIC	?DB_Check_Airdrop_Registrant@@3V?$ScriptRegistrant@VDB_Check_Airdrop@@@@A ; DB_Check_Airdrop_Registrant
PUBLIC	??_C@_0M@LPKOJAMC@ArrowID?3int?$AA@		; `string'
PUBLIC	??_7Bypass_Drop_Off_Control@@6B@		; Bypass_Drop_Off_Control::`vftable'
PUBLIC	??_C@_0BC@HOIKKGNK@Generic_Cinematic?$AA@	; `string'
PUBLIC	??_C@_0BA@ECNCKCNL@XG_TransprtBone?$AA@		; `string'
PUBLIC	??_C@_00CNPNBAHC@?$AA@				; `string'
PUBLIC	??_C@_0BM@LLIBMBBB@XG_TransprtBone?4XG_HD_TTraj?$AA@ ; `string'
PUBLIC	??_C@_0O@CGIOPOPI@BN_Trajectory?$AA@		; `string'
PUBLIC	??_C@_0BJ@FEBFBIF@GDI_Transport_Helicopter?$AA@	; `string'
PUBLIC	??_C@_0BJ@GBHHDNCJ@Nod_Transport_Helicopter?$AA@ ; `string'
PUBLIC	??_C@_0BK@PAHFALDP@v_Nod_Trnspt?4v_Nod_Trnspt?$AA@ ; `string'
PUBLIC	??_C@_05HBJPNAAK@Blamo?$AA@			; `string'
PUBLIC	??_C@_0M@CNJIJLLK@XG_HD_HTraj?$AA@		; `string'
PUBLIC	??_C@_0BI@CFAHIPBD@XG_HD_HTraj?4XG_HD_HTraj?$AA@ ; `string'
PUBLIC	??_C@_0O@LDKNACI@XG_HD_Harness?$AA@		; `string'
PUBLIC	??_C@_0BM@MKCKFNFC@XG_HD_Harness?4XG_HD_Harness?$AA@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@ ; ScriptRegistrant<Bypass_Drop_Off_Control>::`vftable'
PUBLIC	?DropOffControlRegistrant@@3V?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@A ; DropOffControlRegistrant
...
PUBLIC	??_C@_0EB@BOOGPFKJ@ScriptRegistrant?$DMclass?5DB_Cinema@ ; `string'
...
PUBLIC	??_C@_0DB@IDJHOOLF@ScriptRegistrant?$DMclass?5DB_Check_@ ; `string'
PUBLIC	??_C@_0DI@HBPCLFGN@ScriptRegistrant?$DMclass?5Bypass_Dr@ ; `string'
...
PUBLIC	??_R4DB_CinematicVehicleFactoryBypass@@6B@	; DB_CinematicVehicleFactoryBypass::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVDB_CinematicVehicleFactoryBypass@@@8	; DB_CinematicVehicleFactoryBypass `RTTI Type Descriptor'
PUBLIC	??_R3DB_CinematicVehicleFactoryBypass@@8	; DB_CinematicVehicleFactoryBypass::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2DB_CinematicVehicleFactoryBypass@@8	; DB_CinematicVehicleFactoryBypass::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@DB_CinematicVehicleFactoryBypass@@8 ; DB_CinematicVehicleFactoryBypass::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4DB_Check_Airdrop@@6B@			; DB_Check_Airdrop::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVDB_Check_Airdrop@@@8			; DB_Check_Airdrop `RTTI Type Descriptor'
PUBLIC	??_R3DB_Check_Airdrop@@8			; DB_Check_Airdrop::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2DB_Check_Airdrop@@8			; DB_Check_Airdrop::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@DB_Check_Airdrop@@8		; DB_Check_Airdrop::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@ ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@@8 ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@ ; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VDB_Check_Airdrop@@@@@8 ; ScriptRegistrant<DB_Check_Airdrop> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VDB_Check_Airdrop@@@@8	; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VDB_Check_Airdrop@@@@8	; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VDB_Check_Airdrop@@@@8 ; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4Bypass_Drop_Off_Control@@6B@		; Bypass_Drop_Off_Control::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVBypass_Drop_Off_Control@@@8		; Bypass_Drop_Off_Control `RTTI Type Descriptor'
PUBLIC	??_R3Bypass_Drop_Off_Control@@8			; Bypass_Drop_Off_Control::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2Bypass_Drop_Off_Control@@8			; Bypass_Drop_Off_Control::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@Bypass_Drop_Off_Control@@8	; Bypass_Drop_Off_Control::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@ ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@@8 ; ScriptRegistrant<Bypass_Drop_Off_Control> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	??_EDB_CinematicVehicleFactoryBypass@@UAEPAXI@Z:PROC ; DB_CinematicVehicleFactoryBypass::`vector deleting destructor'
EXTRN	??_EDB_Check_Airdrop@@UAEPAXI@Z:PROC		; DB_Check_Airdrop::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<DB_Check_Airdrop>::`vector deleting destructor'
EXTRN	??_EBypass_Drop_Off_Control@@UAEPAXI@Z:PROC	; Bypass_Drop_Off_Control::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<Bypass_Drop_Off_Control>::`vector deleting destructor'
...
_BSS	SEGMENT
?DB_CinematicVehicleFactoryBypass_Registrant@@3V?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@A DB 010H DUP (?) ; DB_CinematicVehicleFactoryBypass_Registrant
?DB_Check_Airdrop_Registrant@@3V?$ScriptRegistrant@VDB_Check_Airdrop@@@@A DB 010H DUP (?) ; DB_Check_Airdrop_Registrant
?DropOffControlRegistrant@@3V?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@A DB 010H DUP (?) ; DropOffControlRegistrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_DB_CinematicVehicleFactoryBypass_Registrant$initializer$ DD FLAT:??__EDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT __real@41633333
CONST	SEGMENT
__real@41633333 DD 041633333r			; 14.2
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@@8 ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8 DD 00H ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<Bypass_Drop_Off_Control> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@ DD 00H ; ScriptRegistrant<Bypass_Drop_Off_Control>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@Bypass_Drop_Off_Control@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@Bypass_Drop_Off_Control@@8 DD FLAT:??_R0?AVBypass_Drop_Off_Control@@@8 ; Bypass_Drop_Off_Control::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3Bypass_Drop_Off_Control@@8
rdata$r	ENDS
;	COMDAT ??_R2Bypass_Drop_Off_Control@@8
rdata$r	SEGMENT
??_R2Bypass_Drop_Off_Control@@8 DD FLAT:??_R1A@?0A@EA@Bypass_Drop_Off_Control@@8 ; Bypass_Drop_Off_Control::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3Bypass_Drop_Off_Control@@8
rdata$r	SEGMENT
??_R3Bypass_Drop_Off_Control@@8 DD 00H			; Bypass_Drop_Off_Control::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2Bypass_Drop_Off_Control@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVBypass_Drop_Off_Control@@@8
_DATA	SEGMENT
??_R0?AVBypass_Drop_Off_Control@@@8 DD FLAT:??_7type_info@@6B@ ; Bypass_Drop_Off_Control `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVBypass_Drop_Off_Control@@', 00H
_DATA	ENDS
;	COMDAT ??_R4Bypass_Drop_Off_Control@@6B@
rdata$r	SEGMENT
??_R4Bypass_Drop_Off_Control@@6B@ DD 00H		; Bypass_Drop_Off_Control::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVBypass_Drop_Off_Control@@@8
	DD	FLAT:??_R3Bypass_Drop_Off_Control@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VDB_Check_Airdrop@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VDB_Check_Airdrop@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VDB_Check_Airdrop@@@@@8 ; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VDB_Check_Airdrop@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VDB_Check_Airdrop@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VDB_Check_Airdrop@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VDB_Check_Airdrop@@@@8 ; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VDB_Check_Airdrop@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VDB_Check_Airdrop@@@@8 DD 00H	; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VDB_Check_Airdrop@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VDB_Check_Airdrop@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VDB_Check_Airdrop@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<DB_Check_Airdrop> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VDB_Check_Airdrop@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@ DD 00H	; ScriptRegistrant<DB_Check_Airdrop>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VDB_Check_Airdrop@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VDB_Check_Airdrop@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@@8 ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8 DD 00H ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass'
	DB	'@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@ DD 00H ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@DB_Check_Airdrop@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@DB_Check_Airdrop@@8 DD FLAT:??_R0?AVDB_Check_Airdrop@@@8 ; DB_Check_Airdrop::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3DB_Check_Airdrop@@8
rdata$r	ENDS
;	COMDAT ??_R2DB_Check_Airdrop@@8
rdata$r	SEGMENT
??_R2DB_Check_Airdrop@@8 DD FLAT:??_R1A@?0A@EA@DB_Check_Airdrop@@8 ; DB_Check_Airdrop::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3DB_Check_Airdrop@@8
rdata$r	SEGMENT
??_R3DB_Check_Airdrop@@8 DD 00H				; DB_Check_Airdrop::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2DB_Check_Airdrop@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVDB_Check_Airdrop@@@8
_DATA	SEGMENT
??_R0?AVDB_Check_Airdrop@@@8 DD FLAT:??_7type_info@@6B@	; DB_Check_Airdrop `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVDB_Check_Airdrop@@', 00H
_DATA	ENDS
;	COMDAT ??_R4DB_Check_Airdrop@@6B@
rdata$r	SEGMENT
??_R4DB_Check_Airdrop@@6B@ DD 00H			; DB_Check_Airdrop::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVDB_Check_Airdrop@@@8
	DD	FLAT:??_R3DB_Check_Airdrop@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@DB_CinematicVehicleFactoryBypass@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@DB_CinematicVehicleFactoryBypass@@8 DD FLAT:??_R0?AVDB_CinematicVehicleFactoryBypass@@@8 ; DB_CinematicVehicleFactoryBypass::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	04H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3DB_CinematicVehicleFactoryBypass@@8
rdata$r	ENDS
;	COMDAT ??_R2DB_CinematicVehicleFactoryBypass@@8
rdata$r	SEGMENT
??_R2DB_CinematicVehicleFactoryBypass@@8 DD FLAT:??_R1A@?0A@EA@DB_CinematicVehicleFactoryBypass@@8 ; DB_CinematicVehicleFactoryBypass::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@JFW_Object_Created_Hook_Base@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3DB_CinematicVehicleFactoryBypass@@8
rdata$r	SEGMENT
??_R3DB_CinematicVehicleFactoryBypass@@8 DD 00H		; DB_CinematicVehicleFactoryBypass::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	05H
	DD	FLAT:??_R2DB_CinematicVehicleFactoryBypass@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVDB_CinematicVehicleFactoryBypass@@@8
_DATA	SEGMENT
??_R0?AVDB_CinematicVehicleFactoryBypass@@@8 DD FLAT:??_7type_info@@6B@ ; DB_CinematicVehicleFactoryBypass `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVDB_CinematicVehicleFactoryBypass@@', 00H
_DATA	ENDS
;	COMDAT ??_R4DB_CinematicVehicleFactoryBypass@@6B@
rdata$r	SEGMENT
??_R4DB_CinematicVehicleFactoryBypass@@6B@ DD 00H	; DB_CinematicVehicleFactoryBypass::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVDB_CinematicVehicleFactoryBypass@@@8
	DD	FLAT:??_R3DB_CinematicVehicleFactoryBypass@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DI@HBPCLFGN@ScriptRegistrant?$DMclass?5Bypass_Dr@
CONST	SEGMENT
??_C@_0DI@HBPCLFGN@ScriptRegistrant?$DMclass?5Bypass_Dr@ DB 'ScriptRegist'
	DB	'rant<class Bypass_Drop_Off_Control>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DB@IDJHOOLF@ScriptRegistrant?$DMclass?5DB_Check_@
CONST	SEGMENT
??_C@_0DB@IDJHOOLF@ScriptRegistrant?$DMclass?5DB_Check_@ DB 'ScriptRegist'
	DB	'rant<class DB_Check_Airdrop>::Create', 00H	; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0EB@BOOGPFKJ@ScriptRegistrant?$DMclass?5DB_Cinema@
CONST	SEGMENT
??_C@_0EB@BOOGPFKJ@ScriptRegistrant?$DMclass?5DB_Cinema@ DB 'ScriptRegist'
	DB	'rant<class DB_CinematicVehicleFactoryBypass>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@ ; ScriptRegistrant<Bypass_Drop_Off_Control>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BM@MKCKFNFC@XG_HD_Harness?4XG_HD_Harness?$AA@
CONST	SEGMENT
??_C@_0BM@MKCKFNFC@XG_HD_Harness?4XG_HD_Harness?$AA@ DB 'XG_HD_Harness.XG'
	DB	'_HD_Harness', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@LDKNACI@XG_HD_Harness?$AA@
CONST	SEGMENT
??_C@_0O@LDKNACI@XG_HD_Harness?$AA@ DB 'XG_HD_Harness', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@CFAHIPBD@XG_HD_HTraj?4XG_HD_HTraj?$AA@
CONST	SEGMENT
??_C@_0BI@CFAHIPBD@XG_HD_HTraj?4XG_HD_HTraj?$AA@ DB 'XG_HD_HTraj.XG_HD_HT'
	DB	'raj', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@CNJIJLLK@XG_HD_HTraj?$AA@
CONST	SEGMENT
??_C@_0M@CNJIJLLK@XG_HD_HTraj?$AA@ DB 'XG_HD_HTraj', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_05HBJPNAAK@Blamo?$AA@
CONST	SEGMENT
??_C@_05HBJPNAAK@Blamo?$AA@ DB 'Blamo', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@PAHFALDP@v_Nod_Trnspt?4v_Nod_Trnspt?$AA@
CONST	SEGMENT
??_C@_0BK@PAHFALDP@v_Nod_Trnspt?4v_Nod_Trnspt?$AA@ DB 'v_Nod_Trnspt.v_Nod'
	DB	'_Trnspt', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@GBHHDNCJ@Nod_Transport_Helicopter?$AA@
CONST	SEGMENT
??_C@_0BJ@GBHHDNCJ@Nod_Transport_Helicopter?$AA@ DB 'Nod_Transport_Helico'
	DB	'pter', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@FEBFBIF@GDI_Transport_Helicopter?$AA@
CONST	SEGMENT
??_C@_0BJ@FEBFBIF@GDI_Transport_Helicopter?$AA@ DB 'GDI_Transport_Helicop'
	DB	'ter', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@CGIOPOPI@BN_Trajectory?$AA@
CONST	SEGMENT
??_C@_0O@CGIOPOPI@BN_Trajectory?$AA@ DB 'BN_Trajectory', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@LLIBMBBB@XG_TransprtBone?4XG_HD_TTraj?$AA@
CONST	SEGMENT
??_C@_0BM@LLIBMBBB@XG_TransprtBone?4XG_HD_TTraj?$AA@ DB 'XG_TransprtBone.'
	DB	'XG_HD_TTraj', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_00CNPNBAHC@?$AA@
CONST	SEGMENT
??_C@_00CNPNBAHC@?$AA@ DB 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@ECNCKCNL@XG_TransprtBone?$AA@
CONST	SEGMENT
??_C@_0BA@ECNCKCNL@XG_TransprtBone?$AA@ DB 'XG_TransprtBone', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@HOIKKGNK@Generic_Cinematic?$AA@
CONST	SEGMENT
??_C@_0BC@HOIKKGNK@Generic_Cinematic?$AA@ DB 'Generic_Cinematic', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7Bypass_Drop_Off_Control@@6B@
CONST	SEGMENT
??_7Bypass_Drop_Off_Control@@6B@ DD FLAT:??_R4Bypass_Drop_Off_Control@@6B@ ; Bypass_Drop_Off_Control::`vftable'
	DD	FLAT:??_EBypass_Drop_Off_Control@@UAEPAXI@Z
	...
	DD	FLAT:?Created@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@@Z
	...
	DD	FLAT:?Timer_Expired@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@H@Z
...
CONST	ENDS
;	COMDAT ??_C@_0M@LPKOJAMC@ArrowID?3int?$AA@
CONST	SEGMENT
??_C@_0M@LPKOJAMC@ArrowID?3int?$AA@ DB 'ArrowID:int', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@ ; ScriptRegistrant<DB_Check_Airdrop>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0CB@EFFGNNNN@DB_CinematicVehicleFactoryBypass@
CONST	SEGMENT
??_C@_0CB@EFFGNNNN@DB_CinematicVehicleFactoryBypass@ DB 'DB_CinematicVehi'
	DB	'cleFactoryBypass', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@BEFKOJOJ@PresetName?3string?$AA@
CONST	SEGMENT
??_C@_0BC@BEFKOJOJ@PresetName?3string?$AA@ DB 'PresetName:string', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@ ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0CI@BJNFBMCE@Your?5Vehicle?5will?5be?5Airdropped?5@
CONST	SEGMENT
??_C@_0CI@BJNFBMCE@Your?5Vehicle?5will?5be?5Airdropped?5@ DB 'Your Vehicl'
	DB	'e will be Airdropped nearby.', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_07EECDMLNK@ArrowID?$AA@
CONST	SEGMENT
??_C@_07EECDMLNK@ArrowID?$AA@ DB 'ArrowID', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@DDNLOMJF@DAAirDroppedVehicleObserverClass@
CONST	SEGMENT
??_C@_0CB@DDNLOMJF@DAAirDroppedVehicleObserverClass@ DB 'DAAirDroppedVehi'
	DB	'cleObserverClass', 00H			; `string'
CONST	ENDS
;	COMDAT ??_7DB_Check_Airdrop@@6B@
CONST	SEGMENT
??_7DB_Check_Airdrop@@6B@ DD FLAT:??_R4DB_Check_Airdrop@@6B@ ; DB_Check_Airdrop::`vftable'
	DD	FLAT:??_EDB_Check_Airdrop@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@ScriptImpClass@@UAEXPAVScriptableGameObj@@HH0@Z
	...
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Entered@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Exited@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
CONST	ENDS
;	COMDAT ??_C@_0BB@IDFBNCKJ@DB_Check_Airdrop?$AA@
CONST	SEGMENT
??_C@_0BB@IDFBNCKJ@DB_Check_Airdrop?$AA@ DB 'DB_Check_Airdrop', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@FPLAAJEA@PresetName?$AA@
CONST	SEGMENT
??_C@_0L@FPLAAJEA@PresetName?$AA@ DB 'PresetName', 00H	; `string'
CONST	ENDS
;	COMDAT ??_7DB_CinematicVehicleFactoryBypass@@6B@
CONST	SEGMENT
??_7DB_CinematicVehicleFactoryBypass@@6B@ DD FLAT:??_R4DB_CinematicVehicleFactoryBypass@@6B@ ; DB_CinematicVehicleFactoryBypass::`vftable'
	DD	FLAT:??_EDB_CinematicVehicleFactoryBypass@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	...
	DD	FLAT:?Load_Data@ScriptImpClass@@UAEXAAVScriptLoader@@@Z
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
	DD	FLAT:?ObjectCreateHook@DB_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z
CONST	ENDS
;	COMDAT ??_C@_0BI@HAKDAMCO@Bypass_Drop_Off_Control?$AA@
CONST	SEGMENT
??_C@_0BI@HAKDAMCO@Bypass_Drop_Off_Control?$AA@ DB 'Bypass_Drop_Off_Contr'
	DB	'ol', 00H					; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BB@DGIDEDNE@invisible_object?$AA@
CONST	SEGMENT
??_C@_0BB@DGIDEDNE@invisible_object?$AA@ DB 'invisible_object', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
CRT$XCU	SEGMENT
_DB_Check_Airdrop_Registrant$initializer$ DD FLAT:??__EDB_Check_Airdrop_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_DropOffControlRegistrant$initializer$ DD FLAT:??__EDropOffControlRegistrant@@YAXXZ
CRT$XCU	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDropOffControlRegistrant@@YAXXZ
text$yd	SEGMENT
??__FDropOffControlRegistrant@@YAXXZ PROC		; `dynamic atexit destructor for 'DropOffControlRegistrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DropOffControlRegistrant@@3V?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@A ; DropOffControlRegistrant
	call	??1?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDropOffControlRegistrant@@YAXXZ ENDP		; `dynamic atexit destructor for 'DropOffControlRegistrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ??__EDropOffControlRegistrant@@YAXXZ
text$yc	SEGMENT
??__EDropOffControlRegistrant@@YAXXZ PROC		; `dynamic initializer for 'DropOffControlRegistrant'', COMDAT

; 183  : ScriptRegistrant<Bypass_Drop_Off_Control> DropOffControlRegistrant("Bypass_Drop_Off_Control", "ID:int");
	...
	push	OFFSET ??_C@_0BI@HAKDAMCO@Bypass_Drop_Off_Control?$AA@
	mov	ecx, OFFSET ?DropOffControlRegistrant@@3V?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@A ; DropOffControlRegistrant
	call	??0?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@QAE@PBD0@Z ; ScriptRegistrant<Bypass_Drop_Off_Control>::ScriptRegistrant<Bypass_Drop_Off_Control>
	push	OFFSET ??__FDropOffControlRegistrant@@YAXXZ ; `dynamic atexit destructor for 'DropOffControlRegistrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDropOffControlRegistrant@@YAXXZ ENDP		; `dynamic initializer for 'DropOffControlRegistrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAXI@Z PROC ; ScriptRegistrant<Bypass_Drop_Off_Control>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<Bypass_Drop_Off_Control>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAE@XZ PROC ; ScriptRegistrant<Bypass_Drop_Off_Control>::~ScriptRegistrant<Bypass_Drop_Off_Control>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAE@XZ ENDP ; ScriptRegistrant<Bypass_Drop_Off_Control>::~ScriptRegistrant<Bypass_Drop_Off_Control>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<Bypass_Drop_Off_Control>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DI@HBPCLFGN@ScriptRegistrant?$DMclass?5Bypass_Dr@
	push	553					; 00000229H
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0Bypass_Drop_Off_Control@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<Bypass_Drop_Off_Control>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<Bypass_Drop_Off_Control>::ScriptRegistrant<Bypass_Drop_Off_Control>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VBypass_Drop_Off_Control@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<Bypass_Drop_Off_Control>::ScriptRegistrant<Bypass_Drop_Off_Control>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GBypass_Drop_Off_Control@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GBypass_Drop_Off_Control@@UAEPAXI@Z PROC		; Bypass_Drop_Off_Control::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1Bypass_Drop_Off_Control@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GBypass_Drop_Off_Control@@UAEPAXI@Z ENDP		; Bypass_Drop_Off_Control::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1Bypass_Drop_Off_Control@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1Bypass_Drop_Off_Control@@UAE@XZ PROC			; Bypass_Drop_Off_Control::~Bypass_Drop_Off_Control, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1Bypass_Drop_Off_Control@@UAE@XZ ENDP			; Bypass_Drop_Off_Control::~Bypass_Drop_Off_Control
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0Bypass_Drop_Off_Control@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0Bypass_Drop_Off_Control@@QAE@XZ PROC			; Bypass_Drop_Off_Control::Bypass_Drop_Off_Control, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7Bypass_Drop_Off_Control@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0Bypass_Drop_Off_Control@@QAE@XZ ENDP			; Bypass_Drop_Off_Control::Bypass_Drop_Off_Control
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ?Timer_Expired@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_TransportPreset$1 = -24				; size = 4
_FakeHarnessPreset$2 = -20				; size = 4
_HarnessPreset$3 = -16					; size = 4
_TransbonePreset$4 = -12				; size = 4
_Vehicle$5 = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_number$ = 12						; size = 4
?Timer_Expired@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@H@Z PROC ; Bypass_Drop_Off_Control::Timer_Expired, COMDAT
; _this$ = ecx
...
; 146  : 	{
; 147  : 		GameObject *Vehicle = Commands->Find_Object(vehicle_id);
	...
	call	eax
	add	esp, 4
	mov	DWORD PTR _Vehicle$5[ebp], eax

; 148  : 		if(Vehicle)

	cmp	DWORD PTR _Vehicle$5[ebp], 0
	je	SHORT $LN9@Timer_Expi

; 149  : 		{
; 150  : 			Commands->Attach_To_Object_Bone(Commands->Find_Object(vehicle_id), 0, 0);
...
; 151  : 			if(Vehicle->As_VehicleGameObj())

	mov	eax, DWORD PTR _Vehicle$5[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _Vehicle$5[ebp]
...
; 154  : 				{
; 155  : 					Commands->Set_Is_Visible(Vehicle,true);
...
; 160  : 	else if(number == 2)

	cmp	DWORD PTR _number$[ebp], 2
	jne	$LN11@Timer_Expi

; 161  : 	{
; 162  : 		GameObject *TransbonePreset = Commands->Find_Object(transbone_id);
	...
	call	eax
	add	esp, 4
	mov	DWORD PTR _TransbonePreset$4[ebp], eax

; 163  : 
; 164  : 		if(TransbonePreset) Commands->Destroy_Object(TransbonePreset);

	cmp	DWORD PTR _TransbonePreset$4[ebp], 0
	je	SHORT $LN4@Timer_Expi
	mov	eax, DWORD PTR _TransbonePreset$4[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 165  : 
; 166  : 		GameObject *HarnessPreset = Commands->Find_Object(vehharness_id);
	...
	call	eax
	add	esp, 4
	mov	DWORD PTR _HarnessPreset$3[ebp], eax

; 167  : 
; 168  : 		if(HarnessPreset) Commands->Destroy_Object(HarnessPreset);

	cmp	DWORD PTR _HarnessPreset$3[ebp], 0
	je	SHORT $LN3@Timer_Expi
	mov	eax, DWORD PTR _HarnessPreset$3[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+92]
	call	edx
...
; 169  : 
; 170  : 		GameObject *FakeHarnessPreset = Commands->Find_Object(fakeharness_id);
	...
	call	eax
	add	esp, 4
	mov	DWORD PTR _FakeHarnessPreset$2[ebp], eax

; 171  : 
; 172  : 		if(FakeHarnessPreset) Commands->Destroy_Object(FakeHarnessPreset);

	cmp	DWORD PTR _FakeHarnessPreset$2[ebp], 0
	je	SHORT $LN2@Timer_Expi
	mov	eax, DWORD PTR _FakeHarnessPreset$2[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+92]
	call	edx
...
; 173  : 
; 174  : 		GameObject *TransportPreset = Commands->Find_Object(trans_id);
	...
	call	eax
	add	esp, 4
	mov	DWORD PTR _TransportPreset$1[ebp], eax

; 175  : 
; 176  : 		if(TransportPreset) Commands->Destroy_Object(TransportPreset);

	cmp	DWORD PTR _TransportPreset$1[ebp], 0
	je	SHORT $LN1@Timer_Expi
	mov	eax, DWORD PTR _TransportPreset$1[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+92]
	call	edx
...
; 181  : }
	...
	pop	ebp
	ret	8
?Timer_Expired@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@H@Z ENDP ; Bypass_Drop_Off_Control::Timer_Expired
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ?Created@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv135 = -124						; size = 4
$T1 = -120						; size = 12
_fakeharness$2 = -44					; size = 4
_vehharness$3 = -40					; size = 4
_trans$4 = -36						; size = 4
_transbone$5 = -32					; size = 4
_pos$6 = -28						; size = 12
_Team$7 = -16						; size = 4
_vehicle$ = -12						; size = 4
_ID$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@@Z PROC ; Bypass_Drop_Off_Control::Created, COMDAT
; _this$ = ecx
...
; 87   : 
; 88   : 
; 89   : 	//SignalFlare_Gold_Phys3
; 90   : 	invisible = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+48], 0

; 91   : 	int ID = Get_Int_Parameter("ID");
...
; 92   : 	GameObject* vehicle = Commands->Find_Object(ID);
...
; 94   : 	{
; 95   : 		int Team = Get_Object_Type(vehicle);
...
; 96   : 		Vector3 pos = Commands->Get_Position(obj);
...
; 97   : 	
; 98   : 		GameObject *transbone = Commands->Create_Object("Generic_Cinematic", pos);

	lea	eax, DWORD PTR _pos$6[ebp]
	push	eax
	push	OFFSET ??_C@_0BC@HOIKKGNK@Generic_Cinematic?$AA@
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+100]
	call	edx
	add	esp, 8
	mov	DWORD PTR _transbone$5[ebp], eax

; 99   : 		Commands->Set_Model(transbone, "XG_TransprtBone");

	push	OFFSET ??_C@_0BA@ECNCKCNL@XG_TransprtBone?$AA@
	mov	eax, DWORD PTR _transbone$5[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 100  : 		Commands->Set_Animation(transbone, "XG_TransprtBone.XG_HD_TTraj", false, "", 2.0, -1.0, false);
	...
	push	0
	push	OFFSET ??_C@_0BM@LLIBMBBB@XG_TransprtBone?4XG_HD_TTraj?$AA@
	mov	eax, DWORD PTR _transbone$5[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 101  : 
; 102  : 		GameObject *trans = Commands->Create_Object_At_Bone(transbone, Team == 1 ? "GDI_Transport_Helicopter" : "Nod_Transport_Helicopter", "BN_Trajectory");

	cmp	DWORD PTR _Team$7[ebp], 1
	jne	SHORT $LN7@Created
	mov	DWORD PTR tv135[ebp], OFFSET ??_C@_0BJ@FEBFBIF@GDI_Transport_Helicopter?$AA@
	jmp	SHORT $LN8@Created
$LN7@Created:
	mov	DWORD PTR tv135[ebp], OFFSET ??_C@_0BJ@GBHHDNCJ@Nod_Transport_Helicopter?$AA@
$LN8@Created:
	push	OFFSET ??_C@_0O@CGIOPOPI@BN_Trajectory?$AA@
	mov	eax, DWORD PTR tv135[ebp]
	push	eax
	mov	ecx, DWORD PTR _transbone$5[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	eax, DWORD PTR [edx+104]
	call	eax
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _trans$4[ebp], eax

; 103  : 
; 104  : 		Commands->Set_Animation(trans, "v_Nod_Trnspt.v_Nod_Trnspt", true, "", 2.0, -1.0, false);
	...
	push	OFFSET ??_C@_00CNPNBAHC@?$AA@
	push	1
	push	OFFSET ??_C@_0BK@PAHFALDP@v_Nod_Trnspt?4v_Nod_Trnspt?$AA@
	mov	eax, DWORD PTR _trans$4[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+164]
	call	edx
...
; 105  : 		//Set_Vehicle_Is_Visible(trans, false);
; 106  : 		Commands->Set_Shield_Type(trans,"Blamo");
...
; 107  : 		Commands->Attach_To_Object_Bone(trans, transbone, "BN_Trajectory");

	push	OFFSET ??_C@_0O@CGIOPOPI@BN_Trajectory?$AA@
	mov	eax, DWORD PTR _transbone$5[ebp]
	push	eax
	mov	ecx, DWORD PTR _trans$4[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 108  :  
; 109  : 		GameObject *vehharness = Commands->Create_Object("Generic_Cinematic", pos);
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _vehharness$3[ebp], eax

; 110  : 		Commands->Set_Model(vehharness, "XG_HD_HTraj");

	push	OFFSET ??_C@_0M@CNJIJLLK@XG_HD_HTraj?$AA@
	mov	eax, DWORD PTR _vehharness$3[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+160]
	call	edx
...
; 111  : 		Commands->Set_Animation(vehharness, "XG_HD_HTraj.XG_HD_HTraj", false, "", 2.0, -1.0, false);
	...
	push	OFFSET ??_C@_00CNPNBAHC@?$AA@
	push	0
	push	OFFSET ??_C@_0BI@CFAHIPBD@XG_HD_HTraj?4XG_HD_HTraj?$AA@
	mov	eax, DWORD PTR _vehharness$3[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+164]
...
; 112  :  
; 113  : 		GameObject *fakeharness = Commands->Create_Object("Generic_Cinematic", pos);
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _fakeharness$2[ebp], eax

; 114  : 		Commands->Set_Model(fakeharness, "XG_HD_Harness");

	push	OFFSET ??_C@_0O@LDKNACI@XG_HD_Harness?$AA@
	mov	eax, DWORD PTR _fakeharness$2[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+160]
	call	edx
...
; 115  : 		Commands->Set_Animation(fakeharness, "XG_HD_Harness.XG_HD_Harness", false, "", 2.0, -1.0, false);
	...
	push	OFFSET ??_C@_00CNPNBAHC@?$AA@
	push	0
	push	OFFSET ??_C@_0BM@MKCKFNFC@XG_HD_Harness?4XG_HD_Harness?$AA@
	mov	eax, DWORD PTR _fakeharness$2[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+164]
...
; 116  : 
; 117  : 		Set_Object_Type(vehicle, Team);
...
; 118  : 		if(vehicle->As_VehicleGameObj())
...
; 119  : 		{
; 120  : 			if(vehicle->As_VehicleGameObj()->Get_Is_Scripts_Visible())
	...
	call	eax
	mov	ecx, eax
	call	?Get_Is_Scripts_Visible@VehicleGameObj@@QAE_NXZ ; VehicleGameObj::Get_Is_Scripts_Visible
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN2@Created

; 121  : 			{
; 122  : 				Commands->Set_Is_Visible(vehicle, false);
...
; 128  : 			}
; 129  : 		}
; 130  : 		Commands->Attach_To_Object_Bone(vehicle, vehharness, "BN_Trajectory");
...
; 131  :  
; 132  : 		transbone_id = Commands->Get_ID(transbone);
...
; 133  : 		trans_id = Commands->Get_ID(trans);
...
; 134  : 		vehharness_id = Commands->Get_ID(vehharness);
...
; 135  : 		vehicle_id = Commands->Get_ID(vehicle);
...
; 136  : 		fakeharness_id = Commands->Get_ID(fakeharness);
...
; 137  :  
; 138  : 		Commands->Start_Timer(obj, this, 14.2f, 1);

	push	1
	push	ecx
	movss	xmm0, DWORD PTR __real@41633333
	movss	DWORD PTR [esp], xmm0
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
...
; 139  : 		Commands->Start_Timer(obj, this, 30, 2);
...
; 141  : }
	...
	pop	ebp
	ret	4
?Created@Bypass_Drop_Off_Control@@EAEXPAVScriptableGameObj@@@Z ENDP ; Bypass_Drop_Off_Control::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDB_Check_Airdrop_Registrant@@YAXXZ
text$yd	SEGMENT
??__FDB_Check_Airdrop_Registrant@@YAXXZ PROC		; `dynamic atexit destructor for 'DB_Check_Airdrop_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DB_Check_Airdrop_Registrant@@3V?$ScriptRegistrant@VDB_Check_Airdrop@@@@A ; DB_Check_Airdrop_Registrant
	call	??1?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDB_Check_Airdrop_Registrant@@YAXXZ ENDP		; `dynamic atexit destructor for 'DB_Check_Airdrop_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ??__EDB_Check_Airdrop_Registrant@@YAXXZ
text$yc	SEGMENT
??__EDB_Check_Airdrop_Registrant@@YAXXZ PROC		; `dynamic initializer for 'DB_Check_Airdrop_Registrant'', COMDAT

; 71   : ScriptRegistrant<DB_Check_Airdrop> DB_Check_Airdrop_Registrant("DB_Check_Airdrop","ArrowID:int");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0M@LPKOJAMC@ArrowID?3int?$AA@
	push	OFFSET ??_C@_0BB@IDFBNCKJ@DB_Check_Airdrop?$AA@
	mov	ecx, OFFSET ?DB_Check_Airdrop_Registrant@@3V?$ScriptRegistrant@VDB_Check_Airdrop@@@@A ; DB_Check_Airdrop_Registrant
	call	??0?$ScriptRegistrant@VDB_Check_Airdrop@@@@QAE@PBD0@Z ; ScriptRegistrant<DB_Check_Airdrop>::ScriptRegistrant<DB_Check_Airdrop>
	push	OFFSET ??__FDB_Check_Airdrop_Registrant@@YAXXZ ; `dynamic atexit destructor for 'DB_Check_Airdrop_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDB_Check_Airdrop_Registrant@@YAXXZ ENDP		; `dynamic initializer for 'DB_Check_Airdrop_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAXI@Z PROC ; ScriptRegistrant<DB_Check_Airdrop>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<DB_Check_Airdrop>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAE@XZ PROC	; ScriptRegistrant<DB_Check_Airdrop>::~ScriptRegistrant<DB_Check_Airdrop>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAE@XZ ENDP	; ScriptRegistrant<DB_Check_Airdrop>::~ScriptRegistrant<DB_Check_Airdrop>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<DB_Check_Airdrop>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DB@IDJHOOLF@ScriptRegistrant?$DMclass?5DB_Check_@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VDB_Check_Airdrop@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<DB_Check_Airdrop>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VDB_Check_Airdrop@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VDB_Check_Airdrop@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<DB_Check_Airdrop>::ScriptRegistrant<DB_Check_Airdrop>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VDB_Check_Airdrop@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VDB_Check_Airdrop@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<DB_Check_Airdrop>::ScriptRegistrant<DB_Check_Airdrop>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ
text$yd	SEGMENT
??__FDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ PROC ; `dynamic atexit destructor for 'DB_CinematicVehicleFactoryBypass_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DB_CinematicVehicleFactoryBypass_Registrant@@3V?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@A ; DB_CinematicVehicleFactoryBypass_Registrant
	call	??1?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ ENDP ; `dynamic atexit destructor for 'DB_CinematicVehicleFactoryBypass_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ??__EDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ
text$yc	SEGMENT
??__EDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ PROC ; `dynamic initializer for 'DB_CinematicVehicleFactoryBypass_Registrant'', COMDAT

; 70   : ScriptRegistrant<DB_CinematicVehicleFactoryBypass> DB_CinematicVehicleFactoryBypass_Registrant("DB_CinematicVehicleFactoryBypass","PresetName:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0BC@BEFKOJOJ@PresetName?3string?$AA@
	push	OFFSET ??_C@_0CB@EFFGNNNN@DB_CinematicVehicleFactoryBypass@
	mov	ecx, OFFSET ?DB_CinematicVehicleFactoryBypass_Registrant@@3V?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@A ; DB_CinematicVehicleFactoryBypass_Registrant
	call	??0?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::ScriptRegistrant<DB_CinematicVehicleFactoryBypass>
	push	OFFSET ??__FDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ ; `dynamic atexit destructor for 'DB_CinematicVehicleFactoryBypass_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDB_CinematicVehicleFactoryBypass_Registrant@@YAXXZ ENDP ; `dynamic initializer for 'DB_CinematicVehicleFactoryBypass_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z PROC ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAE@XZ PROC ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::~ScriptRegistrant<DB_CinematicVehicleFactoryBypass>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAE@XZ ENDP ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::~ScriptRegistrant<DB_CinematicVehicleFactoryBypass>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0EB@BOOGPFKJ@ScriptRegistrant?$DMclass?5DB_Cinema@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0DB_CinematicVehicleFactoryBypass@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::ScriptRegistrant<DB_CinematicVehicleFactoryBypass>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VDB_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<DB_CinematicVehicleFactoryBypass>::ScriptRegistrant<DB_CinematicVehicleFactoryBypass>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GDB_Check_Airdrop@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDB_Check_Airdrop@@UAEPAXI@Z PROC			; DB_Check_Airdrop::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GDB_Check_Airdrop@@UAEPAXI@Z ENDP			; DB_Check_Airdrop::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1DB_Check_Airdrop@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DB_Check_Airdrop@@UAE@XZ PROC			; DB_Check_Airdrop::~DB_Check_Airdrop, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1DB_Check_Airdrop@@UAE@XZ ENDP			; DB_Check_Airdrop::~DB_Check_Airdrop
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0DB_Check_Airdrop@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DB_Check_Airdrop@@QAE@XZ PROC			; DB_Check_Airdrop::DB_Check_Airdrop, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DB_Check_Airdrop@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0DB_Check_Airdrop@@QAE@XZ ENDP			; DB_Check_Airdrop::DB_Check_Airdrop
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ?Timer_Expired@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
$T1 = -84						; size = 12
_DavesArrow$2 = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_Number$ = 12						; size = 4
?Timer_Expired@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@H@Z PROC ; DB_Check_Airdrop::Timer_Expired, COMDAT
; _this$ = ecx
...
; 55   : 		if(Number == 12)
	...
	cmp	DWORD PTR _Number$[ebp], 12		; 0000000cH
	jne	$LN1@Timer_Expi

; 56   : 		{
; 57   : 			if(obj->As_VehicleGameObj()->Get_Lock_Owner() && Commands->Get_Player_Type(obj->As_VehicleGameObj()->Get_Lock_Owner()) == 1 && !obj->Find_Observer("DAAirDroppedVehicleObserverClass"))
	...
	cmp	eax, 1
	jne	$LN1@Timer_Expi
	push	OFFSET ??_C@_0CB@DDNLOMJF@DAAirDroppedVehicleObserverClass@
	mov	ecx, DWORD PTR _obj$[ebp]
...
; 58   : 			{
; 59   : 				GameObject *DavesArrow = Commands->Find_Object(Get_Int_Parameter("ArrowID"));

	push	OFFSET ??_C@_07EECDMLNK@ArrowID?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	push	eax
	...
	call	ecx
	add	esp, 4
	mov	DWORD PTR _DavesArrow$2[ebp], eax

; 60   : 				if(DavesArrow)

	cmp	DWORD PTR _DavesArrow$2[ebp], 0
	je	SHORT $LN1@Timer_Expi

; 61   : 				{
; 62   : 					Send_Message_Player(obj->As_VehicleGameObj()->Get_Lock_Owner(),150,150,255,"Your Vehicle will be Airdropped nearby.");

	push	OFFSET ??_C@_0CI@BJNFBMCE@Your?5Vehicle?5will?5be?5Airdropped?5@
	push	255					; 000000ffH
	push	150					; 00000096H
	push	150					; 00000096H
	mov	eax, DWORD PTR _obj$[ebp]
...
; 63   : 					Bypass_Drop_Off(Commands->Get_Position(DavesArrow),Commands->Get_Facing(DavesArrow),obj);

	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	mov	ecx, DWORD PTR _DavesArrow$2[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	...
	push	eax
	call	??0Vector3@@QAE@ABV0@@Z			; Vector3::Vector3
	call	?Bypass_Drop_Off@@YAXVVector3@@MPAVScriptableGameObj@@@Z ; Bypass_Drop_Off
	add	esp, 20					; 00000014H
$LN1@Timer_Expi:
...
; 67   : 	}
	...
	pop	ebp
	ret	8
?Timer_Expired@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@H@Z ENDP ; DB_Check_Airdrop::Timer_Expired
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ?Created@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@@Z PROC ; DB_Check_Airdrop::Created, COMDAT
; _this$ = ecx
...
; 50   : 		Commands->Start_Timer(obj,this,0.0f,12);
...
; 51   : 	}
	...
	pop	ebp
	ret	4
?Created@DB_Check_Airdrop@@EAEXPAVScriptableGameObj@@@Z ENDP ; DB_Check_Airdrop::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GDB_CinematicVehicleFactoryBypass@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDB_CinematicVehicleFactoryBypass@@UAEPAXI@Z PROC	; DB_CinematicVehicleFactoryBypass::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1DB_CinematicVehicleFactoryBypass@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GDB_CinematicVehicleFactoryBypass@@UAEPAXI@Z ENDP	; DB_CinematicVehicleFactoryBypass::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1DB_CinematicVehicleFactoryBypass@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DB_CinematicVehicleFactoryBypass@@UAE@XZ PROC	; DB_CinematicVehicleFactoryBypass::~DB_CinematicVehicleFactoryBypass, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1DB_CinematicVehicleFactoryBypass@@UAE@XZ ENDP	; DB_CinematicVehicleFactoryBypass::~DB_CinematicVehicleFactoryBypass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0DB_CinematicVehicleFactoryBypass@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DB_CinematicVehicleFactoryBypass@@QAE@XZ PROC	; DB_CinematicVehicleFactoryBypass::DB_CinematicVehicleFactoryBypass, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DB_CinematicVehicleFactoryBypass@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0DB_CinematicVehicleFactoryBypass@@QAE@XZ ENDP	; DB_CinematicVehicleFactoryBypass::DB_CinematicVehicleFactoryBypass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ?ObjectCreateHook@DB_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv86 = -88						; size = 4
tv164 = -84						; size = 4
tv159 = -78						; size = 1
...
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?ObjectCreateHook@DB_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z PROC ; DB_CinematicVehicleFactoryBypass::ObjectCreateHook, COMDAT
; _this$ = ecx
...
; 36   : 		{
; 37   : 			if(strcmp(Commands->Get_Preset_Name(obj),Get_Parameter("PresetName")) == 0)
...
$LL5@ObjectCrea:
	...
	cmp	cl, BYTE PTR [edx]
	jne	SHORT $LN6@ObjectCrea
	cmp	BYTE PTR tv152[ebp], 0
	je	SHORT $LN7@ObjectCrea
	mov	eax, DWORD PTR tv148[ebp]
	...
	jne	SHORT $LN6@ObjectCrea
	add	DWORD PTR tv148[ebp], 2
	add	DWORD PTR tv149[ebp], 2
	cmp	BYTE PTR tv159[ebp], 0
	jne	SHORT $LL5@ObjectCrea
$LN7@ObjectCrea:
	mov	DWORD PTR tv164[ebp], 0
	jmp	SHORT $LN8@ObjectCrea
$LN6@ObjectCrea:
	sbb	eax, eax
	or	eax, 1
...
$LN8@ObjectCrea:
	...
	jne	SHORT $LN3@ObjectCrea

; 38   : 			{
; 39   : 				{
; 40   : 					Attach_Script_Once_V(obj,"DB_Check_Airdrop","%i",Owner()->Get_ID());
...
; 45   : 	}
	...
	pop	ebp
	ret	4
?ObjectCreateHook@DB_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z ENDP ; DB_CinematicVehicleFactoryBypass::ObjectCreateHook
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dbvehiclebypass.cpp
;	COMDAT ?Bypass_Drop_Off@@YAXVVector3@@MPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -72						; size = 4
_Drop$ = -4						; size = 4
_Location$ = 8						; size = 12
_Facing$ = 20						; size = 4
_dropObj$ = 24						; size = 4
?Bypass_Drop_Off@@YAXVVector3@@MPAVScriptableGameObj@@@Z PROC ; Bypass_Drop_Off, COMDAT
...
; 23   : 	Location.Z += 1;
	...
	movss	xmm0, DWORD PTR _Location$[ebp+8]
	addss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR _Location$[ebp+8], xmm0

; 24   : 
; 25   : 	GameObject *Drop = Commands->Create_Object("invisible_object", Location);

	lea	eax, DWORD PTR _Location$[ebp]
	push	eax
	push	OFFSET ??_C@_0BB@DGIDEDNE@invisible_object?$AA@
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+100]
	call	edx
	add	esp, 8
...
; 26   : 	Commands->Set_Facing(Drop,Facing);

	push	ecx
	movss	xmm0, DWORD PTR _Facing$[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	eax, DWORD PTR _Drop$[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 27   : 	Commands->Attach_Script(Drop,"Bypass_Drop_Off_Control",StringClass::getFormattedString("%i",dropObj->Get_ID()));

	mov	ecx, DWORD PTR _dropObj$[ebp]
	call	?Get_ID@BaseGameObj@@QBEHXZ		; BaseGameObj::Get_ID
	push	eax
	push	OFFSET ??_C@_02IKAHHCAI@?$CFi?$AA@
...
; 28   : }
	...
	pop	ebp
	ret	0
?Bypass_Drop_Off@@YAXVVector3@@MPAVScriptableGameObj@@@Z ENDP ; Bypass_Drop_Off
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vehiclegameobj.h
;	COMDAT ?Get_Is_Scripts_Visible@VehicleGameObj@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Is_Scripts_Visible@VehicleGameObj@@QAE_NXZ PROC	; VehicleGameObj::Get_Is_Scripts_Visible, COMDAT
; _this$ = ecx

; 125  : 	bool Get_Is_Scripts_Visible() {return visible;}
	...
	pop	ebp
	ret	0
?Get_Is_Scripts_Visible@VehicleGameObj@@QAE_NXZ ENDP	; VehicleGameObj::Get_Is_Scripts_Visible
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vehiclegameobj.h
