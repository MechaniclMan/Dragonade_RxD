; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\matrix4.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Multiply@Matrix4@@SAXABV1@0PAV1@@Z		; Matrix4::Multiply
PUBLIC	?Multiply@Matrix4@@SAXABVMatrix3D@@ABV1@PAV1@@Z	; Matrix4::Multiply
PUBLIC	?Multiply@Matrix4@@SAXABV1@ABVMatrix3D@@PAV1@@Z	; Matrix4::Multiply
...
PUBLIC	?ReflectPlane@Matrix4@@SA?AV1@ABVPlaneClass@@@Z	; Matrix4::ReflectPlane
PUBLIC	?IDENTITY@Matrix4@@2V1@B			; Matrix4::IDENTITY
...
_BSS	SEGMENT
?IDENTITY@Matrix4@@2V1@B DB 040H DUP (?)		; Matrix4::IDENTITY
_BSS	ENDS
CRT$XCU	SEGMENT
?IDENTITY$initializer$@Matrix4@@2P6AXXZA DD FLAT:??__E?IDENTITY@Matrix4@@2V1@B@@YAXXZ ; Matrix4::IDENTITY$initializer$
CRT$XCU	ENDS
...
; File x:\github\renegade\dragonade_rxd\scripts\matrix4.cpp
;	COMDAT ??__E?IDENTITY@Matrix4@@2V1@B@@YAXXZ
text$yc	SEGMENT
$T1 = -128						; size = 16
$T2 = -112						; size = 16
$T3 = -96						; size = 16
$T4 = -80						; size = 16
??__E?IDENTITY@Matrix4@@2V1@B@@YAXXZ PROC		; `dynamic initializer for 'Matrix4::IDENTITY'', COMDAT
...
; 19   : 										  Vector4(0,0,0,1));
	...
	call	??0Vector4@@QAE@MMMM@Z			; Vector4::Vector4
	push	eax
	mov	ecx, OFFSET ?IDENTITY@Matrix4@@2V1@B	; Matrix4::IDENTITY
	...
	pop	ebp
	ret	0
??__E?IDENTITY@Matrix4@@2V1@B@@YAXXZ ENDP		; `dynamic initializer for 'Matrix4::IDENTITY''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\matrix4.cpp
;	COMDAT ?ReflectPlane@Matrix4@@SA?AV1@ABVPlaneClass@@@Z
_TEXT	SEGMENT
tv298 = -148						; size = 4
tv296 = -148						; size = 4
tv294 = -148						; size = 4
...
__plane$ = 12						; size = 4
?ReflectPlane@Matrix4@@SA?AV1@ABVPlaneClass@@@Z PROC	; Matrix4::ReflectPlane, COMDAT
...
; 93   : 	temp[0][0] = -2 * plane.N.X * plane.N.X + 1;	temp[0][1] = -2 * plane.N.Y * plane.N.X;		temp[0][2] = -2 * plane.N.Z * plane.N.X;		temp[0][3] = 0;
	...
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
...
; 94   : 	temp[1][0] = -2 * plane.N.X * plane.N.Y;		temp[1][1] = -2 * plane.N.Y * plane.N.Y + 1;	temp[1][2] = -2 * plane.N.Z * plane.N.Y;		temp[1][3] = 0;
...
; 95   : 	temp[2][0] = -2 * plane.N.X * plane.N.Z;		temp[2][1] = -2 * plane.N.Y * plane.N.Z;		temp[2][2] = -2 * plane.N.Z * plane.N.Z + 1;	temp[2][3] = 0;
...
; 96   : 	temp[3][0] = -2 * plane.N.X * plane.D;			temp[3][1] = -2 * plane.N.Y * plane.D;			temp[3][2] = -2 * plane.N.Z * plane.D;			temp[3][3] = 1;
...
; 98   : };
	...
	pop	ebp
	ret	0
?ReflectPlane@Matrix4@@SA?AV1@ABVPlaneClass@@@Z ENDP	; Matrix4::ReflectPlane
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\matrix4.cpp
;	COMDAT ?Multiply@Matrix4@@SAXABV1@ABVMatrix3D@@PAV1@@Z
_TEXT	SEGMENT
tv1258 = -80						; size = 4
tv1232 = -80						; size = 4
tv1206 = -80						; size = 4
...
_b$ = 12						; size = 4
_res$ = 16						; size = 4
?Multiply@Matrix4@@SAXABV1@ABVMatrix3D@@PAV1@@Z PROC	; Matrix4::Multiply, COMDAT
...
; 66   : 	#define ROWCOL(i,j) a[i][0]*b[0][j] + a[i][1]*b[1][j] + a[i][2]*b[2][j]
; 67   : 	#define ROWCOL4(i,j) a[i][0]*b[0][j] + a[i][1]*b[1][j] + a[i][2]*b[2][j] + a[i][3]
; 68   : 	(*res)[0][0] = ROWCOL(0,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1158[ebp]
	addss	xmm1, xmm0
	push	0
	push	0
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1160[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 69   : 	(*res)[0][1] = ROWCOL(0,1);
	...
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1162[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1162[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1164[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 70   : 	(*res)[0][2] = ROWCOL(0,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1168[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1170[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1172[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1172[ebp]
	movss	DWORD PTR [eax], xmm0

; 71   : 	(*res)[0][3] = ROWCOL4(0,3);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1174[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1176[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1176[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	...
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1180[ebp]
	movss	DWORD PTR [eax], xmm0

; 72   : 	(*res)[1][0] = ROWCOL(1,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1182[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1184[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1184[ebp]
	addss	xmm1, xmm0
	push	0
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
...
; 73   : 	(*res)[1][1] = ROWCOL(1,1);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1190[ebp]
	addss	xmm1, xmm0
	push	1
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1192[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 74   : 	(*res)[1][2] = ROWCOL(1,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1194[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1196[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 75   : 	(*res)[1][3] = ROWCOL4(1,3);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1200[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1202[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1202[ebp]
	addss	xmm1, xmm0
	push	3
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1204[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	...
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1206[ebp], xmm0
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 76   : 	(*res)[2][0] = ROWCOL(2,0);
	...
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1208[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1208[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1210[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1210[ebp]
	addss	xmm1, xmm0
	push	0
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1212[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 77   : 	(*res)[2][1] = ROWCOL(2,1);
	...
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1214[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1214[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1216[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1216[ebp]
	addss	xmm1, xmm0
	push	1
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1218[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 78   : 	(*res)[2][2] = ROWCOL(2,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1220[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1222[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1222[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1224[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 79   : 	(*res)[2][3] = ROWCOL4(2,3);
	...
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1226[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1226[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1228[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1228[ebp]
	addss	xmm1, xmm0
	push	3
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1230[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	...
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1232[ebp], xmm0
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 80   : 	(*res)[3][0] = ROWCOL(3,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1234[ebp]
	addss	xmm1, xmm0
	push	2
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1236[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1236[ebp]
	addss	xmm1, xmm0
	push	0
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1238[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 81   : 	(*res)[3][1] = ROWCOL(3,1);
	...
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1240[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1240[ebp]
	addss	xmm1, xmm0
	push	2
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1242[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1242[ebp]
	addss	xmm1, xmm0
	push	1
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1244[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1244[ebp]
	movss	DWORD PTR [eax], xmm0

; 82   : 	(*res)[3][2] = ROWCOL(3,2);
	...
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1246[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1246[ebp]
	addss	xmm1, xmm0
	push	2
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1248[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1248[ebp]
	addss	xmm1, xmm0
	push	2
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1250[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 83   : 	(*res)[3][3] = ROWCOL4(3,3);
	...
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1252[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1252[ebp]
	addss	xmm1, xmm0
	push	2
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1254[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1254[ebp]
	addss	xmm1, xmm0
	push	3
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1256[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
...
; 86   : }
	...
	pop	ebp
	ret	0
?Multiply@Matrix4@@SAXABV1@ABVMatrix3D@@PAV1@@Z ENDP	; Matrix4::Multiply
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\matrix4.cpp
;	COMDAT ?Multiply@Matrix4@@SAXABVMatrix3D@@ABV1@PAV1@@Z
_TEXT	SEGMENT
tv1254 = -80						; size = 4
tv1246 = -80						; size = 4
tv1238 = -80						; size = 4
...
_b$ = 12						; size = 4
_res$ = 16						; size = 4
?Multiply@Matrix4@@SAXABVMatrix3D@@ABV1@PAV1@@Z PROC	; Matrix4::Multiply, COMDAT
...
; 45   : 	#define ROWCOL(i,j) a[i][0]*b[0][j] + a[i][1]*b[1][j] + a[i][2]*b[2][j] + a[i][3]*b[3][j]
; 46   : 	(*res)[0][0] = ROWCOL(0,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1160[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
...
; 48   : 	(*res)[0][2] = ROWCOL(0,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1178[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1180[ebp], xmm1
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 49   : 	(*res)[0][3] = ROWCOL(0,3);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1186[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1188[ebp], xmm1
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 50   : 	(*res)[1][0] = ROWCOL(1,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1192[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
...
; 51   : 	(*res)[1][1] = ROWCOL(1,1);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1204[ebp]
	addss	xmm1, xmm0
	push	1
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1206[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1206[ebp]
...
; 52   : 	(*res)[1][2] = ROWCOL(1,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1212[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1214[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1214[ebp]
	movss	DWORD PTR [eax], xmm0

; 53   : 	(*res)[1][3] = ROWCOL(1,3);
	...
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1216[ebp], xmm0
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1218[ebp]
	addss	xmm1, xmm0
	push	3
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1220[ebp], xmm1
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 54   : 	(*res)[2][0] = ROWCOL(2,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1224[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1226[ebp], xmm1
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 55   : 	(*res)[2][1] = ROWCOL(2,1);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1232[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1234[ebp], xmm1
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
...
; 56   : 	(*res)[2][2] = ROWCOL(2,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1244[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1246[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 57   : 	(*res)[2][3] = ROWCOL(2,3);
	...
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1248[ebp], xmm0
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1250[ebp]
	addss	xmm1, xmm0
	push	3
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1252[ebp], xmm1
	call	??AMatrix3D@@QBEABVVector4@@H@Z		; Matrix3D::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1254[ebp]
	movss	DWORD PTR [eax], xmm0
...
; 63   : }
	...
	pop	ebp
	ret	0
?Multiply@Matrix4@@SAXABVMatrix3D@@ABV1@PAV1@@Z ENDP	; Matrix4::Multiply
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\matrix4.cpp
;	COMDAT ?Multiply@Matrix4@@SAXABV1@0PAV1@@Z
_TEXT	SEGMENT
tv1550 = -80						; size = 4
tv1542 = -80						; size = 4
tv1534 = -80						; size = 4
...
_b$ = 12						; size = 4
_res$ = 16						; size = 4
?Multiply@Matrix4@@SAXABV1@0PAV1@@Z PROC		; Matrix4::Multiply, COMDAT
...
; 24   : 	#define ROWCOL(i,j) a[i][0]*b[0][j] + a[i][1]*b[1][j] + a[i][2]*b[2][j] + a[i][3]*b[3][j]
; 25   : 	(*res)[0][0] = ROWCOL(0,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1424[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1426[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1426[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1428[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1428[ebp]
	addss	xmm1, xmm0
	push	0
	push	0
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1430[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1430[ebp]
	movss	DWORD PTR [eax], xmm0

; 26   : 	(*res)[0][1] = ROWCOL(0,1);
	...
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1432[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1432[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1434[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1434[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1436[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1436[ebp]
	addss	xmm1, xmm0
	push	1
	push	0
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1438[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 27   : 	(*res)[0][2] = ROWCOL(0,2);
	...
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1440[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1440[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1442[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1442[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1444[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1444[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1446[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1446[ebp]
	movss	DWORD PTR [eax], xmm0

; 28   : 	(*res)[0][3] = ROWCOL(0,3);
	...
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1448[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1448[ebp]
	addss	xmm1, xmm0
	push	2
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1450[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1450[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1452[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1452[ebp]
	addss	xmm1, xmm0
	push	3
	push	0
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1454[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1454[ebp]
	movss	DWORD PTR [eax], xmm0

; 29   : 	(*res)[1][0] = ROWCOL(1,0);
	...
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1456[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1456[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1458[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1458[ebp]
	addss	xmm1, xmm0
	push	3
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1460[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1460[ebp]
	addss	xmm1, xmm0
	push	0
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1462[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 30   : 	(*res)[1][1] = ROWCOL(1,1);
	...
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1464[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1464[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1466[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1466[ebp]
	addss	xmm1, xmm0
	push	3
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1468[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1468[ebp]
	addss	xmm1, xmm0
	push	1
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1470[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 31   : 	(*res)[1][2] = ROWCOL(1,2);
	...
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1472[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1472[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1474[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1474[ebp]
	addss	xmm1, xmm0
	push	3
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1476[ebp], xmm1
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1476[ebp]
	addss	xmm1, xmm0
	push	2
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1478[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 32   : 	(*res)[1][3] = ROWCOL(1,3);
	...
	push	1
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1480[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1484[ebp]
	addss	xmm1, xmm0
	push	3
	push	1
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1486[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 33   : 	(*res)[2][0] = ROWCOL(2,0);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1492[ebp]
	addss	xmm1, xmm0
	push	0
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1494[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 34   : 	(*res)[2][1] = ROWCOL(2,1);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1500[ebp]
	addss	xmm1, xmm0
	push	1
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1502[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 35   : 	(*res)[2][2] = ROWCOL(2,2);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1508[ebp]
	addss	xmm1, xmm0
	push	2
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1510[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 36   : 	(*res)[2][3] = ROWCOL(2,3);
	...
	push	2
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1512[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1516[ebp]
	addss	xmm1, xmm0
	push	3
	push	2
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1518[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 37   : 	(*res)[3][0] = ROWCOL(3,0);
	...
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1520[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1524[ebp]
	addss	xmm1, xmm0
	push	0
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1526[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 38   : 	(*res)[3][1] = ROWCOL(3,1);
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1532[ebp]
	addss	xmm1, xmm0
	push	1
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1534[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
...
; 39   : 	(*res)[3][2] = ROWCOL(3,2);
	...
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1536[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1540[ebp]
	addss	xmm1, xmm0
	push	2
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1542[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1542[ebp]
	movss	DWORD PTR [eax], xmm0

; 40   : 	(*res)[3][3] = ROWCOL(3,3);
	...
	push	3
	mov	ecx, DWORD PTR _a$[ebp]
	movss	DWORD PTR tv1544[ebp], xmm0
	call	??AMatrix4@@QBEABVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QBEABMH@Z			; Vector4::operator[]
	mov	esi, eax
	...
	movss	xmm0, DWORD PTR [esi]
	mulss	xmm0, DWORD PTR [eax]
	movss	xmm1, DWORD PTR tv1548[ebp]
	addss	xmm1, xmm0
	push	3
	push	3
	mov	ecx, DWORD PTR _res$[ebp]
	movss	DWORD PTR tv1550[ebp], xmm1
	call	??AMatrix4@@QAEAAVVector4@@H@Z		; Matrix4::operator[]
	mov	ecx, eax
	call	??AVector4@@QAEAAMH@Z			; Vector4::operator[]
	movss	xmm0, DWORD PTR tv1550[ebp]
	movss	DWORD PTR [eax], xmm0
...
; 42   : }
	...
	pop	ebp
	ret	0
?Multiply@Matrix4@@SAXABV1@0PAV1@@Z ENDP		; Matrix4::Multiply
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\matrix4.h
