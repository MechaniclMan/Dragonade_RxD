; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\dllmain.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?wwscripts@@3PAUHINSTANCE__@@A			; wwscripts
PUBLIC	?CreateScript@@3P6APAVScriptClass@@PBD@ZA	; CreateScript
PUBLIC	?DestroyScript@@3P6AXPAVScriptClass@@@ZA	; DestroyScript
PUBLIC	?GetScriptCount@@3P6AHXZA			; GetScriptCount
PUBLIC	?GetScriptName@@3P6APADH@ZA			; GetScriptName
PUBLIC	?GetScriptParamDescription@@3P6APADH@ZA		; GetScriptParamDescription
PUBLIC	?SetRequestDestroyFunc@@3P6AXP6AXPAVScriptClass@@@Z@ZA ; SetRequestDestroyFunc
PUBLIC	?OldCount@@3IA					; OldCount
PUBLIC	?SetScriptCommands@@3P6A_NPAVScriptCommandsClass@@@ZA ; SetScriptCommands
PUBLIC	?tt@@3PAUHINSTANCE__@@A				; tt
_BSS	SEGMENT
?wwscripts@@3PAUHINSTANCE__@@A DD 01H DUP (?)		; wwscripts
?CreateScript@@3P6APAVScriptClass@@PBD@ZA DD 01H DUP (?) ; CreateScript
?DestroyScript@@3P6AXPAVScriptClass@@@ZA DD 01H DUP (?)	; DestroyScript
?GetScriptCount@@3P6AHXZA DD 01H DUP (?)		; GetScriptCount
?GetScriptName@@3P6APADH@ZA DD 01H DUP (?)		; GetScriptName
?GetScriptParamDescription@@3P6APADH@ZA DD 01H DUP (?)	; GetScriptParamDescription
?SetRequestDestroyFunc@@3P6AXP6AXPAVScriptClass@@@Z@ZA DD 01H DUP (?) ; SetRequestDestroyFunc
?OldCount@@3IA DD 01H DUP (?)				; OldCount
?SetScriptCommands@@3P6A_NPAVScriptCommandsClass@@@ZA DD 01H DUP (?) ; SetScriptCommands
?tt@@3PAUHINSTANCE__@@A DD 01H DUP (?)			; tt
_BSS	ENDS
CONST	SEGMENT
...
PUBLIC	_Destroy_Script
PUBLIC	_Get_Script_Count
PUBLIC	_Get_Script_Name
PUBLIC	_Get_Script_Param_Description
...
PUBLIC	??_C@_0DB@KLDDDEO@Error?5getting?5function?5address?5f@ ; `string'
PUBLIC	??_C@_0N@CNHOAEDG@scripts2?4dll?$AA@		; `string'
PUBLIC	??_C@_0M@LIEOGHOI@dllload?4txt?$AA@		; `string'
PUBLIC	??_C@_02CPIDLAI@at?$AA@				; `string'
PUBLIC	??_C@_0DG@IDAKMICH@?$FLscripts2?4dll?$FN?5Module?5not?5found?0@ ; `string'
PUBLIC	??_C@_05NAOIJFC@Error?$AA@			; `string'
PUBLIC	??_C@_0EO@ODMDBBCA@scripts2?4dll?5was?5not?5found?4?5Are?5@ ; `string'
PUBLIC	??_C@_0N@HOEEPKHH@Bandtest?4dll?$AA@		; `string'
PUBLIC	??_C@_0O@MLAMJOAE@Create_Script?$AA@		; `string'
PUBLIC	??_C@_0P@FAMANIPC@Destroy_Script?$AA@		; `string'
PUBLIC	??_C@_0BB@FPCCPBMO@Get_Script_Count?$AA@	; `string'
PUBLIC	??_C@_0BA@JJJPOLJN@Get_Script_Name?$AA@		; `string'
PUBLIC	??_C@_0BN@LOHDBOCD@Get_Script_Param_Description?$AA@ ; `string'
PUBLIC	??_C@_0BE@HENBLHN@Set_Script_Commands?$AA@	; `string'
PUBLIC	??_C@_0BJ@JJJNDFHO@Set_Request_Destroy_Func?$AA@ ; `string'
PUBLIC	?__LINE__Var@?1??DllMain@@9@12@4JA		; `DllMain'::`2'::__LINE__Var
PUBLIC	??_C@_07JLKLLPCJ@DllMain?$AA@			; `string'
PUBLIC	??_C@_0DF@BCGEFFMI@x?3?2github?2renegade?2dragonade_rxd@ ; `string'
PUBLIC	??_C@_1GK@GFIFGELI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@ ; `string'
PUBLIC	??_C@_0CO@NDBPENPI@?$FLscripts2?4dll?$FN?5Failed?5to?5load?0?5?5@ ; `string'
PUBLIC	??_C@_0FA@INGEHCNO@Unfortunately?0?5there?5was?5an?5erro@ ; `string'
PUBLIC	?__LINE__Var@?1??Destroy_Script@@9@4JA		; `Destroy_Script'::`2'::__LINE__Var
...
PUBLIC	??_C@_0O@BNEJLMHD@AddRefillHook?$AA@		; `string'
PUBLIC	??_C@_0BB@EIEGDAAC@AddLoadLevelHook?$AA@	; `string'
PUBLIC	??_C@_0BE@CMNOJHEG@AddPreLoadLevelHook?$AA@	; `string'
PUBLIC	??_C@_0BA@CLNCABAJ@AddGameOverHook?$AA@		; `string'
PUBLIC	??_C@_0N@LENHPPAN@AddThinkHook?$AA@		; `string'
PUBLIC	??_C@_0BC@BBENPMJL@AddPlayerJoinHook?$AA@	; `string'
PUBLIC	??_C@_0N@NAFJFAFI@AddRadioHook?$AA@		; `string'
PUBLIC	??_C@_0BD@DPCHFGLM@AddStockDamageHook?$AA@	; `string'
PUBLIC	??_C@_0BA@BBKLPBME@AddTtDamageHook?$AA@		; `string'
...
PUBLIC	??_C@_0BG@JHNOCNBI@Set_Air_Vehicle_Limit?$AA@	; `string'
PUBLIC	??_C@_0BG@GCIIPEFJ@Get_Air_Vehicle_Limit?$AA@	; `string'
PUBLIC	??_C@_0BI@EPCJNOFE@Set_Naval_Vehicle_Limit?$AA@	; `string'
PUBLIC	??_C@_0BI@FJEEDPDG@Get_Naval_Vehicle_Limit?$AA@	; `string'
...
PUBLIC	??_C@_0P@HNCONIDI@AddLogFileHook?$AA@		; `string'
...
PUBLIC	??_C@_0O@LDKANIHI@SendHUDNumber?$AA@		; `string'
...
PUBLIC	??_C@_0BA@LAAPBNCO@SetExplosionObj?$AA@		; `string'
PUBLIC	??_C@_0BG@MGJKMDNE@Update_Network_Object?$AA@	; `string'
PUBLIC	??_C@_0BN@DBPFKBIP@Update_Network_Object_Player?$AA@ ; `string'
PUBLIC	??_C@_0BB@KODCNLCD@Send_Client_Text?$AA@	; `string'
PUBLIC	??_C@_0BJ@OAFNGCJM@Send_Client_Announcement?$AA@ ; `string'
PUBLIC	??_C@_0BJ@GFFELGGI@Send_Player_Kill_Message?$AA@ ; `string'
PUBLIC	??_C@_0BH@PPDDLNAI@Send_Purchase_Response?$AA@	; `string'
PUBLIC	??_C@_0BA@PAOFDFMO@AddShaderNotify?$AA@		; `string'
PUBLIC	??_C@_0BD@MIJEHJPC@RemoveShaderNotify?$AA@	; `string'
PUBLIC	??_C@_0BC@JAJPDGBP@Do_Objectives_Dlg?$AA@	; `string'
PUBLIC	??_C@_0BB@CKFDLPNI@Set_Player_Limit?$AA@	; `string'
PUBLIC	??_C@_0BB@EOAKABGK@Get_Player_Limit?$AA@	; `string'
PUBLIC	??_C@_0O@KBNEBNDF@Get_Fog_Range?$AA@		; `string'
PUBLIC	??_C@_0BJ@MFMOMIAG@Send_Shader_Param_Player?$AA@ ; `string'
PUBLIC	??_C@_0BC@MPOBLDOO@Send_Shader_Param?$AA@	; `string'
PUBLIC	??_C@_0BN@LINMOLCD@Send_Shader_Param_Obj_Player?$AA@ ; `string'
PUBLIC	??_C@_0BG@BAHDOHNM@Send_Shader_Param_Obj?$AA@	; `string'
PUBLIC	??_C@_0BF@HJGIAIBL@Set_GDI_Soldier_Name?$AA@	; `string'
PUBLIC	??_C@_0BF@CBPBJAJE@Set_Nod_Soldier_Name?$AA@	; `string'
PUBLIC	??_C@_0BF@CAHFBOEM@Get_GDI_Soldier_Name?$AA@	; `string'
PUBLIC	??_C@_0BF@HIOMIGMD@Get_Nod_Soldier_Name?$AA@	; `string'
PUBLIC	??_C@_0P@CIBEDKLK@Get_IP_Address?$AA@		; `string'
PUBLIC	??_C@_0M@BMLEFENB@Get_IP_Port?$AA@		; `string'
PUBLIC	??_C@_06OBMKEHHP@Get_IP?$AA@			; `string'
PUBLIC	??_C@_0O@HGLENABK@Get_Bandwidth?$AA@		; `string'
PUBLIC	??_C@_08MIDJAJFC@Get_Ping?$AA@			; `string'
PUBLIC	??_C@_09BMMJMFDN@Get_Kbits?$AA@			; `string'
PUBLIC	??_C@_0BI@NMNJMHDF@Set_Fog_Override_Player?$AA@	; `string'
PUBLIC	??_C@_0BK@HJOBBNJB@Clear_Fog_Override_Player?$AA@ ; `string'
PUBLIC	??_C@_0BC@JDPJACPF@Display_Game_Hint?$AA@	; `string'
PUBLIC	??_C@_0BI@HBEECHGJ@Display_Game_Hint_Image?$AA@	; `string'
PUBLIC	??_C@_0BE@DPDOKOIN@Set_Current_Bullets?$AA@	; `string'
PUBLIC	??_C@_0BJ@HBIAKGBG@Set_Current_Clip_Bullets?$AA@ ; `string'
PUBLIC	??_C@_0BF@IGNOCPCM@Set_Position_Bullets?$AA@	; `string'
PUBLIC	??_C@_0BK@PFMHAEDP@Set_Position_Clip_Bullets?$AA@ ; `string'
PUBLIC	??_C@_0M@BBALKCKK@Set_Bullets?$AA@		; `string'
PUBLIC	??_C@_0BB@GBBAMEON@Set_Clip_Bullets?$AA@	; `string'
PUBLIC	??_C@_0BC@DOKEIPDP@Set_Moon_Is_Earth?$AA@	; `string'
PUBLIC	??_C@_0P@IFLCBABJ@Get_Mine_Limit?$AA@		; `string'
PUBLIC	??_C@_0BN@HCOBCAKM@Set_Special_Base_Destruction?$AA@ ; `string'
PUBLIC	??_C@_0BD@CIKJLBBI@Get_Client_Version?$AA@	; `string'
PUBLIC	??_C@_0BE@ONCNJJOE@Get_Client_Revision?$AA@	; `string'
PUBLIC	??_C@_0N@KCCFFNCM@Get_Revision?$AA@		; `string'
PUBLIC	??_C@_0BD@OBLOLDMF@Get_Damage_Warhead?$AA@	; `string'
PUBLIC	??_C@_0BI@JIIEILAI@Get_Damage_Is_Explosion?$AA@	; `string'
PUBLIC	??_C@_0BL@CNKGLJFF@Get_GameObj_By_Player_Name?$AA@ ; `string'
PUBLIC	??_C@_0BI@IKKGHMIO@Send_Custom_All_Players?$AA@	; `string'
PUBLIC	??_C@_0BD@OENNAHJF@Steal_Team_Credits?$AA@	; `string'
PUBLIC	??_C@_0BB@GNKDJAPA@Get_Team_Credits?$AA@	; `string'
PUBLIC	??_C@_0BO@CBJGBMHF@addConnectionAcceptanceFilter?$AA@ ; `string'
PUBLIC	??_C@_0CB@CDPLPPFP@removeConnectionAcceptanceFilter@ ; `string'
PUBLIC	??_C@_0M@EEKOFJGB@Is_WOL_User?$AA@		; `string'
PUBLIC	??_C@_0N@DAELDDLM@Evict_Client?$AA@		; `string'
PUBLIC	??_C@_0BG@MGKHICLA@Get_Current_Map_Index?$AA@	; `string'
PUBLIC	??_C@_0BA@LADOGJKB@Get_Player_List?$AA@		; `string'
PUBLIC	??_C@_07EFKPMHOM@Get_Map?$AA@			; `string'
PUBLIC	??_C@_0O@ELCCKCDM@Get_Map_Count?$AA@		; `string'
PUBLIC	??_C@_07LNFOPIDN@Set_Map?$AA@			; `string'
PUBLIC	??_C@_0BF@GCNCPLHO@Get_Game_Definitions?$AA@	; `string'
PUBLIC	??_C@_0BH@IHKNJKJK@Get_Client_Serial_Hash?$AA@	; `string'
PUBLIC	??_C@_0P@OJJGKEPN@Get_Tech_Level?$AA@		; `string'
PUBLIC	??_C@_0P@CHIIFONB@Set_Tech_Level?$AA@		; `string'
PUBLIC	??_C@_0BK@MBBJNDAC@Create_Explosion_Extended?$AA@ ; `string'
PUBLIC	??_C@_0BC@MCBNEPNP@Retrieve_Waypaths?$AA@	; `string'
PUBLIC	??_C@_0BD@JAOCIDCF@Retrieve_Waypoints?$AA@	; `string'
PUBLIC	??_C@_0BG@OAHAGLBP@Get_Waypoint_Position?$AA@	; `string'
PUBLIC	??_C@_0BH@PDJMNJCP@Test_Raycast_Collision?$AA@	; `string'
PUBLIC	??_C@_0BA@EPEIBMGB@Is_Inside_AABox?$AA@		; `string'
PUBLIC	??_C@_0BN@CHIPDPPJ@Can_Generic_Soldier_Teleport?$AA@ ; `string'
PUBLIC	??_C@_0BB@KPMAEJFO@Create_Lightning?$AA@	; `string'
PUBLIC	??_C@_0BL@DJDEMAL@Set_Global_Stealth_Disable?$AA@ ; `string'
PUBLIC	??_C@_0L@HLBGKHMG@Get_Clouds?$AA@		; `string'
PUBLIC	??_C@_0O@FLLNHPOE@Get_Lightning?$AA@		; `string'
PUBLIC	??_C@_08FBDEIGIB@Get_Wind?$AA@			; `string'
PUBLIC	??_C@_08KDMANPBB@Get_Rain?$AA@			; `string'
PUBLIC	??_C@_08FJEODDFN@Get_Snow?$AA@			; `string'
PUBLIC	??_C@_07JCMAJHBD@Get_Ash?$AA@			; `string'
PUBLIC	??_C@_0BE@CKDHLKBN@Update_Game_Options?$AA@	; `string'
PUBLIC	??_C@_0N@BNLKPPME@GetTTVersion?$AA@		; `string'
PUBLIC	??_C@_0O@GCHNBEFF@GetTTRevision?$AA@		; `string'
PUBLIC	??_C@_0BJ@PMNABOCK@Set_HUD_Help_Text_Player?$AA@ ; `string'
PUBLIC	??_C@_0BF@PFLLMIL@Change_String_Player?$AA@	; `string'
PUBLIC	??_C@_0BG@KJKLKMGE@Force_Position_Update?$AA@	; `string'
PUBLIC	??_C@_0BJ@PJBDKDAH@Get_Random_Pathfind_Spot?$AA@ ; `string'
PUBLIC	??_C@_0BO@CDDFNNIK@Set_HUD_Help_Text_Player_Text?$AA@ ; `string'
PUBLIC	??_C@_0N@EOOKECOI@Grant_Weapon?$AA@		; `string'
PUBLIC	??_C@_0CB@GAMPJPEP@Set_Object_Visibility_For_Player@ ; `string'
PUBLIC	??_C@_0BG@NDNBGNDC@Set_Object_Visibility?$AA@	; `string'
PUBLIC	??_C@_0BN@MNHDNECN@Lock_Soldier_Collision_Group?$AA@ ; `string'
PUBLIC	??_C@_0BP@OFPNIFML@Unlock_Soldier_Collision_Group?$AA@ ; `string'
PUBLIC	??_C@_0BC@OPOCOHML@Is_Engine_Enabled?$AA@	; `string'
PUBLIC	??_C@_0L@OJPFPEND@Stop_Timer?$AA@		; `string'
PUBLIC	??_C@_0CD@IHAMJBGA@Create_2D_Wave_Sound_Dialog_Play@ ; `string'
PUBLIC	??_C@_0BN@BHCGCFMD@Force_Position_Update_Player?$AA@ ; `string'
PUBLIC	??_C@_0M@PCEDCCOL@Stop_Timer2?$AA@		; `string'
PUBLIC	??_C@_09LECGCIKL@Has_Timer?$AA@			; `string'
PUBLIC	??_C@_0CD@PCCCJNDK@Set_Background_Music_Player_Offs@ ; `string'
PUBLIC	??_C@_0BC@EBLDIAJM@Set_Camera_Player?$AA@	; `string'
PUBLIC	??_C@_0CE@DJELLLKJ@Set_Definition_TranslationID_Pla@ ; `string'
PUBLIC	??_C@_0BL@EBCOCMCD@Set_Net_Update_Rate_Player?$AA@ ; `string'
PUBLIC	??_C@_0BJ@NMJAIGMB@Force_Orientation_Update?$AA@ ; `string'
PUBLIC	??_C@_0CA@COJCCGGD@Force_Orientation_Update_Player?$AA@ ; `string'
PUBLIC	??_C@_0CG@BNPLHOGJ@Create_2D_Wave_Sound_Cinematic_P@ ; `string'
PUBLIC	??_C@_0BE@CDHJMHKH@Force_Turret_Update?$AA@	; `string'
PUBLIC	??_C@_0BL@PJDBCFCK@Force_Turret_Update_Player?$AA@ ; `string'
PUBLIC	??_C@_0BG@GCJJLOAF@Force_Velocity_Update?$AA@	; `string'
PUBLIC	??_C@_0BN@OFEEDOD@Force_Velocity_Update_Player?$AA@ ; `string'
PUBLIC	??_C@_0BI@OGKIMEOH@Set_Camera_Host_Network?$AA@	; `string'
PUBLIC	??_C@_0BG@NEGNEADK@Get_Pathfind_Distance?$AA@	; `string'
PUBLIC	??_C@_0BN@GDJJNJCI@Cancel_Get_Pathfind_Distance?$AA@ ; `string'
PUBLIC	??_C@_0BM@LJLCFGA@Get_Pathfind_Distance_Async?$AA@ ; `string'
PUBLIC	??_C@_0BP@PNNEBMGK@Get_Pathfind_Distance_Blocking?$AA@ ; `string'
PUBLIC	??_C@_0BP@OGKOEPDC@Get_Multiplayer_Spawn_Location?$AA@ ; `string'
PUBLIC	??_C@_0BI@FCBDKAOB@Enable_Spawners_By_Name?$AA@	; `string'
PUBLIC	??_C@_0BG@ILOBNMKF@Is_Pathfind_Generated?$AA@	; `string'
PUBLIC	??_C@_0BK@CBLGFILN@Get_Closest_Pathfind_Spot?$AA@ ; `string'
PUBLIC	??_C@_0BP@COALLJHN@Get_Closest_Pathfind_Spot_Size?$AA@ ; `string'
PUBLIC	??_C@_0BJ@JHELCOIP@Get_Radio_Command_String?$AA@ ; `string'
PUBLIC	??_C@_0O@FHPGGMKB@Set_Emot_Icon?$AA@		; `string'
PUBLIC	??_C@_0BH@PKFFGFMH@Kill_Messages_Disabled?$AA@	; `string'
PUBLIC	??_C@_0BD@OEAAAKCL@Is_Sidebar_Enabled?$AA@	; `string'
PUBLIC	??_C@_0BC@LMJNBGJO@Is_Extras_Enabled?$AA@	; `string'
PUBLIC	??_C@_0BB@LONJLONK@Can_Build_Ground?$AA@	; `string'
PUBLIC	??_C@_0O@BJJEMMOO@Can_Build_Air?$AA@		; `string'
PUBLIC	??_C@_0BA@JMDGKCJC@Can_Build_Naval?$AA@		; `string'
PUBLIC	??_C@_0BA@NCMHCGDC@Is_Soldier_Busy?$AA@		; `string'
PUBLIC	??_C@_0BF@HEIMOFCE@Is_On_Enemy_Pedestal?$AA@	; `string'
PUBLIC	??_C@_0BL@NCKGFMPN@Find_Closest_Poly_Position?$AA@ ; `string'
PUBLIC	??_C@_0BF@PCJAOOMO@Say_Dynamic_Dialogue?$AA@	; `string'
PUBLIC	??_C@_0BM@HMJAADLA@Say_Dynamic_Dialogue_Player?$AA@ ; `string'
PUBLIC	??_C@_0BK@BOOJDLJL@Say_Dynamic_Dialogue_Team?$AA@ ; `string'
PUBLIC	??_C@_0BI@BMFOCDPE@Enable_Letterbox_Player?$AA@	; `string'
PUBLIC	??_C@_0BC@KKDEFCI@Create_Sound_Team?$AA@	; `string'
PUBLIC	??_C@_0BF@PKKIEJOG@Create_2D_Sound_Team?$AA@	; `string'
PUBLIC	??_C@_0BJ@FILHJFPE@Create_2D_WAV_Sound_Team?$AA@ ; `string'
PUBLIC	??_C@_0CA@NOOIODNK@Create_2D_WAV_Sound_Team_Dialog?$AA@ ; `string'
PUBLIC	??_C@_0CD@NKPLJNPA@Create_2D_WAV_Sound_Team_Cinemat@ ; `string'
PUBLIC	??_C@_0CB@OOHPDBDN@Create_3D_WAV_Sound_At_Bone_Team@ ; `string'
PUBLIC	??_C@_0BN@LENANALF@Create_3D_Sound_At_Bone_Team?$AA@ ; `string'
PUBLIC	??_C@_0BC@KPFPLBNK@Stop_Sound_Player?$AA@	; `string'
PUBLIC	??_C@_0BA@DEEOCNAN@Stop_Sound_Team?$AA@		; `string'
PUBLIC	??_C@_0BI@PDALEOGH@Set_Subobject_Animation?$AA@	; `string'
PUBLIC	??_C@_0P@GONKBC@Set_Time_Scale?$AA@		; `string'
PUBLIC	??_C@_0BP@KJNFPFIH@Set_Subobject_Animation_Player?$AA@ ; `string'
PUBLIC	??_C@_0BB@BKPJBBLB@Write_File_Async?$AA@	; `string'
PUBLIC	??_C@_0O@DGJINLIG@AddDialogHook?$AA@		; `string'
PUBLIC	??_C@_0BB@EMOCKGK@RemoveDialogHook?$AA@		; `string'
PUBLIC	??_C@_0BD@OIKKAPBF@Create_Menu_Dialog?$AA@	; `string'
PUBLIC	??_C@_0BE@HIIDPCFF@Create_Popup_Dialog?$AA@	; `string'
PUBLIC	??_C@_0M@BBGAOOPP@Find_Dialog?$AA@		; `string'
PUBLIC	??_C@_0M@DONKLOFJ@Show_Dialog?$AA@		; `string'
PUBLIC	??_C@_0M@PIAILJGL@Hide_Dialog?$AA@		; `string'
PUBLIC	??_C@_0O@CPCMOEMM@Delete_Dialog?$AA@		; `string'
PUBLIC	??_C@_0CA@KKFNMAJB@Display_HUD_Weapon_Grant_Player?$AA@ ; `string'
PUBLIC	??_C@_0BO@OLOLHOFI@Display_HUD_Ammo_Grant_Player?$AA@ ; `string'
PUBLIC	??_C@_0BD@HCKEHOGM@Get_Repository_URL?$AA@	; `string'
PUBLIC	??_C@_0BD@IIIOEIIE@Set_Repository_URL?$AA@	; `string'
PUBLIC	??_C@_0BD@MJFKCMOJ@Get_Screenshot_URL?$AA@	; `string'
PUBLIC	??_C@_0BD@DDHABKAB@Set_Screenshot_URL?$AA@	; `string'
PUBLIC	??_C@_0BA@FEKFIPBI@Take_Screenshot?$AA@		; `string'
PUBLIC	??_C@_0BG@DMAOAPPG@Is_In_Pathfind_Sector?$AA@	; `string'
PUBLIC	??_C@_0BH@KBPEPOOK@Set_Gravity_Multiplier?$AA@	; `string'
PUBLIC	??_C@_0BE@NEFJFAP@Is_Gameplay_Allowed?$AA@	; `string'
PUBLIC	??_C@_0BF@EHLPAFM@Set_Gameplay_Allowed?$AA@	; `string'
PUBLIC	??_C@_0BF@GGGEEGBG@Print_Client_Console?$AA@	; `string'
PUBLIC	??_C@_0BM@JOGFFNHP@Print_Client_Console_Player?$AA@ ; `string'
...
EXTRN	?Set_Request_Destroy_Func@ScriptImpClass@@SAXP6AXPAVScriptClass@@@Z@Z:PROC ; ScriptImpClass::Set_Request_Destroy_Func
...
EXTRN	?GetName@ScriptFactory@@QAEPBDXZ:PROC		; ScriptFactory::GetName
EXTRN	?GetParamDescription@ScriptFactory@@QAEPBDXZ:PROC ; ScriptFactory::GetParamDescription
EXTRN	?CreateScript@ScriptRegistrar@@SAPAVScriptImpClass@@PBD@Z:PROC ; ScriptRegistrar::CreateScript
EXTRN	?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@H@Z:PROC ; ScriptRegistrar::GetScriptFactory
EXTRN	?Count@ScriptRegistrar@@SAHXZ:PROC		; ScriptRegistrar::Count
...
EXTRN	?Init@DA@@SAXXZ:PROC				; DA::Init
EXTRN	?Shutdown@DA@@SAXXZ:PROC			; DA::Shutdown
...
EXTRN	?Get_Player_List@@3P6APAV?$SList@VcPlayer@@@@XZA:DWORD ; Get_Player_List
EXTRN	?Get_Current_Map_Index@@3P6AHXZA:DWORD		; Get_Current_Map_Index
EXTRN	?Get_Map@@3P6APBDH@ZA:DWORD			; Get_Map
EXTRN	?Get_Map_Count@@3P6A?BHXZA:DWORD		; Get_Map_Count
EXTRN	?Set_Map@@3P6A_NPBDH@ZA:DWORD			; Set_Map
EXTRN	?Get_Game_Definitions@@3P6AXAAV?$HashTemplateClass@VStringClass@@VGameDefinition@@@@@ZA:DWORD ; Get_Game_Definitions
EXTRN	?Evict_Client@@3P6AXHABVWideStringClass@@@ZA:DWORD ; Evict_Client
EXTRN	?Get_Client_Serial_Hash@@3P6APBDH@ZA:DWORD	; Get_Client_Serial_Hash
EXTRN	?Get_GameObj_By_Player_Name@@3P6APAVScriptableGameObj@@PBD@ZA:DWORD ; Get_GameObj_By_Player_Name
EXTRN	?Send_Custom_All_Players@@3P6AXHPAVScriptableGameObj@@H@ZA:DWORD ; Send_Custom_All_Players
EXTRN	?Steal_Team_Credits@@3P6AMMH@ZA:DWORD		; Steal_Team_Credits
EXTRN	?Get_Team_Credits@@3P6AMH@ZA:DWORD		; Get_Team_Credits
...
EXTRN	?Set_Position_Bullets@@3P6AXPAVScriptableGameObj@@HH@ZA:DWORD ; Set_Position_Bullets
EXTRN	?Set_Position_Clip_Bullets@@3P6AXPAVScriptableGameObj@@HH@ZA:DWORD ; Set_Position_Clip_Bullets
EXTRN	?Set_Bullets@@3P6AXPAVScriptableGameObj@@PBDH@ZA:DWORD ; Set_Bullets
EXTRN	?Set_Clip_Bullets@@3P6AXPAVScriptableGameObj@@PBDH@ZA:DWORD ; Set_Clip_Bullets
EXTRN	?Display_Game_Hint@@3P6AXPAVScriptableGameObj@@HPBDHHHH@ZA:DWORD ; Display_Game_Hint
EXTRN	?Display_Game_Hint_Image@@3P6AXPAVScriptableGameObj@@HPBDHHHH1@ZA:DWORD ; Display_Game_Hint_Image
EXTRN	?AddShaderNotify@@3P6AHPAUShaderNotifyStruct@@@ZA:DWORD ; AddShaderNotify
EXTRN	?RemoveShaderNotify@@3P6AHH@ZA:DWORD		; RemoveShaderNotify
EXTRN	?AddChatHook@@3P6AXP6A_NHW4TextMessageEnum@@PB_WH@Z@ZA:DWORD ; AddChatHook
EXTRN	?AddHostHook@@3P6AXP6A_NHW4TextMessageEnum@@PBD@Z@ZA:DWORD ; AddHostHook
EXTRN	?AddRefillHook@@3P6AXP6A_NPAVScriptableGameObj@@@Z@ZA:DWORD ; AddRefillHook
...
EXTRN	?AddKeyHook@@3P6AHPAUKeyHookStruct@@@ZA:DWORD	; AddKeyHook
EXTRN	?RemoveKeyHook@@3P6AXH@ZA:DWORD			; RemoveKeyHook
EXTRN	?GetCurrentMusicTrack@@3P6APBDXZA:DWORD		; GetCurrentMusicTrack
EXTRN	?AddLoadLevelHook@@3P6AXP6AXXZ@ZA:DWORD		; AddLoadLevelHook
EXTRN	?AddPreLoadLevelHook@@3P6AXP6AXXZ@ZA:DWORD	; AddPreLoadLevelHook
EXTRN	?AddGameOverHook@@3P6AXP6AXXZ@ZA:DWORD		; AddGameOverHook
EXTRN	?AddThinkHook@@3P6AXP6AXXZ@ZA:DWORD		; AddThinkHook
EXTRN	?AddPlayerJoinHook@@3P6AXP6AXHPBD@Z@ZA:DWORD	; AddPlayerJoinHook
EXTRN	?AddRadioHook@@3P6AXP6A_NHHHHW4AnnouncementEnum@@@Z@ZA:DWORD ; AddRadioHook
EXTRN	?AddStockDamageHook@@3P6AXP6A_NPAVPhysicalGameObj@@0MI@Z@ZA:DWORD ; AddStockDamageHook
EXTRN	?AddTtDamageHook@@3P6AXP6A_NPAVPhysicalGameObj@@0PBVAmmoDefinitionClass@@PBD@Z@ZA:DWORD ; AddTtDamageHook
EXTRN	?AddPlayerLeaveHook@@3P6AXP6AXH@Z@ZA:DWORD	; AddPlayerLeaveHook
EXTRN	?AddPowerupPurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA:DWORD ; AddPowerupPurchaseHook
EXTRN	?AddVehiclePurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA:DWORD ; AddVehiclePurchaseHook
EXTRN	?AddCharacterPurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA:DWORD ; AddCharacterPurchaseHook
EXTRN	?AddPowerupPurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA:DWORD ; AddPowerupPurchaseMonHook
EXTRN	?AddVehiclePurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA:DWORD ; AddVehiclePurchaseMonHook
EXTRN	?AddCharacterPurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA:DWORD ; AddCharacterPurchaseMonHook
EXTRN	?RemovePowerupPurchaseHook@@3P6AXH@ZA:DWORD	; RemovePowerupPurchaseHook
EXTRN	?RemoveVehiclePurchaseHook@@3P6AXH@ZA:DWORD	; RemoveVehiclePurchaseHook
EXTRN	?RemoveCharacterPurchaseHook@@3P6AXH@ZA:DWORD	; RemoveCharacterPurchaseHook
EXTRN	?RemovePowerupPurchaseMonHook@@3P6AXH@ZA:DWORD	; RemovePowerupPurchaseMonHook
EXTRN	?RemoveVehiclePurchaseMonHook@@3P6AXH@ZA:DWORD	; RemoveVehiclePurchaseMonHook
EXTRN	?RemoveCharacterPurchaseMonHook@@3P6AXH@ZA:DWORD ; RemoveCharacterPurchaseMonHook
EXTRN	?Set_Info_Texture@@3P6AXPAVScriptableGameObj@@PBD@ZA:DWORD ; Set_Info_Texture
EXTRN	?Clear_Info_Texture@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Clear_Info_Texture
EXTRN	?Enable_Stealth_Player@@3P6AXPAVScriptableGameObj@@0_N@ZA:DWORD ; Enable_Stealth_Player
EXTRN	?Set_Fog_Enable_Player@@3P6AXPAVScriptableGameObj@@_N@ZA:DWORD ; Set_Fog_Enable_Player
EXTRN	?Set_Fog_Range_Player@@3P6AXPAVScriptableGameObj@@MMM@ZA:DWORD ; Set_Fog_Range_Player
...
EXTRN	?Stop_Background_Music_Player@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Stop_Background_Music_Player
EXTRN	?Enable_Radar_Player@@3P6AXPAVScriptableGameObj@@_N@ZA:DWORD ; Enable_Radar_Player
EXTRN	?Display_GDI_Player_Terminal_Player@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Display_GDI_Player_Terminal_Player
EXTRN	?Display_NOD_Player_Terminal_Player@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Display_NOD_Player_Terminal_Player
...
EXTRN	?Enable_HUD_Player@@3P6AXPAVScriptableGameObj@@_N@ZA:DWORD ; Enable_HUD_Player
EXTRN	?Create_Sound_Player@@3P6AHPAVScriptableGameObj@@PBDABVVector3@@0@ZA:DWORD ; Create_Sound_Player
...
EXTRN	?Create_3D_WAV_Sound_At_Bone_Player@@3P6AHPAVScriptableGameObj@@PBD01@ZA:DWORD ; Create_3D_WAV_Sound_At_Bone_Player
EXTRN	?Create_3D_Sound_At_Bone_Player@@3P6AHPAVScriptableGameObj@@PBD01@ZA:DWORD ; Create_3D_Sound_At_Bone_Player
EXTRN	?Set_Vehicle_Limit@@3P6AXI@ZA:DWORD		; Set_Vehicle_Limit
EXTRN	?Get_Vehicle_Limit@@3P6AKXZA:DWORD		; Get_Vehicle_Limit
EXTRN	?Set_Air_Vehicle_Limit@@3P6AXI@ZA:DWORD		; Set_Air_Vehicle_Limit
EXTRN	?Get_Air_Vehicle_Limit@@3P6AKXZA:DWORD		; Get_Air_Vehicle_Limit
EXTRN	?Set_Naval_Vehicle_Limit@@3P6AXI@ZA:DWORD	; Set_Naval_Vehicle_Limit
EXTRN	?Get_Naval_Vehicle_Limit@@3P6AKXZA:DWORD	; Get_Naval_Vehicle_Limit
...
EXTRN	?Load_New_HUD_INI@@3P6AXPAVScriptableGameObj@@PBD@ZA:DWORD ; Load_New_HUD_INI
EXTRN	?Remove_Weapon@@3P6AXPAVScriptableGameObj@@PBD@ZA:DWORD ; Remove_Weapon
EXTRN	?Change_Radar_Map@@3P6AXMMMPBD@ZA:DWORD		; Change_Radar_Map
EXTRN	?Get_Build_Time_Multiplier@@3P6AMH@ZA:DWORD	; Get_Build_Time_Multiplier
EXTRN	?Set_Currently_Building@@3P6AX_NH@ZA:DWORD	; Set_Currently_Building
EXTRN	?Is_Currently_Building@@3P6A_NH@ZA:DWORD	; Is_Currently_Building
EXTRN	?AddConsoleOutputHook@@3P6AXP6AXPBD@Z@ZA:DWORD	; AddConsoleOutputHook
EXTRN	?AddLogFileHook@@3P6AXP6AXPBD@Z@ZA:DWORD	; AddLogFileHook
EXTRN	?Set_Fog_Color@@3P6AXIII@ZA:DWORD		; Set_Fog_Color
EXTRN	?Set_Fog_Color_Player@@3P6AXPAVScriptableGameObj@@III@ZA:DWORD ; Set_Fog_Color_Player
EXTRN	?Set_Fog_Mode@@3P6AXI@ZA:DWORD			; Set_Fog_Mode
EXTRN	?Set_Fog_Mode_Player@@3P6AXPAVScriptableGameObj@@I@ZA:DWORD ; Set_Fog_Mode_Player
EXTRN	?Set_Fog_Density@@3P6AXM@ZA:DWORD		; Set_Fog_Density
EXTRN	?Set_Fog_Density_Player@@3P6AXPAVScriptableGameObj@@M@ZA:DWORD ; Set_Fog_Density_Player
EXTRN	?Change_Time_Remaining@@3P6AXM@ZA:DWORD		; Change_Time_Remaining
EXTRN	?Change_Time_Limit@@3P6AXH@ZA:DWORD		; Change_Time_Limit
EXTRN	?Display_Security_Dialog@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Display_Security_Dialog
EXTRN	?Send_HUD_Number@@3P6AXPAVScriptableGameObj@@I@ZA:DWORD ; Send_HUD_Number
EXTRN	?GetExplosionObj@@3P6APAVScriptableGameObj@@XZA:DWORD ; GetExplosionObj
...
EXTRN	?Update_Network_Object_Player@@3P6AXPAVNetworkObjectClass@@H@ZA:DWORD ; Update_Network_Object_Player
EXTRN	?Send_Client_Text@@3P6APAVcScTextObj@@ABVWideStringClass@@W4TextMessageEnum@@_NHH22@ZA:DWORD ; Send_Client_Text
EXTRN	?Send_Client_Announcement@@3P6APAVSCAnnouncement@@HHHW4AnnouncementEnum@@H_N1@ZA:DWORD ; Send_Client_Announcement
EXTRN	?Send_Player_Kill_Message@@3P6APAVcPlayerKill@@HH@ZA:DWORD ; Send_Player_Kill_Message
EXTRN	?Send_Purchase_Response@@3P6APAVcPurchaseResponseEvent@@HH@ZA:DWORD ; Send_Purchase_Response
EXTRN	?Do_Objectives_Dlg@@3P6AXPAVScriptableGameObj@@PBD@ZA:DWORD ; Do_Objectives_Dlg
EXTRN	?Set_Player_Limit@@3P6AXI@ZA:DWORD		; Set_Player_Limit
EXTRN	?Get_Player_Limit@@3P6AIXZA:DWORD		; Get_Player_Limit
EXTRN	?Get_Fog_Range@@3P6AXAAM0@ZA:DWORD		; Get_Fog_Range
EXTRN	?Send_Shader_Param_Player@@3P6AXPAVScriptableGameObj@@PBD1@ZA:DWORD ; Send_Shader_Param_Player
EXTRN	?Send_Shader_Param@@3P6AXPBD0@ZA:DWORD		; Send_Shader_Param
EXTRN	?Send_Shader_Param_Obj_Player@@3P6AXPAVScriptableGameObj@@PBD10@ZA:DWORD ; Send_Shader_Param_Obj_Player
EXTRN	?Send_Shader_Param_Obj@@3P6AXPBD0PAVScriptableGameObj@@@ZA:DWORD ; Send_Shader_Param_Obj
EXTRN	?Set_GDI_Soldier_Name@@3P6AXPBD@ZA:DWORD	; Set_GDI_Soldier_Name
EXTRN	?Set_Nod_Soldier_Name@@3P6AXPBD@ZA:DWORD	; Set_Nod_Soldier_Name
EXTRN	?Get_GDI_Soldier_Name@@3P6APBDXZA:DWORD		; Get_GDI_Soldier_Name
EXTRN	?Get_Nod_Soldier_Name@@3P6APBDXZA:DWORD		; Get_Nod_Soldier_Name
EXTRN	?Get_IP_Address@@3P6APBDH@ZA:DWORD		; Get_IP_Address
EXTRN	?Get_IP_Port@@3P6APBDH@ZA:DWORD			; Get_IP_Port
EXTRN	?Get_IP@@3P6APBUsockaddr_in@@H@ZA:DWORD		; Get_IP
EXTRN	?Get_Bandwidth@@3P6AHH@ZA:DWORD			; Get_Bandwidth
EXTRN	?Get_Ping@@3P6AHH@ZA:DWORD			; Get_Ping
EXTRN	?Get_Kbits@@3P6AKH@ZA:DWORD			; Get_Kbits
...
EXTRN	?Set_Moon_Is_Earth@@3P6AX_N@ZA:DWORD		; Set_Moon_Is_Earth
EXTRN	?Set_Global_Stealth_Disable@@3P6AX_N@ZA:DWORD	; Set_Global_Stealth_Disable
EXTRN	?Get_Mine_Limit@@3P6AHXZA:DWORD			; Get_Mine_Limit
EXTRN	?Set_Special_Base_Destruction@@3P6AXXZA:DWORD	; Set_Special_Base_Destruction
EXTRN	?Get_Client_Version@@3P6AMH@ZA:DWORD		; Get_Client_Version
EXTRN	?Get_Client_Revision@@3P6AIH@ZA:DWORD		; Get_Client_Revision
EXTRN	?Get_Revision@@3P6AIH@ZA:DWORD			; Get_Revision
EXTRN	?Get_Damage_Warhead@@3P6AIXZA:DWORD		; Get_Damage_Warhead
EXTRN	?Get_Damage_Is_Explosion@@3P6A_NXZA:DWORD	; Get_Damage_Is_Explosion
EXTRN	?addConnectionAcceptanceFilter@@3P6AXPAVConnectionAcceptanceFilter@@@ZA:DWORD ; addConnectionAcceptanceFilter
EXTRN	?removeConnectionAcceptanceFilter@@3P6A_NPAVConnectionAcceptanceFilter@@@ZA:DWORD ; removeConnectionAcceptanceFilter
EXTRN	?Is_WOL_User@@3P6A_NPA_W@ZA:DWORD		; Is_WOL_User
EXTRN	?Get_Tech_Level@@3P6AHXZA:DWORD			; Get_Tech_Level
EXTRN	?Set_Tech_Level@@3P6AXH@ZA:DWORD		; Set_Tech_Level
EXTRN	?Create_Explosion_Extended@@3P6AXPBDAAVVector3@@PAVScriptableGameObj@@@ZA:DWORD ; Create_Explosion_Extended
EXTRN	?Retrieve_Waypaths@@3P6AXAAV?$DynamicVectorClass@H@@@ZA:DWORD ; Retrieve_Waypaths
EXTRN	?Retrieve_Waypoints@@3P6AXHAAV?$DynamicVectorClass@H@@@ZA:DWORD ; Retrieve_Waypoints
EXTRN	?Get_Waypoint_Position@@3P6AXHHAAVVector3@@@ZA:DWORD ; Get_Waypoint_Position
EXTRN	?Test_Raycast_Collision@@3P6A_NABVVector3@@0_NPAV1@PAVScriptableGameObj@@@ZA:DWORD ; Test_Raycast_Collision
EXTRN	?Is_Inside_AABox@@3P6A_NABVAABoxClass@@ABVVector3@@@ZA:DWORD ; Is_Inside_AABox
EXTRN	?Can_Generic_Soldier_Teleport@@3P6A_NVVector3@@@ZA:DWORD ; Can_Generic_Soldier_Teleport
EXTRN	?Create_Lightning@@3P6AXPBVAmmoDefinitionClass@@AAVVector3@@1@ZA:DWORD ; Create_Lightning
EXTRN	?Get_Clouds@@3P6AXAAM0@ZA:DWORD			; Get_Clouds
EXTRN	?Get_Lightning@@3P6AXAAM0000@ZA:DWORD		; Get_Lightning
EXTRN	?Get_Wind@@3P6AXAAM00@ZA:DWORD			; Get_Wind
EXTRN	?Get_Rain@@3P6AXAAM@ZA:DWORD			; Get_Rain
EXTRN	?Get_Snow@@3P6AXAAM@ZA:DWORD			; Get_Snow
EXTRN	?Get_Ash@@3P6AXAAM@ZA:DWORD			; Get_Ash
EXTRN	?Update_Game_Options@@3P6AXH@ZA:DWORD		; Update_Game_Options
EXTRN	?GetTTVersion@@3P6ANXZA:DWORD			; GetTTVersion
EXTRN	?GetTTRevision@@3P6AIXZA:DWORD			; GetTTRevision
EXTRN	?Set_HUD_Help_Text_Player@@3P6AXPAVScriptableGameObj@@HVVector3@@@ZA:DWORD ; Set_HUD_Help_Text_Player
EXTRN	?Change_String_Player@@3P6AXPAVScriptableGameObj@@HPBD@ZA:DWORD ; Change_String_Player
EXTRN	?Force_Position_Update@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Force_Position_Update
EXTRN	?Get_Random_Pathfind_Spot@@3P6A_NABVVector3@@MPAV1@@ZA:DWORD ; Get_Random_Pathfind_Spot
EXTRN	?Set_HUD_Help_Text_Player_Text@@3P6AXPAVScriptableGameObj@@HPBDVVector3@@@ZA:DWORD ; Set_HUD_Help_Text_Player_Text
EXTRN	?Grant_Weapon@@3P6AXPAVScriptableGameObj@@PBD_NH2@ZA:DWORD ; Grant_Weapon
EXTRN	?Set_Object_Visibility_For_Player@@3P6AXPAVScriptableGameObj@@H_N@ZA:DWORD ; Set_Object_Visibility_For_Player
EXTRN	?Set_Object_Visibility@@3P6AXH_N@ZA:DWORD	; Set_Object_Visibility
EXTRN	?Lock_Soldier_Collision_Group@@3P6AXPAVScriptableGameObj@@W4Collision_Group_Type@@@ZA:DWORD ; Lock_Soldier_Collision_Group
EXTRN	?Unlock_Soldier_Collision_Group@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Unlock_Soldier_Collision_Group
EXTRN	?Is_Engine_Enabled@@3P6A_NPAVScriptableGameObj@@@ZA:DWORD ; Is_Engine_Enabled
EXTRN	?Stop_Timer@@3P6AXPAVScriptableGameObj@@H@ZA:DWORD ; Stop_Timer
EXTRN	?Create_2D_Wave_Sound_Dialog_Player@@3P6AHPAVScriptableGameObj@@PBD@ZA:DWORD ; Create_2D_Wave_Sound_Dialog_Player
EXTRN	?Force_Position_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA:DWORD ; Force_Position_Update_Player
EXTRN	?Stop_Timer2@@3P6AXPAVScriptableGameObj@@PAVScriptClass@@H@ZA:DWORD ; Stop_Timer2
EXTRN	?Has_Timer@@3P6A_NPAVScriptableGameObj@@PAVScriptClass@@H@ZA:DWORD ; Has_Timer
EXTRN	?Set_Background_Music_Player_Offset@@3P6AXPAVScriptableGameObj@@PBDM@ZA:DWORD ; Set_Background_Music_Player_Offset
EXTRN	?Set_Camera_Player@@3P6AXPAVScriptableGameObj@@PBD@ZA:DWORD ; Set_Camera_Player
EXTRN	?Set_Definition_TranslationID_Player@@3P6AXPAVScriptableGameObj@@HH@ZA:DWORD ; Set_Definition_TranslationID_Player
EXTRN	?Set_Net_Update_Rate_Player@@3P6AXPAVScriptableGameObj@@H@ZA:DWORD ; Set_Net_Update_Rate_Player
EXTRN	?Force_Orientation_Update@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Force_Orientation_Update
EXTRN	?Force_Orientation_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA:DWORD ; Force_Orientation_Update_Player
EXTRN	?Create_2D_Wave_Sound_Cinematic_Player@@3P6AHPAVScriptableGameObj@@PBD@ZA:DWORD ; Create_2D_Wave_Sound_Cinematic_Player
EXTRN	?Force_Turret_Update@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Force_Turret_Update
EXTRN	?Force_Turret_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA:DWORD ; Force_Turret_Update_Player
EXTRN	?Force_Velocity_Update@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Force_Velocity_Update
EXTRN	?Force_Velocity_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA:DWORD ; Force_Velocity_Update_Player
EXTRN	?Set_Camera_Host_Network@@3P6AXPAVScriptableGameObj@@@ZA:DWORD ; Set_Camera_Host_Network
EXTRN	?Get_Pathfind_Distance@@3P6AIABVVector3@@0P6AXABUPathfindDistanceRequest@@@ZPAVSmartGameObj@@PAX@ZA:DWORD ; Get_Pathfind_Distance
EXTRN	?Get_Pathfind_Distance_Async@@3P6AIPAVSmartGameObj@@ABVVector3@@P6AXABUPathfindDistanceRequest@@@ZPAX@ZA:DWORD ; Get_Pathfind_Distance_Async
EXTRN	?Cancel_Get_Pathfind_Distance@@3P6A_NI@ZA:DWORD	; Cancel_Get_Pathfind_Distance
EXTRN	?Get_Pathfind_Distance_Blocking@@3P6A_NPAVSmartGameObj@@ABVVector3@@AAMAAW4PathfindDistanceResult@@@ZA:DWORD ; Get_Pathfind_Distance_Blocking
EXTRN	?Get_Multiplayer_Spawn_Location@@3P6AXHPAVSoldierGameObj@@AAVMatrix3D@@@ZA:DWORD ; Get_Multiplayer_Spawn_Location
EXTRN	?Enable_Spawners_By_Name@@3P6AXPBD_N@ZA:DWORD	; Enable_Spawners_By_Name
EXTRN	?Is_Pathfind_Generated@@3P6A_NXZA:DWORD		; Is_Pathfind_Generated
EXTRN	?Get_Closest_Pathfind_Spot@@3P6A_NABVVector3@@MPAV1@@ZA:DWORD ; Get_Closest_Pathfind_Spot
EXTRN	?Get_Closest_Pathfind_Spot_Size@@3P6A_NABVVector3@@MPAV1@M@ZA:DWORD ; Get_Closest_Pathfind_Spot_Size
EXTRN	?Get_Radio_Command_String@@3P6AHH@ZA:DWORD	; Get_Radio_Command_String
EXTRN	?Set_Emot_Icon@@3P6AHPAVSoldierGameObj@@H@ZA:DWORD ; Set_Emot_Icon
EXTRN	?Kill_Messages_Disabled@@3P6A_NXZA:DWORD	; Kill_Messages_Disabled
EXTRN	?Is_Sidebar_Enabled@@3P6A_NXZA:DWORD		; Is_Sidebar_Enabled
EXTRN	?Is_Extras_Enabled@@3P6A_NXZA:DWORD		; Is_Extras_Enabled
EXTRN	?Can_Build_Ground@@3P6A_NH@ZA:DWORD		; Can_Build_Ground
EXTRN	?Can_Build_Air@@3P6A_NH@ZA:DWORD		; Can_Build_Air
EXTRN	?Can_Build_Naval@@3P6A_NH@ZA:DWORD		; Can_Build_Naval
EXTRN	?Is_Soldier_Busy@@3P6A_NPAVSoldierGameObj@@@ZA:DWORD ; Is_Soldier_Busy
EXTRN	?Is_On_Enemy_Pedestal@@3P6A_NPAVBeaconGameObj@@@ZA:DWORD ; Is_On_Enemy_Pedestal
EXTRN	?Find_Closest_Poly_Position@@3P6AXPAVBuildingGameObj@@AAVVector3@@PAV2@@ZA:DWORD ; Find_Closest_Poly_Position
EXTRN	?Say_Dynamic_Dialogue@@3P6AXHPAVSoldierGameObj@@PAH@ZA:DWORD ; Say_Dynamic_Dialogue
EXTRN	?Say_Dynamic_Dialogue_Player@@3P6AXPAVScriptableGameObj@@HPAVSoldierGameObj@@PAH@ZA:DWORD ; Say_Dynamic_Dialogue_Player
EXTRN	?Say_Dynamic_Dialogue_Team@@3P6AXHPAVSoldierGameObj@@PAHH@ZA:DWORD ; Say_Dynamic_Dialogue_Team
EXTRN	?Enable_Letterbox_Player@@3P6AXPAVScriptableGameObj@@_NM@ZA:DWORD ; Enable_Letterbox_Player
EXTRN	?Create_Sound_Team@@3P6AHPBDABVVector3@@PAVScriptableGameObj@@H@ZA:DWORD ; Create_Sound_Team
EXTRN	?Create_2D_Sound_Team@@3P6AHPBDH@ZA:DWORD	; Create_2D_Sound_Team
EXTRN	?Create_2D_WAV_Sound_Team@@3P6AHPBDH@ZA:DWORD	; Create_2D_WAV_Sound_Team
EXTRN	?Create_2D_WAV_Sound_Team_Dialog@@3P6AHPBDH@ZA:DWORD ; Create_2D_WAV_Sound_Team_Dialog
EXTRN	?Create_2D_WAV_Sound_Team_Cinematic@@3P6AHPBDH@ZA:DWORD ; Create_2D_WAV_Sound_Team_Cinematic
EXTRN	?Create_3D_WAV_Sound_At_Bone_Team@@3P6AHPBDPAVScriptableGameObj@@0H@ZA:DWORD ; Create_3D_WAV_Sound_At_Bone_Team
EXTRN	?Create_3D_Sound_At_Bone_Team@@3P6AHPBDPAVScriptableGameObj@@0H@ZA:DWORD ; Create_3D_Sound_At_Bone_Team
EXTRN	?Stop_Sound_Player@@3P6AHPAVScriptableGameObj@@H_N@ZA:DWORD ; Stop_Sound_Player
EXTRN	?Stop_Sound_Team@@3P6AHH_NH@ZA:DWORD		; Stop_Sound_Team
EXTRN	?Set_Subobject_Animation@@3P6AHPAVScriptableGameObj@@PBD_N1MM2@ZA:DWORD ; Set_Subobject_Animation
EXTRN	?Set_Time_Scale@@3P6AXM@ZA:DWORD		; Set_Time_Scale
EXTRN	?Set_Subobject_Animation_Player@@3P6AHPAVScriptableGameObj@@0PBD_N1MM2@ZA:DWORD ; Set_Subobject_Animation_Player
EXTRN	?Write_File_Async@@3P6AHPBD0@ZA:DWORD		; Write_File_Async
EXTRN	?AddDialogHook@@3P6AHP6AXHHHW4DialogMessageType@@@Z@ZA:DWORD ; AddDialogHook
EXTRN	?RemoveDialogHook@@3P6AXH@ZA:DWORD		; RemoveDialogHook
EXTRN	?Create_Menu_Dialog@@3P6APAVScriptedMenuDialogClass@@H@ZA:DWORD ; Create_Menu_Dialog
EXTRN	?Create_Popup_Dialog@@3P6APAVScriptedPopupDialogClass@@H@ZA:DWORD ; Create_Popup_Dialog
EXTRN	?Find_Dialog@@3P6APAVScriptedDialogClass@@H@ZA:DWORD ; Find_Dialog
EXTRN	?Show_Dialog@@3P6AXPAVScriptedDialogClass@@@ZA:DWORD ; Show_Dialog
EXTRN	?Hide_Dialog@@3P6AXPAVScriptedDialogClass@@@ZA:DWORD ; Hide_Dialog
EXTRN	?Delete_Dialog@@3P6AXPAVScriptedDialogClass@@@ZA:DWORD ; Delete_Dialog
EXTRN	?Display_HUD_Weapon_Grant_Player@@3P6AXPAVScriptableGameObj@@HH@ZA:DWORD ; Display_HUD_Weapon_Grant_Player
EXTRN	?Display_HUD_Ammo_Grant_Player@@3P6AXPAVScriptableGameObj@@HH@ZA:DWORD ; Display_HUD_Ammo_Grant_Player
EXTRN	?Get_Repository_URL@@3P6APBDXZA:DWORD		; Get_Repository_URL
EXTRN	?Set_Repository_URL@@3P6AXPBD@ZA:DWORD		; Set_Repository_URL
EXTRN	?Get_Screenshot_URL@@3P6APBDXZA:DWORD		; Get_Screenshot_URL
EXTRN	?Set_Screenshot_URL@@3P6AXPBD@ZA:DWORD		; Set_Screenshot_URL
EXTRN	?Take_Screenshot@@3P6AXH@ZA:DWORD		; Take_Screenshot
EXTRN	?Is_In_Pathfind_Sector@@3P6A_NVVector3@@M@ZA:DWORD ; Is_In_Pathfind_Sector
EXTRN	?Set_Gravity_Multiplier@@3P6AXPAVScriptableGameObj@@M@ZA:DWORD ; Set_Gravity_Multiplier
EXTRN	?Is_Gameplay_Allowed@@3P6A_NXZA:DWORD		; Is_Gameplay_Allowed
EXTRN	?Set_Gameplay_Allowed@@3P6AX_N@ZA:DWORD		; Set_Gameplay_Allowed
EXTRN	?Print_Client_Console@@3P6AXPBDVVector4@@@ZA:DWORD ; Print_Client_Console
EXTRN	?Print_Client_Console_Player@@3P6AXPAVScriptableGameObj@@PBDVVector4@@@ZA:DWORD ; Print_Client_Console_Player
...
EXTRN	?defaultConnectionAcceptanceFilter@@3VDefaultConnectionAcceptanceFilter@@A:DWORD ; defaultConnectionAcceptanceFilter
...
CONST	ENDS
;	COMDAT ??_C@_0BM@JOGFFNHP@Print_Client_Console_Player?$AA@
CONST	SEGMENT
??_C@_0BM@JOGFFNHP@Print_Client_Console_Player?$AA@ DB 'Print_Client_Cons'
	DB	'ole_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@GGGEEGBG@Print_Client_Console?$AA@
CONST	SEGMENT
??_C@_0BF@GGGEEGBG@Print_Client_Console?$AA@ DB 'Print_Client_Console', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@EHLPAFM@Set_Gameplay_Allowed?$AA@
CONST	SEGMENT
??_C@_0BF@EHLPAFM@Set_Gameplay_Allowed?$AA@ DB 'Set_Gameplay_Allowed', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@NEFJFAP@Is_Gameplay_Allowed?$AA@
CONST	SEGMENT
??_C@_0BE@NEFJFAP@Is_Gameplay_Allowed?$AA@ DB 'Is_Gameplay_Allowed', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@KBPEPOOK@Set_Gravity_Multiplier?$AA@
CONST	SEGMENT
??_C@_0BH@KBPEPOOK@Set_Gravity_Multiplier?$AA@ DB 'Set_Gravity_Multiplier'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@DMAOAPPG@Is_In_Pathfind_Sector?$AA@
CONST	SEGMENT
??_C@_0BG@DMAOAPPG@Is_In_Pathfind_Sector?$AA@ DB 'Is_In_Pathfind_Sector', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@FEKFIPBI@Take_Screenshot?$AA@
CONST	SEGMENT
??_C@_0BA@FEKFIPBI@Take_Screenshot?$AA@ DB 'Take_Screenshot', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@DDHABKAB@Set_Screenshot_URL?$AA@
CONST	SEGMENT
??_C@_0BD@DDHABKAB@Set_Screenshot_URL?$AA@ DB 'Set_Screenshot_URL', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@MJFKCMOJ@Get_Screenshot_URL?$AA@
CONST	SEGMENT
??_C@_0BD@MJFKCMOJ@Get_Screenshot_URL?$AA@ DB 'Get_Screenshot_URL', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@IIIOEIIE@Set_Repository_URL?$AA@
CONST	SEGMENT
??_C@_0BD@IIIOEIIE@Set_Repository_URL?$AA@ DB 'Set_Repository_URL', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@HCKEHOGM@Get_Repository_URL?$AA@
CONST	SEGMENT
??_C@_0BD@HCKEHOGM@Get_Repository_URL?$AA@ DB 'Get_Repository_URL', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BO@OLOLHOFI@Display_HUD_Ammo_Grant_Player?$AA@
CONST	SEGMENT
??_C@_0BO@OLOLHOFI@Display_HUD_Ammo_Grant_Player?$AA@ DB 'Display_HUD_Amm'
	DB	'o_Grant_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CA@KKFNMAJB@Display_HUD_Weapon_Grant_Player?$AA@
CONST	SEGMENT
??_C@_0CA@KKFNMAJB@Display_HUD_Weapon_Grant_Player?$AA@ DB 'Display_HUD_W'
	DB	'eapon_Grant_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@CPCMOEMM@Delete_Dialog?$AA@
CONST	SEGMENT
??_C@_0O@CPCMOEMM@Delete_Dialog?$AA@ DB 'Delete_Dialog', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@PIAILJGL@Hide_Dialog?$AA@
CONST	SEGMENT
??_C@_0M@PIAILJGL@Hide_Dialog?$AA@ DB 'Hide_Dialog', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@DONKLOFJ@Show_Dialog?$AA@
CONST	SEGMENT
??_C@_0M@DONKLOFJ@Show_Dialog?$AA@ DB 'Show_Dialog', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@BBGAOOPP@Find_Dialog?$AA@
CONST	SEGMENT
??_C@_0M@BBGAOOPP@Find_Dialog?$AA@ DB 'Find_Dialog', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@HIIDPCFF@Create_Popup_Dialog?$AA@
CONST	SEGMENT
??_C@_0BE@HIIDPCFF@Create_Popup_Dialog?$AA@ DB 'Create_Popup_Dialog', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@OIKKAPBF@Create_Menu_Dialog?$AA@
CONST	SEGMENT
??_C@_0BD@OIKKAPBF@Create_Menu_Dialog?$AA@ DB 'Create_Menu_Dialog', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@EMOCKGK@RemoveDialogHook?$AA@
CONST	SEGMENT
??_C@_0BB@EMOCKGK@RemoveDialogHook?$AA@ DB 'RemoveDialogHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@DGJINLIG@AddDialogHook?$AA@
CONST	SEGMENT
??_C@_0O@DGJINLIG@AddDialogHook?$AA@ DB 'AddDialogHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@BKPJBBLB@Write_File_Async?$AA@
CONST	SEGMENT
??_C@_0BB@BKPJBBLB@Write_File_Async?$AA@ DB 'Write_File_Async', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BP@KJNFPFIH@Set_Subobject_Animation_Player?$AA@
CONST	SEGMENT
??_C@_0BP@KJNFPFIH@Set_Subobject_Animation_Player?$AA@ DB 'Set_Subobject_'
	DB	'Animation_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@GONKBC@Set_Time_Scale?$AA@
CONST	SEGMENT
??_C@_0P@GONKBC@Set_Time_Scale?$AA@ DB 'Set_Time_Scale', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@PDALEOGH@Set_Subobject_Animation?$AA@
CONST	SEGMENT
??_C@_0BI@PDALEOGH@Set_Subobject_Animation?$AA@ DB 'Set_Subobject_Animati'
	DB	'on', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@DEEOCNAN@Stop_Sound_Team?$AA@
CONST	SEGMENT
??_C@_0BA@DEEOCNAN@Stop_Sound_Team?$AA@ DB 'Stop_Sound_Team', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@KPFPLBNK@Stop_Sound_Player?$AA@
CONST	SEGMENT
??_C@_0BC@KPFPLBNK@Stop_Sound_Player?$AA@ DB 'Stop_Sound_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@LENANALF@Create_3D_Sound_At_Bone_Team?$AA@
CONST	SEGMENT
??_C@_0BN@LENANALF@Create_3D_Sound_At_Bone_Team?$AA@ DB 'Create_3D_Sound_'
	DB	'At_Bone_Team', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@OOHPDBDN@Create_3D_WAV_Sound_At_Bone_Team@
CONST	SEGMENT
??_C@_0CB@OOHPDBDN@Create_3D_WAV_Sound_At_Bone_Team@ DB 'Create_3D_WAV_So'
	DB	'und_At_Bone_Team', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CD@NKPLJNPA@Create_2D_WAV_Sound_Team_Cinemat@
CONST	SEGMENT
??_C@_0CD@NKPLJNPA@Create_2D_WAV_Sound_Team_Cinemat@ DB 'Create_2D_WAV_So'
	DB	'und_Team_Cinematic', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CA@NOOIODNK@Create_2D_WAV_Sound_Team_Dialog?$AA@
CONST	SEGMENT
??_C@_0CA@NOOIODNK@Create_2D_WAV_Sound_Team_Dialog?$AA@ DB 'Create_2D_WAV'
	DB	'_Sound_Team_Dialog', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@FILHJFPE@Create_2D_WAV_Sound_Team?$AA@
CONST	SEGMENT
??_C@_0BJ@FILHJFPE@Create_2D_WAV_Sound_Team?$AA@ DB 'Create_2D_WAV_Sound_'
	DB	'Team', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@PKKIEJOG@Create_2D_Sound_Team?$AA@
CONST	SEGMENT
??_C@_0BF@PKKIEJOG@Create_2D_Sound_Team?$AA@ DB 'Create_2D_Sound_Team', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@KKDEFCI@Create_Sound_Team?$AA@
CONST	SEGMENT
??_C@_0BC@KKDEFCI@Create_Sound_Team?$AA@ DB 'Create_Sound_Team', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@BMFOCDPE@Enable_Letterbox_Player?$AA@
CONST	SEGMENT
??_C@_0BI@BMFOCDPE@Enable_Letterbox_Player?$AA@ DB 'Enable_Letterbox_Play'
	DB	'er', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@BOOJDLJL@Say_Dynamic_Dialogue_Team?$AA@
CONST	SEGMENT
??_C@_0BK@BOOJDLJL@Say_Dynamic_Dialogue_Team?$AA@ DB 'Say_Dynamic_Dialogu'
	DB	'e_Team', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@HMJAADLA@Say_Dynamic_Dialogue_Player?$AA@
CONST	SEGMENT
??_C@_0BM@HMJAADLA@Say_Dynamic_Dialogue_Player?$AA@ DB 'Say_Dynamic_Dialo'
	DB	'gue_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@PCJAOOMO@Say_Dynamic_Dialogue?$AA@
CONST	SEGMENT
??_C@_0BF@PCJAOOMO@Say_Dynamic_Dialogue?$AA@ DB 'Say_Dynamic_Dialogue', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@NCKGFMPN@Find_Closest_Poly_Position?$AA@
CONST	SEGMENT
??_C@_0BL@NCKGFMPN@Find_Closest_Poly_Position?$AA@ DB 'Find_Closest_Poly_'
	DB	'Position', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@HEIMOFCE@Is_On_Enemy_Pedestal?$AA@
CONST	SEGMENT
??_C@_0BF@HEIMOFCE@Is_On_Enemy_Pedestal?$AA@ DB 'Is_On_Enemy_Pedestal', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@NCMHCGDC@Is_Soldier_Busy?$AA@
CONST	SEGMENT
??_C@_0BA@NCMHCGDC@Is_Soldier_Busy?$AA@ DB 'Is_Soldier_Busy', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@JMDGKCJC@Can_Build_Naval?$AA@
CONST	SEGMENT
??_C@_0BA@JMDGKCJC@Can_Build_Naval?$AA@ DB 'Can_Build_Naval', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@BJJEMMOO@Can_Build_Air?$AA@
CONST	SEGMENT
??_C@_0O@BJJEMMOO@Can_Build_Air?$AA@ DB 'Can_Build_Air', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@LONJLONK@Can_Build_Ground?$AA@
CONST	SEGMENT
??_C@_0BB@LONJLONK@Can_Build_Ground?$AA@ DB 'Can_Build_Ground', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@LMJNBGJO@Is_Extras_Enabled?$AA@
CONST	SEGMENT
??_C@_0BC@LMJNBGJO@Is_Extras_Enabled?$AA@ DB 'Is_Extras_Enabled', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@OEAAAKCL@Is_Sidebar_Enabled?$AA@
CONST	SEGMENT
??_C@_0BD@OEAAAKCL@Is_Sidebar_Enabled?$AA@ DB 'Is_Sidebar_Enabled', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@PKFFGFMH@Kill_Messages_Disabled?$AA@
CONST	SEGMENT
??_C@_0BH@PKFFGFMH@Kill_Messages_Disabled?$AA@ DB 'Kill_Messages_Disabled'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@FHPGGMKB@Set_Emot_Icon?$AA@
CONST	SEGMENT
??_C@_0O@FHPGGMKB@Set_Emot_Icon?$AA@ DB 'Set_Emot_Icon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@JHELCOIP@Get_Radio_Command_String?$AA@
CONST	SEGMENT
??_C@_0BJ@JHELCOIP@Get_Radio_Command_String?$AA@ DB 'Get_Radio_Command_St'
	DB	'ring', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BP@COALLJHN@Get_Closest_Pathfind_Spot_Size?$AA@
CONST	SEGMENT
??_C@_0BP@COALLJHN@Get_Closest_Pathfind_Spot_Size?$AA@ DB 'Get_Closest_Pa'
	DB	'thfind_Spot_Size', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@CBLGFILN@Get_Closest_Pathfind_Spot?$AA@
CONST	SEGMENT
??_C@_0BK@CBLGFILN@Get_Closest_Pathfind_Spot?$AA@ DB 'Get_Closest_Pathfin'
	DB	'd_Spot', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@ILOBNMKF@Is_Pathfind_Generated?$AA@
CONST	SEGMENT
??_C@_0BG@ILOBNMKF@Is_Pathfind_Generated?$AA@ DB 'Is_Pathfind_Generated', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@FCBDKAOB@Enable_Spawners_By_Name?$AA@
CONST	SEGMENT
??_C@_0BI@FCBDKAOB@Enable_Spawners_By_Name?$AA@ DB 'Enable_Spawners_By_Na'
	DB	'me', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BP@OGKOEPDC@Get_Multiplayer_Spawn_Location?$AA@
CONST	SEGMENT
??_C@_0BP@OGKOEPDC@Get_Multiplayer_Spawn_Location?$AA@ DB 'Get_Multiplaye'
	DB	'r_Spawn_Location', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BP@PNNEBMGK@Get_Pathfind_Distance_Blocking?$AA@
CONST	SEGMENT
??_C@_0BP@PNNEBMGK@Get_Pathfind_Distance_Blocking?$AA@ DB 'Get_Pathfind_D'
	DB	'istance_Blocking', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@LJLCFGA@Get_Pathfind_Distance_Async?$AA@
CONST	SEGMENT
??_C@_0BM@LJLCFGA@Get_Pathfind_Distance_Async?$AA@ DB 'Get_Pathfind_Dista'
	DB	'nce_Async', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@GDJJNJCI@Cancel_Get_Pathfind_Distance?$AA@
CONST	SEGMENT
??_C@_0BN@GDJJNJCI@Cancel_Get_Pathfind_Distance?$AA@ DB 'Cancel_Get_Pathf'
	DB	'ind_Distance', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@NEGNEADK@Get_Pathfind_Distance?$AA@
CONST	SEGMENT
??_C@_0BG@NEGNEADK@Get_Pathfind_Distance?$AA@ DB 'Get_Pathfind_Distance', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@OGKIMEOH@Set_Camera_Host_Network?$AA@
CONST	SEGMENT
??_C@_0BI@OGKIMEOH@Set_Camera_Host_Network?$AA@ DB 'Set_Camera_Host_Netwo'
	DB	'rk', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@OFEEDOD@Force_Velocity_Update_Player?$AA@
CONST	SEGMENT
??_C@_0BN@OFEEDOD@Force_Velocity_Update_Player?$AA@ DB 'Force_Velocity_Up'
	DB	'date_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@GCJJLOAF@Force_Velocity_Update?$AA@
CONST	SEGMENT
??_C@_0BG@GCJJLOAF@Force_Velocity_Update?$AA@ DB 'Force_Velocity_Update', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@PJDBCFCK@Force_Turret_Update_Player?$AA@
CONST	SEGMENT
??_C@_0BL@PJDBCFCK@Force_Turret_Update_Player?$AA@ DB 'Force_Turret_Updat'
	DB	'e_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@CDHJMHKH@Force_Turret_Update?$AA@
CONST	SEGMENT
??_C@_0BE@CDHJMHKH@Force_Turret_Update?$AA@ DB 'Force_Turret_Update', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CG@BNPLHOGJ@Create_2D_Wave_Sound_Cinematic_P@
CONST	SEGMENT
??_C@_0CG@BNPLHOGJ@Create_2D_Wave_Sound_Cinematic_P@ DB 'Create_2D_Wave_S'
	DB	'ound_Cinematic_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CA@COJCCGGD@Force_Orientation_Update_Player?$AA@
CONST	SEGMENT
??_C@_0CA@COJCCGGD@Force_Orientation_Update_Player?$AA@ DB 'Force_Orienta'
	DB	'tion_Update_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@NMJAIGMB@Force_Orientation_Update?$AA@
CONST	SEGMENT
??_C@_0BJ@NMJAIGMB@Force_Orientation_Update?$AA@ DB 'Force_Orientation_Up'
	DB	'date', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@EBCOCMCD@Set_Net_Update_Rate_Player?$AA@
CONST	SEGMENT
??_C@_0BL@EBCOCMCD@Set_Net_Update_Rate_Player?$AA@ DB 'Set_Net_Update_Rat'
	DB	'e_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CE@DJELLLKJ@Set_Definition_TranslationID_Pla@
CONST	SEGMENT
??_C@_0CE@DJELLLKJ@Set_Definition_TranslationID_Pla@ DB 'Set_Definition_T'
	DB	'ranslationID_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@EBLDIAJM@Set_Camera_Player?$AA@
CONST	SEGMENT
??_C@_0BC@EBLDIAJM@Set_Camera_Player?$AA@ DB 'Set_Camera_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CD@PCCCJNDK@Set_Background_Music_Player_Offs@
CONST	SEGMENT
??_C@_0CD@PCCCJNDK@Set_Background_Music_Player_Offs@ DB 'Set_Background_M'
	DB	'usic_Player_Offset', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_09LECGCIKL@Has_Timer?$AA@
CONST	SEGMENT
??_C@_09LECGCIKL@Has_Timer?$AA@ DB 'Has_Timer', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@PCEDCCOL@Stop_Timer2?$AA@
CONST	SEGMENT
??_C@_0M@PCEDCCOL@Stop_Timer2?$AA@ DB 'Stop_Timer2', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@BHCGCFMD@Force_Position_Update_Player?$AA@
CONST	SEGMENT
??_C@_0BN@BHCGCFMD@Force_Position_Update_Player?$AA@ DB 'Force_Position_U'
	DB	'pdate_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CD@IHAMJBGA@Create_2D_Wave_Sound_Dialog_Play@
CONST	SEGMENT
??_C@_0CD@IHAMJBGA@Create_2D_Wave_Sound_Dialog_Play@ DB 'Create_2D_Wave_S'
	DB	'ound_Dialog_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@OJPFPEND@Stop_Timer?$AA@
CONST	SEGMENT
??_C@_0L@OJPFPEND@Stop_Timer?$AA@ DB 'Stop_Timer', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@OPOCOHML@Is_Engine_Enabled?$AA@
CONST	SEGMENT
??_C@_0BC@OPOCOHML@Is_Engine_Enabled?$AA@ DB 'Is_Engine_Enabled', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BP@OFPNIFML@Unlock_Soldier_Collision_Group?$AA@
CONST	SEGMENT
??_C@_0BP@OFPNIFML@Unlock_Soldier_Collision_Group?$AA@ DB 'Unlock_Soldier'
	DB	'_Collision_Group', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@MNHDNECN@Lock_Soldier_Collision_Group?$AA@
CONST	SEGMENT
??_C@_0BN@MNHDNECN@Lock_Soldier_Collision_Group?$AA@ DB 'Lock_Soldier_Col'
	DB	'lision_Group', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@NDNBGNDC@Set_Object_Visibility?$AA@
CONST	SEGMENT
??_C@_0BG@NDNBGNDC@Set_Object_Visibility?$AA@ DB 'Set_Object_Visibility', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@GAMPJPEP@Set_Object_Visibility_For_Player@
CONST	SEGMENT
??_C@_0CB@GAMPJPEP@Set_Object_Visibility_For_Player@ DB 'Set_Object_Visib'
	DB	'ility_For_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@EOOKECOI@Grant_Weapon?$AA@
CONST	SEGMENT
??_C@_0N@EOOKECOI@Grant_Weapon?$AA@ DB 'Grant_Weapon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BO@CDDFNNIK@Set_HUD_Help_Text_Player_Text?$AA@
CONST	SEGMENT
??_C@_0BO@CDDFNNIK@Set_HUD_Help_Text_Player_Text?$AA@ DB 'Set_HUD_Help_Te'
	DB	'xt_Player_Text', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@PJBDKDAH@Get_Random_Pathfind_Spot?$AA@
CONST	SEGMENT
??_C@_0BJ@PJBDKDAH@Get_Random_Pathfind_Spot?$AA@ DB 'Get_Random_Pathfind_'
	DB	'Spot', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@KJKLKMGE@Force_Position_Update?$AA@
CONST	SEGMENT
??_C@_0BG@KJKLKMGE@Force_Position_Update?$AA@ DB 'Force_Position_Update', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@PFLLMIL@Change_String_Player?$AA@
CONST	SEGMENT
??_C@_0BF@PFLLMIL@Change_String_Player?$AA@ DB 'Change_String_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@PMNABOCK@Set_HUD_Help_Text_Player?$AA@
CONST	SEGMENT
??_C@_0BJ@PMNABOCK@Set_HUD_Help_Text_Player?$AA@ DB 'Set_HUD_Help_Text_Pl'
	DB	'ayer', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@GCHNBEFF@GetTTRevision?$AA@
CONST	SEGMENT
??_C@_0O@GCHNBEFF@GetTTRevision?$AA@ DB 'GetTTRevision', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@BNLKPPME@GetTTVersion?$AA@
CONST	SEGMENT
??_C@_0N@BNLKPPME@GetTTVersion?$AA@ DB 'GetTTVersion', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@CKDHLKBN@Update_Game_Options?$AA@
CONST	SEGMENT
??_C@_0BE@CKDHLKBN@Update_Game_Options?$AA@ DB 'Update_Game_Options', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_07JCMAJHBD@Get_Ash?$AA@
CONST	SEGMENT
??_C@_07JCMAJHBD@Get_Ash?$AA@ DB 'Get_Ash', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_08FJEODDFN@Get_Snow?$AA@
CONST	SEGMENT
??_C@_08FJEODDFN@Get_Snow?$AA@ DB 'Get_Snow', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_08KDMANPBB@Get_Rain?$AA@
CONST	SEGMENT
??_C@_08KDMANPBB@Get_Rain?$AA@ DB 'Get_Rain', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_08FBDEIGIB@Get_Wind?$AA@
CONST	SEGMENT
??_C@_08FBDEIGIB@Get_Wind?$AA@ DB 'Get_Wind', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@FLLNHPOE@Get_Lightning?$AA@
CONST	SEGMENT
??_C@_0O@FLLNHPOE@Get_Lightning?$AA@ DB 'Get_Lightning', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@HLBGKHMG@Get_Clouds?$AA@
CONST	SEGMENT
??_C@_0L@HLBGKHMG@Get_Clouds?$AA@ DB 'Get_Clouds', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@DJDEMAL@Set_Global_Stealth_Disable?$AA@
CONST	SEGMENT
??_C@_0BL@DJDEMAL@Set_Global_Stealth_Disable?$AA@ DB 'Set_Global_Stealth_'
	DB	'Disable', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@KPMAEJFO@Create_Lightning?$AA@
CONST	SEGMENT
??_C@_0BB@KPMAEJFO@Create_Lightning?$AA@ DB 'Create_Lightning', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@CHIPDPPJ@Can_Generic_Soldier_Teleport?$AA@
CONST	SEGMENT
??_C@_0BN@CHIPDPPJ@Can_Generic_Soldier_Teleport?$AA@ DB 'Can_Generic_Sold'
	DB	'ier_Teleport', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@EPEIBMGB@Is_Inside_AABox?$AA@
CONST	SEGMENT
??_C@_0BA@EPEIBMGB@Is_Inside_AABox?$AA@ DB 'Is_Inside_AABox', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@PDJMNJCP@Test_Raycast_Collision?$AA@
CONST	SEGMENT
??_C@_0BH@PDJMNJCP@Test_Raycast_Collision?$AA@ DB 'Test_Raycast_Collision'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@OAHAGLBP@Get_Waypoint_Position?$AA@
CONST	SEGMENT
??_C@_0BG@OAHAGLBP@Get_Waypoint_Position?$AA@ DB 'Get_Waypoint_Position', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@JAOCIDCF@Retrieve_Waypoints?$AA@
CONST	SEGMENT
??_C@_0BD@JAOCIDCF@Retrieve_Waypoints?$AA@ DB 'Retrieve_Waypoints', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@MCBNEPNP@Retrieve_Waypaths?$AA@
CONST	SEGMENT
??_C@_0BC@MCBNEPNP@Retrieve_Waypaths?$AA@ DB 'Retrieve_Waypaths', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@MBBJNDAC@Create_Explosion_Extended?$AA@
CONST	SEGMENT
??_C@_0BK@MBBJNDAC@Create_Explosion_Extended?$AA@ DB 'Create_Explosion_Ex'
	DB	'tended', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@CHIIFONB@Set_Tech_Level?$AA@
CONST	SEGMENT
??_C@_0P@CHIIFONB@Set_Tech_Level?$AA@ DB 'Set_Tech_Level', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@OJJGKEPN@Get_Tech_Level?$AA@
CONST	SEGMENT
??_C@_0P@OJJGKEPN@Get_Tech_Level?$AA@ DB 'Get_Tech_Level', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@IHKNJKJK@Get_Client_Serial_Hash?$AA@
CONST	SEGMENT
??_C@_0BH@IHKNJKJK@Get_Client_Serial_Hash?$AA@ DB 'Get_Client_Serial_Hash'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@GCNCPLHO@Get_Game_Definitions?$AA@
CONST	SEGMENT
??_C@_0BF@GCNCPLHO@Get_Game_Definitions?$AA@ DB 'Get_Game_Definitions', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_07LNFOPIDN@Set_Map?$AA@
CONST	SEGMENT
??_C@_07LNFOPIDN@Set_Map?$AA@ DB 'Set_Map', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@ELCCKCDM@Get_Map_Count?$AA@
CONST	SEGMENT
??_C@_0O@ELCCKCDM@Get_Map_Count?$AA@ DB 'Get_Map_Count', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_07EFKPMHOM@Get_Map?$AA@
CONST	SEGMENT
??_C@_07EFKPMHOM@Get_Map?$AA@ DB 'Get_Map', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@LADOGJKB@Get_Player_List?$AA@
CONST	SEGMENT
??_C@_0BA@LADOGJKB@Get_Player_List?$AA@ DB 'Get_Player_List', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@MGKHICLA@Get_Current_Map_Index?$AA@
CONST	SEGMENT
??_C@_0BG@MGKHICLA@Get_Current_Map_Index?$AA@ DB 'Get_Current_Map_Index', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@DAELDDLM@Evict_Client?$AA@
CONST	SEGMENT
??_C@_0N@DAELDDLM@Evict_Client?$AA@ DB 'Evict_Client', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@EEKOFJGB@Is_WOL_User?$AA@
CONST	SEGMENT
??_C@_0M@EEKOFJGB@Is_WOL_User?$AA@ DB 'Is_WOL_User', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@CDPLPPFP@removeConnectionAcceptanceFilter@
CONST	SEGMENT
??_C@_0CB@CDPLPPFP@removeConnectionAcceptanceFilter@ DB 'removeConnection'
	DB	'AcceptanceFilter', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BO@CBJGBMHF@addConnectionAcceptanceFilter?$AA@
CONST	SEGMENT
??_C@_0BO@CBJGBMHF@addConnectionAcceptanceFilter?$AA@ DB 'addConnectionAc'
	DB	'ceptanceFilter', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@GNKDJAPA@Get_Team_Credits?$AA@
CONST	SEGMENT
??_C@_0BB@GNKDJAPA@Get_Team_Credits?$AA@ DB 'Get_Team_Credits', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@OENNAHJF@Steal_Team_Credits?$AA@
CONST	SEGMENT
??_C@_0BD@OENNAHJF@Steal_Team_Credits?$AA@ DB 'Steal_Team_Credits', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@IKKGHMIO@Send_Custom_All_Players?$AA@
CONST	SEGMENT
??_C@_0BI@IKKGHMIO@Send_Custom_All_Players?$AA@ DB 'Send_Custom_All_Playe'
	DB	'rs', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@CNKGLJFF@Get_GameObj_By_Player_Name?$AA@
CONST	SEGMENT
??_C@_0BL@CNKGLJFF@Get_GameObj_By_Player_Name?$AA@ DB 'Get_GameObj_By_Pla'
	DB	'yer_Name', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@JIIEILAI@Get_Damage_Is_Explosion?$AA@
CONST	SEGMENT
??_C@_0BI@JIIEILAI@Get_Damage_Is_Explosion?$AA@ DB 'Get_Damage_Is_Explosi'
	DB	'on', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@OBLOLDMF@Get_Damage_Warhead?$AA@
CONST	SEGMENT
??_C@_0BD@OBLOLDMF@Get_Damage_Warhead?$AA@ DB 'Get_Damage_Warhead', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@KCCFFNCM@Get_Revision?$AA@
CONST	SEGMENT
??_C@_0N@KCCFFNCM@Get_Revision?$AA@ DB 'Get_Revision', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@ONCNJJOE@Get_Client_Revision?$AA@
CONST	SEGMENT
??_C@_0BE@ONCNJJOE@Get_Client_Revision?$AA@ DB 'Get_Client_Revision', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@CIKJLBBI@Get_Client_Version?$AA@
CONST	SEGMENT
??_C@_0BD@CIKJLBBI@Get_Client_Version?$AA@ DB 'Get_Client_Version', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@HCOBCAKM@Set_Special_Base_Destruction?$AA@
CONST	SEGMENT
??_C@_0BN@HCOBCAKM@Set_Special_Base_Destruction?$AA@ DB 'Set_Special_Base'
	DB	'_Destruction', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@IFLCBABJ@Get_Mine_Limit?$AA@
CONST	SEGMENT
??_C@_0P@IFLCBABJ@Get_Mine_Limit?$AA@ DB 'Get_Mine_Limit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@DOKEIPDP@Set_Moon_Is_Earth?$AA@
CONST	SEGMENT
??_C@_0BC@DOKEIPDP@Set_Moon_Is_Earth?$AA@ DB 'Set_Moon_Is_Earth', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@GBBAMEON@Set_Clip_Bullets?$AA@
CONST	SEGMENT
??_C@_0BB@GBBAMEON@Set_Clip_Bullets?$AA@ DB 'Set_Clip_Bullets', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@BBALKCKK@Set_Bullets?$AA@
CONST	SEGMENT
??_C@_0M@BBALKCKK@Set_Bullets?$AA@ DB 'Set_Bullets', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@PFMHAEDP@Set_Position_Clip_Bullets?$AA@
CONST	SEGMENT
??_C@_0BK@PFMHAEDP@Set_Position_Clip_Bullets?$AA@ DB 'Set_Position_Clip_B'
	DB	'ullets', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@IGNOCPCM@Set_Position_Bullets?$AA@
CONST	SEGMENT
??_C@_0BF@IGNOCPCM@Set_Position_Bullets?$AA@ DB 'Set_Position_Bullets', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@HBIAKGBG@Set_Current_Clip_Bullets?$AA@
CONST	SEGMENT
??_C@_0BJ@HBIAKGBG@Set_Current_Clip_Bullets?$AA@ DB 'Set_Current_Clip_Bul'
	DB	'lets', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@DPDOKOIN@Set_Current_Bullets?$AA@
CONST	SEGMENT
??_C@_0BE@DPDOKOIN@Set_Current_Bullets?$AA@ DB 'Set_Current_Bullets', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@HBEECHGJ@Display_Game_Hint_Image?$AA@
CONST	SEGMENT
??_C@_0BI@HBEECHGJ@Display_Game_Hint_Image?$AA@ DB 'Display_Game_Hint_Ima'
	DB	'ge', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@JDPJACPF@Display_Game_Hint?$AA@
CONST	SEGMENT
??_C@_0BC@JDPJACPF@Display_Game_Hint?$AA@ DB 'Display_Game_Hint', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@HJOBBNJB@Clear_Fog_Override_Player?$AA@
CONST	SEGMENT
??_C@_0BK@HJOBBNJB@Clear_Fog_Override_Player?$AA@ DB 'Clear_Fog_Override_'
	DB	'Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@NMNJMHDF@Set_Fog_Override_Player?$AA@
CONST	SEGMENT
??_C@_0BI@NMNJMHDF@Set_Fog_Override_Player?$AA@ DB 'Set_Fog_Override_Play'
	DB	'er', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_09BMMJMFDN@Get_Kbits?$AA@
CONST	SEGMENT
??_C@_09BMMJMFDN@Get_Kbits?$AA@ DB 'Get_Kbits', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_08MIDJAJFC@Get_Ping?$AA@
CONST	SEGMENT
??_C@_08MIDJAJFC@Get_Ping?$AA@ DB 'Get_Ping', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@HGLENABK@Get_Bandwidth?$AA@
CONST	SEGMENT
??_C@_0O@HGLENABK@Get_Bandwidth?$AA@ DB 'Get_Bandwidth', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_06OBMKEHHP@Get_IP?$AA@
CONST	SEGMENT
??_C@_06OBMKEHHP@Get_IP?$AA@ DB 'Get_IP', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@BMLEFENB@Get_IP_Port?$AA@
CONST	SEGMENT
??_C@_0M@BMLEFENB@Get_IP_Port?$AA@ DB 'Get_IP_Port', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@CIBEDKLK@Get_IP_Address?$AA@
CONST	SEGMENT
??_C@_0P@CIBEDKLK@Get_IP_Address?$AA@ DB 'Get_IP_Address', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@HIOMIGMD@Get_Nod_Soldier_Name?$AA@
CONST	SEGMENT
??_C@_0BF@HIOMIGMD@Get_Nod_Soldier_Name?$AA@ DB 'Get_Nod_Soldier_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@CAHFBOEM@Get_GDI_Soldier_Name?$AA@
CONST	SEGMENT
??_C@_0BF@CAHFBOEM@Get_GDI_Soldier_Name?$AA@ DB 'Get_GDI_Soldier_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@CBPBJAJE@Set_Nod_Soldier_Name?$AA@
CONST	SEGMENT
??_C@_0BF@CBPBJAJE@Set_Nod_Soldier_Name?$AA@ DB 'Set_Nod_Soldier_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@HJGIAIBL@Set_GDI_Soldier_Name?$AA@
CONST	SEGMENT
??_C@_0BF@HJGIAIBL@Set_GDI_Soldier_Name?$AA@ DB 'Set_GDI_Soldier_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@BAHDOHNM@Send_Shader_Param_Obj?$AA@
CONST	SEGMENT
??_C@_0BG@BAHDOHNM@Send_Shader_Param_Obj?$AA@ DB 'Send_Shader_Param_Obj', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@LINMOLCD@Send_Shader_Param_Obj_Player?$AA@
CONST	SEGMENT
??_C@_0BN@LINMOLCD@Send_Shader_Param_Obj_Player?$AA@ DB 'Send_Shader_Para'
	DB	'm_Obj_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@MPOBLDOO@Send_Shader_Param?$AA@
CONST	SEGMENT
??_C@_0BC@MPOBLDOO@Send_Shader_Param?$AA@ DB 'Send_Shader_Param', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@MFMOMIAG@Send_Shader_Param_Player?$AA@
CONST	SEGMENT
??_C@_0BJ@MFMOMIAG@Send_Shader_Param_Player?$AA@ DB 'Send_Shader_Param_Pl'
	DB	'ayer', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@KBNEBNDF@Get_Fog_Range?$AA@
CONST	SEGMENT
??_C@_0O@KBNEBNDF@Get_Fog_Range?$AA@ DB 'Get_Fog_Range', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@EOAKABGK@Get_Player_Limit?$AA@
CONST	SEGMENT
??_C@_0BB@EOAKABGK@Get_Player_Limit?$AA@ DB 'Get_Player_Limit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@CKFDLPNI@Set_Player_Limit?$AA@
CONST	SEGMENT
??_C@_0BB@CKFDLPNI@Set_Player_Limit?$AA@ DB 'Set_Player_Limit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@JAJPDGBP@Do_Objectives_Dlg?$AA@
CONST	SEGMENT
??_C@_0BC@JAJPDGBP@Do_Objectives_Dlg?$AA@ DB 'Do_Objectives_Dlg', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@MIJEHJPC@RemoveShaderNotify?$AA@
CONST	SEGMENT
??_C@_0BD@MIJEHJPC@RemoveShaderNotify?$AA@ DB 'RemoveShaderNotify', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@PAOFDFMO@AddShaderNotify?$AA@
CONST	SEGMENT
??_C@_0BA@PAOFDFMO@AddShaderNotify?$AA@ DB 'AddShaderNotify', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@PPDDLNAI@Send_Purchase_Response?$AA@
CONST	SEGMENT
??_C@_0BH@PPDDLNAI@Send_Purchase_Response?$AA@ DB 'Send_Purchase_Response'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@GFFELGGI@Send_Player_Kill_Message?$AA@
CONST	SEGMENT
??_C@_0BJ@GFFELGGI@Send_Player_Kill_Message?$AA@ DB 'Send_Player_Kill_Mes'
	DB	'sage', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@OAFNGCJM@Send_Client_Announcement?$AA@
CONST	SEGMENT
??_C@_0BJ@OAFNGCJM@Send_Client_Announcement?$AA@ DB 'Send_Client_Announce'
	DB	'ment', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@KODCNLCD@Send_Client_Text?$AA@
CONST	SEGMENT
??_C@_0BB@KODCNLCD@Send_Client_Text?$AA@ DB 'Send_Client_Text', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@DBPFKBIP@Update_Network_Object_Player?$AA@
CONST	SEGMENT
??_C@_0BN@DBPFKBIP@Update_Network_Object_Player?$AA@ DB 'Update_Network_O'
	DB	'bject_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@MGJKMDNE@Update_Network_Object?$AA@
CONST	SEGMENT
??_C@_0BG@MGJKMDNE@Update_Network_Object?$AA@ DB 'Update_Network_Object', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@LAAPBNCO@SetExplosionObj?$AA@
CONST	SEGMENT
??_C@_0BA@LAAPBNCO@SetExplosionObj?$AA@ DB 'SetExplosionObj', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0O@LDKANIHI@SendHUDNumber?$AA@
CONST	SEGMENT
??_C@_0O@LDKANIHI@SendHUDNumber?$AA@ DB 'SendHUDNumber', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0P@HNCONIDI@AddLogFileHook?$AA@
CONST	SEGMENT
??_C@_0P@HNCONIDI@AddLogFileHook?$AA@ DB 'AddLogFileHook', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BI@FJEEDPDG@Get_Naval_Vehicle_Limit?$AA@
CONST	SEGMENT
??_C@_0BI@FJEEDPDG@Get_Naval_Vehicle_Limit?$AA@ DB 'Get_Naval_Vehicle_Lim'
	DB	'it', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@EPCJNOFE@Set_Naval_Vehicle_Limit?$AA@
CONST	SEGMENT
??_C@_0BI@EPCJNOFE@Set_Naval_Vehicle_Limit?$AA@ DB 'Set_Naval_Vehicle_Lim'
	DB	'it', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@GCIIPEFJ@Get_Air_Vehicle_Limit?$AA@
CONST	SEGMENT
??_C@_0BG@GCIIPEFJ@Get_Air_Vehicle_Limit?$AA@ DB 'Get_Air_Vehicle_Limit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@JHNOCNBI@Set_Air_Vehicle_Limit?$AA@
CONST	SEGMENT
??_C@_0BG@JHNOCNBI@Set_Air_Vehicle_Limit?$AA@ DB 'Set_Air_Vehicle_Limit', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BA@BBKLPBME@AddTtDamageHook?$AA@
CONST	SEGMENT
??_C@_0BA@BBKLPBME@AddTtDamageHook?$AA@ DB 'AddTtDamageHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@DPCHFGLM@AddStockDamageHook?$AA@
CONST	SEGMENT
??_C@_0BD@DPCHFGLM@AddStockDamageHook?$AA@ DB 'AddStockDamageHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@NAFJFAFI@AddRadioHook?$AA@
CONST	SEGMENT
??_C@_0N@NAFJFAFI@AddRadioHook?$AA@ DB 'AddRadioHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@BBENPMJL@AddPlayerJoinHook?$AA@
CONST	SEGMENT
??_C@_0BC@BBENPMJL@AddPlayerJoinHook?$AA@ DB 'AddPlayerJoinHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LENHPPAN@AddThinkHook?$AA@
CONST	SEGMENT
??_C@_0N@LENHPPAN@AddThinkHook?$AA@ DB 'AddThinkHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@CLNCABAJ@AddGameOverHook?$AA@
CONST	SEGMENT
??_C@_0BA@CLNCABAJ@AddGameOverHook?$AA@ DB 'AddGameOverHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@CMNOJHEG@AddPreLoadLevelHook?$AA@
CONST	SEGMENT
??_C@_0BE@CMNOJHEG@AddPreLoadLevelHook?$AA@ DB 'AddPreLoadLevelHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@EIEGDAAC@AddLoadLevelHook?$AA@
CONST	SEGMENT
??_C@_0BB@EIEGDAAC@AddLoadLevelHook?$AA@ DB 'AddLoadLevelHook', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@BNEJLMHD@AddRefillHook?$AA@
CONST	SEGMENT
??_C@_0O@BNEJLMHD@AddRefillHook?$AA@ DB 'AddRefillHook', 00H ; `string'
CONST	ENDS
...
??_C@_0BK@KODEAOPK@New_Enable_Stealth_Player?$AA@ DB 'New_Enable_Stealth_'
	DB	'Player', 00H				; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Destroy_Script@@9@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Destroy_Script@@9@4JA DD 09bH		; `Destroy_Script'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_0FA@INGEHCNO@Unfortunately?0?5there?5was?5an?5erro@
CONST	SEGMENT
??_C@_0FA@INGEHCNO@Unfortunately?0?5there?5was?5an?5erro@ DB 'Unfortunate'
	DB	'ly, there was an error loading scripts2.dll. Please report th'
	DB	'is bug!', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CO@NDBPENPI@?$FLscripts2?4dll?$FN?5Failed?5to?5load?0?5?5@
CONST	SEGMENT
??_C@_0CO@NDBPENPI@?$FLscripts2?4dll?$FN?5Failed?5to?5load?0?5?5@ DB '[sc'
	DB	'ripts2.dll] Failed to load,  error %d. %s', 0aH, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_1GK@GFIFGELI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
CONST	SEGMENT
??_C@_1GK@GFIFGELI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@ DB 'x'
	DB	00H, ':', 00H, '\', 00H, 'g', 00H, 'i', 00H, 't', 00H, 'h', 00H
	DB	'u', 00H, 'b', 00H, '\', 00H, 'r', 00H, 'e', 00H, 'n', 00H, 'e'
	DB	00H, 'g', 00H, 'a', 00H, 'd', 00H, 'e', 00H, '\', 00H, 'd', 00H
	DB	'r', 00H, 'a', 00H, 'g', 00H, 'o', 00H, 'n', 00H, 'a', 00H, 'd'
	DB	00H, 'e', 00H, '_', 00H, 'r', 00H, 'x', 00H, 'd', 00H, '\', 00H
	DB	's', 00H, 'c', 00H, 'r', 00H, 'i', 00H, 'p', 00H, 't', 00H, 's'
	DB	00H, '\', 00H, 'd', 00H, 'l', 00H, 'l', 00H, 'm', 00H, 'a', 00H
	DB	'i', 00H, 'n', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0DF@BCGEFFMI@x?3?2github?2renegade?2dragonade_rxd@
CONST	SEGMENT
??_C@_0DF@BCGEFFMI@x?3?2github?2renegade?2dragonade_rxd@ DB 'x:\github\re'
	DB	'negade\dragonade_rxd\scripts\dllmain.cpp', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_07JLKLLPCJ@DllMain?$AA@
CONST	SEGMENT
??_C@_07JLKLLPCJ@DllMain?$AA@ DB 'DllMain', 00H		; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??DllMain@@9@12@4JA
_DATA	SEGMENT
?__LINE__Var@?1??DllMain@@9@12@4JA DD 039H		; `DllMain'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_0BJ@JJJNDFHO@Set_Request_Destroy_Func?$AA@
CONST	SEGMENT
??_C@_0BJ@JJJNDFHO@Set_Request_Destroy_Func?$AA@ DB 'Set_Request_Destroy_'
	DB	'Func', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@HENBLHN@Set_Script_Commands?$AA@
CONST	SEGMENT
??_C@_0BE@HENBLHN@Set_Script_Commands?$AA@ DB 'Set_Script_Commands', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@LOHDBOCD@Get_Script_Param_Description?$AA@
CONST	SEGMENT
??_C@_0BN@LOHDBOCD@Get_Script_Param_Description?$AA@ DB 'Get_Script_Param'
	DB	'_Description', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@JJJPOLJN@Get_Script_Name?$AA@
CONST	SEGMENT
??_C@_0BA@JJJPOLJN@Get_Script_Name?$AA@ DB 'Get_Script_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@FPCCPBMO@Get_Script_Count?$AA@
CONST	SEGMENT
??_C@_0BB@FPCCPBMO@Get_Script_Count?$AA@ DB 'Get_Script_Count', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@FAMANIPC@Destroy_Script?$AA@
CONST	SEGMENT
??_C@_0P@FAMANIPC@Destroy_Script?$AA@ DB 'Destroy_Script', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@MLAMJOAE@Create_Script?$AA@
CONST	SEGMENT
??_C@_0O@MLAMJOAE@Create_Script?$AA@ DB 'Create_Script', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@HOEEPKHH@Bandtest?4dll?$AA@
CONST	SEGMENT
??_C@_0N@HOEEPKHH@Bandtest?4dll?$AA@ DB 'Bandtest.dll', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0EO@ODMDBBCA@scripts2?4dll?5was?5not?5found?4?5Are?5@
CONST	SEGMENT
??_C@_0EO@ODMDBBCA@scripts2?4dll?5was?5not?5found?4?5Are?5@ DB 'scripts2.'
	DB	'dll was not found. Are you sure you installed scripts.dll cor'
	DB	'rectly?', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_05NAOIJFC@Error?$AA@
CONST	SEGMENT
??_C@_05NAOIJFC@Error?$AA@ DB 'Error', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0DG@IDAKMICH@?$FLscripts2?4dll?$FN?5Module?5not?5found?0@
CONST	SEGMENT
??_C@_0DG@IDAKMICH@?$FLscripts2?4dll?$FN?5Module?5not?5found?0@ DB '[scri'
	DB	'pts2.dll] Module not found, unable to continue.', 0aH, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_02CPIDLAI@at?$AA@
CONST	SEGMENT
??_C@_02CPIDLAI@at?$AA@ DB 'at', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@LIEOGHOI@dllload?4txt?$AA@
CONST	SEGMENT
??_C@_0M@LIEOGHOI@dllload?4txt?$AA@ DB 'dllload.txt', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@CNHOAEDG@scripts2?4dll?$AA@
CONST	SEGMENT
??_C@_0N@CNHOAEDG@scripts2?4dll?$AA@ DB 'scripts2.dll', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DB@KLDDDEO@Error?5getting?5function?5address?5f@
CONST	SEGMENT
??_C@_0DB@KLDDDEO@Error?5getting?5function?5address?5f@ DB 'Error getting'
	DB	' function address from bandtest.dll', 00H	; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dllmain.cpp
...
; 452  : 	ScriptImpClass::Set_Request_Destroy_Func(function);

	mov	eax, DWORD PTR _function$[ebp]
	push	eax
	call	?Set_Request_Destroy_Func@ScriptImpClass@@SAXP6AXPAVScriptClass@@@Z@Z ; ScriptImpClass::Set_Request_Destroy_Func
	add	esp, 4

; 453  : 	(SetRequestDestroyFunc)(function);

	mov	eax, DWORD PTR _function$[ebp]
	push	eax
	call	DWORD PTR ?SetRequestDestroyFunc@@3P6AXP6AXPAVScriptClass@@@Z@ZA ; SetRequestDestroyFunc
	add	esp, 4
...
; 191  : 	Commands = commands->Commands;

	mov	eax, DWORD PTR _commands$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR ?Commands@@3PAUScriptCommands@@A, ecx ; Commands

; 192  : 	if ((Commands->Size != sizeof(ScriptCommands)) || (Commands->Version != SCRIPT_COMMANDS_VERSION))

	mov	eax, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	cmp	DWORD PTR [eax], 816			; 00000330H
	jne	SHORT $LN1@Set_Script
	mov	eax, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	cmp	DWORD PTR [eax+4], 174			; 000000aeH
	je	SHORT $LN2@Set_Script
$LN1@Set_Script:
...
; 195  : 	}
; 196  : 	Enable_Stealth_Player = (_Enable_Stealth_Player)Address(tt,"New_Enable_Stealth_Player");

	push	OFFSET ??_C@_0BK@KODEAOPK@New_Enable_Stealth_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Enable_Stealth_Player@@3P6AXPAVScriptableGameObj@@0_N@ZA, eax ; Enable_Stealth_Player

; 197  : 	Set_Fog_Enable_Player = (_Set_Fog_Enable_Player)Address(tt,"New_Set_Fog_Enable_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Enable_Player@@3P6AXPAVScriptableGameObj@@_N@ZA, eax ; Set_Fog_Enable_Player

; 198  : 	Set_Fog_Range_Player = (_Set_Fog_Range_Player)Address(tt,"New_Set_Fog_Range_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Range_Player@@3P6AXPAVScriptableGameObj@@MMM@ZA, eax ; Set_Fog_Range_Player

; 199  : 	Set_Background_Music_Player = (_Set_Background_Music_Player)Address(tt,"New_Set_Background_Music_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Background_Music_Player@@3P6AXPAVScriptableGameObj@@PBD@ZA, eax ; Set_Background_Music_Player

; 200  : 	Fade_Background_Music_Player = (_Fade_Background_Music_Player)Address(tt,"New_Fade_Background_Music_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Fade_Background_Music_Player@@3P6AXPAVScriptableGameObj@@PBDHH@ZA, eax ; Fade_Background_Music_Player

; 201  : 	Stop_Background_Music_Player = (_Stop_Background_Music_Player)Address(tt,"New_Stop_Background_Music_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Stop_Background_Music_Player@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Stop_Background_Music_Player

; 202  : 	Enable_Radar_Player = (_Enable_Radar_Player)Address(tt,"New_Enable_Radar_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Enable_Radar_Player@@3P6AXPAVScriptableGameObj@@_N@ZA, eax ; Enable_Radar_Player

; 203  : 	Display_GDI_Player_Terminal_Player = (_Display_GDI_Player_Terminal_Player)Address(tt,"New_Display_GDI_Player_Terminal_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_GDI_Player_Terminal_Player@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Display_GDI_Player_Terminal_Player

; 204  : 	Display_NOD_Player_Terminal_Player = (_Display_NOD_Player_Terminal_Player)Address(tt,"New_Display_NOD_Player_Terminal_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_NOD_Player_Terminal_Player@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Display_NOD_Player_Terminal_Player

; 205  : 	Set_Screen_Fade_Color_Player = (_Set_Screen_Fade_Color_Player)Address(tt,"New_Set_Screen_Fade_Color_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Screen_Fade_Color_Player@@3P6AXPAVScriptableGameObj@@MMMM@ZA, eax ; Set_Screen_Fade_Color_Player

; 206  : 	Set_Screen_Fade_Opacity_Player = (_Set_Screen_Fade_Opacity_Player)Address(tt,"New_Set_Screen_Fade_Opacity_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Screen_Fade_Opacity_Player@@3P6AXPAVScriptableGameObj@@MM@ZA, eax ; Set_Screen_Fade_Opacity_Player

; 207  : 	Force_Camera_Look_Player = (_Force_Camera_Look_Player)Address(tt,"New_Force_Camera_Look_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Camera_Look_Player@@3P6AXPAVScriptableGameObj@@ABVVector3@@@ZA, eax ; Force_Camera_Look_Player

; 208  : 	Enable_HUD_Player = (_Enable_HUD_Player)Address(tt,"New_Enable_HUD_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Enable_HUD_Player@@3P6AXPAVScriptableGameObj@@_N@ZA, eax ; Enable_HUD_Player

; 209  : 	Create_Sound_Player = (_Create_Sound_Player)Address(tt,"New_Create_Sound_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_Sound_Player@@3P6AHPAVScriptableGameObj@@PBDABVVector3@@0@ZA, eax ; Create_Sound_Player

; 210  : 	Create_2D_Sound_Player = (_Create_2D_Sound_Player)Address(tt,"New_Create_2D_Sound_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_Sound_Player@@3P6AHPAVScriptableGameObj@@PBD@ZA, eax ; Create_2D_Sound_Player

; 211  : 	Create_2D_WAV_Sound_Player = (_Create_2D_WAV_Sound_Player)Address(tt,"New_Create_2D_WAV_Sound_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_WAV_Sound_Player@@3P6AHPAVScriptableGameObj@@PBD@ZA, eax ; Create_2D_WAV_Sound_Player

; 212  : 	Create_3D_WAV_Sound_At_Bone_Player = (_Create_3D_WAV_Sound_At_Bone_Player)Address(tt,"New_Create_3D_WAV_Sound_At_Bone_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_3D_WAV_Sound_At_Bone_Player@@3P6AHPAVScriptableGameObj@@PBD01@ZA, eax ; Create_3D_WAV_Sound_At_Bone_Player

; 213  : 	Create_3D_Sound_At_Bone_Player = (_Create_3D_Sound_At_Bone_Player)Address(tt,"New_Create_3D_Sound_At_Bone_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_3D_Sound_At_Bone_Player@@3P6AHPAVScriptableGameObj@@PBD01@ZA, eax ; Create_3D_Sound_At_Bone_Player

; 214  : 	AddObjectCreateHook = (aoch)Address(tt,"NewAddObjectCreateHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddObjectCreateHook@@3P6AHPAUObjectCreateHookStruct@@@ZA, eax ; AddObjectCreateHook

; 215  : 	RemoveObjectCreateHook = (roch)Address(tt,"NewRemoveObjectCreateHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveObjectCreateHook@@3P6AXH@ZA, eax ; RemoveObjectCreateHook

; 216  : 	AddKeyHook = (akh)Address(tt,"AddKeyHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddKeyHook@@3P6AHPAUKeyHookStruct@@@ZA, eax ; AddKeyHook

; 217  : 	RemoveKeyHook = (rkh)Address(tt,"RemoveKeyHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveKeyHook@@3P6AXH@ZA, eax ; RemoveKeyHook

; 218  : 	AddChatHook = (ach)Address(tt,"AddChatHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddChatHook@@3P6AXP6A_NHW4TextMessageEnum@@PB_WH@Z@ZA, eax ; AddChatHook

; 219  : 	AddHostHook = (ahh)Address(tt,"AddHostHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddHostHook@@3P6AXP6A_NHW4TextMessageEnum@@PBD@Z@ZA, eax ; AddHostHook

; 220  : 	AddRefillHook = (arh)Address(tt,"AddRefillHook");

	push	OFFSET ??_C@_0O@BNEJLMHD@AddRefillHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddRefillHook@@3P6AXP6A_NPAVScriptableGameObj@@@Z@ZA, eax ; AddRefillHook

; 221  : 	AddLoadLevelHook = (allh)Address(tt,"AddLoadLevelHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddLoadLevelHook@@3P6AXP6AXXZ@ZA, eax ; AddLoadLevelHook

; 222  : 	AddPreLoadLevelHook = (allh)Address(tt,"AddPreLoadLevelHook");

	push	OFFSET ??_C@_0BE@CMNOJHEG@AddPreLoadLevelHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddPreLoadLevelHook@@3P6AXP6AXXZ@ZA, eax ; AddPreLoadLevelHook

; 223  : 	AddGameOverHook = (allh)Address(tt,"AddGameOverHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddGameOverHook@@3P6AXP6AXXZ@ZA, eax ; AddGameOverHook

; 224  : 	AddThinkHook = (allh)Address(tt,"AddThinkHook");

	push	OFFSET ??_C@_0N@LENHPPAN@AddThinkHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddThinkHook@@3P6AXP6AXXZ@ZA, eax ; AddThinkHook

; 225  : 	AddPlayerJoinHook = (apjh)Address(tt,"AddPlayerJoinHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddPlayerJoinHook@@3P6AXP6AXHPBD@Z@ZA, eax ; AddPlayerJoinHook

; 226  : 	AddRadioHook = (arch)Address(tt,"AddRadioHook");

	push	OFFSET ??_C@_0N@NAFJFAFI@AddRadioHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddRadioHook@@3P6AXP6A_NHHHHW4AnnouncementEnum@@@Z@ZA, eax ; AddRadioHook

; 227  : 	AddStockDamageHook = (asdh)Address(tt,"AddStockDamageHook");

	push	OFFSET ??_C@_0BD@DPCHFGLM@AddStockDamageHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddStockDamageHook@@3P6AXP6A_NPAVPhysicalGameObj@@0MI@Z@ZA, eax ; AddStockDamageHook

; 228  : 	AddTtDamageHook = (atdh)Address(tt,"AddTtDamageHook");

	push	OFFSET ??_C@_0BA@BBKLPBME@AddTtDamageHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddTtDamageHook@@3P6AXP6A_NPAVPhysicalGameObj@@0PBVAmmoDefinitionClass@@PBD@Z@ZA, eax ; AddTtDamageHook

; 229  : 	GetCurrentMusicTrack = (gcmt)Address(tt,"GetCurrentMusicTrack");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?GetCurrentMusicTrack@@3P6APBDXZA, eax ; GetCurrentMusicTrack

; 230  : 	Set_Info_Texture = (sit)Address(tt,"Set_Info_Texture");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Info_Texture@@3P6AXPAVScriptableGameObj@@PBD@ZA, eax ; Set_Info_Texture

; 231  : 	Clear_Info_Texture = (cit)Address(tt,"Clear_Info_Texture");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Clear_Info_Texture@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Clear_Info_Texture

; 232  : 	Set_Vehicle_Limit = (svl)Address(tt,"Set_Vehicle_Limit");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Vehicle_Limit@@3P6AXI@ZA, eax ; Set_Vehicle_Limit

; 233  : 	Get_Vehicle_Limit = (gvl)Address(tt,"Get_Vehicle_Limit");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Vehicle_Limit@@3P6AKXZA, eax ; Get_Vehicle_Limit

; 234  : 	Set_Air_Vehicle_Limit = (svl)Address(tt,"Set_Air_Vehicle_Limit");

	push	OFFSET ??_C@_0BG@JHNOCNBI@Set_Air_Vehicle_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Air_Vehicle_Limit@@3P6AXI@ZA, eax ; Set_Air_Vehicle_Limit

; 235  : 	Get_Air_Vehicle_Limit = (gvl)Address(tt,"Get_Air_Vehicle_Limit");

	push	OFFSET ??_C@_0BG@GCIIPEFJ@Get_Air_Vehicle_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Air_Vehicle_Limit@@3P6AKXZA, eax ; Get_Air_Vehicle_Limit

; 236  : 	Set_Naval_Vehicle_Limit = (svl)Address(tt,"Set_Naval_Vehicle_Limit");

	push	OFFSET ??_C@_0BI@EPCJNOFE@Set_Naval_Vehicle_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Naval_Vehicle_Limit@@3P6AXI@ZA, eax ; Set_Naval_Vehicle_Limit

; 237  : 	Get_Naval_Vehicle_Limit = (gvl)Address(tt,"Get_Naval_Vehicle_Limit");

	push	OFFSET ??_C@_0BI@FJEEDPDG@Get_Naval_Vehicle_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Naval_Vehicle_Limit@@3P6AKXZA, eax ; Get_Naval_Vehicle_Limit

; 238  : 	Send_Message = (sm)Address(tt,"Send_Message");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Message@@3P6AXIIIPBD@ZA, eax ; Send_Message

; 239  : 	Send_Message_Player = (smp)Address(tt,"Send_Message_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Message_Player@@3P6AXPAVScriptableGameObj@@IIIPBD@ZA, eax ; Send_Message_Player

; 240  : 	Load_New_HUD_INI = (lnhi)Address(tt,"Load_New_HUD_INI");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Load_New_HUD_INI@@3P6AXPAVScriptableGameObj@@PBD@ZA, eax ; Load_New_HUD_INI

; 241  : 	Remove_Weapon = (rw)Address(tt,"Remove_Weapon");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Remove_Weapon@@3P6AXPAVScriptableGameObj@@PBD@ZA, eax ; Remove_Weapon

; 242  : 	Change_Radar_Map = (crm)Address(tt,"Change_Radar_Map");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Change_Radar_Map@@3P6AXMMMPBD@ZA, eax ; Change_Radar_Map

; 243  : 	AddPowerupPurchaseHook = (aph)Address(tt,"AddPowerupPurchaseHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddPowerupPurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA, eax ; AddPowerupPurchaseHook

; 244  : 	AddVehiclePurchaseHook = (aph)Address(tt,"AddVehiclePurchaseHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddVehiclePurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA, eax ; AddVehiclePurchaseHook

; 245  : 	AddCharacterPurchaseHook = (aph)Address(tt,"AddCharacterPurchaseHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddCharacterPurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA, eax ; AddCharacterPurchaseHook

; 246  : 	AddPowerupPurchaseMonHook = (apmh)Address(tt,"AddPowerupPurchaseMonHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddPowerupPurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA, eax ; AddPowerupPurchaseMonHook

; 247  : 	AddVehiclePurchaseMonHook = (apmh)Address(tt,"AddVehiclePurchaseMonHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddVehiclePurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA, eax ; AddVehiclePurchaseMonHook

; 248  : 	AddCharacterPurchaseMonHook = (apmh)Address(tt,"AddCharacterPurchaseMonHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddCharacterPurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA, eax ; AddCharacterPurchaseMonHook

; 249  : 	RemovePowerupPurchaseHook = (rph)Address(tt,"RemovePowerupPurchaseHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemovePowerupPurchaseHook@@3P6AXH@ZA, eax ; RemovePowerupPurchaseHook

; 250  : 	RemoveVehiclePurchaseHook = (rph)Address(tt,"RemoveVehiclePurchaseHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveVehiclePurchaseHook@@3P6AXH@ZA, eax ; RemoveVehiclePurchaseHook

; 251  : 	RemoveCharacterPurchaseHook = (rph)Address(tt,"RemoveCharacterPurchaseHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveCharacterPurchaseHook@@3P6AXH@ZA, eax ; RemoveCharacterPurchaseHook

; 252  : 	RemovePowerupPurchaseMonHook = (rph)Address(tt,"RemovePowerupPurchaseMonHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemovePowerupPurchaseMonHook@@3P6AXH@ZA, eax ; RemovePowerupPurchaseMonHook

; 253  : 	RemoveVehiclePurchaseMonHook = (rph)Address(tt,"RemoveVehiclePurchaseMonHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveVehiclePurchaseMonHook@@3P6AXH@ZA, eax ; RemoveVehiclePurchaseMonHook

; 254  : 	RemoveCharacterPurchaseMonHook = (rph)Address(tt,"RemoveCharacterPurchaseMonHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveCharacterPurchaseMonHook@@3P6AXH@ZA, eax ; RemoveCharacterPurchaseMonHook

; 255  : 	Get_Build_Time_Multiplier = (gbm)Address(tt,"Get_Build_Time_Multiplier");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Build_Time_Multiplier@@3P6AMH@ZA, eax ; Get_Build_Time_Multiplier

; 256  : 	Set_Currently_Building = (scb)Address(tt,"Set_Currently_Building");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Currently_Building@@3P6AX_NH@ZA, eax ; Set_Currently_Building

; 257  : 	Is_Currently_Building = (icb)Address(tt,"Is_Currently_Building");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Currently_Building@@3P6A_NH@ZA, eax ; Is_Currently_Building

; 258  : 	AddConsoleOutputHook = (acoh)Address(tt,"AddConsoleOutputHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddConsoleOutputHook@@3P6AXP6AXPBD@Z@ZA, eax ; AddConsoleOutputHook

; 259  : 	AddLogFileHook = (acoh)Address(tt,"AddLogFileHook");

	push	OFFSET ??_C@_0P@HNCONIDI@AddLogFileHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddLogFileHook@@3P6AXP6AXPBD@Z@ZA, eax ; AddLogFileHook

; 260  : 	Set_Fog_Color = (sfc)Address(tt,"New_Set_Fog_Color");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Color@@3P6AXIII@ZA, eax ; Set_Fog_Color

; 261  : 	Set_Fog_Color_Player = (sfcp)Address(tt,"Set_Fog_Color_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Color_Player@@3P6AXPAVScriptableGameObj@@III@ZA, eax ; Set_Fog_Color_Player

; 262  : 	Set_Fog_Mode = (sfm)Address(tt,"New_Set_Fog_Mode");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Mode@@3P6AXI@ZA, eax	; Set_Fog_Mode

; 263  : 	Set_Fog_Mode_Player = (sfmp)Address(tt,"Set_Fog_Mode_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Mode_Player@@3P6AXPAVScriptableGameObj@@I@ZA, eax ; Set_Fog_Mode_Player

; 264  : 	Send_HUD_Number = (shn)Address(tt,"SendHUDNumber");

	push	OFFSET ??_C@_0O@LDKANIHI@SendHUDNumber?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_HUD_Number@@3P6AXPAVScriptableGameObj@@I@ZA, eax ; Send_HUD_Number

; 265  : 	Set_Fog_Density = (sfd)Address(tt,"New_Set_Fog_Density");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Density@@3P6AXM@ZA, eax ; Set_Fog_Density

; 266  : 	Set_Fog_Density_Player = (sfdp)Address(tt,"Set_Fog_Density_Player");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Density_Player@@3P6AXPAVScriptableGameObj@@M@ZA, eax ; Set_Fog_Density_Player

; 267  : 	Change_Time_Remaining = (ctr)Address(tt,"New_Change_Time_Remaining");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Change_Time_Remaining@@3P6AXM@ZA, eax ; Change_Time_Remaining

; 268  : 	Change_Time_Limit = (ctl)Address(tt,"New_Change_Time_Limit");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Change_Time_Limit@@3P6AXH@ZA, eax ; Change_Time_Limit

; 269  : 	Display_Security_Dialog = (dps)Address(tt,"Display_Security_Dialog");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_Security_Dialog@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Display_Security_Dialog

; 270  : 	AddPlayerLeaveHook = (aplh)Address(tt,"AddPlayerLeaveHook");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddPlayerLeaveHook@@3P6AXP6AXH@Z@ZA, eax ; AddPlayerLeaveHook

; 271  : 	GetExplosionObj = (geo)Address(tt,"GetExplosionObj");
	...
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?GetExplosionObj@@3P6APAVScriptableGameObj@@XZA, eax ; GetExplosionObj

; 272  : 	SetExplosionObj = (seo)Address(tt,"SetExplosionObj");

	push	OFFSET ??_C@_0BA@LAAPBNCO@SetExplosionObj?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?SetExplosionObj@@3P6AXPAVScriptableGameObj@@@ZA, eax ; SetExplosionObj

; 273  : 	Update_Network_Object = (uno)Address(tt,"Update_Network_Object");

	push	OFFSET ??_C@_0BG@MGJKMDNE@Update_Network_Object?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Update_Network_Object@@3P6AXPAVNetworkObjectClass@@@ZA, eax ; Update_Network_Object

; 274  : 	Update_Network_Object_Player = (unop)Address(tt,"Update_Network_Object_Player");

	push	OFFSET ??_C@_0BN@DBPFKBIP@Update_Network_Object_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Update_Network_Object_Player@@3P6AXPAVNetworkObjectClass@@H@ZA, eax ; Update_Network_Object_Player

; 275  : 	Send_Client_Text = (sct)Address(tt,"Send_Client_Text");

	push	OFFSET ??_C@_0BB@KODCNLCD@Send_Client_Text?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Client_Text@@3P6APAVcScTextObj@@ABVWideStringClass@@W4TextMessageEnum@@_NHH22@ZA, eax ; Send_Client_Text

; 276  : 	Send_Client_Announcement = (sca)Address(tt,"Send_Client_Announcement");

	push	OFFSET ??_C@_0BJ@OAFNGCJM@Send_Client_Announcement?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Client_Announcement@@3P6APAVSCAnnouncement@@HHHW4AnnouncementEnum@@H_N1@ZA, eax ; Send_Client_Announcement

; 277  : 	Send_Player_Kill_Message = (spkm)Address(tt, "Send_Player_Kill_Message");

	push	OFFSET ??_C@_0BJ@GFFELGGI@Send_Player_Kill_Message?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Player_Kill_Message@@3P6APAVcPlayerKill@@HH@ZA, eax ; Send_Player_Kill_Message

; 278  : 	Send_Purchase_Response = (spr)Address(tt, "Send_Purchase_Response");

	push	OFFSET ??_C@_0BH@PPDDLNAI@Send_Purchase_Response?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Purchase_Response@@3P6APAVcPurchaseResponseEvent@@HH@ZA, eax ; Send_Purchase_Response

; 279  : 	AddShaderNotify = (asn)Address(tt,"AddShaderNotify");

	push	OFFSET ??_C@_0BA@PAOFDFMO@AddShaderNotify?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddShaderNotify@@3P6AHPAUShaderNotifyStruct@@@ZA, eax ; AddShaderNotify

; 280  : 	RemoveShaderNotify = (rsn)Address(tt,"RemoveShaderNotify");

	push	OFFSET ??_C@_0BD@MIJEHJPC@RemoveShaderNotify?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveShaderNotify@@3P6AHH@ZA, eax ; RemoveShaderNotify

; 281  : 	Do_Objectives_Dlg = (dod)Address(tt,"Do_Objectives_Dlg");

	push	OFFSET ??_C@_0BC@JAJPDGBP@Do_Objectives_Dlg?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Do_Objectives_Dlg@@3P6AXPAVScriptableGameObj@@PBD@ZA, eax ; Do_Objectives_Dlg

; 282  : 	Set_Player_Limit = (sl)Address(tt,"Set_Player_Limit");

	push	OFFSET ??_C@_0BB@CKFDLPNI@Set_Player_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Player_Limit@@3P6AXI@ZA, eax ; Set_Player_Limit

; 283  : 	Get_Player_Limit = (gl)Address(tt,"Get_Player_Limit");

	push	OFFSET ??_C@_0BB@EOAKABGK@Get_Player_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Player_Limit@@3P6AIXZA, eax ; Get_Player_Limit

; 284  : 	Get_Fog_Range = (_Get_Fog_Range)Address(tt,"Get_Fog_Range");

	push	OFFSET ??_C@_0O@KBNEBNDF@Get_Fog_Range?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Fog_Range@@3P6AXAAM0@ZA, eax ; Get_Fog_Range

; 285  : 	Send_Shader_Param_Player = (sspp)Address(tt,"Send_Shader_Param_Player");

	push	OFFSET ??_C@_0BJ@MFMOMIAG@Send_Shader_Param_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Shader_Param_Player@@3P6AXPAVScriptableGameObj@@PBD1@ZA, eax ; Send_Shader_Param_Player

; 286  : 	Send_Shader_Param = (ssp)Address(tt,"Send_Shader_Param");

	push	OFFSET ??_C@_0BC@MPOBLDOO@Send_Shader_Param?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Shader_Param@@3P6AXPBD0@ZA, eax ; Send_Shader_Param

; 287  : 	Send_Shader_Param_Obj_Player = (sspop)Address(tt,"Send_Shader_Param_Obj_Player");

	push	OFFSET ??_C@_0BN@LINMOLCD@Send_Shader_Param_Obj_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Shader_Param_Obj_Player@@3P6AXPAVScriptableGameObj@@PBD10@ZA, eax ; Send_Shader_Param_Obj_Player

; 288  : 	Send_Shader_Param_Obj = (sspo)Address(tt,"Send_Shader_Param_Obj");

	push	OFFSET ??_C@_0BG@BAHDOHNM@Send_Shader_Param_Obj?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Shader_Param_Obj@@3P6AXPBD0PAVScriptableGameObj@@@ZA, eax ; Send_Shader_Param_Obj

; 289  : 	Set_GDI_Soldier_Name = (ssn)Address(tt,"Set_GDI_Soldier_Name");

	push	OFFSET ??_C@_0BF@HJGIAIBL@Set_GDI_Soldier_Name?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_GDI_Soldier_Name@@3P6AXPBD@ZA, eax ; Set_GDI_Soldier_Name

; 290  : 	Set_Nod_Soldier_Name = (ssn)Address(tt,"Set_Nod_Soldier_Name");

	push	OFFSET ??_C@_0BF@CBPBJAJE@Set_Nod_Soldier_Name?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Nod_Soldier_Name@@3P6AXPBD@ZA, eax ; Set_Nod_Soldier_Name

; 291  : 	Get_GDI_Soldier_Name = (gsnx)Address(tt,"Get_GDI_Soldier_Name");

	push	OFFSET ??_C@_0BF@CAHFBOEM@Get_GDI_Soldier_Name?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_GDI_Soldier_Name@@3P6APBDXZA, eax ; Get_GDI_Soldier_Name

; 292  : 	Get_Nod_Soldier_Name = (gsnx)Address(tt,"Get_Nod_Soldier_Name");

	push	OFFSET ??_C@_0BF@HIOMIGMD@Get_Nod_Soldier_Name?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Nod_Soldier_Name@@3P6APBDXZA, eax ; Get_Nod_Soldier_Name

; 293  : 	Get_IP_Address = (Get_IP_Addressx)Address(tt,"Get_IP_Address");

	push	OFFSET ??_C@_0P@CIBEDKLK@Get_IP_Address?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_IP_Address@@3P6APBDH@ZA, eax ; Get_IP_Address

; 294  : 	Get_IP_Port = (Get_IP_Portx)Address(tt,"Get_IP_Port");

	push	OFFSET ??_C@_0M@BMLEFENB@Get_IP_Port?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_IP_Port@@3P6APBDH@ZA, eax ; Get_IP_Port

; 295  : 	Get_IP = (Get_IPx)Address(tt,"Get_IP");

	push	OFFSET ??_C@_06OBMKEHHP@Get_IP?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_IP@@3P6APBUsockaddr_in@@H@ZA, eax ; Get_IP

; 296  : 	Get_Bandwidth = (Get_Bandwidthx)Address(tt,"Get_Bandwidth");

	push	OFFSET ??_C@_0O@HGLENABK@Get_Bandwidth?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Bandwidth@@3P6AHH@ZA, eax ; Get_Bandwidth

; 297  : 	Get_Ping = (Get_Pingx)Address(tt,"Get_Ping");

	push	OFFSET ??_C@_08MIDJAJFC@Get_Ping?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Ping@@3P6AHH@ZA, eax	; Get_Ping

; 298  : 	Get_Kbits = (Get_Kbitsx)Address(tt,"Get_Kbits");

	push	OFFSET ??_C@_09BMMJMFDN@Get_Kbits?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Kbits@@3P6AKH@ZA, eax	; Get_Kbits

; 299  : 	Set_Fog_Override_Player = (sfop)Address(tt,"Set_Fog_Override_Player");

	push	OFFSET ??_C@_0BI@NMNJMHDF@Set_Fog_Override_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Fog_Override_Player@@3P6AXPAVScriptableGameObj@@MM@ZA, eax ; Set_Fog_Override_Player

; 300  : 	Clear_Fog_Override_Player = (cfop)Address(tt,"Clear_Fog_Override_Player");

	push	OFFSET ??_C@_0BK@HJOBBNJB@Clear_Fog_Override_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Clear_Fog_Override_Player@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Clear_Fog_Override_Player

; 301  : 	Display_Game_Hint = (dgh)Address(tt,"Display_Game_Hint");

	push	OFFSET ??_C@_0BC@JDPJACPF@Display_Game_Hint?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_Game_Hint@@3P6AXPAVScriptableGameObj@@HPBDHHHH@ZA, eax ; Display_Game_Hint

; 302  : 	Display_Game_Hint_Image = (dghi)Address(tt,"Display_Game_Hint_Image");

	push	OFFSET ??_C@_0BI@HBEECHGJ@Display_Game_Hint_Image?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_Game_Hint_Image@@3P6AXPAVScriptableGameObj@@HPBDHHHH1@ZA, eax ; Display_Game_Hint_Image

; 303  : 	Set_Current_Bullets = (sclb)Address(tt,"Set_Current_Bullets");

	push	OFFSET ??_C@_0BE@DPDOKOIN@Set_Current_Bullets?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Current_Bullets@@3P6AXPAVScriptableGameObj@@H@ZA, eax ; Set_Current_Bullets

; 304  : 	Set_Current_Clip_Bullets = (sclb)Address(tt,"Set_Current_Clip_Bullets");

	push	OFFSET ??_C@_0BJ@HBIAKGBG@Set_Current_Clip_Bullets?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Current_Clip_Bullets@@3P6AXPAVScriptableGameObj@@H@ZA, eax ; Set_Current_Clip_Bullets

; 305  : 	Set_Position_Bullets = (spb)Address(tt,"Set_Position_Bullets");

	push	OFFSET ??_C@_0BF@IGNOCPCM@Set_Position_Bullets?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Position_Bullets@@3P6AXPAVScriptableGameObj@@HH@ZA, eax ; Set_Position_Bullets

; 306  : 	Set_Position_Clip_Bullets = (spb)Address(tt,"Set_Position_Clip_Bullets");

	push	OFFSET ??_C@_0BK@PFMHAEDP@Set_Position_Clip_Bullets?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Position_Clip_Bullets@@3P6AXPAVScriptableGameObj@@HH@ZA, eax ; Set_Position_Clip_Bullets

; 307  : 	Set_Bullets = (sb)Address(tt,"Set_Bullets");

	push	OFFSET ??_C@_0M@BBALKCKK@Set_Bullets?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Bullets@@3P6AXPAVScriptableGameObj@@PBDH@ZA, eax ; Set_Bullets

; 308  : 	Set_Clip_Bullets = (sb)Address(tt,"Set_Clip_Bullets");

	push	OFFSET ??_C@_0BB@GBBAMEON@Set_Clip_Bullets?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Clip_Bullets@@3P6AXPAVScriptableGameObj@@PBDH@ZA, eax ; Set_Clip_Bullets

; 309  : 	Set_Moon_Is_Earth = (smie)Address(tt,"Set_Moon_Is_Earth");

	push	OFFSET ??_C@_0BC@DOKEIPDP@Set_Moon_Is_Earth?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Moon_Is_Earth@@3P6AX_N@ZA, eax ; Set_Moon_Is_Earth

; 310  : 	Get_Mine_Limit = (gml)Address(tt,"Get_Mine_Limit");

	push	OFFSET ??_C@_0P@IFLCBABJ@Get_Mine_Limit?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Mine_Limit@@3P6AHXZA, eax ; Get_Mine_Limit

; 311  : 	Set_Special_Base_Destruction = (sbd)Address(tt,"Set_Special_Base_Destruction");

	push	OFFSET ??_C@_0BN@HCOBCAKM@Set_Special_Base_Destruction?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Special_Base_Destruction@@3P6AXXZA, eax ; Set_Special_Base_Destruction

; 312  : 	Get_Client_Version = (gpv)Address(tt,"Get_Client_Version");

	push	OFFSET ??_C@_0BD@CIKJLBBI@Get_Client_Version?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Client_Version@@3P6AMH@ZA, eax ; Get_Client_Version

; 313  : 	Get_Client_Revision = (gpr)Address(tt,"Get_Client_Revision");

	push	OFFSET ??_C@_0BE@ONCNJJOE@Get_Client_Revision?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Client_Revision@@3P6AIH@ZA, eax ; Get_Client_Revision

; 314  : 	Get_Revision = (gpr)Address(tt,"Get_Revision");

	push	OFFSET ??_C@_0N@KCCFFNCM@Get_Revision?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Revision@@3P6AIH@ZA, eax	; Get_Revision

; 315  : 	Get_Damage_Warhead = (gdw)Address(tt,"Get_Damage_Warhead");

	push	OFFSET ??_C@_0BD@OBLOLDMF@Get_Damage_Warhead?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Damage_Warhead@@3P6AIXZA, eax ; Get_Damage_Warhead

; 316  : 	Get_Damage_Is_Explosion = (gdie)Address(tt, "Get_Damage_Is_Explosion");

	push	OFFSET ??_C@_0BI@JIIEILAI@Get_Damage_Is_Explosion?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Damage_Is_Explosion@@3P6A_NXZA, eax ; Get_Damage_Is_Explosion

; 317  : 	Get_GameObj_By_Player_Name = (ggobpn)Address(tt,"Get_GameObj_By_Player_Name");

	push	OFFSET ??_C@_0BL@CNKGLJFF@Get_GameObj_By_Player_Name?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_GameObj_By_Player_Name@@3P6APAVScriptableGameObj@@PBD@ZA, eax ; Get_GameObj_By_Player_Name

; 318  : 	Send_Custom_All_Players = (scap)Address(tt,"Send_Custom_All_Players");

	push	OFFSET ??_C@_0BI@IKKGHMIO@Send_Custom_All_Players?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Send_Custom_All_Players@@3P6AXHPAVScriptableGameObj@@H@ZA, eax ; Send_Custom_All_Players

; 319  : 	Steal_Team_Credits = (stc)Address(tt,"Steal_Team_Credits");

	push	OFFSET ??_C@_0BD@OENNAHJF@Steal_Team_Credits?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Steal_Team_Credits@@3P6AMMH@ZA, eax ; Steal_Team_Credits

; 320  : 	Get_Team_Credits = (gtc)Address(tt,"Get_Team_Credits");

	push	OFFSET ??_C@_0BB@GNKDJAPA@Get_Team_Credits?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Team_Credits@@3P6AMH@ZA, eax ; Get_Team_Credits

; 321  : 	addConnectionAcceptanceFilter = (addConnectionAcceptanceFilterType)Address(tt, "addConnectionAcceptanceFilter");

	push	OFFSET ??_C@_0BO@CBJGBMHF@addConnectionAcceptanceFilter?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?addConnectionAcceptanceFilter@@3P6AXPAVConnectionAcceptanceFilter@@@ZA, eax ; addConnectionAcceptanceFilter

; 322  : 	removeConnectionAcceptanceFilter = (removeConnectionAcceptanceFilterType)Address(tt, "removeConnectionAcceptanceFilter");

	push	OFFSET ??_C@_0CB@CDPLPPFP@removeConnectionAcceptanceFilter@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?removeConnectionAcceptanceFilter@@3P6A_NPAVConnectionAcceptanceFilter@@@ZA, eax ; removeConnectionAcceptanceFilter

; 323  : 	Is_WOL_User = (iwu)Address(tt, "Is_WOL_User");

	push	OFFSET ??_C@_0M@EEKOFJGB@Is_WOL_User?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_WOL_User@@3P6A_NPA_W@ZA, eax ; Is_WOL_User

; 324  : 	Evict_Client = (ec)Address(tt,"Evict_Client");

	push	OFFSET ??_C@_0N@DAELDDLM@Evict_Client?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Evict_Client@@3P6AXHABVWideStringClass@@@ZA, eax ; Evict_Client

; 325  : 	Get_Current_Map_Index = (gcmi)Address(tt,"Get_Current_Map_Index");

	push	OFFSET ??_C@_0BG@MGKHICLA@Get_Current_Map_Index?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Current_Map_Index@@3P6AHXZA, eax ; Get_Current_Map_Index

; 326  : 	Get_Player_List = (gpl)Address(tt,"Get_Player_List");

	push	OFFSET ??_C@_0BA@LADOGJKB@Get_Player_List?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Player_List@@3P6APAV?$SList@VcPlayer@@@@XZA, eax ; Get_Player_List

; 327  : 	Get_Map = (gm)Address(tt,"Get_Map");

	push	OFFSET ??_C@_07EFKPMHOM@Get_Map?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Map@@3P6APBDH@ZA, eax	; Get_Map

; 328  : 	Get_Map_Count = (gmc)Address(tt,"Get_Map_Count");

	push	OFFSET ??_C@_0O@ELCCKCDM@Get_Map_Count?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Map_Count@@3P6A?BHXZA, eax ; Get_Map_Count

; 329  : 	Set_Map = (smx)Address(tt,"Set_Map");

	push	OFFSET ??_C@_07LNFOPIDN@Set_Map?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Map@@3P6A_NPBDH@ZA, eax	; Set_Map

; 330  : 	Get_Game_Definitions = (ggd)Address(tt,"Get_Game_Definitions");

	push	OFFSET ??_C@_0BF@GCNCPLHO@Get_Game_Definitions?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Game_Definitions@@3P6AXAAV?$HashTemplateClass@VStringClass@@VGameDefinition@@@@@ZA, eax ; Get_Game_Definitions

; 331  : 	Get_Client_Serial_Hash = (gcsh)Address(tt,"Get_Client_Serial_Hash");

	push	OFFSET ??_C@_0BH@IHKNJKJK@Get_Client_Serial_Hash?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Client_Serial_Hash@@3P6APBDH@ZA, eax ; Get_Client_Serial_Hash

; 332  : 	Get_Tech_Level = (gml)Address(tt,"Get_Tech_Level");

	push	OFFSET ??_C@_0P@OJJGKEPN@Get_Tech_Level?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Tech_Level@@3P6AHXZA, eax ; Get_Tech_Level

; 333  : 	Set_Tech_Level = (sw)Address(tt,"Set_Tech_Level");

	push	OFFSET ??_C@_0P@CHIIFONB@Set_Tech_Level?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Tech_Level@@3P6AXH@ZA, eax ; Set_Tech_Level

; 334  : 	Create_Explosion_Extended = (cee)Address(tt,"Create_Explosion_Extended");

	push	OFFSET ??_C@_0BK@MBBJNDAC@Create_Explosion_Extended?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_Explosion_Extended@@3P6AXPBDAAVVector3@@PAVScriptableGameObj@@@ZA, eax ; Create_Explosion_Extended

; 335  : 	Retrieve_Waypaths = (rwpa)Address(tt,"Retrieve_Waypaths");

	push	OFFSET ??_C@_0BC@MCBNEPNP@Retrieve_Waypaths?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Retrieve_Waypaths@@3P6AXAAV?$DynamicVectorClass@H@@@ZA, eax ; Retrieve_Waypaths

; 336  : 	Retrieve_Waypoints = (rwpo)Address(tt,"Retrieve_Waypoints");

	push	OFFSET ??_C@_0BD@JAOCIDCF@Retrieve_Waypoints?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Retrieve_Waypoints@@3P6AXHAAV?$DynamicVectorClass@H@@@ZA, eax ; Retrieve_Waypoints

; 337  : 	Get_Waypoint_Position = (gwp)Address(tt,"Get_Waypoint_Position");

	push	OFFSET ??_C@_0BG@OAHAGLBP@Get_Waypoint_Position?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Waypoint_Position@@3P6AXHHAAVVector3@@@ZA, eax ; Get_Waypoint_Position

; 338  : 	Test_Raycast_Collision = (trc)Address(tt,"Test_Raycast_Collision");

	push	OFFSET ??_C@_0BH@PDJMNJCP@Test_Raycast_Collision?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Test_Raycast_Collision@@3P6A_NABVVector3@@0_NPAV1@PAVScriptableGameObj@@@ZA, eax ; Test_Raycast_Collision

; 339  : 	Is_Inside_AABox = (iib)Address(tt,"Is_Inside_AABox");

	push	OFFSET ??_C@_0BA@EPEIBMGB@Is_Inside_AABox?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Inside_AABox@@3P6A_NABVAABoxClass@@ABVVector3@@@ZA, eax ; Is_Inside_AABox

; 340  : 	Can_Generic_Soldier_Teleport = (cgst)Address(tt,"Can_Generic_Soldier_Teleport");

	push	OFFSET ??_C@_0BN@CHIPDPPJ@Can_Generic_Soldier_Teleport?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Can_Generic_Soldier_Teleport@@3P6A_NVVector3@@@ZA, eax ; Can_Generic_Soldier_Teleport

; 341  : 	Create_Lightning = (cl)Address(tt,"Create_Lightning");

	push	OFFSET ??_C@_0BB@KPMAEJFO@Create_Lightning?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_Lightning@@3P6AXPBVAmmoDefinitionClass@@AAVVector3@@1@ZA, eax ; Create_Lightning

; 342  : 	Set_Global_Stealth_Disable = (smie)Address(tt,"Set_Global_Stealth_Disable");

	push	OFFSET ??_C@_0BL@DJDEMAL@Set_Global_Stealth_Disable?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Global_Stealth_Disable@@3P6AX_N@ZA, eax ; Set_Global_Stealth_Disable

; 343  : 	Get_Clouds = (gc) Address(tt, "Get_Clouds");

	push	OFFSET ??_C@_0L@HLBGKHMG@Get_Clouds?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Clouds@@3P6AXAAM0@ZA, eax ; Get_Clouds

; 344  : 	Get_Lightning = (gli) Address(tt, "Get_Lightning");

	push	OFFSET ??_C@_0O@FLLNHPOE@Get_Lightning?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Lightning@@3P6AXAAM0000@ZA, eax ; Get_Lightning

; 345  : 	Get_Wind = (gw) Address(tt, "Get_Wind");

	push	OFFSET ??_C@_08FBDEIGIB@Get_Wind?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Wind@@3P6AXAAM00@ZA, eax	; Get_Wind

; 346  : 	Get_Rain = (gp) Address(tt, "Get_Rain");

	push	OFFSET ??_C@_08KDMANPBB@Get_Rain?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Rain@@3P6AXAAM@ZA, eax	; Get_Rain

; 347  : 	Get_Snow = (gp) Address(tt, "Get_Snow");

	push	OFFSET ??_C@_08FJEODDFN@Get_Snow?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Snow@@3P6AXAAM@ZA, eax	; Get_Snow

; 348  : 	Get_Ash = (gp) Address(tt, "Get_Ash");

	push	OFFSET ??_C@_07JCMAJHBD@Get_Ash?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Ash@@3P6AXAAM@ZA, eax	; Get_Ash

; 349  : 	Update_Game_Options = (ugo) Address(tt, "Update_Game_Options");

	push	OFFSET ??_C@_0BE@CKDHLKBN@Update_Game_Options?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Update_Game_Options@@3P6AXH@ZA, eax ; Update_Game_Options

; 350  : 	GetTTVersion = (gttv)Address(tt,"GetTTVersion");

	push	OFFSET ??_C@_0N@BNLKPPME@GetTTVersion?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?GetTTVersion@@3P6ANXZA, eax	; GetTTVersion

; 351  : 	GetTTRevision = (gttr)Address(tt,"GetTTRevision");

	push	OFFSET ??_C@_0O@GCHNBEFF@GetTTRevision?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?GetTTRevision@@3P6AIXZA, eax	; GetTTRevision

; 352  : 	Set_HUD_Help_Text_Player = (htp)Address(tt,"Set_HUD_Help_Text_Player");

	push	OFFSET ??_C@_0BJ@PMNABOCK@Set_HUD_Help_Text_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_HUD_Help_Text_Player@@3P6AXPAVScriptableGameObj@@HVVector3@@@ZA, eax ; Set_HUD_Help_Text_Player

; 353  : 	Change_String_Player = (csp)Address(tt,"Change_String_Player");

	push	OFFSET ??_C@_0BF@PFLLMIL@Change_String_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Change_String_Player@@3P6AXPAVScriptableGameObj@@HPBD@ZA, eax ; Change_String_Player

; 354  : 	Force_Position_Update = (fpu)Address(tt,"Force_Position_Update");

	push	OFFSET ??_C@_0BG@KJKLKMGE@Force_Position_Update?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Position_Update@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Force_Position_Update

; 355  : 	Get_Random_Pathfind_Spot = (grps)Address(tt,"Get_Random_Pathfind_Spot");

	push	OFFSET ??_C@_0BJ@PJBDKDAH@Get_Random_Pathfind_Spot?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Random_Pathfind_Spot@@3P6A_NABVVector3@@MPAV1@@ZA, eax ; Get_Random_Pathfind_Spot

; 356  : 	Set_HUD_Help_Text_Player_Text = (htpt)Address(tt,"Set_HUD_Help_Text_Player_Text");

	push	OFFSET ??_C@_0BO@CDDFNNIK@Set_HUD_Help_Text_Player_Text?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_HUD_Help_Text_Player_Text@@3P6AXPAVScriptableGameObj@@HPBDVVector3@@@ZA, eax ; Set_HUD_Help_Text_Player_Text

; 357  : 	Grant_Weapon = (grw)Address(tt,"Grant_Weapon");

	push	OFFSET ??_C@_0N@EOOKECOI@Grant_Weapon?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Grant_Weapon@@3P6AXPAVScriptableGameObj@@PBD_NH2@ZA, eax ; Grant_Weapon

; 358  : 	Set_Object_Visibility_For_Player = (sovfp)Address(tt,"Set_Object_Visibility_For_Player");

	push	OFFSET ??_C@_0CB@GAMPJPEP@Set_Object_Visibility_For_Player@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Object_Visibility_For_Player@@3P6AXPAVScriptableGameObj@@H_N@ZA, eax ; Set_Object_Visibility_For_Player

; 359  : 	Set_Object_Visibility = (sov)Address(tt,"Set_Object_Visibility");

	push	OFFSET ??_C@_0BG@NDNBGNDC@Set_Object_Visibility?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Object_Visibility@@3P6AXH_N@ZA, eax ; Set_Object_Visibility

; 360  : 	Lock_Soldier_Collision_Group = (lscg)Address(tt,"Lock_Soldier_Collision_Group");

	push	OFFSET ??_C@_0BN@MNHDNECN@Lock_Soldier_Collision_Group?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Lock_Soldier_Collision_Group@@3P6AXPAVScriptableGameObj@@W4Collision_Group_Type@@@ZA, eax ; Lock_Soldier_Collision_Group

; 361  : 	Unlock_Soldier_Collision_Group = (ulscg)Address(tt,"Unlock_Soldier_Collision_Group");

	push	OFFSET ??_C@_0BP@OFPNIFML@Unlock_Soldier_Collision_Group?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Unlock_Soldier_Collision_Group@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Unlock_Soldier_Collision_Group

; 362  : 	Unlock_Soldier_Collision_Group = (ulscg)Address(tt,"Unlock_Soldier_Collision_Group");
...
; 363  : 	Is_Engine_Enabled = (iea)Address(tt,"Is_Engine_Enabled");

	push	OFFSET ??_C@_0BC@OPOCOHML@Is_Engine_Enabled?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Engine_Enabled@@3P6A_NPAVScriptableGameObj@@@ZA, eax ; Is_Engine_Enabled

; 364  : 	Stop_Timer = (ss)Address(tt,"Stop_Timer");

	push	OFFSET ??_C@_0L@OJPFPEND@Stop_Timer?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Stop_Timer@@3P6AXPAVScriptableGameObj@@H@ZA, eax ; Stop_Timer

; 365  : 	Create_2D_Wave_Sound_Dialog_Player = (cwsdp)Address(tt,"Create_2D_Wave_Sound_Dialog_Player");

	push	OFFSET ??_C@_0CD@IHAMJBGA@Create_2D_Wave_Sound_Dialog_Play@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_Wave_Sound_Dialog_Player@@3P6AHPAVScriptableGameObj@@PBD@ZA, eax ; Create_2D_Wave_Sound_Dialog_Player

; 366  : 	Force_Position_Update_Player = (fpup)Address(tt,"Force_Position_Update_Player");

	push	OFFSET ??_C@_0BN@BHCGCFMD@Force_Position_Update_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Position_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA, eax ; Force_Position_Update_Player

; 367  : 	Stop_Timer2 = (ss2)Address(tt,"Stop_Timer2");

	push	OFFSET ??_C@_0M@PCEDCCOL@Stop_Timer2?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Stop_Timer2@@3P6AXPAVScriptableGameObj@@PAVScriptClass@@H@ZA, eax ; Stop_Timer2

; 368  : 	Has_Timer = (htm)Address(tt,"Has_Timer");

	push	OFFSET ??_C@_09LECGCIKL@Has_Timer?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Has_Timer@@3P6A_NPAVScriptableGameObj@@PAVScriptClass@@H@ZA, eax ; Has_Timer

; 369  : 	Set_Background_Music_Player_Offset = (sbgmo)Address(tt,"Set_Background_Music_Player_Offset");

	push	OFFSET ??_C@_0CD@PCCCJNDK@Set_Background_Music_Player_Offs@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Background_Music_Player_Offset@@3P6AXPAVScriptableGameObj@@PBDM@ZA, eax ; Set_Background_Music_Player_Offset

; 370  : 	Set_Camera_Player = (setcam)Address(tt,"Set_Camera_Player");

	push	OFFSET ??_C@_0BC@EBLDIAJM@Set_Camera_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Camera_Player@@3P6AXPAVScriptableGameObj@@PBD@ZA, eax ; Set_Camera_Player

; 371  : 	Set_Definition_TranslationID_Player = (settran)Address(tt,"Set_Definition_TranslationID_Player");

	push	OFFSET ??_C@_0CE@DJELLLKJ@Set_Definition_TranslationID_Pla@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Definition_TranslationID_Player@@3P6AXPAVScriptableGameObj@@HH@ZA, eax ; Set_Definition_TranslationID_Player

; 372  : 	Set_Net_Update_Rate_Player = (setnur)Address(tt,"Set_Net_Update_Rate_Player");

	push	OFFSET ??_C@_0BL@EBCOCMCD@Set_Net_Update_Rate_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Net_Update_Rate_Player@@3P6AXPAVScriptableGameObj@@H@ZA, eax ; Set_Net_Update_Rate_Player

; 373  : 	Force_Orientation_Update = (fou)Address(tt,"Force_Orientation_Update");

	push	OFFSET ??_C@_0BJ@NMJAIGMB@Force_Orientation_Update?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Orientation_Update@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Force_Orientation_Update

; 374  : 	Force_Orientation_Update_Player = (foup)Address(tt,"Force_Orientation_Update_Player");

	push	OFFSET ??_C@_0CA@COJCCGGD@Force_Orientation_Update_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Orientation_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA, eax ; Force_Orientation_Update_Player

; 375  : 	Create_2D_Wave_Sound_Cinematic_Player = (cwscp)Address(tt,"Create_2D_Wave_Sound_Cinematic_Player");

	push	OFFSET ??_C@_0CG@BNPLHOGJ@Create_2D_Wave_Sound_Cinematic_P@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_Wave_Sound_Cinematic_Player@@3P6AHPAVScriptableGameObj@@PBD@ZA, eax ; Create_2D_Wave_Sound_Cinematic_Player

; 376  : 	Force_Turret_Update = (ftu)Address(tt,"Force_Turret_Update");

	push	OFFSET ??_C@_0BE@CDHJMHKH@Force_Turret_Update?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Turret_Update@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Force_Turret_Update

; 377  : 	Force_Turret_Update_Player = (ftup)Address(tt,"Force_Turret_Update_Player");

	push	OFFSET ??_C@_0BL@PJDBCFCK@Force_Turret_Update_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Turret_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA, eax ; Force_Turret_Update_Player

; 378  : 	Force_Velocity_Update = (fvu)Address(tt,"Force_Velocity_Update");

	push	OFFSET ??_C@_0BG@GCJJLOAF@Force_Velocity_Update?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Velocity_Update@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Force_Velocity_Update

; 379  : 	Force_Velocity_Update_Player = (fvup)Address(tt,"Force_Velocity_Update_Player");

	push	OFFSET ??_C@_0BN@OFEEDOD@Force_Velocity_Update_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Force_Velocity_Update_Player@@3P6AXPAVScriptableGameObj@@0@ZA, eax ; Force_Velocity_Update_Player

; 380  : 	Set_Camera_Host_Network = (schn)Address(tt,"Set_Camera_Host_Network");

	push	OFFSET ??_C@_0BI@OGKIMEOH@Set_Camera_Host_Network?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Camera_Host_Network@@3P6AXPAVScriptableGameObj@@@ZA, eax ; Set_Camera_Host_Network

; 381  : 	Get_Pathfind_Distance = (gpd)Address(tt,"Get_Pathfind_Distance");

	push	OFFSET ??_C@_0BG@NEGNEADK@Get_Pathfind_Distance?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Pathfind_Distance@@3P6AIABVVector3@@0P6AXABUPathfindDistanceRequest@@@ZPAVSmartGameObj@@PAX@ZA, eax ; Get_Pathfind_Distance

; 382  : 	Cancel_Get_Pathfind_Distance = (cgpd)Address(tt,"Cancel_Get_Pathfind_Distance");

	push	OFFSET ??_C@_0BN@GDJJNJCI@Cancel_Get_Pathfind_Distance?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Cancel_Get_Pathfind_Distance@@3P6A_NI@ZA, eax ; Cancel_Get_Pathfind_Distance

; 383  : 	Get_Pathfind_Distance_Async = (gpda)Address(tt, "Get_Pathfind_Distance_Async");

	push	OFFSET ??_C@_0BM@LJLCFGA@Get_Pathfind_Distance_Async?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Pathfind_Distance_Async@@3P6AIPAVSmartGameObj@@ABVVector3@@P6AXABUPathfindDistanceRequest@@@ZPAX@ZA, eax ; Get_Pathfind_Distance_Async

; 384  : 	Get_Pathfind_Distance_Blocking = (gpdb)Address(tt, "Get_Pathfind_Distance_Blocking");

	push	OFFSET ??_C@_0BP@PNNEBMGK@Get_Pathfind_Distance_Blocking?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Pathfind_Distance_Blocking@@3P6A_NPAVSmartGameObj@@ABVVector3@@AAMAAW4PathfindDistanceResult@@@ZA, eax ; Get_Pathfind_Distance_Blocking

; 385  : 	Get_Multiplayer_Spawn_Location = (gmsl)Address(tt, "Get_Multiplayer_Spawn_Location");

	push	OFFSET ??_C@_0BP@OGKOEPDC@Get_Multiplayer_Spawn_Location?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Multiplayer_Spawn_Location@@3P6AXHPAVSoldierGameObj@@AAVMatrix3D@@@ZA, eax ; Get_Multiplayer_Spawn_Location

; 386  : 	Enable_Spawners_By_Name = (esbn)Address(tt, "Enable_Spawners_By_Name");

	push	OFFSET ??_C@_0BI@FCBDKAOB@Enable_Spawners_By_Name?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Enable_Spawners_By_Name@@3P6AXPBD_N@ZA, eax ; Enable_Spawners_By_Name

; 387  : 	Is_Pathfind_Generated = (ipg)Address(tt, "Is_Pathfind_Generated");

	push	OFFSET ??_C@_0BG@ILOBNMKF@Is_Pathfind_Generated?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Pathfind_Generated@@3P6A_NXZA, eax ; Is_Pathfind_Generated

; 388  : 	Get_Closest_Pathfind_Spot = (gcps)Address(tt, "Get_Closest_Pathfind_Spot");

	push	OFFSET ??_C@_0BK@CBLGFILN@Get_Closest_Pathfind_Spot?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Closest_Pathfind_Spot@@3P6A_NABVVector3@@MPAV1@@ZA, eax ; Get_Closest_Pathfind_Spot

; 389  : 	Get_Closest_Pathfind_Spot_Size = (gcpss)Address(tt, "Get_Closest_Pathfind_Spot_Size");

	push	OFFSET ??_C@_0BP@COALLJHN@Get_Closest_Pathfind_Spot_Size?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Closest_Pathfind_Spot_Size@@3P6A_NABVVector3@@MPAV1@M@ZA, eax ; Get_Closest_Pathfind_Spot_Size

; 390  : 	Get_Radio_Command_String = (grcs)Address(tt, "Get_Radio_Command_String");

	push	OFFSET ??_C@_0BJ@JHELCOIP@Get_Radio_Command_String?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Radio_Command_String@@3P6AHH@ZA, eax ; Get_Radio_Command_String

; 391  : 	Set_Emot_Icon = (sei)Address(tt, "Set_Emot_Icon");

	push	OFFSET ??_C@_0O@FHPGGMKB@Set_Emot_Icon?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Emot_Icon@@3P6AHPAVSoldierGameObj@@H@ZA, eax ; Set_Emot_Icon

; 392  : 	Kill_Messages_Disabled = (kmd)Address(tt, "Kill_Messages_Disabled");

	push	OFFSET ??_C@_0BH@PKFFGFMH@Kill_Messages_Disabled?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Kill_Messages_Disabled@@3P6A_NXZA, eax ; Kill_Messages_Disabled

; 393  : 	Is_Sidebar_Enabled = (ise)Address(tt, "Is_Sidebar_Enabled");

	push	OFFSET ??_C@_0BD@OEAAAKCL@Is_Sidebar_Enabled?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Sidebar_Enabled@@3P6A_NXZA, eax ; Is_Sidebar_Enabled

; 394  : 	Is_Extras_Enabled = (iee)Address(tt, "Is_Extras_Enabled");

	push	OFFSET ??_C@_0BC@LMJNBGJO@Is_Extras_Enabled?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Extras_Enabled@@3P6A_NXZA, eax ; Is_Extras_Enabled

; 395  : 	Can_Build_Ground = (cbg)Address(tt, "Can_Build_Ground");

	push	OFFSET ??_C@_0BB@LONJLONK@Can_Build_Ground?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Can_Build_Ground@@3P6A_NH@ZA, eax ; Can_Build_Ground

; 396  : 	Can_Build_Air = (cba)Address(tt, "Can_Build_Air");

	push	OFFSET ??_C@_0O@BJJEMMOO@Can_Build_Air?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Can_Build_Air@@3P6A_NH@ZA, eax ; Can_Build_Air

; 397  : 	Can_Build_Naval = (cbn)Address(tt, "Can_Build_Naval");

	push	OFFSET ??_C@_0BA@JMDGKCJC@Can_Build_Naval?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Can_Build_Naval@@3P6A_NH@ZA, eax ; Can_Build_Naval

; 398  : 	Is_Soldier_Busy = (isb)Address(tt, "Is_Soldier_Busy");

	push	OFFSET ??_C@_0BA@NCMHCGDC@Is_Soldier_Busy?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Soldier_Busy@@3P6A_NPAVSoldierGameObj@@@ZA, eax ; Is_Soldier_Busy

; 399  : 	Is_On_Enemy_Pedestal = (ioep)Address(tt, "Is_On_Enemy_Pedestal");

	push	OFFSET ??_C@_0BF@HEIMOFCE@Is_On_Enemy_Pedestal?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_On_Enemy_Pedestal@@3P6A_NPAVBeaconGameObj@@@ZA, eax ; Is_On_Enemy_Pedestal

; 400  : 	Find_Closest_Poly_Position = (fcpp)Address(tt, "Find_Closest_Poly_Position");

	push	OFFSET ??_C@_0BL@NCKGFMPN@Find_Closest_Poly_Position?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Find_Closest_Poly_Position@@3P6AXPAVBuildingGameObj@@AAVVector3@@PAV2@@ZA, eax ; Find_Closest_Poly_Position

; 401  : 	Say_Dynamic_Dialogue = (sdd)Address(tt, "Say_Dynamic_Dialogue");

	push	OFFSET ??_C@_0BF@PCJAOOMO@Say_Dynamic_Dialogue?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Say_Dynamic_Dialogue@@3P6AXHPAVSoldierGameObj@@PAH@ZA, eax ; Say_Dynamic_Dialogue

; 402  : 	Say_Dynamic_Dialogue_Player = (sddp)Address(tt, "Say_Dynamic_Dialogue_Player");

	push	OFFSET ??_C@_0BM@HMJAADLA@Say_Dynamic_Dialogue_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Say_Dynamic_Dialogue_Player@@3P6AXPAVScriptableGameObj@@HPAVSoldierGameObj@@PAH@ZA, eax ; Say_Dynamic_Dialogue_Player

; 403  : 	Say_Dynamic_Dialogue_Team = (sddt)Address(tt, "Say_Dynamic_Dialogue_Team");

	push	OFFSET ??_C@_0BK@BOOJDLJL@Say_Dynamic_Dialogue_Team?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Say_Dynamic_Dialogue_Team@@3P6AXHPAVSoldierGameObj@@PAHH@ZA, eax ; Say_Dynamic_Dialogue_Team

; 404  : 	Enable_Letterbox_Player = (elp)Address(tt, "Enable_Letterbox_Player");

	push	OFFSET ??_C@_0BI@BMFOCDPE@Enable_Letterbox_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Enable_Letterbox_Player@@3P6AXPAVScriptableGameObj@@_NM@ZA, eax ; Enable_Letterbox_Player

; 405  : 	Create_Sound_Team = (cst)Address(tt, "Create_Sound_Team");

	push	OFFSET ??_C@_0BC@KKDEFCI@Create_Sound_Team?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_Sound_Team@@3P6AHPBDABVVector3@@PAVScriptableGameObj@@H@ZA, eax ; Create_Sound_Team

; 406  : 	Create_2D_Sound_Team = (c2dst)Address(tt, "Create_2D_Sound_Team");

	push	OFFSET ??_C@_0BF@PKKIEJOG@Create_2D_Sound_Team?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_Sound_Team@@3P6AHPBDH@ZA, eax ; Create_2D_Sound_Team

; 407  : 	Create_2D_WAV_Sound_Team = (c2dwst)Address(tt, "Create_2D_WAV_Sound_Team");

	push	OFFSET ??_C@_0BJ@FILHJFPE@Create_2D_WAV_Sound_Team?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_WAV_Sound_Team@@3P6AHPBDH@ZA, eax ; Create_2D_WAV_Sound_Team

; 408  : 	Create_2D_WAV_Sound_Team_Dialog = (c2dwstd)Address(tt, "Create_2D_WAV_Sound_Team_Dialog");

	push	OFFSET ??_C@_0CA@NOOIODNK@Create_2D_WAV_Sound_Team_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_WAV_Sound_Team_Dialog@@3P6AHPBDH@ZA, eax ; Create_2D_WAV_Sound_Team_Dialog

; 409  : 	Create_2D_WAV_Sound_Team_Cinematic = (c2dwstc)Address(tt, "Create_2D_WAV_Sound_Team_Cinematic");

	push	OFFSET ??_C@_0CD@NKPLJNPA@Create_2D_WAV_Sound_Team_Cinemat@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_2D_WAV_Sound_Team_Cinematic@@3P6AHPBDH@ZA, eax ; Create_2D_WAV_Sound_Team_Cinematic

; 410  : 	Create_3D_WAV_Sound_At_Bone_Team = (c3dwsbt)Address(tt, "Create_3D_WAV_Sound_At_Bone_Team");

	push	OFFSET ??_C@_0CB@OOHPDBDN@Create_3D_WAV_Sound_At_Bone_Team@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_3D_WAV_Sound_At_Bone_Team@@3P6AHPBDPAVScriptableGameObj@@0H@ZA, eax ; Create_3D_WAV_Sound_At_Bone_Team

; 411  : 	Create_3D_Sound_At_Bone_Team = (c3dsbt)Address(tt, "Create_3D_Sound_At_Bone_Team");

	push	OFFSET ??_C@_0BN@LENANALF@Create_3D_Sound_At_Bone_Team?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_3D_Sound_At_Bone_Team@@3P6AHPBDPAVScriptableGameObj@@0H@ZA, eax ; Create_3D_Sound_At_Bone_Team

; 412  : 	Stop_Sound_Player = (_Stop_Sound_Player)Address(tt, "Stop_Sound_Player");

	push	OFFSET ??_C@_0BC@KPFPLBNK@Stop_Sound_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Stop_Sound_Player@@3P6AHPAVScriptableGameObj@@H_N@ZA, eax ; Stop_Sound_Player

; 413  : 	Stop_Sound_Team = (_Stop_Sound_Team)Address(tt, "Stop_Sound_Team");

	push	OFFSET ??_C@_0BA@DEEOCNAN@Stop_Sound_Team?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Stop_Sound_Team@@3P6AHH_NH@ZA, eax ; Stop_Sound_Team

; 414  : 	Set_Subobject_Animation = (ssa)Address(tt,"Set_Subobject_Animation");

	push	OFFSET ??_C@_0BI@PDALEOGH@Set_Subobject_Animation?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Subobject_Animation@@3P6AHPAVScriptableGameObj@@PBD_N1MM2@ZA, eax ; Set_Subobject_Animation

; 415  : 	Set_Time_Scale = (sts)Address(tt,"Set_Time_Scale");

	push	OFFSET ??_C@_0P@GONKBC@Set_Time_Scale?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Time_Scale@@3P6AXM@ZA, eax ; Set_Time_Scale

; 416  : 	Set_Subobject_Animation_Player = (ssap)Address(tt,"Set_Subobject_Animation_Player");

	push	OFFSET ??_C@_0BP@KJNFPFIH@Set_Subobject_Animation_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Subobject_Animation_Player@@3P6AHPAVScriptableGameObj@@0PBD_N1MM2@ZA, eax ; Set_Subobject_Animation_Player

; 417  : 	Write_File_Async = (wfa)Address(tt, "Write_File_Async");

	push	OFFSET ??_C@_0BB@BKPJBBLB@Write_File_Async?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Write_File_Async@@3P6AHPBD0@ZA, eax ; Write_File_Async

; 418  : 	AddDialogHook = (adh)Address(tt, "AddDialogHook");

	push	OFFSET ??_C@_0O@DGJINLIG@AddDialogHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?AddDialogHook@@3P6AHP6AXHHHW4DialogMessageType@@@Z@ZA, eax ; AddDialogHook

; 419  : 	RemoveDialogHook = (rdh)Address(tt, "RemoveDialogHook");

	push	OFFSET ??_C@_0BB@EMOCKGK@RemoveDialogHook?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?RemoveDialogHook@@3P6AXH@ZA, eax ; RemoveDialogHook

; 420  : 	Create_Menu_Dialog = (cmd)Address(tt, "Create_Menu_Dialog");

	push	OFFSET ??_C@_0BD@OIKKAPBF@Create_Menu_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_Menu_Dialog@@3P6APAVScriptedMenuDialogClass@@H@ZA, eax ; Create_Menu_Dialog

; 421  : 	Create_Popup_Dialog = (cpd)Address(tt, "Create_Popup_Dialog");

	push	OFFSET ??_C@_0BE@HIIDPCFF@Create_Popup_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Create_Popup_Dialog@@3P6APAVScriptedPopupDialogClass@@H@ZA, eax ; Create_Popup_Dialog

; 422  : 	Find_Dialog = (idlg)Address(tt, "Find_Dialog");

	push	OFFSET ??_C@_0M@BBGAOOPP@Find_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Find_Dialog@@3P6APAVScriptedDialogClass@@H@ZA, eax ; Find_Dialog

; 423  : 	Show_Dialog = (dlg)Address(tt, "Show_Dialog");

	push	OFFSET ??_C@_0M@DONKLOFJ@Show_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Show_Dialog@@3P6AXPAVScriptedDialogClass@@@ZA, eax ; Show_Dialog

; 424  : 	Hide_Dialog = (dlg)Address(tt, "Hide_Dialog");

	push	OFFSET ??_C@_0M@PIAILJGL@Hide_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Hide_Dialog@@3P6AXPAVScriptedDialogClass@@@ZA, eax ; Hide_Dialog

; 425  : 	Delete_Dialog = (dlg)Address(tt, "Delete_Dialog");

	push	OFFSET ??_C@_0O@CPCMOEMM@Delete_Dialog?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Delete_Dialog@@3P6AXPAVScriptedDialogClass@@@ZA, eax ; Delete_Dialog

; 426  : 	Display_HUD_Weapon_Grant_Player = (dhwg)Address(tt, "Display_HUD_Weapon_Grant_Player");

	push	OFFSET ??_C@_0CA@KKFNMAJB@Display_HUD_Weapon_Grant_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_HUD_Weapon_Grant_Player@@3P6AXPAVScriptableGameObj@@HH@ZA, eax ; Display_HUD_Weapon_Grant_Player

; 427  : 	Display_HUD_Ammo_Grant_Player = (dhwg)Address(tt, "Display_HUD_Ammo_Grant_Player");

	push	OFFSET ??_C@_0BO@OLOLHOFI@Display_HUD_Ammo_Grant_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Display_HUD_Ammo_Grant_Player@@3P6AXPAVScriptableGameObj@@HH@ZA, eax ; Display_HUD_Ammo_Grant_Player

; 428  : 	Get_Repository_URL = (gru)Address(tt, "Get_Repository_URL");

	push	OFFSET ??_C@_0BD@HCKEHOGM@Get_Repository_URL?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Repository_URL@@3P6APBDXZA, eax ; Get_Repository_URL

; 429  : 	Set_Repository_URL = (sru)Address(tt, "Set_Repository_URL");

	push	OFFSET ??_C@_0BD@IIIOEIIE@Set_Repository_URL?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Repository_URL@@3P6AXPBD@ZA, eax ; Set_Repository_URL

; 430  : 	Get_Screenshot_URL = (gru)Address(tt, "Get_Screenshot_URL");

	push	OFFSET ??_C@_0BD@MJFKCMOJ@Get_Screenshot_URL?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Get_Screenshot_URL@@3P6APBDXZA, eax ; Get_Screenshot_URL

; 431  : 	Set_Screenshot_URL = (sru)Address(tt, "Set_Screenshot_URL");

	push	OFFSET ??_C@_0BD@DDHABKAB@Set_Screenshot_URL?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Screenshot_URL@@3P6AXPBD@ZA, eax ; Set_Screenshot_URL

; 432  : 	Take_Screenshot = (tss)Address(tt, "Take_Screenshot");

	push	OFFSET ??_C@_0BA@FEKFIPBI@Take_Screenshot?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Take_Screenshot@@3P6AXH@ZA, eax ; Take_Screenshot

; 433  : 	Is_In_Pathfind_Sector = (iips)Address(tt, "Is_In_Pathfind_Sector");

	push	OFFSET ??_C@_0BG@DMAOAPPG@Is_In_Pathfind_Sector?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_In_Pathfind_Sector@@3P6A_NVVector3@@M@ZA, eax ; Is_In_Pathfind_Sector

; 434  : 	Set_Gravity_Multiplier = (sgm)Address(tt, "Set_Gravity_Multiplier");

	push	OFFSET ??_C@_0BH@KBPEPOOK@Set_Gravity_Multiplier?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Gravity_Multiplier@@3P6AXPAVScriptableGameObj@@M@ZA, eax ; Set_Gravity_Multiplier

; 435  : 	Is_Gameplay_Allowed = (iga)Address(tt, "Is_Gameplay_Allowed");

	push	OFFSET ??_C@_0BE@NEFJFAP@Is_Gameplay_Allowed?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Is_Gameplay_Allowed@@3P6A_NXZA, eax ; Is_Gameplay_Allowed

; 436  : 	Set_Gameplay_Allowed = (sga)Address(tt, "Set_Gameplay_Allowed");

	push	OFFSET ??_C@_0BF@EHLPAFM@Set_Gameplay_Allowed?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Set_Gameplay_Allowed@@3P6AX_N@ZA, eax ; Set_Gameplay_Allowed

; 437  : 	Print_Client_Console = (pcc)Address(tt, "Print_Client_Console");

	push	OFFSET ??_C@_0BF@GGGEEGBG@Print_Client_Console?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Print_Client_Console@@3P6AXPBDVVector4@@@ZA, eax ; Print_Client_Console

; 438  : 	Print_Client_Console_Player = (pccp)Address(tt, "Print_Client_Console_Player");

	push	OFFSET ??_C@_0BM@JOGFFNHP@Print_Client_Console_Player?$AA@
	mov	eax, DWORD PTR ?tt@@3PAUHINSTANCE__@@A	; tt
	push	eax
	call	?GetProcAddressCheck@@YAP6GHXZPAUHINSTANCE__@@PBD@Z ; GetProcAddressCheck
	add	esp, 8
	mov	DWORD PTR ?Print_Client_Console_Player@@3P6AXPAVScriptableGameObj@@PBDVVector4@@@ZA, eax ; Print_Client_Console_Player

; 439  : 
; 440  : 
; 441  : 	DA::Init();

	call	?Init@DA@@SAXXZ				; DA::Init

; 442  : 
; 443  : 	//Write_Renlog(SetScriptCommands)
; 444  : 	addConnectionAcceptanceFilter(&defaultConnectionAcceptanceFilter);

	push	OFFSET ?defaultConnectionAcceptanceFilter@@3VDefaultConnectionAcceptanceFilter@@A ; defaultConnectionAcceptanceFilter
	call	DWORD PTR ?addConnectionAcceptanceFilter@@3P6AXPAVConnectionAcceptanceFilter@@@ZA ; addConnectionAcceptanceFilter
	add	esp, 4

; 445  : 	//Write_GameLog()
; 446  : 	
; 447  : 	return (SetScriptCommands) (commands);

	mov	eax, DWORD PTR _commands$[ebp]
	push	eax
	call	DWORD PTR ?SetScriptCommands@@3P6A_NPAVScriptCommandsClass@@@ZA ; SetScriptCommands
	add	esp, 4
$LN3@Set_Script:
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dllmain.cpp
;	COMDAT _Get_Script_Param_Description
_TEXT	SEGMENT
_n$ = -4						; size = 4
_Number$ = 8						; size = 4
_Get_Script_Param_Description PROC			; COMDAT
...
; 181  : 	if (Number < OldCount)

	mov	eax, DWORD PTR _Number$[ebp]
	cmp	eax, DWORD PTR ?OldCount@@3IA		; OldCount
	jae	SHORT $LN1@Get_Script

; 182  : 	{
; 183  : 		return (GetScriptParamDescription) (Number);

	mov	eax, DWORD PTR _Number$[ebp]
	push	eax
	call	DWORD PTR ?GetScriptParamDescription@@3P6APADH@ZA ; GetScriptParamDescription
	add	esp, 4
	jmp	SHORT $LN2@Get_Script
$LN1@Get_Script:

; 184  : 	}
; 185  : 	int n = Number - OldCount;

	mov	eax, DWORD PTR _Number$[ebp]
	sub	eax, DWORD PTR ?OldCount@@3IA		; OldCount
	mov	DWORD PTR _n$[ebp], eax

; 186  : 	return ScriptRegistrar::GetScriptFactory(n)->GetParamDescription();

	mov	eax, DWORD PTR _n$[ebp]
	push	eax
	call	?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@H@Z ; ScriptRegistrar::GetScriptFactory
	add	esp, 4
	mov	ecx, eax
	call	?GetParamDescription@ScriptFactory@@QAEPBDXZ ; ScriptFactory::GetParamDescription
$LN2@Get_Script:
...
; 187  : }
	...
	pop	ebp
	ret	0
_Get_Script_Param_Description ENDP
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dllmain.cpp
;	COMDAT _Get_Script_Name
_TEXT	SEGMENT
_n$ = -4						; size = 4
_Number$ = 8						; size = 4
_Get_Script_Name PROC					; COMDAT
...
; 172  : 	{
; 173  : 		return (GetScriptName) (Number);

	mov	eax, DWORD PTR _Number$[ebp]
	push	eax
	call	DWORD PTR ?GetScriptName@@3P6APADH@ZA	; GetScriptName
	add	esp, 4
	jmp	SHORT $LN2@Get_Script
$LN1@Get_Script:

; 174  : 	}
; 175  : 	int n = Number - OldCount;

	mov	eax, DWORD PTR _Number$[ebp]
	sub	eax, DWORD PTR ?OldCount@@3IA		; OldCount
	mov	DWORD PTR _n$[ebp], eax

; 176  : 	return ScriptRegistrar::GetScriptFactory(n)->GetName();
	...
	add	esp, 4
	mov	ecx, eax
	call	?GetName@ScriptFactory@@QAEPBDXZ	; ScriptFactory::GetName
$LN2@Get_Script:
...
; 177  : }
	...
	pop	ebp
	ret	0
_Get_Script_Name ENDP
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dllmain.cpp
;	COMDAT _Get_Script_Count
_TEXT	SEGMENT
_sn$ = -4						; size = 4
_Get_Script_Count PROC					; COMDAT
...
; 165  : 	sn = ScriptRegistrar::Count();

	call	?Count@ScriptRegistrar@@SAHXZ		; ScriptRegistrar::Count
	mov	DWORD PTR _sn$[ebp], eax

; 166  : 	return (GetScriptCount) () + sn;

	call	DWORD PTR ?GetScriptCount@@3P6AHXZA	; GetScriptCount
...
; 167  : }
	...
	pop	ebp
	ret	0
_Get_Script_Count ENDP
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dllmain.cpp
;	COMDAT _Destroy_Script
_TEXT	SEGMENT
tv85 = -76						; size = 4
$T1 = -72						; size = 4
$T2 = -68						; size = 4
_scr$ = 8						; size = 4
_Destroy_Script PROC					; COMDAT
...
; 156  : 	if (scr)
	...
	je	SHORT $LN2@Destroy_Sc

; 157  : 	{
; 158  : 		delete scr;

	push	OFFSET ??_C@_0P@FAMANIPC@Destroy_Script?$AA@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Destroy_Script@@9@4JA
	add	eax, 3
	push	eax
	push	OFFSET ??_C@_0DF@BCGEFFMI@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN7@Destroy_Sc
	xor	edx, edx
	jne	SHORT $LN4@Destroy_Sc
	mov	eax, DWORD PTR ?__LINE__Var@?1??Destroy_Script@@9@4JA
	add	eax, 3
	push	eax
	push	OFFSET ??_C@_1GK@GFIFGELI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
	push	OFFSET ??_C@_1M@HLGKFCJM@?$AAf?$AAa?$AAl?$AAs?$AAe?$AA?$AA@
	call	DWORD PTR __imp___wassert
	add	esp, 12					; 0000000cH
$LN4@Destroy_Sc:
	jmp	SHORT $LN2@Destroy_Sc
$LN7@Destroy_Sc:
	mov	edx, DWORD PTR _scr$[ebp]
	mov	DWORD PTR $T2[ebp], edx
	mov	eax, DWORD PTR $T2[ebp]
	mov	DWORD PTR $T1[ebp], eax
	cmp	DWORD PTR $T1[ebp], 0
	je	SHORT $LN5@Destroy_Sc
	push	1
	mov	ecx, DWORD PTR $T1[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T1[ebp]
...
; 142  : 	if (!ScriptName)
	...
	cmp	DWORD PTR _ScriptName$[ebp], 0
	jne	SHORT $LN2@Create_Scr

; 143  : 	{
; 144  : 		return 0;

	xor	eax, eax
	jmp	SHORT $LN3@Create_Scr
$LN2@Create_Scr:

; 145  : 	}
; 146  : 	ScriptClass *scr = ScriptRegistrar::CreateScript(ScriptName);

	mov	eax, DWORD PTR _ScriptName$[ebp]
	push	eax
	call	?CreateScript@ScriptRegistrar@@SAPAVScriptImpClass@@PBD@Z ; ScriptRegistrar::CreateScript
	add	esp, 4
	mov	DWORD PTR _scr$[ebp], eax

; 147  : 	if (scr)

	cmp	DWORD PTR _scr$[ebp], 0
	je	SHORT $LN1@Create_Scr

; 148  : 	{
; 149  : 		return scr;

	mov	eax, DWORD PTR _scr$[ebp]
	jmp	SHORT $LN3@Create_Scr
$LN1@Create_Scr:

; 150  : 	}
; 151  : 	return (CreateScript) (ScriptName);

	mov	eax, DWORD PTR _ScriptName$[ebp]
	push	eax
	call	DWORD PTR ?CreateScript@@3P6APAVScriptClass@@PBD@ZA ; CreateScript
	add	esp, 4
$LN3@Create_Scr:
...
$T1 = -616						; size = 4
$T2 = -612						; size = 4
_errorMessage$3 = -544					; size = 4
_f$4 = -540						; size = 4
_path$5 = -536						; size = 260
_path2$6 = -276						; size = 4
_f$7 = -272						; size = 4
_path$8 = -268						; size = 260
_path2$9 = -8						; size = 4
_LastError$ = -4					; size = 4
_hinstDLL$ = 8						; size = 4
...
; 65   : 			if (Exe != 1)
; 66   : 			{
; 67   : 				MessageBox(HWND_DESKTOP, "Fatal error: Dragonade only works on the FDS. Please replace your scripts.dll with an appropriate version for the Renegade client.", "Renegade", MB_OK | MB_ICONERROR);
; 68   : 				exit(0);
; 69   : 			}
; 70   : 			*/
; 71   : 
...
; 73   : 			{
; 74   : 				if (GetFileAttributes("scripts2.dll") == 0xFFFFFFFF)

	push	OFFSET ??_C@_0N@CNHOAEDG@scripts2?4dll?$AA@
	call	DWORD PTR __imp__GetFileAttributesA@4
	cmp	eax, -1
	jne	$LN8@DllMain

; 75   : 				{
; 76   : 					const char *path2 = Get_File_Path();

	call	?Get_File_Path@@YAPBDXZ			; Get_File_Path
	mov	DWORD PTR _path2$9[ebp], eax

; 77   : 					char path[MAX_PATH];
; 78   : 					strcpy(path,path2);

	mov	eax, DWORD PTR _path2$9[ebp]
	mov	DWORD PTR tv74[ebp], eax
	lea	ecx, DWORD PTR _path$8[ebp]
...
$LN20@DllMain:
	...
	jne	SHORT $LN20@DllMain

; 79   : 					strcat(path,"dllload.txt");

	lea	eax, DWORD PTR _path$8[ebp]
	add	eax, -1
	mov	DWORD PTR tv276[ebp], eax
$LL28@DllMain:
	mov	ecx, DWORD PTR tv276[ebp]
	mov	dl, BYTE PTR [ecx+1]
	mov	BYTE PTR tv279[ebp], dl
	add	DWORD PTR tv276[ebp], 1
	cmp	BYTE PTR tv279[ebp], 0
	jne	SHORT $LL28@DllMain
	mov	edi, DWORD PTR tv276[ebp]
	mov	eax, DWORD PTR ??_C@_0M@LIEOGHOI@dllload?4txt?$AA@
	mov	DWORD PTR [edi], eax
	mov	ecx, DWORD PTR ??_C@_0M@LIEOGHOI@dllload?4txt?$AA@+4
	mov	DWORD PTR [edi+4], ecx
	mov	edx, DWORD PTR ??_C@_0M@LIEOGHOI@dllload?4txt?$AA@+8
	mov	DWORD PTR [edi+8], edx

; 80   : 					FILE *f = fopen(path,"at");
	...
	add	esp, 8
	mov	DWORD PTR _f$7[ebp], eax

; 81   : 					if (f)

	cmp	DWORD PTR _f$7[ebp], 0
	je	SHORT $LN7@DllMain

; 82   : 					{
; 83   : 						fprintf(f,"[scripts2.dll] Module not found, unable to continue.\n");

	push	OFFSET ??_C@_0DG@IDAKMICH@?$FLscripts2?4dll?$FN?5Module?5not?5found?0@
...
; 85   : 					}
; 86   : 					MessageBox(NULL,"scripts2.dll was not found. Are you sure you installed scripts.dll correctly?","Error",MB_OK|MB_ICONEXCLAMATION|MB_TOPMOST);

	push	262192					; 00040030H
	push	OFFSET ??_C@_05NAOIJFC@Error?$AA@
	push	OFFSET ??_C@_0EO@ODMDBBCA@scripts2?4dll?5was?5not?5found?4?5Are?5@
	push	0
	call	DWORD PTR __imp__MessageBoxA@16

; 87   : 					ExitProcess(HRESULT_FROM_WIN32(ERROR_FILE_NOT_FOUND));
...
; 88   : 				}
; 89   : 				tt = GetModuleHandle("Bandtest.dll");

	push	OFFSET ??_C@_0N@HOEEPKHH@Bandtest?4dll?$AA@
	call	DWORD PTR __imp__GetModuleHandleA@4
	mov	DWORD PTR ?tt@@3PAUHINSTANCE__@@A, eax	; tt
$LN10@DllMain:

; 90   : 			}
; 91   : 			wwscripts = LoadLibrary("scripts2.dll");

	push	OFFSET ??_C@_0N@CNHOAEDG@scripts2?4dll?$AA@
	call	DWORD PTR __imp__LoadLibraryA@4
	mov	DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A, eax ; wwscripts
...
; 93   : 			if (wwscripts)
	...
	cmp	DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A, 0 ; wwscripts
	je	$LN6@DllMain

; 94   : 			{
; 95   : 				CreateScript = (cs) GetProcAddress(wwscripts,"Create_Script");

	push	OFFSET ??_C@_0O@MLAMJOAE@Create_Script?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?CreateScript@@3P6APAVScriptClass@@PBD@ZA, eax ; CreateScript

; 96   : 				DestroyScript = (ds) GetProcAddress(wwscripts,"Destroy_Script");

	push	OFFSET ??_C@_0P@FAMANIPC@Destroy_Script?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?DestroyScript@@3P6AXPAVScriptClass@@@ZA, eax ; DestroyScript

; 97   : 				GetScriptCount = (gsc) GetProcAddress(wwscripts,"Get_Script_Count");

	push	OFFSET ??_C@_0BB@FPCCPBMO@Get_Script_Count?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?GetScriptCount@@3P6AHXZA, eax ; GetScriptCount

; 98   : 				GetScriptName = (gsn) GetProcAddress(wwscripts,"Get_Script_Name");

	push	OFFSET ??_C@_0BA@JJJPOLJN@Get_Script_Name?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?GetScriptName@@3P6APADH@ZA, eax ; GetScriptName

; 99   : 				GetScriptParamDescription = (gspd) GetProcAddress(wwscripts,"Get_Script_Param_Description");

	push	OFFSET ??_C@_0BN@LOHDBOCD@Get_Script_Param_Description?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?GetScriptParamDescription@@3P6APADH@ZA, eax ; GetScriptParamDescription

; 100  : 				SetScriptCommands = (ssc) GetProcAddress(wwscripts,"Set_Script_Commands");

	push	OFFSET ??_C@_0BE@HENBLHN@Set_Script_Commands?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?SetScriptCommands@@3P6A_NPAVScriptCommandsClass@@@ZA, eax ; SetScriptCommands

; 101  : 				SetRequestDestroyFunc = (srdf) GetProcAddress(wwscripts,"Set_Request_Destroy_Func");

	push	OFFSET ??_C@_0BJ@JJJNDFHO@Set_Request_Destroy_Func?$AA@
	mov	eax, DWORD PTR ?wwscripts@@3PAUHINSTANCE__@@A ; wwscripts
	push	eax
	call	DWORD PTR __imp__GetProcAddress@8
	mov	DWORD PTR ?SetRequestDestroyFunc@@3P6AXP6AXPAVScriptClass@@@Z@ZA, eax ; SetRequestDestroyFunc

; 102  : 				OldCount = (GetScriptCount) ();

	call	DWORD PTR ?GetScriptCount@@3P6AHXZA	; GetScriptCount
	mov	DWORD PTR ?OldCount@@3IA, eax		; OldCount
...
; 105  : 			{
; 106  : 				const char *path2 = Get_File_Path();

	call	?Get_File_Path@@YAPBDXZ			; Get_File_Path
	mov	DWORD PTR _path2$6[ebp], eax

; 107  : 				char path[MAX_PATH];
; 108  : 				strcpy(path,path2);

	mov	eax, DWORD PTR _path2$6[ebp]
	mov	DWORD PTR tv161[ebp], eax
	lea	ecx, DWORD PTR _path$5[ebp]
...
$LN21@DllMain:
	...
	cmp	BYTE PTR tv164[ebp], 0
	jne	SHORT $LN21@DllMain

; 109  : 				strcat(path,"dllload.txt");

	lea	eax, DWORD PTR _path$5[ebp]
	add	eax, -1
	mov	DWORD PTR tv324[ebp], eax
$LL29@DllMain:
	mov	ecx, DWORD PTR tv324[ebp]
	mov	dl, BYTE PTR [ecx+1]
	mov	BYTE PTR tv327[ebp], dl
	add	DWORD PTR tv324[ebp], 1
	cmp	BYTE PTR tv327[ebp], 0
	jne	SHORT $LL29@DllMain
...
; 111  : 				if (f)
	...
	cmp	DWORD PTR _f$4[ebp], 0
	je	$LN4@DllMain

; 112  : 				{
; 113  : 					char *errorMessage = new char[2048]; //Ugly, but whatever.

	push	OFFSET ??_C@_07JLKLLPCJ@DllMain?$AA@
	mov	eax, DWORD PTR ?__LINE__Var@?1??DllMain@@9@12@4JA
	...
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN23@DllMain
	xor	edx, edx
	jne	SHORT $LN22@DllMain
	mov	eax, DWORD PTR ?__LINE__Var@?1??DllMain@@9@12@4JA
	add	eax, 56					; 00000038H
	push	eax
	push	OFFSET ??_C@_1GK@GFIFGELI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
$LN24@DllMain:
	...
	mov	DWORD PTR _errorMessage$3[ebp], eax

; 114  : 					FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM,NULL,LastError,0,errorMessage,2048,NULL);

	push	0
	push	2048					; 00000800H
	mov	eax, DWORD PTR _errorMessage$3[ebp]
	push	eax
	push	0
...
; 115  : 					fprintf(f,"[scripts2.dll] Failed to load,  error %d. %s\n",LastError,errorMessage);

	mov	eax, DWORD PTR _errorMessage$3[ebp]
	push	eax
	mov	ecx, DWORD PTR _LastError$[ebp]
	push	ecx
	push	OFFSET ??_C@_0CO@NDBPENPI@?$FLscripts2?4dll?$FN?5Failed?5to?5load?0?5?5@
	mov	edx, DWORD PTR _f$4[ebp]
	push	edx
	call	DWORD PTR __imp__fprintf
	add	esp, 16					; 00000010H

; 116  : 					delete[] errorMessage;
	...
	add	esp, 12					; 0000000cH
$LN25@DllMain:
	jmp	SHORT $LN27@DllMain
$LN26@DllMain:
	mov	edx, DWORD PTR _errorMessage$3[ebp]
	mov	DWORD PTR $T2[ebp], edx
	mov	eax, DWORD PTR $T2[ebp]
	push	eax
	call	??_V@YAXPAX@Z				; operator delete[]
...
; 118  : 				}
; 119  : 				MessageBox(NULL,"Unfortunately, there was an error loading scripts2.dll. Please report this bug!","Error",MB_OK|MB_ICONEXCLAMATION);

	push	48					; 00000030H
	push	OFFSET ??_C@_05NAOIJFC@Error?$AA@
	push	OFFSET ??_C@_0FA@INGEHCNO@Unfortunately?0?5there?5was?5an?5erro@
	push	0
	call	DWORD PTR __imp__MessageBoxA@16

; 120  : 				ExitProcess(LastError);
...
; 125  : 			{
; 126  : 				removeConnectionAcceptanceFilter(&defaultConnectionAcceptanceFilter);

	push	OFFSET ?defaultConnectionAcceptanceFilter@@3VDefaultConnectionAcceptanceFilter@@A ; defaultConnectionAcceptanceFilter
	call	DWORD PTR ?removeConnectionAcceptanceFilter@@3P6A_NPAVConnectionAcceptanceFilter@@@ZA ; removeConnectionAcceptanceFilter
	add	esp, 4
$LN2@DllMain:

; 127  : 			}
; 128  : #ifdef SSGM
; 129  : 			SSGMGameManager::Shutdown();
; 130  : #endif			DestroyExpVehFacClass();
; 131  : 			FreeLibrary(wwscripts);
...
; 132  : 			DA::Shutdown();
	...
	call	?Shutdown@DA@@SAXXZ			; DA::Shutdown
$LN16@DllMain:
...
; 43   : 	FARPROC x = GetProcAddress(hModule,lpProcName);
...
; 45   : 	{
; 46   : 		MessageBox(NULL,"Error getting function address from bandtest.dll",lpProcName,MB_OK|MB_ICONEXCLAMATION|MB_TOPMOST);

	push	262192					; 00040030H
	mov	eax, DWORD PTR _lpProcName$[ebp]
	push	eax
	push	OFFSET ??_C@_0DB@KLDDDEO@Error?5getting?5function?5address?5f@
	push	0
	call	DWORD PTR __imp__MessageBoxA@16
$LN1@GetProcAdd:
