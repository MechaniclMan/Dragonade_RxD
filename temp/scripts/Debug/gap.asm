; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\gap.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Created@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z ; RA_Global_Gap_Controller::Created
PUBLIC	?Custom@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@HH0@Z ; RA_Global_Gap_Controller::Custom
PUBLIC	?Timer_Expired@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@H@Z ; RA_Global_Gap_Controller::Timer_Expired
PUBLIC	?Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z ; RA_Global_Gap_Controller::Destroyed
PUBLIC	?Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z ; RA_Global_Gap_Controller::Add_Generator
PUBLIC	?Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z ; RA_Global_Gap_Controller::Remove_Generator
PUBLIC	?Update_Generator@RA_Global_Gap_Controller@@AAEXK_NH@Z ; RA_Global_Gap_Controller::Update_Generator
PUBLIC	?Update_Generator@RA_Global_Gap_Controller@@AAEXK_N@Z ; RA_Global_Gap_Controller::Update_Generator
PUBLIC	??0RA_Global_Gap_Controller@@QAE@XZ		; RA_Global_Gap_Controller::RA_Global_Gap_Controller
PUBLIC	??1RA_Global_Gap_Controller@@UAE@XZ		; RA_Global_Gap_Controller::~RA_Global_Gap_Controller
PUBLIC	??_GRA_Global_Gap_Controller@@UAEPAXI@Z		; RA_Global_Gap_Controller::`scalar deleting destructor'
PUBLIC	?Created@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@@Z ; RA_Gap_Generator_Building::Created
PUBLIC	?Timer_Expired@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@H@Z ; RA_Gap_Generator_Building::Timer_Expired
PUBLIC	?Killed@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@0@Z ; RA_Gap_Generator_Building::Killed
PUBLIC	??0RA_Gap_Generator_Building@@QAE@XZ		; RA_Gap_Generator_Building::RA_Gap_Generator_Building
PUBLIC	??1RA_Gap_Generator_Building@@UAE@XZ		; RA_Gap_Generator_Building::~RA_Gap_Generator_Building
PUBLIC	??_GRA_Gap_Generator_Building@@UAEPAXI@Z	; RA_Gap_Generator_Building::`scalar deleting destructor'
PUBLIC	?Created@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z ; RA_Gap_Generator_Vehicle::Created
PUBLIC	?Custom@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@HH0@Z ; RA_Gap_Generator_Vehicle::Custom
PUBLIC	?Destroyed@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z ; RA_Gap_Generator_Vehicle::Destroyed
PUBLIC	??0RA_Gap_Generator_Vehicle@@QAE@XZ		; RA_Gap_Generator_Vehicle::RA_Gap_Generator_Vehicle
PUBLIC	??1RA_Gap_Generator_Vehicle@@UAE@XZ		; RA_Gap_Generator_Vehicle::~RA_Gap_Generator_Vehicle
PUBLIC	??_GRA_Gap_Generator_Vehicle@@UAEPAXI@Z		; RA_Gap_Generator_Vehicle::`scalar deleting destructor'
PUBLIC	??0RA_Gap_Generator_Ignored@@QAE@XZ		; RA_Gap_Generator_Ignored::RA_Gap_Generator_Ignored
PUBLIC	??1RA_Gap_Generator_Ignored@@UAE@XZ		; RA_Gap_Generator_Ignored::~RA_Gap_Generator_Ignored
PUBLIC	??_GRA_Gap_Generator_Ignored@@UAEPAXI@Z		; RA_Gap_Generator_Ignored::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Global_Gap_Controller>::ScriptRegistrant<RA_Global_Gap_Controller>
PUBLIC	?Create@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<RA_Global_Gap_Controller>::Create
PUBLIC	??1?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAE@XZ ; ScriptRegistrant<RA_Global_Gap_Controller>::~ScriptRegistrant<RA_Global_Gap_Controller>
PUBLIC	??_G?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAXI@Z ; ScriptRegistrant<RA_Global_Gap_Controller>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Gap_Generator_Building>::ScriptRegistrant<RA_Gap_Generator_Building>
PUBLIC	?Create@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<RA_Gap_Generator_Building>::Create
PUBLIC	??1?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAE@XZ ; ScriptRegistrant<RA_Gap_Generator_Building>::~ScriptRegistrant<RA_Gap_Generator_Building>
PUBLIC	??_G?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAXI@Z ; ScriptRegistrant<RA_Gap_Generator_Building>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::ScriptRegistrant<RA_Gap_Generator_Vehicle>
PUBLIC	?Create@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::Create
PUBLIC	??1?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAE@XZ ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::~ScriptRegistrant<RA_Gap_Generator_Vehicle>
PUBLIC	??_G?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAXI@Z ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Gap_Generator_Ignored>::ScriptRegistrant<RA_Gap_Generator_Ignored>
PUBLIC	?Create@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<RA_Gap_Generator_Ignored>::Create
PUBLIC	??1?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAE@XZ ; ScriptRegistrant<RA_Gap_Generator_Ignored>::~ScriptRegistrant<RA_Gap_Generator_Ignored>
PUBLIC	??_G?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAXI@Z ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`scalar deleting destructor'
...
PUBLIC	??_7RA_Global_Gap_Controller@@6B@		; RA_Global_Gap_Controller::`vftable'
PUBLIC	??_7RA_Gap_Generator_Building@@6B@		; RA_Gap_Generator_Building::`vftable'
PUBLIC	??_7RA_Gap_Generator_Vehicle@@6B@		; RA_Gap_Generator_Vehicle::`vftable'
PUBLIC	??_7RA_Gap_Generator_Ignored@@6B@		; RA_Gap_Generator_Ignored::`vftable'
PUBLIC	??_C@_0N@JONNKAKM@Timer_Number?$AA@		; `string'
PUBLIC	??_C@_0N@PNJGAIBD@Update_Delay?$AA@		; `string'
PUBLIC	?__LINE__Var@?1??Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z@4JA ; `RA_Global_Gap_Controller::Destroyed'::`2'::__LINE__Var
PUBLIC	??_C@_0CE@KOACAIDO@RA_Global_Gap_Controller?3?3Destro@ ; `string'
PUBLIC	??_C@_0DB@GBJOEKHD@x?3?2github?2renegade?2dragonade_rxd@ ; `string'
PUBLIC	??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@ ; `string'
PUBLIC	?__LINE__Var@?1??Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z@4JA ; `RA_Global_Gap_Controller::Add_Generator'::`2'::__LINE__Var
PUBLIC	??_C@_0CI@DPDPGNEG@RA_Global_Gap_Controller?3?3Add_Ge@ ; `string'
PUBLIC	?__LINE__Var@?1??Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z@4JA ; `RA_Global_Gap_Controller::Remove_Generator'::`2'::__LINE__Var
PUBLIC	??_C@_0CL@KPHJEMGJ@RA_Global_Gap_Controller?3?3Remove@ ; `string'
PUBLIC	??_C@_0P@LDJAAGFD@Gap_Controller?$AA@		; `string'
PUBLIC	??_C@_04GBPANCCF@Team?$AA@			; `string'
PUBLIC	??_C@_0O@PFDAENIN@Stealth_Range?$AA@		; `string'
PUBLIC	??_C@_0N@EKIKGDCL@ShroudPreset?$AA@		; `string'
PUBLIC	??_C@_0L@ONHIDKBD@SizePreset?$AA@		; `string'
PUBLIC	??_C@_0O@FBCFJMGJ@ROOTTRANSFORM?$AA@		; `string'
PUBLIC	??_7?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@ ; ScriptRegistrant<RA_Global_Gap_Controller>::`vftable'
PUBLIC	?RA_Global_Gap_Controller_Registrant@@3V?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@A ; RA_Global_Gap_Controller_Registrant
PUBLIC	??_C@_0CM@PDBLJBK@Update_Delay?$DN2?40?3float?0Timer_Num@ ; `string'
PUBLIC	??_C@_0BJ@DEFAMALF@RA_Global_Gap_Controller?$AA@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Building>::`vftable'
PUBLIC	?RA_Gap_Generator_Building_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@A ; RA_Gap_Generator_Building_Registrant
PUBLIC	??_C@_0IB@GPLJFFNE@Timer_Number?$DN876?3int?0Stealth_Ran@ ; `string'
PUBLIC	??_C@_0BK@BLJKABMN@RA_Gap_Generator_Building?$AA@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`vftable'
PUBLIC	?RA_Gap_Generator_Vehicle_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@A ; RA_Gap_Generator_Vehicle_Registrant
PUBLIC	??_C@_0GB@GCAPKJOG@Stealth_Range?$DN50?3int?0Gap_Control@ ; `string'
PUBLIC	??_C@_0BJ@KMAJJOPN@RA_Gap_Generator_Vehicle?$AA@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`vftable'
PUBLIC	?RA_Gap_Generator_Ignored_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@A ; RA_Gap_Generator_Ignored_Registrant
...
PUBLIC	??_C@_0DJ@MPBFPAFM@ScriptRegistrant?$DMclass?5RA_Global@ ; `string'
...
PUBLIC	??_C@_0DK@FLINIHOA@ScriptRegistrant?$DMclass?5RA_Gap_Ge@ ; `string'
PUBLIC	??_C@_0DJ@KNILIIPN@ScriptRegistrant?$DMclass?5RA_Gap_Ge@ ; `string'
PUBLIC	??_C@_0DJ@BEHGACHM@ScriptRegistrant?$DMclass?5RA_Gap_Ge@ ; `string'
...
PUBLIC	??_R4RA_Global_Gap_Controller@@6B@		; RA_Global_Gap_Controller::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVRA_Global_Gap_Controller@@@8		; RA_Global_Gap_Controller `RTTI Type Descriptor'
PUBLIC	??_R3RA_Global_Gap_Controller@@8		; RA_Global_Gap_Controller::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2RA_Global_Gap_Controller@@8		; RA_Global_Gap_Controller::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@RA_Global_Gap_Controller@@8	; RA_Global_Gap_Controller::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4RA_Gap_Generator_Building@@6B@		; RA_Gap_Generator_Building::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVRA_Gap_Generator_Building@@@8		; RA_Gap_Generator_Building `RTTI Type Descriptor'
PUBLIC	??_R3RA_Gap_Generator_Building@@8		; RA_Gap_Generator_Building::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2RA_Gap_Generator_Building@@8		; RA_Gap_Generator_Building::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@RA_Gap_Generator_Building@@8	; RA_Gap_Generator_Building::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4RA_Gap_Generator_Vehicle@@6B@		; RA_Gap_Generator_Vehicle::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVRA_Gap_Generator_Vehicle@@@8		; RA_Gap_Generator_Vehicle `RTTI Type Descriptor'
PUBLIC	??_R3RA_Gap_Generator_Vehicle@@8		; RA_Gap_Generator_Vehicle::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2RA_Gap_Generator_Vehicle@@8		; RA_Gap_Generator_Vehicle::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@RA_Gap_Generator_Vehicle@@8	; RA_Gap_Generator_Vehicle::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4RA_Gap_Generator_Ignored@@6B@		; RA_Gap_Generator_Ignored::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVRA_Gap_Generator_Ignored@@@8		; RA_Gap_Generator_Ignored `RTTI Type Descriptor'
PUBLIC	??_R3RA_Gap_Generator_Ignored@@8		; RA_Gap_Generator_Ignored::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2RA_Gap_Generator_Ignored@@8		; RA_Gap_Generator_Ignored::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@RA_Gap_Generator_Ignored@@8	; RA_Gap_Generator_Ignored::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@ ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@@8 ; ScriptRegistrant<RA_Global_Gap_Controller> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Building> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Vehicle> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Ignored> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	?Ranged_Gap_Effect@@YAXPAUGap_ListNode@@@Z:PROC	; Ranged_Gap_Effect
EXTRN	??_ERA_Global_Gap_Controller@@UAEPAXI@Z:PROC	; RA_Global_Gap_Controller::`vector deleting destructor'
EXTRN	??_ERA_Gap_Generator_Building@@UAEPAXI@Z:PROC	; RA_Gap_Generator_Building::`vector deleting destructor'
EXTRN	??_ERA_Gap_Generator_Vehicle@@UAEPAXI@Z:PROC	; RA_Gap_Generator_Vehicle::`vector deleting destructor'
EXTRN	??_ERA_Gap_Generator_Ignored@@UAEPAXI@Z:PROC	; RA_Gap_Generator_Ignored::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<RA_Global_Gap_Controller>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<RA_Gap_Generator_Building>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`vector deleting destructor'
...
_BSS	SEGMENT
?RA_Global_Gap_Controller_Registrant@@3V?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@A DB 010H DUP (?) ; RA_Global_Gap_Controller_Registrant
?RA_Gap_Generator_Building_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@A DB 010H DUP (?) ; RA_Gap_Generator_Building_Registrant
?RA_Gap_Generator_Vehicle_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@A DB 010H DUP (?) ; RA_Gap_Generator_Vehicle_Registrant
?RA_Gap_Generator_Ignored_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@A DB 010H DUP (?) ; RA_Gap_Generator_Ignored_Registrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_RA_Global_Gap_Controller_Registrant$initializer$ DD FLAT:??__ERA_Global_Gap_Controller_Registrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8 DD 00H ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Ignored> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@ DD 00H ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8 DD 00H ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Vehicle> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@ DD 00H ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8 DD 00H ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Building> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@ DD 00H ; ScriptRegistrant<RA_Gap_Generator_Building>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@@8 ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8 DD 00H ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<RA_Global_Gap_Controller> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@ DD 00H ; ScriptRegistrant<RA_Global_Gap_Controller>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@RA_Gap_Generator_Ignored@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@RA_Gap_Generator_Ignored@@8 DD FLAT:??_R0?AVRA_Gap_Generator_Ignored@@@8 ; RA_Gap_Generator_Ignored::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3RA_Gap_Generator_Ignored@@8
rdata$r	ENDS
;	COMDAT ??_R2RA_Gap_Generator_Ignored@@8
rdata$r	SEGMENT
??_R2RA_Gap_Generator_Ignored@@8 DD FLAT:??_R1A@?0A@EA@RA_Gap_Generator_Ignored@@8 ; RA_Gap_Generator_Ignored::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3RA_Gap_Generator_Ignored@@8
rdata$r	SEGMENT
??_R3RA_Gap_Generator_Ignored@@8 DD 00H			; RA_Gap_Generator_Ignored::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2RA_Gap_Generator_Ignored@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVRA_Gap_Generator_Ignored@@@8
_DATA	SEGMENT
??_R0?AVRA_Gap_Generator_Ignored@@@8 DD FLAT:??_7type_info@@6B@ ; RA_Gap_Generator_Ignored `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVRA_Gap_Generator_Ignored@@', 00H
_DATA	ENDS
;	COMDAT ??_R4RA_Gap_Generator_Ignored@@6B@
rdata$r	SEGMENT
??_R4RA_Gap_Generator_Ignored@@6B@ DD 00H		; RA_Gap_Generator_Ignored::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVRA_Gap_Generator_Ignored@@@8
	DD	FLAT:??_R3RA_Gap_Generator_Ignored@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@RA_Gap_Generator_Vehicle@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@RA_Gap_Generator_Vehicle@@8 DD FLAT:??_R0?AVRA_Gap_Generator_Vehicle@@@8 ; RA_Gap_Generator_Vehicle::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3RA_Gap_Generator_Vehicle@@8
rdata$r	ENDS
;	COMDAT ??_R2RA_Gap_Generator_Vehicle@@8
rdata$r	SEGMENT
??_R2RA_Gap_Generator_Vehicle@@8 DD FLAT:??_R1A@?0A@EA@RA_Gap_Generator_Vehicle@@8 ; RA_Gap_Generator_Vehicle::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3RA_Gap_Generator_Vehicle@@8
rdata$r	SEGMENT
??_R3RA_Gap_Generator_Vehicle@@8 DD 00H			; RA_Gap_Generator_Vehicle::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2RA_Gap_Generator_Vehicle@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVRA_Gap_Generator_Vehicle@@@8
_DATA	SEGMENT
??_R0?AVRA_Gap_Generator_Vehicle@@@8 DD FLAT:??_7type_info@@6B@ ; RA_Gap_Generator_Vehicle `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVRA_Gap_Generator_Vehicle@@', 00H
_DATA	ENDS
;	COMDAT ??_R4RA_Gap_Generator_Vehicle@@6B@
rdata$r	SEGMENT
??_R4RA_Gap_Generator_Vehicle@@6B@ DD 00H		; RA_Gap_Generator_Vehicle::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVRA_Gap_Generator_Vehicle@@@8
	DD	FLAT:??_R3RA_Gap_Generator_Vehicle@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@RA_Gap_Generator_Building@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@RA_Gap_Generator_Building@@8 DD FLAT:??_R0?AVRA_Gap_Generator_Building@@@8 ; RA_Gap_Generator_Building::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3RA_Gap_Generator_Building@@8
rdata$r	ENDS
;	COMDAT ??_R2RA_Gap_Generator_Building@@8
rdata$r	SEGMENT
??_R2RA_Gap_Generator_Building@@8 DD FLAT:??_R1A@?0A@EA@RA_Gap_Generator_Building@@8 ; RA_Gap_Generator_Building::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3RA_Gap_Generator_Building@@8
rdata$r	SEGMENT
??_R3RA_Gap_Generator_Building@@8 DD 00H		; RA_Gap_Generator_Building::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2RA_Gap_Generator_Building@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVRA_Gap_Generator_Building@@@8
_DATA	SEGMENT
??_R0?AVRA_Gap_Generator_Building@@@8 DD FLAT:??_7type_info@@6B@ ; RA_Gap_Generator_Building `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVRA_Gap_Generator_Building@@', 00H
_DATA	ENDS
;	COMDAT ??_R4RA_Gap_Generator_Building@@6B@
rdata$r	SEGMENT
??_R4RA_Gap_Generator_Building@@6B@ DD 00H		; RA_Gap_Generator_Building::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVRA_Gap_Generator_Building@@@8
	DD	FLAT:??_R3RA_Gap_Generator_Building@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@RA_Global_Gap_Controller@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@RA_Global_Gap_Controller@@8 DD FLAT:??_R0?AVRA_Global_Gap_Controller@@@8 ; RA_Global_Gap_Controller::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3RA_Global_Gap_Controller@@8
rdata$r	ENDS
;	COMDAT ??_R2RA_Global_Gap_Controller@@8
rdata$r	SEGMENT
??_R2RA_Global_Gap_Controller@@8 DD FLAT:??_R1A@?0A@EA@RA_Global_Gap_Controller@@8 ; RA_Global_Gap_Controller::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3RA_Global_Gap_Controller@@8
rdata$r	SEGMENT
??_R3RA_Global_Gap_Controller@@8 DD 00H			; RA_Global_Gap_Controller::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2RA_Global_Gap_Controller@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVRA_Global_Gap_Controller@@@8
_DATA	SEGMENT
??_R0?AVRA_Global_Gap_Controller@@@8 DD FLAT:??_7type_info@@6B@ ; RA_Global_Gap_Controller `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVRA_Global_Gap_Controller@@', 00H
_DATA	ENDS
;	COMDAT ??_R4RA_Global_Gap_Controller@@6B@
rdata$r	SEGMENT
??_R4RA_Global_Gap_Controller@@6B@ DD 00H		; RA_Global_Gap_Controller::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVRA_Global_Gap_Controller@@@8
	DD	FLAT:??_R3RA_Global_Gap_Controller@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DJ@BEHGACHM@ScriptRegistrant?$DMclass?5RA_Gap_Ge@
CONST	SEGMENT
??_C@_0DJ@BEHGACHM@ScriptRegistrant?$DMclass?5RA_Gap_Ge@ DB 'ScriptRegist'
	DB	'rant<class RA_Gap_Generator_Ignored>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DJ@KNILIIPN@ScriptRegistrant?$DMclass?5RA_Gap_Ge@
CONST	SEGMENT
??_C@_0DJ@KNILIIPN@ScriptRegistrant?$DMclass?5RA_Gap_Ge@ DB 'ScriptRegist'
	DB	'rant<class RA_Gap_Generator_Vehicle>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DK@FLINIHOA@ScriptRegistrant?$DMclass?5RA_Gap_Ge@
CONST	SEGMENT
??_C@_0DK@FLINIHOA@ScriptRegistrant?$DMclass?5RA_Gap_Ge@ DB 'ScriptRegist'
	DB	'rant<class RA_Gap_Generator_Building>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DJ@MPBFPAFM@ScriptRegistrant?$DMclass?5RA_Global@
CONST	SEGMENT
??_C@_0DJ@MPBFPAFM@ScriptRegistrant?$DMclass?5RA_Global@ DB 'ScriptRegist'
	DB	'rant<class RA_Global_Gap_Controller>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BJ@KMAJJOPN@RA_Gap_Generator_Vehicle?$AA@
CONST	SEGMENT
??_C@_0BJ@KMAJJOPN@RA_Gap_Generator_Vehicle?$AA@ DB 'RA_Gap_Generator_Veh'
	DB	'icle', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0GB@GCAPKJOG@Stealth_Range?$DN50?3int?0Gap_Control@
CONST	SEGMENT
??_C@_0GB@GCAPKJOG@Stealth_Range?$DN50?3int?0Gap_Control@ DB 'Stealth_Ran'
	DB	'ge=50:int,Gap_Controller=RA_Game_Manager:string,ShroudPreset:'
	DB	'string,SizePreset:string', 00H		; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BK@BLJKABMN@RA_Gap_Generator_Building?$AA@
CONST	SEGMENT
??_C@_0BK@BLJKABMN@RA_Gap_Generator_Building?$AA@ DB 'RA_Gap_Generator_Bu'
	DB	'ilding', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0IB@GPLJFFNE@Timer_Number?$DN876?3int?0Stealth_Ran@
CONST	SEGMENT
??_C@_0IB@GPLJFFNE@Timer_Number?$DN876?3int?0Stealth_Ran@ DB 'Timer_Numbe'
	DB	'r=876:int,Stealth_Range=50:int,Gap_Controller=RA_Game_Manager'
	DB	':string,Team=1:int,ShroudPreset:string,SizePreset:string', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@ ; ScriptRegistrant<RA_Gap_Generator_Building>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BJ@DEFAMALF@RA_Global_Gap_Controller?$AA@
CONST	SEGMENT
??_C@_0BJ@DEFAMALF@RA_Global_Gap_Controller?$AA@ DB 'RA_Global_Gap_Contro'
	DB	'ller', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0CM@PDBLJBK@Update_Delay?$DN2?40?3float?0Timer_Num@
CONST	SEGMENT
??_C@_0CM@PDBLJBK@Update_Delay?$DN2?40?3float?0Timer_Num@ DB 'Update_Dela'
	DB	'y=2.0:float,Timer_Number=687:int', 00H	; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@ ; ScriptRegistrant<RA_Global_Gap_Controller>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0O@FBCFJMGJ@ROOTTRANSFORM?$AA@
CONST	SEGMENT
??_C@_0O@FBCFJMGJ@ROOTTRANSFORM?$AA@ DB 'ROOTTRANSFORM', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@ONHIDKBD@SizePreset?$AA@
CONST	SEGMENT
??_C@_0L@ONHIDKBD@SizePreset?$AA@ DB 'SizePreset', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@EKIKGDCL@ShroudPreset?$AA@
CONST	SEGMENT
??_C@_0N@EKIKGDCL@ShroudPreset?$AA@ DB 'ShroudPreset', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@PFDAENIN@Stealth_Range?$AA@
CONST	SEGMENT
??_C@_0O@PFDAENIN@Stealth_Range?$AA@ DB 'Stealth_Range', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_04GBPANCCF@Team?$AA@
CONST	SEGMENT
??_C@_04GBPANCCF@Team?$AA@ DB 'Team', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@LDJAAGFD@Gap_Controller?$AA@
CONST	SEGMENT
??_C@_0P@LDJAAGFD@Gap_Controller?$AA@ DB 'Gap_Controller', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CL@KPHJEMGJ@RA_Global_Gap_Controller?3?3Remove@
CONST	SEGMENT
??_C@_0CL@KPHJEMGJ@RA_Global_Gap_Controller?3?3Remove@ DB 'RA_Global_Gap_'
	DB	'Controller::Remove_Generator', 00H		; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z@4JA DD 080H ; `RA_Global_Gap_Controller::Remove_Generator'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_0CI@DPDPGNEG@RA_Global_Gap_Controller?3?3Add_Ge@
CONST	SEGMENT
??_C@_0CI@DPDPGNEG@RA_Global_Gap_Controller?3?3Add_Ge@ DB 'RA_Global_Gap_'
	DB	'Controller::Add_Generator', 00H		; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z@4JA DD 05bH ; `RA_Global_Gap_Controller::Add_Generator'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
CONST	SEGMENT
??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@ DB 'x'
	DB	00H, ':', 00H, '\', 00H, 'g', 00H, 'i', 00H, 't', 00H, 'h', 00H
	DB	'u', 00H, 'b', 00H, '\', 00H, 'r', 00H, 'e', 00H, 'n', 00H, 'e'
	DB	00H, 'g', 00H, 'a', 00H, 'd', 00H, 'e', 00H, '\', 00H, 'd', 00H
	DB	'r', 00H, 'a', 00H, 'g', 00H, 'o', 00H, 'n', 00H, 'a', 00H, 'd'
	DB	00H, 'e', 00H, '_', 00H, 'r', 00H, 'x', 00H, 'd', 00H, '\', 00H
	DB	's', 00H, 'c', 00H, 'r', 00H, 'i', 00H, 'p', 00H, 't', 00H, 's'
	DB	00H, '\', 00H, 'g', 00H, 'a', 00H, 'p', 00H, '.', 00H, 'c', 00H
	DB	'p', 00H, 'p', 00H, 00H, 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0DB@GBJOEKHD@x?3?2github?2renegade?2dragonade_rxd@
CONST	SEGMENT
??_C@_0DB@GBJOEKHD@x?3?2github?2renegade?2dragonade_rxd@ DB 'x:\github\re'
	DB	'negade\dragonade_rxd\scripts\gap.cpp', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0CE@KOACAIDO@RA_Global_Gap_Controller?3?3Destro@
CONST	SEGMENT
??_C@_0CE@KOACAIDO@RA_Global_Gap_Controller?3?3Destro@ DB 'RA_Global_Gap_'
	DB	'Controller::Destroyed', 00H			; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z@4JA DD 04bH ; `RA_Global_Gap_Controller::Destroyed'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_0N@PNJGAIBD@Update_Delay?$AA@
CONST	SEGMENT
??_C@_0N@PNJGAIBD@Update_Delay?$AA@ DB 'Update_Delay', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@JONNKAKM@Timer_Number?$AA@
CONST	SEGMENT
??_C@_0N@JONNKAKM@Timer_Number?$AA@ DB 'Timer_Number', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7RA_Gap_Generator_Ignored@@6B@
CONST	SEGMENT
??_7RA_Gap_Generator_Ignored@@6B@ DD FLAT:??_R4RA_Gap_Generator_Ignored@@6B@ ; RA_Gap_Generator_Ignored::`vftable'
	DD	FLAT:??_ERA_Gap_Generator_Ignored@@UAEPAXI@Z
...
CONST	ENDS
;	COMDAT ??_7RA_Gap_Generator_Vehicle@@6B@
CONST	SEGMENT
??_7RA_Gap_Generator_Vehicle@@6B@ DD FLAT:??_R4RA_Gap_Generator_Vehicle@@6B@ ; RA_Gap_Generator_Vehicle::`vftable'
	DD	FLAT:??_ERA_Gap_Generator_Vehicle@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@ScriptImpClass@@UAEXPAVScriptableGameObj@@H@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7RA_Gap_Generator_Building@@6B@
CONST	SEGMENT
??_7RA_Gap_Generator_Building@@6B@ DD FLAT:??_R4RA_Gap_Generator_Building@@6B@ ; RA_Gap_Generator_Building::`vftable'
	DD	FLAT:??_ERA_Gap_Generator_Building@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@ScriptImpClass@@UAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Entered@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Exited@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7RA_Global_Gap_Controller@@6B@
CONST	SEGMENT
??_7RA_Global_Gap_Controller@@6B@ DD FLAT:??_R4RA_Global_Gap_Controller@@6B@ ; RA_Global_Gap_Controller::`vftable'
	DD	FLAT:??_ERA_Global_Gap_Controller@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Entered@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Exited@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
...
CONST	ENDS
CRT$XCU	SEGMENT
_RA_Gap_Generator_Building_Registrant$initializer$ DD FLAT:??__ERA_Gap_Generator_Building_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_RA_Gap_Generator_Vehicle_Registrant$initializer$ DD FLAT:??__ERA_Gap_Generator_Vehicle_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_RA_Gap_Generator_Ignored_Registrant$initializer$ DD FLAT:??__ERA_Gap_Generator_Ignored_Registrant@@YAXXZ
CRT$XCU	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FRA_Gap_Generator_Ignored_Registrant@@YAXXZ
text$yd	SEGMENT
??__FRA_Gap_Generator_Ignored_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'RA_Gap_Generator_Ignored_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?RA_Gap_Generator_Ignored_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@A ; RA_Gap_Generator_Ignored_Registrant
	call	??1?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FRA_Gap_Generator_Ignored_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'RA_Gap_Generator_Ignored_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ??__ERA_Gap_Generator_Ignored_Registrant@@YAXXZ
text$yc	SEGMENT
??__ERA_Gap_Generator_Ignored_Registrant@@YAXXZ PROC	; `dynamic initializer for 'RA_Gap_Generator_Ignored_Registrant'', COMDAT

; 376  : ScriptRegistrant<RA_Gap_Generator_Ignored> RA_Gap_Generator_Ignored_Registrant("RA_Gap_Generator_Ignored","");
	...
	push	OFFSET ??_C@_0BJ@DJHLIANK@RA_Gap_Generator_Ignored?$AA@
	mov	ecx, OFFSET ?RA_Gap_Generator_Ignored_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@A ; RA_Gap_Generator_Ignored_Registrant
	call	??0?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Gap_Generator_Ignored>::ScriptRegistrant<RA_Gap_Generator_Ignored>
	push	OFFSET ??__FRA_Gap_Generator_Ignored_Registrant@@YAXXZ ; `dynamic atexit destructor for 'RA_Gap_Generator_Ignored_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ERA_Gap_Generator_Ignored_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'RA_Gap_Generator_Ignored_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAXI@Z PROC ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<RA_Gap_Generator_Ignored>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAE@XZ PROC ; ScriptRegistrant<RA_Gap_Generator_Ignored>::~ScriptRegistrant<RA_Gap_Generator_Ignored>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAE@XZ ENDP ; ScriptRegistrant<RA_Gap_Generator_Ignored>::~ScriptRegistrant<RA_Gap_Generator_Ignored>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<RA_Gap_Generator_Ignored>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DJ@BEHGACHM@ScriptRegistrant?$DMclass?5RA_Gap_Ge@
	push	553					; 00000229H
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0RA_Gap_Generator_Ignored@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<RA_Gap_Generator_Ignored>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<RA_Gap_Generator_Ignored>::ScriptRegistrant<RA_Gap_Generator_Ignored>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VRA_Gap_Generator_Ignored@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<RA_Gap_Generator_Ignored>::ScriptRegistrant<RA_Gap_Generator_Ignored>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FRA_Gap_Generator_Vehicle_Registrant@@YAXXZ
text$yd	SEGMENT
??__FRA_Gap_Generator_Vehicle_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'RA_Gap_Generator_Vehicle_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?RA_Gap_Generator_Vehicle_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@A ; RA_Gap_Generator_Vehicle_Registrant
	call	??1?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FRA_Gap_Generator_Vehicle_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'RA_Gap_Generator_Vehicle_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ??__ERA_Gap_Generator_Vehicle_Registrant@@YAXXZ
text$yc	SEGMENT
??__ERA_Gap_Generator_Vehicle_Registrant@@YAXXZ PROC	; `dynamic initializer for 'RA_Gap_Generator_Vehicle_Registrant'', COMDAT

; 375  : ScriptRegistrant<RA_Gap_Generator_Vehicle> RA_Gap_Generator_Vehicle_Registrant("RA_Gap_Generator_Vehicle","Stealth_Range=50:int,Gap_Controller=RA_Game_Manager:string,ShroudPreset:string,SizePreset:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0GB@GCAPKJOG@Stealth_Range?$DN50?3int?0Gap_Control@
	push	OFFSET ??_C@_0BJ@KMAJJOPN@RA_Gap_Generator_Vehicle?$AA@
	mov	ecx, OFFSET ?RA_Gap_Generator_Vehicle_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@A ; RA_Gap_Generator_Vehicle_Registrant
	call	??0?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::ScriptRegistrant<RA_Gap_Generator_Vehicle>
	push	OFFSET ??__FRA_Gap_Generator_Vehicle_Registrant@@YAXXZ ; `dynamic atexit destructor for 'RA_Gap_Generator_Vehicle_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ERA_Gap_Generator_Vehicle_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'RA_Gap_Generator_Vehicle_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAXI@Z PROC ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAE@XZ PROC ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::~ScriptRegistrant<RA_Gap_Generator_Vehicle>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAE@XZ ENDP ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::~ScriptRegistrant<RA_Gap_Generator_Vehicle>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DJ@KNILIIPN@ScriptRegistrant?$DMclass?5RA_Gap_Ge@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0RA_Gap_Generator_Vehicle@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::ScriptRegistrant<RA_Gap_Generator_Vehicle>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VRA_Gap_Generator_Vehicle@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<RA_Gap_Generator_Vehicle>::ScriptRegistrant<RA_Gap_Generator_Vehicle>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FRA_Gap_Generator_Building_Registrant@@YAXXZ
text$yd	SEGMENT
??__FRA_Gap_Generator_Building_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'RA_Gap_Generator_Building_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?RA_Gap_Generator_Building_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@A ; RA_Gap_Generator_Building_Registrant
	call	??1?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FRA_Gap_Generator_Building_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'RA_Gap_Generator_Building_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ??__ERA_Gap_Generator_Building_Registrant@@YAXXZ
text$yc	SEGMENT
??__ERA_Gap_Generator_Building_Registrant@@YAXXZ PROC	; `dynamic initializer for 'RA_Gap_Generator_Building_Registrant'', COMDAT

; 374  : ScriptRegistrant<RA_Gap_Generator_Building> RA_Gap_Generator_Building_Registrant("RA_Gap_Generator_Building","Timer_Number=876:int,Stealth_Range=50:int,Gap_Controller=RA_Game_Manager:string,Team=1:int,ShroudPreset:string,SizePreset:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0IB@GPLJFFNE@Timer_Number?$DN876?3int?0Stealth_Ran@
	push	OFFSET ??_C@_0BK@BLJKABMN@RA_Gap_Generator_Building?$AA@
	mov	ecx, OFFSET ?RA_Gap_Generator_Building_Registrant@@3V?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@A ; RA_Gap_Generator_Building_Registrant
	call	??0?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Gap_Generator_Building>::ScriptRegistrant<RA_Gap_Generator_Building>
	push	OFFSET ??__FRA_Gap_Generator_Building_Registrant@@YAXXZ ; `dynamic atexit destructor for 'RA_Gap_Generator_Building_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ERA_Gap_Generator_Building_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'RA_Gap_Generator_Building_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAXI@Z PROC ; ScriptRegistrant<RA_Gap_Generator_Building>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<RA_Gap_Generator_Building>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAE@XZ PROC ; ScriptRegistrant<RA_Gap_Generator_Building>::~ScriptRegistrant<RA_Gap_Generator_Building>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAE@XZ ENDP ; ScriptRegistrant<RA_Gap_Generator_Building>::~ScriptRegistrant<RA_Gap_Generator_Building>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<RA_Gap_Generator_Building>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DK@FLINIHOA@ScriptRegistrant?$DMclass?5RA_Gap_Ge@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0RA_Gap_Generator_Building@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<RA_Gap_Generator_Building>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<RA_Gap_Generator_Building>::ScriptRegistrant<RA_Gap_Generator_Building>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VRA_Gap_Generator_Building@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<RA_Gap_Generator_Building>::ScriptRegistrant<RA_Gap_Generator_Building>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FRA_Global_Gap_Controller_Registrant@@YAXXZ
text$yd	SEGMENT
??__FRA_Global_Gap_Controller_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'RA_Global_Gap_Controller_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?RA_Global_Gap_Controller_Registrant@@3V?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@A ; RA_Global_Gap_Controller_Registrant
	call	??1?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FRA_Global_Gap_Controller_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'RA_Global_Gap_Controller_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ??__ERA_Global_Gap_Controller_Registrant@@YAXXZ
text$yc	SEGMENT
??__ERA_Global_Gap_Controller_Registrant@@YAXXZ PROC	; `dynamic initializer for 'RA_Global_Gap_Controller_Registrant'', COMDAT

; 373  : ScriptRegistrant<RA_Global_Gap_Controller> RA_Global_Gap_Controller_Registrant("RA_Global_Gap_Controller","Update_Delay=2.0:float,Timer_Number=687:int");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0CM@PDBLJBK@Update_Delay?$DN2?40?3float?0Timer_Num@
	push	OFFSET ??_C@_0BJ@DEFAMALF@RA_Global_Gap_Controller?$AA@
	mov	ecx, OFFSET ?RA_Global_Gap_Controller_Registrant@@3V?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@A ; RA_Global_Gap_Controller_Registrant
	call	??0?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@QAE@PBD0@Z ; ScriptRegistrant<RA_Global_Gap_Controller>::ScriptRegistrant<RA_Global_Gap_Controller>
	push	OFFSET ??__FRA_Global_Gap_Controller_Registrant@@YAXXZ ; `dynamic atexit destructor for 'RA_Global_Gap_Controller_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ERA_Global_Gap_Controller_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'RA_Global_Gap_Controller_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAXI@Z PROC ; ScriptRegistrant<RA_Global_Gap_Controller>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<RA_Global_Gap_Controller>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAE@XZ PROC ; ScriptRegistrant<RA_Global_Gap_Controller>::~ScriptRegistrant<RA_Global_Gap_Controller>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAE@XZ ENDP ; ScriptRegistrant<RA_Global_Gap_Controller>::~ScriptRegistrant<RA_Global_Gap_Controller>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<RA_Global_Gap_Controller>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DJ@MPBFPAFM@ScriptRegistrant?$DMclass?5RA_Global@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0RA_Global_Gap_Controller@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<RA_Global_Gap_Controller>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<RA_Global_Gap_Controller>::ScriptRegistrant<RA_Global_Gap_Controller>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VRA_Global_Gap_Controller@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<RA_Global_Gap_Controller>::ScriptRegistrant<RA_Global_Gap_Controller>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GRA_Gap_Generator_Ignored@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GRA_Gap_Generator_Ignored@@UAEPAXI@Z PROC		; RA_Gap_Generator_Ignored::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1RA_Gap_Generator_Ignored@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GRA_Gap_Generator_Ignored@@UAEPAXI@Z ENDP		; RA_Gap_Generator_Ignored::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1RA_Gap_Generator_Ignored@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1RA_Gap_Generator_Ignored@@UAE@XZ PROC		; RA_Gap_Generator_Ignored::~RA_Gap_Generator_Ignored, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1RA_Gap_Generator_Ignored@@UAE@XZ ENDP		; RA_Gap_Generator_Ignored::~RA_Gap_Generator_Ignored
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0RA_Gap_Generator_Ignored@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0RA_Gap_Generator_Ignored@@QAE@XZ PROC		; RA_Gap_Generator_Ignored::RA_Gap_Generator_Ignored, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7RA_Gap_Generator_Ignored@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0RA_Gap_Generator_Ignored@@QAE@XZ ENDP		; RA_Gap_Generator_Ignored::RA_Gap_Generator_Ignored
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GRA_Gap_Generator_Vehicle@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GRA_Gap_Generator_Vehicle@@UAEPAXI@Z PROC		; RA_Gap_Generator_Vehicle::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1RA_Gap_Generator_Vehicle@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GRA_Gap_Generator_Vehicle@@UAEPAXI@Z ENDP		; RA_Gap_Generator_Vehicle::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1RA_Gap_Generator_Vehicle@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1RA_Gap_Generator_Vehicle@@UAE@XZ PROC		; RA_Gap_Generator_Vehicle::~RA_Gap_Generator_Vehicle, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1RA_Gap_Generator_Vehicle@@UAE@XZ ENDP		; RA_Gap_Generator_Vehicle::~RA_Gap_Generator_Vehicle
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0RA_Gap_Generator_Vehicle@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0RA_Gap_Generator_Vehicle@@QAE@XZ PROC		; RA_Gap_Generator_Vehicle::RA_Gap_Generator_Vehicle, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7RA_Gap_Generator_Vehicle@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0RA_Gap_Generator_Vehicle@@QAE@XZ ENDP		; RA_Gap_Generator_Vehicle::RA_Gap_Generator_Vehicle
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Destroyed@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_GapControl$ = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Destroyed@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z PROC ; RA_Gap_Generator_Vehicle::Destroyed, COMDAT
; _this$ = ecx
...
; 354  : 	GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));

	push	OFFSET ??_C@_0P@LDJAAGFD@Gap_Controller?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	...
	add	esp, 8
	mov	DWORD PTR _GapControl$[ebp], eax

; 355  : 	Commands->Send_Custom_Event(obj, GapControl, 3333, 0, 0);
	...
	push	0
	push	3333					; 00000d05H
	mov	eax, DWORD PTR _GapControl$[ebp]
	push	eax
...
; 357  : 	{
; 358  : 		Commands->Destroy_Object(Commands->Find_Object(shroudID));
...
; 362  : 	{
; 363  : 		Commands->Destroy_Object(Commands->Find_Object(sizeID));
...
; 366  : }
	...
	pop	ebp
	ret	4
?Destroyed@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z ENDP ; RA_Gap_Generator_Vehicle::Destroyed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Custom@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
$T1 = -128						; size = 12
$T2 = -116						; size = 12
_object$3 = -40						; size = 4
_position$4 = -36					; size = 12
_object$5 = -24						; size = 4
_position$6 = -20					; size = 12
_GapControl$ = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; RA_Gap_Generator_Vehicle::Custom, COMDAT
; _this$ = ecx
...
; 315  : 	GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));
...
; 316  : 	if (type == CUSTOM_EVENT_VEHICLE_ENTERED)

	cmp	DWORD PTR _type$[ebp], 1000000028	; 3b9aca1cH
	jne	$LN7@Custom

; 317  : 	{
; 318  : 		Commands->Send_Custom_Event(obj, GapControl, 2222, 1, 0); //Activate Stealth Field
...
; 320  : 		{
; 321  : 			Vector3 position = Commands->Get_Bone_Position(obj, "ROOTTRANSFORM");

	push	OFFSET ??_C@_0O@FBCFJMGJ@ROOTTRANSFORM?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	...
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR _position$6[ebp]
	call	??0Vector3@@QAE@ABV0@@Z			; Vector3::Vector3

; 322  : 			GameObject *object = Commands->Create_Object(Get_Parameter("ShroudPreset"), position);

	lea	eax, DWORD PTR _position$6[ebp]
	push	eax
	push	OFFSET ??_C@_0N@EKIKGDCL@ShroudPreset?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 323  : 			Commands->Set_Player_Type(object,Commands->Get_Player_Type(obj));
...
; 324  : 			Commands->Attach_To_Object_Bone(object, obj, "ROOTTRANSFORM");
...
; 325  : 			shroudID = Commands->Get_ID(object);
...
; 328  : 		{
; 329  : 			Vector3 position = Commands->Get_Bone_Position(obj, "ROOTTRANSFORM");
...
; 330  : 			GameObject *object = Commands->Create_Object(Get_Parameter("SizePreset"), position);

	lea	eax, DWORD PTR _position$4[ebp]
	push	eax
	push	OFFSET ??_C@_0L@ONHIDKBD@SizePreset?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 331  : 			Commands->Set_Player_Type(object,Commands->Get_Player_Type(obj));
...
; 332  : 			Commands->Attach_To_Object_Bone(object, obj, "ROOTTRANSFORM");

	push	OFFSET ??_C@_0O@FBCFJMGJ@ROOTTRANSFORM?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	mov	ecx, DWORD PTR _object$3[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	eax, DWORD PTR [edx+572]
	call	eax
...
; 333  : 			sizeID = Commands->Get_ID(object);
...
; 336  : 	else if (type == CUSTOM_EVENT_VEHICLE_EXITED)

	cmp	DWORD PTR _type$[ebp], 1000000029	; 3b9aca1dH
	jne	$LN1@Custom

; 337  : 	{
; 338  : 		Commands->Send_Custom_Event(obj, GapControl, 2222, 0, 0); //Deactivate Stealth Field
...
; 340  : 		{
; 341  : 			Commands->Destroy_Object(Commands->Find_Object(shroudID));
...
; 345  : 		{
; 346  : 			Commands->Destroy_Object(Commands->Find_Object(sizeID));
...
; 350  : }
	...
	pop	ebp
	ret	16					; 00000010H
?Custom@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; RA_Gap_Generator_Vehicle::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Created@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_GapControl$ = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z PROC ; RA_Gap_Generator_Vehicle::Created, COMDAT
; _this$ = ecx
...
; 302  : 	GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));
...
; 303  : 	if (!Commands->Get_Player_Type(obj))
...
; 304  : 	{
; 305  : 		Commands->Send_Custom_Event(obj, GapControl, 1000, Get_Int_Parameter("Stealth_Range"), 0.5);

	push	ecx
	movss	xmm0, DWORD PTR __real@3f000000
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0O@PFDAENIN@Stealth_Range?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 306  : 	}
; 307  : 	else if (Commands->Get_Player_Type(obj) == 1)
...
; 308  : 	{
; 309  : 		Commands->Send_Custom_Event(obj, GapControl, 1111, Get_Int_Parameter("Stealth_Range"), 0.5);
...
; 311  : }
	...
	pop	ebp
	ret	4
?Created@RA_Gap_Generator_Vehicle@@EAEXPAVScriptableGameObj@@@Z ENDP ; RA_Gap_Generator_Vehicle::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GRA_Gap_Generator_Building@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GRA_Gap_Generator_Building@@UAEPAXI@Z PROC		; RA_Gap_Generator_Building::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1RA_Gap_Generator_Building@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GRA_Gap_Generator_Building@@UAEPAXI@Z ENDP		; RA_Gap_Generator_Building::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1RA_Gap_Generator_Building@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1RA_Gap_Generator_Building@@UAE@XZ PROC		; RA_Gap_Generator_Building::~RA_Gap_Generator_Building, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1RA_Gap_Generator_Building@@UAE@XZ ENDP		; RA_Gap_Generator_Building::~RA_Gap_Generator_Building
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0RA_Gap_Generator_Building@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0RA_Gap_Generator_Building@@QAE@XZ PROC		; RA_Gap_Generator_Building::RA_Gap_Generator_Building, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7RA_Gap_Generator_Building@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0RA_Gap_Generator_Building@@QAE@XZ ENDP		; RA_Gap_Generator_Building::RA_Gap_Generator_Building
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Killed@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_GapControl$ = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_killer$ = 12						; size = 4
?Killed@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@0@Z PROC ; RA_Gap_Generator_Building::Killed, COMDAT
; _this$ = ecx
...
; 282  : 	GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));
...
; 283  : 	Commands->Send_Custom_Event(obj, GapControl, 3333, 0, 0);
...
; 285  : 	{
; 286  : 		Commands->Destroy_Object(Commands->Find_Object(shroudID));
...
; 290  : 	{
; 291  : 		Commands->Destroy_Object(Commands->Find_Object(sizeID));
...
; 294  : }
	...
	pop	ebp
	ret	8
?Killed@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@0@Z ENDP ; RA_Gap_Generator_Building::Killed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Timer_Expired@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
$T1 = -132						; size = 12
$T2 = -120						; size = 12
_GapControl$3 = -44					; size = 4
_object$4 = -40						; size = 4
_position$5 = -36					; size = 12
_object$6 = -24						; size = 4
_position$7 = -20					; size = 12
_GapControl$8 = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_number$ = 12						; size = 4
?Timer_Expired@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@H@Z PROC ; RA_Gap_Generator_Building::Timer_Expired, COMDAT
; _this$ = ecx
...
; 235  : 	if (number == Get_Int_Parameter("Timer_Number"))

	push	OFFSET ??_C@_0N@JONNKAKM@Timer_Number?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
...
; 236  : 	{
; 237  : 		if (!enabled && Is_Base_Powered(Get_Object_Type(obj)))
...
; 238  : 		{
; 239  : 			GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));
	...
	call	?Find_Object_By_Preset@@YAPAVScriptableGameObj@@HPBD@Z ; Find_Object_By_Preset
	add	esp, 8
	mov	DWORD PTR _GapControl$8[ebp], eax

; 240  : 			Commands->Send_Custom_Event(obj, GapControl, 2222, 1, 0); //Activate Stealth Field
	...
	push	1
	push	2222					; 000008aeH
	mov	eax, DWORD PTR _GapControl$8[ebp]
	push	eax
	mov	ecx, DWORD PTR _obj$[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 243  : 			{
; 244  : 				Vector3 position = Commands->Get_Bone_Position(obj, "ROOTTRANSFORM");
	...
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR _position$7[ebp]
	call	??0Vector3@@QAE@ABV0@@Z			; Vector3::Vector3

; 245  : 				GameObject *object = Commands->Create_Object(Get_Parameter("ShroudPreset"), position);

	lea	eax, DWORD PTR _position$7[ebp]
	push	eax
	push	OFFSET ??_C@_0N@EKIKGDCL@ShroudPreset?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _object$6[ebp], eax

; 246  : 				Commands->Set_Player_Type(object,Commands->Get_Player_Type(obj));
	...
	add	esp, 4
	push	eax
	mov	eax, DWORD PTR _object$6[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+252]
	call	edx
...
; 247  : 				Commands->Attach_To_Object_Bone(object, obj, "ROOTTRANSFORM");
...
; 248  : 				shroudID = Commands->Get_ID(object);
...
; 251  : 			{
; 252  : 				Vector3 position = Commands->Get_Bone_Position(obj, "ROOTTRANSFORM");
	...
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR _position$5[ebp]
	call	??0Vector3@@QAE@ABV0@@Z			; Vector3::Vector3

; 253  : 				GameObject *object = Commands->Create_Object(Get_Parameter("SizePreset"), position);

	lea	eax, DWORD PTR _position$5[ebp]
	push	eax
	push	OFFSET ??_C@_0L@ONHIDKBD@SizePreset?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
...
; 254  : 				Commands->Set_Player_Type(object,Commands->Get_Player_Type(obj));
...
; 255  : 				Commands->Attach_To_Object_Bone(object, obj, "ROOTTRANSFORM");
...
; 256  : 				sizeID = Commands->Get_ID(object);
...
; 259  : 		}
; 260  : 		else if(enabled && !Is_Base_Powered(Get_Object_Type(obj)))
...
; 261  : 		{
; 262  : 			GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));
	...
	call	?Find_Object_By_Preset@@YAPAVScriptableGameObj@@HPBD@Z ; Find_Object_By_Preset
	add	esp, 8
	mov	DWORD PTR _GapControl$3[ebp], eax

; 263  : 			Commands->Send_Custom_Event(obj, GapControl, 2222, 0, 0); //Deactivate Stealth Field
	...
	push	0
	push	2222					; 000008aeH
	mov	eax, DWORD PTR _GapControl$3[ebp]
	push	eax
	mov	ecx, DWORD PTR _obj$[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 265  : 			{
; 266  : 				Commands->Destroy_Object(Commands->Find_Object(shroudID));
...
; 270  : 			{
; 271  : 				Commands->Destroy_Object(Commands->Find_Object(sizeID));
...
; 275  : 		}
; 276  : 		Commands->Start_Timer(obj, this, 2, Get_Int_Parameter("Timer_Number"));
...
; 278  : }
	...
	pop	ebp
	ret	8
?Timer_Expired@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@H@Z ENDP ; RA_Gap_Generator_Building::Timer_Expired
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Created@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -104						; size = 12
_object2$ = -28						; size = 4
_object$ = -24						; size = 4
...
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@@Z PROC ; RA_Gap_Generator_Building::Created, COMDAT
; _this$ = ecx
...
; 208  : 	GameObject *GapControl = Find_Object_By_Preset(2, Get_Parameter("Gap_Controller"));
...
; 210  : 	{
; 211  : 		Commands->Send_Custom_Event(obj, GapControl, 1000, Get_Int_Parameter("Stealth_Range"), 2);
...
; 212  : 		Commands->Send_Custom_Event(obj, GapControl, 2222, 3, 3);
...
; 214  : 	}
; 215  : 	else if (Get_Int_Parameter("Team") == 1)
...
; 216  : 	{
; 217  : 		Commands->Send_Custom_Event(obj, GapControl, 1111, Get_Int_Parameter("Stealth_Range"), 2);
...
; 218  : 		Commands->Send_Custom_Event(obj, GapControl, 2222, 3, 3);
...
; 223  : 	Vector3 position = Commands->Get_Position(obj);
...
; 224  : 	GameObject *object = Commands->Create_Object(Get_Parameter("ShroudPreset"), position);
...
; 225  : 	Commands->Set_Player_Type(object,Commands->Get_Player_Type(obj));
...
; 226  : 	shroudID = Commands->Get_ID(object);
...
; 227  : 	GameObject *object2 = Commands->Create_Object(Get_Parameter("SizePreset"), position);
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _object2$[ebp], eax

; 228  : 	Commands->Set_Player_Type(object2,Commands->Get_Player_Type(obj));
	...
	add	esp, 4
	push	eax
	mov	eax, DWORD PTR _object2$[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+252]
	call	edx
...
; 229  : 	sizeID = Commands->Get_ID(object2);
...
; 230  : 	Commands->Start_Timer(obj, this, 2, Get_Int_Parameter("Timer_Number"));
...
; 231  : }
	...
	pop	ebp
	ret	4
?Created@RA_Gap_Generator_Building@@EAEXPAVScriptableGameObj@@@Z ENDP ; RA_Gap_Generator_Building::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GRA_Global_Gap_Controller@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GRA_Global_Gap_Controller@@UAEPAXI@Z PROC		; RA_Global_Gap_Controller::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1RA_Global_Gap_Controller@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GRA_Global_Gap_Controller@@UAEPAXI@Z ENDP		; RA_Global_Gap_Controller::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1RA_Global_Gap_Controller@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1RA_Global_Gap_Controller@@UAE@XZ PROC		; RA_Global_Gap_Controller::~RA_Global_Gap_Controller, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1RA_Global_Gap_Controller@@UAE@XZ ENDP		; RA_Global_Gap_Controller::~RA_Global_Gap_Controller
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0RA_Global_Gap_Controller@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0RA_Global_Gap_Controller@@QAE@XZ PROC		; RA_Global_Gap_Controller::RA_Global_Gap_Controller, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7RA_Global_Gap_Controller@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0RA_Global_Gap_Controller@@QAE@XZ ENDP		; RA_Global_Gap_Controller::RA_Global_Gap_Controller
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Update_Generator@RA_Global_Gap_Controller@@AAEXK_N@Z
_TEXT	SEGMENT
_Current$1 = -8						; size = 4
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
_Active$ = 12						; size = 1
?Update_Generator@RA_Global_Gap_Controller@@AAEXK_N@Z PROC ; RA_Global_Gap_Controller::Update_Generator, COMDAT
; _this$ = ecx
...
; 184  : 	if (ListHead) //always check for List's existence

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+28], 0
	je	SHORT $LN5@Update_Gen

; 185  : 	{
; 186  : 		Gap_ListNode *Current = ListHead;
...
; 188  : 		{
; 189  : 			if (Current->unitID == ID)

	mov	eax, DWORD PTR _Current$1[ebp]
	mov	ecx, DWORD PTR [eax+4]
	cmp	ecx, DWORD PTR _ID$[ebp]
	jne	SHORT $LN1@Update_Gen

; 190  : 			{
; 191  : 				Current->active = Active;
...
; 196  : }
	...
	pop	ebp
	ret	8
?Update_Generator@RA_Global_Gap_Controller@@AAEXK_N@Z ENDP ; RA_Global_Gap_Controller::Update_Generator
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Update_Generator@RA_Global_Gap_Controller@@AAEXK_NH@Z
_TEXT	SEGMENT
_Current$1 = -8						; size = 4
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
_Active$ = 12						; size = 1
_Team$ = 16						; size = 4
?Update_Generator@RA_Global_Gap_Controller@@AAEXK_NH@Z PROC ; RA_Global_Gap_Controller::Update_Generator, COMDAT
; _this$ = ecx
...
; 167  : 	if (ListHead) //always check for List's existence
...
; 168  : 	{
; 169  : 		Gap_ListNode *Current = ListHead;
...
; 173  : 			{
; 174  : 				Current->active = Active;

	mov	eax, DWORD PTR _Current$1[ebp]
	mov	cl, BYTE PTR _Active$[ebp]
	mov	BYTE PTR [eax+16], cl

; 175  : 				Current->teamID = Team;
...
; 180  : }
	...
	pop	ebp
	ret	12					; 0000000cH
?Update_Generator@RA_Global_Gap_Controller@@AAEXK_NH@Z ENDP ; RA_Global_Gap_Controller::Update_Generator
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z
_TEXT	SEGMENT
$T1 = -84						; size = 4
$T2 = -80						; size = 4
_Current$3 = -12					; size = 4
_Previous$4 = -8					; size = 4
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
?Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z PROC ; RA_Global_Gap_Controller::Remove_Generator, COMDAT
; _this$ = ecx
...
; 129  : 	if (ListHead) //No need to remove if list doesn't exist
...
; 130  : 	{
; 131  : 		Gap_ListNode *Previous = ListHead;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	DWORD PTR _Previous$4[ebp], ecx
$LN9@Remove_Gen:

; 132  : 		do //Check if ListHead is pointing to a deletable Node
; 133  : 		{
; 134  : 			if (ListHead->unitID == ID)

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	edx, DWORD PTR [ecx+4]
	cmp	edx, DWORD PTR _ID$[ebp]
	jne	SHORT $LN8@Remove_Gen

; 135  : 			{
; 136  : 				ListHead = ListHead->Next;
...
; 137  : 				delete Previous;
	...
	push	OFFSET ??_C@_0CL@KPHJEMGJ@RA_Global_Gap_Controller?3?3Remove@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z@4JA
	add	eax, 9
	push	eax
	push	OFFSET ??_C@_0DB@GBJOEKHD@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN14@Remove_Gen
	xor	edx, edx
	jne	SHORT $LN13@Remove_Gen
	mov	eax, DWORD PTR ?__LINE__Var@?1??Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z@4JA
	add	eax, 9
	push	eax
	push	OFFSET ??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
	push	OFFSET ??_C@_1M@HLGKFCJM@?$AAf?$AAa?$AAl?$AAs?$AAe?$AA?$AA@
	call	DWORD PTR __imp___wassert
	add	esp, 12					; 0000000cH
$LN13@Remove_Gen:
	jmp	SHORT $LN15@Remove_Gen
$LN14@Remove_Gen:
	mov	edx, DWORD PTR _Previous$4[ebp]
...
; 138  : 				Previous = ListHead;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	DWORD PTR _Previous$4[ebp], ecx

; 139  : 				if (ListHead == NULL)
...
; 140  : 				{
; 141  : 					return; //Hit the End of the List
...
; 143  : 			}
; 144  : 		}
; 145  : 		while (ListHead->unitID == ID); //Continue until ListHead no longer is effected by change
...
; 146  : 		Gap_ListNode *Current = ListHead->Next;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR _Current$3[ebp], edx
$LN4@Remove_Gen:

; 147  : 		while (Current)

	cmp	DWORD PTR _Current$3[ebp], 0
	je	$LN11@Remove_Gen

; 148  : 		{
; 149  : 			if (Current->unitID == ID)

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	ecx, DWORD PTR [eax+4]
	cmp	ecx, DWORD PTR _ID$[ebp]
	jne	SHORT $LN2@Remove_Gen

; 150  : 			{
; 151  : 				Previous->Next = Current->Next;

	mov	eax, DWORD PTR _Previous$4[ebp]
	mov	ecx, DWORD PTR _Current$3[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR [eax], edx

; 152  : 				Current->Next = NULL; //safety
...
; 153  : 				delete Current;
	...
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN17@Remove_Gen
	xor	edx, edx
	jne	SHORT $LN16@Remove_Gen
	mov	eax, DWORD PTR ?__LINE__Var@?1??Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z@4JA
	add	eax, 25					; 00000019H
	push	eax
	push	OFFSET ??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
	...
	add	esp, 12					; 0000000cH
$LN16@Remove_Gen:
	jmp	SHORT $LN18@Remove_Gen
$LN17@Remove_Gen:
	mov	edx, DWORD PTR _Current$3[ebp]
...
; 154  : 				Current = Previous->Next;

	mov	eax, DWORD PTR _Previous$4[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _Current$3[ebp], ecx

; 155  : 			}
; 156  : 			else

	jmp	SHORT $LN1@Remove_Gen
$LN2@Remove_Gen:
...
; 158  : 				Previous = Current;
	...
	mov	eax, DWORD PTR _Current$3[ebp]
	mov	DWORD PTR _Previous$4[ebp], eax
...
; 163  : }
	...
	pop	ebp
	ret	4
?Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z ENDP ; RA_Global_Gap_Controller::Remove_Generator
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z
_TEXT	SEGMENT
tv146 = -84						; size = 4
tv80 = -84						; size = 4
$T1 = -80						; size = 4
...
_Range$ = 12						; size = 4
_Team$ = 16						; size = 4
?Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z PROC	; RA_Global_Gap_Controller::Add_Generator, COMDAT
; _this$ = ecx
...
; 92   : 	if (!ListHead) //no list exists yet
...
; 93   : 	{
; 94   : 		ListHead = new Gap_ListNode;

	push	OFFSET ??_C@_0CI@DPDPGNEG@RA_Global_Gap_Controller?3?3Add_Ge@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z@4JA
	add	eax, 3
	push	eax
	push	OFFSET ??_C@_0DB@GBJOEKHD@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN9@Add_Genera
	xor	edx, edx
	jne	SHORT $LN8@Add_Genera
	mov	eax, DWORD PTR ?__LINE__Var@?1??Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z@4JA
	add	eax, 3
	push	eax
	push	OFFSET ??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
; 95   : 		ListHead->Next = NULL;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	DWORD PTR [ecx], 0

; 96   : 		ListHead->unitID = ObjectID;
...
; 99   : 		ListHead->active = false; //all generators initialize off
...
; 100  : 	}
; 101  : 	else //List exists, add node

	jmp	$LN4@Add_Genera
$LN5@Add_Genera:

; 102  : 	{
; 103  : 		Gap_ListNode *Current = ListHead;
...
; 104  : 		while (Current->Next != NULL)
	...
	mov	eax, DWORD PTR _Current$3[ebp]
	cmp	DWORD PTR [eax], 0
	je	SHORT $LN2@Add_Genera

; 105  : 		{
; 106  : 			if (Current->unitID == ObjectID)

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	ecx, DWORD PTR [eax+4]
	cmp	ecx, DWORD PTR _ObjectID$[ebp]
	jne	SHORT $LN1@Add_Genera

; 107  : 			{	//Same ID, replace current node 
; 108  : 				Current->range = Range;

	mov	eax, DWORD PTR _Current$3[ebp]
	movss	xmm0, DWORD PTR _Range$[ebp]
	movss	DWORD PTR [eax+8], xmm0

; 109  : 				Current->teamID = Team;

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	ecx, DWORD PTR _Team$[ebp]
	mov	DWORD PTR [eax+12], ecx

; 110  : 				Current->active = false; //all generators initialize off

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	BYTE PTR [eax+16], 0

; 111  : 				return; //job done, end now
...
; 114  : 		}
	...
	jmp	SHORT $LN3@Add_Genera
$LN2@Add_Genera:

; 115  : 		//At End of list, Tack on new node
; 116  : 		Current->Next = new Gap_ListNode;
	...
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN12@Add_Genera
	xor	edx, edx
	jne	SHORT $LN11@Add_Genera
	mov	eax, DWORD PTR ?__LINE__Var@?1??Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z@4JA
	add	eax, 25					; 00000019H
	push	eax
	push	OFFSET ??_C@_1GC@DEJGBNEP@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
; 117  : 		Current = Current->Next; //Switch to new node

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _Current$3[ebp], ecx

; 118  : 		//Initialize new node
; 119  : 		Current->Next = NULL;

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	DWORD PTR [eax], 0

; 120  : 		Current->unitID = ObjectID;

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	ecx, DWORD PTR _ObjectID$[ebp]
	mov	DWORD PTR [eax+4], ecx

; 121  : 		Current->range = Range;

	mov	eax, DWORD PTR _Current$3[ebp]
	movss	xmm0, DWORD PTR _Range$[ebp]
	movss	DWORD PTR [eax+8], xmm0

; 122  : 		Current->teamID = Team;

	mov	eax, DWORD PTR _Current$3[ebp]
	mov	ecx, DWORD PTR _Team$[ebp]
	mov	DWORD PTR [eax+12], ecx

; 123  : 		Current->active = false; //all generators initialize off
...
; 125  : }
	...
	pop	ebp
	ret	12					; 0000000cH
?Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z ENDP	; RA_Global_Gap_Controller::Add_Generator
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -80						; size = 4
_Previous$ = -12					; size = 4
_Current$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z PROC ; RA_Global_Gap_Controller::Destroyed, COMDAT
; _this$ = ecx
...
; 76   : 	//Destroy List
; 77   : 	Gap_ListNode *Current = ListHead;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	DWORD PTR _Current$[ebp], ecx

; 78   : 	Gap_ListNode *Previous = NULL;
...
; 84   : 		delete Previous;
	...
	push	OFFSET ??_C@_0CE@KOACAIDO@RA_Global_Gap_Controller?3?3Destro@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z@4JA
	add	eax, 9
	push	eax
	push	OFFSET ??_C@_0DB@GBJOEKHD@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
...
; 88   : }
	...
	pop	ebp
	ret	4
?Destroyed@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z ENDP ; RA_Global_Gap_Controller::Destroyed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Timer_Expired@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_number$ = 12						; size = 4
?Timer_Expired@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@H@Z PROC ; RA_Global_Gap_Controller::Timer_Expired, COMDAT
; _this$ = ecx
...
; 67   : 	if (number == Get_Int_Parameter("Timer_Number"))
...
; 68   : 	{
; 69   : 		Ranged_Gap_Effect(ListHead); //Ranged_Gap_Effect needs to know if there's a null list now

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	push	ecx
	call	?Ranged_Gap_Effect@@YAXPAUGap_ListNode@@@Z ; Ranged_Gap_Effect
	add	esp, 4

; 70   : 		Commands->Start_Timer(obj, this, Get_Float_Parameter("Update_Delay"), Get_Int_Parameter("Timer_Number"));

	push	OFFSET ??_C@_0N@JONNKAKM@Timer_Number?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	push	eax
	push	OFFSET ??_C@_0N@PNJGAIBD@Update_Delay?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 72   : }
	...
	pop	ebp
	ret	8
?Timer_Expired@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@H@Z ENDP ; RA_Global_Gap_Controller::Timer_Expired
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Custom@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
tv81 = -72						; size = 4
tv64 = -72						; size = 4
_this$ = -4						; size = 4
...
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; RA_Global_Gap_Controller::Custom, COMDAT
; _this$ = ecx
...
; 28   : 	//message 1111 = Allied Team Generator Created 
; 29   : 	//message 1000 = Soviet Team Generator Created
; 30   : 	//message 2222 = Generator Switch State (param shows new state)
; 31   : 	//message 3333 = Generator Destroyed
; 32   : 	switch(type)

	mov	eax, DWORD PTR _type$[ebp]
	mov	DWORD PTR tv64[ebp], eax
	cmp	DWORD PTR tv64[ebp], 2222		; 000008aeH
	jg	SHORT $LN15@Custom
	cmp	DWORD PTR tv64[ebp], 2222		; 000008aeH
	je	$LN8@Custom
	cmp	DWORD PTR tv64[ebp], 1000		; 000003e8H
	je	SHORT $LN9@Custom
	cmp	DWORD PTR tv64[ebp], 1111		; 00000457H
	je	SHORT $LN10@Custom
	jmp	$LN11@Custom
$LN15@Custom:
	cmp	DWORD PTR tv64[ebp], 3333		; 00000d05H
	je	$LN1@Custom
	jmp	$LN11@Custom
$LN10@Custom:

; 33   : 	{
; 34   : 	case 1111: //Add Allied Generator
; 35   : 		Add_Generator(Commands->Get_ID(sender), (float)param, 1);
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Add_Generator@RA_Global_Gap_Controller@@AAEXKMH@Z ; RA_Global_Gap_Controller::Add_Generator
...
; 37   : 	case 1000: //Add Soviet Generator
; 38   : 		Add_Generator(Commands->Get_ID(sender), (float)param, 0);
...
; 40   : 	//Change Generator Status -- make sure to check team type somehow...
; 41   : 	//param: 0 = Mobile Gap Offline, 1 = Mobile Gap Online, 2 = Gap Offline, 3 = Gap Online
; 42   : 	case 2222:
; 43   : 		switch(param)
	...
	jmp	DWORD PTR $LN16@Custom[ecx*4]
$LN5@Custom:

; 44   : 		{
; 45   : 		case 0:
; 46   : 			Update_Generator(Commands->Get_ID(sender), false); //Don't Update Team
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Update_Generator@RA_Global_Gap_Controller@@AAEXK_N@Z ; RA_Global_Gap_Controller::Update_Generator
...
; 48   : 		case 1:
; 49   : 			Update_Generator(Commands->Get_ID(sender), true, Commands->Get_Player_Type(sender));
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Update_Generator@RA_Global_Gap_Controller@@AAEXK_NH@Z ; RA_Global_Gap_Controller::Update_Generator
...
; 51   : 		case 2:
; 52   : 			Update_Generator(Commands->Get_ID(sender), false);
...
; 54   : 		case 3:
; 55   : 			Update_Generator(Commands->Get_ID(sender), true);
...
; 59   : 	case 3333: //Remove Generator from List
; 60   : 		Remove_Generator(Commands->Get_ID(sender));
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Remove_Generator@RA_Global_Gap_Controller@@AAEXK@Z ; RA_Global_Gap_Controller::Remove_Generator
$LN11@Custom:
...
$LN16@Custom:
	...
	DD	$LN3@Custom
	DD	$LN2@Custom
?Custom@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; RA_Global_Gap_Controller::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\gap.cpp
;	COMDAT ?Created@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z PROC ; RA_Global_Gap_Controller::Created, COMDAT
; _this$ = ecx
...
; 23   : 	Commands->Start_Timer(obj, this, 5, Get_Int_Parameter("Timer_Number"));
...
; 24   : }
	...
	pop	ebp
	ret	4
?Created@RA_Global_Gap_Controller@@EAEXPAVScriptableGameObj@@@Z ENDP ; RA_Global_Gap_Controller::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
