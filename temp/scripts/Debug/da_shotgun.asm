; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\da_shotgun.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??9?$SafeDataClass@I@@QAE_NABI@Z		; SafeDataClass<unsigned int>::operator!=
...
PUBLIC	?Init@DAShotgunGameModeClass@@EAEXXZ		; DAShotgunGameModeClass::Init
PUBLIC	?Add_Weapon_Request_Event@DAShotgunGameModeClass@@EAE_NPAVcPlayer@@PBVWeaponDefinitionClass@@@Z ; DAShotgunGameModeClass::Add_Weapon_Request_Event
PUBLIC	?Object_Created_Event@DAShotgunGameModeClass@@EAEXPAVScriptableGameObj@@@Z ; DAShotgunGameModeClass::Object_Created_Event
PUBLIC	??0DAShotgunGameModeClass@@QAE@XZ		; DAShotgunGameModeClass::DAShotgunGameModeClass
PUBLIC	??1DAShotgunGameModeClass@@UAE@XZ		; DAShotgunGameModeClass::~DAShotgunGameModeClass
PUBLIC	??_GDAShotgunGameModeClass@@UAEPAXI@Z		; DAShotgunGameModeClass::`scalar deleting destructor'
PUBLIC	??0?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@QAE@PBD00@Z ; DAGameModeRegistrant<DAShotgunGameModeClass>::DAGameModeRegistrant<DAShotgunGameModeClass>
PUBLIC	?Create_Instance@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAVDAGameModeClass@@XZ ; DAGameModeRegistrant<DAShotgunGameModeClass>::Create_Instance
PUBLIC	??1?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAE@XZ ; DAGameModeRegistrant<DAShotgunGameModeClass>::~DAGameModeRegistrant<DAShotgunGameModeClass>
PUBLIC	??_G?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAXI@Z ; DAGameModeRegistrant<DAShotgunGameModeClass>::`scalar deleting destructor'
...
PUBLIC	??_EDAShotgunGameModeClass@@W3AEPAXI@Z		; [thunk]:DAShotgunGameModeClass::`vector deleting destructor'
...
PUBLIC	??_7DAShotgunGameModeClass@@6BDAEventClass@@@	; DAShotgunGameModeClass::`vftable'
PUBLIC	??_7DAShotgunGameModeClass@@6BDAGameModeClass@@@ ; DAShotgunGameModeClass::`vftable'
PUBLIC	??_C@_0BG@KMDKJAL@Weapon_Shotgun_Player?$AA@	; `string'
PUBLIC	??_C@_0BI@NKBDMJJH@Weapon_RepairGun_Player?$AA@	; `string'
PUBLIC	??_C@_0BA@KMCDLBNP@CNCVehicleLight?$AA@		; `string'
PUBLIC	??_C@_0BB@OJPIEFFD@CNCVehicleMedium?$AA@	; `string'
PUBLIC	??_7?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@ ; DAGameModeRegistrant<DAShotgunGameModeClass>::`vftable'
PUBLIC	?DAShotgunGameModeClassRegistrant@@3V?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@A ; DAShotgunGameModeClassRegistrant
PUBLIC	??_C@_0N@MECOLIJ@Shotgun?5Wars?$AA@		; `string'
...
PUBLIC	??_C@_0EE@DCAEPIDL@DAGameModeRegistrant?$DMclass?5DASho@ ; `string'
...
PUBLIC	??_R4DAShotgunGameModeClass@@6BDAEventClass@@@	; DAShotgunGameModeClass::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVDAShotgunGameModeClass@@@8		; DAShotgunGameModeClass `RTTI Type Descriptor'
PUBLIC	??_R3DAShotgunGameModeClass@@8			; DAShotgunGameModeClass::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2DAShotgunGameModeClass@@8			; DAShotgunGameModeClass::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@DAShotgunGameModeClass@@8		; DAShotgunGameModeClass::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R13?0A@EA@DAGameModeClass@@8			; DAGameModeClass::`RTTI Base Class Descriptor at (4,-1,0,64)'
PUBLIC	??_R4DAShotgunGameModeClass@@6BDAGameModeClass@@@ ; DAShotgunGameModeClass::`RTTI Complete Object Locator'
PUBLIC	??_R4?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@ ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@@8 ; DAGameModeRegistrant<DAShotgunGameModeClass> `RTTI Type Descriptor'
PUBLIC	??_R3?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	?Get_Armor_Type@ArmorWarheadManager@@SAIPBD@Z:PROC ; ArmorWarheadManager::Get_Armor_Type
EXTRN	?Get_Definition@PowerUpGameObj@@QBEABVPowerUpGameObjDef@@XZ:PROC ; PowerUpGameObj::Get_Definition
...
EXTRN	??_EDAShotgunGameModeClass@@UAEPAXI@Z:PROC	; DAShotgunGameModeClass::`vector deleting destructor'
EXTRN	??_E?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAXI@Z:PROC ; DAGameModeRegistrant<DAShotgunGameModeClass>::`vector deleting destructor'
...
_BSS	ENDS
_BSS	SEGMENT
?DAShotgunGameModeClassRegistrant@@3V?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@A DB 014H DUP (?) ; DAShotgunGameModeClassRegistrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_DAShotgunGameModeClassRegistrant$initializer$ DD FLAT:??__EDAShotgunGameModeClassRegistrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 DD FLAT:??_R0?AV?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@@8 ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8
rdata$r	SEGMENT
??_R2?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 DD FLAT:??_R1A@?0A@EA@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@DAGameModeFactoryClass@@8
rdata$r	ENDS
;	COMDAT ??_R3?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8
rdata$r	SEGMENT
??_R3?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8 DD 00H ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@@8
_DATA	SEGMENT
??_R0?AV?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@@8 DD FLAT:??_7type_info@@6B@ ; DAGameModeRegistrant<DAShotgunGameModeClass> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@
rdata$r	SEGMENT
??_R4?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@ DD 00H ; DAGameModeRegistrant<DAShotgunGameModeClass>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@@8
	DD	FLAT:??_R3?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@8
rdata$r	ENDS
;	COMDAT ??_R4DAShotgunGameModeClass@@6BDAGameModeClass@@@
rdata$r	SEGMENT
??_R4DAShotgunGameModeClass@@6BDAGameModeClass@@@ DD 00H ; DAShotgunGameModeClass::`RTTI Complete Object Locator'
	DD	04H
	DD	00H
	DD	FLAT:??_R0?AVDAShotgunGameModeClass@@@8
	DD	FLAT:??_R3DAShotgunGameModeClass@@8
rdata$r	ENDS
...
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@DAShotgunGameModeClass@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@DAShotgunGameModeClass@@8 DD FLAT:??_R0?AVDAShotgunGameModeClass@@@8 ; DAShotgunGameModeClass::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	02H
	DD	00H
	DD	0ffffffffH
	DD	00H
	...
	DD	FLAT:??_R3DAShotgunGameModeClass@@8
rdata$r	ENDS
;	COMDAT ??_R2DAShotgunGameModeClass@@8
rdata$r	SEGMENT
??_R2DAShotgunGameModeClass@@8 DD FLAT:??_R1A@?0A@EA@DAShotgunGameModeClass@@8 ; DAShotgunGameModeClass::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@DAEventClass@@8
	DD	FLAT:??_R13?0A@EA@DAGameModeClass@@8
rdata$r	ENDS
;	COMDAT ??_R3DAShotgunGameModeClass@@8
rdata$r	SEGMENT
??_R3DAShotgunGameModeClass@@8 DD 00H			; DAShotgunGameModeClass::`RTTI Class Hierarchy Descriptor'
	DD	01H
	DD	03H
	DD	FLAT:??_R2DAShotgunGameModeClass@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVDAShotgunGameModeClass@@@8
_DATA	SEGMENT
??_R0?AVDAShotgunGameModeClass@@@8 DD FLAT:??_7type_info@@6B@ ; DAShotgunGameModeClass `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVDAShotgunGameModeClass@@', 00H
_DATA	ENDS
;	COMDAT ??_R4DAShotgunGameModeClass@@6BDAEventClass@@@
rdata$r	SEGMENT
??_R4DAShotgunGameModeClass@@6BDAEventClass@@@ DD 00H	; DAShotgunGameModeClass::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVDAShotgunGameModeClass@@@8
	DD	FLAT:??_R3DAShotgunGameModeClass@@8
...
CONST	ENDS
;	COMDAT ??_C@_0EE@DCAEPIDL@DAGameModeRegistrant?$DMclass?5DASho@
CONST	SEGMENT
??_C@_0EE@DCAEPIDL@DAGameModeRegistrant?$DMclass?5DASho@ DB 'DAGameModeRe'
	DB	'gistrant<class DAShotgunGameModeClass>::Create_Instance', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0N@MECOLIJ@Shotgun?5Wars?$AA@
CONST	SEGMENT
??_C@_0N@MECOLIJ@Shotgun?5Wars?$AA@ DB 'Shotgun Wars', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@
CONST	SEGMENT
??_7?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@ DD FLAT:??_R4?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@ ; DAGameModeRegistrant<DAShotgunGameModeClass>::`vftable'
	DD	FLAT:??_E?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAXI@Z
	DD	FLAT:?Create_Instance@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAVDAGameModeClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BB@OJPIEFFD@CNCVehicleMedium?$AA@
CONST	SEGMENT
??_C@_0BB@OJPIEFFD@CNCVehicleMedium?$AA@ DB 'CNCVehicleMedium', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@KMCDLBNP@CNCVehicleLight?$AA@
CONST	SEGMENT
??_C@_0BA@KMCDLBNP@CNCVehicleLight?$AA@ DB 'CNCVehicleLight', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@NKBDMJJH@Weapon_RepairGun_Player?$AA@
CONST	SEGMENT
??_C@_0BI@NKBDMJJH@Weapon_RepairGun_Player?$AA@ DB 'Weapon_RepairGun_Play'
	DB	'er', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@KMDKJAL@Weapon_Shotgun_Player?$AA@
CONST	SEGMENT
??_C@_0BG@KMDKJAL@Weapon_Shotgun_Player?$AA@ DB 'Weapon_Shotgun_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7DAShotgunGameModeClass@@6BDAGameModeClass@@@
CONST	SEGMENT
??_7DAShotgunGameModeClass@@6BDAGameModeClass@@@ DD FLAT:??_R4DAShotgunGameModeClass@@6BDAGameModeClass@@@ ; DAShotgunGameModeClass::`vftable'
	DD	FLAT:?Init@DAShotgunGameModeClass@@EAEXXZ
	DD	FLAT:??_EDAShotgunGameModeClass@@W3AEPAXI@Z
CONST	ENDS
;	COMDAT ??_7DAShotgunGameModeClass@@6BDAEventClass@@@
CONST	SEGMENT
??_7DAShotgunGameModeClass@@6BDAEventClass@@@ DD FLAT:??_R4DAShotgunGameModeClass@@6BDAEventClass@@@ ; DAShotgunGameModeClass::`vftable'
	...
	DD	FLAT:?Add_Weapon_Request_Event@DAShotgunGameModeClass@@EAE_NPAVcPlayer@@PBVWeaponDefinitionClass@@@Z
	...
	DD	FLAT:?Object_Created_Event@DAShotgunGameModeClass@@EAEXPAVScriptableGameObj@@@Z
	...
	DD	FLAT:??_EDAShotgunGameModeClass@@UAEPAXI@Z
CONST	ENDS
...
;	COMDAT ??_EDAShotgunGameModeClass@@W3AEPAXI@Z
_TEXT	SEGMENT
??_EDAShotgunGameModeClass@@W3AEPAXI@Z PROC		; [thunk]:DAShotgunGameModeClass::`vector deleting destructor', COMDAT
	sub	ecx, 4
	jmp	??_EDAShotgunGameModeClass@@UAEPAXI@Z
??_EDAShotgunGameModeClass@@W3AEPAXI@Z ENDP		; [thunk]:DAShotgunGameModeClass::`vector deleting destructor'
_TEXT	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDAShotgunGameModeClassRegistrant@@YAXXZ
text$yd	SEGMENT
??__FDAShotgunGameModeClassRegistrant@@YAXXZ PROC	; `dynamic atexit destructor for 'DAShotgunGameModeClassRegistrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DAShotgunGameModeClassRegistrant@@3V?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@A ; DAShotgunGameModeClassRegistrant
	call	??1?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDAShotgunGameModeClassRegistrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'DAShotgunGameModeClassRegistrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\da_shotgun.cpp
;	COMDAT ??__EDAShotgunGameModeClassRegistrant@@YAXXZ
text$yc	SEGMENT
??__EDAShotgunGameModeClassRegistrant@@YAXXZ PROC	; `dynamic initializer for 'DAShotgunGameModeClassRegistrant'', COMDAT

; 86   : Register_Game_Mode(DAShotgunGameModeClass,"Shotgun","Shotgun Wars",0);
	...
	push	edi
	push	0
	push	OFFSET ??_C@_0N@MECOLIJ@Shotgun?5Wars?$AA@
	push	OFFSET ??_C@_07DGIAOJJ@Shotgun?$AA@
	mov	ecx, OFFSET ?DAShotgunGameModeClassRegistrant@@3V?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@A ; DAShotgunGameModeClassRegistrant
	call	??0?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@QAE@PBD00@Z ; DAGameModeRegistrant<DAShotgunGameModeClass>::DAGameModeRegistrant<DAShotgunGameModeClass>
	push	OFFSET ??__FDAShotgunGameModeClassRegistrant@@YAXXZ ; `dynamic atexit destructor for 'DAShotgunGameModeClassRegistrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDAShotgunGameModeClassRegistrant@@YAXXZ ENDP	; `dynamic initializer for 'DAShotgunGameModeClassRegistrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAXI@Z PROC ; DAGameModeRegistrant<DAShotgunGameModeClass>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAXI@Z ENDP ; DAGameModeRegistrant<DAShotgunGameModeClass>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAE@XZ PROC ; DAGameModeRegistrant<DAShotgunGameModeClass>::~DAGameModeRegistrant<DAShotgunGameModeClass>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAE@XZ ENDP ; DAGameModeRegistrant<DAShotgunGameModeClass>::~DAGameModeRegistrant<DAShotgunGameModeClass>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\da_gamemode.h
;	COMDAT ?Create_Instance@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAVDAGameModeClass@@XZ
_TEXT	SEGMENT
tv95 = -84						; size = 4
tv91 = -80						; size = 4
tv93 = -76						; size = 4
$T1 = -72						; size = 4
_this$ = -4						; size = 4
?Create_Instance@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAVDAGameModeClass@@XZ PROC ; DAGameModeRegistrant<DAShotgunGameModeClass>::Create_Instance, COMDAT
; _this$ = ecx
...
; 70   : 			Instance = new T;
	...
	push	OFFSET ??_C@_0EE@DCAEPIDL@DAGameModeRegistrant?$DMclass?5DASho@
	push	70					; 00000046H
...
$LN7@Create_Ins:
	...
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0DAShotgunGameModeClass@@QAE@XZ
...
; 75   : 	}
	...
	pop	ebp
	ret	0
?Create_Instance@?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@UAEPAVDAGameModeClass@@XZ ENDP ; DAGameModeRegistrant<DAShotgunGameModeClass>::Create_Instance
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\da_gamemode.h
;	COMDAT ??0?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@QAE@PBD00@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ShortName$ = 8						; size = 4
_LongName$ = 12						; size = 4
_RequiredData$ = 16					; size = 4
??0?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@QAE@PBD00@Z PROC ; DAGameModeRegistrant<DAShotgunGameModeClass>::DAGameModeRegistrant<DAShotgunGameModeClass>, COMDAT
; _this$ = ecx
...
; 67   : 	DAGameModeRegistrant(const char *ShortName,const char *LongName,const char *RequiredData = 0) : DAGameModeFactoryClass(ShortName,LongName,RequiredData) { }
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	12					; 0000000cH
??0?$DAGameModeRegistrant@VDAShotgunGameModeClass@@@@QAE@PBD00@Z ENDP ; DAGameModeRegistrant<DAShotgunGameModeClass>::DAGameModeRegistrant<DAShotgunGameModeClass>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GDAShotgunGameModeClass@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDAShotgunGameModeClass@@UAEPAXI@Z PROC		; DAShotgunGameModeClass::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1DAShotgunGameModeClass@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GDAShotgunGameModeClass@@UAEPAXI@Z ENDP		; DAShotgunGameModeClass::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1DAShotgunGameModeClass@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DAShotgunGameModeClass@@UAE@XZ PROC			; DAShotgunGameModeClass::~DAShotgunGameModeClass, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1DAShotgunGameModeClass@@UAE@XZ ENDP			; DAShotgunGameModeClass::~DAShotgunGameModeClass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0DAShotgunGameModeClass@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DAShotgunGameModeClass@@QAE@XZ PROC			; DAShotgunGameModeClass::DAShotgunGameModeClass, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DAShotgunGameModeClass@@6BDAEventClass@@@
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+4], OFFSET ??_7DAShotgunGameModeClass@@6BDAGameModeClass@@@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0DAShotgunGameModeClass@@QAE@XZ ENDP			; DAShotgunGameModeClass::DAShotgunGameModeClass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\da_shotgun.cpp
;	COMDAT ?Object_Created_Event@DAShotgunGameModeClass@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv202 = -92						; size = 4
tv210 = -88						; size = 4
tv203 = -88						; size = 4
tv151 = -88						; size = 4
_Soldier$1 = -20					; size = 4
_LightArmor$2 = -16					; size = 4
_Vehicle$3 = -12					; size = 4
_Building$4 = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Object_Created_Event@DAShotgunGameModeClass@@EAEXPAVScriptableGameObj@@@Z PROC ; DAShotgunGameModeClass::Object_Created_Event, COMDAT
; _this$ = ecx

; 57   : void DAShotgunGameModeClass::Object_Created_Event(GameObject *obj) {
...
; 58   : 	if (BuildingGameObj *Building = obj->As_BuildingGameObj()) {
	...
	cmp	DWORD PTR _Building$4[ebp], 0
	je	SHORT $LN10@Object_Cre

; 59   : 		Building->Get_Defense_Object()->Set_Skin(ArmorWarheadManager::Get_Armor_Type("CNCVehicleMedium"));

	push	OFFSET ??_C@_0BB@OJPIEFFD@CNCVehicleMedium?$AA@
...
; 60   : 		Building->Get_Defense_Object()->Set_Shield_Type(ArmorWarheadManager::Get_Armor_Type("CNCVehicleMedium"));
...
; 61   : 		const_cast<BuildingGameObjDef&>(Building->Get_Definition()).MCTSkin = ArmorWarheadManager::Get_Armor_Type("CNCVehicleLight");

	push	OFFSET ??_C@_0BA@KMCDLBNP@CNCVehicleLight?$AA@
	call	?Get_Armor_Type@ArmorWarheadManager@@SAIPBD@Z ; ArmorWarheadManager::Get_Armor_Type
	add	esp, 4
	mov	esi, eax
	mov	ecx, DWORD PTR _Building$4[ebp]
...
; 62   : 	}
; 63   : 	else if (VehicleGameObj *Vehicle = obj->As_VehicleGameObj()) {
...
; 64   : 		if (!_stricmp(Vehicle->Get_Weapon()->Get_Name(),"Weapon_Shotgun_Player")) {

	push	OFFSET ??_C@_0BG@KMDKJAL@Weapon_Shotgun_Player?$AA@
	mov	ecx, DWORD PTR _Vehicle$3[ebp]
	...
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN7@Object_Cre

; 65   : 			Update_Network_Object(Vehicle);

	cmp	DWORD PTR _Vehicle$3[ebp], 0
	je	SHORT $LN13@Object_Cre
	mov	eax, DWORD PTR _Vehicle$3[ebp]
	add	eax, 8
	mov	DWORD PTR tv151[ebp], eax
	jmp	SHORT $LN14@Object_Cre
$LN13@Object_Cre:
...
; 66   : 			Set_Position_Clip_Bullets(Vehicle,1,-1);

	push	-1
	push	1
	mov	eax, DWORD PTR _Vehicle$3[ebp]
	push	eax
	call	DWORD PTR ?Set_Position_Clip_Bullets@@3P6AXPAVScriptableGameObj@@HH@ZA ; Set_Position_Clip_Bullets
	add	esp, 12					; 0000000cH
$LN7@Object_Cre:

; 67   : 		}
; 68   : 		if (Vehicle->Get_Defense_Object()->Get_Shield_Type() != ArmorType(1)) {
...
; 69   : 			ArmorType LightArmor = ArmorWarheadManager::Get_Armor_Type("CNCVehicleLight");

	push	OFFSET ??_C@_0BA@KMCDLBNP@CNCVehicleLight?$AA@
	call	?Get_Armor_Type@ArmorWarheadManager@@SAIPBD@Z ; ArmorWarheadManager::Get_Armor_Type
	add	esp, 4
	mov	DWORD PTR _LightArmor$2[ebp], eax

; 70   : 			Vehicle->Get_Defense_Object()->Set_Shield_Type(LightArmor);

	mov	eax, DWORD PTR _LightArmor$2[ebp]
	push	eax
	mov	ecx, DWORD PTR _Vehicle$3[ebp]
	call	?Get_Defense_Object@DamageableGameObj@@QAEPAVDefenseObjectClass@@XZ ; DamageableGameObj::Get_Defense_Object
	mov	ecx, eax
...
; 71   : 			Vehicle->Get_Defense_Object()->Set_Skin(LightArmor);
...
; 74   : 	else if (SoldierGameObj *Soldier = obj->As_SoldierGameObj()) {
	...
	call	eax
	mov	DWORD PTR _Soldier$1[ebp], eax
	cmp	DWORD PTR _Soldier$1[ebp], 0
	je	SHORT $LN4@Object_Cre

; 75   : 		if (Soldier->Get_Player()) {

	mov	ecx, DWORD PTR _Soldier$1[ebp]
	call	?Get_Player@SoldierGameObj@@QAEPAVcPlayer@@XZ ; SoldierGameObj::Get_Player
	test	eax, eax
	je	SHORT $LN3@Object_Cre

; 76   : 			Update_Network_Object(Soldier->Get_Player());

	mov	ecx, DWORD PTR _Soldier$1[ebp]
	call	?Get_Player@SoldierGameObj@@QAEPAVcPlayer@@XZ ; SoldierGameObj::Get_Player
	mov	DWORD PTR tv203[ebp], eax
	cmp	DWORD PTR tv203[ebp], 0
	je	SHORT $LN15@Object_Cre
	mov	eax, DWORD PTR tv203[ebp]
	add	eax, 160				; 000000a0H
	mov	DWORD PTR tv202[ebp], eax
	jmp	SHORT $LN16@Object_Cre
$LN15@Object_Cre:
...
; 77   : 		}
; 78   : 		Update_Network_Object(Soldier);

	cmp	DWORD PTR _Soldier$1[ebp], 0
	je	SHORT $LN17@Object_Cre
	mov	eax, DWORD PTR _Soldier$1[ebp]
	add	eax, 8
	mov	DWORD PTR tv210[ebp], eax
	jmp	SHORT $LN18@Object_Cre
$LN17@Object_Cre:
...
; 79   : 		Set_Position_Clip_Bullets(Soldier,1,-1);
	...
	call	DWORD PTR ?Set_Position_Clip_Bullets@@3P6AXPAVScriptableGameObj@@HH@ZA ; Set_Position_Clip_Bullets
	add	esp, 12					; 0000000cH
	jmp	SHORT $LN11@Object_Cre
$LN4@Object_Cre:

; 80   : 	}
; 81   : 	else if (((PowerUpGameObj*)obj)->Get_Definition().GrantWeapon) {

	mov	ecx, DWORD PTR _obj$[ebp]
	call	?Get_Definition@PowerUpGameObj@@QBEABVPowerUpGameObjDef@@XZ ; PowerUpGameObj::Get_Definition
	movzx	eax, BYTE PTR [eax+200]
	test	eax, eax
	je	SHORT $LN11@Object_Cre

; 82   : 		obj->Set_Delete_Pending();
...
; 84   : }
	...
	pop	ebp
	ret	4
?Object_Created_Event@DAShotgunGameModeClass@@EAEXPAVScriptableGameObj@@@Z ENDP ; DAShotgunGameModeClass::Object_Created_Event
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\da_shotgun.cpp
;	COMDAT ?Add_Weapon_Request_Event@DAShotgunGameModeClass@@EAE_NPAVcPlayer@@PBVWeaponDefinitionClass@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_Player$ = 8						; size = 4
_Weapon$ = 12						; size = 4
?Add_Weapon_Request_Event@DAShotgunGameModeClass@@EAE_NPAVcPlayer@@PBVWeaponDefinitionClass@@@Z PROC ; DAShotgunGameModeClass::Add_Weapon_Request_Event, COMDAT
; _this$ = ecx

; 50   : bool DAShotgunGameModeClass::Add_Weapon_Request_Event(cPlayer *Player,const WeaponDefinitionClass *Weapon) {
...
; 51   : 	if (_stricmp(Weapon->Get_Name(),"Weapon_Shotgun_Player") && _stricmp(Weapon->Get_Name(), "Weapon_RepairGun_Player")) {
	...
	add	esp, 8
	test	eax, eax
	je	SHORT $LN1@Add_Weapon
	push	OFFSET ??_C@_0BI@NKBDMJJH@Weapon_RepairGun_Player?$AA@
	mov	eax, DWORD PTR _Weapon$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _Weapon$[ebp]
	mov	eax, DWORD PTR [edx+48]
...
; 55   : }
	...
	pop	ebp
	ret	8
?Add_Weapon_Request_Event@DAShotgunGameModeClass@@EAE_NPAVcPlayer@@PBVWeaponDefinitionClass@@@Z ENDP ; DAShotgunGameModeClass::Add_Weapon_Request_Event
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\da_shotgun.cpp
;	COMDAT ?Init@DAShotgunGameModeClass@@EAEXXZ
_TEXT	SEGMENT
$T1 = -112						; size = 4
$T2 = -108						; size = 4
$T3 = -104						; size = 4
...
_Def$5 = -32						; size = 4
_Def$6 = -28						; size = 4
_LightArmor$ = -24					; size = 4
_RepairID$ = -20					; size = 4
_ShotgunID$ = -16					; size = 4
_Repair$ = -12						; size = 4
_Shotgun$ = -8						; size = 4
_this$ = -4						; size = 4
?Init@DAShotgunGameModeClass@@EAEXXZ PROC		; DAShotgunGameModeClass::Init, COMDAT
; _this$ = ecx

; 21   : void DAShotgunGameModeClass::Init() {
...
; 22   : 	Register_Event(DAEvent::ADDWEAPONREQUEST,INT_MAX);
...
; 23   : 	Register_Object_Event(DAObjectEvent::CREATED,DAObjectEvent::POWERUP | DAObjectEvent::BUILDING | DAObjectEvent::ARMED,INT_MAX);
...
; 24   : 
; 25   : 	WeaponDefinitionClass *Shotgun = (WeaponDefinitionClass*)Find_Named_Definition("Weapon_Shotgun_Player");

	push	OFFSET ??_C@_0BG@KMDKJAL@Weapon_Shotgun_Player?$AA@
	call	?Find_Named_Definition@@YAPAVDefinitionClass@@PBD@Z ; Find_Named_Definition
	add	esp, 4
	mov	DWORD PTR _Shotgun$[ebp], eax

; 26   : 	WeaponDefinitionClass *Repair = (WeaponDefinitionClass*)Find_Named_Definition("Weapon_RepairGun_Player");
...
; 27   : 	int ShotgunID = Shotgun->Get_ID();

	mov	eax, DWORD PTR _Shotgun$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _Shotgun$[ebp]
	mov	eax, DWORD PTR [edx+36]
	call	eax
	mov	DWORD PTR _ShotgunID$[ebp], eax

; 28   : 	Shotgun->MaxInventoryRounds = -1;
...
; 29   : 	int RepairID = Repair->Get_ID();

	mov	eax, DWORD PTR _Repair$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _Repair$[ebp]
	mov	eax, DWORD PTR [edx+36]
	call	eax
	mov	DWORD PTR _RepairID$[ebp], eax

; 30   : 	ArmorType LightArmor = ArmorWarheadManager::Get_Armor_Type("CNCVehicleLight");

	push	OFFSET ??_C@_0BA@KMCDLBNP@CNCVehicleLight?$AA@
	call	?Get_Armor_Type@ArmorWarheadManager@@SAIPBD@Z ; ArmorWarheadManager::Get_Armor_Type
	add	esp, 4
	mov	DWORD PTR _LightArmor$[ebp], eax

; 31   : 
; 32   : 	for (SoldierGameObjDef *Def = (SoldierGameObjDef*)DefinitionMgrClass::Get_First(CID_Soldier);Def;Def = (SoldierGameObjDef*)DefinitionMgrClass::Get_Next(Def,CID_Soldier)) {

	push	1
	push	12289					; 00003001H
	call	DWORD PTR __imp_?Get_First@DefinitionMgrClass@@SAPAVDefinitionClass@@IW4ID_TYPE@1@@Z
	add	esp, 8
	mov	DWORD PTR _Def$6[ebp], eax
	jmp	SHORT $LN8@Init
$LN7@Init:
	push	1
	push	12289					; 00003001H
	mov	eax, DWORD PTR _Def$6[ebp]
	push	eax
	call	DWORD PTR __imp_?Get_Next@DefinitionMgrClass@@SAPAVDefinitionClass@@PAV2@IW4ID_TYPE@1@@Z
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _Def$6[ebp], eax
$LN8@Init:
	cmp	DWORD PTR _Def$6[ebp], 0
	je	SHORT $LN6@Init

; 33   : 		Def->WeaponDefID = ShotgunID;

	mov	eax, DWORD PTR _Def$6[ebp]
	mov	ecx, DWORD PTR _ShotgunID$[ebp]
	mov	DWORD PTR [eax+196], ecx

; 34   : 		Def->SecondaryWeaponDefID = RepairID;

	mov	eax, DWORD PTR _Def$6[ebp]
	mov	ecx, DWORD PTR _RepairID$[ebp]
	mov	DWORD PTR [eax+200], ecx

; 35   : 		Def->WeaponRounds = -1;

	mov	DWORD PTR $T2[ebp], -1
	lea	eax, DWORD PTR $T2[ebp]
	push	eax
	mov	ecx, DWORD PTR _Def$6[ebp]
...
; 37   : 
; 38   : 	for (VehicleGameObjDef *Def = (VehicleGameObjDef*)DefinitionMgrClass::Get_First(CID_Vehicle); Def; Def = (VehicleGameObjDef*)DefinitionMgrClass::Get_Next(Def, CID_Vehicle)) {

	push	1
	push	12304					; 00003010H
	call	DWORD PTR __imp_?Get_First@DefinitionMgrClass@@SAPAVDefinitionClass@@IW4ID_TYPE@1@@Z
	add	esp, 8
...
; 39   : 		if (Def->Get_Type() != VehicleType::VEHICLE_TYPE_TURRET) {

	mov	ecx, DWORD PTR _Def$5[ebp]
	call	?Get_Type@VehicleGameObjDef@@QBE?AW4VehicleType@@XZ ; VehicleGameObjDef::Get_Type
	cmp	eax, 4
	je	SHORT $LN2@Init

; 40   : 			Def->WeaponDefID = ShotgunID;

	mov	eax, DWORD PTR _Def$5[ebp]
	mov	ecx, DWORD PTR _ShotgunID$[ebp]
	mov	DWORD PTR [eax+196], ecx

; 41   : 			Def->WeaponRounds = -1;
...
; 42   : 		}
; 43   : 		if (Def->DefenseObjectDef.ShieldType != ArmorType(1)) {
	...
	call	??9?$SafeDataClass@I@@QAE_NABI@Z	; SafeDataClass<unsigned int>::operator!=
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN1@Init

; 44   : 			Def->DefenseObjectDef.ShieldType = LightArmor;

	lea	eax, DWORD PTR _LightArmor$[ebp]
	push	eax
	mov	ecx, DWORD PTR _Def$5[ebp]
	add	ecx, 96					; 00000060H
	call	??4?$SafeDataClass@I@@QAEAAIABI@Z	; SafeDataClass<unsigned int>::operator=

; 45   : 			Def->DefenseObjectDef.Skin = LightArmor;
...
; 48   : }
	...
	pop	ebp
	ret	0
?Init@DAShotgunGameModeClass@@EAEXXZ ENDP		; DAShotgunGameModeClass::Init
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\datasafe.h
;	COMDAT ??9?$SafeDataClass@I@@QAE_NABI@Z
_TEXT	SEGMENT
tv74 = -76						; size = 4
_data_ptr$ = -8						; size = 4
_this$ = -4						; size = 4
_data$ = 8						; size = 4
??9?$SafeDataClass@I@@QAE_NABI@Z PROC			; SafeDataClass<unsigned int>::operator!=, COMDAT
; _this$ = ecx
...
; 700  : }
	...
	pop	ebp
	ret	4
??9?$SafeDataClass@I@@QAE_NABI@Z ENDP			; SafeDataClass<unsigned int>::operator!=
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\datasafe.h
