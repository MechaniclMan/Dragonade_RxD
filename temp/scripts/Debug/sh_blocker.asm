; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\sh_blocker.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Created@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z ; SH_CustomCollisionGroup::Created
PUBLIC	?Detach@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z ; SH_CustomCollisionGroup::Detach
PUBLIC	??0SH_CustomCollisionGroup@@QAE@XZ		; SH_CustomCollisionGroup::SH_CustomCollisionGroup
PUBLIC	??1SH_CustomCollisionGroup@@UAE@XZ		; SH_CustomCollisionGroup::~SH_CustomCollisionGroup
PUBLIC	??_GSH_CustomCollisionGroup@@UAEPAXI@Z		; SH_CustomCollisionGroup::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@QAE@PBD0@Z ; ScriptRegistrant<SH_CustomCollisionGroup>::ScriptRegistrant<SH_CustomCollisionGroup>
PUBLIC	?Create@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<SH_CustomCollisionGroup>::Create
PUBLIC	??1?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAE@XZ ; ScriptRegistrant<SH_CustomCollisionGroup>::~ScriptRegistrant<SH_CustomCollisionGroup>
PUBLIC	??_G?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAXI@Z ; ScriptRegistrant<SH_CustomCollisionGroup>::`scalar deleting destructor'
...
PUBLIC	??_7SH_CustomCollisionGroup@@6B@		; SH_CustomCollisionGroup::`vftable'
PUBLIC	??_C@_0P@LJIANPK@CollisionGroup?$AA@		; `string'
PUBLIC	??_7?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@ ; ScriptRegistrant<SH_CustomCollisionGroup>::`vftable'
PUBLIC	?SH_CustomCollisionGroupRegistrant@@3V?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@A ; SH_CustomCollisionGroupRegistrant
PUBLIC	??_C@_0BF@FBFDFJCN@CollisionGroup?$DN0?3int?$AA@ ; `string'
PUBLIC	??_C@_0BI@DDPAEIKM@SH_CustomCollisionGroup?$AA@	; `string'
...
PUBLIC	??_C@_0DI@PHHNKFL@ScriptRegistrant?$DMclass?5SH_Custom@ ; `string'
...
PUBLIC	??_R4SH_CustomCollisionGroup@@6B@		; SH_CustomCollisionGroup::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVSH_CustomCollisionGroup@@@8		; SH_CustomCollisionGroup `RTTI Type Descriptor'
PUBLIC	??_R3SH_CustomCollisionGroup@@8			; SH_CustomCollisionGroup::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2SH_CustomCollisionGroup@@8			; SH_CustomCollisionGroup::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@SH_CustomCollisionGroup@@8	; SH_CustomCollisionGroup::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@ ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@@8 ; ScriptRegistrant<SH_CustomCollisionGroup> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	??_ESH_CustomCollisionGroup@@UAEPAXI@Z:PROC	; SH_CustomCollisionGroup::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<SH_CustomCollisionGroup>::`vector deleting destructor'
...
_BSS	SEGMENT
?SH_CustomCollisionGroupRegistrant@@3V?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@A DB 010H DUP (?) ; SH_CustomCollisionGroupRegistrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_SH_CustomCollisionGroupRegistrant$initializer$ DD FLAT:??__ESH_CustomCollisionGroupRegistrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@@8 ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8 DD 00H ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<SH_CustomCollisionGroup> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@ DD 00H ; ScriptRegistrant<SH_CustomCollisionGroup>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@SH_CustomCollisionGroup@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@SH_CustomCollisionGroup@@8 DD FLAT:??_R0?AVSH_CustomCollisionGroup@@@8 ; SH_CustomCollisionGroup::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3SH_CustomCollisionGroup@@8
rdata$r	ENDS
;	COMDAT ??_R2SH_CustomCollisionGroup@@8
rdata$r	SEGMENT
??_R2SH_CustomCollisionGroup@@8 DD FLAT:??_R1A@?0A@EA@SH_CustomCollisionGroup@@8 ; SH_CustomCollisionGroup::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3SH_CustomCollisionGroup@@8
rdata$r	SEGMENT
??_R3SH_CustomCollisionGroup@@8 DD 00H			; SH_CustomCollisionGroup::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2SH_CustomCollisionGroup@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVSH_CustomCollisionGroup@@@8
_DATA	SEGMENT
??_R0?AVSH_CustomCollisionGroup@@@8 DD FLAT:??_7type_info@@6B@ ; SH_CustomCollisionGroup `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVSH_CustomCollisionGroup@@', 00H
_DATA	ENDS
;	COMDAT ??_R4SH_CustomCollisionGroup@@6B@
rdata$r	SEGMENT
??_R4SH_CustomCollisionGroup@@6B@ DD 00H		; SH_CustomCollisionGroup::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVSH_CustomCollisionGroup@@@8
	DD	FLAT:??_R3SH_CustomCollisionGroup@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DI@PHHNKFL@ScriptRegistrant?$DMclass?5SH_Custom@
CONST	SEGMENT
??_C@_0DI@PHHNKFL@ScriptRegistrant?$DMclass?5SH_Custom@ DB 'ScriptRegistr'
	DB	'ant<class SH_CustomCollisionGroup>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BI@DDPAEIKM@SH_CustomCollisionGroup?$AA@
CONST	SEGMENT
??_C@_0BI@DDPAEIKM@SH_CustomCollisionGroup?$AA@ DB 'SH_CustomCollisionGro'
	DB	'up', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@FBFDFJCN@CollisionGroup?$DN0?3int?$AA@
CONST	SEGMENT
??_C@_0BF@FBFDFJCN@CollisionGroup?$DN0?3int?$AA@ DB 'CollisionGroup=0:int'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@ ; ScriptRegistrant<SH_CustomCollisionGroup>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0P@LJIANPK@CollisionGroup?$AA@
CONST	SEGMENT
??_C@_0P@LJIANPK@CollisionGroup?$AA@ DB 'CollisionGroup', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7SH_CustomCollisionGroup@@6B@
CONST	SEGMENT
??_7SH_CustomCollisionGroup@@6B@ DD FLAT:??_R4SH_CustomCollisionGroup@@6B@ ; SH_CustomCollisionGroup::`vftable'
	DD	FLAT:??_ESH_CustomCollisionGroup@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FSH_CustomCollisionGroupRegistrant@@YAXXZ
text$yd	SEGMENT
??__FSH_CustomCollisionGroupRegistrant@@YAXXZ PROC	; `dynamic atexit destructor for 'SH_CustomCollisionGroupRegistrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?SH_CustomCollisionGroupRegistrant@@3V?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@A ; SH_CustomCollisionGroupRegistrant
	call	??1?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FSH_CustomCollisionGroupRegistrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'SH_CustomCollisionGroupRegistrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_blocker.cpp
;	COMDAT ??__ESH_CustomCollisionGroupRegistrant@@YAXXZ
text$yc	SEGMENT
??__ESH_CustomCollisionGroupRegistrant@@YAXXZ PROC	; `dynamic initializer for 'SH_CustomCollisionGroupRegistrant'', COMDAT

; 76   : REGISTER_SCRIPT(SH_CustomCollisionGroup, "CollisionGroup=0:int");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0BF@FBFDFJCN@CollisionGroup?$DN0?3int?$AA@
	push	OFFSET ??_C@_0BI@DDPAEIKM@SH_CustomCollisionGroup?$AA@
	mov	ecx, OFFSET ?SH_CustomCollisionGroupRegistrant@@3V?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@A ; SH_CustomCollisionGroupRegistrant
	call	??0?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@QAE@PBD0@Z ; ScriptRegistrant<SH_CustomCollisionGroup>::ScriptRegistrant<SH_CustomCollisionGroup>
	push	OFFSET ??__FSH_CustomCollisionGroupRegistrant@@YAXXZ ; `dynamic atexit destructor for 'SH_CustomCollisionGroupRegistrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ESH_CustomCollisionGroupRegistrant@@YAXXZ ENDP	; `dynamic initializer for 'SH_CustomCollisionGroupRegistrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAXI@Z PROC ; ScriptRegistrant<SH_CustomCollisionGroup>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<SH_CustomCollisionGroup>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAE@XZ PROC ; ScriptRegistrant<SH_CustomCollisionGroup>::~ScriptRegistrant<SH_CustomCollisionGroup>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAE@XZ ENDP ; ScriptRegistrant<SH_CustomCollisionGroup>::~ScriptRegistrant<SH_CustomCollisionGroup>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<SH_CustomCollisionGroup>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DI@PHHNKFL@ScriptRegistrant?$DMclass?5SH_Custom@
	push	553					; 00000229H
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0SH_CustomCollisionGroup@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<SH_CustomCollisionGroup>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<SH_CustomCollisionGroup>::ScriptRegistrant<SH_CustomCollisionGroup>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VSH_CustomCollisionGroup@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<SH_CustomCollisionGroup>::ScriptRegistrant<SH_CustomCollisionGroup>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GSH_CustomCollisionGroup@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GSH_CustomCollisionGroup@@UAEPAXI@Z PROC		; SH_CustomCollisionGroup::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1SH_CustomCollisionGroup@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GSH_CustomCollisionGroup@@UAEPAXI@Z ENDP		; SH_CustomCollisionGroup::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1SH_CustomCollisionGroup@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1SH_CustomCollisionGroup@@UAE@XZ PROC			; SH_CustomCollisionGroup::~SH_CustomCollisionGroup, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1SH_CustomCollisionGroup@@UAE@XZ ENDP			; SH_CustomCollisionGroup::~SH_CustomCollisionGroup
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0SH_CustomCollisionGroup@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0SH_CustomCollisionGroup@@QAE@XZ PROC			; SH_CustomCollisionGroup::SH_CustomCollisionGroup, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7SH_CustomCollisionGroup@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0SH_CustomCollisionGroup@@QAE@XZ ENDP			; SH_CustomCollisionGroup::SH_CustomCollisionGroup
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_blocker.cpp
;	COMDAT ?Detach@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_phys$1 = -12						; size = 4
_physical_obj$2 = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Detach@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z PROC ; SH_CustomCollisionGroup::Detach, COMDAT
; _this$ = ecx
...
; 51   : 		// base implementation
; 52   : 		ScriptImpClass::Detach(obj);
...
; 53   : 
; 54   : 		if (Exe != 4) //make sure we dont try things in LE that may cause issues

	cmp	DWORD PTR ?Exe@@3HA, 4			; Exe
	je	SHORT $LN3@Detach

; 55   : 		{
; 56   : 			// pull out the physical_obj
; 57   : 			PhysicalGameObj* physical_obj = obj->As_PhysicalGameObj();
	...
	call	eax
	mov	DWORD PTR _physical_obj$2[ebp], eax

; 58   : 	
; 59   : 			// only physical objects can play
; 60   : 			if (!physical_obj) return;

	cmp	DWORD PTR _physical_obj$2[ebp], 0
	jne	SHORT $LN1@Detach
	jmp	SHORT $LN3@Detach
$LN1@Detach:

; 61   : 	
; 62   : 			// pull out the phys
; 63   : 			PhysClass* phys = physical_obj->Peek_Physical_Object();

	mov	ecx, DWORD PTR _physical_obj$2[ebp]
...
; 64   : 	
; 65   : 			// restore the original collision group
; 66   : 			phys->Set_Collision_Group(original_group);
...
; 67   : 	
; 68   : 			// inform netcode of the dirty things we've done with the phys
; 69   : 			physical_obj->Set_Object_Dirty_Bit(NetworkObjectClass::BIT_RARE, true);

	push	1
	push	7
	mov	ecx, DWORD PTR _physical_obj$2[ebp]
	add	ecx, 8
	mov	eax, DWORD PTR _physical_obj$2[ebp]
	mov	edx, DWORD PTR [eax+8]
...
; 71   : 	};
	...
	pop	ebp
	ret	4
?Detach@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z ENDP ; SH_CustomCollisionGroup::Detach
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_blocker.cpp
;	COMDAT ?Created@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_phys$ = -12						; size = 4
_physical_obj$ = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z PROC ; SH_CustomCollisionGroup::Created, COMDAT
; _this$ = ecx
...
; 30   : 		// pull out the physical_obj
; 31   : 		PhysicalGameObj* physical_obj = obj->As_PhysicalGameObj();
	...
	mov	eax, DWORD PTR [edx+36]
	call	eax
	mov	DWORD PTR _physical_obj$[ebp], eax

; 32   : 
; 33   : 		// only physical objects can play
; 34   : 		if (!physical_obj) return;

	cmp	DWORD PTR _physical_obj$[ebp], 0
	jne	SHORT $LN1@Created
	jmp	SHORT $LN2@Created
$LN1@Created:

; 35   : 
; 36   : 		// pull out the phys
; 37   : 		PhysClass* phys = physical_obj->Peek_Physical_Object();

	mov	ecx, DWORD PTR _physical_obj$[ebp]
	call	?Peek_Physical_Object@PhysicalGameObj@@QBEPAVPhysClass@@XZ ; PhysicalGameObj::Peek_Physical_Object
	mov	DWORD PTR _phys$[ebp], eax

; 38   : 
; 39   : 		// backup the original collision group
; 40   : 		original_group = phys->Get_Collision_Group();
...
; 41   : 
; 42   : 		// tweak the current collision group
; 43   : 		phys->Set_Collision_Group((Collision_Group_Type)Get_Int_Parameter("CollisionGroup"));

	push	OFFSET ??_C@_0P@LJIANPK@CollisionGroup?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 44   : 
; 45   : 		// inform netcode of the dirty things we've done with the phys
; 46   : 		physical_obj->Set_Object_Dirty_Bit(NetworkObjectClass::BIT_RARE, true);

	push	1
	push	7
	mov	ecx, DWORD PTR _physical_obj$[ebp]
	add	ecx, 8
	mov	eax, DWORD PTR _physical_obj$[ebp]
	mov	edx, DWORD PTR [eax+8]
	mov	eax, DWORD PTR [edx+56]
	call	eax
$LN2@Created:
...
; 47   : 	};
	...
	pop	ebp
	ret	4
?Created@SH_CustomCollisionGroup@@UAEXPAVScriptableGameObj@@@Z ENDP ; SH_CustomCollisionGroup::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
