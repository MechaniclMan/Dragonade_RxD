; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\dan.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Created@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::Created
PUBLIC	?Custom@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@HH0@Z ; DAN_CnC_Crate::Custom
PUBLIC	?Points@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z ; DAN_CnC_Crate::Points
PUBLIC	?DeathCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::DeathCrate
PUBLIC	?StealthSuit@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::StealthSuit
PUBLIC	?DeHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::DeHealth
PUBLIC	?DeArmour@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::DeArmour
PUBLIC	?FullHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::FullHealth
PUBLIC	?Money@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z ; DAN_CnC_Crate::Money
PUBLIC	?SpyCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::SpyCrate
PUBLIC	?RandomWeapon@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::RandomWeapon
PUBLIC	?Theif@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::Theif
PUBLIC	?Register_Auto_Save_Variables@DAN_CnC_Crate@@UAEXXZ ; DAN_CnC_Crate::Register_Auto_Save_Variables
PUBLIC	??0DAN_CnC_Crate@@QAE@XZ			; DAN_CnC_Crate::DAN_CnC_Crate
PUBLIC	??1DAN_CnC_Crate@@UAE@XZ			; DAN_CnC_Crate::~DAN_CnC_Crate
PUBLIC	??_GDAN_CnC_Crate@@UAEPAXI@Z			; DAN_CnC_Crate::`scalar deleting destructor'
PUBLIC	?Killed@DAN_Drop_Wreckage_On_Death@@EAEXPAVScriptableGameObj@@0@Z ; DAN_Drop_Wreckage_On_Death::Killed
PUBLIC	??0DAN_Drop_Wreckage_On_Death@@QAE@XZ		; DAN_Drop_Wreckage_On_Death::DAN_Drop_Wreckage_On_Death
PUBLIC	??1DAN_Drop_Wreckage_On_Death@@UAE@XZ		; DAN_Drop_Wreckage_On_Death::~DAN_Drop_Wreckage_On_Death
PUBLIC	??_GDAN_Drop_Wreckage_On_Death@@UAEPAXI@Z	; DAN_Drop_Wreckage_On_Death::`scalar deleting destructor'
PUBLIC	?Created@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@@Z ; DAN_Wreckage_Rebuildable::Created
PUBLIC	?Damaged@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@0M@Z ; DAN_Wreckage_Rebuildable::Damaged
PUBLIC	??0DAN_Wreckage_Rebuildable@@QAE@XZ		; DAN_Wreckage_Rebuildable::DAN_Wreckage_Rebuildable
PUBLIC	??1DAN_Wreckage_Rebuildable@@UAE@XZ		; DAN_Wreckage_Rebuildable::~DAN_Wreckage_Rebuildable
PUBLIC	??_GDAN_Wreckage_Rebuildable@@UAEPAXI@Z		; DAN_Wreckage_Rebuildable::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VDAN_CnC_Crate@@@@QAE@PBD0@Z ; ScriptRegistrant<DAN_CnC_Crate>::ScriptRegistrant<DAN_CnC_Crate>
PUBLIC	?Create@?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<DAN_CnC_Crate>::Create
PUBLIC	??1?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAE@XZ	; ScriptRegistrant<DAN_CnC_Crate>::~ScriptRegistrant<DAN_CnC_Crate>
PUBLIC	??_G?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAXI@Z ; ScriptRegistrant<DAN_CnC_Crate>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@QAE@PBD0@Z ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::ScriptRegistrant<DAN_Drop_Wreckage_On_Death>
PUBLIC	?Create@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::Create
PUBLIC	??1?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAE@XZ ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::~ScriptRegistrant<DAN_Drop_Wreckage_On_Death>
PUBLIC	??_G?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAXI@Z ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@QAE@PBD0@Z ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::ScriptRegistrant<DAN_Wreckage_Rebuildable>
PUBLIC	?Create@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::Create
PUBLIC	??1?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAE@XZ ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::~ScriptRegistrant<DAN_Wreckage_Rebuildable>
PUBLIC	??_G?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAXI@Z ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`scalar deleting destructor'
...
PUBLIC	??_7DAN_CnC_Crate@@6B@				; DAN_CnC_Crate::`vftable'
PUBLIC	??_7DAN_Drop_Wreckage_On_Death@@6B@		; DAN_Drop_Wreckage_On_Death::`vftable'
PUBLIC	??_7DAN_Wreckage_Rebuildable@@6B@		; DAN_Wreckage_Rebuildable::`vftable'
PUBLIC	??_C@_08KJFDAMJE@vehcol2m?$AA@			; `string'
PUBLIC	??_C@_0BA@OPFMGFNB@Vehicle_Blocker?$AA@		; `string'
PUBLIC	??_C@_06KANFALAM@Points?$AA@			; `string'
PUBLIC	??_C@_0M@BBADFEMH@Death_Crate?$AA@		; `string'
PUBLIC	??_C@_0N@IEOKPBOP@Stealth_Suit?$AA@		; `string'
PUBLIC	??_C@_08GCAIFBH@DeHealth?$AA@			; `string'
PUBLIC	??_C@_08OLMBCAOE@DeArmour?$AA@			; `string'
PUBLIC	??_C@_0M@CNCIDAIH@Full_Health?$AA@		; `string'
PUBLIC	??_C@_05INIBOMDG@Money?$AA@			; `string'
PUBLIC	??_C@_09BKEBHOJH@Spy_Crate?$AA@			; `string'
PUBLIC	??_C@_0O@NCDPHFJO@Random_Weapon?$AA@		; `string'
PUBLIC	??_C@_05IDJBDIO@Theif?$AA@			; `string'
PUBLIC	??_C@_0DE@DFGNMDND@?$FLCrate?5Script?$FN?5Error?3?5Non?9Exista@ ; `string'
PUBLIC	??_C@_03OHGKCNFD@Nod?$AA@			; `string'
PUBLIC	??_C@_03IOFAJBDH@GDI?$AA@			; `string'
PUBLIC	??_C@_0CL@JOHJIEBL@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5100?5@ ; `string'
PUBLIC	??_C@_0CL@JCJJGOKP@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5500?5@ ; `string'
PUBLIC	??_C@_0CM@FMOHGIO@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?51000@ ; `string'
PUBLIC	??_C@_0DI@IMPAJEMH@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@ ; `string'
PUBLIC	??_C@_0DI@GIMPBKE@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@ ; `string'
PUBLIC	??_C@_0DJ@JCIILKJJ@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@ ; `string'
PUBLIC	??_C@_0BM@HFFMNHJD@Beacon_Ion_Cannon_Anim_Post?$AA@ ; `string'
PUBLIC	??_C@_05PGGAFPFO@Death?$AA@			; `string'
PUBLIC	??_C@_0EE@FBMAKOGL@MESSAGE?5?$FLCrate?$FN?5Some?5poor?5?$CFs?5guy@ ; `string'
PUBLIC	??_C@_0DC@OEPLOBAA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@ ; `string'
PUBLIC	??_C@_0DA@KOANLGJC@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Armour?5has@ ; `string'
PUBLIC	??_C@_0DC@MJBNDGJD@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@ ; `string'
PUBLIC	??_C@_0DA@NKGKADIE@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5has@ ; `string'
PUBLIC	??_C@_0DF@BLOGGKPG@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@ ; `string'
PUBLIC	??_C@_0DO@ILLJPHKI@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5and@ ; `string'
PUBLIC	??_C@_0DP@EKIBNOHC@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@ ; `string'
PUBLIC	??_C@_0DP@JBELJNLO@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?550@ ; `string'
PUBLIC	??_C@_0EA@HPKJGBCK@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@ ; `string'
PUBLIC	??_C@_0EA@MNKOGAFA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@ ; `string'
PUBLIC	??_C@_0EA@BGGECDJM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?55@ ; `string'
PUBLIC	??_C@_0EB@KKEOAPHA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@ ; `string'
PUBLIC	??_C@_0O@KHEPPGKC@Random?5Weapon?$AA@		; `string'
PUBLIC	??_C@_0BN@LNEEPDJK@CnC_POW_AutoRifle_Player_GDI?$AA@ ; `string'
PUBLIC	??_C@_09BALDGHFC@AutoRifle?$AA@			; `string'
PUBLIC	??_C@_0BE@MNHLMFIN@POW_Chaingun_Player?$AA@	; `string'
PUBLIC	??_C@_08HGFIDDGE@ChainGun?$AA@			; `string'
PUBLIC	??_C@_0BH@IEBFNIJ@POW_ChemSprayer_Player?$AA@	; `string'
PUBLIC	??_C@_0N@MJKCECGH@Chem?5Sprayer?$AA@		; `string'
PUBLIC	??_C@_0BI@CPKKILGH@POW_Flamethrower_Player?$AA@	; `string'
PUBLIC	??_C@_0N@PCEMONCD@FlameThrower?$AA@		; `string'
PUBLIC	??_C@_0BL@PLIKDCOD@POW_GrenadeLauncher_Player?$AA@ ; `string'
PUBLIC	??_C@_0BB@GIEOMMBO@Grenade?5Launcher?$AA@	; `string'
PUBLIC	??_C@_0BJ@DCEKIBO@POW_LaserChaingun_Player?$AA@	; `string'
PUBLIC	??_C@_0P@CHLANEGF@Laser?5Chaingun?$AA@		; `string'
PUBLIC	??_C@_0BG@PDODNLCD@POW_LaserRifle_Player?$AA@	; `string'
PUBLIC	??_C@_0M@JIDFGGKB@Laser?5Rifle?$AA@		; `string'
PUBLIC	??_C@_0BJ@NBMNFBAO@POW_MineProximity_Player?$AA@ ; `string'
PUBLIC	??_C@_0P@LDPJNFDM@Proximity?5Mine?$AA@		; `string'
PUBLIC	??_C@_0BG@OOJAAJNC@POW_MineRemote_Player?$AA@	; `string'
PUBLIC	??_C@_0M@JIJMKCGL@Remote?5Mine?$AA@		; `string'
PUBLIC	??_C@_0BF@NCBBDDDP@POW_MineTimed_Player?$AA@	; `string'
PUBLIC	??_C@_08EOMCENKK@Timed?5C4?$AA@			; `string'
PUBLIC	??_C@_0BN@JFMDLPCE@POW_PersonalIonCannon_Player?$AA@ ; `string'
PUBLIC	??_C@_0BE@BNLHADBG@Personal?5Ion?5Cannon?$AA@	; `string'
PUBLIC	??_C@_0BD@EEDBCDBM@POW_Railgun_Player?$AA@	; `string'
PUBLIC	??_C@_07HMKBNLLE@RailGun?$AA@			; `string'
PUBLIC	??_C@_0BH@GEDCLKJB@POW_RamjetRifle_Player?$AA@	; `string'
PUBLIC	??_C@_0N@BEBCIPAC@Ramjet?5Rifle?$AA@		; `string'
PUBLIC	??_C@_0BK@MPOBPNAD@POW_RocketLauncher_Player?$AA@ ; `string'
PUBLIC	??_C@_0P@DLPOPCDE@RocketLauncher?$AA@		; `string'
PUBLIC	??_C@_0BD@PJGNEDGL@POW_Shotgun_Player?$AA@	; `string'
PUBLIC	??_C@_07DGIAOJJ@Shotgun?$AA@			; `string'
PUBLIC	??_C@_0BH@NMPBHGGK@POW_SniperRifle_Player?$AA@	; `string'
PUBLIC	??_C@_0N@PNCKKCNC@Sniper?5Rifle?$AA@		; `string'
PUBLIC	??_C@_0BN@DFPKBHOD@POW_TiberiumAutoRifle_Player?$AA@ ; `string'
PUBLIC	??_C@_0BD@HOPBGNJM@Tiberium?5AutoRifle?$AA@	; `string'
PUBLIC	??_C@_0CA@LONNBBEG@POW_TiberiumFlechetteGun_Player?$AA@ ; `string'
PUBLIC	??_C@_0BH@FLHHBJAG@Tiberium?5Flechette?5Gun?$AA@ ; `string'
PUBLIC	??_C@_0ED@FCCMOKPM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5been?5g@ ; `string'
PUBLIC	??_C@_0EK@IEJILPIP@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5got?5@ ; `string'
PUBLIC	??_C@_0DE@GIGKJILE@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5foun@ ; `string'
PUBLIC	??_C@_0EC@JCFFNCHJ@MESSAGE?5?$FLCrate?$FN?5Awwww?0?5some?5poor@ ; `string'
PUBLIC	??_C@_0BA@BKACAECP@Wreckage_Preset?$AA@		; `string'
PUBLIC	??_C@_0BJ@GBJDLGFE@DAN_Wreckage_Rebuildable?$AA@ ; `string'
PUBLIC	??_C@_0P@LNANEEHL@Vehicle_Preset?$AA@		; `string'
PUBLIC	??_7?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@	; ScriptRegistrant<DAN_CnC_Crate>::`vftable'
PUBLIC	?DAN_CnC_Crate_Registrant@@3V?$ScriptRegistrant@VDAN_CnC_Crate@@@@A ; DAN_CnC_Crate_Registrant
PUBLIC	??_C@_0IK@JCFAOJPL@Death_Crate?3int?0Stealth_Suit?3int@ ; `string'
PUBLIC	??_C@_0O@HFMLEFFA@DAN_CnC_Crate?$AA@		; `string'
PUBLIC	??_7?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@ ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`vftable'
PUBLIC	?DAN_Drop_Wreckage_On_Death_Registrant@@3V?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@A ; DAN_Drop_Wreckage_On_Death_Registrant
PUBLIC	??_C@_0BH@BDPHDFEA@Wreckage_Preset?3string?$AA@	; `string'
PUBLIC	??_C@_0BL@CHLLAFDD@DAN_Drop_Wreckage_On_Death?$AA@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@ ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`vftable'
PUBLIC	?DAN_Wreckage_Rebuildable_Registrant@@3V?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@A ; DAN_Wreckage_Rebuildable_Registrant
PUBLIC	??_C@_0BG@JJNJEEOF@Vehicle_Preset?3string?$AA@	; `string'
...
PUBLIC	??_C@_0CO@NPBAPBE@ScriptRegistrant?$DMclass?5DAN_CnC_C@ ; `string'
...
PUBLIC	??_C@_0DL@MBHDMDNB@ScriptRegistrant?$DMclass?5DAN_Drop_@ ; `string'
PUBLIC	??_C@_0DJ@CJNBOBLB@ScriptRegistrant?$DMclass?5DAN_Wreck@ ; `string'
...
PUBLIC	??_R4DAN_CnC_Crate@@6B@				; DAN_CnC_Crate::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVDAN_CnC_Crate@@@8			; DAN_CnC_Crate `RTTI Type Descriptor'
PUBLIC	??_R3DAN_CnC_Crate@@8				; DAN_CnC_Crate::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2DAN_CnC_Crate@@8				; DAN_CnC_Crate::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@DAN_CnC_Crate@@8			; DAN_CnC_Crate::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4DAN_Drop_Wreckage_On_Death@@6B@		; DAN_Drop_Wreckage_On_Death::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVDAN_Drop_Wreckage_On_Death@@@8		; DAN_Drop_Wreckage_On_Death `RTTI Type Descriptor'
PUBLIC	??_R3DAN_Drop_Wreckage_On_Death@@8		; DAN_Drop_Wreckage_On_Death::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2DAN_Drop_Wreckage_On_Death@@8		; DAN_Drop_Wreckage_On_Death::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@DAN_Drop_Wreckage_On_Death@@8	; DAN_Drop_Wreckage_On_Death::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4DAN_Wreckage_Rebuildable@@6B@		; DAN_Wreckage_Rebuildable::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVDAN_Wreckage_Rebuildable@@@8		; DAN_Wreckage_Rebuildable `RTTI Type Descriptor'
PUBLIC	??_R3DAN_Wreckage_Rebuildable@@8		; DAN_Wreckage_Rebuildable::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2DAN_Wreckage_Rebuildable@@8		; DAN_Wreckage_Rebuildable::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@DAN_Wreckage_Rebuildable@@8	; DAN_Wreckage_Rebuildable::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@	; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VDAN_CnC_Crate@@@@@8	; ScriptRegistrant<DAN_CnC_Crate> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VDAN_CnC_Crate@@@@8	; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VDAN_CnC_Crate@@@@8	; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_CnC_Crate@@@@8 ; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@ ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@@8 ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@ ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@@8 ; ScriptRegistrant<DAN_Wreckage_Rebuildable> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	??_EDAN_CnC_Crate@@UAEPAXI@Z:PROC		; DAN_CnC_Crate::`vector deleting destructor'
EXTRN	??_EDAN_Drop_Wreckage_On_Death@@UAEPAXI@Z:PROC	; DAN_Drop_Wreckage_On_Death::`vector deleting destructor'
EXTRN	??_EDAN_Wreckage_Rebuildable@@UAEPAXI@Z:PROC	; DAN_Wreckage_Rebuildable::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<DAN_CnC_Crate>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`vector deleting destructor'
...
_BSS	SEGMENT
?DAN_CnC_Crate_Registrant@@3V?$ScriptRegistrant@VDAN_CnC_Crate@@@@A DB 010H DUP (?) ; DAN_CnC_Crate_Registrant
?DAN_Drop_Wreckage_On_Death_Registrant@@3V?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@A DB 010H DUP (?) ; DAN_Drop_Wreckage_On_Death_Registrant
?DAN_Wreckage_Rebuildable_Registrant@@3V?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@A DB 010H DUP (?) ; DAN_Wreckage_Rebuildable_Registrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_DAN_CnC_Crate_Registrant$initializer$ DD FLAT:??__EDAN_CnC_Crate_Registrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@@8 ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8 DD 00H ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<DAN_Wreckage_Rebuildable> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@ DD 00H ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@@8 ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8 DD 00H ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@ DD 00H ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_CnC_Crate@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_CnC_Crate@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VDAN_CnC_Crate@@@@@8 ; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VDAN_CnC_Crate@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VDAN_CnC_Crate@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VDAN_CnC_Crate@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VDAN_CnC_Crate@@@@8 ; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VDAN_CnC_Crate@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VDAN_CnC_Crate@@@@8 DD 00H	; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VDAN_CnC_Crate@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VDAN_CnC_Crate@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VDAN_CnC_Crate@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<DAN_CnC_Crate> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VDAN_CnC_Crate@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@ DD 00H	; ScriptRegistrant<DAN_CnC_Crate>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VDAN_CnC_Crate@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VDAN_CnC_Crate@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@DAN_Wreckage_Rebuildable@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@DAN_Wreckage_Rebuildable@@8 DD FLAT:??_R0?AVDAN_Wreckage_Rebuildable@@@8 ; DAN_Wreckage_Rebuildable::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3DAN_Wreckage_Rebuildable@@8
rdata$r	ENDS
;	COMDAT ??_R2DAN_Wreckage_Rebuildable@@8
rdata$r	SEGMENT
??_R2DAN_Wreckage_Rebuildable@@8 DD FLAT:??_R1A@?0A@EA@DAN_Wreckage_Rebuildable@@8 ; DAN_Wreckage_Rebuildable::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3DAN_Wreckage_Rebuildable@@8
rdata$r	SEGMENT
??_R3DAN_Wreckage_Rebuildable@@8 DD 00H			; DAN_Wreckage_Rebuildable::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2DAN_Wreckage_Rebuildable@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVDAN_Wreckage_Rebuildable@@@8
_DATA	SEGMENT
??_R0?AVDAN_Wreckage_Rebuildable@@@8 DD FLAT:??_7type_info@@6B@ ; DAN_Wreckage_Rebuildable `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVDAN_Wreckage_Rebuildable@@', 00H
_DATA	ENDS
;	COMDAT ??_R4DAN_Wreckage_Rebuildable@@6B@
rdata$r	SEGMENT
??_R4DAN_Wreckage_Rebuildable@@6B@ DD 00H		; DAN_Wreckage_Rebuildable::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVDAN_Wreckage_Rebuildable@@@8
	DD	FLAT:??_R3DAN_Wreckage_Rebuildable@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@DAN_Drop_Wreckage_On_Death@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@DAN_Drop_Wreckage_On_Death@@8 DD FLAT:??_R0?AVDAN_Drop_Wreckage_On_Death@@@8 ; DAN_Drop_Wreckage_On_Death::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3DAN_Drop_Wreckage_On_Death@@8
rdata$r	ENDS
;	COMDAT ??_R2DAN_Drop_Wreckage_On_Death@@8
rdata$r	SEGMENT
??_R2DAN_Drop_Wreckage_On_Death@@8 DD FLAT:??_R1A@?0A@EA@DAN_Drop_Wreckage_On_Death@@8 ; DAN_Drop_Wreckage_On_Death::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3DAN_Drop_Wreckage_On_Death@@8
rdata$r	SEGMENT
??_R3DAN_Drop_Wreckage_On_Death@@8 DD 00H		; DAN_Drop_Wreckage_On_Death::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2DAN_Drop_Wreckage_On_Death@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVDAN_Drop_Wreckage_On_Death@@@8
_DATA	SEGMENT
??_R0?AVDAN_Drop_Wreckage_On_Death@@@8 DD FLAT:??_7type_info@@6B@ ; DAN_Drop_Wreckage_On_Death `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVDAN_Drop_Wreckage_On_Death@@', 00H
_DATA	ENDS
;	COMDAT ??_R4DAN_Drop_Wreckage_On_Death@@6B@
rdata$r	SEGMENT
??_R4DAN_Drop_Wreckage_On_Death@@6B@ DD 00H		; DAN_Drop_Wreckage_On_Death::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVDAN_Drop_Wreckage_On_Death@@@8
	DD	FLAT:??_R3DAN_Drop_Wreckage_On_Death@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@DAN_CnC_Crate@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@DAN_CnC_Crate@@8 DD FLAT:??_R0?AVDAN_CnC_Crate@@@8 ; DAN_CnC_Crate::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3DAN_CnC_Crate@@8
rdata$r	ENDS
;	COMDAT ??_R2DAN_CnC_Crate@@8
rdata$r	SEGMENT
??_R2DAN_CnC_Crate@@8 DD FLAT:??_R1A@?0A@EA@DAN_CnC_Crate@@8 ; DAN_CnC_Crate::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3DAN_CnC_Crate@@8
rdata$r	SEGMENT
??_R3DAN_CnC_Crate@@8 DD 00H				; DAN_CnC_Crate::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2DAN_CnC_Crate@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVDAN_CnC_Crate@@@8
_DATA	SEGMENT
??_R0?AVDAN_CnC_Crate@@@8 DD FLAT:??_7type_info@@6B@	; DAN_CnC_Crate `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVDAN_CnC_Crate@@', 00H
_DATA	ENDS
;	COMDAT ??_R4DAN_CnC_Crate@@6B@
rdata$r	SEGMENT
??_R4DAN_CnC_Crate@@6B@ DD 00H				; DAN_CnC_Crate::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVDAN_CnC_Crate@@@8
	DD	FLAT:??_R3DAN_CnC_Crate@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DJ@CJNBOBLB@ScriptRegistrant?$DMclass?5DAN_Wreck@
CONST	SEGMENT
??_C@_0DJ@CJNBOBLB@ScriptRegistrant?$DMclass?5DAN_Wreck@ DB 'ScriptRegist'
	DB	'rant<class DAN_Wreckage_Rebuildable>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DL@MBHDMDNB@ScriptRegistrant?$DMclass?5DAN_Drop_@
CONST	SEGMENT
??_C@_0DL@MBHDMDNB@ScriptRegistrant?$DMclass?5DAN_Drop_@ DB 'ScriptRegist'
	DB	'rant<class DAN_Drop_Wreckage_On_Death>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0CO@NPBAPBE@ScriptRegistrant?$DMclass?5DAN_CnC_C@
CONST	SEGMENT
??_C@_0CO@NPBAPBE@ScriptRegistrant?$DMclass?5DAN_CnC_C@ DB 'ScriptRegistr'
	DB	'ant<class DAN_CnC_Crate>::Create', 00H	; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BG@JJNJEEOF@Vehicle_Preset?3string?$AA@
CONST	SEGMENT
??_C@_0BG@JJNJEEOF@Vehicle_Preset?3string?$AA@ DB 'Vehicle_Preset:string', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@ ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BL@CHLLAFDD@DAN_Drop_Wreckage_On_Death?$AA@
CONST	SEGMENT
??_C@_0BL@CHLLAFDD@DAN_Drop_Wreckage_On_Death?$AA@ DB 'DAN_Drop_Wreckage_'
	DB	'On_Death', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@BDPHDFEA@Wreckage_Preset?3string?$AA@
CONST	SEGMENT
??_C@_0BH@BDPHDFEA@Wreckage_Preset?3string?$AA@ DB 'Wreckage_Preset:strin'
	DB	'g', 00H					; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@ ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0O@HFMLEFFA@DAN_CnC_Crate?$AA@
CONST	SEGMENT
??_C@_0O@HFMLEFFA@DAN_CnC_Crate?$AA@ DB 'DAN_CnC_Crate', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0IK@JCFAOJPL@Death_Crate?3int?0Stealth_Suit?3int@
CONST	SEGMENT
??_C@_0IK@JCFAOJPL@Death_Crate?3int?0Stealth_Suit?3int@ DB 'Death_Crate:i'
	DB	'nt,Stealth_Suit:int,DeHealth:int,DeArmour:int,Full_Health:int'
	DB	',Money:int,Spy_Crate:int,Random_Weapon:int,Points:int,Theif:i'
	DB	'nt', 00H					; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@ ; ScriptRegistrant<DAN_CnC_Crate>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0P@LNANEEHL@Vehicle_Preset?$AA@
CONST	SEGMENT
??_C@_0P@LNANEEHL@Vehicle_Preset?$AA@ DB 'Vehicle_Preset', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@GBJDLGFE@DAN_Wreckage_Rebuildable?$AA@
CONST	SEGMENT
??_C@_0BJ@GBJDLGFE@DAN_Wreckage_Rebuildable?$AA@ DB 'DAN_Wreckage_Rebuild'
	DB	'able', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@BKACAECP@Wreckage_Preset?$AA@
CONST	SEGMENT
??_C@_0BA@BKACAECP@Wreckage_Preset?$AA@ DB 'Wreckage_Preset', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0EC@JCFFNCHJ@MESSAGE?5?$FLCrate?$FN?5Awwww?0?5some?5poor@
CONST	SEGMENT
??_C@_0EC@JCFFNCHJ@MESSAGE?5?$FLCrate?$FN?5Awwww?0?5some?5poor@ DB 'MESSA'
	DB	'GE [Crate] Awwww, some poor %s guy lost all his money! Pwnt!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DE@GIGKJILE@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5foun@
CONST	SEGMENT
??_C@_0DE@GIGKJILE@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5foun@ DB 'ME'
	DB	'SSAGE [Crate] Some %s guy found the Stealth Suit!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0EK@IEJILPIP@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5got?5@
CONST	SEGMENT
??_C@_0EK@IEJILPIP@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5got?5@ DB 'M'
	DB	'ESSAGE [Crate] Some %s guy got the Spy Crate! Better watch yo'
	DB	'ur base, %s', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0ED@FCCMOKPM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5been?5g@
CONST	SEGMENT
??_C@_0ED@FCCMOKPM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5been?5g@ DB 'P'
	DB	'PAGE %d [Crate] You have been given a %s from the Weapons Loc'
	DB	'ker!', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@FLHHBJAG@Tiberium?5Flechette?5Gun?$AA@
CONST	SEGMENT
??_C@_0BH@FLHHBJAG@Tiberium?5Flechette?5Gun?$AA@ DB 'Tiberium Flechette G'
	DB	'un', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0CA@LONNBBEG@POW_TiberiumFlechetteGun_Player?$AA@
CONST	SEGMENT
??_C@_0CA@LONNBBEG@POW_TiberiumFlechetteGun_Player?$AA@ DB 'POW_TiberiumF'
	DB	'lechetteGun_Player', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@HOPBGNJM@Tiberium?5AutoRifle?$AA@
CONST	SEGMENT
??_C@_0BD@HOPBGNJM@Tiberium?5AutoRifle?$AA@ DB 'Tiberium AutoRifle', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@DFPKBHOD@POW_TiberiumAutoRifle_Player?$AA@
CONST	SEGMENT
??_C@_0BN@DFPKBHOD@POW_TiberiumAutoRifle_Player?$AA@ DB 'POW_TiberiumAuto'
...
CONST	ENDS
;	COMDAT ??_C@_0BH@NMPBHGGK@POW_SniperRifle_Player?$AA@
CONST	SEGMENT
??_C@_0BH@NMPBHGGK@POW_SniperRifle_Player?$AA@ DB 'POW_SniperRifle_Player'
	DB	00H						; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BD@PJGNEDGL@POW_Shotgun_Player?$AA@
CONST	SEGMENT
??_C@_0BD@PJGNEDGL@POW_Shotgun_Player?$AA@ DB 'POW_Shotgun_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@DLPOPCDE@RocketLauncher?$AA@
CONST	SEGMENT
??_C@_0P@DLPOPCDE@RocketLauncher?$AA@ DB 'RocketLauncher', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@MPOBPNAD@POW_RocketLauncher_Player?$AA@
CONST	SEGMENT
??_C@_0BK@MPOBPNAD@POW_RocketLauncher_Player?$AA@ DB 'POW_RocketLauncher_'
	DB	'Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@BEBCIPAC@Ramjet?5Rifle?$AA@
CONST	SEGMENT
??_C@_0N@BEBCIPAC@Ramjet?5Rifle?$AA@ DB 'Ramjet Rifle', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@GEDCLKJB@POW_RamjetRifle_Player?$AA@
CONST	SEGMENT
??_C@_0BH@GEDCLKJB@POW_RamjetRifle_Player?$AA@ DB 'POW_RamjetRifle_Player'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_07HMKBNLLE@RailGun?$AA@
CONST	SEGMENT
??_C@_07HMKBNLLE@RailGun?$AA@ DB 'RailGun', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@EEDBCDBM@POW_Railgun_Player?$AA@
CONST	SEGMENT
??_C@_0BD@EEDBCDBM@POW_Railgun_Player?$AA@ DB 'POW_Railgun_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@BNLHADBG@Personal?5Ion?5Cannon?$AA@
CONST	SEGMENT
??_C@_0BE@BNLHADBG@Personal?5Ion?5Cannon?$AA@ DB 'Personal Ion Cannon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@JFMDLPCE@POW_PersonalIonCannon_Player?$AA@
CONST	SEGMENT
??_C@_0BN@JFMDLPCE@POW_PersonalIonCannon_Player?$AA@ DB 'POW_PersonalIonC'
	DB	'annon_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_08EOMCENKK@Timed?5C4?$AA@
CONST	SEGMENT
??_C@_08EOMCENKK@Timed?5C4?$AA@ DB 'Timed C4', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@NCBBDDDP@POW_MineTimed_Player?$AA@
CONST	SEGMENT
??_C@_0BF@NCBBDDDP@POW_MineTimed_Player?$AA@ DB 'POW_MineTimed_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@JIJMKCGL@Remote?5Mine?$AA@
CONST	SEGMENT
??_C@_0M@JIJMKCGL@Remote?5Mine?$AA@ DB 'Remote Mine', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0P@LDPJNFDM@Proximity?5Mine?$AA@
CONST	SEGMENT
??_C@_0P@LDPJNFDM@Proximity?5Mine?$AA@ DB 'Proximity Mine', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@NBMNFBAO@POW_MineProximity_Player?$AA@
CONST	SEGMENT
??_C@_0BJ@NBMNFBAO@POW_MineProximity_Player?$AA@ DB 'POW_MineProximity_Pl'
	DB	'ayer', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@JIDFGGKB@Laser?5Rifle?$AA@
CONST	SEGMENT
??_C@_0M@JIDFGGKB@Laser?5Rifle?$AA@ DB 'Laser Rifle', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@PDODNLCD@POW_LaserRifle_Player?$AA@
CONST	SEGMENT
??_C@_0BG@PDODNLCD@POW_LaserRifle_Player?$AA@ DB 'POW_LaserRifle_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@CHLANEGF@Laser?5Chaingun?$AA@
CONST	SEGMENT
??_C@_0P@CHLANEGF@Laser?5Chaingun?$AA@ DB 'Laser Chaingun', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@DCEKIBO@POW_LaserChaingun_Player?$AA@
CONST	SEGMENT
??_C@_0BJ@DCEKIBO@POW_LaserChaingun_Player?$AA@ DB 'POW_LaserChaingun_Pla'
	DB	'yer', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@GIEOMMBO@Grenade?5Launcher?$AA@
CONST	SEGMENT
??_C@_0BB@GIEOMMBO@Grenade?5Launcher?$AA@ DB 'Grenade Launcher', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@PLIKDCOD@POW_GrenadeLauncher_Player?$AA@
CONST	SEGMENT
??_C@_0BL@PLIKDCOD@POW_GrenadeLauncher_Player?$AA@ DB 'POW_GrenadeLaunche'
	DB	'r_Player', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@PCEMONCD@FlameThrower?$AA@
CONST	SEGMENT
??_C@_0N@PCEMONCD@FlameThrower?$AA@ DB 'FlameThrower', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@CPKKILGH@POW_Flamethrower_Player?$AA@
CONST	SEGMENT
??_C@_0BI@CPKKILGH@POW_Flamethrower_Player?$AA@ DB 'POW_Flamethrower_Play'
	DB	'er', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@MJKCECGH@Chem?5Sprayer?$AA@
CONST	SEGMENT
??_C@_0N@MJKCECGH@Chem?5Sprayer?$AA@ DB 'Chem Sprayer', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_08HGFIDDGE@ChainGun?$AA@
CONST	SEGMENT
??_C@_08HGFIDDGE@ChainGun?$AA@ DB 'ChainGun', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@MNHLMFIN@POW_Chaingun_Player?$AA@
CONST	SEGMENT
??_C@_0BE@MNHLMFIN@POW_Chaingun_Player?$AA@ DB 'POW_Chaingun_Player', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_09BALDGHFC@AutoRifle?$AA@
CONST	SEGMENT
??_C@_09BALDGHFC@AutoRifle?$AA@ DB 'AutoRifle', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@LNEEPDJK@CnC_POW_AutoRifle_Player_GDI?$AA@
CONST	SEGMENT
??_C@_0BN@LNEEPDJK@CnC_POW_AutoRifle_Player_GDI?$AA@ DB 'CnC_POW_AutoRifl'
	DB	'e_Player_GDI', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@KHEPPGKC@Random?5Weapon?$AA@
CONST	SEGMENT
??_C@_0O@KHEPPGKC@Random?5Weapon?$AA@ DB 'Random Weapon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0EB@KKEOAPHA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@
CONST	SEGMENT
??_C@_0EB@KKEOAPHA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@ DB 'P'
	DB	'PAGE %d [Crate] You have lost 1000 Credits from the MoneyCrat'
	DB	'e!', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0EA@BGGECDJM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?55@
CONST	SEGMENT
??_C@_0EA@BGGECDJM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?55@ DB 'P'
	DB	'PAGE %d [Crate] You have lost 500 Credits from the MoneyCrate'
	DB	'!', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0EA@MNKOGAFA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@
CONST	SEGMENT
??_C@_0EA@MNKOGAFA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@ DB 'P'
	DB	'PAGE %d [Crate] You have lost 100 Credits from the MoneyCrate'
	DB	'!', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0EA@HPKJGBCK@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@
CONST	SEGMENT
??_C@_0EA@HPKJGBCK@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@ DB 'P'
	DB	'PAGE %d [Crate] You have got 1000 Credits from the MoneyCrate'
	DB	'!', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0DP@JBELJNLO@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?550@
CONST	SEGMENT
??_C@_0DP@JBELJNLO@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?550@ DB 'P'
	DB	'PAGE %d [Crate] You have got 500 Credits from the MoneyCrate!'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0DP@EKIBNOHC@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@
CONST	SEGMENT
??_C@_0DP@EKIBNOHC@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@ DB 'P'
	DB	'PAGE %d [Crate] You have got 100 Credits from the MoneyCrate!'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0DO@ILLJPHKI@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5and@
CONST	SEGMENT
??_C@_0DO@ILLJPHKI@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5and@ DB 'PP'
	DB	'AGE %d [Crate] Your Health and Armour has been replenished!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DF@BLOGGKPG@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@
CONST	SEGMENT
??_C@_0DF@BLOGGKPG@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@ DB 'P'
	DB	'PAGE %d [Crate] You have got the Full Health Crate!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DA@NKGKADIE@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5has@
CONST	SEGMENT
??_C@_0DA@NKGKADIE@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5has@ DB 'PP'
	DB	'AGE %d [Crate] Your Health has been set to 1!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DC@MJBNDGJD@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@
CONST	SEGMENT
??_C@_0DC@MJBNDGJD@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@ DB 'P'
	DB	'PAGE %d [Crate] You have got the DeHealth Crate!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DA@KOANLGJC@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Armour?5has@
CONST	SEGMENT
??_C@_0DA@KOANLGJC@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Armour?5has@ DB 'PP'
	DB	'AGE %d [Crate] Your Armour has been set to 1!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DC@OEPLOBAA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@
CONST	SEGMENT
??_C@_0DC@OEPLOBAA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@ DB 'P'
	DB	'PAGE %d [Crate] You have got the DeArmour Crate!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0EE@FBMAKOGL@MESSAGE?5?$FLCrate?$FN?5Some?5poor?5?$CFs?5guy@
CONST	SEGMENT
??_C@_0EE@FBMAKOGL@MESSAGE?5?$FLCrate?$FN?5Some?5poor?5?$CFs?5guy@ DB 'ME'
	DB	'SSAGE [Crate] Some poor %s guy just got owned by the Death Cr'
	DB	'ate!', 00H					; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BM@HFFMNHJD@Beacon_Ion_Cannon_Anim_Post?$AA@
CONST	SEGMENT
??_C@_0BM@HFFMNHJD@Beacon_Ion_Cannon_Anim_Post?$AA@ DB 'Beacon_Ion_Cannon'
	DB	'_Anim_Post', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0DJ@JCIILKJJ@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@
CONST	SEGMENT
??_C@_0DJ@JCIILKJJ@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@ DB 'MESSA'
	DB	'GE [Crate] Hope you dont miss those 1000 points, %s', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DI@GIMPBKE@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@
CONST	SEGMENT
??_C@_0DI@GIMPBKE@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@ DB 'MESSAG'
	DB	'E [Crate] Hope you dont miss those 500 points, %s', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DI@IMPAJEMH@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@
CONST	SEGMENT
??_C@_0DI@IMPAJEMH@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@ DB 'MESSA'
	DB	'GE [Crate] Hope you dont miss those 100 points, %s', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CM@FMOHGIO@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?51000@
CONST	SEGMENT
??_C@_0CM@FMOHGIO@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?51000@ DB 'MESSAGE'
	DB	' [Crate] Enjoy those 1000 points, %s', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0CL@JCJJGOKP@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5500?5@
CONST	SEGMENT
??_C@_0CL@JCJJGOKP@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5500?5@ DB 'MESSA'
	DB	'GE [Crate] Enjoy those 500 points, %s', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0CL@JOHJIEBL@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5100?5@
CONST	SEGMENT
??_C@_0CL@JOHJIEBL@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5100?5@ DB 'MESSA'
	DB	'GE [Crate] Enjoy those 100 Points, %s', 00H	; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DE@DFGNMDND@?$FLCrate?5Script?$FN?5Error?3?5Non?9Exista@
CONST	SEGMENT
??_C@_0DE@DFGNMDND@?$FLCrate?5Script?$FN?5Error?3?5Non?9Exista@ DB '[Crat'
	DB	'e Script] Error: Non-Existant Function called!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_05IDJBDIO@Theif?$AA@
CONST	SEGMENT
??_C@_05IDJBDIO@Theif?$AA@ DB 'Theif', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@NCDPHFJO@Random_Weapon?$AA@
CONST	SEGMENT
??_C@_0O@NCDPHFJO@Random_Weapon?$AA@ DB 'Random_Weapon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_09BKEBHOJH@Spy_Crate?$AA@
CONST	SEGMENT
??_C@_09BKEBHOJH@Spy_Crate?$AA@ DB 'Spy_Crate', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_05INIBOMDG@Money?$AA@
CONST	SEGMENT
??_C@_05INIBOMDG@Money?$AA@ DB 'Money', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@CNCIDAIH@Full_Health?$AA@
CONST	SEGMENT
??_C@_0M@CNCIDAIH@Full_Health?$AA@ DB 'Full_Health', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_08OLMBCAOE@DeArmour?$AA@
CONST	SEGMENT
??_C@_08OLMBCAOE@DeArmour?$AA@ DB 'DeArmour', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_08GCAIFBH@DeHealth?$AA@
CONST	SEGMENT
??_C@_08GCAIFBH@DeHealth?$AA@ DB 'DeHealth', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@IEOKPBOP@Stealth_Suit?$AA@
CONST	SEGMENT
??_C@_0N@IEOKPBOP@Stealth_Suit?$AA@ DB 'Stealth_Suit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@BBADFEMH@Death_Crate?$AA@
CONST	SEGMENT
??_C@_0M@BBADFEMH@Death_Crate?$AA@ DB 'Death_Crate', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_06KANFALAM@Points?$AA@
CONST	SEGMENT
??_C@_06KANFALAM@Points?$AA@ DB 'Points', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@OPFMGFNB@Vehicle_Blocker?$AA@
CONST	SEGMENT
??_C@_0BA@OPFMGFNB@Vehicle_Blocker?$AA@ DB 'Vehicle_Blocker', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_08KJFDAMJE@vehcol2m?$AA@
CONST	SEGMENT
??_C@_08KJFDAMJE@vehcol2m?$AA@ DB 'vehcol2m', 00H	; `string'
CONST	ENDS
;	COMDAT ??_7DAN_Wreckage_Rebuildable@@6B@
CONST	SEGMENT
??_7DAN_Wreckage_Rebuildable@@6B@ DD FLAT:??_R4DAN_Wreckage_Rebuildable@@6B@ ; DAN_Wreckage_Rebuildable::`vftable'
	DD	FLAT:??_EDAN_Wreckage_Rebuildable@@UAEPAXI@Z
	...
	DD	FLAT:?Created@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@0M@Z
...
CONST	ENDS
;	COMDAT ??_7DAN_Drop_Wreckage_On_Death@@6B@
CONST	SEGMENT
??_7DAN_Drop_Wreckage_On_Death@@6B@ DD FLAT:??_R4DAN_Drop_Wreckage_On_Death@@6B@ ; DAN_Drop_Wreckage_On_Death::`vftable'
	DD	FLAT:??_EDAN_Drop_Wreckage_On_Death@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@DAN_Drop_Wreckage_On_Death@@EAEXPAVScriptableGameObj@@0@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7DAN_CnC_Crate@@6B@
CONST	SEGMENT
??_7DAN_CnC_Crate@@6B@ DD FLAT:??_R4DAN_CnC_Crate@@6B@	; DAN_CnC_Crate::`vftable'
	DD	FLAT:??_EDAN_CnC_Crate@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@ScriptImpClass@@UAEXPAVScriptableGameObj@@H@Z
	...
	DD	FLAT:?Save_Data@ScriptImpClass@@UAEXAAVScriptSaver@@@Z
	DD	FLAT:?Load_Data@ScriptImpClass@@UAEXAAVScriptLoader@@@Z
	DD	FLAT:?Register_Auto_Save_Variables@DAN_CnC_Crate@@UAEXXZ
CONST	ENDS
...
CONST	ENDS
CRT$XCU	SEGMENT
_DAN_Drop_Wreckage_On_Death_Registrant$initializer$ DD FLAT:??__EDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_DAN_Wreckage_Rebuildable_Registrant$initializer$ DD FLAT:??__EDAN_Wreckage_Rebuildable_Registrant@@YAXXZ
CRT$XCU	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDAN_Wreckage_Rebuildable_Registrant@@YAXXZ
text$yd	SEGMENT
??__FDAN_Wreckage_Rebuildable_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'DAN_Wreckage_Rebuildable_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DAN_Wreckage_Rebuildable_Registrant@@3V?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@A ; DAN_Wreckage_Rebuildable_Registrant
	call	??1?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDAN_Wreckage_Rebuildable_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'DAN_Wreckage_Rebuildable_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ??__EDAN_Wreckage_Rebuildable_Registrant@@YAXXZ
text$yc	SEGMENT
??__EDAN_Wreckage_Rebuildable_Registrant@@YAXXZ PROC	; `dynamic initializer for 'DAN_Wreckage_Rebuildable_Registrant'', COMDAT

; 467  : ScriptRegistrant<DAN_Wreckage_Rebuildable> DAN_Wreckage_Rebuildable_Registrant("DAN_Wreckage_Rebuildable","Vehicle_Preset:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0BG@JJNJEEOF@Vehicle_Preset?3string?$AA@
	push	OFFSET ??_C@_0BJ@GBJDLGFE@DAN_Wreckage_Rebuildable?$AA@
	mov	ecx, OFFSET ?DAN_Wreckage_Rebuildable_Registrant@@3V?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@A ; DAN_Wreckage_Rebuildable_Registrant
	call	??0?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@QAE@PBD0@Z ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::ScriptRegistrant<DAN_Wreckage_Rebuildable>
	push	OFFSET ??__FDAN_Wreckage_Rebuildable_Registrant@@YAXXZ ; `dynamic atexit destructor for 'DAN_Wreckage_Rebuildable_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDAN_Wreckage_Rebuildable_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'DAN_Wreckage_Rebuildable_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAXI@Z PROC ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAE@XZ PROC ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::~ScriptRegistrant<DAN_Wreckage_Rebuildable>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAE@XZ ENDP ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::~ScriptRegistrant<DAN_Wreckage_Rebuildable>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DJ@CJNBOBLB@ScriptRegistrant?$DMclass?5DAN_Wreck@
	push	553					; 00000229H
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0DAN_Wreckage_Rebuildable@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::ScriptRegistrant<DAN_Wreckage_Rebuildable>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VDAN_Wreckage_Rebuildable@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<DAN_Wreckage_Rebuildable>::ScriptRegistrant<DAN_Wreckage_Rebuildable>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ
text$yd	SEGMENT
??__FDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'DAN_Drop_Wreckage_On_Death_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DAN_Drop_Wreckage_On_Death_Registrant@@3V?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@A ; DAN_Drop_Wreckage_On_Death_Registrant
	call	??1?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'DAN_Drop_Wreckage_On_Death_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ??__EDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ
text$yc	SEGMENT
??__EDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ PROC	; `dynamic initializer for 'DAN_Drop_Wreckage_On_Death_Registrant'', COMDAT

; 466  : ScriptRegistrant<DAN_Drop_Wreckage_On_Death> DAN_Drop_Wreckage_On_Death_Registrant("DAN_Drop_Wreckage_On_Death","Wreckage_Preset:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0BH@BDPHDFEA@Wreckage_Preset?3string?$AA@
	push	OFFSET ??_C@_0BL@CHLLAFDD@DAN_Drop_Wreckage_On_Death?$AA@
	mov	ecx, OFFSET ?DAN_Drop_Wreckage_On_Death_Registrant@@3V?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@A ; DAN_Drop_Wreckage_On_Death_Registrant
	call	??0?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@QAE@PBD0@Z ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::ScriptRegistrant<DAN_Drop_Wreckage_On_Death>
	push	OFFSET ??__FDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ ; `dynamic atexit destructor for 'DAN_Drop_Wreckage_On_Death_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDAN_Drop_Wreckage_On_Death_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'DAN_Drop_Wreckage_On_Death_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAXI@Z PROC ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAE@XZ PROC ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::~ScriptRegistrant<DAN_Drop_Wreckage_On_Death>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAE@XZ ENDP ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::~ScriptRegistrant<DAN_Drop_Wreckage_On_Death>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DL@MBHDMDNB@ScriptRegistrant?$DMclass?5DAN_Drop_@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0DAN_Drop_Wreckage_On_Death@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::ScriptRegistrant<DAN_Drop_Wreckage_On_Death>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VDAN_Drop_Wreckage_On_Death@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<DAN_Drop_Wreckage_On_Death>::ScriptRegistrant<DAN_Drop_Wreckage_On_Death>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FDAN_CnC_Crate_Registrant@@YAXXZ
text$yd	SEGMENT
??__FDAN_CnC_Crate_Registrant@@YAXXZ PROC		; `dynamic atexit destructor for 'DAN_CnC_Crate_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?DAN_CnC_Crate_Registrant@@3V?$ScriptRegistrant@VDAN_CnC_Crate@@@@A ; DAN_CnC_Crate_Registrant
	call	??1?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FDAN_CnC_Crate_Registrant@@YAXXZ ENDP		; `dynamic atexit destructor for 'DAN_CnC_Crate_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ??__EDAN_CnC_Crate_Registrant@@YAXXZ
text$yc	SEGMENT
??__EDAN_CnC_Crate_Registrant@@YAXXZ PROC		; `dynamic initializer for 'DAN_CnC_Crate_Registrant'', COMDAT

; 465  : ScriptRegistrant<DAN_CnC_Crate> DAN_CnC_Crate_Registrant("DAN_CnC_Crate","Death_Crate:int,Stealth_Suit:int,DeHealth:int,DeArmour:int,Full_Health:int,Money:int,Spy_Crate:int,Random_Weapon:int,Points:int,Theif:int");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0IK@JCFAOJPL@Death_Crate?3int?0Stealth_Suit?3int@
	push	OFFSET ??_C@_0O@HFMLEFFA@DAN_CnC_Crate?$AA@
	mov	ecx, OFFSET ?DAN_CnC_Crate_Registrant@@3V?$ScriptRegistrant@VDAN_CnC_Crate@@@@A ; DAN_CnC_Crate_Registrant
	call	??0?$ScriptRegistrant@VDAN_CnC_Crate@@@@QAE@PBD0@Z ; ScriptRegistrant<DAN_CnC_Crate>::ScriptRegistrant<DAN_CnC_Crate>
	push	OFFSET ??__FDAN_CnC_Crate_Registrant@@YAXXZ ; `dynamic atexit destructor for 'DAN_CnC_Crate_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__EDAN_CnC_Crate_Registrant@@YAXXZ ENDP		; `dynamic initializer for 'DAN_CnC_Crate_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAXI@Z PROC	; ScriptRegistrant<DAN_CnC_Crate>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAXI@Z ENDP	; ScriptRegistrant<DAN_CnC_Crate>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAE@XZ PROC	; ScriptRegistrant<DAN_CnC_Crate>::~ScriptRegistrant<DAN_CnC_Crate>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAE@XZ ENDP	; ScriptRegistrant<DAN_CnC_Crate>::~ScriptRegistrant<DAN_CnC_Crate>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<DAN_CnC_Crate>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0CO@NPBAPBE@ScriptRegistrant?$DMclass?5DAN_CnC_C@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VDAN_CnC_Crate@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<DAN_CnC_Crate>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VDAN_CnC_Crate@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VDAN_CnC_Crate@@@@QAE@PBD0@Z PROC	; ScriptRegistrant<DAN_CnC_Crate>::ScriptRegistrant<DAN_CnC_Crate>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VDAN_CnC_Crate@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VDAN_CnC_Crate@@@@QAE@PBD0@Z ENDP	; ScriptRegistrant<DAN_CnC_Crate>::ScriptRegistrant<DAN_CnC_Crate>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GDAN_Wreckage_Rebuildable@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDAN_Wreckage_Rebuildable@@UAEPAXI@Z PROC		; DAN_Wreckage_Rebuildable::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1DAN_Wreckage_Rebuildable@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GDAN_Wreckage_Rebuildable@@UAEPAXI@Z ENDP		; DAN_Wreckage_Rebuildable::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1DAN_Wreckage_Rebuildable@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DAN_Wreckage_Rebuildable@@UAE@XZ PROC		; DAN_Wreckage_Rebuildable::~DAN_Wreckage_Rebuildable, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1DAN_Wreckage_Rebuildable@@UAE@XZ ENDP		; DAN_Wreckage_Rebuildable::~DAN_Wreckage_Rebuildable
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0DAN_Wreckage_Rebuildable@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DAN_Wreckage_Rebuildable@@QAE@XZ PROC		; DAN_Wreckage_Rebuildable::DAN_Wreckage_Rebuildable, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DAN_Wreckage_Rebuildable@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0DAN_Wreckage_Rebuildable@@QAE@XZ ENDP		; DAN_Wreckage_Rebuildable::DAN_Wreckage_Rebuildable
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Damaged@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@0M@Z
_TEXT	SEGMENT
tv188 = -128						; size = 4
tv174 = -128						; size = 4
tv245 = -124						; size = 4
...
$T1 = -116						; size = 12
$T2 = -104						; size = 12
_CurTank$3 = -28					; size = 4
_CurPosition$4 = -24					; size = 12
_MaxHealth$5 = -12					; size = 4
_TotalHealth$6 = -8					; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_damager$ = 12						; size = 4
_amount$ = 16						; size = 4
?Damaged@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@0M@Z PROC ; DAN_Wreckage_Rebuildable::Damaged, COMDAT
; _this$ = ecx
...
; 447  : 	{
; 448  : 		float TotalHealth = Commands->Get_Health(obj) + Commands->Get_Shield_Strength(obj);
	...
	movss	DWORD PTR _TotalHealth$6[ebp], xmm0

; 449  : 		const float MaxHealth = Commands->Get_Max_Health(obj) + Commands->Get_Max_Shield_Strength(obj);
	...
	movss	DWORD PTR _MaxHealth$5[ebp], xmm0

; 450  : 		Vector3 CurPosition = Commands->Get_Position(obj);
	...
	add	esp, 8
	push	eax
	lea	ecx, DWORD PTR _CurPosition$4[ebp]
	call	??0Vector3@@QAE@ABV0@@Z			; Vector3::Vector3

; 451  : 		if (TotalHealth == MaxHealth)

	movss	xmm0, DWORD PTR _TotalHealth$6[ebp]
	ucomiss	xmm0, DWORD PTR _MaxHealth$5[ebp]
	lahf
	test	ah, 68					; 00000044H
	jp	$LN1@Damaged

; 452  : 		{
; 453  : 			GameObject *CurTank = Commands->Create_Object(Get_Parameter("Vehicle_Preset"),Commands->Get_Position(obj));
	...
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0P@LNANEEHL@Vehicle_Preset?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _CurTank$3[ebp], eax

; 454  : 			Commands->Set_Facing(CurTank,Commands->Get_Facing(obj));
	...
	call	edx
	fstp	DWORD PTR [esp]
	mov	eax, DWORD PTR _CurTank$3[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 455  : 			Commands->Set_Health(CurTank,5);
...
; 456  : 			Commands->Set_Shield_Strength(CurTank,0);
...
; 457  : 			Commands->Set_Player_Type(CurTank,Commands->Get_Player_Type(damager));
...
; 458  : 			CurPosition.Z += 1;
	...
	movss	xmm0, DWORD PTR _CurPosition$4[ebp+8]
	addss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR _CurPosition$4[ebp+8], xmm0

; 459  : 			Commands->Set_Position(CurTank,CurPosition);

	lea	eax, DWORD PTR _CurPosition$4[ebp]
	push	eax
	mov	ecx, DWORD PTR _CurTank$3[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 460  : 			Commands->Destroy_Object(obj); 
...
; 463  : }
	...
	pop	ebp
	ret	12					; 0000000cH
?Damaged@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@0M@Z ENDP ; DAN_Wreckage_Rebuildable::Damaged
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Created@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@@Z PROC ; DAN_Wreckage_Rebuildable::Created, COMDAT
; _this$ = ecx
...
; 439  : 	Commands->Set_Player_Type(obj,-2);
...
; 440  : 	Commands->Set_Health(obj,50);
...
; 441  : 	Commands->Set_Shield_Strength(obj,0);
...
; 442  : }
	...
	pop	ebp
	ret	4
?Created@DAN_Wreckage_Rebuildable@@EAEXPAVScriptableGameObj@@@Z ENDP ; DAN_Wreckage_Rebuildable::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GDAN_Drop_Wreckage_On_Death@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDAN_Drop_Wreckage_On_Death@@UAEPAXI@Z PROC		; DAN_Drop_Wreckage_On_Death::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1DAN_Drop_Wreckage_On_Death@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GDAN_Drop_Wreckage_On_Death@@UAEPAXI@Z ENDP		; DAN_Drop_Wreckage_On_Death::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1DAN_Drop_Wreckage_On_Death@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DAN_Drop_Wreckage_On_Death@@UAE@XZ PROC		; DAN_Drop_Wreckage_On_Death::~DAN_Drop_Wreckage_On_Death, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1DAN_Drop_Wreckage_On_Death@@UAE@XZ ENDP		; DAN_Drop_Wreckage_On_Death::~DAN_Drop_Wreckage_On_Death
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0DAN_Drop_Wreckage_On_Death@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DAN_Drop_Wreckage_On_Death@@QAE@XZ PROC		; DAN_Drop_Wreckage_On_Death::DAN_Drop_Wreckage_On_Death, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DAN_Drop_Wreckage_On_Death@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0DAN_Drop_Wreckage_On_Death@@QAE@XZ ENDP		; DAN_Drop_Wreckage_On_Death::DAN_Drop_Wreckage_On_Death
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Killed@DAN_Drop_Wreckage_On_Death@@EAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
$T1 = -84						; size = 12
_CurTank$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_killer$ = 12						; size = 4
?Killed@DAN_Drop_Wreckage_On_Death@@EAEXPAVScriptableGameObj@@0@Z PROC ; DAN_Drop_Wreckage_On_Death::Killed, COMDAT
; _this$ = ecx
...
; 431  : 	GameObject *CurTank;
; 432  : 	CurTank = Commands->Create_Object(Get_Parameter("Wreckage_Preset"),Commands->Get_Position(obj));
	...
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BA@BKACAECP@Wreckage_Preset?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _CurTank$[ebp], eax

; 433  : 	Commands->Set_Facing(CurTank,Commands->Get_Facing(obj));
	...
	call	edx
	fstp	DWORD PTR [esp]
	mov	eax, DWORD PTR _CurTank$[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+76]
	call	edx
...
; 434  : 	Commands->Attach_Script(CurTank,"DAN_Wreckage_Rebuildable",Commands->Get_Preset_Name(obj));
...
; 435  : }
	...
	pop	ebp
	ret	8
?Killed@DAN_Drop_Wreckage_On_Death@@EAEXPAVScriptableGameObj@@0@Z ENDP ; DAN_Drop_Wreckage_On_Death::Killed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GDAN_CnC_Crate@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GDAN_CnC_Crate@@UAEPAXI@Z PROC			; DAN_CnC_Crate::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GDAN_CnC_Crate@@UAEPAXI@Z ENDP			; DAN_CnC_Crate::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1DAN_CnC_Crate@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1DAN_CnC_Crate@@UAE@XZ PROC				; DAN_CnC_Crate::~DAN_CnC_Crate, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1DAN_CnC_Crate@@UAE@XZ ENDP				; DAN_CnC_Crate::~DAN_CnC_Crate
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0DAN_CnC_Crate@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0DAN_CnC_Crate@@QAE@XZ PROC				; DAN_CnC_Crate::DAN_CnC_Crate, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DAN_CnC_Crate@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0DAN_CnC_Crate@@QAE@XZ ENDP				; DAN_CnC_Crate::DAN_CnC_Crate
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Register_Auto_Save_Variables@DAN_CnC_Crate@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Register_Auto_Save_Variables@DAN_CnC_Crate@@UAEXXZ PROC ; DAN_CnC_Crate::Register_Auto_Save_Variables, COMDAT
; _this$ = ecx
...
; 426  : 	Auto_Save_Variable(&VehBlock,4,1);
...
; 427  : }
	...
	pop	ebp
	ret	0
?Register_Auto_Save_Variables@DAN_CnC_Crate@@UAEXXZ ENDP ; DAN_CnC_Crate::Register_Auto_Save_Variables
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Theif@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv131 = -588						; size = 4
_Text$ = -520						; size = 512
_Team$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Theif@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC	; DAN_CnC_Crate::Theif, COMDAT
; _this$ = ecx
...
; 410  : 	if (!Commands->Get_Player_Type(obj))
...
; 412  : 		Team = "Nod";
	...
	mov	DWORD PTR _Team$[ebp], OFFSET ??_C@_03OHGKCNFD@Nod?$AA@
	jmp	SHORT $LN1@Theif
$LN3@Theif:

; 413  : 	}
; 414  : 	else if (Commands->Get_Player_Type(obj) == 1)
...
; 416  : 		Team = "GDI";
	...
	mov	DWORD PTR _Team$[ebp], OFFSET ??_C@_03IOFAJBDH@GDI?$AA@
$LN1@Theif:

; 417  : 	}
; 418  : 	char Text[512];
; 419  : 	Commands->Give_Money(obj,(Commands->Get_Money(obj)*-1),false);
...
; 420  : 	sprintf(Text,"MESSAGE [Crate] Awwww, some poor %s guy lost all his money! Pwnt!",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0EC@JCFFNCHJ@MESSAGE?5?$FLCrate?$FN?5Awwww?0?5some?5poor@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 421  : 	Console_Input(Text);
...
; 422  : }
	...
	pop	ebp
	ret	4
?Theif@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP	; DAN_CnC_Crate::Theif
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?RandomWeapon@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv70 = -596						; size = 4
_Weapon$ = -528						; size = 4
_RandNum$ = -524					; size = 4
...
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?RandomWeapon@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::RandomWeapon, COMDAT
; _this$ = ecx
...
; 285  : 	int PlayerID;
; 286  : 	PlayerID = Get_Player_ID(obj);
...
; 287  : 	char Text[512];
; 288  : 	int RandNum = Commands->Get_Random_Int(1,19);
	...
	call	ecx
	add	esp, 8
	mov	DWORD PTR _RandNum$[ebp], eax

; 289  : 	char *Weapon;
; 290  : 	Weapon = "Random Weapon";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0O@KHEPPGKC@Random?5Weapon?$AA@

; 291  : 	switch (RandNum)

	mov	eax, DWORD PTR _RandNum$[ebp]
	mov	DWORD PTR tv70[ebp], eax
	mov	ecx, DWORD PTR tv70[ebp]
	sub	ecx, 1
	mov	DWORD PTR tv70[ebp], ecx
	cmp	DWORD PTR tv70[ebp], 17			; 00000011H
	ja	$LN19@RandomWeap
	mov	edx, DWORD PTR tv70[ebp]
	jmp	DWORD PTR $LN23@RandomWeap[edx*4]
$LN18@RandomWeap:

; 292  : 	{
; 293  : 		case 1:
; 294  : 			Grant_Powerup(obj,"CnC_POW_AutoRifle_Player_GDI");

	push	OFFSET ??_C@_0BN@LNEEPDJK@CnC_POW_AutoRifle_Player_GDI?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 295  : 			Weapon = "AutoRifle";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_09BALDGHFC@AutoRifle?$AA@
...
; 297  : 		case 2:
; 298  : 			Grant_Powerup(obj,"POW_Chaingun_Player");

	push	OFFSET ??_C@_0BE@MNHLMFIN@POW_Chaingun_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8
...
; 299  : 			Weapon = "ChainGun";
	...
	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_08HGFIDDGE@ChainGun?$AA@
...
; 301  : 		case 3:
; 302  : 			Grant_Powerup(obj,"POW_ChemSprayer_Player");
...
; 303  : 			Weapon = "Chem Sprayer";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0N@MJKCECGH@Chem?5Sprayer?$AA@
...
; 305  : 		case 4:
; 306  : 			Grant_Powerup(obj,"POW_Flamethrower_Player");

	push	OFFSET ??_C@_0BI@CPKKILGH@POW_Flamethrower_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 307  : 			Weapon = "FlameThrower";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0N@PCEMONCD@FlameThrower?$AA@
...
; 309  : 		case 5:
; 310  : 			Grant_Powerup(obj,"POW_GrenadeLauncher_Player");

	push	OFFSET ??_C@_0BL@PLIKDCOD@POW_GrenadeLauncher_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 311  : 			Weapon = "Grenade Launcher";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0BB@GIEOMMBO@Grenade?5Launcher?$AA@
...
; 313  : 		case 6:
; 314  : 			Grant_Powerup(obj,"POW_LaserChaingun_Player");

	push	OFFSET ??_C@_0BJ@DCEKIBO@POW_LaserChaingun_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 315  : 			Weapon = "Laser Chaingun";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0P@CHLANEGF@Laser?5Chaingun?$AA@
...
; 317  : 		case 7:
; 318  : 			Grant_Powerup(obj,"POW_LaserRifle_Player");

	push	OFFSET ??_C@_0BG@PDODNLCD@POW_LaserRifle_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 319  : 			Weapon = "Laser Rifle";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0M@JIDFGGKB@Laser?5Rifle?$AA@
...
; 321  : 		case 8:
; 322  : 			Grant_Powerup(obj,"POW_MineProximity_Player");

	push	OFFSET ??_C@_0BJ@NBMNFBAO@POW_MineProximity_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 323  : 			Weapon = "Proximity Mine";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0P@LDPJNFDM@Proximity?5Mine?$AA@
...
; 325  : 		case 9:
; 326  : 			Grant_Powerup(obj,"POW_MineRemote_Player");
...
; 327  : 			Weapon = "Remote Mine";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0M@JIJMKCGL@Remote?5Mine?$AA@
...
; 329  : 		case 10:
; 330  : 			Grant_Powerup(obj,"POW_MineTimed_Player");

	push	OFFSET ??_C@_0BF@NCBBDDDP@POW_MineTimed_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8
...
; 331  : 			Weapon = "Timed C4";
	...
	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_08EOMCENKK@Timed?5C4?$AA@
...
; 333  : 		case 11:
; 334  : 			Grant_Powerup(obj,"POW_PersonalIonCannon_Player");

	push	OFFSET ??_C@_0BN@JFMDLPCE@POW_PersonalIonCannon_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 335  : 			Weapon = "Personal Ion Cannon";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0BE@BNLHADBG@Personal?5Ion?5Cannon?$AA@
...
; 337  : 		case 12:
; 338  : 			Grant_Powerup(obj,"POW_Railgun_Player");

	push	OFFSET ??_C@_0BD@EEDBCDBM@POW_Railgun_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8
...
; 339  : 			Weapon = "RailGun";
	...
	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_07HMKBNLLE@RailGun?$AA@
...
; 341  : 		case 13:
; 342  : 			Grant_Powerup(obj,"POW_RamjetRifle_Player");

	push	OFFSET ??_C@_0BH@GEDCLKJB@POW_RamjetRifle_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 343  : 			Weapon = "Ramjet Rifle";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0N@BEBCIPAC@Ramjet?5Rifle?$AA@
...
; 345  : 		case 14:
; 346  : 			Grant_Powerup(obj,"POW_RocketLauncher_Player");

	push	OFFSET ??_C@_0BK@MPOBPNAD@POW_RocketLauncher_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 347  : 			Weapon = "RocketLauncher";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0P@DLPOPCDE@RocketLauncher?$AA@

; 348  : 			break;

	jmp	SHORT $LN19@RandomWeap
$LN4@RandomWeap:

; 349  : 		case 15:
; 350  : 			Grant_Powerup(obj,"POW_Shotgun_Player");

	push	OFFSET ??_C@_0BD@PJGNEDGL@POW_Shotgun_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8
...
; 351  : 			Weapon = "Shotgun";
	...
	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_07DGIAOJJ@Shotgun?$AA@
...
; 353  : 		case 16:
; 354  : 			Grant_Powerup(obj,"POW_SniperRifle_Player");

	push	OFFSET ??_C@_0BH@NMPBHGGK@POW_SniperRifle_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 355  : 			Weapon = "Sniper Rifle";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0N@PNCKKCNC@Sniper?5Rifle?$AA@
...
; 357  : 		case 17:
; 358  : 			Grant_Powerup(obj,"POW_TiberiumAutoRifle_Player");

	push	OFFSET ??_C@_0BN@DFPKBHOD@POW_TiberiumAutoRifle_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 359  : 			Weapon = "Tiberium AutoRifle";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0BD@HOPBGNJM@Tiberium?5AutoRifle?$AA@
...
; 361  : 		case 18:
; 362  : 			Grant_Powerup(obj,"POW_TiberiumFlechetteGun_Player");

	push	OFFSET ??_C@_0CA@LONNBBEG@POW_TiberiumFlechetteGun_Player?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Grant_Powerup@@YAXPAVScriptableGameObj@@PBD@Z ; Grant_Powerup
	add	esp, 8

; 363  : 			Weapon = "Tiberium Flechette Gun";

	mov	DWORD PTR _Weapon$[ebp], OFFSET ??_C@_0BH@FLHHBJAG@Tiberium?5Flechette?5Gun?$AA@
$LN19@RandomWeap:

; 364  : 			break;
; 365  : 	}
; 366  : 	sprintf(Text,"PPAGE %d [Crate] You have been given a %s from the Weapons Locker!",PlayerID,Weapon);

	mov	eax, DWORD PTR _Weapon$[ebp]
	push	eax
	mov	ecx, DWORD PTR _PlayerID$[ebp]
	push	ecx
	push	OFFSET ??_C@_0ED@FCCMOKPM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5been?5g@
	lea	edx, DWORD PTR _Text$[ebp]
	push	edx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H

; 367  : 	Console_Input(Text);
...
$LN23@RandomWeap:
	...
	DD	$LN2@RandomWeap
	DD	$LN1@RandomWeap
?RandomWeapon@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::RandomWeapon
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?SpyCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_Text$ = -524						; size = 512
_OtherTeam$ = -12					; size = 4
_Team$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?SpyCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::SpyCrate, COMDAT
; _this$ = ecx
...
; 373  : 	char *OtherTeam = 0;

	mov	DWORD PTR _OtherTeam$[ebp], 0

; 374  : 	if (!Commands->Get_Player_Type(obj))
...
; 377  : 		OtherTeam = "GDI";
	...
	mov	DWORD PTR _OtherTeam$[ebp], OFFSET ??_C@_03IOFAJBDH@GDI?$AA@
	jmp	SHORT $LN2@SpyCrate
$LN3@SpyCrate:

; 378  : 	}
; 379  : 	else if (Commands->Get_Player_Type(obj) == 1)
...
; 382  : 		OtherTeam = "Nod";
	...
	mov	DWORD PTR _OtherTeam$[ebp], OFFSET ??_C@_03OHGKCNFD@Nod?$AA@
$LN2@SpyCrate:

; 383  : 	}
; 384  : 	char Text[512];
; 385  : 	Commands->Set_Is_Visible(obj,false);
...
; 386  : 	sprintf(Text,"MESSAGE [Crate] Some %s guy got the Spy Crate! Better watch your base, %s",Team,OtherTeam);

	mov	eax, DWORD PTR _OtherTeam$[ebp]
	push	eax
	mov	ecx, DWORD PTR _Team$[ebp]
	push	ecx
	push	OFFSET ??_C@_0EK@IEJILPIP@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5got?5@
	lea	edx, DWORD PTR _Text$[ebp]
	push	edx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H

; 387  : 	Console_Input(Text);
...
; 388  : }
	...
	pop	ebp
	ret	4
?SpyCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::SpyCrate
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Money@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
tv70 = -592						; size = 4
_Num$ = -524						; size = 4
_Text$ = -520						; size = 512
...
_obj$ = 8						; size = 4
_RandNum$ = 12						; size = 4
?Money@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z PROC ; DAN_CnC_Crate::Money, COMDAT
; _this$ = ecx
...
; 234  : 	int PlayerID;
; 235  : 	PlayerID = Get_Player_ID(obj);
...
; 236  : 	char Text[512];
; 237  : 	const int Num = Commands->Get_Random_Int(1,7);
...
; 242  : 			{
; 243  : 				Commands->Give_Money(obj,100,false);
...
; 244  : 				sprintf(Text,"PPAGE %d [Crate] You have got 100 Credits from the MoneyCrate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DP@EKIBNOHC@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 245  : 				Console_Input(Text);
...
; 248  : 			{
; 249  : 				Commands->Give_Money(obj,500,false);
...
; 250  : 				sprintf(Text,"PPAGE %d [Crate] You have got 500 Credits from the MoneyCrate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DP@JBELJNLO@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?550@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 251  : 				Console_Input(Text);
...
; 254  : 			{
; 255  : 				Commands->Give_Money(obj,1000,false);
...
; 256  : 				sprintf(Text,"PPAGE %d [Crate] You have got 1000 Credits from the MoneyCrate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0EA@HPKJGBCK@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?510@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 257  : 				Console_Input(Text);
...
; 262  : 			{
; 263  : 				Commands->Give_Money(obj,-100,false);
...
; 264  : 				sprintf(Text,"PPAGE %d [Crate] You have lost 100 Credits from the MoneyCrate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0EA@MNKOGAFA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 265  : 				Console_Input(Text);
...
; 268  : 			{
; 269  : 				Commands->Give_Money(obj,-500,false);
...
; 270  : 				sprintf(Text,"PPAGE %d [Crate] You have lost 500 Credits from the MoneyCrate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0EA@BGGECDJM@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?55@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 271  : 				Console_Input(Text);
...
; 274  : 			{
; 275  : 				Commands->Give_Money(obj,-1000,false);
...
; 276  : 				sprintf(Text,"PPAGE %d [Crate] You have lost 1000 Credits from the MoneyCrate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0EB@KKEOAPHA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5lost?51@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 277  : 				Console_Input(Text);
...
; 281  : }
	...
	pop	ebp
	ret	8
?Money@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z ENDP ; DAN_CnC_Crate::Money
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?FullHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_PlayerID$ = -520					; size = 4
_Text$ = -516						; size = 512
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?FullHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::FullHealth, COMDAT
; _this$ = ecx
...
; 221  : 	char Text[512];
; 222  : 	int PlayerID;
; 223  : 	PlayerID = Get_Player_ID(obj);
...
; 224  : 	Commands->Set_Health(obj,Commands->Get_Max_Health(obj));
...
; 225  : 	Commands->Set_Shield_Strength(obj,Commands->Get_Max_Shield_Strength(obj));
...
; 226  : 	sprintf(Text,"PPAGE %d [Crate] You have got the Full Health Crate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DF@BLOGGKPG@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 227  : 	Console_Input(Text);
...
; 228  : 	sprintf(Text,"PPAGE %d [Crate] Your Health and Armour has been replenished!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DO@ILLJPHKI@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5and@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 229  : 	Console_Input(Text);
...
; 230  : }
	...
	pop	ebp
	ret	4
?FullHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::FullHealth
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?DeArmour@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv91 = -588						; size = 4
_PlayerID$ = -520					; size = 4
_Text$ = -516						; size = 512
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?DeArmour@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::DeArmour, COMDAT
; _this$ = ecx
...
; 192  : 	char Text[512];
; 193  : 	int PlayerID;
; 194  : 	PlayerID = Get_Player_ID(obj);
...
; 195  : 	if (Commands->Get_Shield_Strength(obj) > 1)
	...
	jbe	SHORT $LN2@DeArmour

; 196  : 	{
; 197  : 		Commands->Set_Shield_Strength(obj,1);
...
; 198  : 		sprintf(Text,"PPAGE %d [Crate] You have got the DeArmour Crate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DC@OEPLOBAA@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 199  : 		Console_Input(Text);
...
; 200  : 		sprintf(Text,"PPAGE %d [Crate] Your Armour has been set to 1!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DA@KOANLGJC@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Armour?5has@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 201  : 		Console_Input(Text);
...
; 204  : 		DeHealth(obj);
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?DeHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::DeHealth
$LN1@DeArmour:
...
; 205  : }
	...
	pop	ebp
	ret	4
?DeArmour@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::DeArmour
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?DeHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_PlayerID$ = -520					; size = 4
_Text$ = -516						; size = 512
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?DeHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::DeHealth, COMDAT
; _this$ = ecx
...
; 209  : 	char Text[512];
; 210  : 	int PlayerID;
; 211  : 	PlayerID = Get_Player_ID(obj);
...
; 213  : 	sprintf(Text,"PPAGE %d [Crate] You have got the DeHealth Crate!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DC@MJBNDGJD@PPAGE?5?$CFd?5?$FLCrate?$FN?5You?5have?5got?5th@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 214  : 	Console_Input(Text);
...
; 215  : 	sprintf(Text,"PPAGE %d [Crate] Your Health has been set to 1!",PlayerID);

	mov	eax, DWORD PTR _PlayerID$[ebp]
	push	eax
	push	OFFSET ??_C@_0DA@NKGKADIE@PPAGE?5?$CFd?5?$FLCrate?$FN?5Your?5Health?5has@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 216  : 	Console_Input(Text);
...
; 217  : }
	...
	pop	ebp
	ret	4
?DeHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::DeHealth
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?StealthSuit@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_Text$ = -520						; size = 512
_Team$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?StealthSuit@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::StealthSuit, COMDAT
; _this$ = ecx
...
; 393  : 	if (!Commands->Get_Player_Type(obj))
	...
	add	esp, 4
	test	eax, eax
	jne	SHORT $LN3@StealthSui

; 394  : 	{
; 395  : 		Team = "Nod";

	mov	DWORD PTR _Team$[ebp], OFFSET ??_C@_03OHGKCNFD@Nod?$AA@
	jmp	SHORT $LN2@StealthSui
$LN3@StealthSui:

; 396  : 	}
; 397  : 	else if (Commands->Get_Player_Type(obj) == 1)
...
; 400  : 	}
; 401  : 	char Text[512];
; 402  : 	Commands->Enable_Stealth(obj,true);
...
; 403  : 	sprintf(Text,"MESSAGE [Crate] Some %s guy found the Stealth Suit!",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0DE@GIGKJILE@MESSAGE?5?$FLCrate?$FN?5Some?5?$CFs?5guy?5foun@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 404  : 	Console_Input(Text);
...
; 405  : }
	...
	pop	ebp
	ret	4
?StealthSuit@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::StealthSuit
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?DeathCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -596						; size = 12
_Text$ = -520						; size = 512
_Team$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?DeathCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::DeathCrate, COMDAT
; _this$ = ecx
...
; 175  : 	if (!Commands->Get_Player_Type(obj))
	...
	add	esp, 4
	test	eax, eax
	jne	SHORT $LN3@DeathCrate

; 176  : 	{
; 177  : 		Team = "Nod";

	mov	DWORD PTR _Team$[ebp], OFFSET ??_C@_03OHGKCNFD@Nod?$AA@
	jmp	SHORT $LN1@DeathCrate
$LN3@DeathCrate:

; 178  : 	}
; 179  : 	else if (Commands->Get_Player_Type(obj) == 1)
...
; 182  : 	}
; 183  : 	char Text[512];
; 184  : 	Commands->Create_Object("Beacon_Ion_Cannon_Anim_Post",Commands->Get_Position(obj));
	...
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BM@HFFMNHJD@Beacon_Ion_Cannon_Anim_Post?$AA@
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+100]
	call	edx
	add	esp, 8

; 185  : 	Commands->Apply_Damage(obj,1000,"Death",0);
...
; 186  : 	sprintf(Text,"MESSAGE [Crate] Some poor %s guy just got owned by the Death Crate!",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0EE@FBMAKOGL@MESSAGE?5?$FLCrate?$FN?5Some?5poor?5?$CFs?5guy@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 187  : 	Console_Input(Text);
...
; 188  : }
	...
	pop	ebp
	ret	4
?DeathCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::DeathCrate
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Points@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
tv76 = -592						; size = 4
_Num$ = -524						; size = 4
_Text$ = -520						; size = 512
...
_obj$ = 8						; size = 4
_RandNum$ = 12						; size = 4
?Points@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z PROC ; DAN_CnC_Crate::Points, COMDAT
; _this$ = ecx
...
; 116  : 	if (!Commands->Get_Player_Type(obj))
	...
	add	esp, 4
	test	eax, eax
	jne	SHORT $LN13@Points

; 117  : 	{
; 118  : 		Team = "Nod";

	mov	DWORD PTR _Team$[ebp], OFFSET ??_C@_03OHGKCNFD@Nod?$AA@
	jmp	SHORT $LN11@Points
$LN13@Points:

; 119  : 	}
; 120  : 	else if (Commands->Get_Player_Type(obj) == 1)
...
; 123  : 	}
; 124  : 	char Text[512];
; 125  : 	int Num = Commands->Get_Random_Int(1,7);
...
; 127  : 	{
; 128  : 		case 1:// Give points
; 129  : 			if ((1 <= Num) && (Num < 4))

	cmp	DWORD PTR _Num$[ebp], 1
	jl	SHORT $LN7@Points
	cmp	DWORD PTR _Num$[ebp], 4
	jge	SHORT $LN7@Points

; 130  : 			{
; 131  : 				Commands->Give_Points(obj,100,true);
...
; 132  : 				sprintf(Text,"MESSAGE [Crate] Enjoy those 100 Points, %s",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0CL@JOHJIEBL@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5100?5@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 133  : 				Console_Input(Text);
...
; 135  : 			if ((4 <= Num) && (Num < 6))
	...
	jl	SHORT $LN6@Points
	cmp	DWORD PTR _Num$[ebp], 6
	jge	SHORT $LN6@Points

; 136  : 			{
; 137  : 				Commands->Give_Points(obj,500,true);
...
; 138  : 				sprintf(Text,"MESSAGE [Crate] Enjoy those 500 points, %s",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0CL@JCJJGOKP@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?5500?5@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 139  : 				Console_Input(Text);
...
; 141  : 			if (Num == 6)
	...
	cmp	DWORD PTR _Num$[ebp], 6
	jne	SHORT $LN5@Points

; 142  : 			{
; 143  : 				Commands->Give_Points(obj,1000,true);
...
; 144  : 				sprintf(Text,"MESSAGE [Crate] Enjoy those 1000 points, %s",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0CM@FMOHGIO@MESSAGE?5?$FLCrate?$FN?5Enjoy?5those?51000@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 145  : 				Console_Input(Text);
...
; 148  : 		case 2:// Take Points
; 149  : 			if ((1 <= Num) && (Num < 4))

	cmp	DWORD PTR _Num$[ebp], 1
	jl	SHORT $LN3@Points
	cmp	DWORD PTR _Num$[ebp], 4
	jge	SHORT $LN3@Points

; 150  : 			{
; 151  : 				Commands->Give_Points(obj,-100,true);
...
; 152  : 				sprintf(Text,"MESSAGE [Crate] Hope you dont miss those 100 points, %s",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0DI@IMPAJEMH@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 153  : 				Console_Input(Text);
...
; 155  : 			if ((4 <= Num) && (Num < 6))
	...
	jl	SHORT $LN2@Points
	cmp	DWORD PTR _Num$[ebp], 6
	jge	SHORT $LN2@Points

; 156  : 			{
; 157  : 				Commands->Give_Points(obj,-500,true);
...
; 158  : 				sprintf(Text,"MESSAGE [Crate] Hope you dont miss those 500 points, %s",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0DI@GIMPBKE@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 159  : 				Console_Input(Text);
...
; 161  : 			if (Num == 6)
	...
	cmp	DWORD PTR _Num$[ebp], 6
	jne	SHORT $LN1@Points

; 162  : 			{
; 163  : 				Commands->Give_Points(obj,-1000,true);
...
; 164  : 				sprintf(Text,"MESSAGE [Crate] Hope you dont miss those 1000 points, %s",Team);

	mov	eax, DWORD PTR _Team$[ebp]
	push	eax
	push	OFFSET ??_C@_0DJ@JCIILKJJ@MESSAGE?5?$FLCrate?$FN?5Hope?5you?5dont?5mi@
	lea	ecx, DWORD PTR _Text$[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH

; 165  : 				Console_Input(Text);
...
; 169  : }
	...
	pop	ebp
	ret	8
?Points@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z ENDP ; DAN_CnC_Crate::Points
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Custom@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
tv232 = -372						; size = 4
_RandParam$1 = -304					; size = 4
_RandNum$2 = -300					; size = 4
_z$3 = -296						; size = 4
_x$4 = -292						; size = 4
_Number$5 = -288					; size = 196
_Total$6 = -92						; size = 4
_y$7 = -88						; size = 4
_Chance$8 = -84						; size = 40
_Params$9 = -44						; size = 40
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; DAN_CnC_Crate::Custom, COMDAT
; _this$ = ecx
...
; 28   : 	if (type == CUSTOM_EVENT_POWERUP_GRANTED)

	cmp	DWORD PTR _type$[ebp], 1000000025	; 3b9aca19H
	jne	$LN22@Custom

; 29   : 	{
; 30   : 		Commands->Destroy_Object(Commands->Find_Object(VehBlock));
...
; 31   : 		// Holds whether or not each powerup is enabled!
; 32   : 		const int Params[] = {Get_Int_Parameter("Points"),			// 0<- 'ID' of powerup

	push	OFFSET ??_C@_06KANFALAM@Points?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp], eax

; 33   : 								Get_Int_Parameter("Death_Crate"),	// 1

	push	OFFSET ??_C@_0M@BBADFEMH@Death_Crate?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+4], eax

; 34   : 								Get_Int_Parameter("Stealth_Suit"),	// 2

	push	OFFSET ??_C@_0N@IEOKPBOP@Stealth_Suit?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+8], eax

; 35   : 								Get_Int_Parameter("DeHealth"),		// 3

	push	OFFSET ??_C@_08GCAIFBH@DeHealth?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+12], eax

; 36   : 								Get_Int_Parameter("DeArmour"),		// 4

	push	OFFSET ??_C@_08OLMBCAOE@DeArmour?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+16], eax

; 37   : 								Get_Int_Parameter("Full_Health"),	// 5

	push	OFFSET ??_C@_0M@CNCIDAIH@Full_Health?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+20], eax

; 38   : 								Get_Int_Parameter("Money"),			// 6

	push	OFFSET ??_C@_05INIBOMDG@Money?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+24], eax

; 39   : 								Get_Int_Parameter("Spy_Crate"),		// 7

	push	OFFSET ??_C@_09BKEBHOJH@Spy_Crate?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+28], eax

; 40   : 								Get_Int_Parameter("Random_Weapon"),	// 8

	push	OFFSET ??_C@_0O@NCDPHFJO@Random_Weapon?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+32], eax

; 41   : 								Get_Int_Parameter("Theif")};		// 9

	push	OFFSET ??_C@_05IDJBDIO@Theif?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _Params$9[ebp+36], eax

; 42   : 		// The chance of each Powerup occuring. The higher,the more likely
; 43   : 		const int Chance[] = {4,			// 0

	mov	DWORD PTR _Chance$8[ebp], 4

; 44   : 							 4,				// 1

	mov	DWORD PTR _Chance$8[ebp+4], 4

; 45   : 							 2,				// 2

	mov	DWORD PTR _Chance$8[ebp+8], 2

; 46   : 							 5,				// 3

	mov	DWORD PTR _Chance$8[ebp+12], 5

; 47   : 							 5,				// 4

	mov	DWORD PTR _Chance$8[ebp+16], 5

; 48   : 							 4,				// 5

	mov	DWORD PTR _Chance$8[ebp+20], 4

; 49   : 							 4,				// 6

	mov	DWORD PTR _Chance$8[ebp+24], 4

; 50   : 							 1,				// 7

	mov	DWORD PTR _Chance$8[ebp+28], 1

; 51   : 							 5,				// 8

	mov	DWORD PTR _Chance$8[ebp+32], 5

; 52   : 							 4};			// 9

	mov	DWORD PTR _Chance$8[ebp+36], 4
...
; 54   : 		int Total = 0;
	...
	mov	DWORD PTR _Total$6[ebp], 0

; 55   : 		int Number[49]; // This number MUST be the sum of what Chance[] holds.
; 56   : 		// This loop cycles through Params[] and looks for enabled Powerups
; 57   : 		// It then puts the powerup 'ID' in Number as many times as the number in Chance[]
; 58   : 		memset(Number,0,sizeof(Number));

	push	196					; 000000c4H
	push	0
	lea	eax, DWORD PTR _Number$5[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
$LN20@Custom:
	cmp	DWORD PTR _x$4[ebp], 9
	jge	SHORT $LN18@Custom

; 60   : 		{
; 61   : 			if (Params[x] >= 1)

	mov	eax, DWORD PTR _x$4[ebp]
	cmp	DWORD PTR _Params$9[ebp+eax*4], 1
	jl	SHORT $LN17@Custom

; 62   : 			{
; 63   : 				for (int z = 0; z <= Chance[x]; z++)

	mov	DWORD PTR _z$3[ebp], 0
...
$LN16@Custom:
	...
	cmp	ecx, DWORD PTR _Chance$8[ebp+eax*4]
	jg	SHORT $LN17@Custom
...
; 65   : 					Number[y] = x;
	...
	mov	DWORD PTR _Number$5[ebp+eax*4], ecx
...
; 67   : 					Total++;
	...
	mov	eax, DWORD PTR _Total$6[ebp]
	add	eax, 1
	mov	DWORD PTR _Total$6[ebp], eax

; 68   : 				}

	jmp	SHORT $LN15@Custom
$LN17@Custom:
...
; 71   : 		int RandNum = Commands->Get_Random_Int(1,(Total + 1));
	...
	call	edx
	add	esp, 8
	mov	DWORD PTR _RandNum$2[ebp], eax

; 72   : 		const int RandParam = Commands->Get_Random_Int(1,3);
	...
	call	ecx
	add	esp, 8
	mov	DWORD PTR _RandParam$1[ebp], eax

; 73   : 		// Just add the function on the end when you want to add a new powerup!
; 74   : 		switch (Number[RandNum])

	mov	eax, DWORD PTR _RandNum$2[ebp]
	mov	ecx, DWORD PTR _Number$5[ebp+eax*4]
	mov	DWORD PTR tv232[ebp], ecx
	cmp	DWORD PTR tv232[ebp], 9
	ja	$LN1@Custom
	mov	edx, DWORD PTR tv232[ebp]
	jmp	DWORD PTR $LN24@Custom[edx*4]
$LN11@Custom:

; 75   : 		{
; 76   : 			case 0:
; 77   : 				Points(sender,RandParam);

	mov	eax, DWORD PTR _RandParam$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _sender$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Points@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z ; DAN_CnC_Crate::Points
...
; 80   : 				DeathCrate(obj);
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?DeathCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::DeathCrate
...
; 82   : 			case 2:
; 83   : 				StealthSuit(sender);

	mov	eax, DWORD PTR _sender$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?StealthSuit@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::StealthSuit
...
; 89   : 				DeArmour(sender);
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?DeArmour@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::DeArmour
...
; 91   : 			case 5:
; 92   : 				FullHealth(sender);

	mov	eax, DWORD PTR _sender$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FullHealth@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::FullHealth
...
; 95   : 				Money(sender,RandParam);
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Money@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@H@Z ; DAN_CnC_Crate::Money
...
; 98   : 				SpyCrate(sender);
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SpyCrate@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::SpyCrate
...
; 100  : 			case 8:
; 101  : 				RandomWeapon(sender);

	mov	eax, DWORD PTR _sender$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?RandomWeapon@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::RandomWeapon
...
; 104  : 				Theif(sender);
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Theif@DAN_CnC_Crate@@AAEXPAVScriptableGameObj@@@Z ; DAN_CnC_Crate::Theif
...
; 106  : 			default:
; 107  : 				Console_Output("[Crate Script] Error: Non-Existant Function called!");

	push	OFFSET ??_C@_0DE@DFGNMDND@?$FLCrate?5Script?$FN?5Error?3?5Non?9Exista@
...
$LN24@Custom:
	...
	DD	$LN3@Custom
	DD	$LN2@Custom
?Custom@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; DAN_CnC_Crate::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\dan.cpp
;	COMDAT ?Created@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -80						; size = 12
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@@Z PROC ; DAN_CnC_Crate::Created, COMDAT
; _this$ = ecx
...
; 20   : 	// Create the vehicle blocker and save it as a GameObject Variable,so I can destroy 
; 21   : 	// it when the crate is picked up! 
; 22   : 	Commands->Set_Model(obj,"vehcol2m");

	push	OFFSET ??_C@_08KJFDAMJE@vehcol2m?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 23   : 	VehBlock = Commands->Get_ID(Commands->Create_Object("Vehicle_Blocker",Commands->Get_Position(obj)));
	...
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BA@OPFMGFNB@Vehicle_Blocker?$AA@
	mov	ecx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	edx, DWORD PTR [ecx+100]
	call	edx
	add	esp, 8
...
; 24   : }
	...
	pop	ebp
	ret	4
?Created@DAN_CnC_Crate@@EAEXPAVScriptableGameObj@@@Z ENDP ; DAN_CnC_Crate::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
