; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\nhp.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Enemy_Seen@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@0@Z ; NHP_Smart_Targetting::Enemy_Seen
PUBLIC	?Created@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@@Z ; NHP_Smart_Targetting::Created
PUBLIC	??0NHP_Smart_Targetting@@QAE@XZ			; NHP_Smart_Targetting::NHP_Smart_Targetting
PUBLIC	??1NHP_Smart_Targetting@@UAE@XZ			; NHP_Smart_Targetting::~NHP_Smart_Targetting
PUBLIC	??_GNHP_Smart_Targetting@@UAEPAXI@Z		; NHP_Smart_Targetting::`scalar deleting destructor'
PUBLIC	?Created@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@@Z ; NHP_Guard_Bot::Created
PUBLIC	?Damaged@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@0M@Z ; NHP_Guard_Bot::Damaged
PUBLIC	??0NHP_Guard_Bot@@QAE@XZ			; NHP_Guard_Bot::NHP_Guard_Bot
PUBLIC	??1NHP_Guard_Bot@@UAE@XZ			; NHP_Guard_Bot::~NHP_Guard_Bot
PUBLIC	??_GNHP_Guard_Bot@@UAEPAXI@Z			; NHP_Guard_Bot::`scalar deleting destructor'
PUBLIC	?Created@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@@Z ; NHP_Construction_AI::Created
PUBLIC	?Timer_Expired@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@H@Z ; NHP_Construction_AI::Timer_Expired
PUBLIC	?Register_Auto_Save_Variables@NHP_Construction_AI@@UAEXXZ ; NHP_Construction_AI::Register_Auto_Save_Variables
PUBLIC	??0NHP_Construction_AI@@QAE@XZ			; NHP_Construction_AI::NHP_Construction_AI
PUBLIC	??1NHP_Construction_AI@@UAE@XZ			; NHP_Construction_AI::~NHP_Construction_AI
PUBLIC	??_GNHP_Construction_AI@@UAEPAXI@Z		; NHP_Construction_AI::`scalar deleting destructor'
PUBLIC	?Created@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@@Z ; NHP_Sensor_Array_Zone::Created
PUBLIC	?Custom@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@HH0@Z ; NHP_Sensor_Array_Zone::Custom
PUBLIC	?Entered@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z ; NHP_Sensor_Array_Zone::Entered
PUBLIC	?Exited@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z ; NHP_Sensor_Array_Zone::Exited
PUBLIC	?Register_Auto_Save_Variables@NHP_Sensor_Array_Zone@@UAEXXZ ; NHP_Sensor_Array_Zone::Register_Auto_Save_Variables
PUBLIC	??0NHP_Sensor_Array_Zone@@QAE@XZ		; NHP_Sensor_Array_Zone::NHP_Sensor_Array_Zone
PUBLIC	??1NHP_Sensor_Array_Zone@@UAE@XZ		; NHP_Sensor_Array_Zone::~NHP_Sensor_Array_Zone
PUBLIC	??_GNHP_Sensor_Array_Zone@@UAEPAXI@Z		; NHP_Sensor_Array_Zone::`scalar deleting destructor'
PUBLIC	?Created@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@@Z ; NHP_Sensorable_Object::Created
PUBLIC	?Killed@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@0@Z ; NHP_Sensorable_Object::Killed
PUBLIC	?Custom@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@HH0@Z ; NHP_Sensorable_Object::Custom
PUBLIC	?Register_Auto_Save_Variables@NHP_Sensorable_Object@@UAEXXZ ; NHP_Sensorable_Object::Register_Auto_Save_Variables
PUBLIC	??0NHP_Sensorable_Object@@QAE@XZ		; NHP_Sensorable_Object::NHP_Sensorable_Object
PUBLIC	??1NHP_Sensorable_Object@@UAE@XZ		; NHP_Sensorable_Object::~NHP_Sensorable_Object
PUBLIC	??_GNHP_Sensorable_Object@@UAEPAXI@Z		; NHP_Sensorable_Object::`scalar deleting destructor'
...
PUBLIC	??0?$ScriptRegistrant@VNHP_Construction_AI@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Construction_AI>::ScriptRegistrant<NHP_Construction_AI>
PUBLIC	?Create@?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NHP_Construction_AI>::Create
PUBLIC	??1?$ScriptRegistrant@VNHP_Construction_AI@@@@UAE@XZ ; ScriptRegistrant<NHP_Construction_AI>::~ScriptRegistrant<NHP_Construction_AI>
PUBLIC	??_G?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAXI@Z ; ScriptRegistrant<NHP_Construction_AI>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNHP_Smart_Targetting@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Smart_Targetting>::ScriptRegistrant<NHP_Smart_Targetting>
PUBLIC	?Create@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NHP_Smart_Targetting>::Create
PUBLIC	??1?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAE@XZ ; ScriptRegistrant<NHP_Smart_Targetting>::~ScriptRegistrant<NHP_Smart_Targetting>
PUBLIC	??_G?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAXI@Z ; ScriptRegistrant<NHP_Smart_Targetting>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNHP_Guard_Bot@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Guard_Bot>::ScriptRegistrant<NHP_Guard_Bot>
PUBLIC	?Create@?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NHP_Guard_Bot>::Create
PUBLIC	??1?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAE@XZ	; ScriptRegistrant<NHP_Guard_Bot>::~ScriptRegistrant<NHP_Guard_Bot>
PUBLIC	??_G?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAXI@Z ; ScriptRegistrant<NHP_Guard_Bot>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Sensor_Array_Zone>::ScriptRegistrant<NHP_Sensor_Array_Zone>
PUBLIC	?Create@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NHP_Sensor_Array_Zone>::Create
PUBLIC	??1?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAE@XZ ; ScriptRegistrant<NHP_Sensor_Array_Zone>::~ScriptRegistrant<NHP_Sensor_Array_Zone>
PUBLIC	??_G?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAXI@Z ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNHP_Sensorable_Object@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Sensorable_Object>::ScriptRegistrant<NHP_Sensorable_Object>
PUBLIC	?Create@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NHP_Sensorable_Object>::Create
PUBLIC	??1?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAE@XZ ; ScriptRegistrant<NHP_Sensorable_Object>::~ScriptRegistrant<NHP_Sensorable_Object>
PUBLIC	??_G?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAXI@Z ; ScriptRegistrant<NHP_Sensorable_Object>::`scalar deleting destructor'
...
PUBLIC	??_7NHP_Smart_Targetting@@6B@			; NHP_Smart_Targetting::`vftable'
PUBLIC	??_7NHP_Guard_Bot@@6B@				; NHP_Guard_Bot::`vftable'
PUBLIC	??_7NHP_Construction_AI@@6B@			; NHP_Construction_AI::`vftable'
PUBLIC	??_7NHP_Sensor_Array_Zone@@6B@			; NHP_Sensor_Array_Zone::`vftable'
PUBLIC	??_7NHP_Sensorable_Object@@6B@			; NHP_Sensorable_Object::`vftable'
...
PUBLIC	??_C@_0BD@GIAAKBJM@Presets_1?94_Weapon?$AA@	; `string'
PUBLIC	??_C@_0BD@PGCPPKJI@Presets_5?96_Weapon?$AA@	; `string'
PUBLIC	??_C@_0N@LGDIIJN@Other_Weapon?$AA@		; `string'
PUBLIC	??_C@_0L@EAJLNBCG@Preset_One?$AA@		; `string'
PUBLIC	??_C@_0L@COJLHBMN@Preset_Two?$AA@		; `string'
PUBLIC	??_C@_0N@EPADNPAK@Preset_Three?$AA@		; `string'
PUBLIC	??_C@_0M@GGMOKDDM@Preset_Four?$AA@		; `string'
PUBLIC	??_C@_0M@EEGAMGCP@Preset_Five?$AA@		; `string'
PUBLIC	??_C@_0L@KAHHEDJI@Preset_Six?$AA@		; `string'
PUBLIC	??_C@_0N@MGAAGFJP@Preset_Seven?$AA@		; `string'
PUBLIC	??_C@_0N@IGCPDAGK@Preset_Eight?$AA@		; `string'
PUBLIC	??_C@_08DFKPLDPN@Distance?$AA@			; `string'
PUBLIC	??_C@_05HOIAGEJD@Speed?$AA@			; `string'
PUBLIC	??_C@_0L@JCFEAFCJ@Time_Delay?$AA@		; `string'
PUBLIC	??_C@_0M@HPDDLCBF@Money_Limit?$AA@		; `string'
PUBLIC	??_C@_09MNMLKPFC@Money_Gen?$AA@			; `string'
PUBLIC	??_C@_0O@GMEIBLGN@Money_Waypath?$AA@		; `string'
PUBLIC	??_C@_0M@HEJJGPE@Guard_Limit?$AA@		; `string'
PUBLIC	??_C@_09DEFEEAH@Guard_Inf?$AA@			; `string'
PUBLIC	??_C@_0O@BHCOEFGL@Guard_Waypath?$AA@		; `string'
PUBLIC	??_C@_0N@NDFBCBJN@Attack_Limit?$AA@		; `string'
PUBLIC	??_C@_0M@NIPPNKMI@Attack_Unit?$AA@		; `string'
PUBLIC	??_C@_0P@PGBEGHLC@Attack_Waypath?$AA@		; `string'
PUBLIC	??_C@_0P@NIEAFCIF@Sound_Position?$AA@		; `string'
PUBLIC	??_C@_0N@JLPHONAA@Sound_Preset?$AA@		; `string'
PUBLIC	??_C@_0L@HNDGGODA@Check_Team?$AA@		; `string'
PUBLIC	??_C@_01KDCPPGHE@r?$AA@				; `string'
PUBLIC	??_C@_0BB@CEMOLLEK@Sensor_List_File?$AA@	; `string'
PUBLIC	??_C@_0DA@PBCPBJNG@ERROR?$CB?5Sensor?5can?5not?5find?5file?5@ ; `string'
PUBLIC	??_C@_02DPKJAMEF@?$CFd?$AA@			; `string'
PUBLIC	??_C@_07FDFGNKME@?$CF99?$FL?$FO?6?$FN?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@ ; ScriptRegistrant<NHP_Construction_AI>::`vftable'
PUBLIC	?NHP_Construction_AI_Registrant@@3V?$ScriptRegistrant@VNHP_Construction_AI@@@@A ; NHP_Construction_AI_Registrant
PUBLIC	??_C@_0KO@JACCPGEM@Money_Gen?3string?0Guard_Inf?3strin@ ; `string'
PUBLIC	??_C@_0BE@PNFNPKL@NHP_Construction_AI?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@ ; ScriptRegistrant<NHP_Smart_Targetting>::`vftable'
PUBLIC	?NHP_Smart_Targetting_Registrant@@3V?$ScriptRegistrant@VNHP_Smart_Targetting@@@@A ; NHP_Smart_Targetting_Registrant
PUBLIC	??_C@_0OA@JEOKLGIA@Presets_1?94_Weapon?3string?0Preset@ ; `string'
PUBLIC	??_C@_0BF@HJIAEKLM@NHP_Smart_Targetting?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@	; ScriptRegistrant<NHP_Guard_Bot>::`vftable'
PUBLIC	?NHP_Guard_Bot_Registrant@@3V?$ScriptRegistrant@VNHP_Guard_Bot@@@@A ; NHP_Guard_Bot_Registrant
PUBLIC	??_C@_0BL@IAJHMGBA@Distance?3float?0Speed?3float?$AA@ ; `string'
PUBLIC	??_C@_0O@CFNCFLAK@NHP_Guard_Bot?$AA@		; `string'
PUBLIC	??_7?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@ ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`vftable'
PUBLIC	?NHP_Sensor_Array_Zone_Registrant@@3V?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@A ; NHP_Sensor_Array_Zone_Registrant
PUBLIC	??_C@_0FC@FILLCJII@Sensor_List_File?3string?0Sound_Pr@ ; `string'
PUBLIC	??_C@_0BG@BOLOBHNN@NHP_Sensor_Array_Zone?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@ ; ScriptRegistrant<NHP_Sensorable_Object>::`vftable'
PUBLIC	?NHP_Sensorable_Object_Registrant@@3V?$ScriptRegistrant@VNHP_Sensorable_Object@@@@A ; NHP_Sensorable_Object_Registrant
PUBLIC	??_C@_00CNPNBAHC@?$AA@				; `string'
PUBLIC	??_C@_0BG@HLJDKIAH@NHP_Sensorable_Object?$AA@	; `string'
...
PUBLIC	??_C@_0DE@CCMGKNL@ScriptRegistrant?$DMclass?5NHP_Const@ ; `string'
...
PUBLIC	??_C@_0DF@MGIAIKOI@ScriptRegistrant?$DMclass?5NHP_Smart@ ; `string'
PUBLIC	??_C@_0CO@HNHEDGAP@ScriptRegistrant?$DMclass?5NHP_Guard@ ; `string'
PUBLIC	??_C@_0DG@MGAMFAFA@ScriptRegistrant?$DMclass?5NHP_Senso@ ; `string'
PUBLIC	??_C@_0DG@LOKAJJEJ@ScriptRegistrant?$DMclass?5NHP_Senso@ ; `string'
...
PUBLIC	??_R4NHP_Smart_Targetting@@6B@			; NHP_Smart_Targetting::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNHP_Smart_Targetting@@@8		; NHP_Smart_Targetting `RTTI Type Descriptor'
PUBLIC	??_R3NHP_Smart_Targetting@@8			; NHP_Smart_Targetting::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NHP_Smart_Targetting@@8			; NHP_Smart_Targetting::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NHP_Smart_Targetting@@8		; NHP_Smart_Targetting::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NHP_Guard_Bot@@6B@				; NHP_Guard_Bot::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNHP_Guard_Bot@@@8			; NHP_Guard_Bot `RTTI Type Descriptor'
PUBLIC	??_R3NHP_Guard_Bot@@8				; NHP_Guard_Bot::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NHP_Guard_Bot@@8				; NHP_Guard_Bot::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NHP_Guard_Bot@@8			; NHP_Guard_Bot::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NHP_Construction_AI@@6B@			; NHP_Construction_AI::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNHP_Construction_AI@@@8			; NHP_Construction_AI `RTTI Type Descriptor'
PUBLIC	??_R3NHP_Construction_AI@@8			; NHP_Construction_AI::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NHP_Construction_AI@@8			; NHP_Construction_AI::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NHP_Construction_AI@@8		; NHP_Construction_AI::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NHP_Sensor_Array_Zone@@6B@			; NHP_Sensor_Array_Zone::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNHP_Sensor_Array_Zone@@@8		; NHP_Sensor_Array_Zone `RTTI Type Descriptor'
PUBLIC	??_R3NHP_Sensor_Array_Zone@@8			; NHP_Sensor_Array_Zone::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NHP_Sensor_Array_Zone@@8			; NHP_Sensor_Array_Zone::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NHP_Sensor_Array_Zone@@8		; NHP_Sensor_Array_Zone::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NHP_Sensorable_Object@@6B@			; NHP_Sensorable_Object::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNHP_Sensorable_Object@@@8		; NHP_Sensorable_Object `RTTI Type Descriptor'
PUBLIC	??_R3NHP_Sensorable_Object@@8			; NHP_Sensorable_Object::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NHP_Sensorable_Object@@8			; NHP_Sensorable_Object::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NHP_Sensorable_Object@@8		; NHP_Sensorable_Object::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
PUBLIC	??_R4?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@ ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNHP_Construction_AI@@@@@8 ; ScriptRegistrant<NHP_Construction_AI> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNHP_Construction_AI@@@@8 ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNHP_Construction_AI@@@@8 ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Construction_AI@@@@8 ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@ ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNHP_Smart_Targetting@@@@@8 ; ScriptRegistrant<NHP_Smart_Targetting> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@	; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNHP_Guard_Bot@@@@@8	; ScriptRegistrant<NHP_Guard_Bot> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNHP_Guard_Bot@@@@8	; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNHP_Guard_Bot@@@@8	; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Guard_Bot@@@@8 ; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@ ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@@8 ; ScriptRegistrant<NHP_Sensor_Array_Zone> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@ ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNHP_Sensorable_Object@@@@@8 ; ScriptRegistrant<NHP_Sensorable_Object> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	??_ENHP_Smart_Targetting@@UAEPAXI@Z:PROC	; NHP_Smart_Targetting::`vector deleting destructor'
EXTRN	??_ENHP_Guard_Bot@@UAEPAXI@Z:PROC		; NHP_Guard_Bot::`vector deleting destructor'
EXTRN	??_ENHP_Construction_AI@@UAEPAXI@Z:PROC		; NHP_Construction_AI::`vector deleting destructor'
EXTRN	??_ENHP_Sensor_Array_Zone@@UAEPAXI@Z:PROC	; NHP_Sensor_Array_Zone::`vector deleting destructor'
EXTRN	??_ENHP_Sensorable_Object@@UAEPAXI@Z:PROC	; NHP_Sensorable_Object::`vector deleting destructor'
...
EXTRN	??_E?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NHP_Construction_AI>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NHP_Smart_Targetting>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NHP_Guard_Bot>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NHP_Sensorable_Object>::`vector deleting destructor'
...
_BSS	SEGMENT
?NHP_Construction_AI_Registrant@@3V?$ScriptRegistrant@VNHP_Construction_AI@@@@A DB 010H DUP (?) ; NHP_Construction_AI_Registrant
?NHP_Smart_Targetting_Registrant@@3V?$ScriptRegistrant@VNHP_Smart_Targetting@@@@A DB 010H DUP (?) ; NHP_Smart_Targetting_Registrant
?NHP_Guard_Bot_Registrant@@3V?$ScriptRegistrant@VNHP_Guard_Bot@@@@A DB 010H DUP (?) ; NHP_Guard_Bot_Registrant
?NHP_Sensor_Array_Zone_Registrant@@3V?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@A DB 010H DUP (?) ; NHP_Sensor_Array_Zone_Registrant
?NHP_Sensorable_Object_Registrant@@3V?$ScriptRegistrant@VNHP_Sensorable_Object@@@@A DB 010H DUP (?) ; NHP_Sensorable_Object_Registrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_NHP_Construction_AI_Registrant$initializer$ DD FLAT:??__ENHP_Construction_AI_Registrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Sensorable_Object@@@@@8 ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8 DD 00H ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNHP_Sensorable_Object@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNHP_Sensorable_Object@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NHP_Sensorable_Object> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNHP_Sensorable_Object@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@ DD 00H ; ScriptRegistrant<NHP_Sensorable_Object>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Sensorable_Object@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Sensorable_Object@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@@8 ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8 DD 00H ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NHP_Sensor_Array_Zone> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@ DD 00H ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Guard_Bot@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Guard_Bot@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Guard_Bot@@@@@8 ; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Guard_Bot@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNHP_Guard_Bot@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNHP_Guard_Bot@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Guard_Bot@@@@8 ; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNHP_Guard_Bot@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNHP_Guard_Bot@@@@8 DD 00H	; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNHP_Guard_Bot@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNHP_Guard_Bot@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNHP_Guard_Bot@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NHP_Guard_Bot> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNHP_Guard_Bot@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@ DD 00H	; ScriptRegistrant<NHP_Guard_Bot>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Guard_Bot@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Guard_Bot@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Smart_Targetting@@@@@8 ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8 DD 00H ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNHP_Smart_Targetting@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNHP_Smart_Targetting@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NHP_Smart_Targetting> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNHP_Smart_Targetting@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@ DD 00H ; ScriptRegistrant<NHP_Smart_Targetting>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Smart_Targetting@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Smart_Targetting@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Construction_AI@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Construction_AI@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Construction_AI@@@@@8 ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Construction_AI@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNHP_Construction_AI@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNHP_Construction_AI@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNHP_Construction_AI@@@@8 ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNHP_Construction_AI@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNHP_Construction_AI@@@@8 DD 00H ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNHP_Construction_AI@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNHP_Construction_AI@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNHP_Construction_AI@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NHP_Construction_AI> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNHP_Construction_AI@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@ DD 00H ; ScriptRegistrant<NHP_Construction_AI>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNHP_Construction_AI@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNHP_Construction_AI@@@@8
rdata$r	ENDS
...
??_R4ThreadClass@@6B@ DD 00H				; ThreadClass::`RTTI Complete Object Locator'
	...
	DD	FLAT:??_R3ThreadClass@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NHP_Sensorable_Object@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NHP_Sensorable_Object@@8 DD FLAT:??_R0?AVNHP_Sensorable_Object@@@8 ; NHP_Sensorable_Object::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NHP_Sensorable_Object@@8
rdata$r	ENDS
;	COMDAT ??_R2NHP_Sensorable_Object@@8
rdata$r	SEGMENT
??_R2NHP_Sensorable_Object@@8 DD FLAT:??_R1A@?0A@EA@NHP_Sensorable_Object@@8 ; NHP_Sensorable_Object::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NHP_Sensorable_Object@@8
rdata$r	SEGMENT
??_R3NHP_Sensorable_Object@@8 DD 00H			; NHP_Sensorable_Object::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NHP_Sensorable_Object@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNHP_Sensorable_Object@@@8
_DATA	SEGMENT
??_R0?AVNHP_Sensorable_Object@@@8 DD FLAT:??_7type_info@@6B@ ; NHP_Sensorable_Object `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNHP_Sensorable_Object@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NHP_Sensorable_Object@@6B@
rdata$r	SEGMENT
??_R4NHP_Sensorable_Object@@6B@ DD 00H			; NHP_Sensorable_Object::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNHP_Sensorable_Object@@@8
	DD	FLAT:??_R3NHP_Sensorable_Object@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NHP_Sensor_Array_Zone@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NHP_Sensor_Array_Zone@@8 DD FLAT:??_R0?AVNHP_Sensor_Array_Zone@@@8 ; NHP_Sensor_Array_Zone::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NHP_Sensor_Array_Zone@@8
rdata$r	ENDS
;	COMDAT ??_R2NHP_Sensor_Array_Zone@@8
rdata$r	SEGMENT
??_R2NHP_Sensor_Array_Zone@@8 DD FLAT:??_R1A@?0A@EA@NHP_Sensor_Array_Zone@@8 ; NHP_Sensor_Array_Zone::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NHP_Sensor_Array_Zone@@8
rdata$r	SEGMENT
??_R3NHP_Sensor_Array_Zone@@8 DD 00H			; NHP_Sensor_Array_Zone::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NHP_Sensor_Array_Zone@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNHP_Sensor_Array_Zone@@@8
_DATA	SEGMENT
??_R0?AVNHP_Sensor_Array_Zone@@@8 DD FLAT:??_7type_info@@6B@ ; NHP_Sensor_Array_Zone `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNHP_Sensor_Array_Zone@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NHP_Sensor_Array_Zone@@6B@
rdata$r	SEGMENT
??_R4NHP_Sensor_Array_Zone@@6B@ DD 00H			; NHP_Sensor_Array_Zone::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNHP_Sensor_Array_Zone@@@8
	DD	FLAT:??_R3NHP_Sensor_Array_Zone@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NHP_Construction_AI@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NHP_Construction_AI@@8 DD FLAT:??_R0?AVNHP_Construction_AI@@@8 ; NHP_Construction_AI::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NHP_Construction_AI@@8
rdata$r	ENDS
;	COMDAT ??_R2NHP_Construction_AI@@8
rdata$r	SEGMENT
??_R2NHP_Construction_AI@@8 DD FLAT:??_R1A@?0A@EA@NHP_Construction_AI@@8 ; NHP_Construction_AI::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NHP_Construction_AI@@8
rdata$r	SEGMENT
??_R3NHP_Construction_AI@@8 DD 00H			; NHP_Construction_AI::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NHP_Construction_AI@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNHP_Construction_AI@@@8
_DATA	SEGMENT
??_R0?AVNHP_Construction_AI@@@8 DD FLAT:??_7type_info@@6B@ ; NHP_Construction_AI `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNHP_Construction_AI@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NHP_Construction_AI@@6B@
rdata$r	SEGMENT
??_R4NHP_Construction_AI@@6B@ DD 00H			; NHP_Construction_AI::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNHP_Construction_AI@@@8
	DD	FLAT:??_R3NHP_Construction_AI@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NHP_Guard_Bot@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NHP_Guard_Bot@@8 DD FLAT:??_R0?AVNHP_Guard_Bot@@@8 ; NHP_Guard_Bot::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NHP_Guard_Bot@@8
rdata$r	ENDS
;	COMDAT ??_R2NHP_Guard_Bot@@8
rdata$r	SEGMENT
??_R2NHP_Guard_Bot@@8 DD FLAT:??_R1A@?0A@EA@NHP_Guard_Bot@@8 ; NHP_Guard_Bot::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NHP_Guard_Bot@@8
rdata$r	SEGMENT
??_R3NHP_Guard_Bot@@8 DD 00H				; NHP_Guard_Bot::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NHP_Guard_Bot@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNHP_Guard_Bot@@@8
_DATA	SEGMENT
??_R0?AVNHP_Guard_Bot@@@8 DD FLAT:??_7type_info@@6B@	; NHP_Guard_Bot `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNHP_Guard_Bot@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NHP_Guard_Bot@@6B@
rdata$r	SEGMENT
??_R4NHP_Guard_Bot@@6B@ DD 00H				; NHP_Guard_Bot::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNHP_Guard_Bot@@@8
	DD	FLAT:??_R3NHP_Guard_Bot@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NHP_Smart_Targetting@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NHP_Smart_Targetting@@8 DD FLAT:??_R0?AVNHP_Smart_Targetting@@@8 ; NHP_Smart_Targetting::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NHP_Smart_Targetting@@8
rdata$r	ENDS
;	COMDAT ??_R2NHP_Smart_Targetting@@8
rdata$r	SEGMENT
??_R2NHP_Smart_Targetting@@8 DD FLAT:??_R1A@?0A@EA@NHP_Smart_Targetting@@8 ; NHP_Smart_Targetting::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NHP_Smart_Targetting@@8
rdata$r	SEGMENT
??_R3NHP_Smart_Targetting@@8 DD 00H			; NHP_Smart_Targetting::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NHP_Smart_Targetting@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNHP_Smart_Targetting@@@8
_DATA	SEGMENT
??_R0?AVNHP_Smart_Targetting@@@8 DD FLAT:??_7type_info@@6B@ ; NHP_Smart_Targetting `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNHP_Smart_Targetting@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NHP_Smart_Targetting@@6B@
rdata$r	SEGMENT
??_R4NHP_Smart_Targetting@@6B@ DD 00H			; NHP_Smart_Targetting::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNHP_Smart_Targetting@@@8
	DD	FLAT:??_R3NHP_Smart_Targetting@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DG@LOKAJJEJ@ScriptRegistrant?$DMclass?5NHP_Senso@
CONST	SEGMENT
??_C@_0DG@LOKAJJEJ@ScriptRegistrant?$DMclass?5NHP_Senso@ DB 'ScriptRegist'
	DB	'rant<class NHP_Sensorable_Object>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DG@MGAMFAFA@ScriptRegistrant?$DMclass?5NHP_Senso@
CONST	SEGMENT
??_C@_0DG@MGAMFAFA@ScriptRegistrant?$DMclass?5NHP_Senso@ DB 'ScriptRegist'
	DB	'rant<class NHP_Sensor_Array_Zone>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CO@HNHEDGAP@ScriptRegistrant?$DMclass?5NHP_Guard@
CONST	SEGMENT
??_C@_0CO@HNHEDGAP@ScriptRegistrant?$DMclass?5NHP_Guard@ DB 'ScriptRegist'
	DB	'rant<class NHP_Guard_Bot>::Create', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0DF@MGIAIKOI@ScriptRegistrant?$DMclass?5NHP_Smart@
CONST	SEGMENT
??_C@_0DF@MGIAIKOI@ScriptRegistrant?$DMclass?5NHP_Smart@ DB 'ScriptRegist'
	DB	'rant<class NHP_Smart_Targetting>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DE@CCMGKNL@ScriptRegistrant?$DMclass?5NHP_Const@
CONST	SEGMENT
??_C@_0DE@CCMGKNL@ScriptRegistrant?$DMclass?5NHP_Const@ DB 'ScriptRegistr'
	DB	'ant<class NHP_Construction_AI>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BG@HLJDKIAH@NHP_Sensorable_Object?$AA@
CONST	SEGMENT
??_C@_0BG@HLJDKIAH@NHP_Sensorable_Object?$AA@ DB 'NHP_Sensorable_Object', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_00CNPNBAHC@?$AA@
CONST	SEGMENT
??_C@_00CNPNBAHC@?$AA@ DB 00H				; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@ ; ScriptRegistrant<NHP_Sensorable_Object>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BG@BOLOBHNN@NHP_Sensor_Array_Zone?$AA@
CONST	SEGMENT
??_C@_0BG@BOLOBHNN@NHP_Sensor_Array_Zone?$AA@ DB 'NHP_Sensor_Array_Zone', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0FC@FILLCJII@Sensor_List_File?3string?0Sound_Pr@
CONST	SEGMENT
??_C@_0FC@FILLCJII@Sensor_List_File?3string?0Sound_Pr@ DB 'Sensor_List_Fi'
	DB	'le:string,Sound_Preset:string,Sound_Position:vector3,Check_Te'
	DB	'am:int', 00H				; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@ ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0O@CFNCFLAK@NHP_Guard_Bot?$AA@
CONST	SEGMENT
??_C@_0O@CFNCFLAK@NHP_Guard_Bot?$AA@ DB 'NHP_Guard_Bot', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@IAJHMGBA@Distance?3float?0Speed?3float?$AA@
CONST	SEGMENT
??_C@_0BL@IAJHMGBA@Distance?3float?0Speed?3float?$AA@ DB 'Distance:float,'
	DB	'Speed:float', 00H				; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@ ; ScriptRegistrant<NHP_Guard_Bot>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BF@HJIAEKLM@NHP_Smart_Targetting?$AA@
CONST	SEGMENT
??_C@_0BF@HJIAEKLM@NHP_Smart_Targetting?$AA@ DB 'NHP_Smart_Targetting', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0OA@JEOKLGIA@Presets_1?94_Weapon?3string?0Preset@
CONST	SEGMENT
??_C@_0OA@JEOKLGIA@Presets_1?94_Weapon?3string?0Preset@ DB 'Presets_1-4_W'
	DB	'eapon:string,Presets_5-6_Weapon:string,Other_Weapon:string,Pr'
	DB	'eset_One:string,Preset_Two:string,Preset_Three:string,Preset_'
	DB	'Four:string,Preset_Five:string,Preset_Six:string,Preset_Seven'
	DB	':string,Preset_Eight:string', 00H		; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@ ; ScriptRegistrant<NHP_Smart_Targetting>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BE@PNFNPKL@NHP_Construction_AI?$AA@
CONST	SEGMENT
??_C@_0BE@PNFNPKL@NHP_Construction_AI?$AA@ DB 'NHP_Construction_AI', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0KO@JACCPGEM@Money_Gen?3string?0Guard_Inf?3strin@
CONST	SEGMENT
??_C@_0KO@JACCPGEM@Money_Gen?3string?0Guard_Inf?3strin@ DB 'Money_Gen:str'
	DB	'ing,Guard_Inf:string,Attack_Unit:string,Money_Limit:int,Guard'
	DB	'_Limit:int,Attack_Limit:int,Time_Delay:float,Money_Waypath:in'
	DB	't,Guard_Waypath:int,Attack_Waypath:int', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@ ; ScriptRegistrant<NHP_Construction_AI>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_07FDFGNKME@?$CF99?$FL?$FO?6?$FN?$AA@
CONST	SEGMENT
??_C@_07FDFGNKME@?$CF99?$FL?$FO?6?$FN?$AA@ DB '%99[^', 0aH, ']', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_02DPKJAMEF@?$CFd?$AA@
CONST	SEGMENT
??_C@_02DPKJAMEF@?$CFd?$AA@ DB '%d', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0DA@PBCPBJNG@ERROR?$CB?5Sensor?5can?5not?5find?5file?5@
CONST	SEGMENT
??_C@_0DA@PBCPBJNG@ERROR?$CB?5Sensor?5can?5not?5find?5file?5@ DB 'ERROR! '
	DB	'Sensor can not find file for sensor list', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@CEMOLLEK@Sensor_List_File?$AA@
CONST	SEGMENT
??_C@_0BB@CEMOLLEK@Sensor_List_File?$AA@ DB 'Sensor_List_File', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_01KDCPPGHE@r?$AA@
CONST	SEGMENT
??_C@_01KDCPPGHE@r?$AA@ DB 'r', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@HNDGGODA@Check_Team?$AA@
CONST	SEGMENT
??_C@_0L@HNDGGODA@Check_Team?$AA@ DB 'Check_Team', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@JLPHONAA@Sound_Preset?$AA@
CONST	SEGMENT
??_C@_0N@JLPHONAA@Sound_Preset?$AA@ DB 'Sound_Preset', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@NIEAFCIF@Sound_Position?$AA@
CONST	SEGMENT
??_C@_0P@NIEAFCIF@Sound_Position?$AA@ DB 'Sound_Position', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@PGBEGHLC@Attack_Waypath?$AA@
CONST	SEGMENT
??_C@_0P@PGBEGHLC@Attack_Waypath?$AA@ DB 'Attack_Waypath', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@NIPPNKMI@Attack_Unit?$AA@
CONST	SEGMENT
??_C@_0M@NIPPNKMI@Attack_Unit?$AA@ DB 'Attack_Unit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@NDFBCBJN@Attack_Limit?$AA@
CONST	SEGMENT
??_C@_0N@NDFBCBJN@Attack_Limit?$AA@ DB 'Attack_Limit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@BHCOEFGL@Guard_Waypath?$AA@
CONST	SEGMENT
??_C@_0O@BHCOEFGL@Guard_Waypath?$AA@ DB 'Guard_Waypath', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_09DEFEEAH@Guard_Inf?$AA@
CONST	SEGMENT
??_C@_09DEFEEAH@Guard_Inf?$AA@ DB 'Guard_Inf', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@HEJJGPE@Guard_Limit?$AA@
CONST	SEGMENT
??_C@_0M@HEJJGPE@Guard_Limit?$AA@ DB 'Guard_Limit', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@GMEIBLGN@Money_Waypath?$AA@
CONST	SEGMENT
??_C@_0O@GMEIBLGN@Money_Waypath?$AA@ DB 'Money_Waypath', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_09MNMLKPFC@Money_Gen?$AA@
CONST	SEGMENT
??_C@_09MNMLKPFC@Money_Gen?$AA@ DB 'Money_Gen', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@HPDDLCBF@Money_Limit?$AA@
CONST	SEGMENT
??_C@_0M@HPDDLCBF@Money_Limit?$AA@ DB 'Money_Limit', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_08DFKPLDPN@Distance?$AA@
CONST	SEGMENT
??_C@_08DFKPLDPN@Distance?$AA@ DB 'Distance', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@IGCPDAGK@Preset_Eight?$AA@
CONST	SEGMENT
??_C@_0N@IGCPDAGK@Preset_Eight?$AA@ DB 'Preset_Eight', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@MGAAGFJP@Preset_Seven?$AA@
CONST	SEGMENT
??_C@_0N@MGAAGFJP@Preset_Seven?$AA@ DB 'Preset_Seven', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@KAHHEDJI@Preset_Six?$AA@
CONST	SEGMENT
??_C@_0L@KAHHEDJI@Preset_Six?$AA@ DB 'Preset_Six', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@EEGAMGCP@Preset_Five?$AA@
CONST	SEGMENT
??_C@_0M@EEGAMGCP@Preset_Five?$AA@ DB 'Preset_Five', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@GGMOKDDM@Preset_Four?$AA@
CONST	SEGMENT
??_C@_0M@GGMOKDDM@Preset_Four?$AA@ DB 'Preset_Four', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@EPADNPAK@Preset_Three?$AA@
CONST	SEGMENT
??_C@_0N@EPADNPAK@Preset_Three?$AA@ DB 'Preset_Three', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@COJLHBMN@Preset_Two?$AA@
CONST	SEGMENT
??_C@_0L@COJLHBMN@Preset_Two?$AA@ DB 'Preset_Two', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@EAJLNBCG@Preset_One?$AA@
CONST	SEGMENT
??_C@_0L@EAJLNBCG@Preset_One?$AA@ DB 'Preset_One', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LGDIIJN@Other_Weapon?$AA@
CONST	SEGMENT
??_C@_0N@LGDIIJN@Other_Weapon?$AA@ DB 'Other_Weapon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@PGCPPKJI@Presets_5?96_Weapon?$AA@
CONST	SEGMENT
??_C@_0BD@PGCPPKJI@Presets_5?96_Weapon?$AA@ DB 'Presets_5-6_Weapon', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@GIAAKBJM@Presets_1?94_Weapon?$AA@
CONST	SEGMENT
??_C@_0BD@GIAAKBJM@Presets_1?94_Weapon?$AA@ DB 'Presets_1-4_Weapon', 00H ; `string'
CONST	ENDS
...
??_7ThreadClass@@6B@ DD FLAT:??_R4ThreadClass@@6B@	; ThreadClass::`vftable'
	...
	DD	FLAT:__purecall
CONST	ENDS
;	COMDAT ??_7NHP_Sensorable_Object@@6B@
CONST	SEGMENT
??_7NHP_Sensorable_Object@@6B@ DD FLAT:??_R4NHP_Sensorable_Object@@6B@ ; NHP_Sensorable_Object::`vftable'
	DD	FLAT:??_ENHP_Sensorable_Object@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@ScriptImpClass@@UAEXPAVScriptableGameObj@@H@Z
	...
	DD	FLAT:?Save_Data@ScriptImpClass@@UAEXAAVScriptSaver@@@Z
	DD	FLAT:?Load_Data@ScriptImpClass@@UAEXAAVScriptLoader@@@Z
	DD	FLAT:?Register_Auto_Save_Variables@NHP_Sensorable_Object@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7NHP_Sensor_Array_Zone@@6B@
CONST	SEGMENT
??_7NHP_Sensor_Array_Zone@@6B@ DD FLAT:??_R4NHP_Sensor_Array_Zone@@6B@ ; NHP_Sensor_Array_Zone::`vftable'
	DD	FLAT:??_ENHP_Sensor_Array_Zone@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@ScriptImpClass@@UAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Entered@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Exited@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Owner@ScriptImpClass@@UAEPAVScriptableGameObj@@XZ
	DD	FLAT:?Get_Owner_Ptr@ScriptImpClass@@UAEPAPAVScriptableGameObj@@XZ
	DD	FLAT:?Set_Parameters_String@ScriptImpClass@@UAEXPBD@Z
	DD	FLAT:?Get_Parameters_String@ScriptImpClass@@UAEXPADI@Z
	...
	DD	FLAT:?Save_Data@ScriptImpClass@@UAEXAAVScriptSaver@@@Z
	DD	FLAT:?Load_Data@ScriptImpClass@@UAEXAAVScriptLoader@@@Z
	DD	FLAT:?Register_Auto_Save_Variables@NHP_Sensor_Array_Zone@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7NHP_Construction_AI@@6B@
CONST	SEGMENT
??_7NHP_Construction_AI@@6B@ DD FLAT:??_R4NHP_Construction_AI@@6B@ ; NHP_Construction_AI::`vftable'
	DD	FLAT:??_ENHP_Construction_AI@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@ScriptImpClass@@UAEXPAVScriptableGameObj@@HH0@Z
	...
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Entered@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Exited@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	...
	DD	FLAT:?Save_Data@ScriptImpClass@@UAEXAAVScriptSaver@@@Z
	DD	FLAT:?Load_Data@ScriptImpClass@@UAEXAAVScriptLoader@@@Z
	DD	FLAT:?Register_Auto_Save_Variables@NHP_Construction_AI@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7NHP_Guard_Bot@@6B@
CONST	SEGMENT
??_7NHP_Guard_Bot@@6B@ DD FLAT:??_R4NHP_Guard_Bot@@6B@	; NHP_Guard_Bot::`vftable'
	DD	FLAT:??_ENHP_Guard_Bot@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@ScriptImpClass@@UAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7NHP_Smart_Targetting@@6B@
CONST	SEGMENT
??_7NHP_Smart_Targetting@@6B@ DD FLAT:??_R4NHP_Smart_Targetting@@6B@ ; NHP_Smart_Targetting::`vftable'
	DD	FLAT:??_ENHP_Smart_Targetting@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@ScriptImpClass@@UAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@ScriptImpClass@@UAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
...
CONST	ENDS
CRT$XCU	SEGMENT
_NHP_Smart_Targetting_Registrant$initializer$ DD FLAT:??__ENHP_Smart_Targetting_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_NHP_Guard_Bot_Registrant$initializer$ DD FLAT:??__ENHP_Guard_Bot_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_NHP_Sensor_Array_Zone_Registrant$initializer$ DD FLAT:??__ENHP_Sensor_Array_Zone_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_NHP_Sensorable_Object_Registrant$initializer$ DD FLAT:??__ENHP_Sensorable_Object_Registrant@@YAXXZ
CRT$XCU	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNHP_Sensorable_Object_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNHP_Sensorable_Object_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'NHP_Sensorable_Object_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NHP_Sensorable_Object_Registrant@@3V?$ScriptRegistrant@VNHP_Sensorable_Object@@@@A ; NHP_Sensorable_Object_Registrant
	call	??1?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNHP_Sensorable_Object_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'NHP_Sensorable_Object_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ??__ENHP_Sensorable_Object_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENHP_Sensorable_Object_Registrant@@YAXXZ PROC	; `dynamic initializer for 'NHP_Sensorable_Object_Registrant'', COMDAT

; 310  : ScriptRegistrant<NHP_Sensorable_Object> NHP_Sensorable_Object_Registrant("NHP_Sensorable_Object","");
	...
	push	OFFSET ??_C@_0BG@HLJDKIAH@NHP_Sensorable_Object?$AA@
	mov	ecx, OFFSET ?NHP_Sensorable_Object_Registrant@@3V?$ScriptRegistrant@VNHP_Sensorable_Object@@@@A ; NHP_Sensorable_Object_Registrant
	call	??0?$ScriptRegistrant@VNHP_Sensorable_Object@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Sensorable_Object>::ScriptRegistrant<NHP_Sensorable_Object>
	push	OFFSET ??__FNHP_Sensorable_Object_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NHP_Sensorable_Object_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENHP_Sensorable_Object_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'NHP_Sensorable_Object_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NHP_Sensorable_Object>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NHP_Sensorable_Object>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAE@XZ PROC ; ScriptRegistrant<NHP_Sensorable_Object>::~ScriptRegistrant<NHP_Sensorable_Object>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAE@XZ ENDP ; ScriptRegistrant<NHP_Sensorable_Object>::~ScriptRegistrant<NHP_Sensorable_Object>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NHP_Sensorable_Object>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DG@LOKAJJEJ@ScriptRegistrant?$DMclass?5NHP_Senso@
	push	553					; 00000229H
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NHP_Sensorable_Object@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNHP_Sensorable_Object@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NHP_Sensorable_Object>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNHP_Sensorable_Object@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNHP_Sensorable_Object@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NHP_Sensorable_Object>::ScriptRegistrant<NHP_Sensorable_Object>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNHP_Sensorable_Object@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNHP_Sensorable_Object@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NHP_Sensorable_Object>::ScriptRegistrant<NHP_Sensorable_Object>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNHP_Sensor_Array_Zone_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNHP_Sensor_Array_Zone_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'NHP_Sensor_Array_Zone_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NHP_Sensor_Array_Zone_Registrant@@3V?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@A ; NHP_Sensor_Array_Zone_Registrant
	call	??1?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNHP_Sensor_Array_Zone_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'NHP_Sensor_Array_Zone_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ??__ENHP_Sensor_Array_Zone_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENHP_Sensor_Array_Zone_Registrant@@YAXXZ PROC	; `dynamic initializer for 'NHP_Sensor_Array_Zone_Registrant'', COMDAT

; 309  : ScriptRegistrant<NHP_Sensor_Array_Zone> NHP_Sensor_Array_Zone_Registrant("NHP_Sensor_Array_Zone","Sensor_List_File:string,Sound_Preset:string,Sound_Position:vector3,Check_Team:int");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0FC@FILLCJII@Sensor_List_File?3string?0Sound_Pr@
	push	OFFSET ??_C@_0BG@BOLOBHNN@NHP_Sensor_Array_Zone?$AA@
	mov	ecx, OFFSET ?NHP_Sensor_Array_Zone_Registrant@@3V?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@A ; NHP_Sensor_Array_Zone_Registrant
	call	??0?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Sensor_Array_Zone>::ScriptRegistrant<NHP_Sensor_Array_Zone>
	push	OFFSET ??__FNHP_Sensor_Array_Zone_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NHP_Sensor_Array_Zone_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENHP_Sensor_Array_Zone_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'NHP_Sensor_Array_Zone_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NHP_Sensor_Array_Zone>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAE@XZ PROC ; ScriptRegistrant<NHP_Sensor_Array_Zone>::~ScriptRegistrant<NHP_Sensor_Array_Zone>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAE@XZ ENDP ; ScriptRegistrant<NHP_Sensor_Array_Zone>::~ScriptRegistrant<NHP_Sensor_Array_Zone>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NHP_Sensor_Array_Zone>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DG@MGAMFAFA@ScriptRegistrant?$DMclass?5NHP_Senso@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NHP_Sensor_Array_Zone@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NHP_Sensor_Array_Zone>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NHP_Sensor_Array_Zone>::ScriptRegistrant<NHP_Sensor_Array_Zone>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNHP_Sensor_Array_Zone@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NHP_Sensor_Array_Zone>::ScriptRegistrant<NHP_Sensor_Array_Zone>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNHP_Guard_Bot_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNHP_Guard_Bot_Registrant@@YAXXZ PROC		; `dynamic atexit destructor for 'NHP_Guard_Bot_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NHP_Guard_Bot_Registrant@@3V?$ScriptRegistrant@VNHP_Guard_Bot@@@@A ; NHP_Guard_Bot_Registrant
	call	??1?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNHP_Guard_Bot_Registrant@@YAXXZ ENDP		; `dynamic atexit destructor for 'NHP_Guard_Bot_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ??__ENHP_Guard_Bot_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENHP_Guard_Bot_Registrant@@YAXXZ PROC		; `dynamic initializer for 'NHP_Guard_Bot_Registrant'', COMDAT

; 308  : ScriptRegistrant<NHP_Guard_Bot> NHP_Guard_Bot_Registrant("NHP_Guard_Bot","Distance:float,Speed:float");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0BL@IAJHMGBA@Distance?3float?0Speed?3float?$AA@
	push	OFFSET ??_C@_0O@CFNCFLAK@NHP_Guard_Bot?$AA@
	mov	ecx, OFFSET ?NHP_Guard_Bot_Registrant@@3V?$ScriptRegistrant@VNHP_Guard_Bot@@@@A ; NHP_Guard_Bot_Registrant
	call	??0?$ScriptRegistrant@VNHP_Guard_Bot@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Guard_Bot>::ScriptRegistrant<NHP_Guard_Bot>
	push	OFFSET ??__FNHP_Guard_Bot_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NHP_Guard_Bot_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENHP_Guard_Bot_Registrant@@YAXXZ ENDP		; `dynamic initializer for 'NHP_Guard_Bot_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAXI@Z PROC	; ScriptRegistrant<NHP_Guard_Bot>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAXI@Z ENDP	; ScriptRegistrant<NHP_Guard_Bot>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAE@XZ PROC	; ScriptRegistrant<NHP_Guard_Bot>::~ScriptRegistrant<NHP_Guard_Bot>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAE@XZ ENDP	; ScriptRegistrant<NHP_Guard_Bot>::~ScriptRegistrant<NHP_Guard_Bot>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NHP_Guard_Bot>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0CO@HNHEDGAP@ScriptRegistrant?$DMclass?5NHP_Guard@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNHP_Guard_Bot@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NHP_Guard_Bot>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNHP_Guard_Bot@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNHP_Guard_Bot@@@@QAE@PBD0@Z PROC	; ScriptRegistrant<NHP_Guard_Bot>::ScriptRegistrant<NHP_Guard_Bot>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNHP_Guard_Bot@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNHP_Guard_Bot@@@@QAE@PBD0@Z ENDP	; ScriptRegistrant<NHP_Guard_Bot>::ScriptRegistrant<NHP_Guard_Bot>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNHP_Smart_Targetting_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNHP_Smart_Targetting_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'NHP_Smart_Targetting_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NHP_Smart_Targetting_Registrant@@3V?$ScriptRegistrant@VNHP_Smart_Targetting@@@@A ; NHP_Smart_Targetting_Registrant
	call	??1?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNHP_Smart_Targetting_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'NHP_Smart_Targetting_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ??__ENHP_Smart_Targetting_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENHP_Smart_Targetting_Registrant@@YAXXZ PROC	; `dynamic initializer for 'NHP_Smart_Targetting_Registrant'', COMDAT

; 307  : ScriptRegistrant<NHP_Smart_Targetting> NHP_Smart_Targetting_Registrant("NHP_Smart_Targetting","Presets_1-4_Weapon:string,Presets_5-6_Weapon:string,Other_Weapon:string,Preset_One:string,Preset_Two:string,Preset_Three:string,Preset_Four:string,Preset_Five:string,Preset_Six:string,Preset_Seven:string,Preset_Eight:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0OA@JEOKLGIA@Presets_1?94_Weapon?3string?0Preset@
	push	OFFSET ??_C@_0BF@HJIAEKLM@NHP_Smart_Targetting?$AA@
	mov	ecx, OFFSET ?NHP_Smart_Targetting_Registrant@@3V?$ScriptRegistrant@VNHP_Smart_Targetting@@@@A ; NHP_Smart_Targetting_Registrant
	call	??0?$ScriptRegistrant@VNHP_Smart_Targetting@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Smart_Targetting>::ScriptRegistrant<NHP_Smart_Targetting>
	push	OFFSET ??__FNHP_Smart_Targetting_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NHP_Smart_Targetting_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENHP_Smart_Targetting_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'NHP_Smart_Targetting_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NHP_Smart_Targetting>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NHP_Smart_Targetting>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAE@XZ PROC ; ScriptRegistrant<NHP_Smart_Targetting>::~ScriptRegistrant<NHP_Smart_Targetting>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAE@XZ ENDP ; ScriptRegistrant<NHP_Smart_Targetting>::~ScriptRegistrant<NHP_Smart_Targetting>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NHP_Smart_Targetting>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DF@MGIAIKOI@ScriptRegistrant?$DMclass?5NHP_Smart@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NHP_Smart_Targetting@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNHP_Smart_Targetting@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NHP_Smart_Targetting>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNHP_Smart_Targetting@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNHP_Smart_Targetting@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NHP_Smart_Targetting>::ScriptRegistrant<NHP_Smart_Targetting>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNHP_Smart_Targetting@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNHP_Smart_Targetting@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NHP_Smart_Targetting>::ScriptRegistrant<NHP_Smart_Targetting>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNHP_Construction_AI_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNHP_Construction_AI_Registrant@@YAXXZ PROC		; `dynamic atexit destructor for 'NHP_Construction_AI_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NHP_Construction_AI_Registrant@@3V?$ScriptRegistrant@VNHP_Construction_AI@@@@A ; NHP_Construction_AI_Registrant
	call	??1?$ScriptRegistrant@VNHP_Construction_AI@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNHP_Construction_AI_Registrant@@YAXXZ ENDP		; `dynamic atexit destructor for 'NHP_Construction_AI_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ??__ENHP_Construction_AI_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENHP_Construction_AI_Registrant@@YAXXZ PROC		; `dynamic initializer for 'NHP_Construction_AI_Registrant'', COMDAT

; 306  : ScriptRegistrant<NHP_Construction_AI> NHP_Construction_AI_Registrant("NHP_Construction_AI","Money_Gen:string,Guard_Inf:string,Attack_Unit:string,Money_Limit:int,Guard_Limit:int,Attack_Limit:int,Time_Delay:float,Money_Waypath:int,Guard_Waypath:int,Attack_Waypath:int");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0KO@JACCPGEM@Money_Gen?3string?0Guard_Inf?3strin@
	push	OFFSET ??_C@_0BE@PNFNPKL@NHP_Construction_AI?$AA@
	mov	ecx, OFFSET ?NHP_Construction_AI_Registrant@@3V?$ScriptRegistrant@VNHP_Construction_AI@@@@A ; NHP_Construction_AI_Registrant
	call	??0?$ScriptRegistrant@VNHP_Construction_AI@@@@QAE@PBD0@Z ; ScriptRegistrant<NHP_Construction_AI>::ScriptRegistrant<NHP_Construction_AI>
	push	OFFSET ??__FNHP_Construction_AI_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NHP_Construction_AI_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENHP_Construction_AI_Registrant@@YAXXZ ENDP		; `dynamic initializer for 'NHP_Construction_AI_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NHP_Construction_AI>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NHP_Construction_AI>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNHP_Construction_AI@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNHP_Construction_AI@@@@UAE@XZ PROC ; ScriptRegistrant<NHP_Construction_AI>::~ScriptRegistrant<NHP_Construction_AI>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNHP_Construction_AI@@@@UAE@XZ ENDP ; ScriptRegistrant<NHP_Construction_AI>::~ScriptRegistrant<NHP_Construction_AI>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NHP_Construction_AI>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DE@CCMGKNL@ScriptRegistrant?$DMclass?5NHP_Const@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NHP_Construction_AI@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNHP_Construction_AI@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NHP_Construction_AI>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNHP_Construction_AI@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNHP_Construction_AI@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NHP_Construction_AI>::ScriptRegistrant<NHP_Construction_AI>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNHP_Construction_AI@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNHP_Construction_AI@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NHP_Construction_AI>::ScriptRegistrant<NHP_Construction_AI>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNHP_Sensorable_Object@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNHP_Sensorable_Object@@UAEPAXI@Z PROC		; NHP_Sensorable_Object::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NHP_Sensorable_Object@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNHP_Sensorable_Object@@UAEPAXI@Z ENDP		; NHP_Sensorable_Object::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NHP_Sensorable_Object@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NHP_Sensorable_Object@@UAE@XZ PROC			; NHP_Sensorable_Object::~NHP_Sensorable_Object, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NHP_Sensorable_Object@@UAE@XZ ENDP			; NHP_Sensorable_Object::~NHP_Sensorable_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NHP_Sensorable_Object@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NHP_Sensorable_Object@@QAE@XZ PROC			; NHP_Sensorable_Object::NHP_Sensorable_Object, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NHP_Sensorable_Object@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NHP_Sensorable_Object@@QAE@XZ ENDP			; NHP_Sensorable_Object::NHP_Sensorable_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Register_Auto_Save_Variables@NHP_Sensorable_Object@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Register_Auto_Save_Variables@NHP_Sensorable_Object@@UAEXXZ PROC ; NHP_Sensorable_Object::Register_Auto_Save_Variables, COMDAT
; _this$ = ecx
...
; 302  : 	Auto_Save_Variable(&insideSensorZone,4,1);
...
; 303  : 	Auto_Save_Variable(&sensorZone,4,2);
...
; 304  : }
	...
	pop	ebp
	ret	0
?Register_Auto_Save_Variables@NHP_Sensorable_Object@@UAEXXZ ENDP ; NHP_Sensorable_Object::Register_Auto_Save_Variables
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Custom@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; NHP_Sensorable_Object::Custom, COMDAT
; _this$ = ecx
...
; 285  : 	if (type == 20103020)

	cmp	DWORD PTR _type$[ebp], 20103020		; 0132bf6cH
...
; 288  : 		{
; 289  : 			insideSensorZone = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+28], 1

; 290  : 			sensorZone = Commands->Get_ID(sender);
...
; 293  : 		{
; 294  : 			insideSensorZone = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+28], 0

; 295  : 			sensorZone = Commands->Get_ID(sender);
...
; 298  : }
	...
	pop	ebp
	ret	16					; 00000010H
?Custom@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; NHP_Sensorable_Object::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Killed@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_killer$ = 12						; size = 4
?Killed@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@0@Z PROC ; NHP_Sensorable_Object::Killed, COMDAT
; _this$ = ecx
...
; 280  : 		Commands->Send_Custom_Event(obj,Commands->Find_Object(sensorZone),20103020,1,0);

	push	ecx
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [esp], xmm0
	push	1
	push	20103020				; 0132bf6cH
	mov	eax, DWORD PTR _this$[ebp]
...
; 281  : }
	...
	pop	ebp
	ret	8
?Killed@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@0@Z ENDP ; NHP_Sensorable_Object::Killed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Created@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@@Z PROC ; NHP_Sensorable_Object::Created, COMDAT
; _this$ = ecx
...
; 275  : }
	...
	pop	ebp
	ret	4
?Created@NHP_Sensorable_Object@@EAEXPAVScriptableGameObj@@@Z ENDP ; NHP_Sensorable_Object::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNHP_Sensor_Array_Zone@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNHP_Sensor_Array_Zone@@UAEPAXI@Z PROC		; NHP_Sensor_Array_Zone::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NHP_Sensor_Array_Zone@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNHP_Sensor_Array_Zone@@UAEPAXI@Z ENDP		; NHP_Sensor_Array_Zone::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NHP_Sensor_Array_Zone@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NHP_Sensor_Array_Zone@@UAE@XZ PROC			; NHP_Sensor_Array_Zone::~NHP_Sensor_Array_Zone, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NHP_Sensor_Array_Zone@@UAE@XZ ENDP			; NHP_Sensor_Array_Zone::~NHP_Sensor_Array_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NHP_Sensor_Array_Zone@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NHP_Sensor_Array_Zone@@QAE@XZ PROC			; NHP_Sensor_Array_Zone::NHP_Sensor_Array_Zone, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NHP_Sensor_Array_Zone@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NHP_Sensor_Array_Zone@@QAE@XZ ENDP			; NHP_Sensor_Array_Zone::NHP_Sensor_Array_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Register_Auto_Save_Variables@NHP_Sensor_Array_Zone@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Register_Auto_Save_Variables@NHP_Sensor_Array_Zone@@UAEXXZ PROC ; NHP_Sensor_Array_Zone::Register_Auto_Save_Variables, COMDAT
; _this$ = ecx
...
; 265  : 	Auto_Save_Variable(&SensorIsAlive,4,1);
...
; 266  : 	Auto_Save_Variable(&count,4,2);
...
; 267  : 	Auto_Save_Variable(&soundId,4,3);
...
; 268  : }
	...
	pop	ebp
	ret	0
?Register_Auto_Save_Variables@NHP_Sensor_Array_Zone@@UAEXXZ ENDP ; NHP_Sensor_Array_Zone::Register_Auto_Save_Variables
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Exited@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_i$1 = -116						; size = 4
_detectName$ = -112					; size = 100
_detectCount$ = -12					; size = 4
_handle$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_exiter$ = 12						; size = 4
?Exited@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z PROC ; NHP_Sensor_Array_Zone::Exited, COMDAT
; _this$ = ecx
...
; 226  : 	if (!SensorIsAlive)

	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, BYTE PTR [eax+28]
	test	ecx, ecx
	jne	SHORT $LN9@Exited
...
; 228  : 	if (Get_Int_Parameter("Check_Team") == Commands->Get_Player_Type(exiter))

	push	OFFSET ??_C@_0L@HNDGGODA@Check_Team?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 230  : 	FILE* handle = fopen(Get_Parameter("Sensor_List_File"), "r");

	push	OFFSET ??_C@_01KDCPPGHE@r?$AA@
	push	OFFSET ??_C@_0BB@CEMOLLEK@Sensor_List_File?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
...
; 231  : 	int detectCount = 0;

	mov	DWORD PTR _detectCount$[ebp], 0

; 232  : 	char detectName[100];
; 233  : 	detectName[99] = 0;

	mov	eax, 1
	imul	eax, 99					; 00000063H
	mov	BYTE PTR _detectName$[ebp+eax], 0

; 234  : 	if (!handle)

	cmp	DWORD PTR _handle$[ebp], 0
	jne	SHORT $LN7@Exited

; 235  : 	{
; 236  : 		Send_Message(255,255,255,"ERROR! Sensor can not find file for sensor list");

	push	OFFSET ??_C@_0DA@PBCPBJNG@ERROR?$CB?5Sensor?5can?5not?5find?5file?5@
	push	255					; 000000ffH
	push	255					; 000000ffH
	push	255					; 000000ffH
...
; 238  : 	}
; 239  : #pragma warning(suppress: 6031) //warning C6031: return value ignored
; 240  : 	fscanf(handle,"%d", &detectCount);

	lea	eax, DWORD PTR _detectCount$[ebp]
	push	eax
...
; 241  : 	for (int i=0;i<=detectCount;i++)

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN6@Exited
$LN5@Exited:
...
$LN6@Exited:
	mov	eax, DWORD PTR _i$1[ebp]
	cmp	eax, DWORD PTR _detectCount$[ebp]
	jg	$LN4@Exited

; 242  : 	{
; 243  : #pragma warning(suppress: 6031) //warning C6031: return value ignored
; 244  : 		fscanf(handle,"%99[^\n]", detectName);

	lea	eax, DWORD PTR _detectName$[ebp]
	push	eax
	push	OFFSET ??_C@_07FDFGNKME@?$CF99?$FL?$FO?6?$FN?$AA@
	mov	ecx, DWORD PTR _handle$[ebp]
	push	ecx
	call	DWORD PTR __imp__fscanf
	add	esp, 12					; 0000000cH

; 245  : 		if (!_stricmp(Commands->Get_Preset_Name(exiter),detectName))

	lea	eax, DWORD PTR _detectName$[ebp]
	push	eax
	mov	ecx, DWORD PTR _exiter$[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 251  : 			{
; 252  : 				Commands->Stop_Sound(soundId,false);
...
; 253  : 			}
; 254  : 			//Tell the object that it has left
; 255  : 			Commands->Send_Custom_Event(obj,exiter,20103020,1,0);
...
; 261  : }
	...
	pop	ebp
	ret	8
?Exited@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z ENDP ; NHP_Sensor_Array_Zone::Exited
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Entered@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_i$1 = -116						; size = 4
_detectName$ = -112					; size = 100
_detectCount$ = -12					; size = 4
...
_obj$ = 8						; size = 4
_enterer$ = 12						; size = 4
?Entered@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z PROC ; NHP_Sensor_Array_Zone::Entered, COMDAT
; _this$ = ecx
...
; 189  : 	if (!SensorIsAlive)

	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, BYTE PTR [eax+28]
	test	ecx, ecx
	jne	SHORT $LN8@Entered
...
; 191  : 	if (Get_Int_Parameter("Check_Team") == Commands->Get_Player_Type(enterer))
...
; 193  : 	FILE* handle = fopen(Get_Parameter("Sensor_List_File"), "r");
...
; 194  : 	int detectCount = 0;

	mov	DWORD PTR _detectCount$[ebp], 0

; 195  : 	char detectName[100];
; 196  : 	detectName[99] = 0;
...
; 198  : 	{
; 199  : 		Send_Message(255,255,255,"ERROR! Sensor can not find file for sensor list");
...
; 201  : 	}
; 202  : #pragma warning(suppress: 6031) //warning C6031: return value ignored
; 203  : 	fscanf(handle,"%d", &detectCount);
...
; 204  : 	for (int i=0;i<=detectCount;i++)
...
; 205  : 	{
; 206  : #pragma warning(suppress: 6031) //warning C6031: return value ignored
; 207  : 		fscanf(handle,"%99[^\n]", detectName);
...
; 208  : 		if (!_stricmp(Commands->Get_Preset_Name(enterer),detectName))
...
; 212  : 			{
; 213  : 				Commands->Start_Sound(soundId);
...
; 214  : 			}
; 215  : 			//Tell the object that it has entered
; 216  : 			Commands->Send_Custom_Event(obj,enterer,20103020,0,0);
...
; 222  : }
	...
	pop	ebp
	ret	8
?Entered@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@0@Z ENDP ; NHP_Sensor_Array_Zone::Entered
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Custom@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; NHP_Sensor_Array_Zone::Custom, COMDAT
; _this$ = ecx
...
; 168  : 	if (type == 901192102)

	cmp	DWORD PTR _type$[ebp], 901192102	; 35b719a6H
...
; 174  : 	}
; 175  : 	if (type == 20103020)

	cmp	DWORD PTR _type$[ebp], 20103020		; 0132bf6cH
	jne	SHORT $LN8@Custom

; 176  : 	{
; 177  : 		if (Get_Int_Parameter("Check_Team") == Commands->Get_Player_Type(sender))
...
; 183  : 			Commands->Stop_Sound(soundId,false);
...
; 185  : }
	...
	pop	ebp
	ret	16					; 00000010H
?Custom@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; NHP_Sensor_Array_Zone::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Created@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -80						; size = 12
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@@Z PROC ; NHP_Sensor_Array_Zone::Created, COMDAT
; _this$ = ecx
...
; 161  : 	SensorIsAlive = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+28], 1

; 162  : 	soundId = Commands->Create_Sound(Get_Parameter("Sound_Preset"),Get_Vector3_Parameter("Sound_Position"),obj);

	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	push	OFFSET ??_C@_0P@NIEAFCIF@Sound_Position?$AA@
	lea	ecx, DWORD PTR $T1[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 163  : 	Commands->Stop_Sound(soundId,false);
...
; 164  : }
	...
	pop	ebp
	ret	4
?Created@NHP_Sensor_Array_Zone@@EAEXPAVScriptableGameObj@@@Z ENDP ; NHP_Sensor_Array_Zone::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNHP_Construction_AI@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNHP_Construction_AI@@UAEPAXI@Z PROC			; NHP_Construction_AI::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NHP_Construction_AI@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNHP_Construction_AI@@UAEPAXI@Z ENDP			; NHP_Construction_AI::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NHP_Construction_AI@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NHP_Construction_AI@@UAE@XZ PROC			; NHP_Construction_AI::~NHP_Construction_AI, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NHP_Construction_AI@@UAE@XZ ENDP			; NHP_Construction_AI::~NHP_Construction_AI
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NHP_Construction_AI@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NHP_Construction_AI@@QAE@XZ PROC			; NHP_Construction_AI::NHP_Construction_AI, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NHP_Construction_AI@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NHP_Construction_AI@@QAE@XZ ENDP			; NHP_Construction_AI::NHP_Construction_AI
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Register_Auto_Save_Variables@NHP_Construction_AI@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Register_Auto_Save_Variables@NHP_Construction_AI@@UAEXXZ PROC ; NHP_Construction_AI::Register_Auto_Save_Variables, COMDAT
; _this$ = ecx
...
; 152  : 	Auto_Save_Variable(&unitlim1,4,1);
...
; 153  : 	Auto_Save_Variable(&unitlim2,4,2);
...
; 154  : 	Auto_Save_Variable(&unitlim3,4,3);
...
; 155  : }
	...
	pop	ebp
	ret	0
?Register_Auto_Save_Variables@NHP_Construction_AI@@UAEXXZ ENDP ; NHP_Construction_AI::Register_Auto_Save_Variables
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Timer_Expired@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
tv90 = -336						; size = 4
$T1 = -332						; size = 12
$T2 = -320						; size = 12
...
_limit$ = -220						; size = 4
_timer$ = -216						; size = 4
_params$ = -212						; size = 196
_spawnPos$ = -16					; size = 12
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_number$ = 12						; size = 4
?Timer_Expired@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@H@Z PROC ; NHP_Construction_AI::Timer_Expired, COMDAT
; _this$ = ecx
...
; 84   : 	int id;
; 85   : 	const char *unit;
; 86   : 	GameObject *object;
; 87   : 	timer = Get_Float_Parameter("Time_Delay");
	...
	fstp	DWORD PTR _timer$[ebp]

; 88   : 	spawnPos.X = Commands->Get_Position(obj).X + 5;
...
; 89   : 	spawnPos.Y = Commands->Get_Position(obj).Y;
...
; 90   : 	spawnPos.Z = Commands->Get_Position(obj).Z + 2;
...
; 91   : 	switch (number)
	...
	jmp	DWORD PTR $LN11@Timer_Expi[edx*4]
$LN6@Timer_Expi:

; 92   : 	{
; 93   : 	case 1:
; 94   : 	case 5:
; 95   : 			limit = Get_Int_Parameter("Money_Limit");

	push	OFFSET ??_C@_0M@HPDDLCBF@Money_Limit?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _limit$[ebp], eax

; 96   : 			if (unitlim1 < limit)
...
; 99   : 				unit = Get_Parameter("Money_Gen");

	push	OFFSET ??_C@_09MNMLKPFC@Money_Gen?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _unit$[ebp], eax

; 100  : 				object = Commands->Create_Object(unit,spawnPos);
...
; 101  : 				id = Get_Int_Parameter("Money_Waypath");

	push	OFFSET ??_C@_0O@GMEIBLGN@Money_Waypath?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _id$[ebp], eax

; 102  : 				params.MoveArrivedDistance = 100;

	movss	xmm0, DWORD PTR __real@42c80000
	movss	DWORD PTR _params$[ebp+64], xmm0

; 103  : 				params.Set_Basic(this,100,1);
...
; 104  : 				params.WaypathID = id;

	mov	eax, DWORD PTR _id$[ebp]
	mov	DWORD PTR _params$[ebp+136], eax

; 105  : 				params.WaypathSplined = true;

	mov	BYTE PTR _params$[ebp+148], 1

; 106  : 				params.AttackActive = false;

	mov	BYTE PTR _params$[ebp+109], 0

; 107  : 				params.AttackCheckBlocked = false;

	mov	BYTE PTR _params$[ebp+108], 0

; 108  : 				Commands->Action_Goto(object,params);
...
; 109  : 				Commands->Start_Timer(obj,this,timer,2);

	push	2
	push	ecx
	movss	xmm0, DWORD PTR _timer$[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	mov	ecx, DWORD PTR _obj$[ebp]
...
; 112  : 	case 2:
; 113  : 			limit = Get_Int_Parameter("Guard_Limit");

	push	OFFSET ??_C@_0M@HEJJGPE@Guard_Limit?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _limit$[ebp], eax

; 114  : 			if (unitlim2 < limit)
...
; 117  : 				unit = Get_Parameter("Guard_Inf");

	push	OFFSET ??_C@_09DEFEEAH@Guard_Inf?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _unit$[ebp], eax

; 118  : 				object = Commands->Create_Object(unit,spawnPos);
...
; 119  : 				id = Get_Int_Parameter("Guard_Waypath");

	push	OFFSET ??_C@_0O@BHCOEFGL@Guard_Waypath?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _id$[ebp], eax

; 120  : 				params.Set_Basic(this,100,1);
...
; 121  : 				params.WaypathID = id;

	mov	eax, DWORD PTR _id$[ebp]
	mov	DWORD PTR _params$[ebp+136], eax

; 122  : 				params.WaypathSplined = true;

	mov	BYTE PTR _params$[ebp+148], 1

; 123  : 				params.AttackActive = false;

	mov	BYTE PTR _params$[ebp+109], 0

; 124  : 				params.AttackCheckBlocked = false;

	mov	BYTE PTR _params$[ebp+108], 0

; 125  : 				Commands->Action_Goto(object,params);
...
; 126  : 				Commands->Start_Timer(obj,this,timer,3);
...
; 129  : 	case 3:
; 130  : 	case 4:
; 131  : 			limit = Get_Int_Parameter("Attack_Limit");

	push	OFFSET ??_C@_0N@NDFBCBJN@Attack_Limit?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _limit$[ebp], eax

; 132  : 			if (unitlim3 < limit)
...
; 135  : 				unit = Get_Parameter("Attack_Unit");

	push	OFFSET ??_C@_0M@NIPPNKMI@Attack_Unit?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _unit$[ebp], eax

; 136  : 				object = Commands->Create_Object(unit,spawnPos);
...
; 137  : 				id = Get_Int_Parameter("Attack_Waypath");

	push	OFFSET ??_C@_0P@PGBEGHLC@Attack_Waypath?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Int_Parameter@ScriptImpClass@@QAEHPBD@Z ; ScriptImpClass::Get_Int_Parameter
	mov	DWORD PTR _id$[ebp], eax

; 138  : 				params.Set_Basic(this,100,1);
...
; 139  : 				params.WaypathID = id;

	mov	eax, DWORD PTR _id$[ebp]
	mov	DWORD PTR _params$[ebp+136], eax

; 140  : 				params.WaypathSplined = true;

	mov	BYTE PTR _params$[ebp+148], 1

; 141  : 				params.AttackActive = false;

	mov	BYTE PTR _params$[ebp+109], 0

; 142  : 				params.AttackCheckBlocked = false;

	mov	BYTE PTR _params$[ebp+108], 0

; 143  : 				Commands->Action_Goto(object,params);
...
; 144  : 				Commands->Start_Timer(obj,this,timer,4);
...
$LN11@Timer_Expi:
	...
	DD	$LN2@Timer_Expi
	DD	$LN6@Timer_Expi
?Timer_Expired@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@H@Z ENDP ; NHP_Construction_AI::Timer_Expired
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Created@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_timer$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@@Z PROC ; NHP_Construction_AI::Created, COMDAT
; _this$ = ecx
...
; 70   : 	float timer;
; 71   : 	timer = Get_Float_Parameter("Time_Delay");
...
; 72   : 	Commands->Start_Timer(obj,this,timer,1);
...
; 76   : }
	...
	pop	ebp
	ret	4
?Created@NHP_Construction_AI@@EAEXPAVScriptableGameObj@@@Z ENDP ; NHP_Construction_AI::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNHP_Guard_Bot@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNHP_Guard_Bot@@UAEPAXI@Z PROC			; NHP_Guard_Bot::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNHP_Guard_Bot@@UAEPAXI@Z ENDP			; NHP_Guard_Bot::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NHP_Guard_Bot@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NHP_Guard_Bot@@UAE@XZ PROC				; NHP_Guard_Bot::~NHP_Guard_Bot, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NHP_Guard_Bot@@UAE@XZ ENDP				; NHP_Guard_Bot::~NHP_Guard_Bot
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NHP_Guard_Bot@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NHP_Guard_Bot@@QAE@XZ PROC				; NHP_Guard_Bot::NHP_Guard_Bot, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NHP_Guard_Bot@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NHP_Guard_Bot@@QAE@XZ ENDP				; NHP_Guard_Bot::NHP_Guard_Bot
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Damaged@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@0M@Z
_TEXT	SEGMENT
_s$ = -208						; size = 4
_d$ = -204						; size = 4
_actionThingy$ = -200					; size = 196
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_damager$ = 12						; size = 4
_amount$ = 16						; size = 4
?Damaged@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@0M@Z PROC ; NHP_Guard_Bot::Damaged, COMDAT
; _this$ = ecx
...
; 54   : 	ActionParamsStruct actionThingy;

	lea	ecx, DWORD PTR _actionThingy$[ebp]
	call	??0ActionParamsStruct@@QAE@XZ		; ActionParamsStruct::ActionParamsStruct

; 55   : 	float d;
; 56   : 	float s;
; 57   : 	actionThingy.Set_Basic(this,70,1);
...
; 58   : 	d = Get_Float_Parameter("Distance");

	push	OFFSET ??_C@_08DFKPLDPN@Distance?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Float_Parameter@ScriptImpClass@@QAEMPBD@Z ; ScriptImpClass::Get_Float_Parameter
	fstp	DWORD PTR _d$[ebp]

; 59   : 	s = Get_Float_Parameter("Speed");
...
; 60   : 	if (Commands->Get_Player_Type(obj) == Commands->Get_Player_Type(damager))
...
; 61   : 	{
; 62   : 		actionThingy.Set_Movement(damager,s,d);
...
; 63   : 		actionThingy.MoveFollow = true;

	mov	BYTE PTR _actionThingy$[ebp+69], 1

; 64   : 		Commands->Action_Goto(obj,actionThingy);

	lea	eax, DWORD PTR _actionThingy$[ebp]
	push	eax
	mov	ecx, DWORD PTR _obj$[ebp]
	push	ecx
	mov	edx, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
...
; 66   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?Damaged@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@0M@Z ENDP ; NHP_Guard_Bot::Damaged
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Created@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@@Z PROC ; NHP_Guard_Bot::Created, COMDAT
; _this$ = ecx
...
; 49   : 	Commands->Enable_HUD_Pokable_Indicator(obj,1);
...
; 50   : }
	...
	pop	ebp
	ret	4
?Created@NHP_Guard_Bot@@EAEXPAVScriptableGameObj@@@Z ENDP ; NHP_Guard_Bot::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNHP_Smart_Targetting@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNHP_Smart_Targetting@@UAEPAXI@Z PROC		; NHP_Smart_Targetting::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NHP_Smart_Targetting@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNHP_Smart_Targetting@@UAEPAXI@Z ENDP		; NHP_Smart_Targetting::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NHP_Smart_Targetting@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NHP_Smart_Targetting@@UAE@XZ PROC			; NHP_Smart_Targetting::~NHP_Smart_Targetting, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NHP_Smart_Targetting@@UAE@XZ ENDP			; NHP_Smart_Targetting::~NHP_Smart_Targetting
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NHP_Smart_Targetting@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NHP_Smart_Targetting@@QAE@XZ PROC			; NHP_Smart_Targetting::NHP_Smart_Targetting, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NHP_Smart_Targetting@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NHP_Smart_Targetting@@QAE@XZ ENDP			; NHP_Smart_Targetting::NHP_Smart_Targetting
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Created@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@@Z PROC ; NHP_Smart_Targetting::Created, COMDAT
; _this$ = ecx
...
; 19   : 	Commands->Enable_Enemy_Seen(obj,true);
...
; 20   : }
	...
	pop	ebp
	ret	4
?Created@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@@Z ENDP ; NHP_Smart_Targetting::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nhp.cpp
;	COMDAT ?Enemy_Seen@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_d$ = -16						; size = 4
_b$ = -12						; size = 4
_c$ = -8						; size = 4
...
_obj$ = 8						; size = 4
_enemy$ = 12						; size = 4
?Enemy_Seen@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@0@Z PROC ; NHP_Smart_Targetting::Enemy_Seen, COMDAT
; _this$ = ecx
...
; 26   : 	const char *b;
; 27   : 	const char *d;
; 28   : 	c = Get_Parameter("Presets_1-4_Weapon");

	push	OFFSET ??_C@_0BD@GIAAKBJM@Presets_1?94_Weapon?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _c$[ebp], eax

; 29   : 	b = Get_Parameter("Presets_5-6_Weapon");

	push	OFFSET ??_C@_0BD@PGCPPKJI@Presets_5?96_Weapon?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _b$[ebp], eax

; 30   : 	d = Get_Parameter("Other_Weapon");

	push	OFFSET ??_C@_0N@LGDIIJN@Other_Weapon?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _d$[ebp], eax

; 31   : 
; 32   : 	if ((!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_One"))) || ((!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Two")))) || ((!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Three")))) || ((!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Four")))))

	push	OFFSET ??_C@_0L@EAJLNBCG@Preset_One?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	...
	test	eax, eax
	je	$LN5@Enemy_Seen
	push	OFFSET ??_C@_0L@COJLHBMN@Preset_Two?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
	...
	push	OFFSET ??_C@_0N@EPADNPAK@Preset_Three?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
	...
	test	eax, eax
	je	SHORT $LN5@Enemy_Seen
	push	OFFSET ??_C@_0M@GGMOKDDM@Preset_Four?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
...
; 33   : 	{
; 34   : 		Commands->Select_Weapon(obj,c);
...
; 35   : 	}
; 36   : 	else if ((!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Five"))) || (!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Six"))) || (!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Seven"))) || (!_stricmp(Commands->Get_Preset_Name(enemy),Get_Parameter("Preset_Eight"))))

	push	OFFSET ??_C@_0M@EEGAMGCP@Preset_Five?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
	...
	test	eax, eax
	je	$LN2@Enemy_Seen
	push	OFFSET ??_C@_0L@KAHHEDJI@Preset_Six?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
	...
	push	OFFSET ??_C@_0N@MGAAGFJP@Preset_Seven?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
	...
	test	eax, eax
	je	SHORT $LN2@Enemy_Seen
	push	OFFSET ??_C@_0N@IGCPDAGK@Preset_Eight?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	push	eax
	mov	eax, DWORD PTR _enemy$[ebp]
...
; 37   : 	{
; 38   : 		Commands->Select_Weapon(obj,b);
...
; 41   : 	{
; 42   : 		Commands->Select_Weapon(obj,d);
...
; 45   : }
	...
	pop	ebp
	ret	8
?Enemy_Seen@NHP_Smart_Targetting@@EAEXPAVScriptableGameObj@@0@Z ENDP ; NHP_Smart_Targetting::Enemy_Seen
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
