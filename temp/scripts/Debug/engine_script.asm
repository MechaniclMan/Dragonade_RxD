; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\engine_script.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_07GLAFNOGD@vector3?$AA@			; `string'
PUBLIC	??_C@_04DBJPMPLO@enum?$AA@			; `string'
PUBLIC	??_C@_07HMFGJOIF@emitter?$AA@			; `string'
PUBLIC	??_C@_06GEPNGEJI@weapon?$AA@			; `string'
PUBLIC	??_C@_04PGKJFGNK@ammo?$AA@			; `string'
PUBLIC	??_C@_09DJINNLFM@explosion?$AA@			; `string'
PUBLIC	??_C@_09KCBFNMAJ@animation?$AA@			; `string'
PUBLIC	??_C@_04PJKACIJD@gang?$AA@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_04PJKACIJD@gang?$AA@
CONST	SEGMENT
??_C@_04PJKACIJD@gang?$AA@ DB 'gang', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_09KCBFNMAJ@animation?$AA@
CONST	SEGMENT
??_C@_09KCBFNMAJ@animation?$AA@ DB 'animation', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_09DJINNLFM@explosion?$AA@
CONST	SEGMENT
??_C@_09DJINNLFM@explosion?$AA@ DB 'explosion', 00H	; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_07HMFGJOIF@emitter?$AA@
CONST	SEGMENT
??_C@_07HMFGJOIF@emitter?$AA@ DB 'emitter', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_04DBJPMPLO@enum?$AA@
CONST	SEGMENT
??_C@_04DBJPMPLO@enum?$AA@ DB 'enum', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_07GLAFNOGD@vector3?$AA@
CONST	SEGMENT
??_C@_07GLAFNOGD@vector3?$AA@ DB 'vector3', 00H		; `string'
CONST	ENDS
...
CONST	ENDS
CONST	SEGMENT
_PARAM_TYPE_STRINGS DD FLAT:??_C@_03JBIPMCLC@int?$AA@
	DD	FLAT:??_C@_05KNFBNCOH@float?$AA@
	DD	FLAT:??_C@_06ICGJLFIM@string?$AA@
	DD	FLAT:??_C@_04DDKJGDCM@bool?$AA@
	DD	FLAT:??_C@_02OLOABKKD@ID?$AA@
	DD	FLAT:??_C@_07GLAFNOGD@vector3?$AA@
	DD	FLAT:??_C@_04DBJPMPLO@enum?$AA@
	DD	FLAT:??_C@_07HMFGJOIF@emitter?$AA@
	DD	FLAT:??_C@_06GEPNGEJI@weapon?$AA@
	DD	FLAT:??_C@_04PGKJFGNK@ammo?$AA@
	DD	FLAT:??_C@_09DJINNLFM@explosion?$AA@
	DD	FLAT:??_C@_09KCBFNMAJ@animation?$AA@
	DD	FLAT:??_C@_04PJKACIJD@gang?$AA@
	DD	FLAT:??_C@_04DAMGJPCA@file?$AA@
	DD	FLAT:??_C@_05MHNANJII@sound?$AA@
...
PUBLIC	??0GenericSLNode@@IAE@PAXPAV0@@Z		; GenericSLNode::GenericSLNode
PUBLIC	?Remove_Script@@YAXPAVScriptableGameObj@@PBD@Z	; Remove_Script
PUBLIC	?Remove_All_Scripts@@YAXPAVScriptableGameObj@@@Z ; Remove_All_Scripts
PUBLIC	?Attach_Script_Preset@@YAXPBD00H@Z		; Attach_Script_Preset
PUBLIC	?Attach_Script_Type@@YAXPBD0KH@Z		; Attach_Script_Type
PUBLIC	?Remove_Script_Preset@@YAXPBD0H@Z		; Remove_Script_Preset
PUBLIC	?Remove_Script_Type@@YAXPBDKH@Z			; Remove_Script_Type
PUBLIC	?Is_Script_Attached@@YA_NPAVScriptableGameObj@@PBD@Z ; Is_Script_Attached
PUBLIC	?Attach_Script_Once@@YAXPAVScriptableGameObj@@PBD1@Z ; Attach_Script_Once
PUBLIC	?Attach_Script_Preset_Once@@YAXPBD00H@Z		; Attach_Script_Preset_Once
PUBLIC	?Attach_Script_Type_Once@@YAXPBD0KH@Z		; Attach_Script_Type_Once
PUBLIC	?Attach_Script_Building@@YAXPBD0H@Z		; Attach_Script_Building
PUBLIC	?Attach_Script_Is_Preset@@YAXPAVScriptableGameObj@@PBD11H@Z ; Attach_Script_Is_Preset
PUBLIC	?Attach_Script_Is_Type@@YAXPAVScriptableGameObj@@KPBD1H@Z ; Attach_Script_Is_Type
PUBLIC	?Attach_Script_Player_Once@@YAXPBD0H@Z		; Attach_Script_Player_Once
PUBLIC	?Remove_Duplicate_Script@@YAXPAVScriptableGameObj@@PBD@Z ; Remove_Duplicate_Script
PUBLIC	?Attach_Script_All_Buildings_Team@@YAXHPBD0_N@Z	; Attach_Script_All_Buildings_Team
PUBLIC	?Attach_Script_All_Turrets_Team@@YAXHPBD0_N@Z	; Attach_Script_All_Turrets_Team
PUBLIC	?Find_Building_With_Script@@YAPAVScriptableGameObj@@HHPBDPAV1@@Z ; Find_Building_With_Script
PUBLIC	?Find_Object_With_Script@@YAPAVScriptableGameObj@@PBD@Z ; Find_Object_With_Script
PUBLIC	?Find_Closest_Object_With_Script@@YAPAVScriptableGameObj@@PBDVVector3@@@Z ; Find_Closest_Object_With_Script
PUBLIC	?Find_All_Objects_With_Script@@YAXPBDAAV?$SList@VScriptableGameObj@@@@@Z ; Find_All_Objects_With_Script
PUBLIC	?Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z ; Find_All_Objects_With_Script_By_Distance
PUBLIC	?Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z ; Find_All_Vehicles_By_Distance
PUBLIC	?Send_Custom_Event_To_Objects_With_Script@@YAXPAVScriptableGameObj@@PBDHHM@Z ; Send_Custom_Event_To_Objects_With_Script
PUBLIC	?Send_Custom_Event_To_Objects_With_Script_Ranged@@YAXPAVScriptableGameObj@@PBDHHMM@Z ; Send_Custom_Event_To_Objects_With_Script_Ranged
PUBLIC	?Find_Script_On_Object@@YAPAVScriptImpClass@@PAVScriptableGameObj@@PBD@Z ; Find_Script_On_Object
PUBLIC	?Attach_Script_Occupants@@YAXPAVScriptableGameObj@@PBD1@Z ; Attach_Script_Occupants
PUBLIC	?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1ZZ ; Attach_Script_V
PUBLIC	?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z ; Attach_Script_V
PUBLIC	?Attach_Script_Once_V@@YAXPAVScriptableGameObj@@PBD1ZZ ; Attach_Script_Once_V
PUBLIC	??0ScriptParameter@@QAE@XZ			; ScriptParameter::ScriptParameter
PUBLIC	??1ScriptParameter@@QAE@XZ			; ScriptParameter::~ScriptParameter
PUBLIC	??4ScriptParameter@@QAEAAV0@ABV0@@Z		; ScriptParameter::operator=
PUBLIC	??_EScriptParameter@@QAEPAXI@Z			; ScriptParameter::`vector deleting destructor'
PUBLIC	?Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z ; Get_Script_Parameters
...
PUBLIC	?Get_Observers@ScriptableGameObj@@QAEABV?$SimpleDynVecClass@PAVGameObjObserverClass@@@@XZ ; ScriptableGameObj::Get_Observers
PUBLIC	?Count@?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEHXZ ; SimpleDynVecClass<GameObjObserverClass *>::Count
PUBLIC	??A?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEABQAVGameObjObserverClass@@H@Z ; SimpleDynVecClass<GameObjObserverClass *>::operator[]
...
PUBLIC	?insertBefore@?$SList@VScriptableGameObj@@@@QAEXPAVScriptableGameObj@@AAV?$SLNode@VScriptableGameObj@@@@@Z ; SList<ScriptableGameObj>::insertBefore
PUBLIC	??0?$SList@M@@QAE@XZ				; SList<float>::SList<float>
PUBLIC	??1?$SList@M@@UAE@XZ				; SList<float>::~SList<float>
PUBLIC	?Add_Head@?$SList@M@@UAE_NPAM@Z			; SList<float>::Add_Head
PUBLIC	?Add_Head@?$SList@M@@UAE_NAAV1@@Z		; SList<float>::Add_Head
PUBLIC	?Add_Tail@?$SList@M@@UAE_NPAM@Z			; SList<float>::Add_Tail
PUBLIC	?Add_Tail@?$SList@M@@UAE_NAAV1@@Z		; SList<float>::Add_Tail
PUBLIC	?Remove_Head@?$SList@M@@UAEPAMXZ		; SList<float>::Remove_Head
PUBLIC	?Remove_Tail@?$SList@M@@UAEPAMXZ		; SList<float>::Remove_Tail
PUBLIC	?Remove@?$SList@M@@UAE_NPBM@Z			; SList<float>::Remove
PUBLIC	?Remove_All@?$SList@M@@UAEXXZ			; SList<float>::Remove_All
PUBLIC	?Insert_Before@?$SList@M@@UAE_NPAMPBM@Z		; SList<float>::Insert_Before
PUBLIC	?Insert_After@?$SList@M@@UAE_NPAMPBM@Z		; SList<float>::Insert_After
PUBLIC	?Is_Empty@?$SList@M@@UBE_NXZ			; SList<float>::Is_Empty
PUBLIC	?Get_Count@?$SList@M@@UBEIXZ			; SList<float>::Get_Count
PUBLIC	?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ		; SList<float>::Head
PUBLIC	?insertBefore@?$SList@M@@QAEXPAMAAV?$SLNode@M@@@Z ; SList<float>::insertBefore
PUBLIC	??_G?$SList@M@@UAEPAXI@Z			; SList<float>::`scalar deleting destructor'
PUBLIC	?Set_Next@?$SLNode@M@@QAEXPAV1@@Z		; SLNode<float>::Set_Next
PUBLIC	?Next@?$SLNode@M@@QBEPAV1@XZ			; SLNode<float>::Next
PUBLIC	?Data@?$SLNode@M@@QBEPAMXZ			; SLNode<float>::Data
PUBLIC	??0?$SLNode@M@@IAE@PAM@Z			; SLNode<float>::SLNode<float>
PUBLIC	??0?$SLNode@M@@IAE@PAMPAV0@@Z			; SLNode<float>::SLNode<float>
...
PUBLIC	??0?$SLNode@VScriptableGameObj@@@@IAE@PAVScriptableGameObj@@PAV0@@Z ; SLNode<ScriptableGameObj>::SLNode<ScriptableGameObj>
PUBLIC	?Get_Param_Type@@YAHPBD@Z			; Get_Param_Type
PUBLIC	??A?$VectorClass@VScriptParameter@@@@QAEAAVScriptParameter@@H@Z ; VectorClass<ScriptParameter>::operator[]
PUBLIC	?Length@?$VectorClass@VScriptParameter@@@@QBEHXZ ; VectorClass<ScriptParameter>::Length
PUBLIC	?Add@?$DynamicVectorClass@VScriptParameter@@@@QAE_NABVScriptParameter@@@Z ; DynamicVectorClass<ScriptParameter>::Add
PUBLIC	?Delete_All@?$DynamicVectorClass@VScriptParameter@@@@QAEXXZ ; DynamicVectorClass<ScriptParameter>::Delete_All
...
PUBLIC	??_7?$SList@M@@6B@				; SList<float>::`vftable'
PUBLIC	?__LINE__Var@?1??Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA ; `Find_All_Objects_With_Script_By_Distance'::`2'::__LINE__Var
PUBLIC	??_C@_0CJ@KCIIGHPE@Find_All_Objects_With_Script_By_@ ; `string'
PUBLIC	??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@ ; `string'
PUBLIC	??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@ ; `string'
PUBLIC	?__LINE__Var@?1??Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA ; `Find_All_Vehicles_By_Distance'::`2'::__LINE__Var
PUBLIC	??_C@_0BO@HDHFKGIM@Find_All_Vehicles_By_Distance?$AA@ ; `string'
PUBLIC	?__LINE__Var@?1??Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z@4JA ; `Attach_Script_V'::`2'::__LINE__Var
PUBLIC	??_C@_0BA@BFCJEGOL@Attach_Script_V?$AA@		; `string'
PUBLIC	??_C@_01IHBHIGKO@?0?$AA@			; `string'
PUBLIC	?__LINE__Var@?1??Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z@4JA ; `Get_Script_Parameters'::`2'::__LINE__Var
PUBLIC	??_C@_0BG@DDLIJLA@Get_Script_Parameters?$AA@	; `string'
...
PUBLIC	??_C@_0CN@PEIMBNJH@SList?$DMclass?5ScriptableGameObj?$DO?3?3@ ; `string'
PUBLIC	??_C@_0BH@NLHPPKCN@SList?$DMfloat?$DO?3?3Add_Head?$AA@ ; `string'
PUBLIC	??_C@_0BH@DHMHMMEJ@SList?$DMfloat?$DO?3?3Add_Tail?$AA@ ; `string'
PUBLIC	??_C@_0BK@JICKFGDE@SList?$DMfloat?$DO?3?3Remove_Head?$AA@ ; `string'
PUBLIC	??_C@_0BF@CGKAMEOP@SList?$DMfloat?$DO?3?3Remove?$AA@ ; `string'
PUBLIC	??_C@_0BJ@HFNOCHEL@SList?$DMfloat?$DO?3?3Remove_All?$AA@ ; `string'
PUBLIC	??_C@_0BM@MMBJJAJD@SList?$DMfloat?$DO?3?3Insert_Before?$AA@ ; `string'
PUBLIC	??_C@_0BL@BOIMIBNP@SList?$DMfloat?$DO?3?3Insert_After?$AA@ ; `string'
PUBLIC	??_C@_0BL@KMDEJBPJ@SList?$DMfloat?$DO?3?3insertBefore?$AA@ ; `string'
...
PUBLIC	??_R4?$SList@M@@6B@				; SList<float>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$SList@M@@@8				; SList<float> `RTTI Type Descriptor'
PUBLIC	??_R3?$SList@M@@8				; SList<float>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$SList@M@@8				; SList<float>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$SList@M@@8			; SList<float>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	__imp___vscprintf_p:PROC
...
EXTRN	?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@PBD@Z:PROC ; ScriptRegistrar::GetScriptFactory
...
EXTRN	?Find_Observer@ScriptableGameObj@@QAEPAVGameObjObserverClass@@PBD@Z:PROC ; ScriptableGameObj::Find_Observer
...
EXTRN	?Building_Type@@YAHPAVScriptableGameObj@@@Z:PROC ; Building_Type
...
EXTRN	??_E?$SList@M@@UAEPAXI@Z:PROC			; SList<float>::`vector deleting destructor'
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$SList@M@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$SList@M@@8 DD FLAT:??_R0?AV?$SList@M@@@8 ; SList<float>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	00H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$SList@M@@8
rdata$r	ENDS
;	COMDAT ??_R2?$SList@M@@8
rdata$r	SEGMENT
??_R2?$SList@M@@8 DD FLAT:??_R1A@?0A@EA@?$SList@M@@8	; SList<float>::`RTTI Base Class Array'
rdata$r	ENDS
;	COMDAT ??_R3?$SList@M@@8
rdata$r	SEGMENT
??_R3?$SList@M@@8 DD 00H				; SList<float>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	01H
	DD	FLAT:??_R2?$SList@M@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$SList@M@@@8
_DATA	SEGMENT
??_R0?AV?$SList@M@@@8 DD FLAT:??_7type_info@@6B@	; SList<float> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$SList@M@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$SList@M@@6B@
rdata$r	SEGMENT
??_R4?$SList@M@@6B@ DD 00H				; SList<float>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$SList@M@@@8
	DD	FLAT:??_R3?$SList@M@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BL@KMDEJBPJ@SList?$DMfloat?$DO?3?3insertBefore?$AA@
CONST	SEGMENT
??_C@_0BL@KMDEJBPJ@SList?$DMfloat?$DO?3?3insertBefore?$AA@ DB 'SList<floa'
	DB	't>::insertBefore', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@BOIMIBNP@SList?$DMfloat?$DO?3?3Insert_After?$AA@
CONST	SEGMENT
??_C@_0BL@BOIMIBNP@SList?$DMfloat?$DO?3?3Insert_After?$AA@ DB 'SList<floa'
	DB	't>::Insert_After', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@MMBJJAJD@SList?$DMfloat?$DO?3?3Insert_Before?$AA@
CONST	SEGMENT
??_C@_0BM@MMBJJAJD@SList?$DMfloat?$DO?3?3Insert_Before?$AA@ DB 'SList<flo'
	DB	'at>::Insert_Before', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@HFNOCHEL@SList?$DMfloat?$DO?3?3Remove_All?$AA@
CONST	SEGMENT
??_C@_0BJ@HFNOCHEL@SList?$DMfloat?$DO?3?3Remove_All?$AA@ DB 'SList<float>'
	DB	'::Remove_All', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@CGKAMEOP@SList?$DMfloat?$DO?3?3Remove?$AA@
CONST	SEGMENT
??_C@_0BF@CGKAMEOP@SList?$DMfloat?$DO?3?3Remove?$AA@ DB 'SList<float>::Re'
	DB	'move', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@JICKFGDE@SList?$DMfloat?$DO?3?3Remove_Head?$AA@
CONST	SEGMENT
??_C@_0BK@JICKFGDE@SList?$DMfloat?$DO?3?3Remove_Head?$AA@ DB 'SList<float'
	DB	'>::Remove_Head', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@DHMHMMEJ@SList?$DMfloat?$DO?3?3Add_Tail?$AA@
CONST	SEGMENT
??_C@_0BH@DHMHMMEJ@SList?$DMfloat?$DO?3?3Add_Tail?$AA@ DB 'SList<float>::'
	DB	'Add_Tail', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@NLHPPKCN@SList?$DMfloat?$DO?3?3Add_Head?$AA@
CONST	SEGMENT
??_C@_0BH@NLHPPKCN@SList?$DMfloat?$DO?3?3Add_Head?$AA@ DB 'SList<float>::'
	DB	'Add_Head', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CN@PEIMBNJH@SList?$DMclass?5ScriptableGameObj?$DO?3?3@
CONST	SEGMENT
??_C@_0CN@PEIMBNJH@SList?$DMclass?5ScriptableGameObj?$DO?3?3@ DB 'SList<c'
	DB	'lass ScriptableGameObj>::insertBefore', 00H	; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BG@DDLIJLA@Get_Script_Parameters?$AA@
CONST	SEGMENT
??_C@_0BG@DDLIJLA@Get_Script_Parameters?$AA@ DB 'Get_Script_Parameters', 00H ; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z@4JA DD 02b2H ; `Get_Script_Parameters'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_01IHBHIGKO@?0?$AA@
CONST	SEGMENT
??_C@_01IHBHIGKO@?0?$AA@ DB ',', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@BFCJEGOL@Attach_Script_V?$AA@
CONST	SEGMENT
??_C@_0BA@BFCJEGOL@Attach_Script_V?$AA@ DB 'Attach_Script_V', 00H ; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z@4JA DD 0285H ; `Attach_Script_V'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_0BO@HDHFKGIM@Find_All_Vehicles_By_Distance?$AA@
CONST	SEGMENT
??_C@_0BO@HDHFKGIM@Find_All_Vehicles_By_Distance?$AA@ DB 'Find_All_Vehicl'
	DB	'es_By_Distance', 00H			; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA DD 0207H ; `Find_All_Vehicles_By_Distance'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
CONST	SEGMENT
??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@ DB 'x'
	DB	00H, ':', 00H, '\', 00H, 'g', 00H, 'i', 00H, 't', 00H, 'h', 00H
	DB	'u', 00H, 'b', 00H, '\', 00H, 'r', 00H, 'e', 00H, 'n', 00H, 'e'
	DB	00H, 'g', 00H, 'a', 00H, 'd', 00H, 'e', 00H, '\', 00H, 'd', 00H
	DB	'r', 00H, 'a', 00H, 'g', 00H, 'o', 00H, 'n', 00H, 'a', 00H, 'd'
	...
	DB	'e', 00H, '_', 00H, 's', 00H, 'c', 00H, 'r', 00H, 'i', 00H, 'p'
	DB	00H, 't', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@
CONST	SEGMENT
??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@ DB 'x:\github\re'
	DB	'negade\dragonade_rxd\scripts\engine_script.cpp', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CJ@KCIIGHPE@Find_All_Objects_With_Script_By_@
CONST	SEGMENT
??_C@_0CJ@KCIIGHPE@Find_All_Objects_With_Script_By_@ DB 'Find_All_Objects'
	DB	'_With_Script_By_Distance', 00H		; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?1??Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA DD 01dbH ; `Find_All_Objects_With_Script_By_Distance'::`2'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_7?$SList@M@@6B@
CONST	SEGMENT
??_7?$SList@M@@6B@ DD FLAT:??_R4?$SList@M@@6B@		; SList<float>::`vftable'
	DD	FLAT:??_E?$SList@M@@UAEPAXI@Z
	DD	FLAT:?Add_Head@?$SList@M@@UAE_NAAV1@@Z
	DD	FLAT:?Add_Head@?$SList@M@@UAE_NPAM@Z
	DD	FLAT:?Add_Tail@?$SList@M@@UAE_NAAV1@@Z
	DD	FLAT:?Add_Tail@?$SList@M@@UAE_NPAM@Z
	DD	FLAT:?Remove_Head@?$SList@M@@UAEPAMXZ
	DD	FLAT:?Remove_Tail@?$SList@M@@UAEPAMXZ
	DD	FLAT:?Remove@?$SList@M@@UAE_NPBM@Z
	DD	FLAT:?Remove_All@?$SList@M@@UAEXXZ
	DD	FLAT:?Insert_Before@?$SList@M@@UAE_NPAMPBM@Z
	DD	FLAT:?Insert_After@?$SList@M@@UAE_NPAMPBM@Z
	DD	FLAT:?Is_Empty@?$SList@M@@UBE_NXZ
	DD	FLAT:?Get_Count@?$SList@M@@UBEIXZ
CONST	ENDS
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
;	COMDAT ?Delete_All@?$DynamicVectorClass@VScriptParameter@@@@QAEXXZ
_TEXT	SEGMENT
_len$ = -8						; size = 4
_this$ = -4						; size = 4
?Delete_All@?$DynamicVectorClass@VScriptParameter@@@@QAEXXZ PROC ; DynamicVectorClass<ScriptParameter>::Delete_All, COMDAT
; _this$ = ecx
...
; 461  : 	}
	...
	pop	ebp
	ret	0
?Delete_All@?$DynamicVectorClass@VScriptParameter@@@@QAEXXZ ENDP ; DynamicVectorClass<ScriptParameter>::Delete_All
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
;	COMDAT ?Add@?$DynamicVectorClass@VScriptParameter@@@@QAE_NABVScriptParameter@@@Z
_TEXT	SEGMENT
tv149 = -72						; size = 4
_this$ = -4						; size = 4
_object$ = 8						; size = 4
?Add@?$DynamicVectorClass@VScriptParameter@@@@QAE_NABVScriptParameter@@@Z PROC ; DynamicVectorClass<ScriptParameter>::Add, COMDAT
; _this$ = ecx
...
; 319  : 		if (ActiveCount >= Length())
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Length@?$VectorClass@VScriptParameter@@@@QBEHXZ ; VectorClass<ScriptParameter>::Length
	mov	ecx, DWORD PTR _this$[ebp]
...
; 333  : 		(*this)[ActiveCount++] = object;
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??A?$VectorClass@VScriptParameter@@@@QAEAAVScriptParameter@@H@Z ; VectorClass<ScriptParameter>::operator[]
	mov	ecx, eax
	call	??4ScriptParameter@@QAEAAV0@ABV0@@Z
...
; 335  : 	}
	...
	pop	ebp
	ret	4
?Add@?$DynamicVectorClass@VScriptParameter@@@@QAE_NABVScriptParameter@@@Z ENDP ; DynamicVectorClass<ScriptParameter>::Add
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
;	COMDAT ?Length@?$VectorClass@VScriptParameter@@@@QBEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Length@?$VectorClass@VScriptParameter@@@@QBEHXZ PROC	; VectorClass<ScriptParameter>::Length, COMDAT
; _this$ = ecx
...
; 201  : 	}
	...
	pop	ebp
	ret	0
?Length@?$VectorClass@VScriptParameter@@@@QBEHXZ ENDP	; VectorClass<ScriptParameter>::Length
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
;	COMDAT ??A?$VectorClass@VScriptParameter@@@@QAEAAVScriptParameter@@H@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_index$ = 8						; size = 4
??A?$VectorClass@VScriptParameter@@@@QAEAAVScriptParameter@@H@Z PROC ; VectorClass<ScriptParameter>::operator[], COMDAT
; _this$ = ecx
...
; 124  : 	} 
	...
	pop	ebp
	ret	4
??A?$VectorClass@VScriptParameter@@@@QAEAAVScriptParameter@@H@Z ENDP ; VectorClass<ScriptParameter>::operator[]
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Get_Param_Type@@YAHPBD@Z
_TEXT	SEGMENT
_i$1 = -4						; size = 4
_str$ = 8						; size = 4
?Get_Param_Type@@YAHPBD@Z PROC				; Get_Param_Type, COMDAT
...
; 679  : 	for (int i = 0; i < PARAM_TYPE_COUNT; i++)

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN4@Get_Param_
$LN3@Get_Param_:
...
$LN4@Get_Param_:
	...
	jge	SHORT $LN2@Get_Param_

; 680  : 	{
; 681  : 		if (!lstrcmpiA(str, PARAM_TYPE_STRINGS[i]))

	mov	eax, DWORD PTR _i$1[ebp]
	mov	ecx, DWORD PTR _PARAM_TYPE_STRINGS[eax*4]
	push	ecx
	mov	edx, DWORD PTR _str$[ebp]
	push	edx
	call	DWORD PTR __imp__lstrcmpiA@8
	test	eax, eax
	jne	SHORT $LN1@Get_Param_

; 682  : 		{
; 683  : 			return i;

	mov	eax, DWORD PTR _i$1[ebp]
	jmp	SHORT $LN5@Get_Param_
$LN1@Get_Param_:

; 684  : 		}
; 685  : 	}

	jmp	SHORT $LN3@Get_Param_
$LN2@Get_Param_:
...
; 687  : }
	...
	pop	ebp
	ret	0
?Get_Param_Type@@YAHPBD@Z ENDP				; Get_Param_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ??0?$SLNode@VScriptableGameObj@@@@IAE@PAVScriptableGameObj@@PAV0@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_data$ = 8						; size = 4
_next$ = 12						; size = 4
??0?$SLNode@VScriptableGameObj@@@@IAE@PAVScriptableGameObj@@PAV0@@Z PROC ; SLNode<ScriptableGameObj>::SLNode<ScriptableGameObj>, COMDAT
; _this$ = ecx
...
; 70   : 	SLNode(T* data, SLNode<T>* next) : GenericSLNode(data, next) {}
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0GenericSLNode@@IAE@PAXPAV0@@Z	; GenericSLNode::GenericSLNode
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	8
??0?$SLNode@VScriptableGameObj@@@@IAE@PAVScriptableGameObj@@PAV0@@Z ENDP ; SLNode<ScriptableGameObj>::SLNode<ScriptableGameObj>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ??0?$SLNode@M@@IAE@PAMPAV0@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_data$ = 8						; size = 4
_next$ = 12						; size = 4
??0?$SLNode@M@@IAE@PAMPAV0@@Z PROC			; SLNode<float>::SLNode<float>, COMDAT
; _this$ = ecx
...
; 70   : 	SLNode(T* data, SLNode<T>* next) : GenericSLNode(data, next) {}
	...
	pop	ebp
	ret	8
??0?$SLNode@M@@IAE@PAMPAV0@@Z ENDP			; SLNode<float>::SLNode<float>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ??0?$SLNode@M@@IAE@PAM@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
??0?$SLNode@M@@IAE@PAM@Z PROC				; SLNode<float>::SLNode<float>, COMDAT
; _this$ = ecx
...
; 69   : 	SLNode(T *obj) : GenericSLNode(obj) {}
	...
	pop	ebp
	ret	4
??0?$SLNode@M@@IAE@PAM@Z ENDP				; SLNode<float>::SLNode<float>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Data@?$SLNode@M@@QBEPAMXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Data@?$SLNode@M@@QBEPAMXZ PROC				; SLNode<float>::Data, COMDAT
; _this$ = ecx
...
; 67   : 	}
	...
	pop	ebp
	ret	0
?Data@?$SLNode@M@@QBEPAMXZ ENDP				; SLNode<float>::Data
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Next@?$SLNode@M@@QBEPAV1@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Next@?$SLNode@M@@QBEPAV1@XZ PROC			; SLNode<float>::Next, COMDAT
; _this$ = ecx
...
; 63   : 	}
	...
	pop	ebp
	ret	0
?Next@?$SLNode@M@@QBEPAV1@XZ ENDP			; SLNode<float>::Next
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Set_Next@?$SLNode@M@@QAEXPAV1@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_n$ = 8							; size = 4
?Set_Next@?$SLNode@M@@QAEXPAV1@@Z PROC			; SLNode<float>::Set_Next, COMDAT
; _this$ = ecx
...
; 59   : 	}
	...
	pop	ebp
	ret	4
?Set_Next@?$SLNode@M@@QAEXPAV1@@Z ENDP			; SLNode<float>::Set_Next
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$SList@M@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$SList@M@@UAEPAXI@Z PROC				; SList<float>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1?$SList@M@@UAE@XZ			; SList<float>::~SList<float>
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$SList@M@@UAEPAXI@Z ENDP				; SList<float>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?insertBefore@?$SList@M@@QAEXPAMAAV?$SLNode@M@@@Z
_TEXT	SEGMENT
tv86 = -84						; size = 4
tv88 = -80						; size = 4
$T1 = -76						; size = 4
...
_data$ = 8						; size = 4
_node$ = 12						; size = 4
?insertBefore@?$SList@M@@QAEXPAMAAV?$SLNode@M@@@Z PROC	; SList<float>::insertBefore, COMDAT
; _this$ = ecx
...
; 334  : 		SLNode<T>* nextNode = new SLNode<T>(node.Data(), node.Next());
	...
	push	OFFSET ??_C@_0BL@KMDEJBPJ@SList?$DMfloat?$DO?3?3insertBefore?$AA@
	push	334					; 0000014eH
...
$LN7@insertBefo:
	...
	call	?Next@?$SLNode@M@@QBEPAV1@XZ		; SLNode<float>::Next
	push	eax
	mov	ecx, DWORD PTR _node$[ebp]
	call	?Data@?$SLNode@M@@QBEPAMXZ		; SLNode<float>::Data
	push	eax
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0?$SLNode@M@@IAE@PAMPAV0@@Z		; SLNode<float>::SLNode<float>
...
; 339  : 	}
	...
	pop	ebp
	ret	8
?insertBefore@?$SList@M@@QAEXPAMAAV?$SLNode@M@@@Z ENDP	; SList<float>::insertBefore
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ PROC		; SList<float>::Head, COMDAT
; _this$ = ecx
...
; 315  : 	}
	...
	pop	ebp
	ret	0
?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ ENDP		; SList<float>::Head
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Get_Count@?$SList@M@@UBEIXZ
_TEXT	SEGMENT
_node$1 = -12						; size = 4
_count$ = -8						; size = 4
_this$ = -4						; size = 4
?Get_Count@?$SList@M@@UBEIXZ PROC			; SList<float>::Get_Count, COMDAT
; _this$ = ecx
...
; 309  : 	}
	...
	pop	ebp
	ret	0
?Get_Count@?$SList@M@@UBEIXZ ENDP			; SList<float>::Get_Count
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Is_Empty@?$SList@M@@UBE_NXZ
_TEXT	SEGMENT
tv66 = -72						; size = 4
_this$ = -4						; size = 4
?Is_Empty@?$SList@M@@UBE_NXZ PROC			; SList<float>::Is_Empty, COMDAT
; _this$ = ecx
...
; 298  : 	}
	...
	pop	ebp
	ret	0
?Is_Empty@?$SList@M@@UBE_NXZ ENDP			; SList<float>::Is_Empty
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Insert_After@?$SList@M@@UAE_NPAMPBM@Z
_TEXT	SEGMENT
tv140 = -88						; size = 4
tv142 = -84						; size = 4
$T1 = -80						; size = 4
...
_newnode$ = 8						; size = 4
_oldnode$ = 12						; size = 4
?Insert_After@?$SList@M@@UAE_NPAMPBM@Z PROC		; SList<float>::Insert_After, COMDAT
; _this$ = ecx
...
; 286  : 			SLNode<T> *temp = new SLNode<T>(newnode);
	...
	push	OFFSET ??_C@_0BL@BOIMIBNP@SList?$DMfloat?$DO?3?3Insert_After?$AA@
	push	286					; 0000011eH
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN14@Insert_Aft:
	...
	push	eax
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0?$SLNode@M@@IAE@PAM@Z		; SLNode<float>::SLNode<float>
...
; 287  : 			temp->Set_Next(cur->Next());
	...
	call	?Set_Next@?$SLNode@M@@QAEXPAV1@@Z	; SLNode<float>::Set_Next
...
; 292  : 	}
	...
	pop	ebp
	ret	8
?Insert_After@?$SList@M@@UAE_NPAMPBM@Z ENDP		; SList<float>::Insert_After
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Insert_Before@?$SList@M@@UAE_NPAMPBM@Z
_TEXT	SEGMENT
tv145 = -88						; size = 4
tv147 = -84						; size = 4
$T1 = -80						; size = 4
...
_newnode$ = 8						; size = 4
_oldnode$ = 12						; size = 4
?Insert_Before@?$SList@M@@UAE_NPAMPBM@Z PROC		; SList<float>::Insert_Before, COMDAT
; _this$ = ecx
...
; 258  : 			SLNode<T> *temp	= new SLNode<T> (newnode);
	...
	push	OFFSET ??_C@_0BM@MMBJJAJD@SList?$DMfloat?$DO?3?3Insert_Before?$AA@
	push	258					; 00000102H
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 264  : 	}
	...
	pop	ebp
	ret	8
?Insert_Before@?$SList@M@@UAE_NPAMPBM@Z ENDP		; SList<float>::Insert_Before
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Remove_All@?$SList@M@@UAEXXZ
_TEXT	SEGMENT
$T1 = -80						; size = 4
_cur$2 = -12						; size = 4
_next$ = -8						; size = 4
_this$ = -4						; size = 4
?Remove_All@?$SList@M@@UAEXXZ PROC			; SList<float>::Remove_All, COMDAT
; _this$ = ecx
...
; 236  : 			delete cur;
	...
	push	OFFSET ??_C@_0BJ@HFNOCHEL@SList?$DMfloat?$DO?3?3Remove_All?$AA@
	push	236					; 000000ecH
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 239  : 	}
	...
	pop	ebp
	ret	0
?Remove_All@?$SList@M@@UAEXXZ ENDP			; SList<float>::Remove_All
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Remove@?$SList@M@@UAE_NPBM@Z
_TEXT	SEGMENT
tv76 = -81						; size = 1
$T1 = -80						; size = 4
_temp$2 = -12						; size = 4
...
_this$ = -4						; size = 4
_element$ = 8						; size = 4
?Remove@?$SList@M@@UAE_NPBM@Z PROC			; SList<float>::Remove, COMDAT
; _this$ = ecx
...
; 223  : 			delete temp;
	...
	push	OFFSET ??_C@_0BF@CGKAMEOP@SList?$DMfloat?$DO?3?3Remove?$AA@
	push	223					; 000000dfH
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 227  : 	}
	...
	pop	ebp
	ret	4
?Remove@?$SList@M@@UAE_NPBM@Z ENDP			; SList<float>::Remove
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Remove_Tail@?$SList@M@@UAEPAMXZ
_TEXT	SEGMENT
tv76 = -76						; size = 4
_data$ = -8						; size = 4
_this$ = -4						; size = 4
?Remove_Tail@?$SList@M@@UAEPAMXZ PROC			; SList<float>::Remove_Tail, COMDAT
; _this$ = ecx
...
; 198  : 	}
	...
	pop	ebp
	ret	0
?Remove_Tail@?$SList@M@@UAEPAMXZ ENDP			; SList<float>::Remove_Tail
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Remove_Head@?$SList@M@@UAEPAMXZ
_TEXT	SEGMENT
$T1 = -80						; size = 4
_data$ = -12						; size = 4
_temp$ = -8						; size = 4
_this$ = -4						; size = 4
?Remove_Head@?$SList@M@@UAEPAMXZ PROC			; SList<float>::Remove_Head, COMDAT
; _this$ = ecx
...
; 185  : 		delete temp;
	...
	push	OFFSET ??_C@_0BK@JICKFGDE@SList?$DMfloat?$DO?3?3Remove_Head?$AA@
	push	185					; 000000b9H
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 187  : 	}
	...
	pop	ebp
	ret	0
?Remove_Head@?$SList@M@@UAEPAMXZ ENDP			; SList<float>::Remove_Head
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Add_Tail@?$SList@M@@UAE_NAAV1@@Z
_TEXT	SEGMENT
_cur$1 = -8						; size = 4
_this$ = -4						; size = 4
_list$ = 8						; size = 4
?Add_Tail@?$SList@M@@UAE_NAAV1@@Z PROC			; SList<float>::Add_Tail, COMDAT
; _this$ = ecx
...
; 169  : 	}
	...
	pop	ebp
	ret	4
?Add_Tail@?$SList@M@@UAE_NAAV1@@Z ENDP			; SList<float>::Add_Tail
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Add_Tail@?$SList@M@@UAE_NPAM@Z
_TEXT	SEGMENT
tv82 = -84						; size = 4
tv84 = -80						; size = 4
$T1 = -76						; size = 4
...
_this$ = -4						; size = 4
_data$ = 8						; size = 4
?Add_Tail@?$SList@M@@UAE_NPAM@Z PROC			; SList<float>::Add_Tail, COMDAT
; _this$ = ecx
...
; 144  : 		SLNode<T> *temp = new SLNode<T> (data);
	...
	push	OFFSET ??_C@_0BH@DHMHMMEJ@SList?$DMfloat?$DO?3?3Add_Tail?$AA@
	push	144					; 00000090H
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 155  : 	}
	...
	pop	ebp
	ret	4
?Add_Tail@?$SList@M@@UAE_NPAM@Z ENDP			; SList<float>::Add_Tail
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Add_Head@?$SList@M@@UAE_NAAV1@@Z
_TEXT	SEGMENT
tv90 = -92						; size = 4
tv92 = -88						; size = 4
$T1 = -84						; size = 4
...
_this$ = -4						; size = 4
_list$ = 8						; size = 4
?Add_Head@?$SList@M@@UAE_NAAV1@@Z PROC			; SList<float>::Add_Head, COMDAT
; _this$ = ecx
...
; 123  : 				SLNode<T> *temp = new SLNode<T>(cur->Data());
	...
	push	OFFSET ??_C@_0BH@NLHPPKCN@SList?$DMfloat?$DO?3?3Add_Head?$AA@
	push	123					; 0000007bH
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
; 135  : 	}
	...
	pop	ebp
	ret	4
?Add_Head@?$SList@M@@UAE_NAAV1@@Z ENDP			; SList<float>::Add_Head
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Add_Head@?$SList@M@@UAE_NPAM@Z
_TEXT	SEGMENT
tv82 = -84						; size = 4
tv84 = -80						; size = 4
$T1 = -76						; size = 4
...
_this$ = -4						; size = 4
_data$ = 8						; size = 4
?Add_Head@?$SList@M@@UAE_NPAM@Z PROC			; SList<float>::Add_Head, COMDAT
; _this$ = ecx
...
; 109  : 	}
	...
	pop	ebp
	ret	4
?Add_Head@?$SList@M@@UAE_NPAM@Z ENDP			; SList<float>::Add_Head
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ??1?$SList@M@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$SList@M@@UAE@XZ PROC				; SList<float>::~SList<float>, COMDAT
; _this$ = ecx
...
; 90   : 	{
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$SList@M@@6B@

; 91   : 		Remove_All();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?Remove_All@?$SList@M@@UAEXXZ		; SList<float>::Remove_All
...
; 92   : 	}
	...
	pop	ebp
	ret	0
??1?$SList@M@@UAE@XZ ENDP				; SList<float>::~SList<float>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ??0?$SList@M@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0?$SList@M@@QAE@XZ PROC				; SList<float>::SList<float>, COMDAT
; _this$ = ecx
...
; 87   : 	}
	...
	pop	ebp
	ret	0
??0?$SList@M@@QAE@XZ ENDP				; SList<float>::SList<float>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?insertBefore@?$SList@VScriptableGameObj@@@@QAEXPAVScriptableGameObj@@AAV?$SLNode@VScriptableGameObj@@@@@Z
_TEXT	SEGMENT
tv86 = -84						; size = 4
tv88 = -80						; size = 4
$T1 = -76						; size = 4
...
_data$ = 8						; size = 4
_node$ = 12						; size = 4
?insertBefore@?$SList@VScriptableGameObj@@@@QAEXPAVScriptableGameObj@@AAV?$SLNode@VScriptableGameObj@@@@@Z PROC ; SList<ScriptableGameObj>::insertBefore, COMDAT
; _this$ = ecx
...
; 334  : 		SLNode<T>* nextNode = new SLNode<T>(node.Data(), node.Next());
	...
	push	OFFSET ??_C@_0CN@PEIMBNJH@SList?$DMclass?5ScriptableGameObj?$DO?3?3@
	push	334					; 0000014eH
	push	OFFSET ??_C@_0DB@DFBFLIIO@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN7@insertBefo:
	...
	push	eax
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0?$SLNode@VScriptableGameObj@@@@IAE@PAVScriptableGameObj@@PAV0@@Z ; SLNode<ScriptableGameObj>::SLNode<ScriptableGameObj>
	mov	DWORD PTR tv86[ebp], eax
	jmp	SHORT $LN6@insertBefo
$LN5@insertBefo:
	mov	DWORD PTR tv86[ebp], 0
...
; 339  : 	}
	...
	pop	ebp
	ret	8
?insertBefore@?$SList@VScriptableGameObj@@@@QAEXPAVScriptableGameObj@@AAV?$SLNode@VScriptableGameObj@@@@@Z ENDP ; SList<ScriptableGameObj>::insertBefore
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
;	COMDAT ??A?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEABQAVGameObjObserverClass@@H@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_index$ = 8						; size = 4
??A?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEABQAVGameObjObserverClass@@H@Z PROC ; SimpleDynVecClass<GameObjObserverClass *>::operator[], COMDAT
; _this$ = ecx
...
; 831  : 	}
	...
	pop	ebp
	ret	4
??A?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEABQAVGameObjObserverClass@@H@Z ENDP ; SimpleDynVecClass<GameObjObserverClass *>::operator[]
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
;	COMDAT ?Count@?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Count@?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEHXZ PROC ; SimpleDynVecClass<GameObjObserverClass *>::Count, COMDAT
; _this$ = ecx
...
; 823  : 	}
	...
	pop	ebp
	ret	0
?Count@?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEHXZ ENDP ; SimpleDynVecClass<GameObjObserverClass *>::Count
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptablegameobj.h
;	COMDAT ?Get_Observers@ScriptableGameObj@@QAEABV?$SimpleDynVecClass@PAVGameObjObserverClass@@@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Observers@ScriptableGameObj@@QAEABV?$SimpleDynVecClass@PAVGameObjObserverClass@@@@XZ PROC ; ScriptableGameObj::Get_Observers, COMDAT
; _this$ = ecx

; 53   : 	const SimpleDynVecClass<GameObjObserverClass *> & Get_Observers( void )	{ return Observers; }
	...
	pop	ebp
	ret	0
?Get_Observers@ScriptableGameObj@@QAEABV?$SimpleDynVecClass@PAVGameObjObserverClass@@@@XZ ENDP ; ScriptableGameObj::Get_Observers
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z
_TEXT	SEGMENT
$T1 = -104						; size = 4
_p$2 = -36						; size = 12
_value$3 = -24						; size = 4
...
?Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z PROC ; Get_Script_Parameters, COMDAT
...
; 691  : 	parameters.Delete_All();

	mov	ecx, DWORD PTR _parameters$[ebp]
	call	?Delete_All@?$DynamicVectorClass@VScriptParameter@@@@QAEXXZ ; DynamicVectorClass<ScriptParameter>::Delete_All

; 692  : 	auto factory = ScriptRegistrar::GetScriptFactory(script);

	mov	eax, DWORD PTR _script$[ebp]
	push	eax
	call	?GetScriptFactory@ScriptRegistrar@@SAPAVScriptFactory@@PBD@Z ; ScriptRegistrar::GetScriptFactory
	add	esp, 4
...
; 696  : 	}
; 697  : 	char* working = newstr(factory->GetParamDescription());
	...
	add	esp, 4
	mov	DWORD PTR _working$[ebp], eax

; 698  : 	char *param = strtok(working, ",");

	push	OFFSET ??_C@_01IHBHIGKO@?0?$AA@
	mov	eax, DWORD PTR _working$[ebp]
	push	eax
...
; 700  : 	{
; 701  : 		char *sname = param;

	mov	eax, DWORD PTR _param$[ebp]
	mov	DWORD PTR _sname$5[ebp], eax

; 702  : 		char *type = strchr(param, ':');
...
; 708  : 			value[0] = '\0';
	...
	mov	eax, 1
	imul	eax, 0
	mov	ecx, DWORD PTR _value$3[ebp]
	mov	BYTE PTR [ecx+eax], 0
...
; 710  : 		}
; 711  : 		ScriptParameter p;

	lea	ecx, DWORD PTR _p$2[ebp]
	call	??0ScriptParameter@@QAE@XZ

; 712  : 		p.name = sname;

	mov	eax, DWORD PTR _sname$5[ebp]
	push	eax
	lea	ecx, DWORD PTR _p$2[ebp]
...
; 713  : 		p.value = value;
	...
	mov	eax, DWORD PTR _value$3[ebp]
	push	eax
	lea	ecx, DWORD PTR _p$2[ebp+4]
	call	??4StringClass@@QAEABV0@PBD@Z		; StringClass::operator=

; 714  : 		p.type = Get_Param_Type(type);

	mov	eax, DWORD PTR _type$4[ebp]
	push	eax
	call	?Get_Param_Type@@YAHPBD@Z		; Get_Param_Type
	add	esp, 4
	mov	DWORD PTR _p$2[ebp+8], eax

; 715  : 		parameters.Add(p);

	lea	eax, DWORD PTR _p$2[ebp]
	push	eax
	mov	ecx, DWORD PTR _parameters$[ebp]
	call	?Add@?$DynamicVectorClass@VScriptParameter@@@@QAE_NABVScriptParameter@@@Z ; DynamicVectorClass<ScriptParameter>::Add

; 716  : 		param = strtok(nullptr, ",");
...
; 717  : 	}
	...
	lea	ecx, DWORD PTR _p$2[ebp]
	call	??1ScriptParameter@@QAE@XZ
	jmp	$LN3@Get_Script
$LN2@Get_Script:

; 718  : 	delete[] working;

	push	OFFSET ??_C@_0BG@DDLIJLA@Get_Script_Parameters?$AA@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z@4JA
	add	eax, 28					; 0000001cH
	push	eax
	push	OFFSET ??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN8@Get_Script
	xor	edx, edx
	jne	SHORT $LN7@Get_Script
	mov	eax, DWORD PTR ?__LINE__Var@?1??Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z@4JA
	add	eax, 28					; 0000001cH
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
	push	OFFSET ??_C@_1M@HLGKFCJM@?$AAf?$AAa?$AAl?$AAs?$AAe?$AA?$AA@
	call	DWORD PTR __imp___wassert
	add	esp, 12					; 0000000cH
$LN7@Get_Script:
	jmp	SHORT $LN5@Get_Script
$LN8@Get_Script:
	mov	edx, DWORD PTR _working$[ebp]
...
; 719  : }
	...
	pop	ebp
	ret	0
?Get_Script_Parameters@@YAXPBDAAV?$DynamicVectorClass@VScriptParameter@@@@@Z ENDP ; Get_Script_Parameters
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_EScriptParameter@@QAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_EScriptParameter@@QAEPAXI@Z PROC			; ScriptParameter::`vector deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	and	eax, 2
	je	SHORT $LN3@vector
	push	OFFSET ??1ScriptParameter@@QAE@XZ
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax-4]
	push	ecx
	push	12					; 0000000cH
...
$LN4@vector:
	...
	pop	ebp
	ret	4
??_EScriptParameter@@QAEPAXI@Z ENDP			; ScriptParameter::`vector deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??4ScriptParameter@@QAEAAV0@ABV0@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___that$ = 8						; size = 4
??4ScriptParameter@@QAEAAV0@ABV0@@Z PROC		; ScriptParameter::operator=, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	4
??4ScriptParameter@@QAEAAV0@ABV0@@Z ENDP		; ScriptParameter::operator=
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1ScriptParameter@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1ScriptParameter@@QAE@XZ PROC				; ScriptParameter::~ScriptParameter, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1ScriptParameter@@QAE@XZ ENDP				; ScriptParameter::~ScriptParameter
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0ScriptParameter@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0ScriptParameter@@QAE@XZ PROC				; ScriptParameter::ScriptParameter, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??0ScriptParameter@@QAE@XZ ENDP				; ScriptParameter::ScriptParameter
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Once_V@@YAXPAVScriptableGameObj@@PBD1ZZ
_TEXT	SEGMENT
_vargs$ = -4						; size = 4
_pObj$ = 8						; size = 4
_script$ = 12						; size = 4
_params$ = 16						; size = 4
?Attach_Script_Once_V@@YAXPAVScriptableGameObj@@PBD1ZZ PROC ; Attach_Script_Once_V, COMDAT
...
; 668  :   if ( !pObj || Is_Script_Attached(pObj,script))

	cmp	DWORD PTR _pObj$[ebp], 0
	je	SHORT $LN1@Attach_Scr
	mov	eax, DWORD PTR _script$[ebp]
	push	eax
...
; 669  :     return;
	...
	jmp	SHORT $LN3@Attach_Scr
$LN2@Attach_Scr:

; 670  : 
; 671  :   va_list vargs;
; 672  :   va_start ( vargs, params );

	lea	eax, DWORD PTR _params$[ebp+4]
	mov	DWORD PTR _vargs$[ebp], eax

; 673  :   Attach_Script_V(pObj,script,params,vargs);
	...
	push	eax
	call	?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z ; Attach_Script_V
	add	esp, 16					; 00000010H
...
; 675  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Once_V@@YAXPAVScriptableGameObj@@PBD1ZZ ENDP ; Attach_Script_Once_V
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z
_TEXT	SEGMENT
tv82 = -84						; size = 4
$T1 = -80						; size = 4
$T2 = -76						; size = 4
_formattedParams$ = -8					; size = 4
_length$ = -4						; size = 4
_pObj$ = 8						; size = 4
_script$ = 12						; size = 4
_params$ = 16						; size = 4
_vargs$ = 20						; size = 4
?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z PROC ; Attach_Script_V, COMDAT
...
; 648  : 
; 649  :   int length = _vscprintf_p(params,vargs);

	mov	eax, DWORD PTR _vargs$[ebp]
	push	eax
	mov	ecx, DWORD PTR _params$[ebp]
	push	ecx
	call	DWORD PTR __imp___vscprintf_p
	add	esp, 8
	mov	DWORD PTR _length$[ebp], eax

; 650  :   char* formattedParams = new char[length+1];

	push	OFFSET ??_C@_0BA@BFCJEGOL@Attach_Script_V?$AA@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z@4JA
	add	eax, 5
	push	eax
	push	OFFSET ??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN5@Attach_Scr
	xor	edx, edx
	jne	SHORT $LN4@Attach_Scr
	mov	eax, DWORD PTR ?__LINE__Var@?1??Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z@4JA
	add	eax, 5
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
$LN6@Attach_Scr:
	mov	ecx, DWORD PTR tv82[ebp]
	mov	DWORD PTR _formattedParams$[ebp], ecx

; 651  :   _vsnprintf_s(formattedParams, length+1, length, params, vargs);
	...
	add	eax, 1
	push	eax
	mov	ecx, DWORD PTR _formattedParams$[ebp]
	push	ecx
	call	DWORD PTR __imp___vsnprintf_s
	add	esp, 20					; 00000014H

; 652  : 
; 653  :   Commands->Attach_Script(pObj, script, formattedParams);

	mov	eax, DWORD PTR _formattedParams$[ebp]
	push	eax
...
; 655  :   delete[] formattedParams;
	...
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN8@Attach_Scr
	xor	edx, edx
	jne	SHORT $LN7@Attach_Scr
	mov	eax, DWORD PTR ?__LINE__Var@?1??Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z@4JA
	add	eax, 10					; 0000000aH
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
	...
	add	esp, 12					; 0000000cH
$LN7@Attach_Scr:
	jmp	SHORT $LN2@Attach_Scr
$LN8@Attach_Scr:
	mov	edx, DWORD PTR _formattedParams$[ebp]
...
; 656  : }
	...
	pop	ebp
	ret	0
?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1PAD@Z ENDP ; Attach_Script_V
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1ZZ
_TEXT	SEGMENT
_vargs$ = -4						; size = 4
_pObj$ = 8						; size = 4
_script$ = 12						; size = 4
_params$ = 16						; size = 4
?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1ZZ PROC	; Attach_Script_V, COMDAT
...
; 660  :   va_list vargs;
; 661  :   va_start ( vargs, params );

	lea	eax, DWORD PTR _params$[ebp+4]
	mov	DWORD PTR _vargs$[ebp], eax

; 662  :   Attach_Script_V(pObj,script,params,vargs);
...
; 664  : }
	...
	pop	ebp
	ret	0
?Attach_Script_V@@YAXPAVScriptableGameObj@@PBD1ZZ ENDP	; Attach_Script_V
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Occupants@@YAXPAVScriptableGameObj@@PBD1@Z
_TEXT	SEGMENT
_i$1 = -12						; size = 4
_x$ = -8						; size = 4
_o$ = -4						; size = 4
...
_script$ = 12						; size = 4
_params$ = 16						; size = 4
?Attach_Script_Occupants@@YAXPAVScriptableGameObj@@PBD1@Z PROC ; Attach_Script_Occupants, COMDAT
...
; 628  : 	if (!obj || !obj->As_VehicleGameObj())
	...
	call	eax
	test	eax, eax
	jne	SHORT $LN6@Attach_Scr
$LN5@Attach_Scr:

; 629  : 	{
; 630  : 		return;

	jmp	SHORT $LN7@Attach_Scr
$LN6@Attach_Scr:

; 631  : 	}
; 632  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 633  : 	int x = o->Get_Definition().Get_Seat_Count();
...
$LN4@Attach_Scr:
	...
	jge	SHORT $LN7@Attach_Scr

; 635  : 	{
; 636  : 		if (o->Get_Occupant(i))
...
; 637  : 		{
; 638  : 			Commands->Attach_Script(o->Get_Occupant(i),script,params);
...
; 641  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Occupants@@YAXPAVScriptableGameObj@@PBD1@Z ENDP ; Attach_Script_Occupants
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_Script_On_Object@@YAPAVScriptImpClass@@PAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
_obj$ = 8						; size = 4
_script$ = 12						; size = 4
?Find_Script_On_Object@@YAPAVScriptImpClass@@PAVScriptableGameObj@@PBD@Z PROC ; Find_Script_On_Object, COMDAT
...
; 619  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN1@Find_Scrip

; 620  : 	{
; 621  : 		return NULL;

	xor	eax, eax
	jmp	SHORT $LN2@Find_Scrip
$LN1@Find_Scrip:

; 622  : 	}
; 623  : 	return (ScriptImpClass *)obj->Find_Observer(script);

	mov	eax, DWORD PTR _script$[ebp]
	push	eax
	mov	ecx, DWORD PTR _obj$[ebp]
	call	?Find_Observer@ScriptableGameObj@@QAEPAVGameObjObserverClass@@PBD@Z ; ScriptableGameObj::Find_Observer
$LN2@Find_Scrip:
...
; 624  : }
	...
	pop	ebp
	ret	0
?Find_Script_On_Object@@YAPAVScriptImpClass@@PAVScriptableGameObj@@PBD@Z ENDP ; Find_Script_On_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Send_Custom_Event_To_Objects_With_Script_Ranged@@YAXPAVScriptableGameObj@@PBDHHMM@Z
_TEXT	SEGMENT
tv171 = -104						; size = 4
$T1 = -100						; size = 12
$T2 = -88						; size = 12
...
_delay$ = 24						; size = 4
_range$ = 28						; size = 4
?Send_Custom_Event_To_Objects_With_Script_Ranged@@YAXPAVScriptableGameObj@@PBDHHMM@Z PROC ; Send_Custom_Event_To_Objects_With_Script_Ranged, COMDAT
...
; 594  : 	}
; 595  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 600  : 		if (o)
	...
	je	SHORT $LN3@Send_Custo

; 601  : 		{
; 602  : 			o2 = o->As_ScriptableGameObj();
...
; 605  : 		{
; 606  : 			if ( Is_Script_Attached( o2, script )
; 607  : 				&& Commands->Get_ID ( sender ) != Commands->Get_ID ( o2 )
; 608  : 				&& Vector3::Distance_Squared ( Commands->Get_Position ( sender ), Commands->Get_Position ( o2 ) ) <= range * range )

	mov	eax, DWORD PTR _script$[ebp]
	push	eax
	mov	ecx, DWORD PTR _o2$3[ebp]
	push	ecx
	call	?Is_Script_Attached@@YA_NPAVScriptableGameObj@@PBD@Z ; Is_Script_Attached
	add	esp, 8
	movzx	edx, al
	...
	jb	SHORT $LN1@Send_Custo

; 609  : 			{
; 610  : 				Commands->Send_Custom_Event(sender,o2,message,param,delay);
...
; 615  : }
	...
	pop	ebp
	ret	0
?Send_Custom_Event_To_Objects_With_Script_Ranged@@YAXPAVScriptableGameObj@@PBDHHMM@Z ENDP ; Send_Custom_Event_To_Objects_With_Script_Ranged
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Send_Custom_Event_To_Objects_With_Script@@YAXPAVScriptableGameObj@@PBDHHM@Z
_TEXT	SEGMENT
_o2$1 = -12						; size = 4
_o$2 = -8						; size = 4
_x$ = -4						; size = 4
...
_param$ = 20						; size = 4
_delay$ = 24						; size = 4
?Send_Custom_Event_To_Objects_With_Script@@YAXPAVScriptableGameObj@@PBDHHM@Z PROC ; Send_Custom_Event_To_Objects_With_Script, COMDAT
...
; 567  : 	}
; 568  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 570  : 	{
; 571  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$2[ebp], eax

; 572  : 		ScriptableGameObj *o2 = 0;
...
; 578  : 		{
; 579  : 			if ( Is_Script_Attached( o2, script )
; 580  : 				&& Commands->Get_ID ( sender ) != Commands->Get_ID ( o2 ) )

	mov	eax, DWORD PTR _script$[ebp]
	push	eax
	mov	ecx, DWORD PTR _o2$1[ebp]
	push	ecx
	call	?Is_Script_Attached@@YA_NPAVScriptableGameObj@@PBD@Z ; Is_Script_Attached
	add	esp, 8
	movzx	edx, al
...
; 581  : 			{
; 582  : 				Commands->Send_Custom_Event(sender,o2,message,param,delay);
...
; 587  : }
	...
	pop	ebp
	ret	0
?Send_Custom_Event_To_Objects_With_Script@@YAXPAVScriptableGameObj@@PBDHHM@Z ENDP ; Send_Custom_Event_To_Objects_With_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z
_TEXT	SEGMENT
tv85 = -128						; size = 4
tv141 = -124						; size = 4
tv80 = -124						; size = 4
...
_o$5 = -32						; size = 4
_d$6 = -28						; size = 4
_distance$7 = -24					; size = 4
_obj$8 = -20						; size = 4
_objNode$9 = -16					; size = 4
_distances$ = -12					; size = 12
_objects$ = 8						; size = 4
_position$ = 12						; size = 12
?Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z PROC ; Find_All_Vehicles_By_Distance, COMDAT
...
; 521  : 
; 522  :   // Internal list of distances, in the same order as GameObjects in objects
; 523  :   SList<float> distances;

	lea	ecx, DWORD PTR _distances$[ebp]
	call	??0?$SList@M@@QAE@XZ			; SList<float>::SList<float>

; 524  : 
; 525  :   for ( SLNode<BaseGameObj>* objNode = GameObjManager::GameObjList.Head(); objNode != NULL; objNode = objNode->Next() )

	mov	ecx, DWORD PTR ?GameObjList@GameObjManager@@2AAV?$SList@VBaseGameObj@@@@A ; GameObjManager::GameObjList
	call	?Head@?$SList@VBaseGameObj@@@@QBEPAV?$SLNode@VBaseGameObj@@@@XZ ; SList<BaseGameObj>::Head
	mov	DWORD PTR _objNode$9[ebp], eax
	jmp	SHORT $LN12@Find_All_V
$LN11@Find_All_V:
	mov	ecx, DWORD PTR _objNode$9[ebp]
	call	?Next@?$SLNode@VBaseGameObj@@@@QBEPAV1@XZ ; SLNode<BaseGameObj>::Next
	mov	DWORD PTR _objNode$9[ebp], eax
$LN12@Find_All_V:
	cmp	DWORD PTR _objNode$9[ebp], 0
	je	$LN10@Find_All_V

; 526  :   {
; 527  :     ScriptableGameObj* obj = (objNode->Data()) ? objNode->Data()->As_ScriptableGameObj() : NULL;

	mov	ecx, DWORD PTR _objNode$9[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	test	eax, eax
	je	SHORT $LN15@Find_All_V
	mov	ecx, DWORD PTR _objNode$9[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	...
	jmp	SHORT $LN16@Find_All_V
$LN15@Find_All_V:
	mov	DWORD PTR tv85[ebp], 0
$LN16@Find_All_V:
	mov	ecx, DWORD PTR tv85[ebp]
	mov	DWORD PTR _obj$8[ebp], ecx

; 528  : 	if ( obj && obj->As_VehicleGameObj() )

	cmp	DWORD PTR _obj$8[ebp], 0
	je	$LN4@Find_All_V
	mov	eax, DWORD PTR _obj$8[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$8[ebp]
	mov	eax, DWORD PTR [edx+40]
	call	eax
	test	eax, eax
	je	$LN4@Find_All_V
...
; 529  :     {
; 530  :       // SList cannot contain non-pointer types... stupid thing!
; 531  :       float* distance = new float;

	push	OFFSET ??_C@_0BO@HDHFKGIM@Find_All_Vehicles_By_Distance?$AA@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
	add	eax, 12					; 0000000cH
	push	eax
	push	OFFSET ??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN18@Find_All_V
	xor	edx, edx
	jne	SHORT $LN17@Find_All_V
	mov	eax, DWORD PTR ?__LINE__Var@?1??Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
	add	eax, 12					; 0000000cH
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
$LN19@Find_All_V:
	...
	mov	DWORD PTR _distance$7[ebp], eax

; 532  :       *distance = Commands->Get_Distance(Commands->Get_Position(obj), position);
	...
	call	eax
	add	esp, 8
	mov	ecx, DWORD PTR _distance$7[ebp]
	fstp	DWORD PTR [ecx]

; 533  : 
; 534  :       SLNode<float>* d = distances.Head();

	lea	ecx, DWORD PTR _distances$[ebp]
	call	?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ	; SList<float>::Head
	mov	DWORD PTR _d$6[ebp], eax

; 535  :       for ( SLNode<GameObject>* o = objects.Head();
...
; 536  :         d != NULL;
	...
	jmp	SHORT $LN8@Find_All_V
$LN7@Find_All_V:

; 537  :         d = d->Next(), o = o->Next() )
	...
	mov	DWORD PTR _o$5[ebp], eax
$LN8@Find_All_V:
	cmp	DWORD PTR _d$6[ebp], 0
	je	SHORT $LN6@Find_All_V

; 538  :       {
; 539  :         if ( *distance < *d->Data() )
	...
	movss	xmm0, DWORD PTR [eax]
	comiss	xmm0, DWORD PTR [ecx]
	jbe	SHORT $LN5@Find_All_V

; 540  :         {
; 541  :           objects.insertBefore(obj, *o);
	...
	push	ecx
	mov	ecx, DWORD PTR _objects$[ebp]
	call	?insertBefore@?$SList@VScriptableGameObj@@@@QAEXPAVScriptableGameObj@@AAV?$SLNode@VScriptableGameObj@@@@@Z ; SList<ScriptableGameObj>::insertBefore

; 542  :           distances.insertBefore(distance, *d);

	mov	eax, DWORD PTR _d$6[ebp]
	push	eax
	mov	ecx, DWORD PTR _distance$7[ebp]
	push	ecx
	lea	ecx, DWORD PTR _distances$[ebp]
	call	?insertBefore@?$SList@M@@QAEXPAMAAV?$SLNode@M@@@Z ; SList<float>::insertBefore

; 543  :           distance = NULL;

	mov	DWORD PTR _distance$7[ebp], 0

; 544  :           break;

	jmp	SHORT $LN6@Find_All_V
$LN5@Find_All_V:

; 545  :         }
; 546  :       }

	jmp	SHORT $LN7@Find_All_V
$LN6@Find_All_V:

; 547  : 
; 548  :       // OK, all existing objects are closer than this one so add it to the end of the list
; 549  :       if ( distance != NULL )

	cmp	DWORD PTR _distance$7[ebp], 0
	je	SHORT $LN4@Find_All_V

; 550  :       {
; 551  :         objects.Add_Tail(obj);
...
; 552  :         distances.Add_Tail(distance);

	mov	eax, DWORD PTR _distance$7[ebp]
	push	eax
	lea	ecx, DWORD PTR _distances$[ebp]
	call	?Add_Tail@?$SList@M@@UAE_NPAM@Z		; SList<float>::Add_Tail
$LN4@Find_All_V:
...
; 556  : 
; 557  :   // Clean up memory since SList insists on having heap objects...
; 558  :   for ( SLNode<float>* d = distances.Head(); d != NULL; d = d->Next() )

	lea	ecx, DWORD PTR _distances$[ebp]
	call	?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ	; SList<float>::Head
	mov	DWORD PTR _d$4[ebp], eax
	jmp	SHORT $LN3@Find_All_V
$LN2@Find_All_V:
...
; 559  :     delete d->Data();
	...
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN21@Find_All_V
	xor	edx, edx
	jne	SHORT $LN20@Find_All_V
	mov	eax, DWORD PTR ?__LINE__Var@?1??Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
	add	eax, 40					; 00000028H
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
; 560  : }
	...
	pop	ebp
	ret	0
?Find_All_Vehicles_By_Distance@@YAXAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z ENDP ; Find_All_Vehicles_By_Distance
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z
_TEXT	SEGMENT
tv85 = -128						; size = 4
tv137 = -124						; size = 4
tv80 = -124						; size = 4
...
?Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z PROC ; Find_All_Objects_With_Script_By_Distance, COMDAT
...
; 477  : 
; 478  :   // Internal list of distances, in the same order as GameObjects in objects
; 479  :   SList<float> distances;

	lea	ecx, DWORD PTR _distances$[ebp]
	call	??0?$SList@M@@QAE@XZ			; SList<float>::SList<float>

; 480  : 
; 481  :   for ( SLNode<BaseGameObj>* objNode = GameObjManager::GameObjList.Head(); objNode != NULL; objNode = objNode->Next() )

	mov	ecx, DWORD PTR ?GameObjList@GameObjManager@@2AAV?$SList@VBaseGameObj@@@@A ; GameObjManager::GameObjList
	call	?Head@?$SList@VBaseGameObj@@@@QBEPAV?$SLNode@VBaseGameObj@@@@XZ ; SList<BaseGameObj>::Head
	mov	DWORD PTR _objNode$9[ebp], eax
	jmp	SHORT $LN12@Find_All_O
$LN11@Find_All_O:
	mov	ecx, DWORD PTR _objNode$9[ebp]
	call	?Next@?$SLNode@VBaseGameObj@@@@QBEPAV1@XZ ; SLNode<BaseGameObj>::Next
	mov	DWORD PTR _objNode$9[ebp], eax
...
; 482  :   {
; 483  :     ScriptableGameObj* obj = (objNode->Data()) ? objNode->Data()->As_ScriptableGameObj() : NULL;

	mov	ecx, DWORD PTR _objNode$9[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	test	eax, eax
	je	SHORT $LN15@Find_All_O
	mov	ecx, DWORD PTR _objNode$9[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR tv80[ebp], eax
	mov	eax, DWORD PTR tv80[ebp]
...
; 484  :     if ( obj && Is_Script_Attached(obj,script) )
...
; 485  :     {
; 486  :       // SList cannot contain non-pointer types... stupid thing!
; 487  :       float* distance = new float;

	push	OFFSET ??_C@_0CJ@KCIIGHPE@Find_All_Objects_With_Script_By_@
	mov	eax, DWORD PTR ?__LINE__Var@?1??Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
	add	eax, 12					; 0000000cH
	push	eax
	push	OFFSET ??_C@_0DL@KAJKABMB@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN18@Find_All_O
	xor	edx, edx
	jne	SHORT $LN17@Find_All_O
	mov	eax, DWORD PTR ?__LINE__Var@?1??Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
	add	eax, 12					; 0000000cH
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
; 488  :       *distance = Commands->Get_Distance(Commands->Get_Position(obj), position);
...
; 489  : 
; 490  :       SLNode<float>* d = distances.Head();

	lea	ecx, DWORD PTR _distances$[ebp]
	call	?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ	; SList<float>::Head
	mov	DWORD PTR _d$6[ebp], eax

; 491  :       for ( SLNode<GameObject>* o = objects.Head();
...
; 492  :         d != NULL;
	...
	jmp	SHORT $LN8@Find_All_O
$LN7@Find_All_O:

; 493  :         d = d->Next(), o = o->Next() )
...
$LN8@Find_All_O:
	cmp	DWORD PTR _d$6[ebp], 0
	je	SHORT $LN6@Find_All_O

; 494  :       {
; 495  :         if ( *distance < *d->Data() )
	...
	movss	xmm0, DWORD PTR [eax]
	comiss	xmm0, DWORD PTR [ecx]
	jbe	SHORT $LN5@Find_All_O

; 496  :         {
; 497  :           objects.insertBefore(obj, *o);
...
; 498  :           distances.insertBefore(distance, *d);
...
; 500  :           break;
	...
	jmp	SHORT $LN6@Find_All_O
$LN5@Find_All_O:

; 501  :         }
; 502  :       }

	jmp	SHORT $LN7@Find_All_O
$LN6@Find_All_O:

; 503  : 
; 504  :       // OK, all existing objects are closer than this one so add it to the end of the list
; 505  :       if ( distance != NULL )

	cmp	DWORD PTR _distance$7[ebp], 0
	je	SHORT $LN4@Find_All_O

; 506  :       {
; 507  :         objects.Add_Tail(obj);
...
; 508  :         distances.Add_Tail(distance);
...
; 512  : 
; 513  :   // Clean up memory since SList insists on having heap objects...
; 514  :   for ( SLNode<float>* d = distances.Head(); d != NULL; d = d->Next() )

	lea	ecx, DWORD PTR _distances$[ebp]
	call	?Head@?$SList@M@@QBEPAV?$SLNode@M@@XZ	; SList<float>::Head
	mov	DWORD PTR _d$4[ebp], eax
	jmp	SHORT $LN3@Find_All_O
$LN2@Find_All_O:
	mov	ecx, DWORD PTR _d$4[ebp]
	call	?Next@?$SLNode@M@@QBEPAV1@XZ		; SLNode<float>::Next
	mov	DWORD PTR _d$4[ebp], eax
...
; 515  :     delete d->Data();
	...
	add	esp, 12					; 0000000cH
	xor	ecx, ecx
	je	SHORT $LN21@Find_All_O
	xor	edx, edx
	jne	SHORT $LN20@Find_All_O
	mov	eax, DWORD PTR ?__LINE__Var@?1??Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z@4JA
	add	eax, 40					; 00000028H
	push	eax
	push	OFFSET ??_C@_1HG@PIHNJNKI@?$AAx?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAh?$AAu?$AAb?$AA?2?$AAr?$AAe?$AAn?$AAe?$AAg?$AAa?$AAd?$AAe?$AA?2?$AAd?$AAr?$AAa?$AAg?$AAo?$AAn?$AAa?$AAd?$AAe?$AA_?$AAr?$AAx?$AAd@
...
; 516  : }
	...
	pop	ebp
	ret	0
?Find_All_Objects_With_Script_By_Distance@@YAXPBDAAV?$SList@VScriptableGameObj@@@@VVector3@@@Z ENDP ; Find_All_Objects_With_Script_By_Distance
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_All_Objects_With_Script@@YAXPBDAAV?$SList@VScriptableGameObj@@@@@Z
_TEXT	SEGMENT
_o2$1 = -12						; size = 4
_o$2 = -8						; size = 4
_x$ = -4						; size = 4
_script$ = 8						; size = 4
_objects$ = 12						; size = 4
?Find_All_Objects_With_Script@@YAXPBDAAV?$SList@VScriptableGameObj@@@@@Z PROC ; Find_All_Objects_With_Script, COMDAT
...
; 453  : 
; 454  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 456  : 	{
; 457  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$2[ebp], eax

; 458  : 		ScriptableGameObj *o2 = 0;
...
; 459  : 		if (o)
	...
	cmp	DWORD PTR _o$2[ebp], 0
	je	SHORT $LN3@Find_All_O

; 460  : 		{
; 461  : 			o2 = o->As_ScriptableGameObj();
...
; 463  : 		if (o2)
	...
	cmp	DWORD PTR _o2$1[ebp], 0
	je	SHORT $LN2@Find_All_O

; 464  : 		{
; 465  : 			if (Is_Script_Attached(o2, script))
...
; 472  : }
	...
	pop	ebp
	ret	0
?Find_All_Objects_With_Script@@YAXPBDAAV?$SList@VScriptableGameObj@@@@@Z ENDP ; Find_All_Objects_With_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_Closest_Object_With_Script@@YAPAVScriptableGameObj@@PBDVVector3@@@Z
_TEXT	SEGMENT
$T1 = -100						; size = 12
_dist$2 = -24						; size = 4
_o2$3 = -20						; size = 4
...
_x$ = -12						; size = 4
_closest$ = -8						; size = 4
_closestdist$ = -4					; size = 4
_script$ = 8						; size = 4
_pos$ = 12						; size = 12
?Find_Closest_Object_With_Script@@YAPAVScriptableGameObj@@PBDVVector3@@@Z PROC ; Find_Closest_Object_With_Script, COMDAT
...
; 422  : 	float closestdist = FLT_MAX;

	movss	xmm0, DWORD PTR __real@7f7fffff
	movss	DWORD PTR _closestdist$[ebp], xmm0

; 423  : 	GameObject *closest = NULL;

	mov	DWORD PTR _closest$[ebp], 0

; 424  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 426  : 	{
; 427  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$4[ebp], eax

; 428  : 		ScriptableGameObj *o2 = 0;
...
; 429  : 		if (o)
	...
	cmp	DWORD PTR _o$4[ebp], 0
	je	SHORT $LN4@Find_Close

; 430  : 		{
; 431  : 			o2 = o->As_ScriptableGameObj();
...
; 433  : 		if (o2)
	...
	cmp	DWORD PTR _o2$3[ebp], 0
	je	SHORT $LN1@Find_Close

; 434  : 		{
; 435  : 			if (Is_Script_Attached(o2, script))
...
; 436  : 			{
; 437  : 				float dist = Vector3::Distance_Squared(Commands->Get_Position(o2), pos);
...
; 448  : }
	...
	pop	ebp
	ret	0
?Find_Closest_Object_With_Script@@YAPAVScriptableGameObj@@PBDVVector3@@@Z ENDP ; Find_Closest_Object_With_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_Object_With_Script@@YAPAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
_o2$1 = -12						; size = 4
_o$2 = -8						; size = 4
_x$ = -4						; size = 4
_script$ = 8						; size = 4
?Find_Object_With_Script@@YAPAVScriptableGameObj@@PBD@Z PROC ; Find_Object_With_Script, COMDAT
...
; 399  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 400  : 	while (x)
	...
	cmp	DWORD PTR _x$[ebp], 0
	je	SHORT $LN4@Find_Objec

; 401  : 	{
; 402  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$2[ebp], eax

; 403  : 		ScriptableGameObj *o2 = 0;
...
; 404  : 		if (o)
	...
	cmp	DWORD PTR _o$2[ebp], 0
	je	SHORT $LN3@Find_Objec

; 405  : 		{
; 406  : 			o2 = o->As_ScriptableGameObj();
...
; 408  : 		if (o2)
	...
	cmp	DWORD PTR _o2$1[ebp], 0
	je	SHORT $LN2@Find_Objec

; 409  : 		{
; 410  : 			if (Is_Script_Attached(o2, script))
...
; 418  : }
	...
	pop	ebp
	ret	0
?Find_Object_With_Script@@YAPAVScriptableGameObj@@PBD@Z ENDP ; Find_Object_With_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Find_Building_With_Script@@YAPAVScriptableGameObj@@HHPBDPAV1@@Z
_TEXT	SEGMENT
_o$1 = -8						; size = 4
_x$ = -4						; size = 4
_Team$ = 8						; size = 4
...
_Script$ = 16						; size = 4
_Caller$ = 20						; size = 4
?Find_Building_With_Script@@YAPAVScriptableGameObj@@HHPBDPAV1@@Z PROC ; Find_Building_With_Script, COMDAT
...
; 381  : 	SLNode<BuildingGameObj> *x = GameObjManager::BuildingGameObjList.Head();
...
; 386  : 		{
; 387  : 			if ((Type == -1 || Building_Type(o) == Type) && (Get_Object_Type(o) == Team || Team == 2) && !Is_Building_Dead(o) && Is_Script_Attached(o,Script) && o != Caller)

	cmp	DWORD PTR _Type$[ebp], -1
	je	SHORT $LN2@Find_Build
	mov	eax, DWORD PTR _o$1[ebp]
	push	eax
	call	?Building_Type@@YAHPAVScriptableGameObj@@@Z ; Building_Type
	add	esp, 4
...
; 395  : }
	...
	pop	ebp
	ret	0
?Find_Building_With_Script@@YAPAVScriptableGameObj@@HHPBDPAV1@@Z ENDP ; Find_Building_With_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_All_Turrets_Team@@YAXHPBD0_N@Z
_TEXT	SEGMENT
_o$1 = -8						; size = 4
_x$ = -4						; size = 4
_Team$ = 8						; size = 4
...
_Params$ = 16						; size = 4
_Once$ = 20						; size = 1
?Attach_Script_All_Turrets_Team@@YAXHPBD0_N@Z PROC	; Attach_Script_All_Turrets_Team, COMDAT
...
; 360  : 	SLNode<VehicleGameObj> *x = GameObjManager::VehicleGameObjList.Head();
...
; 361  : 	while (x)
	...
	cmp	DWORD PTR _x$[ebp], 0
	je	SHORT $LN7@Attach_Scr

; 362  : 	{
; 363  : 		VehicleGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VVehicleGameObj@@@@QBEPAVVehicleGameObj@@XZ ; SLNode<VehicleGameObj>::Data
	mov	DWORD PTR _o$1[ebp], eax

; 364  : 		if (Get_Vehicle_Mode(o) == VEHICLE_TYPE_TURRET && (Get_Object_Type(o) == Team || Team == 2))
...
; 366  : 			if (Once)
	...
	movzx	eax, BYTE PTR _Once$[ebp]
	test	eax, eax
	je	SHORT $LN2@Attach_Scr

; 367  : 			{
; 368  : 				Attach_Script_Once(o,Script,Params);
...
; 371  : 			{
; 372  : 				Commands->Attach_Script(o,Script,Params);
...
; 377  : }
	...
	pop	ebp
	ret	0
?Attach_Script_All_Turrets_Team@@YAXHPBD0_N@Z ENDP	; Attach_Script_All_Turrets_Team
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_All_Buildings_Team@@YAXHPBD0_N@Z
_TEXT	SEGMENT
_o$1 = -8						; size = 4
_x$ = -4						; size = 4
_Team$ = 8						; size = 4
...
_Params$ = 16						; size = 4
_Once$ = 20						; size = 1
?Attach_Script_All_Buildings_Team@@YAXHPBD0_N@Z PROC	; Attach_Script_All_Buildings_Team, COMDAT
...
; 341  : 		{
; 342  : 			if (Get_Object_Type(o) == Team || Team == 2)
...
; 345  : 				{
; 346  : 					Attach_Script_Once(o,Script,Params);
...
; 348  : 				else
	...
	jmp	SHORT $LN5@Attach_Scr
$LN2@Attach_Scr:

; 349  : 				{
; 350  : 					Commands->Attach_Script(o,Script,Params);
...
; 356  : }
	...
	pop	ebp
	ret	0
?Attach_Script_All_Buildings_Team@@YAXHPBD0_N@Z ENDP	; Attach_Script_All_Buildings_Team
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Remove_Duplicate_Script@@YAXPAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
tv78 = -80						; size = 4
_i$1 = -12						; size = 4
_Found$ = -5						; size = 1
...
_obj$ = 8						; size = 4
_script$ = 12						; size = 4
?Remove_Duplicate_Script@@YAXPAVScriptableGameObj@@PBD@Z PROC ; Remove_Duplicate_Script, COMDAT
...
; 49   : 	}
; 50   : 	const SimpleDynVecClass<GameObjObserverClass *> *observers = &obj->Get_Observers();

	mov	ecx, DWORD PTR _obj$[ebp]
	call	?Get_Observers@ScriptableGameObj@@QAEABV?$SimpleDynVecClass@PAVGameObjObserverClass@@@@XZ ; ScriptableGameObj::Get_Observers
	mov	DWORD PTR _observers$[ebp], eax

; 51   : 	bool Found = false;

	mov	BYTE PTR _Found$[ebp], 0

; 52   : 	for (int i = 0;i < observers->Count();i++)

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN6@Remove_Dup
$LN5@Remove_Dup:
	mov	eax, DWORD PTR _i$1[ebp]
	add	eax, 1
	mov	DWORD PTR _i$1[ebp], eax
$LN6@Remove_Dup:
	mov	ecx, DWORD PTR _observers$[ebp]
	call	?Count@?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEHXZ ; SimpleDynVecClass<GameObjObserverClass *>::Count
	cmp	DWORD PTR _i$1[ebp], eax
	jge	SHORT $LN8@Remove_Dup

; 53   : 	{
; 54   : 		if (!_stricmp((*observers)[i]->Get_Name(),script))

	mov	eax, DWORD PTR _i$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _observers$[ebp]
	call	??A?$SimpleDynVecClass@PAVGameObjObserverClass@@@@QBEABQAVGameObjObserverClass@@H@Z ; SimpleDynVecClass<GameObjObserverClass *>::operator[]
	mov	ecx, DWORD PTR [eax]
...
; 60   : 			else
	...
	jmp	SHORT $LN3@Remove_Dup
$LN2@Remove_Dup:

; 61   : 			{
; 62   : 				((ScriptImpClass*)(*observers)[i])->Destroy_Script();
...
; 66   : }
	...
	pop	ebp
	ret	0
?Remove_Duplicate_Script@@YAXPAVScriptableGameObj@@PBD@Z ENDP ; Remove_Duplicate_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Player_Once@@YAXPBD0H@Z
_TEXT	SEGMENT
_o$1 = -8						; size = 4
_x$ = -4						; size = 4
_script$ = 8						; size = 4
_params$ = 12						; size = 4
_team$ = 16						; size = 4
?Attach_Script_Player_Once@@YAXPBD0H@Z PROC		; Attach_Script_Player_Once, COMDAT
...
; 270  : 	SLNode<SoldierGameObj> *x = GameObjManager::StarGameObjList.Head();
...
; 271  : 	while (x)
	...
	cmp	DWORD PTR _x$[ebp], 0
	je	SHORT $LN6@Attach_Scr

; 272  : 	{
; 273  : 		SoldierGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VSoldierGameObj@@@@QBEPAVSoldierGameObj@@XZ ; SLNode<SoldierGameObj>::Data
	mov	DWORD PTR _o$1[ebp], eax

; 274  : 		if ((Get_Object_Type(o) == team) || (team == 2))
	...
	je	SHORT $LN2@Attach_Scr
	cmp	DWORD PTR _team$[ebp], 2
	jne	SHORT $LN3@Attach_Scr
$LN2@Attach_Scr:

; 275  : 		{
; 276  : 			if (!Is_Script_Attached(o,script))
...
; 283  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Player_Once@@YAXPBD0H@Z ENDP		; Attach_Script_Player_Once
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Is_Type@@YAXPAVScriptableGameObj@@KPBD1H@Z
_TEXT	SEGMENT
_d$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
...
_params$ = 20						; size = 4
_team$ = 24						; size = 4
?Attach_Script_Is_Type@@YAXPAVScriptableGameObj@@KPBD1H@Z PROC ; Attach_Script_Is_Type, COMDAT
...
; 326  : 	{
; 327  : 		if ((Get_Object_Type(obj) == team) || (team == 2))
...
; 328  : 		{
; 329  : 			Commands->Attach_Script(obj,script,params);
...
; 332  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Is_Type@@YAXPAVScriptableGameObj@@KPBD1H@Z ENDP ; Attach_Script_Is_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Is_Preset@@YAXPAVScriptableGameObj@@PBD11H@Z
_TEXT	SEGMENT
_d$ = -4						; size = 4
_obj$ = 8						; size = 4
_preset$ = 12						; size = 4
...
_params$ = 20						; size = 4
_team$ = 24						; size = 4
?Attach_Script_Is_Preset@@YAXPAVScriptableGameObj@@PBD11H@Z PROC ; Attach_Script_Is_Preset, COMDAT
...
; 307  : 	}
; 308  : 	const DefinitionClass *d = &obj->Get_Definition();

	mov	ecx, DWORD PTR _obj$[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$[ebp], eax

; 309  : 	if (!_stricmp(d->Get_Name(),preset))
...
; 310  : 	{
; 311  : 		if ((Get_Object_Type(obj) == team) || (team == 2))
...
; 312  : 		{
; 313  : 			Commands->Attach_Script(obj,script,params);
...
; 316  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Is_Preset@@YAXPAVScriptableGameObj@@PBD11H@Z ENDP ; Attach_Script_Is_Preset
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
...
; 287  : 	SLNode<BuildingGameObj> *x = GameObjManager::BuildingGameObjList.Head();
...
; 292  : 		{
; 293  : 			if ((Get_Object_Type(o) == team) || (team == 2))
...
; 294  : 			{
; 295  : 				Commands->Attach_Script(o,script,params);
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Type_Once@@YAXPBD0KH@Z
_TEXT	SEGMENT
_d$1 = -16						; size = 4
_o2$2 = -12						; size = 4
_o$3 = -8						; size = 4
...
_type$ = 16						; size = 4
_team$ = 20						; size = 4
?Attach_Script_Type_Once@@YAXPBD0KH@Z PROC		; Attach_Script_Type_Once, COMDAT
...
; 241  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 243  : 	{
; 244  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$3[ebp], eax

; 245  : 		ScriptableGameObj *o2 = 0;

	mov	DWORD PTR _o2$2[ebp], 0
...
; 248  : 			o2 = o->As_ScriptableGameObj();
	...
	mov	eax, DWORD PTR [edx+48]
	call	eax
	mov	DWORD PTR _o2$2[ebp], eax
$LN6@Attach_Scr:

; 249  : 		}
; 250  : 		if (o2)

	cmp	DWORD PTR _o2$2[ebp], 0
	je	SHORT $LN5@Attach_Scr

; 251  : 		{
; 252  : 			const DefinitionClass *d = &o2->Get_Definition();

	mov	ecx, DWORD PTR _o2$2[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$1[ebp], eax

; 253  : 			if (d->Get_Class_ID() == type)
...
; 254  : 			{
; 255  : 				if ((Get_Object_Type(o2) == team) || (team == 2))

	mov	eax, DWORD PTR _o2$2[ebp]
	push	eax
	call	?Get_Object_Type@@YAHPAVScriptableGameObj@@@Z ; Get_Object_Type
	add	esp, 4
	cmp	eax, DWORD PTR _team$[ebp]
...
; 256  : 				{
; 257  : 					if (!Is_Script_Attached(o2,script))
...
; 258  : 					{
; 259  : 						Commands->Attach_Script(o2,script,params);

	mov	eax, DWORD PTR _params$[ebp]
	push	eax
	mov	ecx, DWORD PTR _script$[ebp]
	push	ecx
	mov	edx, DWORD PTR _o2$2[ebp]
	push	edx
	mov	eax, DWORD PTR ?Commands@@3PAUScriptCommands@@A ; Commands
	mov	ecx, DWORD PTR [eax+120]
	call	ecx
...
; 266  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Type_Once@@YAXPBD0KH@Z ENDP		; Attach_Script_Type_Once
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Preset_Once@@YAXPBD00H@Z
_TEXT	SEGMENT
_d$1 = -16						; size = 4
_o2$2 = -12						; size = 4
_o$3 = -8						; size = 4
...
_preset$ = 16						; size = 4
_team$ = 20						; size = 4
?Attach_Script_Preset_Once@@YAXPBD00H@Z PROC		; Attach_Script_Preset_Once, COMDAT
...
; 212  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 214  : 	{
; 215  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$3[ebp], eax

; 216  : 		ScriptableGameObj *o2 = 0;
...
; 222  : 		{
; 223  : 			const DefinitionClass *d = &o2->Get_Definition();

	mov	ecx, DWORD PTR _o2$2[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$1[ebp], eax

; 224  : 			if (!_stricmp(d->Get_Name(),preset))
...
; 225  : 			{
; 226  : 				if ((Get_Object_Type(o2) == team) || (team == 2))
...
; 227  : 				{
; 228  : 					if (!Is_Script_Attached(o2,script))
...
; 229  : 					{
; 230  : 						Commands->Attach_Script(o2,script,params);
...
; 237  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Preset_Once@@YAXPBD00H@Z ENDP		; Attach_Script_Preset_Once
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Once@@YAXPAVScriptableGameObj@@PBD1@Z
_TEXT	SEGMENT
_obj$ = 8						; size = 4
_script$ = 12						; size = 4
_params$ = 16						; size = 4
?Attach_Script_Once@@YAXPAVScriptableGameObj@@PBD1@Z PROC ; Attach_Script_Once, COMDAT
...
; 203  : 	}
; 204  : 	if (!Is_Script_Attached(obj,script))
...
; 205  : 	{
; 206  : 		Commands->Attach_Script(obj,script,params);
...
; 208  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Once@@YAXPAVScriptableGameObj@@PBD1@Z ENDP ; Attach_Script_Once
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Is_Script_Attached@@YA_NPAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
tv69 = -68						; size = 4
_obj$ = 8						; size = 4
_script$ = 12						; size = 4
?Is_Script_Attached@@YA_NPAVScriptableGameObj@@PBD@Z PROC ; Is_Script_Attached, COMDAT
...
; 191  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN1@Is_Script_

; 192  : 	{
; 193  : 		return false;

	xor	al, al
	jmp	SHORT $LN2@Is_Script_
$LN1@Is_Script_:

; 194  : 	}
; 195  : 	return obj->Find_Observer(script) != 0;
	...
	call	?Find_Observer@ScriptableGameObj@@QAEPAVGameObjObserverClass@@PBD@Z ; ScriptableGameObj::Find_Observer
	test	eax, eax
	je	SHORT $LN4@Is_Script_
	mov	DWORD PTR tv69[ebp], 1
	jmp	SHORT $LN5@Is_Script_
$LN4@Is_Script_:
	mov	DWORD PTR tv69[ebp], 0
$LN5@Is_Script_:
...
; 196  : }
	...
	pop	ebp
	ret	0
?Is_Script_Attached@@YA_NPAVScriptableGameObj@@PBD@Z ENDP ; Is_Script_Attached
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Remove_Script_Type@@YAXPBDKH@Z
_TEXT	SEGMENT
_d$1 = -16						; size = 4
_o2$2 = -12						; size = 4
_o$3 = -8						; size = 4
...
_type$ = 12						; size = 4
_team$ = 16						; size = 4
?Remove_Script_Type@@YAXPBDKH@Z PROC			; Remove_Script_Type, COMDAT
...
; 96   : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 98   : 	{
; 99   : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$3[ebp], eax

; 100  : 		ScriptableGameObj *o2 = 0;
...
; 105  : 		if (o2)
	...
	cmp	DWORD PTR _o2$2[ebp], 0
	je	SHORT $LN4@Remove_Scr

; 106  : 		{
; 107  : 			const DefinitionClass *d = &o2->Get_Definition();

	mov	ecx, DWORD PTR _o2$2[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$1[ebp], eax

; 108  : 			if (d->Get_Class_ID() == type)
	...
	call	eax
	cmp	eax, DWORD PTR _type$[ebp]
	jne	SHORT $LN4@Remove_Scr

; 109  : 			{
; 110  : 				if ((Get_Object_Type(o2) == team) || (team == 2))
	...
	add	esp, 4
	cmp	eax, DWORD PTR _team$[ebp]
	je	SHORT $LN1@Remove_Scr
	cmp	DWORD PTR _team$[ebp], 2
	jne	SHORT $LN4@Remove_Scr
$LN1@Remove_Scr:

; 111  : 				{
; 112  : 					Remove_Script(o2,script);
...
; 118  : }
	...
	pop	ebp
	ret	0
?Remove_Script_Type@@YAXPBDKH@Z ENDP			; Remove_Script_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Remove_Script_Preset@@YAXPBD0H@Z
_TEXT	SEGMENT
_d$1 = -16						; size = 4
_o2$2 = -12						; size = 4
_o$3 = -8						; size = 4
...
_preset$ = 12						; size = 4
_team$ = 16						; size = 4
?Remove_Script_Preset@@YAXPBD0H@Z PROC			; Remove_Script_Preset, COMDAT
...
; 70   : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 72   : 	{
; 73   : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$3[ebp], eax

; 74   : 		ScriptableGameObj *o2 = 0;
...
; 80   : 		{
; 81   : 			const DefinitionClass *d = &o2->Get_Definition();

	mov	ecx, DWORD PTR _o2$2[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$1[ebp], eax

; 82   : 			if (!_stricmp(d->Get_Name(),preset))
...
; 83   : 			{
; 84   : 				if ((Get_Object_Type(o2) == team) || (team == 2))
...
; 92   : }
	...
	pop	ebp
	ret	0
?Remove_Script_Preset@@YAXPBD0H@Z ENDP			; Remove_Script_Preset
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Type@@YAXPBD0KH@Z
_TEXT	SEGMENT
_d$1 = -16						; size = 4
_o2$2 = -12						; size = 4
_o$3 = -8						; size = 4
...
_type$ = 16						; size = 4
_team$ = 20						; size = 4
?Attach_Script_Type@@YAXPBD0KH@Z PROC			; Attach_Script_Type, COMDAT
...
; 165  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 167  : 	{
; 168  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$3[ebp], eax

; 169  : 		ScriptableGameObj *o2 = 0;
...
; 175  : 		{
; 176  : 			const DefinitionClass *d = &o2->Get_Definition();

	mov	ecx, DWORD PTR _o2$2[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$1[ebp], eax

; 177  : 			if (d->Get_Class_ID() == type)
...
; 178  : 			{
; 179  : 				if ((Get_Object_Type(o2) == team) || (team == 2))
...
; 180  : 				{
; 181  : 					Commands->Attach_Script(o2,script,params);
...
; 187  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Type@@YAXPBD0KH@Z ENDP			; Attach_Script_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Attach_Script_Preset@@YAXPBD00H@Z
_TEXT	SEGMENT
_d$1 = -16						; size = 4
_o2$2 = -12						; size = 4
_o$3 = -8						; size = 4
...
_preset$ = 16						; size = 4
_team$ = 20						; size = 4
?Attach_Script_Preset@@YAXPBD00H@Z PROC			; Attach_Script_Preset, COMDAT
...
; 139  : 	SLNode<BaseGameObj> *x = GameObjManager::GameObjList.Head();
...
; 141  : 	{
; 142  : 		BaseGameObj *o = x->Data();

	mov	ecx, DWORD PTR _x$[ebp]
	call	?Data@?$SLNode@VBaseGameObj@@@@QBEPAVBaseGameObj@@XZ ; SLNode<BaseGameObj>::Data
	mov	DWORD PTR _o$3[ebp], eax

; 143  : 		ScriptableGameObj *o2 = 0;
...
; 149  : 		{
; 150  : 			const DefinitionClass *d = &o2->Get_Definition();

	mov	ecx, DWORD PTR _o2$2[ebp]
	call	?Get_Definition@ScriptableGameObj@@QBEABVScriptableGameObjDef@@XZ ; ScriptableGameObj::Get_Definition
	mov	DWORD PTR _d$1[ebp], eax

; 151  : 			if (!_stricmp(d->Get_Name(),preset))
...
; 152  : 			{
; 153  : 				if ((Get_Object_Type(o2) == team) || (team == 2))
...
; 154  : 				{
; 155  : 					Commands->Attach_Script(o2,script,params);
...
; 161  : }
	...
	pop	ebp
	ret	0
?Attach_Script_Preset@@YAXPBD00H@Z ENDP			; Attach_Script_Preset
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Remove_All_Scripts@@YAXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv76 = -80						; size = 4
_i$1 = -12						; size = 4
_x$ = -8						; size = 4
_observers$ = -4					; size = 4
_obj$ = 8						; size = 4
?Remove_All_Scripts@@YAXPAVScriptableGameObj@@@Z PROC	; Remove_All_Scripts, COMDAT
...
; 125  : 	}
; 126  : 	const SimpleDynVecClass<GameObjObserverClass *> *observers = &obj->Get_Observers();

	mov	ecx, DWORD PTR _obj$[ebp]
	call	?Get_Observers@ScriptableGameObj@@QAEABV?$SimpleDynVecClass@PAVGameObjObserverClass@@@@XZ ; ScriptableGameObj::Get_Observers
	mov	DWORD PTR _observers$[ebp], eax

; 127  : 	int x = observers->Count();
...
$LN4@Remove_All:
	mov	eax, DWORD PTR _i$1[ebp]
	cmp	eax, DWORD PTR _x$[ebp]
	jge	SHORT $LN6@Remove_All

; 129  : 	{
; 130  : 		if ((*observers)[i]->Owner() != 0)
...
; 131  : 		{
; 132  : 			((ScriptImpClass*)(*observers)[i])->Destroy_Script();
...
; 135  : }
	...
	pop	ebp
	ret	0
?Remove_All_Scripts@@YAXPAVScriptableGameObj@@@Z ENDP	; Remove_All_Scripts
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_script.cpp
;	COMDAT ?Remove_Script@@YAXPAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
tv78 = -80						; size = 4
_i$1 = -12						; size = 4
_x$ = -8						; size = 4
...
_obj$ = 8						; size = 4
_script$ = 12						; size = 4
?Remove_Script@@YAXPAVScriptableGameObj@@PBD@Z PROC	; Remove_Script, COMDAT
...
; 29   : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN5@Remove_Scr

; 30   : 	{
; 31   : 		return;

	jmp	SHORT $LN6@Remove_Scr
$LN5@Remove_Scr:

; 32   : 	}
; 33   : 	const SimpleDynVecClass<GameObjObserverClass *> *observers = &obj->Get_Observers();
...
; 42   : }
	...
	pop	ebp
	ret	0
?Remove_Script@@YAXPAVScriptableGameObj@@PBD@Z ENDP	; Remove_Script
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ??0GenericSLNode@@IAE@PAXPAV0@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_data$ = 8						; size = 4
_next$ = 12						; size = 4
??0GenericSLNode@@IAE@PAXPAV0@@Z PROC			; GenericSLNode::GenericSLNode, COMDAT
; _this$ = ecx
...
; 46   : 	}
	...
	pop	ebp
	ret	8
??0GenericSLNode@@IAE@PAXPAV0@@Z ENDP			; GenericSLNode::GenericSLNode
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
