; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\sh_factory.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Get_Player_Type@BaseControllerClass@@QBEHXZ	; BaseControllerClass::Get_Player_Type
PUBLIC	??0SH_CinematicVehicleFactoryBypass@@QAE@XZ	; SH_CinematicVehicleFactoryBypass::SH_CinematicVehicleFactoryBypass
PUBLIC	?Created@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z ; SH_CinematicVehicleFactoryBypass::Created
PUBLIC	?Destroyed@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z ; SH_CinematicVehicleFactoryBypass::Destroyed
PUBLIC	?PurchaseHook@SH_CinematicVehicleFactoryBypass@@QAEHPAVBaseControllerClass@@PAVScriptableGameObj@@II@Z ; SH_CinematicVehicleFactoryBypass::PurchaseHook
PUBLIC	?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@QAEXPAVBaseControllerClass@@PAVScriptableGameObj@@III@Z ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor
PUBLIC	?PurchaseHook@SH_CinematicVehicleFactoryBypass@@SAHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z ; SH_CinematicVehicleFactoryBypass::PurchaseHook
PUBLIC	?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@SAXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor
PUBLIC	??1SH_CinematicVehicleFactoryBypass@@UAE@XZ	; SH_CinematicVehicleFactoryBypass::~SH_CinematicVehicleFactoryBypass
PUBLIC	??_GSH_CinematicVehicleFactoryBypass@@UAEPAXI@Z	; SH_CinematicVehicleFactoryBypass::`scalar deleting destructor'
PUBLIC	??$sprintf_s@$0IA@@@YAHAAY0IA@DPBDZZ		; sprintf_s<128>
PUBLIC	?Created@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@@Z ; SH_CinematicVehicleDeliveryCallback::Created
PUBLIC	?Custom@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@HH0@Z ; SH_CinematicVehicleDeliveryCallback::Custom
PUBLIC	??0SH_CinematicVehicleDeliveryCallback@@QAE@XZ	; SH_CinematicVehicleDeliveryCallback::SH_CinematicVehicleDeliveryCallback
PUBLIC	??1SH_CinematicVehicleDeliveryCallback@@UAE@XZ	; SH_CinematicVehicleDeliveryCallback::~SH_CinematicVehicleDeliveryCallback
PUBLIC	??_GSH_CinematicVehicleDeliveryCallback@@UAEPAXI@Z ; SH_CinematicVehicleDeliveryCallback::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::ScriptRegistrant<SH_CinematicVehicleFactoryBypass>
PUBLIC	?Create@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::Create
PUBLIC	??1?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAE@XZ ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::~ScriptRegistrant<SH_CinematicVehicleFactoryBypass>
PUBLIC	??_G?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@QAE@PBD0@Z ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>
PUBLIC	?Create@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::Create
PUBLIC	??1?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAE@XZ ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::~ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>
PUBLIC	??_G?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAXI@Z ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`scalar deleting destructor'
...
PUBLIC	??_7SH_CinematicVehicleFactoryBypass@@6B@	; SH_CinematicVehicleFactoryBypass::`vftable'
...
PUBLIC	??_7SH_CinematicVehicleDeliveryCallback@@6B@	; SH_CinematicVehicleDeliveryCallback::`vftable'
PUBLIC	??_C@_0BA@PHNMDBPG@SH_Invulnerable?$AA@		; `string'
PUBLIC	??_7?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@ ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`vftable'
PUBLIC	?SH_CinematicVehicleFactoryBypassRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@A ; SH_CinematicVehicleFactoryBypassRegistrant
PUBLIC	??_C@_0CD@ICMCGPFB@PresetName?3string?0Cinematic?3stri@ ; `string'
PUBLIC	??_C@_0CB@MHJBBFPH@SH_CinematicVehicleFactoryBypass@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@ ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`vftable'
PUBLIC	?SH_CinematicVehicleDeliveryCallbackRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@A ; SH_CinematicVehicleDeliveryCallbackRegistrant
...
PUBLIC	??_C@_0EB@PKLILFMA@ScriptRegistrant?$DMclass?5SH_Cinema@ ; `string'
...
PUBLIC	??_C@_0EE@FLIHNIDO@ScriptRegistrant?$DMclass?5SH_Cinema@ ; `string'
...
PUBLIC	??_R4SH_CinematicVehicleFactoryBypass@@6B@	; SH_CinematicVehicleFactoryBypass::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVSH_CinematicVehicleFactoryBypass@@@8	; SH_CinematicVehicleFactoryBypass `RTTI Type Descriptor'
PUBLIC	??_R3SH_CinematicVehicleFactoryBypass@@8	; SH_CinematicVehicleFactoryBypass::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2SH_CinematicVehicleFactoryBypass@@8	; SH_CinematicVehicleFactoryBypass::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@SH_CinematicVehicleFactoryBypass@@8 ; SH_CinematicVehicleFactoryBypass::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4SH_CinematicVehicleDeliveryCallback@@6B@	; SH_CinematicVehicleDeliveryCallback::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVSH_CinematicVehicleDeliveryCallback@@@8	; SH_CinematicVehicleDeliveryCallback `RTTI Type Descriptor'
PUBLIC	??_R3SH_CinematicVehicleDeliveryCallback@@8	; SH_CinematicVehicleDeliveryCallback::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2SH_CinematicVehicleDeliveryCallback@@8	; SH_CinematicVehicleDeliveryCallback::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@SH_CinematicVehicleDeliveryCallback@@8 ; SH_CinematicVehicleDeliveryCallback::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@ ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@@8 ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@ ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@@8 ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	??_ESH_CinematicVehicleFactoryBypass@@UAEPAXI@Z:PROC ; SH_CinematicVehicleFactoryBypass::`vector deleting destructor'
EXTRN	??_ESH_CinematicVehicleDeliveryCallback@@UAEPAXI@Z:PROC ; SH_CinematicVehicleDeliveryCallback::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`vector deleting destructor'
...
_BSS	SEGMENT
?SH_CinematicVehicleFactoryBypassRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@A DB 010H DUP (?) ; SH_CinematicVehicleFactoryBypassRegistrant
?SH_CinematicVehicleDeliveryCallbackRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@A DB 010H DUP (?) ; SH_CinematicVehicleDeliveryCallbackRegistrant
_BSS	ENDS
...
_BSS	ENDS
CRT$XCU	SEGMENT
_SH_CinematicVehicleFactoryBypassRegistrant$initializer$ DD FLAT:??__ESH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@@8 ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8 DD 00H ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallb'
	DB	'ack@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@ DD 00H ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@@8 ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8 DD 00H ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass'
	DB	'@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@ DD 00H ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@SH_CinematicVehicleDeliveryCallback@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@SH_CinematicVehicleDeliveryCallback@@8 DD FLAT:??_R0?AVSH_CinematicVehicleDeliveryCallback@@@8 ; SH_CinematicVehicleDeliveryCallback::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3SH_CinematicVehicleDeliveryCallback@@8
rdata$r	ENDS
;	COMDAT ??_R2SH_CinematicVehicleDeliveryCallback@@8
rdata$r	SEGMENT
??_R2SH_CinematicVehicleDeliveryCallback@@8 DD FLAT:??_R1A@?0A@EA@SH_CinematicVehicleDeliveryCallback@@8 ; SH_CinematicVehicleDeliveryCallback::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3SH_CinematicVehicleDeliveryCallback@@8
rdata$r	SEGMENT
??_R3SH_CinematicVehicleDeliveryCallback@@8 DD 00H	; SH_CinematicVehicleDeliveryCallback::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2SH_CinematicVehicleDeliveryCallback@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVSH_CinematicVehicleDeliveryCallback@@@8
_DATA	SEGMENT
??_R0?AVSH_CinematicVehicleDeliveryCallback@@@8 DD FLAT:??_7type_info@@6B@ ; SH_CinematicVehicleDeliveryCallback `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVSH_CinematicVehicleDeliveryCallback@@', 00H
_DATA	ENDS
;	COMDAT ??_R4SH_CinematicVehicleDeliveryCallback@@6B@
rdata$r	SEGMENT
??_R4SH_CinematicVehicleDeliveryCallback@@6B@ DD 00H	; SH_CinematicVehicleDeliveryCallback::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVSH_CinematicVehicleDeliveryCallback@@@8
	DD	FLAT:??_R3SH_CinematicVehicleDeliveryCallback@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@SH_CinematicVehicleFactoryBypass@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@SH_CinematicVehicleFactoryBypass@@8 DD FLAT:??_R0?AVSH_CinematicVehicleFactoryBypass@@@8 ; SH_CinematicVehicleFactoryBypass::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3SH_CinematicVehicleFactoryBypass@@8
rdata$r	ENDS
;	COMDAT ??_R2SH_CinematicVehicleFactoryBypass@@8
rdata$r	SEGMENT
??_R2SH_CinematicVehicleFactoryBypass@@8 DD FLAT:??_R1A@?0A@EA@SH_CinematicVehicleFactoryBypass@@8 ; SH_CinematicVehicleFactoryBypass::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3SH_CinematicVehicleFactoryBypass@@8
rdata$r	SEGMENT
??_R3SH_CinematicVehicleFactoryBypass@@8 DD 00H		; SH_CinematicVehicleFactoryBypass::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2SH_CinematicVehicleFactoryBypass@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVSH_CinematicVehicleFactoryBypass@@@8
_DATA	SEGMENT
??_R0?AVSH_CinematicVehicleFactoryBypass@@@8 DD FLAT:??_7type_info@@6B@ ; SH_CinematicVehicleFactoryBypass `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVSH_CinematicVehicleFactoryBypass@@', 00H
_DATA	ENDS
;	COMDAT ??_R4SH_CinematicVehicleFactoryBypass@@6B@
rdata$r	SEGMENT
??_R4SH_CinematicVehicleFactoryBypass@@6B@ DD 00H	; SH_CinematicVehicleFactoryBypass::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVSH_CinematicVehicleFactoryBypass@@@8
	DD	FLAT:??_R3SH_CinematicVehicleFactoryBypass@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0EE@FLIHNIDO@ScriptRegistrant?$DMclass?5SH_Cinema@
CONST	SEGMENT
??_C@_0EE@FLIHNIDO@ScriptRegistrant?$DMclass?5SH_Cinema@ DB 'ScriptRegist'
	DB	'rant<class SH_CinematicVehicleDeliveryCallback>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0EB@PKLILFMA@ScriptRegistrant?$DMclass?5SH_Cinema@
CONST	SEGMENT
??_C@_0EB@PKLILFMA@ScriptRegistrant?$DMclass?5SH_Cinema@ DB 'ScriptRegist'
	DB	'rant<class SH_CinematicVehicleFactoryBypass>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@ ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0CB@MHJBBFPH@SH_CinematicVehicleFactoryBypass@
CONST	SEGMENT
??_C@_0CB@MHJBBFPH@SH_CinematicVehicleFactoryBypass@ DB 'SH_CinematicVehi'
	DB	'cleFactoryBypass', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CD@ICMCGPFB@PresetName?3string?0Cinematic?3stri@
CONST	SEGMENT
??_C@_0CD@ICMCGPFB@PresetName?3string?0Cinematic?3stri@ DB 'PresetName:st'
	DB	'ring,Cinematic:string', 00H			; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@ ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BA@PHNMDBPG@SH_Invulnerable?$AA@
CONST	SEGMENT
??_C@_0BA@PHNMDBPG@SH_Invulnerable?$AA@ DB 'SH_Invulnerable', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7SH_CinematicVehicleDeliveryCallback@@6B@
CONST	SEGMENT
??_7SH_CinematicVehicleDeliveryCallback@@6B@ DD FLAT:??_R4SH_CinematicVehicleDeliveryCallback@@6B@ ; SH_CinematicVehicleDeliveryCallback::`vftable'
	DD	FLAT:??_ESH_CinematicVehicleDeliveryCallback@@UAEPAXI@Z
	...
	DD	FLAT:?Created@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@@Z
	...
	DD	FLAT:?Custom@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@HH0@Z
...
CONST	ENDS
;	COMDAT ??_7SH_CinematicVehicleFactoryBypass@@6B@
CONST	SEGMENT
??_7SH_CinematicVehicleFactoryBypass@@6B@ DD FLAT:??_R4SH_CinematicVehicleFactoryBypass@@6B@ ; SH_CinematicVehicleFactoryBypass::`vftable'
	DD	FLAT:??_ESH_CinematicVehicleFactoryBypass@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
...
CONST	ENDS
CRT$XCU	SEGMENT
_SH_CinematicVehicleDeliveryCallbackRegistrant$initializer$ DD FLAT:??__ESH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ
CRT$XCU	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FSH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ
text$yd	SEGMENT
??__FSH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ PROC ; `dynamic atexit destructor for 'SH_CinematicVehicleDeliveryCallbackRegistrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?SH_CinematicVehicleDeliveryCallbackRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@A ; SH_CinematicVehicleDeliveryCallbackRegistrant
	call	??1?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FSH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ ENDP ; `dynamic atexit destructor for 'SH_CinematicVehicleDeliveryCallbackRegistrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ??__ESH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ
text$yc	SEGMENT
??__ESH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ PROC ; `dynamic initializer for 'SH_CinematicVehicleDeliveryCallbackRegistrant'', COMDAT

; 120  : REGISTER_SCRIPT(SH_CinematicVehicleDeliveryCallback, "");
	...
	mov	ecx, OFFSET ?SH_CinematicVehicleDeliveryCallbackRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@A ; SH_CinematicVehicleDeliveryCallbackRegistrant
	call	??0?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@QAE@PBD0@Z ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>
	push	OFFSET ??__FSH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ ; `dynamic atexit destructor for 'SH_CinematicVehicleDeliveryCallbackRegistrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ESH_CinematicVehicleDeliveryCallbackRegistrant@@YAXXZ ENDP ; `dynamic initializer for 'SH_CinematicVehicleDeliveryCallbackRegistrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAXI@Z PROC ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAE@XZ PROC ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::~ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAE@XZ ENDP ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::~ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0EE@FLIHNIDO@ScriptRegistrant?$DMclass?5SH_Cinema@
	push	553					; 00000229H
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0SH_CinematicVehicleDeliveryCallback@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VSH_CinematicVehicleDeliveryCallback@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>::ScriptRegistrant<SH_CinematicVehicleDeliveryCallback>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FSH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ
text$yd	SEGMENT
??__FSH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ PROC ; `dynamic atexit destructor for 'SH_CinematicVehicleFactoryBypassRegistrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?SH_CinematicVehicleFactoryBypassRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@A ; SH_CinematicVehicleFactoryBypassRegistrant
	call	??1?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FSH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ ENDP ; `dynamic atexit destructor for 'SH_CinematicVehicleFactoryBypassRegistrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ??__ESH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ
text$yc	SEGMENT
??__ESH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ PROC ; `dynamic initializer for 'SH_CinematicVehicleFactoryBypassRegistrant'', COMDAT

; 119  : REGISTER_SCRIPT(SH_CinematicVehicleFactoryBypass, "PresetName:string,Cinematic:string");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0CD@ICMCGPFB@PresetName?3string?0Cinematic?3stri@
	push	OFFSET ??_C@_0CB@MHJBBFPH@SH_CinematicVehicleFactoryBypass@
	mov	ecx, OFFSET ?SH_CinematicVehicleFactoryBypassRegistrant@@3V?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@A ; SH_CinematicVehicleFactoryBypassRegistrant
	call	??0?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::ScriptRegistrant<SH_CinematicVehicleFactoryBypass>
	push	OFFSET ??__FSH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ ; `dynamic atexit destructor for 'SH_CinematicVehicleFactoryBypassRegistrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ESH_CinematicVehicleFactoryBypassRegistrant@@YAXXZ ENDP ; `dynamic initializer for 'SH_CinematicVehicleFactoryBypassRegistrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z PROC ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAE@XZ PROC ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::~ScriptRegistrant<SH_CinematicVehicleFactoryBypass>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAE@XZ ENDP ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::~ScriptRegistrant<SH_CinematicVehicleFactoryBypass>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0EB@PKLILFMA@ScriptRegistrant?$DMclass?5SH_Cinema@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0SH_CinematicVehicleFactoryBypass@@QAE@XZ ; SH_CinematicVehicleFactoryBypass::SH_CinematicVehicleFactoryBypass
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::ScriptRegistrant<SH_CinematicVehicleFactoryBypass>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VSH_CinematicVehicleFactoryBypass@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<SH_CinematicVehicleFactoryBypass>::ScriptRegistrant<SH_CinematicVehicleFactoryBypass>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GSH_CinematicVehicleDeliveryCallback@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GSH_CinematicVehicleDeliveryCallback@@UAEPAXI@Z PROC	; SH_CinematicVehicleDeliveryCallback::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1SH_CinematicVehicleDeliveryCallback@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GSH_CinematicVehicleDeliveryCallback@@UAEPAXI@Z ENDP	; SH_CinematicVehicleDeliveryCallback::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1SH_CinematicVehicleDeliveryCallback@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1SH_CinematicVehicleDeliveryCallback@@UAE@XZ PROC	; SH_CinematicVehicleDeliveryCallback::~SH_CinematicVehicleDeliveryCallback, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1SH_CinematicVehicleDeliveryCallback@@UAE@XZ ENDP	; SH_CinematicVehicleDeliveryCallback::~SH_CinematicVehicleDeliveryCallback
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0SH_CinematicVehicleDeliveryCallback@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0SH_CinematicVehicleDeliveryCallback@@QAE@XZ PROC	; SH_CinematicVehicleDeliveryCallback::SH_CinematicVehicleDeliveryCallback, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7SH_CinematicVehicleDeliveryCallback@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0SH_CinematicVehicleDeliveryCallback@@QAE@XZ ENDP	; SH_CinematicVehicleDeliveryCallback::SH_CinematicVehicleDeliveryCallback
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?Custom@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; SH_CinematicVehicleDeliveryCallback::Custom, COMDAT
; _this$ = ecx
...
; 109  :         if (type == SH_CVFB_DELIVERED)

	cmp	DWORD PTR _type$[ebp], 43000		; 0000a7f8H
	jne	SHORT $LN2@Custom

; 110  :         {
; 111  :             Remove_Script(obj, "SH_Invulnerable");

	push	OFFSET ??_C@_0BA@PHNMDBPG@SH_Invulnerable?$AA@
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Remove_Script@@YAXPAVScriptableGameObj@@PBD@Z ; Remove_Script
	add	esp, 8

; 112  :             Commands->Enable_Vehicle_Transitions(obj, true);
...
; 114  :     }
	...
	pop	ebp
	ret	16					; 00000010H
?Custom@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; SH_CinematicVehicleDeliveryCallback::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?Created@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@@Z PROC ; SH_CinematicVehicleDeliveryCallback::Created, COMDAT
; _this$ = ecx
...
; 103  :         Commands->Attach_Script(obj, "SH_Invulnerable", "");
...
; 104  :         Commands->Enable_Vehicle_Transitions(obj, false);
...
; 105  :     }
	...
	pop	ebp
	ret	4
?Created@SH_CinematicVehicleDeliveryCallback@@EAEXPAVScriptableGameObj@@@Z ENDP ; SH_CinematicVehicleDeliveryCallback::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GSH_CinematicVehicleFactoryBypass@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GSH_CinematicVehicleFactoryBypass@@UAEPAXI@Z PROC	; SH_CinematicVehicleFactoryBypass::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1SH_CinematicVehicleFactoryBypass@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GSH_CinematicVehicleFactoryBypass@@UAEPAXI@Z ENDP	; SH_CinematicVehicleFactoryBypass::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1SH_CinematicVehicleFactoryBypass@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1SH_CinematicVehicleFactoryBypass@@UAE@XZ PROC	; SH_CinematicVehicleFactoryBypass::~SH_CinematicVehicleFactoryBypass, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1SH_CinematicVehicleFactoryBypass@@UAE@XZ ENDP	; SH_CinematicVehicleFactoryBypass::~SH_CinematicVehicleFactoryBypass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@SAXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z
_TEXT	SEGMENT
_base$ = 8						; size = 4
_purchaser$ = 12					; size = 4
_cost$ = 16						; size = 4
_preset$ = 20						; size = 4
_purchase_status$ = 24					; size = 4
_instance$ = 28						; size = 4
?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@SAXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z PROC ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor, COMDAT
...
; 95   :         ((SH_CinematicVehicleFactoryBypass*)instance)->PurchaseMonitor(base, purchaser, cost, preset, purchase_status);

	mov	eax, DWORD PTR _purchase_status$[ebp]
	push	eax
	mov	ecx, DWORD PTR _preset$[ebp]
	push	ecx
	mov	edx, DWORD PTR _cost$[ebp]
	push	edx
	mov	eax, DWORD PTR _purchaser$[ebp]
	push	eax
	mov	ecx, DWORD PTR _base$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _instance$[ebp]
	call	?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@QAEXPAVBaseControllerClass@@PAVScriptableGameObj@@III@Z ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor
...
; 96   :     }
	...
	pop	ebp
	ret	0
?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@SAXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z ENDP ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?PurchaseHook@SH_CinematicVehicleFactoryBypass@@SAHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z
_TEXT	SEGMENT
_base$ = 8						; size = 4
_purchaser$ = 12					; size = 4
_cost$ = 16						; size = 4
_preset$ = 20						; size = 4
_instance$ = 24						; size = 4
?PurchaseHook@SH_CinematicVehicleFactoryBypass@@SAHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z PROC ; SH_CinematicVehicleFactoryBypass::PurchaseHook, COMDAT
...
; 90   :         return ((SH_CinematicVehicleFactoryBypass*)instance)->PurchaseHook(base, purchaser, cost, preset);

	mov	eax, DWORD PTR _preset$[ebp]
	push	eax
	mov	ecx, DWORD PTR _cost$[ebp]
	push	ecx
	mov	edx, DWORD PTR _purchaser$[ebp]
	push	edx
	mov	eax, DWORD PTR _base$[ebp]
	push	eax
	mov	ecx, DWORD PTR _instance$[ebp]
	call	?PurchaseHook@SH_CinematicVehicleFactoryBypass@@QAEHPAVBaseControllerClass@@PAVScriptableGameObj@@II@Z ; SH_CinematicVehicleFactoryBypass::PurchaseHook
...
; 91   :     }
	...
	pop	ebp
	ret	0
?PurchaseHook@SH_CinematicVehicleFactoryBypass@@SAHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z ENDP ; SH_CinematicVehicleFactoryBypass::PurchaseHook
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@QAEXPAVBaseControllerClass@@PAVScriptableGameObj@@III@Z
_TEXT	SEGMENT
$T1 = -236						; size = 12
_vehicle$ = -160					; size = 4
_cinematic$ = -156					; size = 4
_cinematic_params$ = -152				; size = 128
_facing$ = -24						; size = 4
...
_preset$ = 20						; size = 4
_purchase_status$ = 24					; size = 4
?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@QAEXPAVBaseControllerClass@@PAVScriptableGameObj@@III@Z PROC ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor, COMDAT
; _this$ = ecx
...
; 63   :         if (purchase_status != 0 || preset != preset_id || base->Get_Player_Type() != Get_Player_Type(purchaser)) return; // not ours

	cmp	DWORD PTR _purchase_status$[ebp], 0
	jne	SHORT $LN1@PurchaseMo
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _preset$[ebp]
	cmp	ecx, DWORD PTR [eax+36]
	jne	SHORT $LN1@PurchaseMo
	mov	ecx, DWORD PTR _base$[ebp]
	call	?Get_Player_Type@BaseControllerClass@@QBEHXZ ; BaseControllerClass::Get_Player_Type
	mov	esi, eax
	mov	eax, DWORD PTR _purchaser$[ebp]
	push	eax
...
; 66   :         Vector3 position = Commands->Get_Position(owner);
...
; 67   :         float facing = Commands->Get_Facing(owner);
...
; 68   : 
; 69   :         // create cinematic
; 70   :         char cinematic_params[128];
; 71   :         sprintf_s(cinematic_params, "%s,1", Get_Parameter("Cinematic"));
...
; 72   : 
; 73   :         auto cinematic = Commands->Create_Object("Invisible_Object", position);
...
; 74   :         Commands->Set_Facing(cinematic, facing);
...
; 75   :         Commands->Attach_Script(cinematic, "JFW_Cinematic", cinematic_params);
...
; 76   : 
; 77   :         // create vehicle at delivery site
; 78   :         GameObject* vehicle = Commands->Create_Object(Get_Parameter("PresetName"), position);
...
; 79   :         Commands->Set_Facing(vehicle, facing);
...
; 80   :         Commands->Attach_Script(vehicle, "SH_CinematicVehicleDeliveryCallback", "");
...
; 81   : 
; 82   :         // load vehicle and purchaser into cinematic, start it
; 83   :         Commands->Send_Custom_Event(owner, cinematic, CINEMATIC_SET_SLOT + 0, Commands->Get_ID(vehicle), 0);
...
; 84   :         Commands->Send_Custom_Event(owner, cinematic, CINEMATIC_SET_SLOT + 1, Commands->Get_ID(purchaser), 0);
...
; 85   :         Commands->Send_Custom_Event(owner, cinematic, CINEMATIC_START, 0, 0);
...
; 86   :     }
	...
	pop	ebp
	ret	20					; 00000014H
?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@QAEXPAVBaseControllerClass@@PAVScriptableGameObj@@III@Z ENDP ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?PurchaseHook@SH_CinematicVehicleFactoryBypass@@QAEHPAVBaseControllerClass@@PAVScriptableGameObj@@II@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_base$ = 8						; size = 4
_purchaser$ = 12					; size = 4
_cost$ = 16						; size = 4
_preset$ = 20						; size = 4
?PurchaseHook@SH_CinematicVehicleFactoryBypass@@QAEHPAVBaseControllerClass@@PAVScriptableGameObj@@II@Z PROC ; SH_CinematicVehicleFactoryBypass::PurchaseHook, COMDAT
; _this$ = ecx
...
; 56   :        if (preset != preset_id || base->Get_Player_Type() != Get_Player_Type(purchaser)) return -1; // not ours, process normally

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _preset$[ebp]
	cmp	ecx, DWORD PTR [eax+36]
	jne	SHORT $LN1@PurchaseHo
	mov	ecx, DWORD PTR _base$[ebp]
	call	?Get_Player_Type@BaseControllerClass@@QBEHXZ ; BaseControllerClass::Get_Player_Type
	mov	esi, eax
	mov	eax, DWORD PTR _purchaser$[ebp]
	...
	add	esp, 4
	cmp	esi, eax
	je	SHORT $LN2@PurchaseHo
$LN1@PurchaseHo:
	or	eax, -1
	jmp	SHORT $LN3@PurchaseHo
$LN2@PurchaseHo:

; 57   : 
; 58   :        return -3; // process normally, but prevent creation
...
; 59   :     }
	...
	pop	ebp
	ret	16					; 00000010H
?PurchaseHook@SH_CinematicVehicleFactoryBypass@@QAEHPAVBaseControllerClass@@PAVScriptableGameObj@@II@Z ENDP ; SH_CinematicVehicleFactoryBypass::PurchaseHook
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?Destroyed@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Destroyed@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z PROC ; SH_CinematicVehicleFactoryBypass::Destroyed, COMDAT
; _this$ = ecx
...
; 48   :         RemoveVehiclePurchaseHook(hook_handle);

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	push	ecx
	call	DWORD PTR ?RemoveVehiclePurchaseHook@@3P6AXH@ZA ; RemoveVehiclePurchaseHook
	add	esp, 4

; 49   :         RemoveVehiclePurchaseMonHook(monitor_handle);

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	push	ecx
	call	DWORD PTR ?RemoveVehiclePurchaseMonHook@@3P6AXH@ZA ; RemoveVehiclePurchaseMonHook
	add	esp, 4
...
; 52   :     }
	...
	pop	ebp
	ret	4
?Destroyed@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z ENDP ; SH_CinematicVehicleFactoryBypass::Destroyed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ?Created@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z PROC ; SH_CinematicVehicleFactoryBypass::Created, COMDAT
; _this$ = ecx
...
; 41   :         hook_handle = AddVehiclePurchaseHook(PurchaseHook, (const char*)this);

	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	push	OFFSET ?PurchaseHook@SH_CinematicVehicleFactoryBypass@@SAHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z ; SH_CinematicVehicleFactoryBypass::PurchaseHook
	call	DWORD PTR ?AddVehiclePurchaseHook@@3P6AHP6AHPAVBaseControllerClass@@PAVScriptableGameObj@@IIPBD@Z2@ZA ; AddVehiclePurchaseHook
	add	esp, 8
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+28], eax

; 42   :         monitor_handle = AddVehiclePurchaseMonHook(PurchaseMonitor, (const char*)this);

	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	push	OFFSET ?PurchaseMonitor@SH_CinematicVehicleFactoryBypass@@SAXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z ; SH_CinematicVehicleFactoryBypass::PurchaseMonitor
	call	DWORD PTR ?AddVehiclePurchaseMonHook@@3P6AHP6AXPAVBaseControllerClass@@PAVScriptableGameObj@@IIIPBD@Z2@ZA ; AddVehiclePurchaseMonHook
	add	esp, 8
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+32], eax

; 43   :         preset_id = Get_Definition_ID(Get_Parameter("PresetName"));
...
; 44   :     }
	...
	pop	ebp
	ret	4
?Created@SH_CinematicVehicleFactoryBypass@@UAEXPAVScriptableGameObj@@@Z ENDP ; SH_CinematicVehicleFactoryBypass::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\sh_factory.cpp
;	COMDAT ??0SH_CinematicVehicleFactoryBypass@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0SH_CinematicVehicleFactoryBypass@@QAE@XZ PROC	; SH_CinematicVehicleFactoryBypass::SH_CinematicVehicleFactoryBypass, COMDAT
; _this$ = ecx
...
; 36   :     {
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7SH_CinematicVehicleFactoryBypass@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+28], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+32], 0
...
; 37   :     }
	...
	pop	ebp
	ret	0
??0SH_CinematicVehicleFactoryBypass@@QAE@XZ ENDP	; SH_CinematicVehicleFactoryBypass::SH_CinematicVehicleFactoryBypass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\basecontrollerclass.h
;	COMDAT ?Get_Player_Type@BaseControllerClass@@QBEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Player_Type@BaseControllerClass@@QBEHXZ PROC	; BaseControllerClass::Get_Player_Type, COMDAT
; _this$ = ecx
...
; 112  : 	}
	...
	pop	ebp
	ret	0
?Get_Player_Type@BaseControllerClass@@QBEHXZ ENDP	; BaseControllerClass::Get_Player_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
