...
PUBLIC	?Created@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@@Z ; NH_Spawn_Object_On_Poke::Created
PUBLIC	?Damaged@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@0M@Z ; NH_Spawn_Object_On_Poke::Damaged
PUBLIC	?Custom@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@HH0@Z ; NH_Spawn_Object_On_Poke::Custom
PUBLIC	?Timer_Expired@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@H@Z ; NH_Spawn_Object_On_Poke::Timer_Expired
PUBLIC	??0NH_Spawn_Object_On_Poke@@QAE@XZ		; NH_Spawn_Object_On_Poke::NH_Spawn_Object_On_Poke
PUBLIC	??1NH_Spawn_Object_On_Poke@@UAE@XZ		; NH_Spawn_Object_On_Poke::~NH_Spawn_Object_On_Poke
PUBLIC	??_GNH_Spawn_Object_On_Poke@@UAEPAXI@Z		; NH_Spawn_Object_On_Poke::`scalar deleting destructor'
PUBLIC	?Custom@NH_SetTeam_OnLeave@@EAEXPAVScriptableGameObj@@HH0@Z ; NH_SetTeam_OnLeave::Custom
PUBLIC	??0NH_SetTeam_OnLeave@@QAE@XZ			; NH_SetTeam_OnLeave::NH_SetTeam_OnLeave
PUBLIC	??1NH_SetTeam_OnLeave@@UAE@XZ			; NH_SetTeam_OnLeave::~NH_SetTeam_OnLeave
PUBLIC	??_GNH_SetTeam_OnLeave@@UAEPAXI@Z		; NH_SetTeam_OnLeave::`scalar deleting destructor'
PUBLIC	?Death@NH_Deploy_Building_On_Poke@@AAEXPAVScriptableGameObj@@0@Z ; NH_Deploy_Building_On_Poke::Death
PUBLIC	??0NH_Deploy_Building_On_Poke@@QAE@XZ		; NH_Deploy_Building_On_Poke::NH_Deploy_Building_On_Poke
PUBLIC	??1NH_Deploy_Building_On_Poke@@UAE@XZ		; NH_Deploy_Building_On_Poke::~NH_Deploy_Building_On_Poke
PUBLIC	??_GNH_Deploy_Building_On_Poke@@UAEPAXI@Z	; NH_Deploy_Building_On_Poke::`scalar deleting destructor'
PUBLIC	?Created@NH_Create_Buy_Panels@@EAEXPAVScriptableGameObj@@@Z ; NH_Create_Buy_Panels::Created
PUBLIC	?Death@NH_Create_Buy_Panels@@AAEXPAVScriptableGameObj@@0@Z ; NH_Create_Buy_Panels::Death
PUBLIC	?Register_Auto_Save_Variables@NH_Create_Buy_Panels@@UAEXXZ ; NH_Create_Buy_Panels::Register_Auto_Save_Variables
PUBLIC	??0NH_Create_Buy_Panels@@QAE@XZ			; NH_Create_Buy_Panels::NH_Create_Buy_Panels
PUBLIC	??1NH_Create_Buy_Panels@@UAE@XZ			; NH_Create_Buy_Panels::~NH_Create_Buy_Panels
PUBLIC	??_GNH_Create_Buy_Panels@@UAEPAXI@Z		; NH_Create_Buy_Panels::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_SetTeam_OnLeave>::ScriptRegistrant<NH_SetTeam_OnLeave>
PUBLIC	?Create@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NH_SetTeam_OnLeave>::Create
PUBLIC	??1?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAE@XZ ; ScriptRegistrant<NH_SetTeam_OnLeave>::~ScriptRegistrant<NH_SetTeam_OnLeave>
PUBLIC	??_G?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAXI@Z ; ScriptRegistrant<NH_SetTeam_OnLeave>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::ScriptRegistrant<NH_Spawn_Object_On_Poke>
PUBLIC	?Create@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::Create
PUBLIC	??1?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAE@XZ ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::~ScriptRegistrant<NH_Spawn_Object_On_Poke>
PUBLIC	??_G?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAXI@Z ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::ScriptRegistrant<NH_Deploy_Building_On_Poke>
PUBLIC	?Create@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::Create
PUBLIC	??1?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAE@XZ ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::~ScriptRegistrant<NH_Deploy_Building_On_Poke>
PUBLIC	??_G?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAXI@Z ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`scalar deleting destructor'
PUBLIC	??0?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_Create_Buy_Panels>::ScriptRegistrant<NH_Create_Buy_Panels>
PUBLIC	?Create@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAVScriptImpClass@@XZ ; ScriptRegistrant<NH_Create_Buy_Panels>::Create
PUBLIC	??1?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAE@XZ ; ScriptRegistrant<NH_Create_Buy_Panels>::~ScriptRegistrant<NH_Create_Buy_Panels>
PUBLIC	??_G?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAXI@Z ; ScriptRegistrant<NH_Create_Buy_Panels>::`scalar deleting destructor'
...
PUBLIC	??_7NH_Spawn_Object_On_Poke@@6B@		; NH_Spawn_Object_On_Poke::`vftable'
PUBLIC	??_7NH_SetTeam_OnLeave@@6B@			; NH_SetTeam_OnLeave::`vftable'
PUBLIC	??_7NH_Deploy_Building_On_Poke@@6B@		; NH_Deploy_Building_On_Poke::`vftable'
PUBLIC	??_7NH_Create_Buy_Panels@@6B@			; NH_Create_Buy_Panels::`vftable'
PUBLIC	??_C@_0L@FPLAAJEA@PresetName?$AA@		; `string'
PUBLIC	??_C@_0M@ECNBNOLO@Add_Vectors?$AA@		; `string'
PUBLIC	??_C@_0M@IPKOBAPD@BlamoKiller?$AA@		; `string'
PUBLIC	??_C@_0N@IGNLOKKA@Panel_1_Name?$AA@		; `string'
PUBLIC	??_C@_0BB@EMCLOODJ@Panel_1_Position?$AA@	; `string'
PUBLIC	??_C@_0N@LHDDPADN@Panel_2_Name?$AA@		; `string'
PUBLIC	??_C@_0BB@NFMJIIDI@Panel_2_Position?$AA@	; `string'
PUBLIC	??_C@_0N@BBEEPLIJ@Panel_3_Name?$AA@		; `string'
PUBLIC	??_C@_0BB@BEEHFHPI@Panel_3_Position?$AA@	; `string'
PUBLIC	??_C@_0N@NEODMFAH@Panel_4_Name?$AA@		; `string'
PUBLIC	??_C@_0BB@DNHMECHL@Panel_4_Position?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@ ; ScriptRegistrant<NH_SetTeam_OnLeave>::`vftable'
PUBLIC	?NH_SetTeam_OnLeave_Registrant@@3V?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@A ; NH_SetTeam_OnLeave_Registrant
PUBLIC	??_C@_00CNPNBAHC@?$AA@				; `string'
PUBLIC	??_C@_0BD@BGFKKGGL@NH_SetTeam_OnLeave?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@ ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`vftable'
PUBLIC	?NH_Spawn_Object_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@A ; NH_Spawn_Object_On_Poke_Registrant
PUBLIC	??_C@_0CG@KIJKFFMB@PresetName?3string?0Add_Vectors?3ve@ ; `string'
PUBLIC	??_C@_0BI@HEFBEJAC@NH_Spawn_Object_On_Poke?$AA@	; `string'
PUBLIC	??_7?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@ ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`vftable'
PUBLIC	?NH_Deploy_Building_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@A ; NH_Deploy_Building_On_Poke_Registrant
PUBLIC	??_C@_0BL@NKKGFHHD@NH_Deploy_Building_On_Poke?$AA@ ; `string'
PUBLIC	??_7?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@ ; ScriptRegistrant<NH_Create_Buy_Panels>::`vftable'
PUBLIC	?NH_Create_Buy_Panels_Registrant@@3V?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@A ; NH_Create_Buy_Panels_Registrant
PUBLIC	??_C@_0LE@LLOLENJA@Panel_1_Name?3string?0Panel_1_Posi@ ; `string'
PUBLIC	??_C@_0BF@BLJHHIAN@NH_Create_Buy_Panels?$AA@	; `string'
PUBLIC	??_C@_0DD@HPIGEMBL@ScriptRegistrant?$DMclass?5NH_SetTea@ ; `string'
...
PUBLIC	??_C@_0DI@BMDKGBLF@ScriptRegistrant?$DMclass?5NH_Spawn_@ ; `string'
PUBLIC	??_C@_0DL@KHOHMDKE@ScriptRegistrant?$DMclass?5NH_Deploy@ ; `string'
PUBLIC	??_C@_0DF@LJDCAGCH@ScriptRegistrant?$DMclass?5NH_Create@ ; `string'
...
PUBLIC	??_R4NH_Spawn_Object_On_Poke@@6B@		; NH_Spawn_Object_On_Poke::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNH_Spawn_Object_On_Poke@@@8		; NH_Spawn_Object_On_Poke `RTTI Type Descriptor'
PUBLIC	??_R3NH_Spawn_Object_On_Poke@@8			; NH_Spawn_Object_On_Poke::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NH_Spawn_Object_On_Poke@@8			; NH_Spawn_Object_On_Poke::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NH_Spawn_Object_On_Poke@@8	; NH_Spawn_Object_On_Poke::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NH_SetTeam_OnLeave@@6B@			; NH_SetTeam_OnLeave::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNH_SetTeam_OnLeave@@@8			; NH_SetTeam_OnLeave `RTTI Type Descriptor'
PUBLIC	??_R3NH_SetTeam_OnLeave@@8			; NH_SetTeam_OnLeave::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NH_SetTeam_OnLeave@@8			; NH_SetTeam_OnLeave::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NH_SetTeam_OnLeave@@8		; NH_SetTeam_OnLeave::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NH_Deploy_Building_On_Poke@@6B@		; NH_Deploy_Building_On_Poke::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNH_Deploy_Building_On_Poke@@@8		; NH_Deploy_Building_On_Poke `RTTI Type Descriptor'
PUBLIC	??_R3NH_Deploy_Building_On_Poke@@8		; NH_Deploy_Building_On_Poke::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NH_Deploy_Building_On_Poke@@8		; NH_Deploy_Building_On_Poke::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NH_Deploy_Building_On_Poke@@8	; NH_Deploy_Building_On_Poke::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4NH_Create_Buy_Panels@@6B@			; NH_Create_Buy_Panels::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVNH_Create_Buy_Panels@@@8		; NH_Create_Buy_Panels `RTTI Type Descriptor'
PUBLIC	??_R3NH_Create_Buy_Panels@@8			; NH_Create_Buy_Panels::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2NH_Create_Buy_Panels@@8			; NH_Create_Buy_Panels::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@NH_Create_Buy_Panels@@8		; NH_Create_Buy_Panels::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@ ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@@8 ; ScriptRegistrant<NH_SetTeam_OnLeave> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@ ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@@8 ; ScriptRegistrant<NH_Spawn_Object_On_Poke> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@ ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@@8 ; ScriptRegistrant<NH_Deploy_Building_On_Poke> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@ ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@@8 ; ScriptRegistrant<NH_Create_Buy_Panels> `RTTI Type Descriptor'
PUBLIC	??_R3?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	??_ENH_Spawn_Object_On_Poke@@UAEPAXI@Z:PROC	; NH_Spawn_Object_On_Poke::`vector deleting destructor'
EXTRN	??_ENH_SetTeam_OnLeave@@UAEPAXI@Z:PROC		; NH_SetTeam_OnLeave::`vector deleting destructor'
EXTRN	??_ENH_Deploy_Building_On_Poke@@UAEPAXI@Z:PROC	; NH_Deploy_Building_On_Poke::`vector deleting destructor'
EXTRN	??_ENH_Create_Buy_Panels@@UAEPAXI@Z:PROC	; NH_Create_Buy_Panels::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NH_SetTeam_OnLeave>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`vector deleting destructor'
EXTRN	??_E?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAXI@Z:PROC ; ScriptRegistrant<NH_Create_Buy_Panels>::`vector deleting destructor'
...
_BSS	SEGMENT
?NH_SetTeam_OnLeave_Registrant@@3V?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@A DB 010H DUP (?) ; NH_SetTeam_OnLeave_Registrant
?NH_Spawn_Object_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@A DB 010H DUP (?) ; NH_Spawn_Object_On_Poke_Registrant
?NH_Deploy_Building_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@A DB 010H DUP (?) ; NH_Deploy_Building_On_Poke_Registrant
?NH_Create_Buy_Panels_Registrant@@3V?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@A DB 010H DUP (?) ; NH_Create_Buy_Panels_Registrant
_BSS	ENDS
CRT$XCU	SEGMENT
_NH_SetTeam_OnLeave_Registrant$initializer$ DD FLAT:??__ENH_SetTeam_OnLeave_Registrant@@YAXXZ
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@@8 ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8 DD 00H ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NH_Create_Buy_Panels> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@ DD 00H ; ScriptRegistrant<NH_Create_Buy_Panels>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@@8 ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8 DD 00H ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NH_Deploy_Building_On_Poke> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@ DD 00H ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@@8 ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8 DD 00H ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NH_Spawn_Object_On_Poke> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@ DD 00H ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 DD FLAT:??_R0?AV?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@@8 ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8
rdata$r	SEGMENT
??_R2?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 DD FLAT:??_R1A@?0A@EA@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8
rdata$r	SEGMENT
??_R3?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8 DD 00H	; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@@8
_DATA	SEGMENT
??_R0?AV?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@@8 DD FLAT:??_7type_info@@6B@ ; ScriptRegistrant<NH_SetTeam_OnLeave> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@', 00H
_DATA	ENDS
;	COMDAT ??_R4?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@
rdata$r	SEGMENT
??_R4?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@ DD 00H ; ScriptRegistrant<NH_SetTeam_OnLeave>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@@8
	DD	FLAT:??_R3?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NH_Create_Buy_Panels@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NH_Create_Buy_Panels@@8 DD FLAT:??_R0?AVNH_Create_Buy_Panels@@@8 ; NH_Create_Buy_Panels::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NH_Create_Buy_Panels@@8
rdata$r	ENDS
;	COMDAT ??_R2NH_Create_Buy_Panels@@8
rdata$r	SEGMENT
??_R2NH_Create_Buy_Panels@@8 DD FLAT:??_R1A@?0A@EA@NH_Create_Buy_Panels@@8 ; NH_Create_Buy_Panels::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NH_Create_Buy_Panels@@8
rdata$r	SEGMENT
??_R3NH_Create_Buy_Panels@@8 DD 00H			; NH_Create_Buy_Panels::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NH_Create_Buy_Panels@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNH_Create_Buy_Panels@@@8
_DATA	SEGMENT
??_R0?AVNH_Create_Buy_Panels@@@8 DD FLAT:??_7type_info@@6B@ ; NH_Create_Buy_Panels `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNH_Create_Buy_Panels@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NH_Create_Buy_Panels@@6B@
rdata$r	SEGMENT
??_R4NH_Create_Buy_Panels@@6B@ DD 00H			; NH_Create_Buy_Panels::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNH_Create_Buy_Panels@@@8
	DD	FLAT:??_R3NH_Create_Buy_Panels@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NH_Deploy_Building_On_Poke@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NH_Deploy_Building_On_Poke@@8 DD FLAT:??_R0?AVNH_Deploy_Building_On_Poke@@@8 ; NH_Deploy_Building_On_Poke::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NH_Deploy_Building_On_Poke@@8
rdata$r	ENDS
;	COMDAT ??_R2NH_Deploy_Building_On_Poke@@8
rdata$r	SEGMENT
??_R2NH_Deploy_Building_On_Poke@@8 DD FLAT:??_R1A@?0A@EA@NH_Deploy_Building_On_Poke@@8 ; NH_Deploy_Building_On_Poke::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NH_Deploy_Building_On_Poke@@8
rdata$r	SEGMENT
??_R3NH_Deploy_Building_On_Poke@@8 DD 00H		; NH_Deploy_Building_On_Poke::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NH_Deploy_Building_On_Poke@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNH_Deploy_Building_On_Poke@@@8
_DATA	SEGMENT
??_R0?AVNH_Deploy_Building_On_Poke@@@8 DD FLAT:??_7type_info@@6B@ ; NH_Deploy_Building_On_Poke `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNH_Deploy_Building_On_Poke@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NH_Deploy_Building_On_Poke@@6B@
rdata$r	SEGMENT
??_R4NH_Deploy_Building_On_Poke@@6B@ DD 00H		; NH_Deploy_Building_On_Poke::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNH_Deploy_Building_On_Poke@@@8
	DD	FLAT:??_R3NH_Deploy_Building_On_Poke@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NH_SetTeam_OnLeave@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NH_SetTeam_OnLeave@@8 DD FLAT:??_R0?AVNH_SetTeam_OnLeave@@@8 ; NH_SetTeam_OnLeave::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NH_SetTeam_OnLeave@@8
rdata$r	ENDS
;	COMDAT ??_R2NH_SetTeam_OnLeave@@8
rdata$r	SEGMENT
??_R2NH_SetTeam_OnLeave@@8 DD FLAT:??_R1A@?0A@EA@NH_SetTeam_OnLeave@@8 ; NH_SetTeam_OnLeave::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NH_SetTeam_OnLeave@@8
rdata$r	SEGMENT
??_R3NH_SetTeam_OnLeave@@8 DD 00H			; NH_SetTeam_OnLeave::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NH_SetTeam_OnLeave@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNH_SetTeam_OnLeave@@@8
_DATA	SEGMENT
??_R0?AVNH_SetTeam_OnLeave@@@8 DD FLAT:??_7type_info@@6B@ ; NH_SetTeam_OnLeave `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNH_SetTeam_OnLeave@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NH_SetTeam_OnLeave@@6B@
rdata$r	SEGMENT
??_R4NH_SetTeam_OnLeave@@6B@ DD 00H			; NH_SetTeam_OnLeave::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNH_SetTeam_OnLeave@@@8
	DD	FLAT:??_R3NH_SetTeam_OnLeave@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@NH_Spawn_Object_On_Poke@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@NH_Spawn_Object_On_Poke@@8 DD FLAT:??_R0?AVNH_Spawn_Object_On_Poke@@@8 ; NH_Spawn_Object_On_Poke::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	03H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3NH_Spawn_Object_On_Poke@@8
rdata$r	ENDS
;	COMDAT ??_R2NH_Spawn_Object_On_Poke@@8
rdata$r	SEGMENT
??_R2NH_Spawn_Object_On_Poke@@8 DD FLAT:??_R1A@?0A@EA@NH_Spawn_Object_On_Poke@@8 ; NH_Spawn_Object_On_Poke::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@ScriptImpClass@@8
	DD	FLAT:??_R1A@?0A@EA@ScriptClass@@8
	DD	FLAT:??_R1A@?0A@EA@GameObjObserverClass@@8
rdata$r	ENDS
;	COMDAT ??_R3NH_Spawn_Object_On_Poke@@8
rdata$r	SEGMENT
??_R3NH_Spawn_Object_On_Poke@@8 DD 00H			; NH_Spawn_Object_On_Poke::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	04H
	DD	FLAT:??_R2NH_Spawn_Object_On_Poke@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVNH_Spawn_Object_On_Poke@@@8
_DATA	SEGMENT
??_R0?AVNH_Spawn_Object_On_Poke@@@8 DD FLAT:??_7type_info@@6B@ ; NH_Spawn_Object_On_Poke `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVNH_Spawn_Object_On_Poke@@', 00H
_DATA	ENDS
;	COMDAT ??_R4NH_Spawn_Object_On_Poke@@6B@
rdata$r	SEGMENT
??_R4NH_Spawn_Object_On_Poke@@6B@ DD 00H		; NH_Spawn_Object_On_Poke::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVNH_Spawn_Object_On_Poke@@@8
	DD	FLAT:??_R3NH_Spawn_Object_On_Poke@@8
rdata$r	ENDS
...
??_R4ScriptFactory@@6B@ DD 00H				; ScriptFactory::`RTTI Complete Object Locator'
	...
	DD	FLAT:??_R3ScriptFactory@@8
rdata$r	ENDS
;	COMDAT ??_C@_0DF@LJDCAGCH@ScriptRegistrant?$DMclass?5NH_Create@
CONST	SEGMENT
??_C@_0DF@LJDCAGCH@ScriptRegistrant?$DMclass?5NH_Create@ DB 'ScriptRegist'
	DB	'rant<class NH_Create_Buy_Panels>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DL@KHOHMDKE@ScriptRegistrant?$DMclass?5NH_Deploy@
CONST	SEGMENT
??_C@_0DL@KHOHMDKE@ScriptRegistrant?$DMclass?5NH_Deploy@ DB 'ScriptRegist'
	DB	'rant<class NH_Deploy_Building_On_Poke>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DI@BMDKGBLF@ScriptRegistrant?$DMclass?5NH_Spawn_@
CONST	SEGMENT
??_C@_0DI@BMDKGBLF@ScriptRegistrant?$DMclass?5NH_Spawn_@ DB 'ScriptRegist'
	DB	'rant<class NH_Spawn_Object_On_Poke>::Create', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0DD@HPIGEMBL@ScriptRegistrant?$DMclass?5NH_SetTea@
CONST	SEGMENT
??_C@_0DD@HPIGEMBL@ScriptRegistrant?$DMclass?5NH_SetTea@ DB 'ScriptRegist'
	DB	'rant<class NH_SetTeam_OnLeave>::Create', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@BLJHHIAN@NH_Create_Buy_Panels?$AA@
CONST	SEGMENT
??_C@_0BF@BLJHHIAN@NH_Create_Buy_Panels?$AA@ DB 'NH_Create_Buy_Panels', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0LE@LLOLENJA@Panel_1_Name?3string?0Panel_1_Posi@
CONST	SEGMENT
??_C@_0LE@LLOLENJA@Panel_1_Name?3string?0Panel_1_Posi@ DB 'Panel_1_Name:s'
	DB	'tring,Panel_1_Position:vector3,Panel_2_Name:string,Panel_2_Po'
	DB	'sition:vector3,Panel_3_Name:string,Panel_3_Position:vector3,P'
	DB	'anel_4_Name:string,Panel_4_Position:vector3', 00H ; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@ ; ScriptRegistrant<NH_Create_Buy_Panels>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BL@NKKGFHHD@NH_Deploy_Building_On_Poke?$AA@
CONST	SEGMENT
??_C@_0BL@NKKGFHHD@NH_Deploy_Building_On_Poke?$AA@ DB 'NH_Deploy_Building'
	DB	'_On_Poke', 00H				; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@ ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BI@HEFBEJAC@NH_Spawn_Object_On_Poke?$AA@
CONST	SEGMENT
??_C@_0BI@HEFBEJAC@NH_Spawn_Object_On_Poke?$AA@ DB 'NH_Spawn_Object_On_Po'
	DB	'ke', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0CG@KIJKFFMB@PresetName?3string?0Add_Vectors?3ve@
CONST	SEGMENT
??_C@_0CG@KIJKFFMB@PresetName?3string?0Add_Vectors?3ve@ DB 'PresetName:st'
	DB	'ring,Add_Vectors:vector3', 00H		; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@ ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BD@BGFKKGGL@NH_SetTeam_OnLeave?$AA@
CONST	SEGMENT
??_C@_0BD@BGFKKGGL@NH_SetTeam_OnLeave?$AA@ DB 'NH_SetTeam_OnLeave', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_00CNPNBAHC@?$AA@
CONST	SEGMENT
??_C@_00CNPNBAHC@?$AA@ DB 00H				; `string'
CONST	ENDS
;	COMDAT ??_7?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@
CONST	SEGMENT
??_7?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@ DD FLAT:??_R4?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@ ; ScriptRegistrant<NH_SetTeam_OnLeave>::`vftable'
	DD	FLAT:??_E?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAXI@Z
	DD	FLAT:?Create@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAVScriptImpClass@@XZ
CONST	ENDS
;	COMDAT ??_C@_0BB@DNHMECHL@Panel_4_Position?$AA@
CONST	SEGMENT
??_C@_0BB@DNHMECHL@Panel_4_Position?$AA@ DB 'Panel_4_Position', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@NEODMFAH@Panel_4_Name?$AA@
CONST	SEGMENT
??_C@_0N@NEODMFAH@Panel_4_Name?$AA@ DB 'Panel_4_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@BEEHFHPI@Panel_3_Position?$AA@
CONST	SEGMENT
??_C@_0BB@BEEHFHPI@Panel_3_Position?$AA@ DB 'Panel_3_Position', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@BBEEPLIJ@Panel_3_Name?$AA@
CONST	SEGMENT
??_C@_0N@BBEEPLIJ@Panel_3_Name?$AA@ DB 'Panel_3_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@NFMJIIDI@Panel_2_Position?$AA@
CONST	SEGMENT
??_C@_0BB@NFMJIIDI@Panel_2_Position?$AA@ DB 'Panel_2_Position', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LHDDPADN@Panel_2_Name?$AA@
CONST	SEGMENT
??_C@_0N@LHDDPADN@Panel_2_Name?$AA@ DB 'Panel_2_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@EMCLOODJ@Panel_1_Position?$AA@
CONST	SEGMENT
??_C@_0BB@EMCLOODJ@Panel_1_Position?$AA@ DB 'Panel_1_Position', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@IGNLOKKA@Panel_1_Name?$AA@
CONST	SEGMENT
??_C@_0N@IGNLOKKA@Panel_1_Name?$AA@ DB 'Panel_1_Name', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@IPKOBAPD@BlamoKiller?$AA@
CONST	SEGMENT
??_C@_0M@IPKOBAPD@BlamoKiller?$AA@ DB 'BlamoKiller', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@ECNBNOLO@Add_Vectors?$AA@
CONST	SEGMENT
??_C@_0M@ECNBNOLO@Add_Vectors?$AA@ DB 'Add_Vectors', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0L@FPLAAJEA@PresetName?$AA@
CONST	SEGMENT
??_C@_0L@FPLAAJEA@PresetName?$AA@ DB 'PresetName', 00H	; `string'
CONST	ENDS
;	COMDAT ??_7NH_Create_Buy_Panels@@6B@
CONST	SEGMENT
??_7NH_Create_Buy_Panels@@6B@ DD FLAT:??_R4NH_Create_Buy_Panels@@6B@ ; NH_Create_Buy_Panels::`vftable'
	DD	FLAT:??_ENH_Create_Buy_Panels@@UAEPAXI@Z
	...
	DD	FLAT:?Created@NH_Create_Buy_Panels@@EAEXPAVScriptableGameObj@@@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@NH_Create_Buy_Panels@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7NH_Deploy_Building_On_Poke@@6B@
CONST	SEGMENT
??_7NH_Deploy_Building_On_Poke@@6B@ DD FLAT:??_R4NH_Deploy_Building_On_Poke@@6B@ ; NH_Deploy_Building_On_Poke::`vftable'
	DD	FLAT:??_ENH_Deploy_Building_On_Poke@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
...
CONST	ENDS
;	COMDAT ??_7NH_SetTeam_OnLeave@@6B@
CONST	SEGMENT
??_7NH_SetTeam_OnLeave@@6B@ DD FLAT:??_R4NH_SetTeam_OnLeave@@6B@ ; NH_SetTeam_OnLeave::`vftable'
	DD	FLAT:??_ENH_SetTeam_OnLeave@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	...
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@ScriptImpClass@@UAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@NH_SetTeam_OnLeave@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@ScriptImpClass@@UAEXPAVScriptableGameObj@@H@Z
	...
	DD	FLAT:?Register_Auto_Save_Variables@ScriptImpClass@@UAEXXZ
CONST	ENDS
;	COMDAT ??_7NH_Spawn_Object_On_Poke@@6B@
CONST	SEGMENT
??_7NH_Spawn_Object_On_Poke@@6B@ DD FLAT:??_R4NH_Spawn_Object_On_Poke@@6B@ ; NH_Spawn_Object_On_Poke::`vftable'
	DD	FLAT:??_ENH_Spawn_Object_On_Poke@@UAEPAXI@Z
	DD	FLAT:?Get_Name@ScriptImpClass@@UAEPBDXZ
	DD	FLAT:?Attach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Detach@ScriptImpClass@@MAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Created@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Destroyed@ScriptImpClass@@UAEXPAVScriptableGameObj@@@Z
	DD	FLAT:?Killed@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Damaged@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@0M@Z
	DD	FLAT:?Custom@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@HH0@Z
	DD	FLAT:?Sound_Heard@ScriptImpClass@@UAEXPAVScriptableGameObj@@ABUCombatSound@@@Z
	DD	FLAT:?Enemy_Seen@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Action_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@HW4ActionCompleteReason@@@Z
	DD	FLAT:?Timer_Expired@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@H@Z
	DD	FLAT:?Animation_Complete@ScriptImpClass@@UAEXPAVScriptableGameObj@@PBD@Z
	DD	FLAT:?Poked@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Entered@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
	DD	FLAT:?Exited@ScriptImpClass@@UAEXPAVScriptableGameObj@@0@Z
...
CONST	ENDS
CRT$XCU	SEGMENT
_NH_Spawn_Object_On_Poke_Registrant$initializer$ DD FLAT:??__ENH_Spawn_Object_On_Poke_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_NH_Deploy_Building_On_Poke_Registrant$initializer$ DD FLAT:??__ENH_Deploy_Building_On_Poke_Registrant@@YAXXZ
CRT$XCU	ENDS
CRT$XCU	SEGMENT
_NH_Create_Buy_Panels_Registrant$initializer$ DD FLAT:??__ENH_Create_Buy_Panels_Registrant@@YAXXZ
CRT$XCU	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNH_Create_Buy_Panels_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNH_Create_Buy_Panels_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'NH_Create_Buy_Panels_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	...
	push	esi
	push	edi
	mov	ecx, OFFSET ?NH_Create_Buy_Panels_Registrant@@3V?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@A ; NH_Create_Buy_Panels_Registrant
	call	??1?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNH_Create_Buy_Panels_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'NH_Create_Buy_Panels_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ??__ENH_Create_Buy_Panels_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENH_Create_Buy_Panels_Registrant@@YAXXZ PROC	; `dynamic initializer for 'NH_Create_Buy_Panels_Registrant'', COMDAT

; 142  : ScriptRegistrant<NH_Create_Buy_Panels> NH_Create_Buy_Panels_Registrant("NH_Create_Buy_Panels","Panel_1_Name:string,Panel_1_Position:vector3,Panel_2_Name:string,Panel_2_Position:vector3,Panel_3_Name:string,Panel_3_Position:vector3,Panel_4_Name:string,Panel_4_Position:vector3");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0LE@LLOLENJA@Panel_1_Name?3string?0Panel_1_Posi@
	push	OFFSET ??_C@_0BF@BLJHHIAN@NH_Create_Buy_Panels?$AA@
	mov	ecx, OFFSET ?NH_Create_Buy_Panels_Registrant@@3V?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@A ; NH_Create_Buy_Panels_Registrant
	call	??0?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_Create_Buy_Panels>::ScriptRegistrant<NH_Create_Buy_Panels>
	push	OFFSET ??__FNH_Create_Buy_Panels_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NH_Create_Buy_Panels_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENH_Create_Buy_Panels_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'NH_Create_Buy_Panels_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NH_Create_Buy_Panels>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NH_Create_Buy_Panels>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAE@XZ PROC ; ScriptRegistrant<NH_Create_Buy_Panels>::~ScriptRegistrant<NH_Create_Buy_Panels>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAE@XZ ENDP ; ScriptRegistrant<NH_Create_Buy_Panels>::~ScriptRegistrant<NH_Create_Buy_Panels>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NH_Create_Buy_Panels>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DF@LJDCAGCH@ScriptRegistrant?$DMclass?5NH_Create@
	push	553					; 00000229H
...
$LN6@Create:
	...
	call	??0NH_Create_Buy_Panels@@QAE@XZ
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NH_Create_Buy_Panels>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NH_Create_Buy_Panels>::ScriptRegistrant<NH_Create_Buy_Panels>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNH_Create_Buy_Panels@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NH_Create_Buy_Panels>::ScriptRegistrant<NH_Create_Buy_Panels>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNH_Deploy_Building_On_Poke_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNH_Deploy_Building_On_Poke_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'NH_Deploy_Building_On_Poke_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NH_Deploy_Building_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@A ; NH_Deploy_Building_On_Poke_Registrant
	call	??1?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNH_Deploy_Building_On_Poke_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'NH_Deploy_Building_On_Poke_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ??__ENH_Deploy_Building_On_Poke_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENH_Deploy_Building_On_Poke_Registrant@@YAXXZ PROC	; `dynamic initializer for 'NH_Deploy_Building_On_Poke_Registrant'', COMDAT

; 141  : ScriptRegistrant<NH_Deploy_Building_On_Poke> NH_Deploy_Building_On_Poke_Registrant("NH_Deploy_Building_On_Poke","PresetName:string,Add_Vectors:vector3");
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0CG@KIJKFFMB@PresetName?3string?0Add_Vectors?3ve@
	push	OFFSET ??_C@_0BL@NKKGFHHD@NH_Deploy_Building_On_Poke?$AA@
	mov	ecx, OFFSET ?NH_Deploy_Building_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@A ; NH_Deploy_Building_On_Poke_Registrant
	call	??0?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::ScriptRegistrant<NH_Deploy_Building_On_Poke>
	push	OFFSET ??__FNH_Deploy_Building_On_Poke_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NH_Deploy_Building_On_Poke_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENH_Deploy_Building_On_Poke_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'NH_Deploy_Building_On_Poke_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAE@XZ PROC ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::~ScriptRegistrant<NH_Deploy_Building_On_Poke>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAE@XZ ENDP ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::~ScriptRegistrant<NH_Deploy_Building_On_Poke>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DL@KHOHMDKE@ScriptRegistrant?$DMclass?5NH_Deploy@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NH_Deploy_Building_On_Poke@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::ScriptRegistrant<NH_Deploy_Building_On_Poke>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNH_Deploy_Building_On_Poke@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NH_Deploy_Building_On_Poke>::ScriptRegistrant<NH_Deploy_Building_On_Poke>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNH_Spawn_Object_On_Poke_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNH_Spawn_Object_On_Poke_Registrant@@YAXXZ PROC	; `dynamic atexit destructor for 'NH_Spawn_Object_On_Poke_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NH_Spawn_Object_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@A ; NH_Spawn_Object_On_Poke_Registrant
	call	??1?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNH_Spawn_Object_On_Poke_Registrant@@YAXXZ ENDP	; `dynamic atexit destructor for 'NH_Spawn_Object_On_Poke_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ??__ENH_Spawn_Object_On_Poke_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENH_Spawn_Object_On_Poke_Registrant@@YAXXZ PROC	; `dynamic initializer for 'NH_Spawn_Object_On_Poke_Registrant'', COMDAT

; 140  : ScriptRegistrant<NH_Spawn_Object_On_Poke> NH_Spawn_Object_On_Poke_Registrant("NH_Spawn_Object_On_Poke","PresetName:string,Add_Vectors:vector3");
	...
	push	edi
	push	OFFSET ??_C@_0CG@KIJKFFMB@PresetName?3string?0Add_Vectors?3ve@
	push	OFFSET ??_C@_0BI@HEFBEJAC@NH_Spawn_Object_On_Poke?$AA@
	mov	ecx, OFFSET ?NH_Spawn_Object_On_Poke_Registrant@@3V?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@A ; NH_Spawn_Object_On_Poke_Registrant
	call	??0?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::ScriptRegistrant<NH_Spawn_Object_On_Poke>
	push	OFFSET ??__FNH_Spawn_Object_On_Poke_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NH_Spawn_Object_On_Poke_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENH_Spawn_Object_On_Poke_Registrant@@YAXXZ ENDP	; `dynamic initializer for 'NH_Spawn_Object_On_Poke_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAE@XZ PROC ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::~ScriptRegistrant<NH_Spawn_Object_On_Poke>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAE@XZ ENDP ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::~ScriptRegistrant<NH_Spawn_Object_On_Poke>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DI@BMDKGBLF@ScriptRegistrant?$DMclass?5NH_Spawn_@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NH_Spawn_Object_On_Poke@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::ScriptRegistrant<NH_Spawn_Object_On_Poke>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNH_Spawn_Object_On_Poke@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NH_Spawn_Object_On_Poke>::ScriptRegistrant<NH_Spawn_Object_On_Poke>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FNH_SetTeam_OnLeave_Registrant@@YAXXZ
text$yd	SEGMENT
??__FNH_SetTeam_OnLeave_Registrant@@YAXXZ PROC		; `dynamic atexit destructor for 'NH_SetTeam_OnLeave_Registrant'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?NH_SetTeam_OnLeave_Registrant@@3V?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@A ; NH_SetTeam_OnLeave_Registrant
	call	??1?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAE@XZ
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__FNH_SetTeam_OnLeave_Registrant@@YAXXZ ENDP		; `dynamic atexit destructor for 'NH_SetTeam_OnLeave_Registrant''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ??__ENH_SetTeam_OnLeave_Registrant@@YAXXZ
text$yc	SEGMENT
??__ENH_SetTeam_OnLeave_Registrant@@YAXXZ PROC		; `dynamic initializer for 'NH_SetTeam_OnLeave_Registrant'', COMDAT

; 139  : ScriptRegistrant<NH_SetTeam_OnLeave> NH_SetTeam_OnLeave_Registrant("NH_SetTeam_OnLeave","");
	...
	push	OFFSET ??_C@_0BD@BGFKKGGL@NH_SetTeam_OnLeave?$AA@
	mov	ecx, OFFSET ?NH_SetTeam_OnLeave_Registrant@@3V?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@A ; NH_SetTeam_OnLeave_Registrant
	call	??0?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@QAE@PBD0@Z ; ScriptRegistrant<NH_SetTeam_OnLeave>::ScriptRegistrant<NH_SetTeam_OnLeave>
	push	OFFSET ??__FNH_SetTeam_OnLeave_Registrant@@YAXXZ ; `dynamic atexit destructor for 'NH_SetTeam_OnLeave_Registrant''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__ENH_SetTeam_OnLeave_Registrant@@YAXXZ ENDP		; `dynamic initializer for 'NH_SetTeam_OnLeave_Registrant''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_G?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_G?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAXI@Z PROC ; ScriptRegistrant<NH_SetTeam_OnLeave>::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_G?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAXI@Z ENDP ; ScriptRegistrant<NH_SetTeam_OnLeave>::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAE@XZ PROC ; ScriptRegistrant<NH_SetTeam_OnLeave>::~ScriptRegistrant<NH_SetTeam_OnLeave>, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAE@XZ ENDP ; ScriptRegistrant<NH_SetTeam_OnLeave>::~ScriptRegistrant<NH_SetTeam_OnLeave>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ?Create@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAVScriptImpClass@@XZ
_TEXT	SEGMENT
tv77 = -84						; size = 4
tv79 = -80						; size = 4
$T1 = -76						; size = 4
_script$ = -8						; size = 4
_this$ = -4						; size = 4
?Create@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAVScriptImpClass@@XZ PROC ; ScriptRegistrant<NH_SetTeam_OnLeave>::Create, COMDAT
; _this$ = ecx
...
; 553  : 		T* script = new T;
	...
	push	OFFSET ??_C@_0DD@HPIGEMBL@ScriptRegistrant?$DMclass?5NH_SetTea@
	push	553					; 00000229H
	push	OFFSET ??_C@_0DD@KMKBFFOF@x?3?2github?2renegade?2dragonade_rxd@
	call	?SetThreadTrackingInformation@@YAXPBDI0@Z ; SetThreadTrackingInformation
	add	esp, 12					; 0000000cH
...
$LN6@Create:
	...
	je	SHORT $LN4@Create
	mov	ecx, DWORD PTR $T1[ebp]
	call	??0NH_SetTeam_OnLeave@@QAE@XZ
	mov	DWORD PTR tv77[ebp], eax
	jmp	SHORT $LN5@Create
$LN4@Create:
	mov	DWORD PTR tv77[ebp], 0
...
; 557  : 	}
	...
	pop	ebp
	ret	0
?Create@?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@UAEPAVScriptImpClass@@XZ ENDP ; ScriptRegistrant<NH_SetTeam_OnLeave>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scripts.h
;	COMDAT ??0?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@QAE@PBD0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_name$ = 8						; size = 4
_param$ = 12						; size = 4
??0?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@QAE@PBD0@Z PROC ; ScriptRegistrant<NH_SetTeam_OnLeave>::ScriptRegistrant<NH_SetTeam_OnLeave>, COMDAT
; _this$ = ecx
...
; 549  : 	{
	...
	call	??0ScriptFactory@@IAE@PBD0@Z		; ScriptFactory::ScriptFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@6B@
...
; 550  : 	}
	...
	pop	ebp
	ret	8
??0?$ScriptRegistrant@VNH_SetTeam_OnLeave@@@@QAE@PBD0@Z ENDP ; ScriptRegistrant<NH_SetTeam_OnLeave>::ScriptRegistrant<NH_SetTeam_OnLeave>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNH_Create_Buy_Panels@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNH_Create_Buy_Panels@@UAEPAXI@Z PROC		; NH_Create_Buy_Panels::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NH_Create_Buy_Panels@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNH_Create_Buy_Panels@@UAEPAXI@Z ENDP		; NH_Create_Buy_Panels::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NH_Create_Buy_Panels@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NH_Create_Buy_Panels@@UAE@XZ PROC			; NH_Create_Buy_Panels::~NH_Create_Buy_Panels, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NH_Create_Buy_Panels@@UAE@XZ ENDP			; NH_Create_Buy_Panels::~NH_Create_Buy_Panels
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NH_Create_Buy_Panels@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NH_Create_Buy_Panels@@QAE@XZ PROC			; NH_Create_Buy_Panels::NH_Create_Buy_Panels, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NH_Create_Buy_Panels@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NH_Create_Buy_Panels@@QAE@XZ ENDP			; NH_Create_Buy_Panels::NH_Create_Buy_Panels
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Register_Auto_Save_Variables@NH_Create_Buy_Panels@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Register_Auto_Save_Variables@NH_Create_Buy_Panels@@UAEXXZ PROC ; NH_Create_Buy_Panels::Register_Auto_Save_Variables, COMDAT
; _this$ = ecx
...
; 133  : 	Auto_Save_Variable(&panel1,4,1);
...
; 134  : 	Auto_Save_Variable(&panel1,4,2);
...
; 135  : 	Auto_Save_Variable(&panel1,4,3);
...
; 136  : 	Auto_Save_Variable(&panel1,4,4);
...
; 137  : }
	...
	pop	ebp
	ret	0
?Register_Auto_Save_Variables@NH_Create_Buy_Panels@@UAEXXZ ENDP ; NH_Create_Buy_Panels::Register_Auto_Save_Variables
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Death@NH_Create_Buy_Panels@@AAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_prm$ = -12						; size = 4
_msg$ = -8						; size = 4
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_killer$ = 12						; size = 4
?Death@NH_Create_Buy_Panels@@AAEXPAVScriptableGameObj@@0@Z PROC ; NH_Create_Buy_Panels::Death, COMDAT
; _this$ = ecx
...
; 123  : 	msg = 2223;
	...
	mov	DWORD PTR _msg$[ebp], 2223		; 000008afH

; 124  : 	prm = 0;

	mov	DWORD PTR _prm$[ebp], 0

; 125  : 	Commands->Send_Custom_Event(obj,Commands->Find_Object(panel1),msg,prm,0);
...
; 126  : 	Commands->Send_Custom_Event(obj,Commands->Find_Object(panel2),msg,prm,0);
...
; 127  : 	Commands->Send_Custom_Event(obj,Commands->Find_Object(panel3),msg,prm,0);
...
; 128  : 	Commands->Send_Custom_Event(obj,Commands->Find_Object(panel4),msg,prm,0);
...
; 129  : }
	...
	pop	ebp
	ret	8
?Death@NH_Create_Buy_Panels@@AAEXPAVScriptableGameObj@@0@Z ENDP ; NH_Create_Buy_Panels::Death
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Created@NH_Create_Buy_Panels@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
$T1 = -192						; size = 12
$T2 = -180						; size = 12
$T3 = -168						; size = 12
...
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NH_Create_Buy_Panels@@EAEXPAVScriptableGameObj@@@Z PROC ; NH_Create_Buy_Panels::Created, COMDAT
; _this$ = ecx
...
; 84   : 	Vector3 spawner;
	...
	lea	ecx, DWORD PTR _spawner$[ebp]
	call	??0Vector3@@QAE@XZ			; Vector3::Vector3

; 85   : 
; 86   : 	build = Get_Parameter("Panel_1_Name");

	push	OFFSET ??_C@_0N@IGNLOKKA@Panel_1_Name?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _build$[ebp], eax

; 87   : 	spawner = Commands->Get_Position(obj);
...
; 88   : 	position = Get_Vector3_Parameter("Panel_1_Position");

	push	OFFSET ??_C@_0BB@EMCLOODJ@Panel_1_Position?$AA@
...
; 89   : 	spawner.X = spawner.X + position.X;

	movss	xmm0, DWORD PTR _spawner$[ebp]
	addss	xmm0, DWORD PTR _position$[ebp]
	movss	DWORD PTR _spawner$[ebp], xmm0

; 90   : 	spawner.Y = spawner.Y + position.Y;

	movss	xmm0, DWORD PTR _spawner$[ebp+4]
	addss	xmm0, DWORD PTR _position$[ebp+4]
	movss	DWORD PTR _spawner$[ebp+4], xmm0

; 91   : 	spawner.Z = spawner.Z + position.Z;

	movss	xmm0, DWORD PTR _spawner$[ebp+8]
	addss	xmm0, DWORD PTR _position$[ebp+8]
	movss	DWORD PTR _spawner$[ebp+8], xmm0

; 92   : 	panel1 = Commands->Get_ID(Commands->Create_Object(build,spawner));

	lea	eax, DWORD PTR _spawner$[ebp]
	push	eax
...
; 93   : 
; 94   : 	build = Get_Parameter("Panel_2_Name");

	push	OFFSET ??_C@_0N@LHDDPADN@Panel_2_Name?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _build$[ebp], eax

; 95   : 	spawner = Commands->Get_Position(obj);
...
; 96   : 	position = Get_Vector3_Parameter("Panel_2_Position");

	push	OFFSET ??_C@_0BB@NFMJIIDI@Panel_2_Position?$AA@
...
; 97   : 	spawner.X = spawner.X + position.X;

	movss	xmm0, DWORD PTR _spawner$[ebp]
	addss	xmm0, DWORD PTR _position$[ebp]
	movss	DWORD PTR _spawner$[ebp], xmm0

; 98   : 	spawner.Y = spawner.Y + position.Y;

	movss	xmm0, DWORD PTR _spawner$[ebp+4]
	addss	xmm0, DWORD PTR _position$[ebp+4]
	movss	DWORD PTR _spawner$[ebp+4], xmm0

; 99   : 	spawner.Z = spawner.Z + position.Z;

	movss	xmm0, DWORD PTR _spawner$[ebp+8]
	addss	xmm0, DWORD PTR _position$[ebp+8]
	movss	DWORD PTR _spawner$[ebp+8], xmm0

; 100  : 	panel2 = Commands->Get_ID(Commands->Create_Object(build,spawner));
...
; 101  : 
; 102  : 	build = Get_Parameter("Panel_3_Name");

	push	OFFSET ??_C@_0N@BBEEPLIJ@Panel_3_Name?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _build$[ebp], eax

; 103  : 	spawner = Commands->Get_Position(obj);
...
; 104  : 	position = Get_Vector3_Parameter("Panel_3_Position");

	push	OFFSET ??_C@_0BB@BEEHFHPI@Panel_3_Position?$AA@
...
; 105  : 	spawner.X = spawner.X + position.X;

	movss	xmm0, DWORD PTR _spawner$[ebp]
	addss	xmm0, DWORD PTR _position$[ebp]
	movss	DWORD PTR _spawner$[ebp], xmm0

; 106  : 	spawner.Y = spawner.Y + position.Y;

	movss	xmm0, DWORD PTR _spawner$[ebp+4]
	addss	xmm0, DWORD PTR _position$[ebp+4]
	movss	DWORD PTR _spawner$[ebp+4], xmm0

; 107  : 	spawner.Z = spawner.Z + position.Z;

	movss	xmm0, DWORD PTR _spawner$[ebp+8]
	addss	xmm0, DWORD PTR _position$[ebp+8]
	movss	DWORD PTR _spawner$[ebp+8], xmm0

; 108  : 	panel3 = Commands->Get_ID(Commands->Create_Object(build,spawner));
...
; 109  : 
; 110  : 	build = Get_Parameter("Panel_4_Name");

	push	OFFSET ??_C@_0N@NEODMFAH@Panel_4_Name?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Parameter@ScriptImpClass@@QAEPBDPBD@Z ; ScriptImpClass::Get_Parameter
	mov	DWORD PTR _build$[ebp], eax

; 111  : 	spawner = Commands->Get_Position(obj);
...
; 112  : 	position = Get_Vector3_Parameter("Panel_4_Position");

	push	OFFSET ??_C@_0BB@DNHMECHL@Panel_4_Position?$AA@
...
; 113  : 	spawner.X = spawner.X + position.X;

	movss	xmm0, DWORD PTR _spawner$[ebp]
	addss	xmm0, DWORD PTR _position$[ebp]
	movss	DWORD PTR _spawner$[ebp], xmm0

; 114  : 	spawner.Y = spawner.Y + position.Y;

	movss	xmm0, DWORD PTR _spawner$[ebp+4]
	addss	xmm0, DWORD PTR _position$[ebp+4]
	movss	DWORD PTR _spawner$[ebp+4], xmm0

; 115  : 	spawner.Z = spawner.Z + position.Z;

	movss	xmm0, DWORD PTR _spawner$[ebp+8]
	addss	xmm0, DWORD PTR _position$[ebp+8]
	movss	DWORD PTR _spawner$[ebp+8], xmm0

; 116  : 	panel4 = Commands->Get_ID(Commands->Create_Object(build,spawner));
...
; 117  : }
	...
	pop	ebp
	ret	4
?Created@NH_Create_Buy_Panels@@EAEXPAVScriptableGameObj@@@Z ENDP ; NH_Create_Buy_Panels::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNH_Deploy_Building_On_Poke@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNH_Deploy_Building_On_Poke@@UAEPAXI@Z PROC		; NH_Deploy_Building_On_Poke::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NH_Deploy_Building_On_Poke@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNH_Deploy_Building_On_Poke@@UAEPAXI@Z ENDP		; NH_Deploy_Building_On_Poke::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NH_Deploy_Building_On_Poke@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NH_Deploy_Building_On_Poke@@UAE@XZ PROC		; NH_Deploy_Building_On_Poke::~NH_Deploy_Building_On_Poke, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NH_Deploy_Building_On_Poke@@UAE@XZ ENDP		; NH_Deploy_Building_On_Poke::~NH_Deploy_Building_On_Poke
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NH_Deploy_Building_On_Poke@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NH_Deploy_Building_On_Poke@@QAE@XZ PROC		; NH_Deploy_Building_On_Poke::NH_Deploy_Building_On_Poke, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NH_Deploy_Building_On_Poke@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NH_Deploy_Building_On_Poke@@QAE@XZ ENDP		; NH_Deploy_Building_On_Poke::NH_Deploy_Building_On_Poke
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Death@NH_Deploy_Building_On_Poke@@AAEXPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
$T1 = -120						; size = 12
$T2 = -108						; size = 12
_spawner$ = -32						; size = 12
...
_obj$ = 8						; size = 4
_killer$ = 12						; size = 4
?Death@NH_Deploy_Building_On_Poke@@AAEXPAVScriptableGameObj@@0@Z PROC ; NH_Deploy_Building_On_Poke::Death, COMDAT
; _this$ = ecx
...
; 71   : 	build = Get_Parameter("PresetName");
...
; 72   : 	position = Commands->Get_Position(obj);
...
; 73   : 	spawner = Get_Vector3_Parameter("Add_Vectors");

	push	OFFSET ??_C@_0M@ECNBNOLO@Add_Vectors?$AA@
	lea	eax, DWORD PTR $T2[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Vector3_Parameter@ScriptImpClass@@QAE?AVVector3@@PBD@Z ; ScriptImpClass::Get_Vector3_Parameter
...
; 74   : 	position.X = spawner.X + position.X;

	movss	xmm0, DWORD PTR _spawner$[ebp]
	addss	xmm0, DWORD PTR _position$[ebp]
	movss	DWORD PTR _position$[ebp], xmm0

; 75   : 	position.Y = spawner.Y + position.Y;

	movss	xmm0, DWORD PTR _spawner$[ebp+4]
	addss	xmm0, DWORD PTR _position$[ebp+4]
	movss	DWORD PTR _position$[ebp+4], xmm0

; 76   : 	position.Z = spawner.Z + position.Z;

	movss	xmm0, DWORD PTR _spawner$[ebp+8]
	addss	xmm0, DWORD PTR _position$[ebp+8]
	movss	DWORD PTR _position$[ebp+8], xmm0

; 77   : 	Commands->Set_Facing(Commands->Create_Object(build,position),Commands->Get_Facing(obj));
...
; 78   : }
	...
	pop	ebp
	ret	8
?Death@NH_Deploy_Building_On_Poke@@AAEXPAVScriptableGameObj@@0@Z ENDP ; NH_Deploy_Building_On_Poke::Death
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNH_SetTeam_OnLeave@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNH_SetTeam_OnLeave@@UAEPAXI@Z PROC			; NH_SetTeam_OnLeave::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NH_SetTeam_OnLeave@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNH_SetTeam_OnLeave@@UAEPAXI@Z ENDP			; NH_SetTeam_OnLeave::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NH_SetTeam_OnLeave@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NH_SetTeam_OnLeave@@UAE@XZ PROC			; NH_SetTeam_OnLeave::~NH_SetTeam_OnLeave, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NH_SetTeam_OnLeave@@UAE@XZ ENDP			; NH_SetTeam_OnLeave::~NH_SetTeam_OnLeave
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NH_SetTeam_OnLeave@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NH_SetTeam_OnLeave@@QAE@XZ PROC			; NH_SetTeam_OnLeave::NH_SetTeam_OnLeave, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NH_SetTeam_OnLeave@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NH_SetTeam_OnLeave@@QAE@XZ ENDP			; NH_SetTeam_OnLeave::NH_SetTeam_OnLeave
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Custom@NH_SetTeam_OnLeave@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@NH_SetTeam_OnLeave@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; NH_SetTeam_OnLeave::Custom, COMDAT
; _this$ = ecx
...
; 60   : 	if (type == CUSTOM_EVENT_VEHICLE_EXITED)

	cmp	DWORD PTR _type$[ebp], 1000000029	; 3b9aca1dH
	jne	SHORT $LN2@Custom

; 61   : 	{
; 62   : 		Commands->Set_Player_Type(obj,Commands->Get_Player_Type(sender));
...
; 64   : }
	...
	pop	ebp
	ret	16					; 00000010H
?Custom@NH_SetTeam_OnLeave@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; NH_SetTeam_OnLeave::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??_GNH_Spawn_Object_On_Poke@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GNH_Spawn_Object_On_Poke@@UAEPAXI@Z PROC		; NH_Spawn_Object_On_Poke::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1NH_Spawn_Object_On_Poke@@UAE@XZ
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
	je	SHORT $LN1@scalar
	mov	eax, DWORD PTR _this$[ebp]
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GNH_Spawn_Object_On_Poke@@UAEPAXI@Z ENDP		; NH_Spawn_Object_On_Poke::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??1NH_Spawn_Object_On_Poke@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1NH_Spawn_Object_On_Poke@@UAE@XZ PROC			; NH_Spawn_Object_On_Poke::~NH_Spawn_Object_On_Poke, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	0
??1NH_Spawn_Object_On_Poke@@UAE@XZ ENDP			; NH_Spawn_Object_On_Poke::~NH_Spawn_Object_On_Poke
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0NH_Spawn_Object_On_Poke@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0NH_Spawn_Object_On_Poke@@QAE@XZ PROC			; NH_Spawn_Object_On_Poke::NH_Spawn_Object_On_Poke, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	call	??0ScriptImpClass@@QAE@XZ		; ScriptImpClass::ScriptImpClass
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7NH_Spawn_Object_On_Poke@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0NH_Spawn_Object_On_Poke@@QAE@XZ ENDP			; NH_Spawn_Object_On_Poke::NH_Spawn_Object_On_Poke
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Timer_Expired@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_number$ = 12						; size = 4
?Timer_Expired@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@H@Z PROC ; NH_Spawn_Object_On_Poke::Timer_Expired, COMDAT
; _this$ = ecx
...
; 49   : 	Commands->Start_Timer(obj,this,5.00,1);
...
; 50   : }
	...
	pop	ebp
	ret	8
?Timer_Expired@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@H@Z ENDP ; NH_Spawn_Object_On_Poke::Timer_Expired
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Custom@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@HH0@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
_type$ = 12						; size = 4
_param$ = 16						; size = 4
_sender$ = 20						; size = 4
?Custom@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@HH0@Z PROC ; NH_Spawn_Object_On_Poke::Custom, COMDAT
; _this$ = ecx
...
; 55   : 	Commands->Apply_Damage(obj,10000,"BlamoKiller",0);
...
; 56   : }
	...
	pop	ebp
	ret	16					; 00000010H
?Custom@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@HH0@Z ENDP ; NH_Spawn_Object_On_Poke::Custom
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Damaged@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@0M@Z
_TEXT	SEGMENT
$T1 = -120						; size = 12
$T2 = -108						; size = 12
_spawner$ = -32						; size = 12
...
_damager$ = 12						; size = 4
_amount$ = 16						; size = 4
?Damaged@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@0M@Z PROC ; NH_Spawn_Object_On_Poke::Damaged, COMDAT
; _this$ = ecx
...
; 31   : 	build = Get_Parameter("PresetName");
...
; 32   : 	position = Commands->Get_Position(obj);
...
; 33   : 	spawner = Get_Vector3_Parameter("Add_Vectors");
...
; 34   : 
; 35   : 	position.X = spawner.X + position.X;

	movss	xmm0, DWORD PTR _spawner$[ebp]
	addss	xmm0, DWORD PTR _position$[ebp]
	movss	DWORD PTR _position$[ebp], xmm0

; 36   : 	position.Y = spawner.Y + position.Y;

	movss	xmm0, DWORD PTR _spawner$[ebp+4]
	addss	xmm0, DWORD PTR _position$[ebp+4]
	movss	DWORD PTR _position$[ebp+4], xmm0

; 37   : 	position.Z = spawner.Z + position.Z;

	movss	xmm0, DWORD PTR _spawner$[ebp+8]
	addss	xmm0, DWORD PTR _position$[ebp+8]
	movss	DWORD PTR _position$[ebp+8], xmm0

; 38   : 	if (!CheckPlayerType(damager,0))
...
; 39   : 	{
; 40   : 		Commands->Create_Object(build,position);
...
; 42   : 		Commands->Start_Timer(obj,this,5.00,1);
...
; 44   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?Damaged@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@0M@Z ENDP ; NH_Spawn_Object_On_Poke::Damaged
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\nh.cpp
;	COMDAT ?Created@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Created@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@@Z PROC ; NH_Spawn_Object_On_Poke::Created, COMDAT
; _this$ = ecx
...
; 20   : 	Commands->Enable_HUD_Pokable_Indicator(obj,1);
...
; 21   : }
	...
	pop	ebp
	ret	4
?Created@NH_Spawn_Object_On_Poke@@EAEXPAVScriptableGameObj@@@Z ENDP ; NH_Spawn_Object_On_Poke::Created
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
