; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\ReferencerClass.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??1ReferencerClass@@UAE@XZ			; ReferencerClass::~ReferencerClass
PUBLIC	?On_Post_Load@ReferencerClass@@UAEXXZ		; ReferencerClass::On_Post_Load
PUBLIC	??4ReferencerClass@@QAEAAV0@PAVScriptableGameObj@@@Z ; ReferencerClass::operator=
PUBLIC	??4ReferencerClass@@QAEAAV0@ABV0@@Z		; ReferencerClass::operator=
PUBLIC	??BReferencerClass@@QBEPAVScriptableGameObj@@XZ	; ReferencerClass::operator ScriptableGameObj *
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\referencerclass.cpp
;	COMDAT ??BReferencerClass@@QBEPAVScriptableGameObj@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??BReferencerClass@@QBEPAVScriptableGameObj@@XZ PROC	; ReferencerClass::operator ScriptableGameObj *, COMDAT
; _this$ = ecx
...
; 79   : }
	...
	pop	ebp
	ret	0
??BReferencerClass@@QBEPAVScriptableGameObj@@XZ ENDP	; ReferencerClass::operator ScriptableGameObj *
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\referencerclass.cpp
;	COMDAT ??4ReferencerClass@@QAEAAV0@ABV0@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_referencer$ = 8					; size = 4
??4ReferencerClass@@QAEAAV0@ABV0@@Z PROC		; ReferencerClass::operator=, COMDAT
; _this$ = ecx
...
; 38   :    *this = referencer.Get_Ptr();

	mov	ecx, DWORD PTR _referencer$[ebp]
	call	?Get_Ptr@ReferencerClass@@QBEPAVScriptableGameObj@@XZ ; ReferencerClass::Get_Ptr
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??4ReferencerClass@@QAEAAV0@PAVScriptableGameObj@@@Z ; ReferencerClass::operator=
...
; 40   : }
	...
	pop	ebp
	ret	4
??4ReferencerClass@@QAEAAV0@ABV0@@Z ENDP		; ReferencerClass::operator=
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\referencerclass.cpp
;	COMDAT ??4ReferencerClass@@QAEAAV0@PAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv90 = -76						; size = 4
_referencer$1 = -8					; size = 4
_this$ = -4						; size = 4
_object$ = 8						; size = 4
??4ReferencerClass@@QAEAAV0@PAVScriptableGameObj@@@Z PROC ; ReferencerClass::operator=, COMDAT
; _this$ = ecx
...
; 47   :    if (ReferenceTarget)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 0
	je	SHORT $LN8@operator

; 48   :       if (ReferenceTarget->ReferencerListHead == this)
...
; 49   :       {
; 50   :          ReferenceTarget->ReferencerListHead = this->TargetReferencerListNext;
...
; 51   :          ReferenceTarget = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], 0

; 52   :          TargetReferencerListNext   = 0;
...
; 55   :          for (ReferencerClass* referencer = ReferenceTarget->ReferencerListHead; referencer; referencer = referencer->TargetReferencerListNext)

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR _referencer$1[ebp], edx
	jmp	SHORT $LN5@operator
$LN4@operator:
	mov	eax, DWORD PTR _referencer$1[ebp]
	mov	ecx, DWORD PTR [eax+12]
	mov	DWORD PTR _referencer$1[ebp], ecx
$LN5@operator:
	cmp	DWORD PTR _referencer$1[ebp], 0
	je	SHORT $LN8@operator

; 56   :             if (referencer->TargetReferencerListNext == this)
...
; 57   :             {
; 58   :                referencer->TargetReferencerListNext = this->TargetReferencerListNext;
...
; 59   : 
; 60   :                ReferenceTarget = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], 0

; 61   :                TargetReferencerListNext   = 0;
...
; 69   :       TargetReferencerListNext    = object->ReferencerListHead;
...
; 70   :       object->ReferencerListHead = this;
...
; 74   : }
	...
	pop	ebp
	ret	4
??4ReferencerClass@@QAEAAV0@PAVScriptableGameObj@@@Z ENDP ; ReferencerClass::operator=
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\referencerclass.cpp
;	COMDAT ?On_Post_Load@ReferencerClass@@UAEXXZ
_TEXT	SEGMENT
_tempObject$1 = -8					; size = 4
_this$ = -4						; size = 4
?On_Post_Load@ReferencerClass@@UAEXXZ PROC		; ReferencerClass::On_Post_Load, COMDAT
; _this$ = ecx
...
; 24   :    if (ReferenceTarget)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 0
	je	SHORT $LN2@On_Post_Lo

; 25   :    {
; 26   :       ScriptableGameObj* tempObject = ReferenceTarget->ReferenceData;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _tempObject$1[ebp], edx

; 27   :       ReferenceTarget = 0;
...
; 29   :       *this = tempObject;
	...
	mov	eax, DWORD PTR _tempObject$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??4ReferencerClass@@QAEAAV0@PAVScriptableGameObj@@@Z ; ReferencerClass::operator=
$LN2@On_Post_Lo:
...
; 31   : }
	...
	pop	ebp
	ret	0
?On_Post_Load@ReferencerClass@@UAEXXZ ENDP		; ReferencerClass::On_Post_Load
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\referencerclass.cpp
;	COMDAT ??1ReferencerClass@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1ReferencerClass@@UAE@XZ PROC				; ReferencerClass::~ReferencerClass, COMDAT
; _this$ = ecx
...
; 18   : }
	...
	pop	ebp
	ret	0
??1ReferencerClass@@UAE@XZ ENDP				; ReferencerClass::~ReferencerClass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
