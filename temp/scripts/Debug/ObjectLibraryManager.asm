; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\ObjectLibraryManager.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@PBD@Z ; ObjectLibraryManager::Create_Object
PUBLIC	?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@I@Z ; ObjectLibraryManager::Create_Object
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\objectlibrarymanager.cpp
;	COMDAT ?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@I@Z
_TEXT	SEGMENT
$T1 = -80						; size = 4
$T2 = -76						; size = 4
_oError$ = -8						; size = 4
_oDefinition$ = -4					; size = 4
_uDefinitionID$ = 8					; size = 4
?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@I@Z PROC ; ObjectLibraryManager::Create_Object, COMDAT
...
; 24   :    DefinitionClass* oDefinition = DefinitionMgrClass::Find_Definition (uDefinitionID, true);

	push	1
	mov	eax, DWORD PTR _uDefinitionID$[ebp]
	push	eax
	call	DWORD PTR __imp_?Find_Definition@DefinitionMgrClass@@SAPAVDefinitionClass@@I_N@Z
	add	esp, 8
	mov	DWORD PTR _oDefinition$[ebp], eax

; 25   : 
; 26   :    StringClass oError;

	push	0
	push	0
	lea	ecx, DWORD PTR _oError$[ebp]
	call	??0StringClass@@QAE@H_N@Z		; StringClass::StringClass

; 27   :    if (!oDefinition || !oDefinition->Is_Valid_Config (oError))

	cmp	DWORD PTR _oDefinition$[ebp], 0
	je	SHORT $LN1@Create_Obj
	lea	eax, DWORD PTR _oError$[ebp]
	push	eax
	mov	ecx, DWORD PTR _oDefinition$[ebp]
...
; 28   :       return 0;
	...
	jmp	SHORT $LN3@Create_Obj
$LN2@Create_Obj:

; 29   : 
; 30   :    return (PhysicalGameObj *)oDefinition->Create();

	mov	eax, DWORD PTR _oDefinition$[ebp]
...
; 31   : }
	...
	pop	ebp
	ret	0
?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@I@Z ENDP ; ObjectLibraryManager::Create_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\objectlibrarymanager.cpp
;	COMDAT ?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@PBD@Z
_TEXT	SEGMENT
$T1 = -80						; size = 4
$T2 = -76						; size = 4
_oError$ = -8						; size = 4
_oDefinition$ = -4					; size = 4
_cPresetName$ = 8					; size = 4
?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@PBD@Z PROC ; ObjectLibraryManager::Create_Object, COMDAT
...
; 9    :    // const DefinitionClass* oDefinition = DefinitionMgrClass::Find_Typed_Definition (cPresetName, 12288, true);
; 10   :    DefinitionClass* oDefinition = DefinitionMgrClass::Find_Named_Definition (cPresetName, true);

	push	1
	mov	eax, DWORD PTR _cPresetName$[ebp]
	push	eax
...
; 13   :    if (!oDefinition || !oDefinition->Is_Valid_Config (oError))
...
; 15   : 
; 16   :    return (PhysicalGameObj *)oDefinition->Create();
...
; 17   : }
	...
	pop	ebp
	ret	0
?Create_Object@ObjectLibraryManager@@SAPAVPhysicalGameObj@@PBD@Z ENDP ; ObjectLibraryManager::Create_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
