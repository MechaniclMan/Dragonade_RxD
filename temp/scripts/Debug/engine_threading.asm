; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\engine_threading.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?SetThreadName@@YAXKPBD@Z			; SetThreadName
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__sehtable$?SetThreadName@@YAXKPBD@Z DD 0ffffffffH
	DD	FLAT:$LN10@SetThreadN
	DD	FLAT:$LN6@SetThreadN
xdata$x	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_threading.cpp
;	COMDAT ?SetThreadName@@YAXKPBD@Z
_TEXT	SEGMENT
_info$ = -40						; size = 16
__$SEHRec$ = -24					; size = 24
_dwThreadID$ = 8					; size = 4
_szThreadName$ = 12					; size = 4
?SetThreadName@@YAXKPBD@Z PROC				; SetThreadName, COMDAT
...
; 17   : {
	...
	mov	ebp, esp
	push	-1
	push	OFFSET __sehtable$?SetThreadName@@YAXKPBD@Z
	push	OFFSET __except_handler3
	mov	eax, DWORD PTR fs:0
	push	eax
	mov	DWORD PTR fs:0, esp
	add	esp, -88				; ffffffa8H
	push	ebx
	push	esi
	push	edi
...
; 23   : 		info.dwType = 0x1000;
	...
	mov	DWORD PTR _info$[ebp], 4096		; 00001000H

; 24   : 		info.szName = szThreadName;

	mov	eax, DWORD PTR _szThreadName$[ebp]
	mov	DWORD PTR _info$[ebp+4], eax

; 25   : 		info.dwThreadID = dwThreadID;

	mov	eax, DWORD PTR _dwThreadID$[ebp]
...
; 29   : 	{
; 30   : 		RaiseException( 0x406D1388, 0, sizeof(info)/sizeof(DWORD), (DWORD*)&info );

	lea	eax, DWORD PTR _info$[ebp]
	push	eax
	push	4
	push	0
	push	1080890248				; 406d1388H
	call	DWORD PTR __imp__RaiseException@16

; 31   : 	}

	mov	DWORD PTR __$SEHRec$[ebp+20], -1
	jmp	SHORT $LN4@SetThreadN
$LN5@SetThreadN:
$LN10@SetThreadN:

; 32   : #pragma warning(suppress: 6312) //warning C6312: Possible infinite loop: use of the constant EXCEPTION_CONTINUE_EXECUTION in the exception-filter expression of a try-except
; 33   : 	__except (EXCEPTION_CONTINUE_EXECUTION)
...
; 34   : #pragma warning(suppress: 6322) //warning C6322: empty _except block
; 35   : 	{
; 36   : 	}
...
; 38   : }
	...
	pop	ebp
	ret	0
?SetThreadName@@YAXKPBD@Z ENDP				; SetThreadName
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
