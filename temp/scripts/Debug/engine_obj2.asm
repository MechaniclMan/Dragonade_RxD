; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	X:\GitHub\Renegade\Dragonade_RxD\scripts\engine_obj2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Normalize@@YA?AVVector3@@ABV1@@Z		; Normalize
...
PUBLIC	?Is_Delete_Pending@NetworkObjectClass@@QAE_NXZ	; NetworkObjectClass::Is_Delete_Pending
...
PUBLIC	??0CastResultStruct@@QAE@XZ			; CastResultStruct::CastResultStruct
PUBLIC	?Reset@CastResultStruct@@QAEXXZ			; CastResultStruct::Reset
PUBLIC	?Get_Position@PhysClass@@QBEXPAVVector3@@@Z	; PhysClass::Get_Position
PUBLIC	?Inc_Ignore_Counter@PhysClass@@QAEXXZ		; PhysClass::Inc_Ignore_Counter
PUBLIC	?Dec_Ignore_Counter@PhysClass@@QAEXXZ		; PhysClass::Dec_Ignore_Counter
...
PUBLIC	?Is_Acting@ActionClass@@QAE_NXZ			; ActionClass::Is_Acting
PUBLIC	?Has_Player@SmartGameObj@@QAE_NXZ		; SmartGameObj::Has_Player
PUBLIC	?Is_Human_Controlled@SmartGameObj@@QAE_NXZ	; SmartGameObj::Is_Human_Controlled
PUBLIC	?Is_Obj_Visible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z ; SmartGameObj::Is_Obj_Visible
PUBLIC	?Is_Splash_Possible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z ; SmartGameObj::Is_Splash_Possible
PUBLIC	?Is_Stealth_Enabled@SmartGameObj@@QAE_NXZ	; SmartGameObj::Is_Stealth_Enabled
PUBLIC	?Is_Stealthed@SmartGameObj@@QBE_NXZ		; SmartGameObj::Is_Stealthed
...
PUBLIC	??4OBBoxClass@@QAEAAV0@ABV0@@Z			; OBBoxClass::operator=
PUBLIC	?Is_Spy@SoldierGameObjDef@@QBE_NXZ		; SoldierGameObjDef::Is_Spy
PUBLIC	?Is_Unsquishable@SoldierGameObjDef@@QBE_NXZ	; SoldierGameObjDef::Is_Unsquishable
PUBLIC	?Get_Vehicle@SoldierGameObj@@QAEPAVVehicleGameObj@@XZ ; SoldierGameObj::Get_Vehicle
PUBLIC	?Get_Fly_Mode@SoldierGameObj@@QAE_NXZ		; SoldierGameObj::Get_Fly_Mode
...
PUBLIC	?Get_Definition@VehicleGameObj@@QBEABVVehicleGameObjDef@@XZ ; VehicleGameObj::Get_Definition
PUBLIC	?Find_Seat@VehicleGameObj@@QAEHPAVSoldierGameObj@@@Z ; VehicleGameObj::Find_Seat
PUBLIC	?Get_Driver@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Driver
PUBLIC	?Get_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Gunner
PUBLIC	?Get_Actual_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Actual_Gunner
PUBLIC	?Get_Lock_Owner@VehicleGameObj@@QAEPAVScriptableGameObj@@XZ ; VehicleGameObj::Get_Lock_Owner
PUBLIC	?Get_Driver_Is_Gunner@VehicleGameObj@@QAE_NXZ	; VehicleGameObj::Get_Driver_Is_Gunner
PUBLIC	?Get_Occupant@VehicleGameObj@@QAEPAVSoldierGameObj@@H@Z ; VehicleGameObj::Get_Occupant
PUBLIC	?Set_Occupant@VehicleGameObj@@QAEXHPAVSoldierGameObj@@@Z ; VehicleGameObj::Set_Occupant
PUBLIC	??A?$VectorClass@PAVSoldierGameObj@@@@QAEAAPAVSoldierGameObj@@H@Z ; VectorClass<SoldierGameObj *>::operator[]
PUBLIC	?Length@?$VectorClass@PAVSoldierGameObj@@@@QBEHXZ ; VectorClass<SoldierGameObj *>::Length
...
PUBLIC	??0RayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Type@@_N@Z ; RayCollisionTestClass::RayCollisionTestClass
...
PUBLIC	??0PhysRayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Group_Type@@W4Collision_Type@@@Z ; PhysRayCollisionTestClass::PhysRayCollisionTestClass
PUBLIC	?Get_Type@ScriptZoneGameObjDef@@QBE?AW4ZoneType@ZoneConstants@@XZ ; ScriptZoneGameObjDef::Get_Type
PUBLIC	?Inside_Me@ScriptZoneGameObj@@QAE_NPAVPhysicalGameObj@@@Z ; ScriptZoneGameObj::Inside_Me
PUBLIC	?Find_Closest_Zone@ScriptZoneGameObj@@SAPAV1@AAVVector3@@W4ZoneType@ZoneConstants@@@Z ; ScriptZoneGameObj::Find_Closest_Zone
PUBLIC	?Set_Bounding_Box@ScriptZoneGameObj@@QAEXAAVOBBoxClass@@@Z ; ScriptZoneGameObj::Set_Bounding_Box
PUBLIC	?Get_Bounding_Box@ScriptZoneGameObj@@QAEAAVOBBoxClass@@XZ ; ScriptZoneGameObj::Get_Bounding_Box
PUBLIC	?Head@?$SList@VSoldierGameObj@@@@QBEPAV?$SLNode@VSoldierGameObj@@@@XZ ; SList<SoldierGameObj>::Head
PUBLIC	?Head@?$SList@VScriptZoneGameObj@@@@QBEPAV?$SLNode@VScriptZoneGameObj@@@@XZ ; SList<ScriptZoneGameObj>::Head
PUBLIC	?Find_SmartGameObj@GameObjManager@@SAPAVSmartGameObj@@H@Z ; GameObjManager::Find_SmartGameObj
PUBLIC	?Get_Instance@PhysicsSceneClass@@SAPAV1@XZ	; PhysicsSceneClass::Get_Instance
PUBLIC	?Is_Stealthed@StealthEffectClass@@QBE_NXZ	; StealthEffectClass::Is_Stealthed
PUBLIC	?Create_Library_Object@@YAPAVScriptableGameObj@@PBD@Z ; Create_Library_Object
...
PUBLIC	?GrantSupplies@@YAXPAVScriptableGameObj@@@Z	; GrantSupplies
PUBLIC	?Find_Closest_Zone@@YAPAVScriptableGameObj@@AAVVector3@@I@Z ; Find_Closest_Zone
PUBLIC	?Get_Vehicle@@YAPAVScriptableGameObj@@PAV1@@Z	; Get_Vehicle
PUBLIC	?Grant_Refill@@YAXPAVScriptableGameObj@@@Z	; Grant_Refill
PUBLIC	?Change_Character@@YA_NPAVScriptableGameObj@@PBD@Z ; Change_Character
PUBLIC	?Is_Available_For_Purchase@@YA_NPAVScriptableGameObj@@@Z ; Is_Available_For_Purchase
PUBLIC	?Toggle_Fly_Mode@@YAXPAVScriptableGameObj@@@Z	; Toggle_Fly_Mode
PUBLIC	?Get_Vehicle_Occupant_Count@@YAHPAVScriptableGameObj@@@Z ; Get_Vehicle_Occupant_Count
PUBLIC	?Get_Vehicle_Occupant@@YAPAVScriptableGameObj@@PAV1@H@Z ; Get_Vehicle_Occupant
PUBLIC	?Get_Vehicle_Driver@@YAPAVScriptableGameObj@@PAV1@@Z ; Get_Vehicle_Driver
PUBLIC	?Get_Vehicle_Gunner_Pos@@YAPAVScriptableGameObj@@PAV1@@Z ; Get_Vehicle_Gunner_Pos
PUBLIC	?Get_Vehicle_Gunner@@YAPAVScriptableGameObj@@PAV1@@Z ; Get_Vehicle_Gunner
PUBLIC	?Force_Occupant_Exit@@YAXPAVScriptableGameObj@@H@Z ; Force_Occupant_Exit
PUBLIC	?Force_Occupants_Exit@@YAXPAVScriptableGameObj@@@Z ; Force_Occupants_Exit
PUBLIC	?Soldier_Transition_Vehicle@@YAXPAVScriptableGameObj@@@Z ; Soldier_Transition_Vehicle
PUBLIC	?Force_Occupants_Exit_Team@@YAXPAVScriptableGameObj@@H@Z ; Force_Occupants_Exit_Team
PUBLIC	?Get_Vehicle_Return@@YAPAVScriptableGameObj@@PAV1@@Z ; Get_Vehicle_Return
PUBLIC	?Get_Fly_Mode@@YA_NPAVScriptableGameObj@@@Z	; Get_Fly_Mode
PUBLIC	?Is_Stealth@@YA_NPAVScriptableGameObj@@@Z	; Is_Stealth
PUBLIC	?Get_Vehicle_Seat_Count@@YAHPAVScriptableGameObj@@@Z ; Get_Vehicle_Seat_Count
PUBLIC	?Get_Vehicle_Mode@@YAIPAVScriptableGameObj@@@Z	; Get_Vehicle_Mode
PUBLIC	?Is_VTOL@@YA_NPAVScriptableGameObj@@@Z		; Is_VTOL
PUBLIC	?Get_Vehicle_Owner@@YAPAVScriptableGameObj@@PAV1@@Z ; Get_Vehicle_Owner
PUBLIC	?Get_Vehicle_Definition_Mode@@YAIPBD@Z		; Get_Vehicle_Definition_Mode
PUBLIC	?Get_Zone_Box@@YAPAVOBBoxClass@@PAVScriptableGameObj@@@Z ; Get_Zone_Box
PUBLIC	?IsInsideZone@@YA_NPAVScriptableGameObj@@0@Z	; IsInsideZone
PUBLIC	?Get_Vehicle_Definition_Mode_By_ID@@YAIK@Z	; Get_Vehicle_Definition_Mode_By_ID
PUBLIC	?Get_Zone_Type@@YAIPAVScriptableGameObj@@@Z	; Get_Zone_Type
PUBLIC	?Set_Zone_Box@@YAXPAVScriptableGameObj@@AAVOBBoxClass@@@Z ; Set_Zone_Box
PUBLIC	?Create_Zone@@YAPAVScriptableGameObj@@PBDAAVOBBoxClass@@@Z ; Create_Zone
PUBLIC	?Set_Vehicle_Gunner@@YAXPAVScriptableGameObj@@H@Z ; Set_Vehicle_Gunner
...
PUBLIC	?Is_Spy@@YA_NPAVScriptableGameObj@@@Z		; Is_Spy
PUBLIC	?Is_Unsquishable@@YA_NPAVScriptableGameObj@@@Z	; Is_Unsquishable
PUBLIC	?Is_Stealth_Enabled@@YA_NPAVScriptableGameObj@@@Z ; Is_Stealth_Enabled
PUBLIC	?Get_Object_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z ; Get_Object_Count_In_Zone
PUBLIC	?Get_Player_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z ; Get_Player_Count_In_Zone
...
PUBLIC	?Create_Object_Attach_To_Object@@YAPAVScriptableGameObj@@PAV1@PBD1@Z ; Create_Object_Attach_To_Object
PUBLIC	?Get_Occupant_Seat@@YAHPAVScriptableGameObj@@0@Z ; Get_Occupant_Seat
PUBLIC	??$ResolveGameReference@M@@YAAAMHHH@Z		; ResolveGameReference<float>
...
PUBLIC	?GlobalSightRangeScale@SmartGameObj@@0AAMA	; SmartGameObj::GlobalSightRangeScale
...
EXTRN	?Inverse_Rotate_Vector@Matrix3D@@QBE?AVVector3@@ABV2@@Z:PROC ; Matrix3D::Inverse_Rotate_Vector
...
EXTRN	?Get_Definition@SmartGameObj@@QBEABVSmartGameObjDef@@XZ:PROC ; SmartGameObj::Get_Definition
EXTRN	?Set@Matrix3@@QAEXABVQuaternion@@@Z:PROC	; Matrix3::Set
EXTRN	?Re_Init@SoldierGameObj@@QAEXABVSoldierGameObjDef@@@Z:PROC ; SoldierGameObj::Re_Init
EXTRN	?Get_Definition@SoldierGameObj@@QBEABVSoldierGameObjDef@@XZ:PROC ; SoldierGameObj::Get_Definition
EXTRN	?Toggle_Fly_Mode@SoldierGameObj@@QAEXXZ:PROC	; SoldierGameObj::Toggle_Fly_Mode
EXTRN	?Get_Occupant_Count@VehicleGameObj@@QAEHXZ:PROC	; VehicleGameObj::Get_Occupant_Count
EXTRN	?Is_Available_For_Purchase@VehicleFactoryGameObj@@QBE_NXZ:PROC ; VehicleFactoryGameObj::Is_Available_For_Purchase
EXTRN	?Get_Definition@ScriptZoneGameObj@@QBEABVScriptZoneGameObjDef@@XZ:PROC ; ScriptZoneGameObj::Get_Definition
...
EXTRN	?Cast_Ray@PhysicsSceneClass@@QAE_NAAVPhysRayCollisionTestClass@@_N@Z:PROC ; PhysicsSceneClass::Cast_Ray
EXTRN	?Is_Available_For_Purchase@AirFactoryGameObj@@QBE_NXZ:PROC ; AirFactoryGameObj::Is_Available_For_Purchase
EXTRN	?Is_Available_For_Purchase@NavalFactoryGameObj@@QBE_NXZ:PROC ; NavalFactoryGameObj::Is_Available_For_Purchase
...
EXTRN	__imp_?ScriptZoneGameObjList@GameObjManager@@2V?$SList@VScriptZoneGameObj@@@@A:BYTE
EXTRN	?TheScene@PhysicsSceneClass@@0AAPAV1@A:DWORD	; PhysicsSceneClass::TheScene
EXTRN	__fltused:DWORD
_BSS	SEGMENT
?GlobalSightRangeScale@SmartGameObj@@0AAMA DD 01H DUP (?) ; SmartGameObj::GlobalSightRangeScale
_BSS	ENDS
CRT$XCU	SEGMENT
?GlobalSightRangeScale$initializer$@SmartGameObj@@0P6AXXZA DD FLAT:??__E?GlobalSightRangeScale@SmartGameObj@@0AAMA@@YAXXZ ; SmartGameObj::GlobalSightRangeScale$initializer$
CRT$XCU	ENDS
...
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ??__E?GlobalSightRangeScale@SmartGameObj@@0AAMA@@YAXXZ
text$yc	SEGMENT
??__E?GlobalSightRangeScale@SmartGameObj@@0AAMA@@YAXXZ PROC ; `dynamic initializer for 'SmartGameObj::GlobalSightRangeScale'', COMDAT

; 722  : REF_DEF2(float, SmartGameObj::GlobalSightRangeScale, 0x00811E64, 0x0081103C);
	...
	push	edi
	push	0
	push	8458300					; 0081103cH
	push	8461924					; 00811e64H
	call	??$ResolveGameReference@M@@YAAAMHHH@Z	; ResolveGameReference<float>
	add	esp, 12					; 0000000cH
	mov	DWORD PTR ?GlobalSightRangeScale@SmartGameObj@@0AAMA, eax ; SmartGameObj::GlobalSightRangeScale
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__E?GlobalSightRangeScale@SmartGameObj@@0AAMA@@YAXXZ ENDP ; `dynamic initializer for 'SmartGameObj::GlobalSightRangeScale''
text$yc	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\defines.h
;	COMDAT ??$ResolveGameReference@M@@YAAAMHHH@Z
_TEXT	SEGMENT
tv68 = -76						; size = 4
tv69 = -72						; size = 4
tv70 = -68						; size = 4
...
??$ResolveGameReference@M@@YAAAMHHH@Z PROC		; ResolveGameReference<float>, COMDAT
...
; 153  : };
	...
	pop	ebp
	ret	0
??$ResolveGameReference@M@@YAAAMHHH@Z ENDP		; ResolveGameReference<float>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Occupant_Seat@@YAHPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_vehicle$ = 8						; size = 4
_occupant$ = 12						; size = 4
?Get_Occupant_Seat@@YAHPAVScriptableGameObj@@0@Z PROC	; Get_Occupant_Seat, COMDAT
...
; 699  : 	if (!vehicle || !vehicle->As_VehicleGameObj())

	cmp	DWORD PTR _vehicle$[ebp], 0
	je	SHORT $LN3@Get_Occupa
...
; 701  : 		return -1;
	...
	or	eax, -1
	jmp	SHORT $LN5@Get_Occupa
$LN4@Get_Occupa:

; 702  : 	}
; 703  : 	if (!occupant || !occupant->As_SoldierGameObj())

	cmp	DWORD PTR _occupant$[ebp], 0
	je	SHORT $LN1@Get_Occupa
	mov	eax, DWORD PTR _occupant$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _occupant$[ebp]
	mov	eax, DWORD PTR [edx+68]
	call	eax
	test	eax, eax
	jne	SHORT $LN2@Get_Occupa
$LN1@Get_Occupa:
...
; 706  : 	}
; 707  : 	return vehicle->As_VehicleGameObj()->Find_Seat(occupant->As_SoldierGameObj());
	...
	call	eax
	mov	ecx, eax
	call	?Find_Seat@VehicleGameObj@@QAEHPAVSoldierGameObj@@@Z ; VehicleGameObj::Find_Seat
$LN5@Get_Occupa:
...
; 708  : }
	...
	pop	ebp
	ret	0
?Get_Occupant_Seat@@YAHPAVScriptableGameObj@@0@Z ENDP	; Get_Occupant_Seat
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Create_Object_Attach_To_Object@@YAPAVScriptableGameObj@@PAV1@PBD1@Z
_TEXT	SEGMENT
tv80 = -72						; size = 4
tv67 = -72						; size = 4
_obj$ = -4						; size = 4
...
_preset$ = 12						; size = 4
_bone$ = 16						; size = 4
?Create_Object_Attach_To_Object@@YAPAVScriptableGameObj@@PAV1@PBD1@Z PROC ; Create_Object_Attach_To_Object, COMDAT
...
; 687  :   GameObject* obj = Commands->Create_Object_At_Bone(host, preset, (NULL != bone) ? bone : "origin");

	cmp	DWORD PTR _bone$[ebp], 0
	je	SHORT $LN4@Create_Obj
	mov	eax, DWORD PTR _bone$[ebp]
	mov	DWORD PTR tv67[ebp], eax
	jmp	SHORT $LN5@Create_Obj
$LN4@Create_Obj:
	mov	DWORD PTR tv67[ebp], OFFSET ??_C@_06NHCMNMEH@origin?$AA@
$LN5@Create_Obj:
...
; 688  :   if ( NULL != obj )
	...
	je	SHORT $LN1@Create_Obj

; 689  :   {
; 690  :     Commands->Set_Facing(obj, Commands->Get_Facing(host));
...
; 691  :     Commands->Attach_To_Object_Bone(obj, host, (NULL != bone) ? bone : "origin");

	cmp	DWORD PTR _bone$[ebp], 0
	je	SHORT $LN6@Create_Obj
	mov	eax, DWORD PTR _bone$[ebp]
	mov	DWORD PTR tv80[ebp], eax
	jmp	SHORT $LN7@Create_Obj
$LN6@Create_Obj:
	mov	DWORD PTR tv80[ebp], OFFSET ??_C@_06NHCMNMEH@origin?$AA@
$LN7@Create_Obj:
...
; 695  : }
	...
	pop	ebp
	ret	0
?Create_Object_Attach_To_Object@@YAPAVScriptableGameObj@@PAV1@PBD1@Z ENDP ; Create_Object_Attach_To_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Player_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_z$1 = -12						; size = 4
_Return$ = -8						; size = 4
_Zone$ = -4						; size = 4
_obj$ = 8						; size = 4
_Team$ = 12						; size = 4
?Get_Player_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z PROC ; Get_Player_Count_In_Zone, COMDAT
...
; 668  : 		}
; 669  : 		ScriptZoneGameObj *Zone = obj->As_ScriptZoneGameObj();
...
; 670  : 		if (!Zone)
	...
	jne	SHORT $LN6@Get_Player

; 671  : 		{
; 672  : 				return 0;

	xor	eax, eax
	jmp	SHORT $LN8@Get_Player
$LN6@Get_Player:

; 673  : 		}
; 674  : 		int Return = 0;

	mov	DWORD PTR _Return$[ebp], 0

; 675  : 		for (SLNode<SoldierGameObj> *z = GameObjManager::StarGameObjList.Head();z;z = z->Next())
...
; 676  : 		{
; 677  : 				if ((Get_Object_Type(z->Data()) == Team || Team == 2) && Zone->Inside_Me(z->Data()))
...
$LN1@Get_Player:
	...
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN2@Get_Player

; 678  : 				{
; 679  : 						Return++;

	mov	eax, DWORD PTR _Return$[ebp]
	add	eax, 1
	mov	DWORD PTR _Return$[ebp], eax
$LN2@Get_Player:

; 680  : 				}
; 681  : 		}

	jmp	SHORT $LN4@Get_Player
$LN3@Get_Player:
...
; 683  : }
	...
	pop	ebp
	ret	0
?Get_Player_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z ENDP ; Get_Player_Count_In_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Object_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_z$1 = -12						; size = 4
_Return$ = -8						; size = 4
_Zone$ = -4						; size = 4
_obj$ = 8						; size = 4
_Team$ = 12						; size = 4
?Get_Object_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z PROC ; Get_Object_Count_In_Zone, COMDAT
...
; 646  : 		}
; 647  : 		ScriptZoneGameObj *Zone = obj->As_ScriptZoneGameObj();
...
; 648  : 		if (!Zone)
	...
	cmp	DWORD PTR _Zone$[ebp], 0
	jne	SHORT $LN6@Get_Object

; 649  : 		{
; 650  : 				return 0;

	xor	eax, eax
	jmp	SHORT $LN8@Get_Object
$LN6@Get_Object:
...
; 653  : 		for (SLNode<SmartGameObj> *z = GameObjManager::SmartGameObjList.Head();z;z = z->Next())
...
; 654  : 		{
; 655  : 				if ((Get_Object_Type(z->Data()) == Team || Team == 2) && Zone->Inside_Me(z->Data()))
...
; 661  : }
	...
	pop	ebp
	ret	0
?Get_Object_Count_In_Zone@@YAHPAVScriptableGameObj@@H@Z ENDP ; Get_Object_Count_In_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Stealth_Enabled@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_obj$ = 8						; size = 4
?Is_Stealth_Enabled@@YA_NPAVScriptableGameObj@@@Z PROC	; Is_Stealth_Enabled, COMDAT
...
; 634  : 	if (obj && obj->As_SoldierGameObj())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN1@Is_Stealth
	mov	eax, DWORD PTR _obj$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$[ebp]
	mov	eax, DWORD PTR [edx+68]
...
; 635  : 	{
; 636  : 		return obj->As_SoldierGameObj()->Is_Stealth_Enabled();
	...
	call	eax
	mov	ecx, eax
	call	?Is_Stealth_Enabled@SmartGameObj@@QAE_NXZ ; SmartGameObj::Is_Stealth_Enabled
	jmp	SHORT $LN2@Is_Stealth
$LN1@Is_Stealth:
...
; 639  : }
	...
	pop	ebp
	ret	0
?Is_Stealth_Enabled@@YA_NPAVScriptableGameObj@@@Z ENDP	; Is_Stealth_Enabled
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Unsquishable@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_obj$ = 8						; size = 4
?Is_Unsquishable@@YA_NPAVScriptableGameObj@@@Z PROC	; Is_Unsquishable, COMDAT
...
; 625  : 	if (obj && obj->As_SoldierGameObj())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN1@Is_Unsquis
	mov	eax, DWORD PTR _obj$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$[ebp]
	mov	eax, DWORD PTR [edx+68]
...
; 626  : 	{
; 627  : 		return obj->As_SoldierGameObj()->Get_Definition().Is_Unsquishable();
	...
	mov	ecx, eax
	call	?Is_Unsquishable@SoldierGameObjDef@@QBE_NXZ ; SoldierGameObjDef::Is_Unsquishable
	jmp	SHORT $LN2@Is_Unsquis
$LN1@Is_Unsquis:
...
; 630  : }
	...
	pop	ebp
	ret	0
?Is_Unsquishable@@YA_NPAVScriptableGameObj@@@Z ENDP	; Is_Unsquishable
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Spy@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_obj$ = 8						; size = 4
?Is_Spy@@YA_NPAVScriptableGameObj@@@Z PROC		; Is_Spy, COMDAT
...
; 616  : 	if (obj && obj->As_SoldierGameObj())
...
; 617  : 	{
; 618  : 		return obj->As_SoldierGameObj()->Get_Definition().Is_Spy();
	...
	call	?Get_Definition@SoldierGameObj@@QBEABVSoldierGameObjDef@@XZ ; SoldierGameObj::Get_Definition
	mov	ecx, eax
	call	?Is_Spy@SoldierGameObjDef@@QBE_NXZ	; SoldierGameObjDef::Is_Spy
	jmp	SHORT $LN2@Is_Spy
$LN1@Is_Spy:
...
; 621  : }
	...
	pop	ebp
	ret	0
?Is_Spy@@YA_NPAVScriptableGameObj@@@Z ENDP		; Is_Spy
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Set_Vehicle_Gunner@@YAXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_obj2$1 = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
_seat$ = 12						; size = 4
?Set_Vehicle_Gunner@@YAXPAVScriptableGameObj@@H@Z PROC	; Set_Vehicle_Gunner, COMDAT
...
; 468  : 	if (!obj || !obj->As_VehicleGameObj())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN4@Set_Vehicl
	mov	eax, DWORD PTR _obj$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$[ebp]
	mov	eax, DWORD PTR [edx+40]
	call	eax
	test	eax, eax
	jne	SHORT $LN5@Set_Vehicl
$LN4@Set_Vehicl:

; 469  : 	{
; 470  : 		return;

	jmp	SHORT $LN6@Set_Vehicl
$LN5@Set_Vehicl:

; 471  : 	}
; 472  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 473  : 	if (seat <= 1 || seat > o->Get_Definition().Get_Seat_Count())

	cmp	DWORD PTR _seat$[ebp], 1
	jle	SHORT $LN2@Set_Vehicl
	...
	cmp	DWORD PTR _seat$[ebp], eax
	jle	SHORT $LN3@Set_Vehicl
$LN2@Set_Vehicl:
...
; 476  : 	}
; 477  : 	if (o->Get_Occupant(seat) && o->Get_Occupant(1))
...
; 478  : 	{
; 479  : 		SoldierGameObj *obj2 = o->Get_Occupant(1);

	push	1
	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Occupant@VehicleGameObj@@QAEPAVSoldierGameObj@@H@Z ; VehicleGameObj::Get_Occupant
	mov	DWORD PTR _obj2$1[ebp], eax

; 480  : 		o->Set_Occupant(1,o->Get_Occupant(seat));
	...
	push	1
	mov	ecx, DWORD PTR _o$[ebp]
	call	?Set_Occupant@VehicleGameObj@@QAEXHPAVSoldierGameObj@@@Z ; VehicleGameObj::Set_Occupant

; 481  : 		o->Set_Occupant(seat,obj2);

	mov	eax, DWORD PTR _obj2$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _seat$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _o$[ebp]
	call	?Set_Occupant@VehicleGameObj@@QAEXHPAVSoldierGameObj@@@Z ; VehicleGameObj::Set_Occupant
$LN6@Set_Vehicl:
...
; 483  : }
	...
	pop	ebp
	ret	0
?Set_Vehicle_Gunner@@YAXPAVScriptableGameObj@@H@Z ENDP	; Set_Vehicle_Gunner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Create_Zone@@YAPAVScriptableGameObj@@PBDAAVOBBoxClass@@@Z
_TEXT	SEGMENT
_obj$ = -4						; size = 4
_preset$ = 8						; size = 4
_box$ = 12						; size = 4
?Create_Zone@@YAPAVScriptableGameObj@@PBDAAVOBBoxClass@@@Z PROC ; Create_Zone, COMDAT
...
; 460  : 	GameObject *obj = Create_Library_Object(preset);

	mov	eax, DWORD PTR _preset$[ebp]
	push	eax
	call	?Create_Library_Object@@YAPAVScriptableGameObj@@PBD@Z ; Create_Library_Object
	add	esp, 4
	mov	DWORD PTR _obj$[ebp], eax

; 461  : 	Set_Zone_Box(obj,box);

	mov	eax, DWORD PTR _box$[ebp]
	push	eax
	mov	ecx, DWORD PTR _obj$[ebp]
	push	ecx
	call	?Set_Zone_Box@@YAXPAVScriptableGameObj@@AAVOBBoxClass@@@Z ; Set_Zone_Box
	add	esp, 8

; 462  : 	obj->Start_Observers();
...
; 464  : }
	...
	pop	ebp
	ret	0
?Create_Zone@@YAPAVScriptableGameObj@@PBDAAVOBBoxClass@@@Z ENDP ; Create_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Set_Zone_Box@@YAXPAVScriptableGameObj@@AAVOBBoxClass@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
_box$ = 12						; size = 4
?Set_Zone_Box@@YAXPAVScriptableGameObj@@AAVOBBoxClass@@@Z PROC ; Set_Zone_Box, COMDAT
...
; 446  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Set_Zone_B

; 447  : 	{
; 448  : 		return;

	jmp	SHORT $LN3@Set_Zone_B
$LN2@Set_Zone_B:

; 449  : 	}
; 450  : 	ScriptZoneGameObj *o = obj->As_ScriptZoneGameObj();
...
; 454  : 	}
; 455  : 	o->Set_Bounding_Box(box);

	mov	eax, DWORD PTR _box$[ebp]
	push	eax
	mov	ecx, DWORD PTR _o$[ebp]
	call	?Set_Bounding_Box@ScriptZoneGameObj@@QAEXAAVOBBoxClass@@@Z ; ScriptZoneGameObj::Set_Bounding_Box
$LN3@Set_Zone_B:
...
; 456  : }
	...
	pop	ebp
	ret	0
?Set_Zone_Box@@YAXPAVScriptableGameObj@@AAVOBBoxClass@@@Z ENDP ; Set_Zone_Box
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Zone_Type@@YAIPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_d$ = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Zone_Type@@YAIPAVScriptableGameObj@@@Z PROC	; Get_Zone_Type, COMDAT
...
; 431  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Get_Zone_T

; 432  : 	{
; 433  : 		return 0;

	xor	eax, eax
	jmp	SHORT $LN3@Get_Zone_T
$LN2@Get_Zone_T:

; 434  : 	}
; 435  : 	ScriptZoneGameObj *o = obj->As_ScriptZoneGameObj();
...
; 439  : 	}
; 440  : 	const ScriptZoneGameObjDef *d = &o->Get_Definition();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Definition@ScriptZoneGameObj@@QBEABVScriptZoneGameObjDef@@XZ ; ScriptZoneGameObj::Get_Definition
	mov	DWORD PTR _d$[ebp], eax

; 441  : 	return d->Get_Type();

	mov	ecx, DWORD PTR _d$[ebp]
	call	?Get_Type@ScriptZoneGameObjDef@@QBE?AW4ZoneType@ZoneConstants@@XZ ; ScriptZoneGameObjDef::Get_Type
$LN3@Get_Zone_T:
...
; 442  : }
	...
	pop	ebp
	ret	0
?Get_Zone_Type@@YAIPAVScriptableGameObj@@@Z ENDP	; Get_Zone_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Definition_Mode_By_ID@@YAIK@Z
_TEXT	SEGMENT
_d$ = -4						; size = 4
_ID$ = 8						; size = 4
?Get_Vehicle_Definition_Mode_By_ID@@YAIK@Z PROC		; Get_Vehicle_Definition_Mode_By_ID, COMDAT
...
; 424  : 	VehicleGameObjDef *d = (VehicleGameObjDef *)Find_Definition(ID);
...
; 425  : 	if (!d || d->Get_Class_ID() != 0x3010) return 5;

	cmp	DWORD PTR _d$[ebp], 0
	je	SHORT $LN1@Get_Vehicl
...
$LN1@Get_Vehicl:
	mov	eax, 5
	jmp	SHORT $LN3@Get_Vehicl
$LN2@Get_Vehicl:

; 426  : 	return (int)d->Get_Type();
...
; 427  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Definition_Mode_By_ID@@YAIK@Z ENDP		; Get_Vehicle_Definition_Mode_By_ID
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?IsInsideZone@@YA_NPAVScriptableGameObj@@0@Z
_TEXT	SEGMENT
_v$1 = -20						; size = 12
_o2$ = -8						; size = 4
_o$ = -4						; size = 4
_zone$ = 8						; size = 4
_obj$ = 12						; size = 4
?IsInsideZone@@YA_NPAVScriptableGameObj@@0@Z PROC	; IsInsideZone, COMDAT
...
; 403  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN3@IsInsideZo

; 404  : 	{
; 405  : 		return false;

	xor	al, al
	jmp	SHORT $LN4@IsInsideZo
$LN3@IsInsideZo:
...
; 410  : 	}
; 411  : 	GameObject *o = obj->As_SmartGameObj();
...
; 412  : 	ScriptZoneGameObj *o2 = zone->As_ScriptZoneGameObj();
...
; 416  : 		((PhysicalGameObj *)o)->Get_Position(&v);
...
; 420  : }
	...
	pop	ebp
	ret	0
?IsInsideZone@@YA_NPAVScriptableGameObj@@0@Z ENDP	; IsInsideZone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Zone_Box@@YAPAVOBBoxClass@@PAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Zone_Box@@YAPAVOBBoxClass@@PAVScriptableGameObj@@@Z PROC ; Get_Zone_Box, COMDAT
...
; 389  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Get_Zone_B

; 390  : 	{
; 391  : 		return 0;

	xor	eax, eax
	jmp	SHORT $LN3@Get_Zone_B
$LN2@Get_Zone_B:

; 392  : 	}
; 393  : 	ScriptZoneGameObj *o = obj->As_ScriptZoneGameObj();
...
; 397  : 	}
; 398  : 	return &o->Get_Bounding_Box();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Bounding_Box@ScriptZoneGameObj@@QAEAAVOBBoxClass@@XZ ; ScriptZoneGameObj::Get_Bounding_Box
$LN3@Get_Zone_B:
...
; 399  : }
	...
	pop	ebp
	ret	0
?Get_Zone_Box@@YAPAVOBBoxClass@@PAVScriptableGameObj@@@Z ENDP ; Get_Zone_Box
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Definition_Mode@@YAIPBD@Z
_TEXT	SEGMENT
_d$ = -4						; size = 4
_preset$ = 8						; size = 4
?Get_Vehicle_Definition_Mode@@YAIPBD@Z PROC		; Get_Vehicle_Definition_Mode, COMDAT
...
; 382  : 	VehicleGameObjDef *d = (VehicleGameObjDef *)Find_Named_Definition(preset);
...
; 383  : 	if (!d || d->Get_Class_ID() != 0x3010) return 5;
...
; 385  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Definition_Mode@@YAIPBD@Z ENDP		; Get_Vehicle_Definition_Mode
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Owner@@YAPAVScriptableGameObj@@PAV1@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Owner@@YAPAVScriptableGameObj@@PAV1@@Z PROC ; Get_Vehicle_Owner, COMDAT
...
; 372  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN1@Get_Vehicl

; 373  : 	{
; 374  : 		return 0;

	xor	eax, eax
	jmp	SHORT $LN2@Get_Vehicl
$LN1@Get_Vehicl:

; 375  : 	}
; 376  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 377  : 	return o->Get_Lock_Owner();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Lock_Owner@VehicleGameObj@@QAEPAVScriptableGameObj@@XZ ; VehicleGameObj::Get_Lock_Owner
$LN2@Get_Vehicl:
...
; 378  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Owner@@YAPAVScriptableGameObj@@PAV1@@Z ENDP ; Get_Vehicle_Owner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_VTOL@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv71 = -68						; size = 4
_obj$ = 8						; size = 4
?Is_VTOL@@YA_NPAVScriptableGameObj@@@Z PROC		; Is_VTOL, COMDAT
...
; 367  : 	return (Get_Vehicle_Mode(obj) == VEHICLE_TYPE_FLYING) || Get_Fly_Mode(obj);
	...
	movzx	edx, al
	test	edx, edx
	jne	SHORT $LN3@Is_VTOL
	mov	DWORD PTR tv71[ebp], 0
	jmp	SHORT $LN4@Is_VTOL
$LN3@Is_VTOL:
...
; 368  : }
	...
	pop	ebp
	ret	0
?Is_VTOL@@YA_NPAVScriptableGameObj@@@Z ENDP		; Is_VTOL
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Mode@@YAIPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_d$ = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Mode@@YAIPAVScriptableGameObj@@@Z PROC	; Get_Vehicle_Mode, COMDAT
...
; 348  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN3@Get_Vehicl

; 349  : 	{
; 350  : 		return 0;

	xor	eax, eax
	jmp	SHORT $LN4@Get_Vehicl
$LN3@Get_Vehicl:

; 351  : 	}
; 352  : 	GameObject *o = obj->As_VehicleGameObj();
...
; 353  : 	if (!o)
	...
	cmp	DWORD PTR _o$[ebp], 0
	jne	SHORT $LN2@Get_Vehicl

; 354  : 	{
; 355  : 		obj = Get_Vehicle(obj);
...
; 359  : 		}
; 360  : 	}
; 361  : 	const VehicleGameObjDef *d = &obj->As_VehicleGameObj()->Get_Definition();
...
; 363  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Mode@@YAIPAVScriptableGameObj@@@Z ENDP	; Get_Vehicle_Mode
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Seat_Count@@YAHPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Seat_Count@@YAHPAVScriptableGameObj@@@Z PROC ; Get_Vehicle_Seat_Count, COMDAT
...
; 338  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 341  : 	}
; 342  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 343  : 	return o->Get_Definition().Get_Seat_Count();
...
; 344  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Seat_Count@@YAHPAVScriptableGameObj@@@Z ENDP ; Get_Vehicle_Seat_Count
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Stealth@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Is_Stealth@@YA_NPAVScriptableGameObj@@@Z PROC		; Is_Stealth, COMDAT
...
; 324  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Is_Stealth

; 325  : 	{
; 326  : 		return false;

	xor	al, al
	jmp	SHORT $LN3@Is_Stealth
$LN2@Is_Stealth:

; 327  : 	}
; 328  : 	SmartGameObj *o = obj->As_SmartGameObj();
...
; 334  : }
	...
	pop	ebp
	ret	0
?Is_Stealth@@YA_NPAVScriptableGameObj@@@Z ENDP		; Is_Stealth
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Fly_Mode@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Fly_Mode@@YA_NPAVScriptableGameObj@@@Z PROC	; Get_Fly_Mode, COMDAT
...
; 310  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Get_Fly_Mo

; 311  : 	{
; 312  : 		return false;

	xor	al, al
	jmp	SHORT $LN3@Get_Fly_Mo
$LN2@Get_Fly_Mo:

; 313  : 	}
; 314  : 	SoldierGameObj *o = obj->As_SoldierGameObj();
...
; 318  : 	}
; 319  : 	return o->Get_Fly_Mode();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Fly_Mode@SoldierGameObj@@QAE_NXZ	; SoldierGameObj::Get_Fly_Mode
$LN3@Get_Fly_Mo:
...
; 320  : }
	...
	pop	ebp
	ret	0
?Get_Fly_Mode@@YA_NPAVScriptableGameObj@@@Z ENDP	; Get_Fly_Mode
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Return@@YAPAVScriptableGameObj@@PAV1@@Z
_TEXT	SEGMENT
_vehicle$1 = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Return@@YAPAVScriptableGameObj@@PAV1@@Z PROC ; Get_Vehicle_Return, COMDAT
...
; 294  : 	}
; 295  : 	SoldierGameObj *o = obj->As_SoldierGameObj();
...
; 297  : 	{
; 298  : 		GameObject *vehicle = o->Get_Vehicle();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Vehicle@SoldierGameObj@@QAEPAVVehicleGameObj@@XZ ; SoldierGameObj::Get_Vehicle
	mov	DWORD PTR _vehicle$1[ebp], eax

; 299  : 		if (vehicle && vehicle->As_VehicleGameObj())
...
; 306  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Return@@YAPAVScriptableGameObj@@PAV1@@Z ENDP ; Get_Vehicle_Return
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Force_Occupants_Exit_Team@@YAXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_i$1 = -208						; size = 4
_params$ = -204						; size = 196
_x$ = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
_team$ = 12						; size = 4
?Force_Occupants_Exit_Team@@YAXPAVScriptableGameObj@@H@Z PROC ; Force_Occupants_Exit_Team, COMDAT
...
; 272  : 	if (!obj || !obj->As_VehicleGameObj())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN5@Force_Occu
	mov	eax, DWORD PTR _obj$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$[ebp]
	mov	eax, DWORD PTR [edx+40]
...
; 275  : 	}
; 276  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 277  : 	int x = o->Get_Definition().Get_Seat_Count();
...
$LN4@Force_Occu:
	...
	jge	SHORT $LN2@Force_Occu

; 281  : 	{
; 282  : 		if ((o->Get_Occupant(i)) && (Commands->Get_Player_Type(o->Get_Occupant(i)) != team))
...
; 283  : 		{
; 284  : 			Commands->Action_Enter_Exit(o->Get_Occupant(i),params);
...
; 287  : }
	...
	pop	ebp
	ret	0
?Force_Occupants_Exit_Team@@YAXPAVScriptableGameObj@@H@Z ENDP ; Force_Occupants_Exit_Team
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Soldier_Transition_Vehicle@@YAXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_params$ = -196						; size = 196
_obj$ = 8						; size = 4
?Soldier_Transition_Vehicle@@YAXPAVScriptableGameObj@@@Z PROC ; Soldier_Transition_Vehicle, COMDAT
...
; 261  : 	if (!obj || !obj->As_SoldierGameObj())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN1@Soldier_Tr
	mov	eax, DWORD PTR _obj$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$[ebp]
	mov	eax, DWORD PTR [edx+68]
	call	eax
	test	eax, eax
	jne	SHORT $LN2@Soldier_Tr
$LN1@Soldier_Tr:

; 262  : 	{
; 263  : 		return;

	jmp	SHORT $LN3@Soldier_Tr
$LN2@Soldier_Tr:

; 264  : 	}
; 265  : 	ActionParamsStruct params;

	lea	ecx, DWORD PTR _params$[ebp]
	call	??0ActionParamsStruct@@QAE@XZ		; ActionParamsStruct::ActionParamsStruct

; 266  : 	params.Set_Basic((long)0,100,39);
...
; 267  : 	Commands->Action_Enter_Exit(obj,params);
...
; 268  : }
	...
	pop	ebp
	ret	0
?Soldier_Transition_Vehicle@@YAXPAVScriptableGameObj@@@Z ENDP ; Soldier_Transition_Vehicle
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Force_Occupants_Exit@@YAXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_i$1 = -208						; size = 4
_params$ = -204						; size = 196
_x$ = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Force_Occupants_Exit@@YAXPAVScriptableGameObj@@@Z PROC	; Force_Occupants_Exit, COMDAT
...
; 242  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 245  : 	}
; 246  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 247  : 	int x = o->Get_Definition().Get_Seat_Count();
...
; 248  : 	ActionParamsStruct params;

	lea	ecx, DWORD PTR _params$[ebp]
	call	??0ActionParamsStruct@@QAE@XZ		; ActionParamsStruct::ActionParamsStruct

; 249  : 	params.Set_Basic((long)0,100,39);
...
; 253  : 		{
; 254  : 			Commands->Action_Enter_Exit(o->Get_Occupant(i),params);
...
; 257  : }
	...
	pop	ebp
	ret	0
?Force_Occupants_Exit@@YAXPAVScriptableGameObj@@@Z ENDP	; Force_Occupants_Exit
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Force_Occupant_Exit@@YAXPAVScriptableGameObj@@H@Z
_TEXT	SEGMENT
_params$1 = -200					; size = 196
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
_seat$ = 12						; size = 4
?Force_Occupant_Exit@@YAXPAVScriptableGameObj@@H@Z PROC	; Force_Occupant_Exit, COMDAT
...
; 223  : 	if (!obj || !obj->As_VehicleGameObj())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN3@Force_Occu
	mov	eax, DWORD PTR _obj$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _obj$[ebp]
	mov	eax, DWORD PTR [edx+40]
...
; 226  : 	}
; 227  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 228  : 	if (seat >= o->Get_Definition().Get_Seat_Count())
	...
	call	?Get_Seat_Count@VehicleGameObjDef@@QBEHXZ ; VehicleGameObjDef::Get_Seat_Count
	cmp	DWORD PTR _seat$[ebp], eax
	jl	SHORT $LN2@Force_Occu

; 229  : 	{
; 230  : 		return;

	jmp	SHORT $LN5@Force_Occu
$LN2@Force_Occu:

; 231  : 	}
; 232  : 	if (o->Get_Occupant(seat))
...
; 233  : 	{
; 234  : 		ActionParamsStruct params;

	lea	ecx, DWORD PTR _params$1[ebp]
	call	??0ActionParamsStruct@@QAE@XZ		; ActionParamsStruct::ActionParamsStruct

; 235  : 		params.Set_Basic((long)0,100,39);
...
; 236  : 		Commands->Action_Enter_Exit(o->Get_Occupant(seat),params);
...
; 238  : }
	...
	pop	ebp
	ret	0
?Force_Occupant_Exit@@YAXPAVScriptableGameObj@@H@Z ENDP	; Force_Occupant_Exit
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Gunner@@YAPAVScriptableGameObj@@PAV1@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Gunner@@YAPAVScriptableGameObj@@PAV1@@Z PROC ; Get_Vehicle_Gunner, COMDAT
...
; 213  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 216  : 	}
; 217  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 218  : 	return o->Get_Actual_Gunner();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Actual_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Actual_Gunner
$LN3@Get_Vehicl:
...
; 219  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Gunner@@YAPAVScriptableGameObj@@PAV1@@Z ENDP ; Get_Vehicle_Gunner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Gunner_Pos@@YAPAVScriptableGameObj@@PAV1@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Gunner_Pos@@YAPAVScriptableGameObj@@PAV1@@Z PROC ; Get_Vehicle_Gunner_Pos, COMDAT
...
; 203  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 206  : 	}
; 207  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 208  : 	return o->Get_Gunner();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Gunner
$LN3@Get_Vehicl:
...
; 209  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Gunner_Pos@@YAPAVScriptableGameObj@@PAV1@@Z ENDP ; Get_Vehicle_Gunner_Pos
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Driver@@YAPAVScriptableGameObj@@PAV1@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Driver@@YAPAVScriptableGameObj@@PAV1@@Z PROC ; Get_Vehicle_Driver, COMDAT
...
; 193  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 196  : 	}
; 197  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 198  : 	return o->Get_Driver();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Driver@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Driver
$LN3@Get_Vehicl:
...
; 199  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Driver@@YAPAVScriptableGameObj@@PAV1@@Z ENDP ; Get_Vehicle_Driver
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Occupant@@YAPAVScriptableGameObj@@PAV1@H@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
_seat$ = 12						; size = 4
?Get_Vehicle_Occupant@@YAPAVScriptableGameObj@@PAV1@H@Z PROC ; Get_Vehicle_Occupant, COMDAT
...
; 179  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 182  : 	}
; 183  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 184  : 	if (seat >= o->Get_Definition().Get_Seat_Count())
...
; 187  : 	}
; 188  : 	return o->Get_Occupant(seat);
...
; 189  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Occupant@@YAPAVScriptableGameObj@@PAV1@H@Z ENDP ; Get_Vehicle_Occupant
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle_Occupant_Count@@YAHPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle_Occupant_Count@@YAHPAVScriptableGameObj@@@Z PROC ; Get_Vehicle_Occupant_Count, COMDAT
...
; 169  : 	if (!obj || !obj->As_VehicleGameObj())
...
; 172  : 	}
; 173  : 	VehicleGameObj *o = obj->As_VehicleGameObj();
...
; 174  : 	return o->Get_Occupant_Count();
...
; 175  : }
	...
	pop	ebp
	ret	0
?Get_Vehicle_Occupant_Count@@YAHPAVScriptableGameObj@@@Z ENDP ; Get_Vehicle_Occupant_Count
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Toggle_Fly_Mode@@YAXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Toggle_Fly_Mode@@YAXPAVScriptableGameObj@@@Z PROC	; Toggle_Fly_Mode, COMDAT
...
; 155  : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Toggle_Fly

; 156  : 	{
; 157  : 		return;

	jmp	SHORT $LN3@Toggle_Fly
$LN2@Toggle_Fly:

; 158  : 	}
; 159  : 	SoldierGameObj *o = obj->As_SoldierGameObj();
...
; 160  : 	if (o)
	...
	cmp	DWORD PTR _o$[ebp], 0
	je	SHORT $LN3@Toggle_Fly

; 161  : 	{
; 162  : 		o->Toggle_Fly_Mode();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Toggle_Fly_Mode@SoldierGameObj@@QAEXXZ	; SoldierGameObj::Toggle_Fly_Mode

; 163  : 		Commands->Enable_Collisions(o);
...
; 165  : }
	...
	pop	ebp
	ret	0
?Toggle_Fly_Mode@@YAXPAVScriptableGameObj@@@Z ENDP	; Toggle_Fly_Mode
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Available_For_Purchase@@YA_NPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
tv168 = -68						; size = 4
tv158 = -68						; size = 4
tv142 = -68						; size = 4
...
tv74 = -68						; size = 4
_factory$ = 8						; size = 4
?Is_Available_For_Purchase@@YA_NPAVScriptableGameObj@@@Z PROC ; Is_Available_For_Purchase, COMDAT
...
; 135  : 	if (factory->As_BuildingGameObj() && factory->As_BuildingGameObj()->As_VehicleFactoryGameObj())
...
; 136  : 	{
; 137  : 		return factory->As_BuildingGameObj()->As_VehicleFactoryGameObj()->Is_Available_For_Purchase();
	...
	call	eax
	mov	ecx, eax
	call	?Is_Available_For_Purchase@VehicleFactoryGameObj@@QBE_NXZ ; VehicleFactoryGameObj::Is_Available_For_Purchase
	jmp	$LN7@Is_Availab
	jmp	$LN7@Is_Availab
$LN6@Is_Availab:

; 138  : 	}
; 139  : 	else if (factory->As_BuildingGameObj() && factory->As_BuildingGameObj()->As_AirFactoryGameObj())
...
; 140  : 	{
; 141  : 		return factory->As_BuildingGameObj()->As_AirFactoryGameObj()->Is_Available_For_Purchase();
	...
	call	eax
	mov	ecx, eax
	call	?Is_Available_For_Purchase@AirFactoryGameObj@@QBE_NXZ ; AirFactoryGameObj::Is_Available_For_Purchase
	jmp	SHORT $LN7@Is_Availab
	jmp	SHORT $LN7@Is_Availab
$LN4@Is_Availab:

; 142  : 	}
; 143  : 	else if (factory->As_BuildingGameObj() && factory->As_BuildingGameObj()->As_NavalFactoryGameObj())
...
; 144  : 	{
; 145  : 		return factory->As_BuildingGameObj()->As_NavalFactoryGameObj()->Is_Available_For_Purchase();
	...
	call	eax
	mov	ecx, eax
	call	?Is_Available_For_Purchase@NavalFactoryGameObj@@QBE_NXZ ; NavalFactoryGameObj::Is_Available_For_Purchase
	jmp	SHORT $LN7@Is_Availab
...
; 151  : }
	...
	pop	ebp
	ret	0
?Is_Available_For_Purchase@@YA_NPAVScriptableGameObj@@@Z ENDP ; Is_Available_For_Purchase
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Change_Character@@YA_NPAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
_o$ = -8						; size = 4
_def$ = -4						; size = 4
_obj$ = 8						; size = 4
_Preset_Name$ = 12					; size = 4
?Change_Character@@YA_NPAVScriptableGameObj@@PBD@Z PROC	; Change_Character, COMDAT
...
; 110  : 	if (!obj || Get_Vehicle(obj))

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN4@Change_Cha
	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?Get_Vehicle@@YAPAVScriptableGameObj@@PAV1@@Z ; Get_Vehicle
	add	esp, 4
	test	eax, eax
	je	SHORT $LN5@Change_Cha
$LN4@Change_Cha:
...
; 112  : 		return false;
	...
	xor	al, al
	jmp	SHORT $LN6@Change_Cha
$LN5@Change_Cha:

; 113  : 	}
; 114  : 	DefinitionClass *def = Find_Named_Definition(Preset_Name);
...
; 118  : 	}
; 119  : 	if (def->Get_Class_ID() != 0x3001)
...
; 122  : 	}
; 123  : 	SoldierGameObj *o = obj->As_SoldierGameObj();
...
; 127  : 	}
; 128  : 	o->Re_Init(*(SoldierGameObjDef *)def);

	mov	eax, DWORD PTR _def$[ebp]
	push	eax
	mov	ecx, DWORD PTR _o$[ebp]
	call	?Re_Init@SoldierGameObj@@QAEXABVSoldierGameObjDef@@@Z ; SoldierGameObj::Re_Init
...
; 131  : }
	...
	pop	ebp
	ret	0
?Change_Character@@YA_NPAVScriptableGameObj@@PBD@Z ENDP	; Change_Character
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Grant_Refill@@YAXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Grant_Refill@@YAXPAVScriptableGameObj@@@Z PROC		; Grant_Refill, COMDAT
...
; 97   : 	if (!obj)
	...
	cmp	DWORD PTR _obj$[ebp], 0
	jne	SHORT $LN2@Grant_Refi

; 98   : 	{
; 99   : 		return;

	jmp	SHORT $LN3@Grant_Refi
$LN2@Grant_Refi:

; 100  : 	}
; 101  : 	GameObject *o = obj->As_SoldierGameObj();
...
; 102  : 	if (o)
	...
	cmp	DWORD PTR _o$[ebp], 0
	je	SHORT $LN3@Grant_Refi

; 103  : 	{
; 104  : 		GrantSupplies(obj);

	mov	eax, DWORD PTR _obj$[ebp]
	push	eax
	call	?GrantSupplies@@YAXPAVScriptableGameObj@@@Z ; GrantSupplies
	add	esp, 4
$LN3@Grant_Refi:
...
; 106  : }
	...
	pop	ebp
	ret	0
?Grant_Refill@@YAXPAVScriptableGameObj@@@Z ENDP		; Grant_Refill
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Vehicle@@YAPAVScriptableGameObj@@PAV1@@Z
_TEXT	SEGMENT
_vehicle$1 = -8						; size = 4
_o$ = -4						; size = 4
_obj$ = 8						; size = 4
?Get_Vehicle@@YAPAVScriptableGameObj@@PAV1@@Z PROC	; Get_Vehicle, COMDAT
...
; 81   : 	}
; 82   : 	SoldierGameObj *o = obj->As_SoldierGameObj();
...
; 84   : 	{
; 85   : 		GameObject *vehicle = o->Get_Vehicle();

	mov	ecx, DWORD PTR _o$[ebp]
	call	?Get_Vehicle@SoldierGameObj@@QAEPAVVehicleGameObj@@XZ ; SoldierGameObj::Get_Vehicle
	mov	DWORD PTR _vehicle$1[ebp], eax

; 86   : 		if (vehicle && vehicle->As_VehicleGameObj())
...
; 93   : }
	...
	pop	ebp
	ret	0
?Get_Vehicle@@YAPAVScriptableGameObj@@PAV1@@Z ENDP	; Get_Vehicle
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Find_Closest_Zone@@YAPAVScriptableGameObj@@AAVVector3@@I@Z
_TEXT	SEGMENT
_location$ = 8						; size = 4
_type$ = 12						; size = 4
?Find_Closest_Zone@@YAPAVScriptableGameObj@@AAVVector3@@I@Z PROC ; Find_Closest_Zone, COMDAT
...
; 73   : 	return ScriptZoneGameObj::Find_Closest_Zone(location,(ZoneConstants::ZoneType)type);

	mov	eax, DWORD PTR _type$[ebp]
	push	eax
	mov	ecx, DWORD PTR _location$[ebp]
	push	ecx
	call	?Find_Closest_Zone@ScriptZoneGameObj@@SAPAV1@AAVVector3@@W4ZoneType@ZoneConstants@@@Z ; ScriptZoneGameObj::Find_Closest_Zone
	add	esp, 8
...
; 74   : }
	...
	pop	ebp
	ret	0
?Find_Closest_Zone@@YAPAVScriptableGameObj@@AAVVector3@@I@Z ENDP ; Find_Closest_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?GrantSupplies@@YAXPAVScriptableGameObj@@@Z
_TEXT	SEGMENT
_obj$ = 8						; size = 4
?GrantSupplies@@YAXPAVScriptableGameObj@@@Z PROC	; GrantSupplies, COMDAT

; 70   : AT2(0x00470AC0,0x00470230);
...
$AT3PatchStart$3:
	...
	push	0
	push	4653616					; 00470230H
	push	4655808					; 00470ac0H
	call	?HookupAT3@@YAPAXPAX000@Z		; HookupAT3
	add	esp, 16					; 00000010H
	pop	edx
	pop	ecx
	jmp	eax
?GrantSupplies@@YAXPAVScriptableGameObj@@@Z ENDP	; GrantSupplies
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Create_Library_Object@@YAPAVScriptableGameObj@@PBD@Z
_TEXT	SEGMENT
_preset$ = 8						; size = 4
?Create_Library_Object@@YAPAVScriptableGameObj@@PBD@Z PROC ; Create_Library_Object, COMDAT

; 33   : AT2(0x006C6420,0x006C5CC0);
...
$AT3PatchStart$3:
	...
	push	OFFSET $AT3PatchStart$3
	push	0
	push	7101632					; 006c5cc0H
	push	7103520					; 006c6420H
	call	?HookupAT3@@YAPAXPAX000@Z		; HookupAT3
	add	esp, 16					; 00000010H
	pop	edx
	pop	ecx
	jmp	eax
?Create_Library_Object@@YAPAVScriptableGameObj@@PBD@Z ENDP ; Create_Library_Object
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\stealtheffectclass.h
;	COMDAT ?Is_Stealthed@StealthEffectClass@@QBE_NXZ
_TEXT	SEGMENT
tv66 = -72						; size = 4
_this$ = -4						; size = 4
?Is_Stealthed@StealthEffectClass@@QBE_NXZ PROC		; StealthEffectClass::Is_Stealthed, COMDAT
; _this$ = ecx
...
; 35   : 	bool					Is_Stealthed(void) const					{ return CurrentFraction > 0.5f; }
	...
	jbe	SHORT $LN3@Is_Stealth
	mov	DWORD PTR tv66[ebp], 1
	jmp	SHORT $LN4@Is_Stealth
$LN3@Is_Stealth:
...
$LN4@Is_Stealth:
	...
	pop	ebp
	ret	0
?Is_Stealthed@StealthEffectClass@@QBE_NXZ ENDP		; StealthEffectClass::Is_Stealthed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Find_SmartGameObj@GameObjManager@@SAPAVSmartGameObj@@H@Z
_TEXT	SEGMENT
_object$1 = -8						; size = 4
_node$2 = -4						; size = 4
_networkId$ = 8						; size = 4
?Find_SmartGameObj@GameObjManager@@SAPAVSmartGameObj@@H@Z PROC ; GameObjManager::Find_SmartGameObj, COMDAT
...
; 535  : 	if (!networkId)
	...
	cmp	DWORD PTR _networkId$[ebp], 0
	jne	SHORT $LN6@Find_Smart

; 536  : 		return 0;

	xor	eax, eax
	jmp	SHORT $LN7@Find_Smart
$LN6@Find_Smart:

; 537  : 	for (SLNode<SmartGameObj>* node = GameObjManager::SmartGameObjList.Head(); node; node = node->Next())

	mov	ecx, DWORD PTR ?SmartGameObjList@GameObjManager@@2AAV?$SList@VSmartGameObj@@@@A ; GameObjManager::SmartGameObjList
	call	?Head@?$SList@VSmartGameObj@@@@QBEPAV?$SLNode@VSmartGameObj@@@@XZ ; SList<SmartGameObj>::Head
	mov	DWORD PTR _node$2[ebp], eax
	jmp	SHORT $LN5@Find_Smart
$LN4@Find_Smart:
...
$LN5@Find_Smart:
	...
	je	SHORT $LN3@Find_Smart

; 538  : 	{
; 539  : 		SmartGameObj* object = (SmartGameObj *)node->Data();

	mov	ecx, DWORD PTR _node$2[ebp]
	call	?Data@?$SLNode@VSmartGameObj@@@@QBEPAVSmartGameObj@@XZ ; SLNode<SmartGameObj>::Data
	mov	DWORD PTR _object$1[ebp], eax

; 540  : 		if (object->Get_Network_ID() != networkId)

	mov	ecx, DWORD PTR _object$1[ebp]
	add	ecx, 8
	call	?Get_Network_ID@NetworkObjectClass@@QBEHXZ ; NetworkObjectClass::Get_Network_ID
	cmp	eax, DWORD PTR _networkId$[ebp]
	je	SHORT $LN2@Find_Smart

; 541  : 			continue;

	jmp	SHORT $LN4@Find_Smart
$LN2@Find_Smart:

; 542  : 		if (object->Is_Delete_Pending())

	mov	ecx, DWORD PTR _object$1[ebp]
	add	ecx, 8
	call	?Is_Delete_Pending@NetworkObjectClass@@QAE_NXZ ; NetworkObjectClass::Is_Delete_Pending
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN1@Find_Smart
...
; 547  : }
	...
	pop	ebp
	ret	0
?Find_SmartGameObj@GameObjManager@@SAPAVSmartGameObj@@H@Z ENDP ; GameObjManager::Find_SmartGameObj
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
;	COMDAT ?Head@?$SList@VScriptZoneGameObj@@@@QBEPAV?$SLNode@VScriptZoneGameObj@@@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Head@?$SList@VScriptZoneGameObj@@@@QBEPAV?$SLNode@VScriptZoneGameObj@@@@XZ PROC ; SList<ScriptZoneGameObj>::Head, COMDAT
; _this$ = ecx
...
; 315  : 	}
	...
	pop	ebp
	ret	0
?Head@?$SList@VScriptZoneGameObj@@@@QBEPAV?$SLNode@VScriptZoneGameObj@@@@XZ ENDP ; SList<ScriptZoneGameObj>::Head
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\slist.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptzonegameobj.h
;	COMDAT ?Get_Bounding_Box@ScriptZoneGameObj@@QAEAAVOBBoxClass@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Bounding_Box@ScriptZoneGameObj@@QAEAAVOBBoxClass@@XZ PROC ; ScriptZoneGameObj::Get_Bounding_Box, COMDAT
; _this$ = ecx
...
; 46   : 	OBBoxClass &Get_Bounding_Box() {return BoundingBox;}
	...
	pop	ebp
	ret	0
?Get_Bounding_Box@ScriptZoneGameObj@@QAEAAVOBBoxClass@@XZ ENDP ; ScriptZoneGameObj::Get_Bounding_Box
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptzonegameobj.h
;	COMDAT ?Set_Bounding_Box@ScriptZoneGameObj@@QAEXAAVOBBoxClass@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_box$ = 8						; size = 4
?Set_Bounding_Box@ScriptZoneGameObj@@QAEXAAVOBBoxClass@@@Z PROC ; ScriptZoneGameObj::Set_Bounding_Box, COMDAT
; _this$ = ecx
...
; 45   : 	void Set_Bounding_Box(OBBoxClass &box) {BoundingBox = box;}
	...
	call	??4OBBoxClass@@QAEAAV0@ABV0@@Z
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	4
?Set_Bounding_Box@ScriptZoneGameObj@@QAEXAAVOBBoxClass@@@Z ENDP ; ScriptZoneGameObj::Set_Bounding_Box
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Find_Closest_Zone@ScriptZoneGameObj@@SAPAV1@AAVVector3@@W4ZoneType@ZoneConstants@@@Z
_TEXT	SEGMENT
_distance$1 = -20					; size = 4
_zone$2 = -16						; size = 4
_node$3 = -12						; size = 4
_closestzone$ = -8					; size = 4
_closest$ = -4						; size = 4
_Location$ = 8						; size = 4
_Type$ = 12						; size = 4
?Find_Closest_Zone@ScriptZoneGameObj@@SAPAV1@AAVVector3@@W4ZoneType@ZoneConstants@@@Z PROC ; ScriptZoneGameObj::Find_Closest_Zone, COMDAT
...
; 36   : 	float closest = FLT_MAX;

	movss	xmm0, DWORD PTR __real@7f7fffff
	movss	DWORD PTR _closest$[ebp], xmm0

; 37   : 	ScriptZoneGameObj *closestzone = 0;

	mov	DWORD PTR _closestzone$[ebp], 0

; 38   : 	for (SLNode<ScriptZoneGameObj>* node = GameObjManager::ScriptZoneGameObjList.Head(); node; node = node->Next())

	mov	ecx, DWORD PTR __imp_?ScriptZoneGameObjList@GameObjManager@@2V?$SList@VScriptZoneGameObj@@@@A
	call	?Head@?$SList@VScriptZoneGameObj@@@@QBEPAV?$SLNode@VScriptZoneGameObj@@@@XZ ; SList<ScriptZoneGameObj>::Head
	mov	DWORD PTR _node$3[ebp], eax
	jmp	SHORT $LN5@Find_Close
$LN4@Find_Close:
...
$LN5@Find_Close:
	...
	je	SHORT $LN3@Find_Close

; 39   : 	{
; 40   : 		ScriptZoneGameObj *zone = node->Data();

	mov	ecx, DWORD PTR _node$3[ebp]
	call	?Data@?$SLNode@VScriptZoneGameObj@@@@QBEPAVScriptZoneGameObj@@XZ ; SLNode<ScriptZoneGameObj>::Data
	mov	DWORD PTR _zone$2[ebp], eax

; 41   : 		if (zone->Get_Definition().Get_Type() == Type)

	mov	ecx, DWORD PTR _zone$2[ebp]
	call	?Get_Definition@ScriptZoneGameObj@@QBEABVScriptZoneGameObjDef@@XZ ; ScriptZoneGameObj::Get_Definition
	mov	ecx, eax
	call	?Get_Type@ScriptZoneGameObjDef@@QBE?AW4ZoneType@ZoneConstants@@XZ ; ScriptZoneGameObjDef::Get_Type
	cmp	eax, DWORD PTR _Type$[ebp]
	jne	SHORT $LN1@Find_Close

; 42   : 		{
; 43   : 			float distance = Vector3::Distance_Squared(zone->Get_Bounding_Box().Center,Location);
...
; 44   : 			if (distance < closest)

	movss	xmm0, DWORD PTR _closest$[ebp]
...
; 46   : 				closest = distance;
	...
	movss	xmm0, DWORD PTR _distance$1[ebp]
	movss	DWORD PTR _closest$[ebp], xmm0

; 47   : 				closestzone = zone;

	mov	eax, DWORD PTR _zone$2[ebp]
	mov	DWORD PTR _closestzone$[ebp], eax
$LN1@Find_Close:
...
; 50   : 	}
	...
	jmp	SHORT $LN4@Find_Close
$LN3@Find_Close:

; 51   : 	return closestzone;

	mov	eax, DWORD PTR _closestzone$[ebp]
...
; 52   : }
	...
	pop	ebp
	ret	0
?Find_Closest_Zone@ScriptZoneGameObj@@SAPAV1@AAVVector3@@W4ZoneType@ZoneConstants@@@Z ENDP ; ScriptZoneGameObj::Find_Closest_Zone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Inside_Me@ScriptZoneGameObj@@QAE_NPAVPhysicalGameObj@@@Z
_TEXT	SEGMENT
_v$1 = -16						; size = 12
_this$ = -4						; size = 4
_obj$ = 8						; size = 4
?Inside_Me@ScriptZoneGameObj@@QAE_NPAVPhysicalGameObj@@@Z PROC ; ScriptZoneGameObj::Inside_Me, COMDAT
; _this$ = ecx
...
; 56   :     if (obj && obj->Peek_Physical_Object())

	cmp	DWORD PTR _obj$[ebp], 0
	je	SHORT $LN2@Inside_Me
	mov	ecx, DWORD PTR _obj$[ebp]
...
; 66   : }
	...
	pop	ebp
	ret	4
?Inside_Me@ScriptZoneGameObj@@QAE_NPAVPhysicalGameObj@@@Z ENDP ; ScriptZoneGameObj::Inside_Me
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\scriptzonegameobjdef.h
;	COMDAT ?Get_Type@ScriptZoneGameObjDef@@QBE?AW4ZoneType@ZoneConstants@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Type@ScriptZoneGameObjDef@@QBE?AW4ZoneType@ZoneConstants@@XZ PROC ; ScriptZoneGameObjDef::Get_Type, COMDAT
; _this$ = ecx
...
; 40   : 	ZoneConstants::ZoneType Get_Type() const {return ZoneType;}
	...
	pop	ebp
	ret	0
?Get_Type@ScriptZoneGameObjDef@@QBE?AW4ZoneType@ZoneConstants@@XZ ENDP ; ScriptZoneGameObjDef::Get_Type
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\physcoltest.h
;	COMDAT ??0PhysRayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Group_Type@@W4Collision_Type@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ray$ = 8						; size = 4
_res$ = 12						; size = 4
_group$ = 16						; size = 4
_type$ = 20						; size = 4
??0PhysRayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Group_Type@@W4Collision_Type@@@Z PROC ; PhysRayCollisionTestClass::PhysRayCollisionTestClass, COMDAT
; _this$ = ecx
...
; 27   : 	{
	...
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0RayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Type@@_N@Z ; RayCollisionTestClass::RayCollisionTestClass
	mov	eax, DWORD PTR _this$[ebp]
...
; 28   : 	}
	...
	pop	ebp
	ret	16					; 00000010H
??0PhysRayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Group_Type@@W4Collision_Type@@@Z ENDP ; PhysRayCollisionTestClass::PhysRayCollisionTestClass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\coltest.h
;	COMDAT ??0RayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Type@@_N@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ray$ = 8						; size = 4
_res$ = 12						; size = 4
_collision_type$ = 16					; size = 4
_ignore_translucent_meshes$ = 20			; size = 1
??0RayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Type@@_N@Z PROC ; RayCollisionTestClass::RayCollisionTestClass, COMDAT
; _this$ = ecx
...
; 69   : {
	...
	push	edi
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _collision_type$[ebp]
	push	eax
	mov	ecx, DWORD PTR _res$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0CollisionTestClass@@QAE@PAUCastResultStruct@@W4Collision_Type@@@Z ; CollisionTestClass::CollisionTestClass
	mov	eax, DWORD PTR _ray$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 12					; 0000000cH
	call	??0LineSegClass@@QAE@ABV0@@Z
	mov	eax, DWORD PTR _this$[ebp]
	mov	cl, BYTE PTR _ignore_translucent_meshes$[ebp]
...
; 70   : }
	...
	pop	ebp
	ret	16					; 00000010H
??0RayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Type@@_N@Z ENDP ; RayCollisionTestClass::RayCollisionTestClass
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
;	COMDAT ?Length@?$VectorClass@PAVSoldierGameObj@@@@QBEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Length@?$VectorClass@PAVSoldierGameObj@@@@QBEHXZ PROC	; VectorClass<SoldierGameObj *>::Length, COMDAT
; _this$ = ecx
...
; 201  : 	}
	...
	pop	ebp
	ret	0
?Length@?$VectorClass@PAVSoldierGameObj@@@@QBEHXZ ENDP	; VectorClass<SoldierGameObj *>::Length
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_vector.h
...
;	COMDAT ?Set_Occupant@VehicleGameObj@@QAEXHPAVSoldierGameObj@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_seat$ = 8						; size = 4
_occupant$ = 12						; size = 4
?Set_Occupant@VehicleGameObj@@QAEXHPAVSoldierGameObj@@@Z PROC ; VehicleGameObj::Set_Occupant, COMDAT
; _this$ = ecx

; 132  : 	void Set_Occupant(int seat, SoldierGameObj *occupant) {SeatOccupants[seat] = occupant;}
	...
	pop	ebp
	ret	8
?Set_Occupant@VehicleGameObj@@QAEXHPAVSoldierGameObj@@@Z ENDP ; VehicleGameObj::Set_Occupant
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vehiclegameobj.h
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vehiclegameobj.h
;	COMDAT ?Get_Driver_Is_Gunner@VehicleGameObj@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Driver_Is_Gunner@VehicleGameObj@@QAE_NXZ PROC	; VehicleGameObj::Get_Driver_Is_Gunner, COMDAT
; _this$ = ecx

; 117  : 	bool	Get_Driver_Is_Gunner(void)			{return DriverIsGunner;}
	...
	pop	ebp
	ret	0
?Get_Driver_Is_Gunner@VehicleGameObj@@QAE_NXZ ENDP	; VehicleGameObj::Get_Driver_Is_Gunner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vehiclegameobj.h
;	COMDAT ?Get_Lock_Owner@VehicleGameObj@@QAEPAVScriptableGameObj@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Lock_Owner@VehicleGameObj@@QAEPAVScriptableGameObj@@XZ PROC ; VehicleGameObj::Get_Lock_Owner, COMDAT
; _this$ = ecx

; 113  : 	ScriptableGameObj *	Get_Lock_Owner(void) { return LockOwner.Get_Ptr(); }
	...
	pop	ebp
	ret	0
?Get_Lock_Owner@VehicleGameObj@@QAEPAVScriptableGameObj@@XZ ENDP ; VehicleGameObj::Get_Lock_Owner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Actual_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ
_TEXT	SEGMENT
_gunner$ = -8						; size = 4
_this$ = -4						; size = 4
?Get_Actual_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ PROC ; VehicleGameObj::Get_Actual_Gunner, COMDAT
; _this$ = ecx
...
; 520  : 	SoldierGameObj * gunner = Get_Gunner();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ; VehicleGameObj::Get_Gunner
	mov	DWORD PTR _gunner$[ebp], eax

; 521  : 	if ( gunner && !Get_Driver_Is_Gunner() ) {

	cmp	DWORD PTR _gunner$[ebp], 0
	je	SHORT $LN1@Get_Actual
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Get_Driver_Is_Gunner@VehicleGameObj@@QAE_NXZ ; VehicleGameObj::Get_Driver_Is_Gunner
	movzx	eax, al
	test	eax, eax
	jne	SHORT $LN1@Get_Actual

; 522  : 		return gunner;

	mov	eax, DWORD PTR _gunner$[ebp]
	jmp	SHORT $LN2@Get_Actual
$LN1@Get_Actual:

; 523  : 	}
; 524  : 	return Get_Driver();
...
; 525  : }
	...
	pop	ebp
	ret	0
?Get_Actual_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ENDP ; VehicleGameObj::Get_Actual_Gunner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ PROC ; VehicleGameObj::Get_Gunner, COMDAT
; _this$ = ecx
...
; 512  : 	if ( SeatOccupants.Length() > GUNNER_SEAT ) {

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 2476				; 000009acH
	call	?Length@?$VectorClass@PAVSoldierGameObj@@@@QBEHXZ ; VectorClass<SoldierGameObj *>::Length
	cmp	eax, 1
	jle	SHORT $LN1@Get_Gunner

; 513  : 		return SeatOccupants[GUNNER_SEAT];
...
; 516  : }
	...
	pop	ebp
	ret	0
?Get_Gunner@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ENDP ; VehicleGameObj::Get_Gunner
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Driver@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Driver@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ PROC ; VehicleGameObj::Get_Driver, COMDAT
; _this$ = ecx
...
; 504  : 	if ( SeatOccupants.Length() > DRIVER_SEAT ) {

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 2476				; 000009acH
	call	?Length@?$VectorClass@PAVSoldierGameObj@@@@QBEHXZ ; VectorClass<SoldierGameObj *>::Length
	test	eax, eax
	jle	SHORT $LN1@Get_Driver

; 505  : 		return SeatOccupants[DRIVER_SEAT];
...
; 508  : }
	...
	pop	ebp
	ret	0
?Get_Driver@VehicleGameObj@@QAEPAVSoldierGameObj@@XZ ENDP ; VehicleGameObj::Get_Driver
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Find_Seat@VehicleGameObj@@QAEHPAVSoldierGameObj@@@Z
_TEXT	SEGMENT
_i$1 = -8						; size = 4
_this$ = -4						; size = 4
_occupant$ = 8						; size = 4
?Find_Seat@VehicleGameObj@@QAEHPAVSoldierGameObj@@@Z PROC ; VehicleGameObj::Find_Seat, COMDAT
; _this$ = ecx
...
; 712  : 	for ( int i = 0; i < SeatOccupants.Length(); i++ )

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN4@Find_Seat
$LN3@Find_Seat:
	mov	eax, DWORD PTR _i$1[ebp]
	add	eax, 1
	mov	DWORD PTR _i$1[ebp], eax
$LN4@Find_Seat:
	...
	jge	SHORT $LN2@Find_Seat

; 713  : 	{
; 714  : 		if ( SeatOccupants[i] == occupant )
	...
	call	??A?$VectorClass@PAVSoldierGameObj@@@@QAEAAPAVSoldierGameObj@@H@Z ; VectorClass<SoldierGameObj *>::operator[]
	mov	ecx, DWORD PTR [eax]
	cmp	ecx, DWORD PTR _occupant$[ebp]
	jne	SHORT $LN1@Find_Seat

; 715  : 		{
; 716  : 			return i;

	mov	eax, DWORD PTR _i$1[ebp]
	jmp	SHORT $LN5@Find_Seat
$LN1@Find_Seat:

; 717  : 		}
; 718  : 	}

	jmp	SHORT $LN3@Find_Seat
$LN2@Find_Seat:
...
; 720  : }
	...
	pop	ebp
	ret	4
?Find_Seat@VehicleGameObj@@QAEHPAVSoldierGameObj@@@Z ENDP ; VehicleGameObj::Find_Seat
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Get_Definition@VehicleGameObj@@QBEABVVehicleGameObjDef@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Definition@VehicleGameObj@@QBEABVVehicleGameObjDef@@XZ PROC ; VehicleGameObj::Get_Definition, COMDAT
; _this$ = ecx
...
; 529  : 	return (const VehicleGameObjDef &)BaseGameObj::Get_Definition();
...
; 530  : }
	...
	pop	ebp
	ret	0
?Get_Definition@VehicleGameObj@@QBEABVVehicleGameObjDef@@XZ ENDP ; VehicleGameObj::Get_Definition
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
;	COMDAT ?Get_Fly_Mode@SoldierGameObj@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Fly_Mode@SoldierGameObj@@QAE_NXZ PROC		; SoldierGameObj::Get_Fly_Mode, COMDAT
; _this$ = ecx

; 187  : 	bool Get_Fly_Mode() {return InFlyMode;}
	...
	pop	ebp
	ret	0
?Get_Fly_Mode@SoldierGameObj@@QAE_NXZ ENDP		; SoldierGameObj::Get_Fly_Mode
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\soldiergameobj.h
;	COMDAT ?Get_Vehicle@SoldierGameObj@@QAEPAVVehicleGameObj@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Get_Vehicle@SoldierGameObj@@QAEPAVVehicleGameObj@@XZ PROC ; SoldierGameObj::Get_Vehicle, COMDAT
; _this$ = ecx

; 129  : 	VehicleGameObj	*		Get_Vehicle( void )			{ return Vehicle; }
	...
	pop	ebp
	ret	0
?Get_Vehicle@SoldierGameObj@@QAEPAVVehicleGameObj@@XZ ENDP ; SoldierGameObj::Get_Vehicle
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\soldiergameobjdef.h
;	COMDAT ?Is_Unsquishable@SoldierGameObjDef@@QBE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Is_Unsquishable@SoldierGameObjDef@@QBE_NXZ PROC	; SoldierGameObjDef::Is_Unsquishable, COMDAT
; _this$ = ecx
...
; 41   : 	bool Is_Unsquishable() const { return IsUnsquishable; }
	...
	pop	ebp
	ret	0
?Is_Unsquishable@SoldierGameObjDef@@QBE_NXZ ENDP	; SoldierGameObjDef::Is_Unsquishable
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\soldiergameobjdef.h
;	COMDAT ?Is_Spy@SoldierGameObjDef@@QBE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Is_Spy@SoldierGameObjDef@@QBE_NXZ PROC			; SoldierGameObjDef::Is_Spy, COMDAT
; _this$ = ecx
...
; 39   : 	bool Is_Spy() const {return IsSpy;}
	...
	pop	ebp
	ret	0
?Is_Spy@SoldierGameObjDef@@QBE_NXZ ENDP			; SoldierGameObjDef::Is_Spy
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??4OBBoxClass@@QAEAAV0@ABV0@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___that$ = 8						; size = 4
??4OBBoxClass@@QAEAAV0@ABV0@@Z PROC			; OBBoxClass::operator=, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	pop	ebp
	ret	4
??4OBBoxClass@@QAEAAV0@ABV0@@Z ENDP			; OBBoxClass::operator=
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Stealthed@SmartGameObj@@QBE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Is_Stealthed@SmartGameObj@@QBE_NXZ PROC		; SmartGameObj::Is_Stealthed, COMDAT
; _this$ = ecx
...
; 487  : 	if (StealthEffect)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+2120], 0
	je	SHORT $LN2@Is_Stealth

; 488  : 	{
; 489  : 		if (StealthEffect->Is_Stealthed())

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+2120]
	call	?Is_Stealthed@StealthEffectClass@@QBE_NXZ ; StealthEffectClass::Is_Stealthed
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN2@Is_Stealth
...
; 495  : }
	...
	pop	ebp
	ret	0
?Is_Stealthed@SmartGameObj@@QBE_NXZ ENDP		; SmartGameObj::Is_Stealthed
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Stealth_Enabled@SmartGameObj@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Is_Stealth_Enabled@SmartGameObj@@QAE_NXZ PROC		; SmartGameObj::Is_Stealth_Enabled, COMDAT
; _this$ = ecx
...
; 557  : }
	...
	pop	ebp
	ret	0
?Is_Stealth_Enabled@SmartGameObj@@QAE_NXZ ENDP		; SmartGameObj::Is_Stealth_Enabled
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Splash_Possible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z
_TEXT	SEGMENT
tv132 = -316						; size = 4
$T1 = -312						; size = 52
_collisionTest$ = -196					; size = 80
_castResult$ = -116					; size = 40
_lookPosition$ = -76					; size = 12
_lookTransform$ = -64					; size = 48
_bullseyePosition$ = -16				; size = 12
_this$ = -4						; size = 4
_object$ = 8						; size = 4
?Is_Splash_Possible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z PROC ; SmartGameObj::Is_Splash_Possible, COMDAT
; _this$ = ecx
...
; 591  : 	Vector3 bullseyePosition = object->Get_Position();

	lea	eax, DWORD PTR _bullseyePosition$[ebp]
	push	eax
	mov	ecx, DWORD PTR _object$[ebp]
	call	?Get_Position@PhysicalGameObj@@QAE?AVVector3@@XZ ; PhysicalGameObj::Get_Position

; 592  : 	const Matrix3D lookTransform = Get_Look_Transform();

	lea	eax, DWORD PTR _lookTransform$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 593  : 	const Vector3 lookPosition = lookTransform.Get_Translation();

	lea	eax, DWORD PTR _lookPosition$[ebp]
	push	eax
	lea	ecx, DWORD PTR _lookTransform$[ebp]
	call	?Get_Translation@Matrix3D@@QBE?AVVector3@@XZ ; Matrix3D::Get_Translation

; 594  : 	
; 595  : 
; 596  : 	
; 597  : 	CastResultStruct castResult;

	lea	ecx, DWORD PTR _castResult$[ebp]
	call	??0CastResultStruct@@QAE@XZ		; CastResultStruct::CastResultStruct

; 598  : 	PhysRayCollisionTestClass collisionTest(LineSegClass(bullseyePosition,lookPosition), &castResult, BULLET_COLLISION_GROUP);

	push	4
	push	3
	lea	eax, DWORD PTR _castResult$[ebp]
	push	eax
	lea	ecx, DWORD PTR _lookPosition$[ebp]
	push	ecx
	lea	edx, DWORD PTR _bullseyePosition$[ebp]
	push	edx
	lea	ecx, DWORD PTR $T1[ebp]
	call	??0LineSegClass@@QAE@ABVVector3@@0@Z	; LineSegClass::LineSegClass
	push	eax
	lea	ecx, DWORD PTR _collisionTest$[ebp]
	call	??0PhysRayCollisionTestClass@@QAE@ABVLineSegClass@@PAUCastResultStruct@@W4Collision_Group_Type@@W4Collision_Type@@@Z ; PhysRayCollisionTestClass::PhysRayCollisionTestClass

; 599  : 	
; 600  : 	object->Peek_Physical_Object()->Inc_Ignore_Counter();

	mov	ecx, DWORD PTR _object$[ebp]
	call	?Peek_Physical_Object@PhysicalGameObj@@QBEPAVPhysClass@@XZ ; PhysicalGameObj::Peek_Physical_Object
	mov	ecx, eax
	call	?Inc_Ignore_Counter@PhysClass@@QAEXXZ	; PhysClass::Inc_Ignore_Counter

; 601  : 	PhysicsSceneClass::Get_Instance()->Cast_Ray(collisionTest, false);

	push	0
	lea	eax, DWORD PTR _collisionTest$[ebp]
	push	eax
	call	?Get_Instance@PhysicsSceneClass@@SAPAV1@XZ ; PhysicsSceneClass::Get_Instance
	mov	ecx, eax
	call	?Cast_Ray@PhysicsSceneClass@@QAE_NAAVPhysRayCollisionTestClass@@_N@Z ; PhysicsSceneClass::Cast_Ray

; 602  : 	object->Peek_Physical_Object()->Dec_Ignore_Counter();

	mov	ecx, DWORD PTR _object$[ebp]
	call	?Peek_Physical_Object@PhysicalGameObj@@QBEPAVPhysClass@@XZ ; PhysicalGameObj::Peek_Physical_Object
	mov	ecx, eax
	call	?Dec_Ignore_Counter@PhysClass@@QAEXXZ	; PhysClass::Dec_Ignore_Counter

; 603  : 	
; 604  : 	return
; 605  : 		castResult.Fraction == 1.f ||
; 606  : 		collisionTest.CollidedPhysObj == Peek_Physical_Object();

	movss	xmm0, DWORD PTR _castResult$[ebp+4]
	ucomiss	xmm0, DWORD PTR __real@3f800000
	lahf
	test	ah, 68					; 00000044H
	jnp	SHORT $LN3@Is_Splash_
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Peek_Physical_Object@PhysicalGameObj@@QBEPAVPhysClass@@XZ ; PhysicalGameObj::Peek_Physical_Object
	cmp	DWORD PTR _collisionTest$[ebp+68], eax
	je	SHORT $LN3@Is_Splash_
	mov	DWORD PTR tv132[ebp], 0
	jmp	SHORT $LN4@Is_Splash_
$LN3@Is_Splash_:
...
; 607  : }
	...
	pop	ebp
	ret	4
?Is_Splash_Possible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z ENDP ; SmartGameObj::Is_Splash_Possible
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Obj_Visible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z
_TEXT	SEGMENT
tv223 = -372						; size = 8
tv221 = -372						; size = 4
tv186 = -368						; size = 4
...
$T1 = -364						; size = 12
$T2 = -352						; size = 52
_collisionTest$ = -236					; size = 80
_castResult$ = -156					; size = 40
_angle$ = -116						; size = 4
_xyBullseyeDirection$ = -112				; size = 12
_xytranformedBullseyeOffset$ = -100			; size = 12
_tranformedBullseyeOffset$ = -88			; size = 12
_lookPosition$ = -76					; size = 12
_lookTransform$ = -64					; size = 48
_bullseyePosition$ = -16				; size = 12
_this$ = -4						; size = 4
_object$ = 8						; size = 4
?Is_Obj_Visible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z PROC ; SmartGameObj::Is_Obj_Visible, COMDAT
; _this$ = ecx
...
; 561  : 	const Vector3 bullseyePosition = object->Get_Bullseye_Position();
...
; 562  : 	const Matrix3D lookTransform = Get_Look_Transform();
...
; 563  : 	
; 564  : 	const Vector3 lookPosition = lookTransform.Get_Translation();
...
; 565  : 	const Vector3 tranformedBullseyeOffset = lookTransform.Inverse_Rotate_Vector(bullseyePosition - lookPosition);

	lea	eax, DWORD PTR _lookPosition$[ebp]
	push	eax
	lea	ecx, DWORD PTR _bullseyePosition$[ebp]
	push	ecx
	...
	add	esp, 12					; 0000000cH
	push	eax
	lea	eax, DWORD PTR _tranformedBullseyeOffset$[ebp]
	push	eax
	lea	ecx, DWORD PTR _lookTransform$[ebp]
	call	?Inverse_Rotate_Vector@Matrix3D@@QBE?AVVector3@@ABV2@@Z ; Matrix3D::Inverse_Rotate_Vector

; 566  : 	
; 567  : 	if (tranformedBullseyeOffset.Length() >= Get_Definition().SightRange * GlobalSightRangeScale)

	lea	ecx, DWORD PTR _tranformedBullseyeOffset$[ebp]
	call	?Length@Vector3@@QBEMXZ			; Vector3::Length
	fstp	DWORD PTR tv186[ebp]
	movss	xmm0, DWORD PTR tv186[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	DWORD PTR tv221[ebp], xmm0
	call	?Get_Definition@SmartGameObj@@QBEABVSmartGameObjDef@@XZ ; SmartGameObj::Get_Definition
	mov	ecx, DWORD PTR ?GlobalSightRangeScale@SmartGameObj@@0AAMA ; SmartGameObj::GlobalSightRangeScale
	movss	xmm0, DWORD PTR [eax+208]
	mulss	xmm0, DWORD PTR [ecx]
	movss	xmm1, DWORD PTR tv221[ebp]
	comiss	xmm1, xmm0
	jb	SHORT $LN2@Is_Obj_Vis
...
; 569  : 	
; 570  : 	const Vector3 xytranformedBullseyeOffset = Vector3(tranformedBullseyeOffset.X, tranformedBullseyeOffset.Y, 0);

	push	ecx
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _tranformedBullseyeOffset$[ebp+4]
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _tranformedBullseyeOffset$[ebp]
	movss	DWORD PTR [esp], xmm0
	lea	ecx, DWORD PTR _xytranformedBullseyeOffset$[ebp]
	call	??0Vector3@@QAE@MMM@Z			; Vector3::Vector3

; 571  : 	const Vector3 xyBullseyeDirection = Normalize(xytranformedBullseyeOffset);

	lea	eax, DWORD PTR _xytranformedBullseyeOffset$[ebp]
	push	eax
	lea	ecx, DWORD PTR _xyBullseyeDirection$[ebp]
	push	ecx
	call	?Normalize@@YA?AVVector3@@ABV1@@Z	; Normalize
	add	esp, 8

; 572  : 	const float angle = WWMath::Fast_Acos(xyBullseyeDirection.X);

	push	ecx
	movss	xmm0, DWORD PTR _xyBullseyeDirection$[ebp]
	movss	DWORD PTR [esp], xmm0
	call	?Fast_Acos@WWMath@@SAMM@Z		; WWMath::Fast_Acos
	add	esp, 4
	fstp	DWORD PTR _angle$[ebp]

; 573  : 	
; 574  : 	if (angle >= .5 * Get_Definition().SightArc)

	cvtss2sd xmm0, DWORD PTR _angle$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movsd	QWORD PTR tv223[ebp], xmm0
	call	?Get_Definition@SmartGameObj@@QBEABVSmartGameObjDef@@XZ ; SmartGameObj::Get_Definition
	cvtss2sd xmm0, DWORD PTR [eax+212]
	mulsd	xmm0, QWORD PTR __real@3fe0000000000000
	movsd	xmm1, QWORD PTR tv223[ebp]
	comisd	xmm1, xmm0
	jb	SHORT $LN1@Is_Obj_Vis
...
; 576  : 	
; 577  : 	CastResultStruct castResult;

	lea	ecx, DWORD PTR _castResult$[ebp]
	call	??0CastResultStruct@@QAE@XZ		; CastResultStruct::CastResultStruct

; 578  : 	PhysRayCollisionTestClass collisionTest(LineSegClass(lookPosition, bullseyePosition), &castResult, BULLET_COLLISION_GROUP);
	...
	lea	ecx, DWORD PTR _bullseyePosition$[ebp]
	push	ecx
	lea	edx, DWORD PTR _lookPosition$[ebp]
	push	edx
	lea	ecx, DWORD PTR $T2[ebp]
	call	??0LineSegClass@@QAE@ABVVector3@@0@Z	; LineSegClass::LineSegClass
	push	eax
...
; 579  : 	
; 580  : 	Peek_Physical_Object()->Inc_Ignore_Counter();
...
; 581  : 	PhysicsSceneClass::Get_Instance()->Cast_Ray(collisionTest, false);
...
; 582  : 	Peek_Physical_Object()->Dec_Ignore_Counter();
...
; 583  : 	
; 584  : 	return
; 585  : 		castResult.Fraction == 1.f ||
; 586  : 		collisionTest.CollidedPhysObj == object->Peek_Physical_Object();

	movss	xmm0, DWORD PTR _castResult$[ebp+4]
	ucomiss	xmm0, DWORD PTR __real@3f800000
	lahf
	test	ah, 68					; 00000044H
	jnp	SHORT $LN5@Is_Obj_Vis
	mov	ecx, DWORD PTR _object$[ebp]
	call	?Peek_Physical_Object@PhysicalGameObj@@QBEPAVPhysClass@@XZ ; PhysicalGameObj::Peek_Physical_Object
	cmp	DWORD PTR _collisionTest$[ebp+68], eax
	je	SHORT $LN5@Is_Obj_Vis
	mov	DWORD PTR tv167[ebp], 0
	jmp	SHORT $LN6@Is_Obj_Vis
$LN5@Is_Obj_Vis:
...
; 587  : }
	...
	pop	ebp
	ret	4
?Is_Obj_Visible@SmartGameObj@@QAE_NPAVPhysicalGameObj@@@Z ENDP ; SmartGameObj::Is_Obj_Visible
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Human_Controlled@SmartGameObj@@QAE_NXZ
_TEXT	SEGMENT
tv66 = -72						; size = 4
_this$ = -4						; size = 4
?Is_Human_Controlled@SmartGameObj@@QAE_NXZ PROC		; SmartGameObj::Is_Human_Controlled, COMDAT
; _this$ = ecx
...
; 499  : 	return (this->ControlOwner >= 0);

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+2396], 0
	jl	SHORT $LN3@Is_Human_C
	mov	DWORD PTR tv66[ebp], 1
	jmp	SHORT $LN4@Is_Human_C
$LN3@Is_Human_C:
	mov	DWORD PTR tv66[ebp], 0
$LN4@Is_Human_C:
	mov	al, BYTE PTR tv66[ebp]
...
; 500  : }
	...
	pop	ebp
	ret	0
?Is_Human_Controlled@SmartGameObj@@QAE_NXZ ENDP		; SmartGameObj::Is_Human_Controlled
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Has_Player@SmartGameObj@@QAE_NXZ
_TEXT	SEGMENT
tv66 = -72						; size = 4
_this$ = -4						; size = 4
?Has_Player@SmartGameObj@@QAE_NXZ PROC			; SmartGameObj::Has_Player, COMDAT
; _this$ = ecx
...
; 551  : 	return ControlOwner != SERVER_CONTROL_OWNER;

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+2396], -99999		; fffe7961H
	je	SHORT $LN3@Has_Player
	mov	DWORD PTR tv66[ebp], 1
	jmp	SHORT $LN4@Has_Player
$LN3@Has_Player:
	mov	DWORD PTR tv66[ebp], 0
$LN4@Has_Player:
	mov	al, BYTE PTR tv66[ebp]
...
; 552  : }
	...
	pop	ebp
	ret	0
?Has_Player@SmartGameObj@@QAE_NXZ ENDP			; SmartGameObj::Has_Player
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\engine_obj2.cpp
;	COMDAT ?Is_Acting@ActionClass@@QAE_NXZ
_TEXT	SEGMENT
tv66 = -72						; size = 4
_this$ = -4						; size = 4
?Is_Acting@ActionClass@@QAE_NXZ PROC			; ActionClass::Is_Acting, COMDAT
; _this$ = ecx
...
; 611  : 	return ( ActionCode != NULL );

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 0
	je	SHORT $LN3@Is_Acting
	mov	DWORD PTR tv66[ebp], 1
	jmp	SHORT $LN4@Is_Acting
$LN3@Is_Acting:
	mov	DWORD PTR tv66[ebp], 0
$LN4@Is_Acting:
	mov	al, BYTE PTR tv66[ebp]
...
; 612  : }
	...
	pop	ebp
	ret	0
?Is_Acting@ActionClass@@QAE_NXZ ENDP			; ActionClass::Is_Acting
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
;	COMDAT ?Dec_Ignore_Counter@PhysClass@@QAEXXZ
_TEXT	SEGMENT
_count$ = -8						; size = 4
_this$ = -4						; size = 4
?Dec_Ignore_Counter@PhysClass@@QAEXXZ PROC		; PhysClass::Dec_Ignore_Counter, COMDAT
; _this$ = ecx
...
; 237  : }
	...
	pop	ebp
	ret	0
?Dec_Ignore_Counter@PhysClass@@QAEXXZ ENDP		; PhysClass::Dec_Ignore_Counter
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\physclass.h
;	COMDAT ?Inc_Ignore_Counter@PhysClass@@QAEXXZ
_TEXT	SEGMENT
_count$ = -8						; size = 4
_this$ = -4						; size = 4
?Inc_Ignore_Counter@PhysClass@@QAEXXZ PROC		; PhysClass::Inc_Ignore_Counter, COMDAT
; _this$ = ecx
...
; 230  : }
	...
	pop	ebp
	ret	0
?Inc_Ignore_Counter@PhysClass@@QAEXXZ ENDP		; PhysClass::Inc_Ignore_Counter
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\physclass.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\castresultstruct.h
;	COMDAT ?Reset@CastResultStruct@@QAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Reset@CastResultStruct@@QAEXXZ PROC			; CastResultStruct::Reset, COMDAT
; _this$ = ecx
...
; 19   : 	void		Reset(void)		{ StartBad = false; Fraction = 1.0f; Normal.Set(0,0,0); SurfaceType = 0; ComputeContactPoint = false; ContactPoint.Set(0,0,0); }
	...
	pop	ebp
	ret	0
?Reset@CastResultStruct@@QAEXXZ ENDP			; CastResultStruct::Reset
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\castresultstruct.h
;	COMDAT ??0CastResultStruct@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0CastResultStruct@@QAE@XZ PROC			; CastResultStruct::CastResultStruct, COMDAT
; _this$ = ecx
...
; 18   : 	CastResultStruct(void)	{ Reset(); }
	...
	call	??0Vector3@@QAE@XZ			; Vector3::Vector3
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Reset@CastResultStruct@@QAEXXZ		; CastResultStruct::Reset
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0CastResultStruct@@QAE@XZ ENDP			; CastResultStruct::CastResultStruct
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
;	COMDAT ?Is_Delete_Pending@NetworkObjectClass@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Is_Delete_Pending@NetworkObjectClass@@QAE_NXZ PROC	; NetworkObjectClass::Is_Delete_Pending, COMDAT
; _this$ = ecx
...
; 67   : 	bool					Is_Delete_Pending (void)	{ return IsDeletePending; }
	...
	pop	ebp
	ret	0
?Is_Delete_Pending@NetworkObjectClass@@QAE_NXZ ENDP	; NetworkObjectClass::Is_Delete_Pending
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\networkobjectclass.h
...
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vector3.h
;	COMDAT ?Normalize@@YA?AVVector3@@ABV1@@Z
_TEXT	SEGMENT
tv75 = -72						; size = 4
_len2$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
_vec$ = 12						; size = 4
?Normalize@@YA?AVVector3@@ABV1@@Z PROC			; Normalize, COMDAT
...
; 396  : }
	...
	pop	ebp
	ret	0
?Normalize@@YA?AVVector3@@ABV1@@Z ENDP			; Normalize
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File x:\github\renegade\dragonade_rxd\scripts\vector3.h
